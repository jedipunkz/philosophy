---
source: "https://archive.org/details/immanuelkantscr01kantgoog"
title: "Immanuel Kant's Critique of pure reason. In commemoration of the centenary of its first publication"
author: "Müller, F. Max (Friedrich Max), 1823-1900"
year: "1881"
captured_at: "2026-07-10T09:54:35Z"
updated_at: "2026-07-10T09:54:35Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "カント"
query: "Critique of Pure Reason"
plain_text_url: "https://archive.org/download/immanuelkantscr01kantgoog/immanuelkantscr01kantgoog_djvu.txt"
public_domain: true
...
- 著者: Müller, F. Max (Friedrich Max), 1823-1900
- 初版: 1881
- 情報源: [archive](https://archive.org/details/immanuelkantscr01kantgoog)
- パブリックドメイン: ✓
...
^n  ^omratmoxntion  of  il^t  Ctnttnarg  of  its
...
1.  PBEFACE  BY   F.   MAX  MULLER

2.  HISTORICAL   INTRODUCTION  BY  LUDWIG  NOIRfi
...
PRINTED     BT     E.    PIOKABD     HALL,    M.A.,    AND     J.    H.    BTAOT.
PBINTEB8    TO    THE    UNIVEB8ITT.

TABLE  OF  CONTENTS.

Translatob's  Preface
L.  Noibe's  HisTOBiCAii  Introduction
IntroductioD
Ancient  Philosophy
MedioBvcU  Philosophy
Modem  Philosophy
I>e8carte8
...
L  The  theory  of  intellectual  perception
...
Principal  Additions  hade  by  Kant  in  the  Second  Edition

OF  THE  CbITIQUE  OF  PUBK  ReASON 36 1
...
II.  We  are  in  possession  of  certain  cognitions  a  priori y
...
Transcendental  deduction  of  the  universally  i>ossiblc  em-
...
T.  Axioms  of  Intuition  .         .         .         .  .         .  4^'4

Supplement  XVI  b 4O5
...
Supplement  X\TII 469

A.  Fii-st  Analogy.     Principle  of  the  jMTmanence  of  sub-

stance    .........  469

Supplement  XIX 471

B.  Second  Analog)'.  Principle  of  tlie  succession  uf  time,

accordinjy  to  the  law  of  causality       .         .         •         -471

Supplement  XX.  .  -473

C.  Third  Analogy.  Principle  of  co-existence  according  to

the  law  of  recij^rocity  or  community  .         .47.3
...
Why  I  thought  I  might  translate  Zant's  Critique.

*  Btd  how  can  you  waste  your  time  on  a  translation
...
and  DO  wonder  that  it  should  be  so,  if  we  consider
...
On  p.  42 1  (484),  Kant  says :  Da  also  selhst  die
Aujidsung  dieser  Aufgahen  niemals  in  der  Erfahrung
vorJcommen  Jcann.  This  means,  'As  therefore  even  the
...
Die  dogmatische  Aujlosung  ist  also  nicht  etwa  un-
getviss,  sondern  unmoglichy  i.  e.  '  Hence  the  dog-
matical solution  is  not,  as  you  imagine,  uncertain,
but  it  is  impossible.'

On  p.  42 1  (485),  the  syntactical  structure  of  the  sen-
tence, as  well  as  the  intention  of  the  writer,  does  not  al-
low of  our  changing  the  words  so  ist  es  kluglich  gehan-
delty  into  a  question.  It  is  the  particle  so  which  requires
the  transposition  of  the  pronoun  (ist  es  instead  ofes  ist)y
not  the  interrogative  character  of  the  whole  sentence.

On  p.  42  7  (492),  wenn  cannot  be  rendered  hj although,
which  is  wenn  auch  in  German.     Wenn  beide  nach

viii  translator's  preface.

empirischen  Gesetzen  in  einer  Erfahrung  richtig  und
durchgdngig  zusammefthdngen^  means,  '  If  both  have
...
mitztUheilendes  Schattenbild  ihrer  Producte  oder  auch
Beuriheilungen  sein  sollen^  that  is,  *  which,  according
...
{wofern  uberall  nur  ein  speculativer  Beweis  statt  findet)
...
p.  586  (684),  ein  solches  Schemay  ah  oh  es  ein  wirkliches
...
every  presentation  (Vorstellung),  aa  belonging  either
...
messenen  Erhenntnisskraft  angevnesen,  mithin  auch  der
Einjiuss  der  letzteren  auf  jene  unterschieden  vrirdy  that
...
sonst  der  Vemunft^  aber  nur  nicht  hier  wol  anpassen.
...
anpasseriy  ie.  pulchre  convenire^  the  limitation  remain-
...
note,  vol.  L  p.  438),  folglich  die  Einheit  des  Bemusst-
seynSy  ah  synthetischy  aber  dock  ursprilnglich  ange-
troffen  vnrd,  he  means  to  convey  an  opposition  be-
...
ohne  diese  Tauglichkeii,  which  means,  'unless  the  cate-
gories were  adequate  for  that  pmpose,'  but  not,  *  if  the
...
sie  nicht  von  empirischem  Gehrauch  sein  sollen,  und
von  transcendentalem  nicht  sein  hiinnen.
...
p.  386)  die  der  rationalen  Psychologie  vorgeriickten
...
*  to  append/  Ur  erlauht  der  Vernunft  idealischen  Er-
kldrungen  der  Natur  nachzuhdngen  means  *  he  allows
reason  to  indulge  in  ideal  explanations  of  nature/
but  not  *  to  append  idealistic  explanations  of  natural
phenomena/

On  p.  669  (781),  ah  oh  er  die  hy'ahende  Parthei  er-
griffen  hdttey  does  not  mean  '  to  attack  the  position,'
...
a  translation  that  will  constrvs;  and  I  venture  to
say  that  even  to  a  German  student  of  Kant  this
English  traiislation  will  prove  in  many  places  more
...
tences in  Kants  Critique  which  I  have  not  been
...
of  the  most  ancient  languages  and  literaturea  But
...
philosophical  fiiends  in  England,  than  the  common
...
lialiener  miissen,  wenn  sie  vorwdrts  wollen^  denselben
Schritt  ihun,  den  Kant  schon  1781  mackte.  Nut  so
konnen  sie  sick  von  ihrer  dermaligen  schlechJten  Metor

translator's   preface.  XV

physik   und   den   aus   einer  solchen  swh  ergehenden
scJUechten  Consequenzen  lefreien.
...
the  last  century  in  almost  every  language  of  the  world  S
...
work  with  that  of  Copernicus^.  But  if  Kant  was  right
in  his  estimate  of  his  own  philosophy,  it  cannot  be

^  During  the  first  ten  years  after  the  appearance  of  the  Critiqae,
three  hundred  publications  have  been  counted  for  and  against
Kant's  philosophy.     See  Yaihinger,  Kommentar,  i.  p.  9.

'  See  Julius  Walter,  Zum  Gedachtniss  Kant's,  p.  a  8.
...
tions, philosophy  in  England  is  still  Ante-Copemican.
...
and  an  entrenched  groimd  on  the  onward  march  of
the  human  intellect.
...
book  that  is  a  hundred  years  old,  and  yet  as  youne
Md  fteA  as  ever.  ?  7      S
...
this  imdertaking  has  not  been  wasted,  others  also,
...
and  graceftdness  peculiar  to  Professor  Noird's  German
...
If,  then,  while  making  allowance  for  diflferences  of
...
'  Julius  Walter,  Zum  Gedachtniss  Kant's,  p.  27.

^  '  J'ai  lu  et  relu  avec  un  plaisir  infini  le  petit  traits  de  Kant
(Idee  zu  einer  allgemeinen  Geschichte  in  weltbtlrgerlicher  Absicht,
1784) ;  il  est  prodigieux  pour  T^poque,  et  m^me,  si  je  Tavais  connu
six  ou  sept  ans  plus  tot,  il  m'aurait  6pargn6  de  la  peine.  Je  suis
charm6  que  vous  Tayez  traduit,  il  pent  tr6s-efficacement  contribuer
i  preparer  les  esprits  k  la  philosophie  positive.  La  conception
gen^rale  ou  au  moins  la  m^thode  y  est  encore  m^taphysique,  mais
les  details  montrent  k  chaque  instant  I'esprit  positif.  J'avais  tou-
jours  regards  Kant  non-seulemeut  comme  une  tr^s-forte  t^te,  mais
comme  le  m^taphysicien  le  plus  rapproch6  de  la  philosophie  positive.
....  Pour  moi,  je  ne  me  trouve  jusqu'k  present,  apr^s  cette  lecture,
d'autre  valeur  que  celle  d*avoir  systematise  et  arr^te  la  conception
ebauch^e  par  Kant  a  mon  insu,  ce  que  je  dois  surtout  k  Tdducation
'  Bcientifique ;  et  m6me  le  pas  le  plus  positif  et  le  plus  distinct  que
j'ai  fait  apr^  lui,  me  seroble  seulement  d'avoir  d^couvert  la  loi  du
passage  des  id^es  humaines  par  les  trois  etats  th^ologique,  m^ta-
physique,  et  scientifique,  loi  qui  me  semble  Hre  la  base  du  travail
dont  Kant  a  conseilie  Tex^cution.  Je  rends  grace  aujourd'hui  k
mon  defaut  d'^rudition ;  car  si  mon  travail,  tel  qu'il  est  maintenant,
avait  ete  pr^c^de  chez  moi  par  T^tude  du  traits  de  Kant,  il  aurait,
k  mes  propres  yeux,  beaucoup  perdu  de  sa  valeur.'  See  Auguste
Comte,  par  i,.  Littr^,  Paris,  1864,  p.  154;  Lettre  de  Comte  k  M.
d'£ichthal,  10  D^c.  1824.

xxii  translator's  preface.

I  ventured  to  point  out  that,  as  fax  as  I  could
judge,  amid  the  varying  aspects  of  his  philosophical
writings,  Mr.  Herbert  Spencer  also,  hi  what  he  calls
...
b^ns  to  be  invoked  again  for  the  purpose  of  re-
...
of  philosophy.  Then  followed  the  so-called  Beal-
...
knowledge  consists  of  innate  ideas,  Ipng  in  the
...
fas  la  guerre.  Quite  true  it  is  that  but  for  Hume,
...
Professor  Noir^,  when  he  had  written  for  this
...
appreciate  Professor  Noir^'s  accurate  and  luminous
...
my  firiend,  I  shall  here  be  satisfied  with  pointing
...
Adamson,  On  the  Philosophy  of  Kant,  p.  202.  That  Blant  knew
Hume's  Treatise  an  Human  Nature  seems  to  follow  from  Hamann's
Metakritik  uber  den  Purismua  der  reinen  Vemunftf  p.  3,  note.
...
and  more  particularly  his  Critique  of  Pure  Beason,
...
Second  Series  of  my  Lectures  on  the  Science  of  Langiboge,  delivered
in  1867  (ed.  1880,  vol.  ii.  p.  612  seq.) ;  in  my  article  On  the  Origin
of  Reason,  Contemporary  Review^  February,  1878;  my  Lectures  on
Mr.  Darwin's  Philosophy  of  Language,  Fraaei's  Magazine^  May,
1873;  also  in  Professor  Noir^'s  works,  Der'Ursjyrung  der  Sprache,
1877;  and  Max  MiiUer  and  the  Philosophy  of  Language  (Long-
...
])rinciples,  has  been  fully  treated  in  my  Hilbert  Lectures^  1878,
pp.  30  seq.

translator's  preface.  xxix

remained  dormant.  *  Language/  Hamann  writes,  *  is
not  only  the  fomidation  for  the  whole  faculty  of
...
abstraction,  the  antitheses  t^?  y^euSwvvjjLov  yvda-eco^ ;
...
cUmbing  a  mountain,  the  very  roughness  of  the  road
becomes  an  attraction  to  the  traveller.  Besides,  though
Eant  is  a  bad '  builder,  he  is  not  a  bad  archi-
...
'  Gildemeister,  Hamaim's  Leben  und  Schriften,  vol.  iii.  p.  71.
...
nor  the  cimning  of  a  translator,  such  as  Jowett.
...
mind.     Only  let  us  not  imnecessarily  move  the  old
...
tions, definite  in  niunber,  carried  on  from  the  outer
...
*  See  NoW,  in  Die  Gegenwart,  June  23,  1881.
«  Critique,  p.  728  {848).

translator's  preii'ACE.  xxxiii
...
because  its  very  possibility  would  destroy  imity  of
experience  ^'

What  can  have  been  more  delightftd  to  the  un-
prejudiced  observer  than  the  gradual  diminution  of
the  Qnormous  number  of  what  were  called  by  students
...
before  Aristotle  forced  the  terms  yevo^  and  etSog  to
...
nothing  being  asserted  as  to  their  common  origiru
...
subject,  written  one  hundred  years  ago.  *  Reason  ^'
he  writes,  *  prepares  the  field  for  the  understanding,

'  1st.  Through  the  principle  of  homogeneousness  of
...
geneousness, of  specificaiion  and  of  continuity  of  forms/

And  with  reference  to  the  practical  application  of
these  metaphysical  principles  to  the  study  of  nature,  he
writes  again  with  true  philosophical  insight  ^i  *I  often
...
families,  races,  etc.,  wliile  others  insist  that  nature
...
as  revealing  the  intentions  of  natiu^,  particularly  as
...
friends  will  say.  *  You  speak  of  thoughts,'  they  wiU
...
'  Essai  sur  TOrigine  des  Connaissances  humaines,'
writes :  *  Soit  que  nous  nous  ^levions,  pour  parler
m^taphoriquement,  jusque  dans  les  cieux,  soit  que
nous  descendions  dans  les  ablmes,  nous  ne  sortons  pas
de  nous-mdmes  ;  et  ce  n'est  jamais  que  notre  pens^e
...
be  brought  back  to  the  broader  groimd  from  which
...
stiU  rooted  in  the  philosophy  of  the  last  century,
...
to  cost  him  the  whole  of  his  life,  says:  'The  fiinda-
...
able, and  its  beneficent  efiiects  will  bring  back  the
...
foundest  chapters  of  the  Critique  of  Pure  Reason,
in  forgetting  ourselves    and    thinking   really   with

xlii  TRAXSLATOR*S   PREFACE.

Kant  8  own  head,  thus  being  lifted  high  above  our-
...
which  everytliing  that  has  stirred  the  philosophical
...
when  he  says  (p.  1 20)  :  *  So  much  has  Kent's  fertile
...
possibly  Plato's  Eepublic,  Aristotle's  Metaphysics,
Spinoza's  Ethics — none,  if  we  consider  their  histing
eflTect,  their  penetrating  and  far-reaching  influence,
their  wealth  of  thought,  and  their  variety  of  sug-
gestions 2/

Nearly  the  same  judgment  is  repeated  by  Va-
eherot^,  who  speaks  of  the  Critique  as  *un  livre
...
'  Commentar  zu  Kant's  Kritik  der  reinen  Veruunft,  zura  Imn-
dertjahrigen  Jubilaum  dereelben,  lierausgegeben  von  Dr.  H.  Vai-
hinger.   Stuttgart,  1 88 1.

'  Zum  Jubilaum  von  Kant's  Kritik  der  reinen  Vernuuft,  von
H.  Yailiinger,  Separatabdruck  aus  der  ^Vochenschrift,  '  Im  neueu
...
(1641);  Newton,  Principia  philosophia^  natnralis  ma-
...
you  tcdste  your  time  on  a  translation  of  Kant's  Critik
der  reinen  VemunflV
...
in  fact  firom  an  imperfect  understanding  of  his  work
on  the  part  of  his  critics.  He  need  not  have  con-
descended to  show  that  he  was  as  weU-schooled  a
...
a^erated  charges  which  Schopenhauer  and  others
...
lie  says  ^  :  *  I  consider  the  loss  which  the  Second
...
with  the  second  improved  edition.  ...  It  is  not  suflB-
...
Ch.  J.  Krause  (or  Kraus)  could  never  suflSciently  ex-
...
matters,  the  same  in   1787  as  in  178 1.      The  active
...
tector, was  not  replaced  by  WoUner  as  minister  till
...
hearts  we  know  from  some  remarks  foimd  after  his
...
figured, and  coniipt,*  but  imputes  motives  utterly  at
...
dans  la  science,  ne  se  deploie  dans  toute  sa  plenitude  qiik  Tage  ou
Tactivit^  vitale  vient  a  s'afifaiblir/  E.  Saisset,  L'Ame  et  la  Vie,
p.  60.

tbanslatob's  pbefacb.  ifliy

ing  old,  if  not  to  gain  greater  confidence  in  our
opinions,  and  to  feel  justified  in  expressing  them  with
perfect  fireedomi  And  as  to.  *that  firmness  which
alone  enables  ns  to  despise  the  opinions  and  motives
of  our  contemporaries/  let  us  hope  that  that  is  neither
a  blessing  of  youth  nor  of  old  age.  Schopenhauer
personallj,  no  doubt,  had  a  right  to  complain  of  his
...
*  Eant  had  been  told,'  he  continues,  'that  his  system
was  only  a  rSchauffi  of  Berkeley's  Idealism.  This
...
logy. Add  to  this  that  the  great  king,  the  fi:iend
of  light  and  protector  of  truth,  had  just  died  (i  786).
...
Hie  first  chapter  of  the  Second  Book  of  the  Tran-
...
fiill  of  contradictiona  These  I  pointed  out  in  my
critique  of  Kant  (pp.  612-18),  because  at  that  time
(in  18 18)  I  had  never  seen  the  First  Edition,  in
...
evidently  of  its  insufficiency^  E^nt  has  tried  to  im-
...
cancelled.  This  appUes  particularly  to  the  whole  of'
...
Beason  has^  in  its  Second  Edition,  become  a  self-
...
Beason,  for  which  the  successors  of  Kant,  both  those
who  were  for  and  those  who  were  against  him,  have
blamed  each  other,  as  it  would  seem,  with  good
reason,  are  principally  due  to  the  so-caUed  improve-
ments, introduced  into  his  work  by  Elant's  own  hand.
...
his  unchanged  adherence  to  the  principles  of  Tmn-
soendental  Idealism^.  But  all  this  leaves  Kant's
...
'  See  Critique  of  Pure  Beason,  Supp.  XXVIL  p.  508.

teanslator's  preface.  liii
...
system  fix)m  his  First  Edition,  and  then  to  learn,  both
firom  the  additions  and  from  the  omissions  of  the
...
The  additions  of  the  Second  Edition  wiU  be  found
...
Critioal  Treatanent  of  the  Text  of  Kant's  Critique.
...
misprint.     Then  followed  the  Second, '  here  and  there
...
removing  a  nmnber  of  archaisms  which  often  perplex
...
,  Pure  Reason,  published  in  1 799,  there  is  a  long  list  of
...
be  the  work  of  Rink,  or  some  other  amanuensis  of
Kant.  Dr.  Vaihinger  has  shown  that  it  is  the  work
of  a  Professor  GriUo,  who,  in  the  Philosophische
Anzeiger,  a  Supplement  to  L.  H.  Jacob's  Anna-
len  der  Philosophie  und  des  philosophischen  Geistes,
...
^  See  Kehrbach,  Kritik  der  reinen  Yemunfl,  p.  yiii.
...
M  lltANSLATOR's  PRBJACB.

prononns  der,  die,  daSy  are  often  our  only  guide  in
...
nouns refer.  But  Eant  uses  several  nouns  in  a  gender
which  has  become  obsolete.  Thus  he  speaks  ^  of  der
Wachsthum,  der  Wohlgef  alien,  der  Gegentheil,  die  Hin-
derniss,  die  Bediirfmss,  die  Verhaltniss,  and  he  varies
even  between  die  and  das  Verhaltwiss,  die  and  das
ErTcenntnisSy  etc.,  so  that  even  the  genders  of  pro-
...
my  translation  deviated  so  much  from  the  textvs
receptvs  might  not  be  easily  perceived,  I  have  added
...
^  See  Erdmann,  p.  637.  '  See  Erdmann,  p.  660.

translator's  preface.  Ivii

oommmiicated  to  me  by  the  author,  will  give  the
fullest  infonnation  on  the  subject.
...
AntUheais  must  be  changed  into  Thesis.

Page  470  (545),  Noumenon  seems  preferable  to
Fhmnomen^m.

Page  420  (484),  we  must  read  Tc^ne,  instead  of  eine
Wahmehmung.

Page  295  (340),  wfe  must  keep  the  reading  of  the
First  Edition  transcendentcUen,  instead  of  transcenr
denteuj  as  printed  in  the  Second  ;  while  on  p.  578
(674),  transcendenien  may  be  retained,  though  cor-
rected into  transcendentoden  in  the  Corrigenda  of  the
Fifth  Edition.

On  p.  670  (781),  the  First  Edition  reads,  sind  also
keine  Frivaimeinungen,  Hartenstein  rightly  corrects
this  into  reine  Privatmeinungeny  i.  e.  they  are  mere
private  opinions.

Page  714  (832),  instead  of  ein  jeder  Theily  it  is
proposed  to  read  kein  Theil.  This  would  be  neces-
sary if  we  took  vermisst  werden  Tcann,  in  the  sense  of
can  he  spared^  while  if  we  take  it  in  the  sense  of  can
^  missed,  i.  e.  can  be  felt  to  be  absent,  the  reading  of
...
*^n  DritteSy  namlich  reinen  Gegenstand  hahen.  This
gives  no  sense^  because  Kant  never  speaks  of   a

M  lltANSLATOR's  PRBJACB.

proDonns  der^  die,  daSy  are  often  our  only  guide  in
discovering  to  what  substantive  these  pronouns  refer,
while  in  English,  where  the  distinction  of  gender
is  wanting  in  substantives,  it  is  often  absolutely
necessary  to  repeat  the  substantives  to  which  the  pro-
...
which  has  become  obsolete.  Thus  he  speaks  ^  of  der
Wachsthum,  der  Wohlgef  alien,  der  Gegentheil,  die  Hin-
derniss,  die  BedUrfniss,  die  Verhdltniss,  and  he  varies
even  between  die  and  das  Verhaltniss,  die  and  das
ErJcenntnisSy  etc.,  so  that  even  the  genders  of  pro-
nouns may  become  blind  guides.  The  same  applies
to  several  prepositions  which  Kant  construes  with
different  cases  from  what  would  be  sanctioned  by
modem  German  grammar  ^  Thus  ausser  with  him
...
Much  has  been  achieved  in  this  line,  and  con-
jectural .  alterations  have  been  made  by  recent
editors  of  Eant  of  which  a  Bentley  or  a  Lachmann
need  not  be  ashamed.  In  cases  where  these  emenda-
tions affected  the  meaning,  and  when  the  reasons  why
my  translation  deviated  so  much  from  the  textus
rec&ptus  might  not  be  easily  perceived,  I  have  added
the  emendations  adopted  by  me,  in  a  note.  Those
who  wish  for  fuller  information  on  these  points,  will
have  to  consult  Dr.  Vaihinger's  forthcoming  Com-
mentary, which,  to  judge  from  a  few  specimens  kindly
...
oommnnicated  to  me  by  the  author,  will  give  the
...
On  p.  382  (442)  the  reading  of  the  first  edition
AfUithesiB  must  be  changed  into  Thesis.
...
can  he  spared,  while  if  we  take  it  in  the  sense  of  can
he  missedf  i.  e.  can  be  felt  to  be  absent,  the  reading  of
the  First  Edition  ein  jeder  Theil  must  stand.  See  the
Preface  to  the  First  Edition,  p.  xx,  note  i .

On  p.  (138)  157,  the  First  Edition  reads,  Weil  sie
Icein  Drittes,  ndmlich  reinen  Gegenstand  hahen.  This
gives  no  sense^  because  Kant  never  speaks  of  a
...
warmth  and  splendour,  like  a  cloudless  sim  in  an
Eastern  sky.

And  now,  while  I  am  looking  at  the  last  lines  that
I  have  written,  it  may  be  th^  last  lines  that  I  shall
ever  write  on  Kant,  the  same  feeling  comes  over  me
which  I  expressed  in  ihe  Preface  to  the  last  volume
of  my  edition  of  the  Big- Veda  and  its  ancient  com-
mentary, I  feel  as  if  an  old  friend,  with  whom  I
have  had  many  commxmings  during  the  sunny  and
...
of  Pure  Beason,  may  seem  very  different,  and  yet  my
...
stammerings,  ail  aiming  to  express  what  cannot  be
...
aud  delight  generations  to  come.

And  while  ixi  the  Veda  we  may  study  the  child-
hood, we  may  study  in  Kant's  Critique  of  Pure
Beason  the  perfect  manhood  of  the  Aryan  mind.
...
within  reach  of  the  imderstanding — yet  real,  if  any-
...
in  that  simple  word,  I  ought,  as  mterpreted  by
Kant.

I  feel  I  have  done  but  little  for  my  two  friends,
far  less  than  they  have  done  for  me.  I  myself
have  leamt  from  the  Veda  all  that  I  cared  to  learn,
...
estabUsh  its  text  on  a  sound  basis,  and  to  render
...
I  myself  have  leamt  from  him  all  that  I  cared  to
...
Knowledge '  are  very  fer  from  being  identical.  If  our
conception  of  philosophy  includes  all  those  reflections
which  the  human  mind  has  at  difierent  times  in-
...
^  Die  PhiloBopbie  Herakleitos  des  Dunkeln,  i.  p.  xii.
VOL.   I.  B
...
these  terms :  ^  All  future  philosophy  must  he  a  philoso-
phy of  language/

Notwithstanding  this  obvious  confusion  of  terms,
I  have  chosen  the  above  words  of  LassaUe  as  a  motto
for  the  present  work,  first,  because  of  the  great  truth
which  ihey  do  contain,  and,  secondly,  because  of
...
ing or  belief,  we  m\ist  first  familiarise  ourselves  with
...
mankind,— reason,— towards  which  no  Darwmian  has
as  yet  succeeded  in  ihe  least  degree  in  establishing
...
the  Copemican  system.  Not  less  truly  it  has  been
...
PhUosophy  begins  when  men  first  begin  to  reflect
with  curiosity  about  themselves  and  the  world
aronnd  them ;  it  begins  therefore  when  primitive
...
of  mythology.  They  do  not  guess  that  it  is  then-
...
the  desired  explanation  from  the  world  and  m  the
world.
...
trace  in  broad  outline  the  coiuBe  which  has  been
...
gromids  upon  which  it  rests  will  not  become  ap-
...
philosophy  was  cosmology^  that  of  the  medisBval,
...
modem  tendency  /car  e^oxv^ — the  Ego  of  Descartes.
...
conditions  and  in  a  fresh  dii'ection.  The  doctrines  of
...
motion  do  to  the  calculations  of  Copernicus,  Gralileo,
...
it,  he  and  he  only  is  its  author  and  originator  ^Z

*  Prolegomena,  Preface.

'  Farerga  und  ParalipomeDa,  i.  144.
...
end  for  ever  of  all  mvstical  admixtures,  all  un-
...
and  the  logomachies  of  the  ^hool  which  have  already
...
'  Es  kann  die  Spar  von  meinen  Erdentageu
Nicht  in  iESonen  untergehn.'

lO  ANCIENT  PHILOSOPHY.

The  first  attempt  to  plaxje  the  One  at  the  summit
...
ception and  thought,  between  the  Phenomenon  and  th^
Noiimenon.  The  latter  alone  is  the  really  existing,  it
...
mena, must  therefore  be  reconcUed  or  corrected  by
...
in  Herakleitos ;  in  the  former  we  welcome  the  fijrst
glimpses  of  the  idea  of  substance,  of  the  principle  of
the  indestnictibihty  of  force,  as  well  as  of  the  sub-
...
ANCflENT  PHILOSOPHY.  II

achievements  of  Kant^  HeraJdeitos  too  was  seeking
...
was  the  6rst  to  prove  that  multiplicity  and  motion  were  impossible;
the  former  becaase  the  many  must  be  a  particular  number  over  and
...
first  the  half,  and  then  the  half  of  the  half,  and  so  on  cul  tn/mttuniy
...
bom,  as  we  are  accustomed  to  call  rivers  and  springs  the  same,
...
too  are  borne  aloug  in  equally  rapid  course."

'  Plut.  Plac.  Phil.  i.  23.  '  Adv.  Math.  vii.  129.

ANCIENT  PHILOSOPHY.  1 3
...
it  18  to  be  enkindled.     The  window  apertures  by
...
^dications  of  a  perception  that  the  criterion  of  truth
Daust  be   objective,   and    it   agrees  with   this   that
^erakleitos  is  said  to  have  called  our  ears  and  eyes
*^^^,  since  the  mere  sensible  appearance  of  things
^'^ays  deceives  us.     It  is  true  the  Logos  lies  in  the
^orld  without  (in  the  irepiexov^  and  our  own  being  is
^  far  estranged  from  the  world  to  furnish  in  itself
^^  central  starting-point  of  all  knowledge.
.    "Ajiother  truth  that  in  our  days  is  forcing  its  way
^^^o  daylight  is  foreshadowed   in  the  thought  ex-
P'^^^sed  by  Herakleitos — in  full  harmony  with  his
^^damental  principle — that  all  things  proceed  from
^^^,  and  will  be  turned  back  into  fire  at  last.     It
^^y  be   assumed  as   certain  that  the   philosopher
^^^^ved  at  this  truth  by  reflecting  upon  organic  life
...
'^ore  considerable  because   all  subsequent  systems

^^  either  to  attach  •  themselves  to  his  doctrine  or

^  deal  with  it  in  the  way  of  development  or  cor-

^tion,  in  some  cases  retaining  and   exaggerating

^^H,t    was   onensided    and    so    reaching    the    most

^^^^^cus  consequences,  and  in  others  endeavouring  to

^^Vice  this  element  to  its  due  proportion.

Supposing  the  general  estimate  of  the  Herakleitean
^^^^c  to  be  correct,  in  the  form  in  which  it  has  always
^^Xi  reproduced  by  later  writers, — namely,  that  no-
?  ^g  really  18,  but  rather  is  always  beginning  to
^     or  to  cease  to  be,  an  eternal  becoming,  a  middle

^  156  a.  '  De  Anim.  i.  2.

•  Fhys.  AuBcolt.  viii.  c.  3.
...
the  most  extreme  opinion  of  the  (^acrKovrfjov  ipaKXeirl-
^€iv,  or  *  the  professed  Herakleitizers.'
...
^  Plato,  Theatet.  152  E :  *Ek  dc  d^  (JHtpas  re  koL  Kuniaew  Koi  Kpda*»£
np6s  SKkfjXa  yiyvrrai  irdvra  6,  ^fj  <l)a/jL€y  cWi  ouk  ^p9ws  nposayoptvoirrtf'
t<m  yAw  yhp  ovdcfror*  ovbivy  aei  dc  yiyvtrai,  /cat  ir€p\  rovrov  fravrcs  i(^s  oi
(ro<f>o\  nkrip  Uappttvidov  ^fi<l>€pta'6oVf  npcoTay6pas  re  kclL  *HpaicXctror.

'  Metaph.  iii.  c.  5.

ANCIENT  PHILOSOPHY.  1 7
...
Herakleitos  had  silently  eflFected  that  correction.  All
...
^  De  Caelo,  iii.  1 :  0{  dc  r^  ficv  SKKa  irdvra  yimtrBcd  re  (fKun  zeal  pclv,
ctKU  dc  irayias  oMv,  tv  Zi  Ti  yAvov  ihrofJi^KeiK,  c(  ot  ravra  irdvra  ixiraaxtj-
liariCiaBai  vitfuvKH^  oirtp  ^oiKoai  PouXcoOcu  X^yciK  aXXot  rt  ytoXXoI  zeal
'HpoicXciTOff  6  *E<^c(rtoff.

*  The  passage  in  Plutarch  (De  EI  apud  Delph.  p.  388)  is  very
important  in  reference  to  this  view :  Uvp6£  r*  dyrafulpttrBai  ndmra  km
wvp  6narr»v,  &aw€p  xpvcov  xphi"'^^  "^^^  ;^pi;fuzr«>y  XP^^^^»  '  Everything
...
among  the  most  important  aj)ergiL8  transmitted  us  from  the  philo-
...
posite {evavTioTpoiral)  all  things  and  their  diflFerences,
...
accomplished  with  the  rpoTral  and  evavrtorpoTrai,  the

notwithstanding  that  it  forms,  as  I  shall  show  in  another  place,
the  hest  hridge  to  or  preparation  for  the  Kantian  truths,  and
...
ap.  Delph.  392  C:  Uvpbs  Bavaros  a€pi  yipitris  Koi  atpoi  Baporos  vdari
ytvicis.

ANCIENT  PHILOSOPHY.  1 9
...
sistible natural  impulse  in  its  strivings  after  imity.
...
was  impelled  to  assume  the  presence,  in  single  things,  of  a  qainta
esacrUia  over  and  above  the  others,  with  which  the  ingenuity  of  the
dbgtraeteurs  de  quintessence  might  have  free  scope  !
...
sary to  name  the  chemical  theories  of  Qrabam,  and  the  latest  con-
tnbutions  of  Crookes  and  Norman  Lockyer.  It  should  also  be
remembered  that  Schopenhauer  and  Bobert  Mayer,  so  long  ignored
...
that  all  phenomena  are  determined  hy  love  and  hate,
that  by  these  two  principles  all  things  are  formed
and  ejffected,  and  that  by  them  the  boundaries  of  the
whole  phenomenal  world  are  established  and  main-
tained. This  at  all  events  was  a  profound  aperfUy
...
latter  as  ein  gamer  Mann  ^.  Empedokles  does  in-
...
chatter  ^'  Neither  Sokrates  nor  Aristotle,  it  is  true,
were  edified  with  the  way  in  which  Anaxagoras  made
use  of  his  vovq  or  intelligent  principle.  The  latter
...
to  his  vou9^'  That  consciousness  plays  a  considerable
...
gence its  share  in  the  natiu-al  order.  It  was  reserved
...
*  Metaph.  i.  3.  p.  985.  *  Parerg.  L  p.  38.
...
differenc-es  take  the  place  of  the  varied,  uncertain,
inexpUcable  appearances  of  sense,  of  the  strange,
...
^  N<$/i^  yKvKv  Koi  pofit^  irucpov,  pofju^  BepfJLov,  v6fuo  ^Infxpov,  v6fiij^  XP^^4*  ^^
dc  oTOfia  Kal  K€v6p,  &n€p  vofilCirai  fiiv  ttvai  Koi  do^d^erai  ra  ala&rjrdf  ovk  ttrri
dc  Korh,  ahri$€tav  ravra,  ak\a  rh  cirofia  fi6vov  Koi  t6  K€v6v.  Sext.  £mpir.
...
ANCIENT  PHILOSOPHY.  25

were  often  named  together  in  antiquity  and  that
ia  opposition  to  each  other,  and  there  may  be  a
...
must  naturally  be  sought  in  the  ftindamental  prin-
...
diflferent  expression,  clearly  indicating  their  respec-
...
*  This  saying,'  observes  Lange  ^  '  which  in  principle

^  Clem.  Alex.  Strom.  V,  C.  14,  p.  711  Pott  :  Kd<r/ju)y  rhv  amhv  dnav-
TO>v  oCt€  Tis  B€S)V,  otTTC  dvBpontoy  inolrjatv.  aXX*  ^v  fcai  eoriv  wvp  dtl^wopf
dnrdfitpov  fitrpa  Koi  djrofrptvvvfifvov  fitrpa,
...
empiricism  and  to  indicate  its  proper  position  in  relar
tioh  to  philosophical  thought,  have  always  reverted
...
conversation,  according  to  RUmeUn,  to  repeat  again
...
empiricism.  But  a^  the  two  principles  are  after  all
...
diflferent  conception  of  the  atoms  from  that  of  Demo-
...
that  every  effect  must  be  preceded  by  a  cause,  as  tlie
...
world.     Tet  ancient  materialism  did  not  rise  to  a
...
Mathematics  were  still  too  immature,  and  the  cirde
of  experimental  knowledge  too  restricted.  We  must
wait  for  the  enimciation  of  this  truth  till  the  days
...
the  views  of  Demokrltos,  a  school  which  had  already
...
even  at  the  present  day,  wq  are  in  a  position  to  utter
...
truth  must  lead.  To  hira,  as  to  the  physicist,  to
...
imitation  of  the  relations  of  number  ^Z  In  other
...
^   Stob.  £cl.  i.  p.  302 :    Ilv6ay6pas  ovK  €*£  dpc^/Aov,  Kara  dc  dpi6ft6p
cXcyr  wapra  yiyv€a6ai,

*  Metaph.  i.  6  :   Mifi^ct  rk  Svra  <l>a<Av  ftvai  rcuf  apiBfimp.

'  Ibid.  i.  5  :  'ApX7>'  '^^  *ai  «*  vX^r  toU  ova-i^    ^ApiBfjAv  eiKii  rrfv  ov-
...
anticipated  the  Copemican  system.  Copernicus  him-
...
the  famous  dictum  of  Plato,  M^Selg  ayemjuierpiiTO^  eia-lra^
...
vii.  819):  *A11  freemen,  I  conceive,  should  learn  as
...
*  LaDge,  Qescfaichte  des  Matcrialismus,  i.  15.

•  Robert  Mayer,  Die  Mechunik  der  Warme,  p.  247.
...
all  sixicere  devotion  in  the  search  for  truth  and  in  the
inveBtigation  of  the  moral  principles  of  life,  until  at
last  a.n  all-destroying  scepticism,  a  dialectic  and  rhe-
...
Sokra.tes,  and  in  the  eighteenth  century,  Kant,
...
things  metaphysical,  and  the  speciahty  of  both  lies  in
...
lurttier  theoretical  preparation.  It  was  the  fate  of
both  to  have  immediate  successors  and  declared  dis-
oiplee,  who  nevertheless  departed  from  their  prin-
...
g^a.t  divergence  of  their  several  systems,  all  pro-
fesaed  themselves  to  be  derived  respectively  from  the
doctrine  of  Sokrates,  or  of  Kant.'

My  plan  only  allows  me  to  deal  with  the  theo-
'^t'^cal  side  of  the  Sokratic  philosophy,  and  that  of
^^  Buccessors,  in  order  to  show  wherein  the  opposition
^  the  earlier  doctrine  consists,  together  with  the
^^epening  of  philosophic  thought  and  its  increasing
^^dency  in  the  direction  of  what  is  the  principal
^tject  of  this  work.
...
reason  is  a  piinciple  that  may  be  opposed  to  the
...
truth,  amid  the  deceptions  of  the  senses,  a  film  and
...
vov9y  as  an  explanation  of  the  nature  of  the  world ;
...
•wliich  had  led  him  to  reject  the  means  of  flight  and
await  his  destinv  where  he  was  ^
...
motion,  there  is  no  reason  why  the  same  efiect  should
...
'  The  same  thought  has  been  expressed  by  Leibniz  where  he
says  one  might  explain  Caesar's  crossing  the  Rubicon  by  the  laws
of  mechanics,  contraction  of  muscles,  (kc,  whereas  to  the  true  un-
...
laws  of  all  movement,  or  there  is  nothing  reaUy
...
'.  ying  on  imaginary  rational  knowledge,  should  dabble
...
name  be  Aristotle  or  Hegel ^.'  This  is  an  outbreak
...
'  Geschiclite  des  Materialismus,  i.  p.  20.
...
ANCIENT  PHILOSOPHY.  4 1

All  tills  Aristotle  was  able  to  accomplish :  he
...
attempt  to  explain  the  development  of  design  by  the
...
cilable conceptions  M    And  yet  the  fallacy  here  in-

'  Still  plainer  and  more  startling  is  the  following  passage
(7oc.  cit.  i.  72)  about  the  materiulism  of  the  Stoics:  *  That
...
ligence, 6y  the  motion  of  matter  in  accordance  with  universal  laws.*
...
ANCIENT  PHILOSOPflT.  43

there  would  never  be  any  knowledge  at  all  ^  And
...
'  Und  was  in  schwankender  Erschcinuog  schwebt,
Befestiget  mit  dauemden  Gedanken/

Beason  and  its  conceptions  constitute  the  firm
...
Beason,  or  the  rational  principle  (to  vorjriKov),  is
...
was  to  he  thoroughly  estahlished  by  Kant.  'If  time  and  space
...
a«  an  effect.  In  other  words,  the  senses  are  stimulated
...
thought  and  a  j^erception  of  universals,  by  the  sole
constant  action  of  the  outer  world.  Perception  and
sensibility  then  remain,  notwithstanding  the  dis-
tinctly spiritual  (i.  e.  conscious)  chai*acter  of  their
...
^ith  one  another.'      *The  simple   sensations  which
^^ach  the  soul  through  the  body  are  given  at  birth
*o    men  and  animals  by  nature,  but  their  reflections
^^    these  and  on  their  relations  to  being  and  use  are
sIoAvly  and  hardly  gained,  if  they  are  ever  gained,
^y    education   and  long   experience.'     *No   one  can
^^ti^in   truth  who  fails  of  attaining  being,  and  he
^Oo  misses  the  truth  of  anything  can  have  no  know-
^^g®  of  that  thing ;  therefore  knowledge  does  not
^^^sist  in   impressions   of  sense,  but   in   reasoning
^t^out  them,  and  the  two  are  not  identical  •\'

Starting  from  this  newly-won  point  of  vantage,

^  Theatetus  (Jowett's  translation),  184.     ^  jb.  185.     «  lb.  186.

46  ANCIENT  PHILOSOPEnr.
...
*E8  ist  nicht  ciraussen,  da  Buclit  es  der  Thor,
...
the  soul,  to  which  pure  thought  belonged  as  it«
...
Phaedo  (10)  and  Timaeos.  The  summary  of  his  expo-
...
by  like.  Plato  has  used  this  argument  in  the  Timaeos
...
'  Adv.  Math.  viL  116,  119.     (See  also  Schopeuhauer's  Parerga,
i.  48.)

48  ANaENT   PHILOSOPHY.
...
versal, diflferent  both  from  material  things  and  from
...
as  an  established  fact  by  all  modem  philosophy,
...
*  TimsBOS,  27,  28  (Jowett's  Translation).
VOL.  I.  E
...
prehensive.  To  claim  all  ideas,  that  is  t«  say,  every-
thing  which  human  language  designates  bv  a  word,
...
a  difiBculty  which  presents  the  real  crux  of  modern
philosophy.  Platos  plan  was  to  allow  the  phe-
...
the  Dialogue^  when  Sok rates  makes  a  cautious  at-
...
patterns  existing  m  the  realm  of  being,  and  single
...
telHgence  by  a  miracle ;  and  this  latter  path  has
...
events  lay  always  in  something  moving,  L  e.  in  me-
...
Auictions,  with  general  truths  and  principlea  He
demands  a  prima  j>hilo8ophia  whence  everything  else
...
position to  frame  and  to  develope  tjiese  general
...
*  De  Anima,  i.  i.  '  Parerga,  i.  48.

AKCIENT  PHILOSOPHY.  55
...
by  the  reason,  the  to  t/  ^v  eivai,  which  makes  every-
...
{(rivoKov),  Rational  knowledge  apprehends  pure  form,
...
i.  e.  from  the  world-creating,  absolute  IntelUgence.
...
Stoics.  Keal  existence  is  always  material,  and  therefore,  Qod,
...
bached  a  certain  limit,  they  were  unable  to  proceed

further,  and  assumed  some  forms  of  thought  to  exist

^  priori^  and  to   be   incapable   of  further  solution,

^^ch  are  known  by  us  to  be  empirical,  i.  e.  capable

^f  historical  explanation.     But  the  Greeks  did  not

^^stin^ish  between  innate  and  a  priori^  they  took

.^  granted  the  rational  man  with  all  his  gifts,  and

^'^  not  dream  of  seeking  for  his  origin,  or  the  stages

lis  earlier  incomplete   development.      Epikuros

^*^^e,  whose  views  concerning  the  gradual  develop-
...
sensualistic,  whUe  the  nature  of  the  reason  was  not
...
came  into  existence  with  and  hy  language.  Greneral
...
telUgible  worlds,  the  worlds  of  feeling  and  of  matter.
...
of  the  human  feculty  of  representation  or  imagina-
...
through  its  period  of  deyelopment,  of  slow  and  con-
...
an  instrument   upon   whose   keys   (Le.  words)   the
tuman  mind  plays  with  marvellous  skill  so  as  to
bring  out  enchanting  harmonies.     This  power,  which
iiow  seems  to  call  for  such  astonished   admiration,
^rose  from  very  trifling  and  apparently  insignificant
b^nnings  :  from  the  circumstance  that  in  the  few
^d  unimportant  pursuits  which  were  carried  on  in
^mmon  by  primitive  groups  of  men,  certain  sounds
^^8ociated  themselves  with  the  action,  which   dif-
ferentiated themselves  and  gradually  acquired  the
P^wer  of  recalling  to  mind  these  actions  and  the
^^ible   image   of  their  phenomenal   effects.     The

6o  ANCIENT  PHILOSOPHY.

cries  thus  acquired  a  meaning^  and  so  became  the
germs  or  roots  whence  all  human  speech  has  been
regularly  developed,  notwitlistanding  all  diflferences
of  sound.
...
thing  under  diflferent  aspects.

A  spiritual  tradition  becomes  possible  through
wordsy  and  the  community  lives  a  common  spiritual
...
human  manufactiu-es  too,  such  as  tables  or  beds,  are
...
(jrapaSciyfjiaTa  ^),  after  which  the  actual  beds  and  tables
...
universal ia  ante  rem,  and  the  recollection  of  a  former

state  of  existence.     If  we  start,  as  Plato  does,  from

reason  as  an  ultimate  daturrty  as  an  original  property
...
lemains  how  the  men  of  to-day  have  become  familiar

"with  these  ideas ;  how  it  comes  that  they  are  now

really  creative  so  that  countless  objects  are  formed  in

accordance  with  them  ?     Certainlv  only  because  in

toe  dim  remotest  past,  the  thing  itself  and  the  idea

^f  it  were  formed  at  once  by  our  ancestors,  or  rather

developed  out  of  some  still  earlier  creation.     This

^ein^,  when  first  created  and  first  thought,  passes  by

tradition  into  the  thought  and  action  of  unnumbered

Parmenides,  132  (Jowett's  Translation).  *The  more  probable
^^  of  these  ideas  is  that  they  are  patterns  fixed  in  nature,  and
^  other  things  are  like  them  and  resemblances  of  them  ;  and  that
^*^t  is  meant  by  the  participation  of  other  things  in  the  ideas,  is
'^Uy  assimilation  to  them.'
...
forehead  the  tokens  of  its  origin.  ''YXtj  or  materia  is
...
is  its  forniy  which  is  the  second  most  essential  and
...
^iU,  they  only  grew  into  thoughts  and  conceptions
ty  the  sensible  perception  and  contemplation  of  what
^as  created.    They  were  thus  in  the  beginning  more
1^«<  rem,  and  afterwards  more  frequently  ante  rem.
J^  many  passages  of  Aristotle  we  see  clearly  how  the
"^e  germs  of  his  fundamental  principle  lay  in  this
^^consciousness  of  the  origin  of  human  reason  and
^^  properties  which  it  has  derived  from  its  origin.
■^^U8  especially  in  the  famous  passage  ^ :  *  But  the
^^1  may  be  compared  to  the  hand,  for  the  hand  is
^  tool  of  tools,  as  the  mind  is  the  form  of  forms.'
J^^Te  is  a  profound  reason  for  this  parallel  between
^^   land  which  shapes  all  things  and  the  mind  which
^^^  prehends  all  forms.     '  All  things  that  become,'  he

'  De  Anima,  ill.  8.

64  ANCIENT  PHILOSOPHY.

says  in  another  place,  *miist  become  something  as
...
It  has  still  to  he  observed  that  Aristotle,  as  he
...
^  Loc  cit.,  Acyo)  d*  ovcrlav  &/€V  vkrjs  t6  n  ^p  cfvac.

ANCIENT  PHILOSOPHY.  '     65

a  kind  oif  matter,  which  the  formative  human  mind
mJg-ht  modify  and  work  upon  at  will,  since  the  form
...
ejs  machina,  when  he  assumed  the  existence,  beyond
the  starry  spheres,  of  God  as  the  primus  motor ,  the
'KpSrrov  Kivovv  ctKivrrrovy  that  maintained  all  things  in
...
of  antiquity  had  soimded  the  problem  of  metaphysics
^  a  certain  depth,  though  they  were  still  far  from  the
really  final  question,  considering  that  one  assumed
^nose  fiinctions  of  the  reason  which  admit  of  histo-
...
^tional  thought,  and  believed  themselves  to  have
P^^etrated  its  inmost  nature,  and  so  to  have  drawn
*^k  the  veil  which  shrouded  the  mystery  of  being.
^^^y  took  man  for  granted,  and  after  his  image  made
*^e  world.

They  were  still  in  the  outer  court  of  metaphysics,
^^ch  laborious  effort  remained  before  a  mortal  could

^OL.  I.  F

66  ANCIENT  PHILOSOPHY.

dare  to  boast  of  having  penetrated  to  the  very  fsanc-
...
Ear  dp)(j  ^p  6  "KAyos  Koi  Btos  ^p  6  'K6yos*    navra  di    avrov  cyci^ro,  xai
;(0>pW  -avTOv  eytPtro  ovdi  fp, — Ev.  JOH.  i.  I.

The  dark  night  of  the  Middle  Ages  has  long  been

the  subject  of  fable.     There  is  no  word  of  scorn  or

contempt  which  ha«  not  been  hurled  at  the  philosophy
...
^loes  justice  to  both.     It  sees  that  each  generation

f^gins  its  progress  by  riding  on  the  shoulders  of  the

^st,  and  that  even  the  fiercest  opposition  directed

Against  the  pa«t  is  only  a  phase  of  its   continued

development.

And  accordingly  it  is  now  freely  admitted  that

^^ong    the    much-despised    Schoolmen    there    were

^'^  inkers  of  the  first  rank,  whose  names  may  be  set  by

^^^  side  of  the  most  brilliant  philosophers  of  ancient

^^  modem  times.    But  with  this  we  are  not  now  con-

^^^ned.     Every  age  should  be  measured  by  its  own

?*^^ndard.     The  human  mind  was  not,  as  has  been

^^gined,  asleep  during  the  thousand  years  of  medi-

^"^alism ;  still  less  was  it  sunk  in  the  rigidity  of  death.

t^ere  was  development,  albeit  the  slow  development
...
development  of  pliilosophy  as  the  thought  of  the
...
and  indispensable  link  between  ancient  and  modem
philosophy.
...
sprang,  characteristically,  fix)m  the  reaction  against
subjectivism.  The  Beautiful,  the  True,  the  Good,
are  something  realy  not  mere  thoughts  or  images  of
...
^fited  itself  to  the  minds  of  the  ancients.     Hence
^  their  art  too  aims  at  objective  creation.

All  the  philosophical   systems   of  antiquity  bear

^*^B  stamp  of  objectivity.     The  Godhead  is,  even  for

"*^to,  the  Demiurgos  by  whom  the  world  is  formed,

^^  for  Aristotle  the  first  motionless  mover  of  the

^t^eres.      The   enigmatic   metaphysical  conceptions

^ti  which  the  Middle  Ages  tormented  themselves

^^'Te    curtly   set    aside.     Time   is   in   Plato's   eyes

^^^utical  with  the  motion  of  the  sun  (x/ooi/o?  jJ  toS

^^^^voS  Kivfi<n9  or  rjXlou  KivricTii^  Tim.  37)-     And  in  the

le  way  he  identifies  space  with  matter.     Accord-

^^^  to  Aristotle,  space  is  something  like  a  vessel,
...
pliilosophy  we  see  the  two  tendencies  distinguish-
...
coimted  as  mortal  enemies  of  religion.  Hence  too
...
reasons  attainment  of  self-consciousness,  when  it
...
^  QaXrjs  t^fiBrj  novra  nXiipti  BfS>v  turn,  Arist.  de  Aniina,  L  5.

MEDIEVAL  PHILOSOPHY.  7 1
...
sciences,  Lange  is  right  in  saying^,  *  that  merely  to
...
Fpeak,  tangible  principle  was  itself  something  like
Columbus's  egg  in  the  natural  knowledge  of  an-
tiquity. All  the  divine  and  daemonic  gobh'n  array
...
^iBe  them  above  themselves,  bears  throughout  the

^  Qeschichte  dee  Materialismus,  i.  95.

72  MEDLEVAL  PHILOSOPHY.

stamp  of  this  character.  Notwithstanding  their  aflSnity
...
€<mv  6  Koa'juLo^)^  an  uninterrupted  causal  mechanism
...
as  "tlie  infinitude  of  space,  etc.,  always  contrives  to
stato  the  question  in  this  way :  *  Is  it  anythmg  Real
...
anitnum  vel  animam,  vimque  omnem  earn  qua  vel
aga-rnus  quid  vel  sentiamus  in  omnibus  corporibus  vivis
sequabiliter  esse  fusam/  etc.    (Cicero,  Tusc.  i.  lo.)

W'e  have  seen  that  the  most  various  forms  of
philosophy  are  possible  upon  the  foundation  of  ob-
jectivity. Materialism,  Idealism,  Realism  or  In-
div-icJualism,  Monism,  and  all  the  other  systems
kno^wn  to  us  in  later  philosophy,  grow  out  of  this
^J-  Their  significance  and  their  connection  with  the
concitnon  principle  of  their  foundation  only  appears
frocrx  the  fact  that  all  the  different  principles  set  up
^g**^^  in  possessing  the  character  of  reality:  Matter,
Ide^^^  Forms,  or  Individuals,  spiritualised  bodies,  etc.,
*o^^€  in  haying  only  a  real  existence.

Even  the  Scepticism  of  antiquity  does  not  escape
ironci^  this  mental  feshion.  When  it  brings  together  the
^^olusions  of  the  diflEerent  dogmatic  schools  and  says,
^  philosophical  wisdom  is  nought,  this  does  not
i^^^n  that  \he  reality  of  things  is  called  in  question,
but  Tather,  on  the  contrary,  that  man  should  content
bxnciBelf  with  realities  and  not  dream  of  reaching  a
Batiafactory  explanation   or  true  knowledge   of  the

74  MEDIEVAL  PHILOSOPHY.
...
a  decisive  bent  to  the  course  of  modem  philosophy.
...
^d  full  of  snares  and  temptations.     To  turn  away

from  the  world  and  its  seductions,  to  retire  into  one's

o^ni  heart,   penance  and  asceticism,  solitary   inter-

^Urse  with  God,  become  the  most  serious  of  duties.

The  renunciation  of  the  bright  realms  of  the
objective  world  naturally  leads  to  mystery  and
niysticism.  We  see  these  accordingly  co-operating
...
^f  all  things  in  God  as  the  source  of  all  enlighten-
°J^^t  and  the  resting  on  his  heart  as  the  sole  and
^^test  wisdom.

-Among  the  philosophic  systems  of  antiquity  there
^^^e  only  two  that  were  akin  to  the  new  doctrine
^^  allowed  themselves  to  be  interpreted  in  its
^^t:    these  were  the  Platonic  Idealism,  and  the
...
the  difierences  of  space.  Everything  has  proceeded
by  emanation  from  the  eternally  one;  but  by  sin
the  souls  have  fallen  into  the  ft^gmentaiy  condition
...
thence  to  imite  itself  in  direct  contemplation  with
...
^hich  can  hardly  be  given  than  the  mention  that
Plotinos  professed  to  be  ashamed  of  having  a  body
^d  would  never  say  from  what   parents   he  was
descended.
...
^'Jitable   channel   into   which   all   the   longing   and

f^piration  of  the  ages  poured  itself,  thus  determin-

^gr  the   whole  mental  development   of  succeeding

^^^erations.

Hiike  the  ancient  materialism.  Christian  mono-
^'^^ism  was  now  to  banish  the  daemons  and  magic
^*^ix)r8  of  the  natural  world,  which  was  thus  left
*^'^o,  a  region  no  longer  closed  by  fear  or  prejudice
^ff^inst  tranquil  investigation  or  aesthetic  contem-
plation. One  nature  served  the  one  God,  it  was  the
^^^k  of  his  hands.  *  It  is  a  notable  characteristic,*
^^8  A.  V.  Humboldt,  *  of  the  nature  poetry  of  the
*t shrews  that  by  a  reflection  of  the  national  mono-
...
heart,  in  recollection  of  spirit,  in  aspiration  afler
...
forced  laboriouslv  to  seek  out  the  architect  of  the
...
8eek  for  knowledge  in  nature  was  to  tread  the  old
daik  ways,  asking  wisdom  of  devils  instead  of  God.
...
monad  (fjLova^  ayyewfjro^)  has  given  birth  to  all  things.
He  is   the  Bythos  or  Abyssus  by  whom  the  con-
substantial  Silence  {a-iyii)  was  impregnated.     Hence
proceeded  Knowledge  {vouij  and  Truth,  and  these  four
compose  the  Pythagorean  Ter/ja/mJ?,  the  root  of  all
...
8o  MEDIEVAL  PHILOSOPHY.

beings  like  the  Pleroma,  the  ^^ons,  the  Hyle  or
...
God  we  only  know /row  him,  and  with  this,  which  is
...
young  ardour,  and  unbroken  energy,  TertuUian's
faith  should  have  exclaimed,  in  scorn  of  reason  and
all  the  wisdom  of  philosophy,  *  Credo  quia  absurdimi
...
80  there  can  be  but  one  God  to  rule  the  world.
*Deus  autem  qui  est  aetema  mens  ex  omni  utique
parte  perfectae  consummataeque  virtutis  est . . .  Deus
vero,  si  perfectus  est,  ut  esse  debet,  non  potest  esse
nisi  unus.'  (Lact.  Inst.  L  3.)

It  has   often  been   said,  that  the   great  idea  of

Descartes  upon  which  modern  philosophy  is  founded,

18  to  be  met  with  in  St.  Augustine,  who  appeals  to

the  certainty  of  self-consciousness   in  refutation  of

scepticism.    '  Tu  qui  vis  te  nosse,  scis  esse  te  ?    Scio.

TJnde  scis  ?    Nescio.    Moveri  te  scis'?    Nescio.    Cogi-

tare  te  scis  ?    Scio.'    (Sol.  il  i.)    And  again :  'Omnis

qui  se  dubitantem  intelligit,  verum  intelligit,  et  de

tac  re  quam  intelligit  certus  est.     Omnis  igitur  qui

Qtrum  sit  Veritas  dubitet,  in  se  ipso  habet  verum

^nde  non  dubitet,  nee  ilium  verum  nisi  veritate  verum

^t*     Non  itaque  oportet  eum  de  veritate  dubitare

9^i  potuit  undecumque  dubitare.'  (De  Vera  Rel.  73.)

■^oiabt  may  prevail  as  to  whether  our  souls  are  fire

^^    air,  but  it  is  impossible  for  men  to  doubt  that

ta^y  feel,  will,  think  and  judge,  for  doubt  itself  pre-

^^  Imposes  all  this.     The  soul  has  no  certain  know-

^^ge  except  that  of  itself:  *  Nihil  enim  tam  novit

^^118  quam  id  quod  sibi  prgesto  est,  nee  menti  magis

^y^dquam  praesto  est  quam  ipsa  sibi.'     (De  Trinit.

^"^^.  7.)      We  can  only  believe  in  the  existence  of

^^ternal  bodies,  and  we  depend  in  the  same  way

^tK)n  belief  as  to  the  temper,  character,  and  will  of

"VOL.  I.  G

82  MEDIEVAL  PHILOSOPHY.
...
consciousness,  and  recognised  it  as  the  foimdation
...
sequent modem  periods.    In  brief  and  notable  words
Augustine  expresses  this  thought,  as  at   once   the
mle  and  the  aim  of  all  spiritual  research  :  *  Deum  et
...
TheoBophy  take  the  place  of  the  ancient  ontology.
...
^visibly  in  every  part  of  the  body.     It  is  there-
|cre  a  special  spiritual  substance,  which  has  nothing
^  common  with  the  corporeal  natura     Questions
...
by  conditions  ^    Velleius  Paterculus  might  mnke  the

^  Thus,  according  to  Aristotle,  Sokrates  said  Ovk  i<l>*  TJfuv  ywoBai
t6  (nrovtaiovs  c&cu  fj  <l>av\ovs.  (Eth.  mag.  i.  9.)

MEDLEVAX  PHILOSOPHY.  85
...
Dunqnam  recte  fecit,  ut  facere  videretur,  sed  quia
alUerfdcere  non  poterat.'  (ii.  35.)  But  in  a  yet  higher
...
the  human  race  *  praedestinati  sunt  in  setemum  ignem
...
theology  (rara^aTi/ci})  and  a  negative,  abstract  one
(aTo^ariid?) :  the  first  descends  from  God  to  created
...
mcausale  et  insubstantiale !'  The  other  expedient —
that  God  created  men  free — has  been  shown  by  Scho-
penhauer in  many  passages  ^  to  be  a  case  of  *  wooden
...
Categories  are  properly  kinds  of  aflGu-mation.    Lange  ^
...
elenaents  in  our  conception  of  things,  which  became
^D  its  crassest  form  the  very  foundation  of  Scholas-
...
^Bs  who  began   to   distinguish    between  what   the
y^^entific   consciousness  was    always    inclined    to
identify.     But   Aristotle   did    not  get    beyond   the
^^^  imperfect  beginnings  of  such  a  distinction ;  and
^^actly  those  elements  in  his  Logic  and  Metaphysics,
^'^ch  in  consequence  of  this  were  most  perverse,
^^^'e  seized  upon  by  the  untutored  nations  of  the
^Bt  as  the  comer-stone  of  wisdom,  just  because  they

^  Geschichte  des  Materialismus,  i.  159.

90  MEDLEVAL  PHILOSOPHY.
...
distinction  is  the  ripest  fruit  of  modem  philosophy;
...
{to  oi/Tft)9  01/).  Logic,  dialectic,  and  the  rest  were  only
...
^  CfenuB,  dififerentia,  species,  proprium,  accidens.

MEDIEVAL  PHILOSOPHY.  QI
...
tive essays  of  a  healthy  vital  impulse  which  comparer
ideas  and  things,  and  can  therefore  proceed  to  dis-
iinguish  them.  On  this  untrodden  path  then  Erigena
...
guished the  a7ro^acri9  or  logical  negation  from  the

92  MEDIAEVAL  PHILOSOPHY.

a-Teprja-i^  OF  real  negation.  Here  the  problem  of  the
relation  between  thought  and  being  obtrudes  itself
already ;  and  this  important  question,  which  here  only
appears  in  the  form  of  an  aperpuy  will  meet  us  again
...
thing in  the  mtndy  and  that  no  other  starting-point
...
materialism  of  TertuUian's  views.

But  the  most  important  conception  which  me-
diaeval philosophy  was  to  originate  and  bequeath
to  modem  times,  was  that  of  the  concept  (con-
ceptus)  itself;  something  purely  intellectual,  an  object

MEDIEVAL  PHILOSOPHY.  93

bom  of  the  mind  itself,  which  nevertheless  has  mar-
...
*-80  highly  revered  as  an  authority — lent  to  Scholas-
