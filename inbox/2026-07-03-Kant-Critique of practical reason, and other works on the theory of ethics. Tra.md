---
source: "https://archive.org/details/critiquepractic00kantuoft"
title: "Critique of practical reason, and other works on the theory of ethics. Translated by Thomas Kingsmill Abbott with Memoir"
author: "Kant, Immanuel, 1724-1804"
year: "1889"
captured_at: "2026-07-03T19:47:28Z"
updated_at: "2026-07-03T19:47:28Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "カント"
query: "Critique of Practical Reason"
plain_text_url: "https://archive.org/download/critiquepractic00kantuoft/critiquepractic00kantuoft_djvu.txt"
public_domain: true
...
- 初版: 1889
- 情報源: [archive](https://archive.org/details/critiquepractic00kantuoft)
- パブリックドメイン: ✓
...
Second  Edition,  izmo,  $s.

TH-:    ELEMENTS  OF   LOGIC.

Our  A,   B,  C:

A  LECTURE  on  the  Origin  and  History  of  the
ALPHABET.
...
FELLOW    AND     TTTTOR    OF    TRINITY     COLLEGE,     DUBLIN
...
DUBLIN  :     PRINTED  AT  THE  UNIVERSITY  PRESS,  SY  PONSONBY  AND  WELDRICK
...
I.  A  complete  translation  of  the   Gnmdlegung  zur
Metaphysik  der  Bitten.     This  work  was  first  published
in  1785.
...
(rrenzen  der  Uossen  Vernunft^  otherwise  named  Philoso-

phische  Religionslehre.    This  portion  was  first  published

1  /.  e.   "  Religion,  so  far  as  it  lies  within  the  limits  of  Reason
...
Hebe  zu  lug  en  (1797):    WerJce,   ed.  Rosenkr.,  vol.  vii.?
...
were  translated  by  Mr.  Seniple  (Edinburgh,  1836  ;
...
Seniple  has  also  translated  (in  a  distinct  volume)  the
Religion  u.  s.  w.
...
slip,  if  not  a  printer's  error.  Slips  of  the  same  kind  are  frequent,  us
my  foot-notes  show.
...
the  gender  of  substantives.  His  use  of  uvor"  for
11  fur  "  has  been  generally  corrected  by  editors  :  where
...
Heteronpmy  of  the  Will  the  Source  of  all  Spurious  Principles

of  Morality, ib.

VTDlassification   of  all    Principles   of  Morality  which   can   be
...
CHAPTER  I.
Or  THE  PRINCIPLES  OF  PURE  PRACTICAL  REASON,     .        .        .        .105
...
(I
II.  Of  the  Right  of  Pure  Reason  in  its  Practical  Use
...
OF  THE  CONCEPT  OF  AN  OBJECT  OF  PURE  PRACTICAL  REASON,    .        .      1-18
Of  the  typic  of  the  Pure  Practical  Judgment,          .         .  1,39

CHAPTER  III.

OF  THE  MOTIVES  OF  PURE  PRACTICAL  REASON,        ....  k

Critical  Examination  of  the  Analytic  of  P. ire  Practical  Reason,  2

TABLE  OE.CONTENTS.  XI
...
CHAPTER  II.
Or  THE  DIALECTIC  OF  PURE  REASON  IN  DEFINING  THE  CONCEPTION  OF

THE  SUMMUJI  BONTJM, 206

n J  Antinomy  of  Practical  Reason, 209

Critical  Solution  of  the  Antinomy, 210
...
VIII.  Of  Eelief  from  a  Requirement  of  Pure  Reason,          .        .       240

*/X.  Of  the  Wise  Adaptation  of  Man's  Cognitive  Faculties  to
Hf  his  Practical  Destination, 244

PAET    SECOND.

THODOLOGY  OF  PURE  PRACTICAL  REASON, 249
...
INTRODUCTION  TO  THE  METAPHYSIC  OF  MORALS,         ....      1?65
...
I.  Of  the  Original  Capacity  for  Grood  in  Human  Nature,  .  332
...
II.  On  the  Saying,  "  Necessity  has  no  Law,"  .        .        .  {  65
...
through  her  devotion  to  a  friend.1  Kant  strongly  re
...
which  she  took  for  fever-spots  or  petechia),  her  imagination  was
...
distinction  in  this  field.  At  the  age  of  sixteen  Kant  lie,
...
day  had  lengthened  by  about  l|s  in  two  thousand
years.  According  to  Delaunay,  the  actual  amount  of
retardation  is  1s  in  200,000  years.  This  result  is  based
...
3  "Wright's  work  was  entitled,  An  Original  Theory ;  or,  a  Neio  Hypo
...
changes.  "  0  happy,"  he  exclaims,  tl  when  amid  the
...
p.  376.  Humboldt  erroneously  identifies  Kant's  view  of  the  nebula)
with  that  of  Lambert  and  Halley  :  Cosmos  (Sabine'stransl.),  vol.  iii..
p.  223.

MEMOIR   OF    KANT.  XX111
...
he  wrote  an  essay  011  the  volcanoes  in  the  moon,  with
...
1  In  1763  lie  repeated  the  substance  of  it  in  the  treatise,  Der  einzig
mogliche  Beweisgrund  zu  einer  Demonstration  des  Daseym  Gottes.  He-
...
to  Sommcr's  translation  of  Herschel :  "  On  the  Structure  of  the  Heavens."
...
reasons  which  he  gives)  lie  beyond  its  centre  of  figure  i1
...
the  sun,  and  hence  the  easting.2  Kant  showed  that
...
2  Philos.  Trans.,  vol.  xvi.     A  short  time  previously  one  Dr.  Lister
propounded  the  singular  theory  that  the  trade  winds  were  caused  hy
...
that  time.  It  had,  however,  been  stated  by  Greo.  Hadley  (not  "  Sex
tant "  Hadlcy)  in  1735  (Phil.  Trans.,  vol.  xxxix.,  pub.  1738).  But
Hartley's  paper  attracted  no  attention  ;  and  D'Alembert,  in  his  Reflec
...
space,  c.  g.  that  if  we  seek  all  the  paths  which  a  falling
...
Ids  hearers  should  not  have  to  listen  to  a  dry  exposi
...
l'this  summer,"  and  that  it  would  not  be  a  large
...
dence  happened  to  be  present  when  Ka^^jwhp^  syin-
patliizedjwith  the  Americans,  denounced  the  conduct
...
speak.  Suffice  it  to  say,  that  as  Locke's  attempt  to_
keep  the  mind  from  a  going  beyond  its  tether"  was
...
the  other  hand,  Locke  and  lleid,  whose  object  was,  like  Kant's,  to
...
The  Critique  of  Pure  Eeason  was  to  be  followed
...
1  Translated  by  Mr.  Bax,  in  Bonn's  Library,  1883.

MEMOIR  OF    KANT.  XXXV11
...
death,  contained  this  reflection :  a  To  deny  one's
...
11  as  his  Majesty's  most  loyal  subject,"  solemnly  en
...
in  detail,1  and  Metaph/jsical  Elements  of  Law.  After  the
...
1  Translated  by  Mr.  Sample.     Edinburgh,  1836.     Re-issued  1869.
...
2  An  interesting  account  of  "  The  Last  Days  of  Kant,"  taken  from
Wasianski,  may  be  found  in  De  Quinccy's  works,  vol.  iii.
...
engaged  on  the  Kritilc,  in  1771,  he  speaks  of  his
...
spring  regulated  the  tension.  That  he  might  not  be  l
...
tie  occasionally  found  it  necessary  to  change,  in  con
...
about  10  A.M.  ;  3rd,  Dinner  at  1  or  2  ;  4th,  Vesper  JBrod  ;  5th,  Abend
...
many  sins  on  his  heacw  the  unfortunate  madman  killed
a  child  instead.
...
any  further  questions ;  but  having1  to  treat  of  a  being
...
sonable  that  I  in  the  like  case  should  do  for  him."  J
...
1  Discourse  on  the  Attributes,  &c.     Ed.  1728,  p.  200.
...
law,  it  is  obvious  that  some  test  of  fitness  is  required,  j
...
universality  of  the  supposed  law,  Avhereas  the  Utili
...
that  we  are  subjects  of  a  higher  power?1  There  is,
...
juris  inter  decs  et  homines."     Dr.  Adams  (in  his  celebrated  sermon
...
Practical  Eeason  had  happiness  to  confer,  it  would
...
1  This  has  been  recognised  by  philosophers  of  all  periods  who  have
...
ness."  (Astronomy,  10th  ed.,  sec.  439.)  Dubois  Eeymond  makes  a
...
are  they,  as  Boethius  well  expresses  it,  propricz  libertati
...
freedom  without  the  law  of  Practical  Eeason  is  a
...
an  external  fulcrum,  a  TTOV  crrco.  Such  aid,  such
...
1  i  How  short  soever  their  knowledge  may  come  of  an
...
A  NOIENT  GREEK  PHILOSOPHY  was  divided  into
-£j-  three  sciences:  Physics,  Ethics,  and  Logic.  This  divi
...
Logic  cannot  have  any  empirical  part ;  that  is,  a  part  in  M
...
PREFACE   TO   THE    FUNDAMENTAL   PRINCIPLES  [4]

moral  philosophy,  on  the  contrary,  can  each  have  their  empi
rical  part,  since  the  former  has  to  determine  the  laws  ofjiature
...
Whately's  Loyic,  Appendix,  Art.  "Law."]
...
tions  of  (G)  pure  reason ;  and  although  any  other  precept  which
is  founded  on  principles  of  mere  experience  may  be  in  certain
respects  universal,  yet  in  as  far  as  it  «ests  even  in  the  least
...
cases  they  are  applicable,  and  on  the  other  to  procure  for  them  _
...
able  to  make  it  effective  in  concrefo  in  his  life.
...
[?]  OF    THE    METAPHYS1C   OF    MORALS.  5

_Jthat  it  conform  to  the  moral  law,  but  it  must  also  be  done  for
^  the  sake  of  the  kttv±_  otherwise  that  conformity  is  only  very  con
...
is  already  extant  in  the  propsedeutic  prefixed  by  the  celebrated
•  Wolf1  to  his  moral  philosophy,  namely,  his  so-called  general
...
PREFACE   TO   THE    FUNDAMENTAL    PRINCIPLES  s
...
pure  practical  reasVn  is  to  be  Complete,  it  must  be  possible  at
...
[l2]  OF    THE    MKTAPHYSIC    OF    MORALS.
...
NoTHiNG_canjpossibly  be  conceived  in  the  world,  or  even  out  of      6
...
10  FUNpAMENTAL    PRINCIPLES    OF    THE  [l3J
...
I  A  good  will  is  good  not  because  of  what  it  performs  or
effects,  not  by  its  aptness  for  the  attainment  of  some  proposed
lend,  but  simply  by  virtue  of  the  volition,  that  is,  it  is  good  in.
...
12    /  FUNDAMENTAL  PRINCIPLES  OF  THE  [ie]
...
w  For  as  reason  is  not  competent  to  guide  the  will  with  cer-
...
true  destination  must  be  to  prgfaicej&jicill,  notmerely  good  as
vft  a  weans  to  something  else,  but  goodwill  itself,  for  which  reason
|  was  absolutely  necessary.  This  will  then,  though  not  indeed
the  sole  and  complete  good,  must  be  the  supreme  good  and  the
condition  of  every  other,  even  of  the  desire  of  happiness.  (Tinder
...
of  a  good  will  as  its  highest  practical  dftst,inn.tinn)  n.nrl  in  n.ffa.ip-
ing  this  purpose  is  Capable  only  of  a  satisfaction  of  its  own

proper Jsind,  namely,  that  from  the  attainment  of  an  end,  which
end  again  is  determined  by  reason  only,  notwithstanding  that
this  may  involve  many  a  disappointment  to  the  ends  of  inclij
nation  (  IG).  f
...
on  this  account  the  often  anxious  care  which  most  men  take  foil

14  FUNDAMENTAL  PRINCIPLES  OF  THE  [l8J

it  has  no  intrinsic  worth,  and  their  maxim  has  no  moral  import.
They  preserve  their  life  ax  duty  requires,  no  doubt,  but  not
...
beneficent,  not  from  inclination,  but  from  du£y.
...
sion  at  least,  lie  has  [only]  not  sacrificed  the  enjoyment  of  the
...
cannot  be  ..comjnanded,  but  beneficence  for  duty's  sake  may ;
even  though  we  are  not  impelled  to  it  by  any  inclination — nay,
axe  even  repened_by_ajiatui'aLan-d.uncQnqiierab1ft  aversion,  This
...
The  second1  proposition  is  :  Thai^  jin  action  done  from  duty
derives  its  moral_worth,  not  from  the  purpose  which  is  to  be
attained  by  it,  but  frojn_J,he^ma^m^yjwhich  it  is  determined,
and  therefore  does  not  depend  on  the  realization  of  the  object  of
the  action,  but  merely  on  the  priM^dHL^fj^oliiion  by  which  the
...
regard  to  the  ends  which  can  be  attained  by  the  action.  JFor_
jthe  will  stands  between  its  d  priori  principle,  which  is  formal,
and  its_a  posteriori

roads,  and  as  it  must  be  determined  by  something,  it  follows
that  it  must  be  determined  Jiy  the.formal  prinoiple-of-  volition
Avhen  an  action  is  done  from  duty,  in  which  case  every  material
...
frojm~^sp£^fQr_i]i^Jaiv.  I  may  have  inclination  for  an  object
...
1  [The  first  proposition  was  that  to  have  moral  worth  an  action  must  ife
done  from  duty.]  \

;{22]  METAPHYSIC   OF    MORALS.  17

_ofjtself*  which  can  be  an  object  of  respect,  and  hence  a  com
...
and  we  have  not  to  wait  for  it  to  appear  first  in  the  result2  (22) .
...
could  also  icill  that  my  maxim  should  become  a  universal  laic.  Here
...
the  law  (of  honesty,  Sec.),  of  which  he  gives  us  an  example.  Since  we  also
...
20  FUNDAMENTAL    PRINCIPLES    OF    THE  [2o]
...
practical  judgment  has  over  the  ilieiiieJicaLin  the  common  un
...
method  may  be  found  in  Mr.  Semple's  translation  of  the  Metuphysic  of
Ethics,  p.  290.]
...
mark  as  any  philosopher  whatever  can  promise  himself.  Naj^
...
to  make  them  more  accordant  wi.th  our  wishes  and  inclinations,

22  FUNDAMENTAL  PRINCIPLES  OF  THE  [27J
...
whether  they  are  done  strictly  Jrorndutj/,  so  as  to  have  a  moral
...
imaxim  of  an  action,  however  right  in  itself,  rested  simply  on
...
I  am  willing  to  admit  out  of  love  of  humanity  that  even  mosfo
...
but  what  must  rest  simply  on  pure  reason,  independent  5»  all
...
/can  ha^e  only  from  experience)  ;  and,  if  this  is  not  so,  if  these
(principles  are  to  be  found  altogether  d  priori  free  from  every-
jthing  empirical,  in  pure  rational  concepts  only,  and  nowhere
telse,  not  even  in,  the  smallest  degree ;  then  rather  to  adopt  the
...
all  other  springs2  which  may  be  derived  from  the  field  of  expe
...
ton  properties  of  human  nature,  but  must  subsist  d  priori  of  themselves,
...
2  I  have  a  letter  from  the  late  excellent  Sulzer,  in  which  he  asks  me  what
...
28  FUNDAMENTAL   PRINCIPLES   OF    THE  |_35]
...
sophy,  i.  c.  as  metaphysic,  complete  in  itself  (a  thing-  which  in
...
empirical  (so) ,  and  as  it  must  measure  the  whole  extent  of  this
kind  of  rational  knowledge,  goes  as  far  as  ideal  conceptions,
i  where  even  examples  fail  us),  we  must  follow  and  clearly
jdescribe  the  practical  faculty  of  reason,  from  the  general  rules
...
recognised  as  objectively  necessary  are  subjectively  necessary4
also,  i.  e.  the  will  is  a  faculty  to  choose  that  only  which  reason
independent  oif  inclination  recognises  as  practically  necessary,
...
jective  conditions;  in  a  word,  if  the  will  does  not  in  /^^'com
...
tion  of  the  objective  laws  to  a  will  that  is  not  thoroughly  good  I
...
t1  The  dependence  of  the  desires  on  sensations  is  called  inclination,  and
his  accordingly  always  indicates  a  w ant.  The  dependence  of  a  contingently
...
of  good  (ss).  Therefore  no  imperatives  hold  for  the  Divine
...
with  the  law.  Therefore  imperatives  are  only  formulae  tov
...
goricalJy,  The  former  represent  the  practical  necessity  of  a
...
r  Whatever  is  possible  only  by  the  power  of  some  rational
...
be  called  prudence,1  in  the  narrowest  sense.  And  thus  the  im
...
It  concerns  not  the  matter  of  the  actionx  or  its  intended  result,
...
commands  (laivs)  of  morality.  For  it  is  law  only  that  involves
...
1  It  seems  to  me  that  the  proper  signification  of  the  word  pragmatic
...
counsels  (consilia)  than  precepts  (prcecepta)  of  reason,  that  the
...
makes  happy;  because  happiness  is  not  an  ideal  of  reason  butj
...
indeed  be  called p_rj,nf~ip.j£&  of  the  will  but  not  laws,  since  what
ever  is  only  necessary  for  the  attainment  of  some  arbitrary
purpose  may  be  considered  as  in  itself  contingent,  and  we  canj
...
I  liberty  to  choose  the  opposite ;  consequently  it  alone  carries  with

I  it  that  necessity  which  we  require  in  a  law.
...
profound  one  (40).  It  is  an  d  priori  synthetical  practical  propo
sition  j1  and  as  there  is  so  much  difficulty  in  discerning  the  pos-
...
being,  and  is  the  principle  on  which  it  ought Ao  act  that  is  an  imperative.
...
perfect  and  imperfect  duties.1  (45).
...
metapliysic  of  morals ;  so  that  I  give  it  here  only  as  an  arbitrary  one  (in
...
42  FUNDAMENTAL  PRINCIPLES  OF  THE  [52J
...
violate  strict  or  rigorous  (inflexible)  duty  (si)  ;  the  latter  only
...
tance  to  remember  that  we  must  not_allow_ou.rselyes  to  think  of
...
not  like  virtue  to  one  who  has  once  beheld  her  in  her  true  form.1
...
action  in  accordance  with  the  conception  of  certain  laics.  And  such
...
TThese,  therefore,  are  not  merely  subjective  ends  whose  existence
...
humanity,  whether  in  thine  otcn  person  or  in  that  of  any  other,  in
...
my  own  person  so  as  to  mutilate  him,  to  damage  or  kill  him  (53) .
...
in  our  own  person  as  an  end  in  itself,  it  must  'Iso  harmonise
with  it  (59).  Now  there  are  in  humanity  capa'xties  of  greater
...
ior  it  does  not  contain  the  principle  of  duties  to  oneself,  nor  of  the  duties  of
...
judge  who  punishes  him,  and  BO  on.
...
to  be  my  ends  also,  if  that  conception  is  to  have  its  full  eifect
with  me.
...
determining  anything  about  them ;  second!//,  because  it  does  not
...
In  fact  the  o?*3ctive  principle  of  all  practical  legislation  lies
(according  to  tfie  first  principle)  in  the  rule  and  its  form  of
...
physical  si/stem  of  nature,  and  that  based  on  the  universal  pre
...
(GI)  For  although  a  will  which  is  subject  to  fates  may  be
...
all  its  maxims  gives  universal  laivs1,  provided  it  be  otherwise
...
and  that  he  is  c-uly  bound  to  act  in  conformity  with  his  own
...
accordingly  reckon  as  Heteronomy  .l  .
...
beings  in  a  system  by  common  laws.     Now  since  it  is  by  laws  I
...
52  FUNDAMENTAL    PRINCIPLES    OF    THE  [54]

to  say,  we  can  conceive  a  kingdom  of  ends,  which  on  the  preced
ing  principles  is  possible.

(es)  For  all  rational  beings  come  under  the  law  that  each  of
...
54  FUNDAMENTAL    PRINCIPLES    OF   THE  \_66^
...
have  been  adduced  are  at  bottom  only  so  many  f  ormuloe  of  the
...
with  a  kingdom  of  nature2  (57).    There  is  a  progress  here  in  the
...
and  totalittj  of  the  system  of  these.     In  forming  our  moral
...
make  itself  a  universal  laic.     If,  however,  we  wish  to  gain  an
...
with  the  conception  of  a  will  unconditionally  good.  That  icill
...
1  [The  reading  "  Haxime,"  which  is  that  both  of  Rosenkranz  and  Har-
...
conceived,  not  as  an  end  to  be  effected,  but  as  an  independent///
...
above  all  mere  physical  beings,  that  he  must  always  take  his  (GQ)
maxims  from  the  point  of  view  which  regards  himself,  and  like
wise  every  other  rational  being,  as  lawgiviug  beings  (on  which
account  they  are  called  persons).  In  this  way  a  world  of
rational  beings  (mundus  intelligibiUs}  is  possible  as  a  kingdom
...
58  FUNDAMENTAL    PRINCIPLES   OF    THE  [7l]
...
practical  rule  is  an  imperative,  i.  <?.,  that  the  will  of  every  ra
...
60  FUNDAMENTAL  PRINCIPLES  OF  THE  [73J
...
1  [I  read  allgemeines  instead  of  allyemeinem."\

[7o]  METAPHYSIC    OF    MORALS.  61
...
agreeableness  that  a  thing  aifords,  whether  it  be  immediately  and  without
...
empty  and  indefinite,  and  consequently  useless  for  rinding  in
...
judgment)  (70).  But  what  interests  us  more  here  is  to  know  that
...
Row  such  a  synthetical  practical  a  priori  proposition  is  possible

64  FUNDAMENTAL    PRINCIPLES   OF    THE  [77J
...
THE  mil  is  a  kind  of  causality  belonging  to  living  beings  in  so
...
causes  determining  \i ;  just  as  physical  necessity  is  the  property
...
all  rational  beings  endowed  with  a  will.  INow  I  say  every,
...
in  itself  by  a  proof  theoretically  conclusive.1  Now  I  affirm  that,
...
point  of  view  be  ascribed  to  every  rational  being,  j  j
...
68  FUNDAMENTAL  PRINCIPLES    OF    THE  [sti]
...
also  hold  as  objective  (52),  that  is,  universal  principles,  and  so
...
(ss)  We  find  indeed  sometimes  that  we  can  take  an  interest1
...
freedom  (34)  we  think  ourselves  as  causes  efficient  a  priori,  and
...
knowledge  of  clearances,  never  to  that  of  things  in  themselves.
...
sensation  (so).  For  as  he  does  not  as  it  were  create  himself,
...
72  FUNDAMENTAL  PRINCIPLES   OF   THE  [S7]
...
dom  (s?),  and  that  consequently  we  could  assign  no  reason  at
all  for  this  law,  but  could  only  [present]1  it  as  a  petitio  principii
