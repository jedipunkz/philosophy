---
source: "https://archive.org/details/philosophyofkant00kantiala"
...
year: "1908"
captured_at: "2026-07-03T14:35:54Z"
updated_at: "2026-07-03T14:35:54Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "カント"
query: "Critique of Practical Reason"
plain_text_url: "https://archive.org/download/philosophyofkant00kantiala/philosophyofkant00kantiala_djvu.txt"
public_domain: true
...
- 初版: 1908
- 情報源: [archive](https://archive.org/details/philosophyofkant00kantiala)
- パブリックドメイン: ✓
...
KINGSTON,  CANADA,  AUTHOR  OP  "  AN  OUTLINE  OF  PHILOSOPHY,

"HEDONISTIC  THEORIES,"  ETC.
...
^publishers  to  the  Snibersitj).

LONDON    AND    NEW    YORK  :     MACMILLAN    AND    CO.

First  Edition  1888.
Reprinted,  1891,  1894,  1897,  1901,  1908.

OLA800W  :    PRINTED   AT  THE    UNIVERSITY   P]
BY    ROBERT   MACI-KH08E    AND  CO.    LTD,
...
Max  Miiller,  Dr.  Hutchison  Stirling,  Mr.  Mahaffy,  and
...
great  author,  it  may  be  said,  should  be  represented  w  all
...
Chapter  II. — The  Summum  Bonuin,  .  .  291
...
THIS  may  well  be  called  the  age  of  criticism,  a  criti-  yi  n
...
conflicts.     Dogmatism  at  first  held  despotic  sway ;  but  m
...
necessarily  implied  in  the  conception  that  he  had  himselt
...
xvi  In  metaphysical  speculations  it  has  always  been
...
xvii  rnain  at  rest.  Let  us  make  a  similar  experiment  in
...
Now  here  again  I  may  suppose,  either  \htf.\hz  conceptions

4  THE   PHILOSOPHY   OF    KANT.

through  which  I  effect  that  determination  conform  to  the
...
viii  expressed  in  a  priori  conceptions,  all  objects  of
...
first  estimate  of  the  a  priori  knowledge  of  reason,  that
...
xxvii  practical  aspect  I^et  us  suppose  that  the  necessary
...
xxxMimited  all  that  we  can  know  to  mere  phenomena.  I
...
The  term  a  priori  must,  however,  be  denned  more
...
THE  CRITIQUE   OF   PURE   REASON.  II
...
8  be  its  extent,  its  import  and  its  value.     But  the  fact  is,  4
...
parts,  although  these  may  be  of  a  totally  diiferent  nature.
...
ments  may  be  derived.  But  the  conception  of  a  cause
...
5.     The  principles  of  all  Theoretical  Sciences  of  reason
...
t6  perception.  The  propositions  of  arithmetic  are  therefore
...
i 8  action  and  reaction  are  always  equal.  Both  propositions,
...
19  6.      The  Problem,  of  Pure  Reason.
...
of  pure  reason  may  be  put  in  this  way — flow  are  a
...
pure  mathematics  possible  1     How  is  pure  physics  possible?

.„    As  these  sciences  actually  exist,  we  may  fairly  ask  how
they  are  possible ;    for  that  they   must  be   possible   is

21  proved   by  the  fact  that  they  exist.      But  as   no   real
...
:xist,  namely,  in  the  sense  that  there  is  in  man  a  natural
...
Houi  is  a  science  of  metaphysic  possible  1  Thus  a  criticism
...
27  This  transcendental  criticism  will  afford  a  complete  archi-  X3
...
\  5  firstly,  a  doctrine  of  the  elements,  secondly,  a  doctrine  of
...
THE   CRITIQUE   OF    PURE    REASON.  21
...
derived  from  the  general  conceptions  of  line  and  trianglo
...
(Z>)  Space  is  nothing  but  the  form  of  all  the  phenomena
...
whatever  is  possible  :  they  are  not  learned  from  experi-j)  .,
...
the  whole  body  of  a  priori  synthetic  propositions  in  4
...
(V)  Time  is  nothing  but  the  form  of  inner  sense,  that  is,
of  the  perception  of  ourselves  and  our  own  inner  state.
As  it  has  no  influence  on  the  shape  or  position  of  an
50  object,  time  cannot  be  a  determination  of  outer  pheno-
...
j  perception,  it  would  be  evident  that  time  is  itself  a
1  perception.

(c)  Time  is  the  formal  a  priori  condition  of  all  pheno-
j  mena  without  exception.     Space,  as  the  pure  form  of  all  34
I  external  phenomena,  is  the  a  priori  condition  only  of
^external  phenomena.       But   all   objects   of  perception.

TRANSCENDENTAL   AESTHETIC.  33
...
condition  of  inner  phenomena,  and  so  the  mediate  con-^J
...
Time  is  therefore  a  pjor^l^uj^^ye.cpn^jtion  of  human
...
i  tion  is,  in  the  strictest  sense  of  the  word,  objective,  and  is
...
59       8.    General  remarks  on  the  Transcendental  ^Esthetic.
...
it  is  derivative  (intuitus  derivativus)  and  not  original
...
problem  of  transcendental  philosophy  :  How  are  a  priority
synthetic  propositions  possible  1  Such  propositions  rest
...
vye  know  an  object  by  means  of  those  ideas.  In  the
...
pure  perception  contains  only  the   form   under  which  51
...
duces  ideas.  We  are  so  constituted  that  our  perception
...
or  capacities  can  do  the  work  of  the  other.  Under- y
...
874.    Division  of  Transcendental  Logic  into   Analytic  and  62
Dialectic.
...
v\      to  transcendental  logic  to  tell  us  how  t\\e  pure  synthesis  of

1^  ideas  is  brought  to  conceptions.     The  first  element  that
...
TRANSCENDENTAL   ANALYTIC.  5!

"'  a  third  element  is  supplied  by  understanding,  in  the
conceptions  which  give  unify  to  this  pure  synthesis,  and
...
JT6        CHAPTER  II. — DEDUCTION  OF  THE  CATEGORIES.       84

1 3.     Principles  of  a  Transcendental  Deduction.
THERE  is  a  distinction  in  law  between  the  question  of
right  (quid  juris)  and  the  question  of  fact  (quid  factf).
...
which  conceptions  can  relate  a  priori  to  objec-ts,  I  call  a    'i/J*^fa  ,  >
transcendental  deduction ;   and  from  it  I  distinguish  an

54  THE    PHILOSOPHY   OF    KANT.

empirical  deduction,  which  simply  tells  us  how  a  con-
...
\*ions,  which  contain  a  priori  the  condition  of  the  pos-
ibility  of  objects  as  phenomena,  and  therefore  synthesis
...
1     three-fold  synthesis  :  firstly,  the  apprehension  in  perception

.  of  various  ideas,  or  modifications  of  the  mind  ;  secondly,

their    reproduction   in   imagination ;    and,    thirdly,    their

,J  recognition  in  conception.     These  three  forms  of  synthesis

•All  that  comes  under  this  heading  is  taken  from  the  first  edition  of
...
point  to  three  sources  of  knowledge,  which  make  undei
...
knowledge  is,  therefore,  at  bottom  subject  to  time  as  the     \    v
...
consciousness  of  space  and  time  a  priori,  for  these  can  100
...
priori  principles.  CWe  must  then  assume  a  pure  tran-
...
There  can  be  no  knowledge  without  a  conception,  106
...
,Js  possible.  This  pure,  original,  unchangeable  conscious-
...
The  original  and  necessary  consciousness  of  the  identity       A
...
tne  categories,  as  it  appears  in  the  second  edition  of  the  "  Critique.*1
...
mus^  this  unity,  which  precedes  any  conception  of
...
133  together  in  one  universal  self-consciousness.     In  no  other
...
2  t/-  self-consciousness.  This  does  not  of  itself  involve  a
...
135  observing  their  combination.      All  combination  is   the
...
which  the  consciousness  of  self  should  at  the  same  time -4?' ^
...
Upon  the  nriginjij^gyTTfj^rjijgjj^^  Mndpr
...
perception,  not  having  the  act  of  apperception,  "  /  think"
...
s^..  of  certain  given  determinations  as  related  to  an  object
...
1 38  knowledge.  To  know  anything  spatial,  as,  for  instance  a
...
before  it  can  become  an  object  for  me  at  all.  Without  this
...
from  the  siibjedive  unity  of  consciousness,  which  is  a
...
are  necessarily  related  to  an  "/  think"  It  therefore
...
1  become  knowledge.  Now,  those  principles  are  all
...
ations can  come  together  in   one    Conscioustiess.
...
M7  lation  with  objects  of  sense.  Sensuous  perception  is  either
...
pe:  .eptions,  must  be  applied  to  empirical  perceptions.
...
contact  with  itJ  But  what  most  concerns  us  here,  is,

76  THE    PHILOSOPHY   OF    KANT.
...
objective  reality,  or  application  to  objects  that  can  be
...
figural  synthesis  (synthesis  spedosd),  to  distinguish  it  from
...
spontaneous  activity,  I  sometimes  call  it  productive  imagin-
...
leds^e  of  the  laws  by  which  the  combination  of  objects
...
apprehension  must  always  conform,  because  in  no  other  i
...
The  necessary  unity  of  space,  aid  of  external  sensuous
...
63  Categories  are  conceptions  which  a  priori  prescribe
laws  to  phenomena,  and  therefore  to  nature  as  the  sum
total  of  all  phenomena  (natura  matcrialiter  spectata}.
...
1 64  It  is  no  more  wonderful  that  the  laws  of  phenomena  in
...
that  is,  all  phenomena  of  nature,  must  depend  for  qpjn-^
bination  upon  the  categories.  In  the  categories,  there-
fore, nature  as  a  system  of  necessary  laws  (natura
formaliter  spectaia)  has  its  ground  and  origin.  Pure  \\
...
cannot  knoiv  an  object  so  thought  without  perceptions
...
which  all  theoretical  a  priori  knowledge  is  based,  are
...
J?2  pure  form  of  knowledge,  as  expressed  in  conceptions,  J33
judgments,  and   inferences,  and   from   this   analysis   to
derive  formal  rules  for  the  general  use  of  understanding.

!?4  The  business  of  transcendental  logic,  on  the  other  hand,  135
...
1 7  5  pure  conceptions  of  understanding,  but  it  is  able  also  to
...
used.  This  is  called  the  schematism  of  understanding.
...
So  ness  of  a  universal  process  of  imagination,  by  which  an
\  J  image  is  provided  for  a  conception,  is  what  I  call  the
schema  of  a  conception.

In  point  of  fact,  schemata,  and  not  images,  lie  at  the
W  foundation  of  our  pure  sensuous  conceptions.     No  image  H1
...
the  vanishing  point  ( =  o  =  ntgatio).  Hence,  there  is
...
200  guide.  Accordingly  we  find  that  all  the  principles  ofi6i
...
makes  possible  the  idea  of  the  whole.     I  cannot  hive
...
As  to  quantity  (quantitas),  that  is,  the  answer  to  the
...
number  1 2  can  be  produced  only  by  the  synthesis  of  5

206  with  it.     If  mere  numerical  formulas  like  this  are  to  be
...
reality  (realitas  phaenomcnori)  ;  that  which  corresponds  to
...
difference  between  any  two  of  which  is  always  iess  than
the  difference  between  the  given  sensation  and  zeio  or
...
tum of  gravity,  to  indicate  a  quantity,  the  apprehension  of  I(ty
...
in   a  phenomenon,    however  small  it  may   be,   has  an   J  o
...
217  The  quality  of  sensation — colour,  taste, etc., — is  always  175
...
sciousness generally.  In  the  inner  sense,  that  empirical  ^g
...
218  ing  the  intensive  magnitude  of  a  phenomenon,  we  may,
...
o  to  the  given  empirical  consciousness.    Thus,  while  all
...
219  The  three  modi  of  time  are  permanence,  succession,  and  1 7  7
...
221  phenomenon  may  be  so  determined  a  priori,  that  the  rule
...
be  generated  in  conformity  with  rules  of  a  matlie-
...
other An  analogy  of  experience  is,  there-  1 8
...
dogmata  or  mathcmata.     By  a  dogma  is  meant  a  synthetic
...
sion, which  are  the  sole  relations  in  time.  The  permanent  1 83
...
apt  to  lead  to  much  misapprehension,  and  it  is  more  precise  1 87
...
the  very  same  object.  ^\\  that  changes  is  permanent,
...
it,  and  continue  to  exist  up  to  the  mo.  >nt  of  its  origina-
...
experience  from  which  it  was  derived.  Having  no  \^r<-
a  priori  foundation,  but  resting  merely  on  induction,  V,  *"
...
Jl6  THE    PHILOSOPHY   OF    KANT.

clear,  but  lo  make  the  very  consciousness  of  an  object
...
ever, there  is  no_fixed  order  of  succession,  for  the  series
...
determined  in  the  object,  or,  more  exactly^here  is  in  our
...
could  no  longer  be  an  object  of  apprehension.
...
in  time,  but  only  its  determinations,  every  substance  must
...
substances  are  to  to  be  known  in  experience  as  co-exist-  \Y
...
local  community  (cotnmunio  spatii)  could  never  be  empiri-
...
/J  number  of  detached  observations ;  the  chain  of  empirical
...
connection,  are  members  of  a  systematic  whole  (compost 'turn
...
2£  4.  Postulates  of  all  Empirical  Thought.  2jg
...
21 1  priori  conceptions.     Now,  I  maintain  that  nothing  can  be
...
already  known ;  hence  necessity  of  existence  can  never  -«J
...
cannot  be  employed  asscrtorically  beyond  the  world  of
phenomena.  The  conception  of  a  noumenon  is,  there-

311  fore,  merely  the  conception  of  a  limit,  a  conception  which
...
esfe^blish  anything  positive  beyond  the  sphere  of  pheno-
...
3 1 2  before  it.  Such  an  understanding  would  not  know  its
...
that  the  peculiar  principle  of  reason  in  its  logical  sse  is
...
379  A  transcendental  conception  of  reason  is,  therefore,  322
...
unity  of  the  seiies  of  conditions  of  phenomena;  the  third,
the  absolute  unity  of  Hie  condition  of  all  objects  of  tJwught
whatever.
...
the  series  of  conditions  should  be  complete  is  satisfie
if  reason  can  only  present  to  the  understanding  a  priot
...
that  "  /  think  "  is  the  common  vehicle  of  all  conceptions,
...
.sens.e  is  called  body.  Accordingly,  the  very  term  1
...
the  soul  but  H&aJ^cs.fljqbie,  'Merced,  independently  of
all  experience,  from  the  conception  /  as  present  in
all  thought ;  that  is,  if  no  attempt  is  made  to  determine
c  ihevf]$n^:0ture$  as  a  particular  object  of  experience.

of  the   soul  necessarily

w<r

riCKi  &ny  particular  perception  of  my  own
i mingle  with  the  principles  of  the  science,  it
would  aO)  Conger  be  a  rational,  but  would  be  merely  an
...
all  conceptions.  This  7,  or  he,  or  it,  this  thing  that
...
406  Now,  as  the  proposition,  "  7  think?  taken  problem-  34&
