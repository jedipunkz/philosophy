---
source: "https://archive.org/details/in.ernet.dli.2015.247181"
title: "Human Understanding And Selections From A Treatise Of Human Nature"
author: "Hume David"
year: "1907"
captured_at: "2026-08-10T02:24:49Z"
updated_at: "2026-08-10T02:24:49Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "デイヴィッド・ヒューム"
query: "Hume A Treatise of Human Nature"
plain_text_url: "https://archive.org/download/in.ernet.dli.2015.247181/2015.247181.Human-Understanding_djvu.txt"
public_domain: true
...
- 著者: Hume David
- 初版: 1907
- 情報源: [archive](https://archive.org/details/in.ernet.dli.2015.247181)
- パブリックドメイン: ✓
...
LONDON AGENTS
Ktffan Pautt Tr0nrh, Triihti^r ^ Co., Lid.
...
From j b\ A. Rjm>a\ in the Gallery at Fdinhurgh.

PUBLISHERS’ PREFACE.

T he present volume is the second of the series of Phil-
...
Ramsay, whicii forms the frontispiece to the volume, render
...
him modem philosophy entered upon its Kantian phase, be-
...
•Alfred Weber, fUstory ef Phihiaf'ky. New York, 1896.

rUDLISHERS' PREFACE.

is the critical spirit, and positive kno\vlc<lge the goal at which
they aim I'o claim for Kant the sole honor of having
founded criticism is an error which a closer study of British
philosopliy tends to refute.”!
...
Treatise on Hiiinan Understanding, referred to in the
“Author’s Advertisement” to the Enquiry (page xxvili.,
this edition). In spite of Hume’s deprecatory reference to
the Treatise, it remains the complctest expression of his
...
few paragraphs of Section XIT, corresponds to these sections
nf the Treatise. They should be read before, or in place
...
TT IS difiScult for a man to speak long of himself
...
I was bom the twenty-sixth of April, 1711, old
...
My lather, who passed for a man of parts, died when
1 was an infant, leaving me, with an elder brother and
...
which I had too much neglected in n*.y early youth.
...
under iny care and direclion, for tlie state of his mind
anti hoaltli n tiuircd it. I lived with him a twelve-
inonih. My appointments during that time made a
considerable accession to my small forture. I then
receivetl an invitation from General St. Clair to attend
...
camp to the genera], along with Sir Harry Erskineand
...
ai first little more successful than the Treatise iin
Human Nature. On my return from Italy, I hail
the mortification to find all England in a ferment, on
account of Dr. Middleton’s Free Inquiry, while iny
...
In 1751, I removed from the countrj' to the town,
tlie true scene for a man of letters. In 1752 were
...
In 17521 the Paculty of Advocates chose me their
...
capacity, 1 expected proportional applause. But mis-
...
more mortifying, the hook seemed to sink into obliv-
...
was published the second volume of my histor}', con-
...
consider the Cnglish constitution before that period
...
pressions of public folly, and continued ver>' peaceably
...
thing formerly known in England ; 1 was become not
...
received, in 1763, an invitation from the carl of Hert-
...
more 1 was loaded with them. There is, however,
...
lord lieutenant of Ireland. I was chargd d’affaires till
...
declining. I returned to Edinburgh in T76q, very
...
in years, with the prospect of enjoying long my eascj
and of seeing the increase of my reputation.

In spring, 1775» ^ was struck with a disorder in
...
life than 1 am at present.

To conclude historically with my own character; i
1 am, or rather was, (for that is the style I must now
...
funeral oration of myself, but 1 hope it is not a mis-
...
JT is with a real, though a very melancholy pleasure,
...
self, as usual, with correcting his own works fora new
...
man, the beautiful French verses in which the Abb<5
...
weakened, and that appearances were in ma ny respects
...
have at least the satisfaction of leaving all j'our friends,
...
Diahgufs of the Dead^ among all the excuses which
...
little delaj'. I liave done every thing of consequence
...
friends, who came to see him, naturally madeconcern-
...
suitcil the weakness of his body. At his own desire,
...
liimself, of which the following is an extract :
...
to this tedious illness; but unluckily it has, in a creat
...
Three days alter, 1 received the following letter
from Dr. Black :
...
gotten friend j concerning whose philosophical opin-
...
Section 11. Of Scepticism with regard to the Senses
...
Most of the priociples, aod reasoniogs. contained in this vol-
ume,* were published in a work in three volumes, called A Trea-
tise of //liman A'aiure: A work which the Author had projected
...
t Volume II. of the posthumous edilton of Hume's work* published in
iTp and containinR. besides the present Enquiry, A Dittertatien on the Pat
"ont, and An Enquiry Concerning the PrincifUt o/Aforale, A reprint of (he
latter treatise has already appeared in the Reliidon of Science Library (No.
46), published by The Open Court Publisfalng Co.— Editor.

SECTION I.

OF THE DIFFERENT SPECIES OF PHILOSOPHY,

\ yf ORAL philosophy, or the science of human na-
...
us ftel the difference between vice and virtue ; they
...
i^lill push on their enquiries to principles more gen-
...
able, as well as justest fame, has been actjuired by the
...
Bruyire passes the seas, and still maintains his repu-
...
applicable to every exigence of human life. By q»eans
...
ular, either from the extent or scctirit}* of his acquisi-

HUMAN UNDERS TANDING.

5

tioDS. Man is a sociable, no less than a reasonable
being: But neither can he always enjoy company
agreeable and amusing, or preserve the proper relish
for them. Man is also an active being ; and froni
...
though at philosopher may live remote from business,
...
eye ; but to bring light from obscurit)', by whatever
...
either from the fruitless efforts of human vanity, virhich
...
industry, good fortune, or improved sagacity of sue
...
tiinately present to us, yet, whenever they become the
...
faculties, that these powers are distinct from eacli
...
AJV El^QUIRY COATCER/YING

difficuU for us, before, or even after, a careful trial,
...
cover to absurdity and error 1

SECTION II.

OF THE ORIGIN OF IDEAS.

L ivery one will readily allow, that there is a con-
j sidcr.Uile difference between the perceptions of
...
/fVM \ .\ I'XDLKS l AXDlXC. 13

disorders and agitations of the passion. When we
rertect on our past sentiments and affections, our
thought is a faithful mirror, and copies its objects
truly; but tlie colours which it employs are faint and
...
Here therefore we mav/ divide all .the perceptions
of the mind into two classes or species, which are dis-
tinguished by their different degrees of force and viva c-
ity . ) The less forcible and lively are commonly de-
nominated Thoughts or Idfas. The other species want
a name in our language, and in most others; I sup-
pose, because it was not requisite for any, but philos-
ophical purposes, to rank them un<ler a general term
or appellation. Let us, therefore, use a little freedom,
and call them Inipression s: employing that word in a
sense somewhat different from the usual. By the term
impression, then, 1 mean all our more lively percep-
tions, wherT we hear, or see, or feel, or love, or hate,
or desire, or will. And impressions are distinguished
from ideas, which are the less liv ely perceptions, of
which wc arc_cpascip^s, wlien w c refle ct on any of
...
transport us into tlje most distant regions of the uni-
verse ; or even beyond the universe, into tlie tin-
...
its, and that ail this creative power of the mind
...
ent ideas, and mountairtt with which we were

formerly acquainted. A virtuous horse we can con-
ceive j because, from our own feeling, we can conceive
...
our outward _or inward sentiment : the mixfur^'ajid
composition of thes^belongs alone to thejrnind and
will. Or, to express myself in philosophical language7
all our ideas or more feeble perceptions are copies of
our impressions or more lively ones.

To prove this, the two following argumen ts will,
I hope, be sufficient. Firs t, when we analyze our
thoughts or ideas, however compounded sublime,
...
this enquiry to what length wc please ; where we shall
...
Secondly. it_Jiappen, from a defect of the or-
gan, that a man is npt.sus^ptible of any. species of
iensation, we always^ find tliat he is as little suscept-
the correspondent ideas. A blind man can form
...
lias no notion of the relish of wine. And though there
...
which ma}' prove that it is not absolutely impossible
...
If UMAX UXDERS TA XD/XG.

19

particular shade, tliough it had never been convened
...
worth our observing, and docs not merit that for it
...
impre,*ioM; thougl, it matt be
caution no * 'er»n»i which they employed, were not chosen with such

no. Pw what I. meant by / Ifinnatc be equivalent to u.tur.1. then

20

/CA’QCVA'V COXCAAATAVG
...
ah tt.e perceptions and ideas of the mind must be allowed to be innate or
natural, in whatever sense we take the latter word, whether in opposition to
what is uncontmon, arti6cial, or miraculous. If by innate be meant, contem-
porary to our birth, the dispute seems to be frivolous ; nor is it worth while
to enquire at what time ihinkinK begins, whether before, at, or after our
birth. Again, the word seems to bo commonly taken in a very loose

sense, by Locks and others; as standing for any of our perceptions, our sen-
sations and passions, as well as thoughts. Now in this sense, 1 should desire
...
But admitting these terms, in,prttsi«nt and ideas, in the sense above e»
...
To be ingenuous, I must own it to bo my opinion, that Locke was bo
trayed into this question by the schoolmen, who, making use of andehned
...
gclher by some universal principle, which had an
equal influence on all mankind.

Though it be too obvious to escape observation,
that different ideas arc connected together; I do not
find that any philosopher lias attempted to enumerate
...
ideals, namely, Rf semb ianct, yn tjnie or place,

and .Cause or EJfect.

That these principles serve to connect ideas will
not, I believe, be much doubted. nictiy e naturally
leads our thoughts to the original:^ the mention of
one apart ment in a building naturally introduces an
enquiry or discourse concerning the others:® and if
we think of a wouji d, we can scarcely forbear reflect-
...
I Resemblance* S ContiKuiCy. ^Cause and effect.

4 For Instance, Contrast or Contrariety is also a connexion amon^ Ideas
blit it may, perhaps, bo considered as a mixture of Cau^ntiom and Retem-
Hfinct. Where two objects are contrary, the one destroys the other; that is,
the cause of Its aDnihilatico, and the idea of the annihilaiioD of an object
Implies the idea of iia former existence*
...
A ll tlic objects M human reason or enquiry may
. naturally be divided into two kinds, to wit, Jicla-
, tions o/lfdeas, and ^fall(rs of Fact. Of the first kind arc
tlie sciences of Geometry, Algebra, and Arithmetic ;
and in short, every affirmation which is either .intui-
tively or demonstratively certain. That the square of
~fhe hypothenuse is equal to the squares of the two siiles, is
...
Matters of fa ct, which are the second objects of
...
^I.V EXQUIRY CQXCERNIXG

SO conformable to reality. That the sun will not risi
to-morro7u is no less intelligible a proposition, and
...
and destroj'ing that implicit faith and security, which
...
be founded on the relation of ^use I5y
...
tlie inference would be entirely precarious. The hear- *
...
, knowle^e of cause an^effect.

T shall venture to affirm, as a general proposition.
^ which admits of no exception, that t he knowledg e of
this relation is not, in any instance, attained by rea-
spninj's,^ but ailFes enlircly from experience,

when we find that any particular oyects are constantly
...
from tho fluidity aiul transparency of water that it
...
citlter the causes which produced it, or the effects
whicli will arise from it ; nor can our reason, un-
assisted by experience, ever draw any inference con
cerning real existence and matter of fact.

This proposition, that causes attd effects are discover-
ablCy not by reason but by experience, will readily be ad-
...
rnr,\fAX uxoEfiSTAXD/xc.

2-1

pcarance in the world, which bear a close analogy to
...
wltere we consult not experience ; so must we also es-
teem the supposed tie or connexion between the cause
and effect, which binds them together, and renders it
impossible tliat any other effect could result from the
...
cause ? Ma>' not both these balls remain at absolute
...
“Oni^its caus^ It could not, therefore, be d iscov^j -ed
in the cause, and the first invention or conception of
Tf, dTpffori, must be entirely arbitrary. And even after
...
HUM AX l’XD/:RSTAXn/X(: 3 1

solution still gives rise to a new question as diflicult
as the foregoing, and leads us on to farther enquiries.
When it is asked, What is the 7iature of all our reason-
ings concerning matter of fact f the proper answer seems
...
What is the foundation of all conclusions from expertence?
...
the foundation. It is allowed on ail hands that there
...
knows of their nature. As to past £x^ertencef it can be
...
1 The word. Power, it here uted ia a loose and popular tense. The more
accorate explication of it would give additional evidence to this arcrument
See Sect. •j.

HUAfAN UXDERSTAXDIXC

33

pearance similar; this is the main question on wliich
...
but does it follow, that other bread must also nourisli
...
being the same, I hax>e found that such an object has a!'
ways been attended with such an effect, and J foresee, that
...
The connexion between these propos itions is no Tintu-
itiver Therels required a medium, which may enable
...
show tliat none of them can afford such an argument.
...
demonstrative argument or abstract reasoning^ priori.
...
objects, and by which we arc induced to expect effects
...
so like as eggs; jet no one, on account of this appear-
...
wise difierent from that single one ? This question 1
propose as mncli for the sake of information, as with
...
experiments, we inftr a connexion between the sensi-
...
argument this inference is founded ? Whe re is the me-
dium, the interposing ideas, which join proportions
...
the aid of experience ; contrary to the sentiment of ail
...
//UMAX UXDERS TA XD/XC

37

explained. When a man sa3‘s, / hav( found, in all past
instances, such sensible qualities conjoined with such secret
powers'. And when he says, Similar sensible qualities
will always be conjoined 'with similar secret powers, lie is
...
fess that the inference is not intuitive; neitlier is it
...
process of argument secures you against this stipposi
tion ? My practice, you say, refutes my doubts. But
you mistake the purport of my question. As an agent,
1 am quite satisfied in the point ; but as a philosopher,

^.V R.yQUIRY CONCERXmG
...
themselves in fruitless search upon any subject, it tnay
...
since I cannot now discover an argument whicli, it
...
T he passion for philosophy, like tliat for religion,
...
and its superstitious credulity. Ever)' passion is mor-
...
liis conjecture or reasoning concerning any matter of
...
ft UMAX ( 'XDh kSTAXDIXC.

•13

<hice5> tlie other ; nor is it, by any process of reasoning,
...
This principle is Cii&tQnX-Qr-Jlalji t • Fpr_^ylierevet,
...
understanding, we always say, tliat this propensity
is the effect of Qus/om . By employing that word, we-
...
clusions from experience. It is suflicient satisfaction,
...
assert that, after the constant conjunction of two ol)-
...
draws from considering one circle are the same wliich
...
every other body will move after a like impulse. A1
inferences from experience, therefore, are effects of
custom, not of reasoning.'

1 Nothing is more useful than for writers, even, oo moral, foUtical, or
subjects, to distinRuish between rrrtxoj* and exforUnce, and to sup.
pose, tb.U these species of arRuuientation are entirely different from each
other. The former are taken for the mere result of our intellectual faculties,
whjch.byconsidcrinK^/rxVr/thcnatureof things, and examining the effects,
th.n must follow from their operation, establish particular principles of sti-
. nee and philosophy. The hitter are supposed to be derived entirely fro/n
•ense and observation, by which we le.irn what has actually resulted fromtlie
■ peration of particular objects, and are thence able to infer, wlrnt will, f ir
.he future, result from them. Thus, for instance, the limitations and restraints
of civil government, and a legal constitution, m.ay be defended, either from
rtason, which reflecting on the great frailty and corruption of human nature
teaches, ih.n no man can safely be trusted with unlimited authority; or from
.xprrttnte and history, which inform us of the enormous abuses, that amti-

tion. In every age and country, has been found to make of so imprudent a
confiiicnce.

The same distinction between rc.asoo and experience is maintained in all
our deliberations concerning the conduct of life; while the experienetd
statesman, general, physician, or merchant is trusted and followed ; and the
mipra. tised novice, with whatever natural talents endowed, neglected and
ihspiscd. Though it be allowed, that reason may form very plausible
...
lo the maxims, derived from study and reflection.

But notwithstanding that this distinction bo thus universally received
both in the active speculative scenes of life, I shall not scruple to pronounce!
that it is, At boUom, erroneous, at least, superficial

If we examine those arguments, which, in any of the sciences above men-
tioned, are supposed to bo the mere effects of reasoning and reflecUon. they
will ho found to terminate, ni last, Iq some general principle or conclusion,
lor which wo can assign no reason but observ ation and experience. The only
difference between them and those maxims, which are vulgarly esteemed the
result of pure cxperienco. is, that the former cannot be established without
...
.n tho latter, the experienced event Is exactly and fully familiar to that which
we Iiifer ns the result of any particular situaUon. The history of a Tiberius
or a Nero makes us dread a like tyranny, were our monarchs freed from the
.estra.nts of laws and senates.- But the observation of any fraud or cruelly

f/U.SfAy UXDERSTAXDIXC.

45

Custom, then, is tlie great guide of liunian life. It
...
senses. We sliould never know how to adjust means
...
our conclusions from experience carry us beyond o\ir
...
the senses or memory, from wdneh we may first pro-
ceed in drawing these conclusions. A man, who should
find in a desert countrythe remains of pompous build-
ings, would conclude that the country had, in ancient

in private life is sufficient, with the sld of s little thoiiitht, to kWo us the same
apprehension; while it serves as an instance of the ttcneral corruption of
human Daturc, and shows os iho danger which we must incur hy reposiD^ aii
< fitiro confidence in mankind. In both cases, it is experience which is ulti-
mately the foundation of our iofcrcoce and conclusion.

There is no man so yountt and unexperienced, as not tohave formed, from
observation, many itcneral and just maziois concerninK human affairs an<l the
conduct of life; hi^t It must be confessed, that, when a man comes to put
these in practice, he will be extremely liable to error, till time and farther
experience both enlartte these maxims, and teach him their proper use and
application. In every situation or incident, there are many particular and
seemiogiy minute clrcumstaDces, which the man of greatest talent is, at first,
apt to overlook, though on them the jusiuess of his conclusions, and coose^
qoently the prudence of his conduct, entirely depend. Not to mention, that,
to a young beginner, the general observations and maxims occur not always
on ibo proper occasions, nor can be immediately applied with due calmness
and distinction. The truth Is, an unexperienced rcasoncr could be no reat
soner at all, were he absolutely unexperienced; and when we assign tba
...
limes, been cultivated t>y civilized inhabitants ; but
did nothing of this nature occur to him, he could never
forn\ such an inference. We learn the events of former
...
But as you cannot proceed after this manner, tn infini-
iHtHy you must at last terminate in some fact, which is
...
remote from the common theories of philosophy. _^1J -
belief of matter of fact or real existence is derived
merely 7rom some object,'^refehl to fhie' memory or
senses, and a customary conjunction b etween tliat a nd
some other object. Or in other words ; haying found
in many instances, that any two kinds of objects —
flame and heat, snow and cold — ^hayealways beenTcon-
joined tog^her ; if flame or snow be presented anew
to the senses, the mind i^cm^ied by ^usl o m to expert
heat or cold, and to bduve that s»r.b-a-/^ nalitv do es
exist, and will discover itself upon a nearer approach.

If UMAX UXnERUTAXDiyG.
...
passion of love, when we receive benefits; or hatretl,
when we meet with injuries. All these operations are
...
more accurately the nature of this and of the

customary conjunc/iortf whence it is derived. By this
...
48 A.V /:.VQL7fiy COXCE/^A7A'G

’.liar time and place, conceive them as existent, and
...
mind has authority over jiII its ideas, it could volun-
...
It follows, therefore, that the difference betweeu
ficiion and belUf lies in some sentiment or fe elin g,
which is annexed to the latter, not to the former, and
which depends not on the will, nor can be commanded
^}. P^^^sure. It must be excited by nature, like all
...
Were we to attempt a dtfinition of this sentiment,
we should, perhaps, 6nd it a ^ry difficult, if not an
...
imagination. Provided we agree about the tiling, it is
...
tion, and in their to the mind. I confess, that
...
is a term that every one sufficient!}' understands in
...
These ideas take faster hold of my mind than i Jeas of
...
attends the mere fic^ons of the imagination, an^
that this manner of conception arises from a customary
conjunction of the object with something present to

HUMAN V\DERSTAND/NG. 5 t

the memory or senses; 1 believe that it will not be
...
We have alieady observed that nature has estab-
...
three, namely, Rtsimblancfy Contiguity Causation -,
...
HUMAy Ui\’DERSTA.\Dli\’G

53

We may add force to these experiments by others
of a different kind, in considering the effects of co7tti^-
uiiy as well as of resemblance. It is certain that dis-
...
tion alone is not able to give a superior vivacity to an)
...
wntiguity. Superstitious people are fond of the rcl-
iques of saints and holy men, for the same reason , that
they seek after types or images, in order to enliven

« ‘ N.turane Dobii. Inquli. damm dicam, ao errore qnodam at cum ca
loca videamoi, la quibgs menioria di^caos virot acceperimus muliun. ‘

Scl^Xc.”

u( BOD tioa camt ai hit fn» • * »d»ODiUool» eat In loeiai

woe cauat as hia memoriae deducta ait diaciplioa/

C/etrtf dt FinHut. Lib. v.

5-1

HXQL'/Jf)' CO.VCERX/XG

their devotion, and Rive them a more intimate and
...
him by a sliorter chain of consequences than any of
...
tlent, that this object would instantly revive its corre-
...
influence of the picture supposes, that wc belUve our
friend to have once existed. Contiguity to home can
never excite our ideas of home, unless we believe that
it really exists. Now I assert, that tliis belief, where
...
tion of thought from the cause to the eflect piocfieds-
not from reason. It derives its origin altogether from

iru.\fAX uxDERSTAxnrxc

53

custonLand experience. And as ii first begins from an
...
cf the latter object ? But what is there in this whole
...
'”crsa, is so essential to the subsistence of all human
...
T hough there be no such thing as Chance in the
...
as this superiority encreascs, and surpasses the oppo-
site chances, the probability receives a proportionable
eocrease, and begets still a higher degree of belief or
...
probability would be much higher, and pur belief or
...
1 Mr. Locke divides all areumentt ioto decnonsirative and probable. In
ibit view« we must taj, that il is only probable all mco must die. or that the
suo will rite to-morrow* But to conform our lanituage more to common use,
we oocbi to divide ar^me&tt into ^nd

By proofs meanlnf tucb ericumeoit from experience tt leave no room for
doubt or oppotitlofi.

58

/t.y /;.\v/V/?j' ('oxc/ije.v/,v(;

rowly, it may, pcTliaps, afford matter (or curious spec-
ulation.
...
V r}' nature of chance, to render all the particular
events, comprehended in it, entirely equal. But find-
ing a greater number of sides concur in the one event
tlian in the other, the mind is carried more frequently
to that event, and meets it oftener, in revolving the
various possibilities or chances, on wliich the ultimate
...
//UMAN UNDE A’ S rA.VD/.W,

50

creature: Tlie production of motion by impulse and
...
imagination, beget that sentiment which we call beliefs
...
\ipon any of the received systems of philosophy, and
...
Euchd so simple, as not to consist of more parts, than
...
ment than either geometr)' or physics, we may con-
...
more obscure and uncertain, than those of poivtr^ forct,
ftifrgy or necessary connexion^ of which it Ts~eVery~hiom-
...
of our impressions, or, in other words, that insjmpps-
sible for us'tb/^/Wy^of any thing, which we have not an.t®-
cedentlyy<r//, eitl ter by our-^xtemal or i nternal sepsc s.
I have endeavoured* to explain and prove tliis propo-
...
ideas, that compose them. But when w'e have pushed
up definitions to the most simple ideas, and find still
some ambiguity and obscurity ; what resource arc w'e
...
greater certainty, let us search for it in all thesources,
from which it may possibly be derived.

When we look about us towards external objects,
and consider the operation of causes, we are nev er
able, in a single instance, to discover any power or
neces^ry connexion ; any quality, which binds the
effect to the'cause,~and renders the one an infallible
consequence of the other. We only find, that the.o^ne
^oes actually, in fact, follow the'other. The impulse
of one billiard-ball is attended ^th motion in the sec-
...
From the first appe^’ance of an object^ ^wejiexfiT-
...
operation ; because no bodie s ever disc over any powe r,
which c^ be. the original of this idea.*

"^STnee, therefore, external objects as they app ^rj^t
the senses, g|ve us no^idea of power or necessary ep n-!
ne^on, by their operation in part icular instance s, let!
...
1 Mr. Locke, io his chspicr c( power, says, that, 6Ddiog from eiporlenco,
that t K?fS~sro seyeral ne w p rodoctioos in matt er, and coDcludiog that them
mo st some where be a powe r capable of p roducing ibcA we arrivo at last hj
tbi srMso Ding ai rno idei ot power . But do reai6Hmg feao ever a i ^ a uT a jifi^
ofl gin aT, simple ldea:^s ibis philosopher LiaseU confesses* This, tbarefora^
pan never be the crif io of that Idea,
...
arc possessed of power. This idea, then, is an idea
...
Nve are every moment conscious. But the means, by
...
Jirsi \ is there any principle in all nature more
thaji_th fiu nion-o£^oul-. with hoH y- by which
...
HUMA.V CXDEHSTAXDINC.

67

beyond our comprehension. But if by consciousness
wc perceived any power or energy in the will, we must
...
will an influence over the tongue and fingers, nolover
...
liealth is conscious of power to actuate any member
...
/liV ENQUIRY CONCERNING

instructing us in the secret connexion, which binds
them together, and renders them inseparable.

Thirdly^ We learn from anatomy, thatjhe immedi-
ate object of power in voluntary motion, is not th^
member itself which is moved, but certai^ muscles,
...
or command of our will, w’e raise up a new idea, fix
the mind to the contemplation of it, turn it on all sides,
and at last dismiss it for some other idea, when %ve
think that we have surveyed it with sufficient accuracy ?
1 believe the same arguments will prove, that even
this command of the will gives us no real idea of force
or energy.

Ftrsij It must be allowed, that, when we know a
...
the naUire of Uie human soul and thej)ahire_of_an idea,
or the aptitude of the one to produce t!)C other? This
is a real creation; a production of something out of
nothing : Which implies a power so great, that it may

I It miy be prcicoded^ that the resistance which wc meet with in bodies,
obliRio^ os frcqacntly to ciert our force, and call up all our power, this gives
us the idea of force and power. It is this or strong endeavour, of which
we are consclons, that 1$ the original impression froiu which tJiis idea is cop-
ied. But, f 5 fH, we attribute power to a vast number of objects, where wc never
...
over its Ideas and limbs, In common thinking and motion, where the edcci
follows immediately upon the will, without any exertion or snmmooing up of
force ; to inanimate matter, which is not capable of this seotiment.

This sentiment of an endeavour to overcome resistance has 00 known coii-
iiexioD with any event x What follows it, we know by experience ; but could
not know it 6 It must, however, be confessed, that the animal

which we experience, though it can afford no accurate precise idea of power,
enters very much into that vulgar, inacrurate (dr.i, which is formed of it

70

E INQUIRY CONCERKING
...
tlie will : But the manner, in which this operation is
performed, the power by which it is produced, is en-
tirely beyond our comprehension.

Secondly, The command of the mind over itselUs
...
Thirdly, TJiis self-commaucLi.s yei:y_dififiteaLat-dif-

A man in health possesses more of it
...
potcnce of its Maker, if I may be allowed so to speak,
...
and is for ever infal]il)lc in its operation. They ac-
quire, by long habit, such a turn of mind, that, upon
the appearacc of the cause, they immediately expect
with assurance its usual attendant, and hardly con-
ceive it possible that any other event could result from
it. It is only on the discovery of extraordinary phac-
nomcna, such as earthquakes, pestilence, and prodi-
...
nature. But philosophers, who carry their scrutin}' a
1

72

A.V EKQUIRY CO^^CERNING

little farther, immediately perceive that, even in the
most familiar events, the energy of the cause is as un-
intelligible as in the most unusual, and that \ ye on ly
learn by experience the frequent Conjunction p/ objects,
...
pretend that those obje cts which are commonly denom-
inated causes, are in reality nothing but occasions
...
of saying that one billard-ball moves another b)' a force
...
to the same conclusion. They assert that tlie Deity
is tlie immediate cause of the union between soul and
...
.-tx KXQL'lRy COXCERXJXC

fiisi the fabric of the world with such perfect foresiglit
...
, Firsts it seems to me that this theory of the univer-
sal energy and operation of the Supreme Being is too
I bold ever to carry conviction with it to a man, suffici-
ently apprized of the weakness of human reason, and
y the narrow limits to which it is confined in all its oper-
...
that this fancied experience has no authority when Ave
...
meots on which this theory is founded. We are ig-
...
of the manner or force by wfuch a mind, even the su.
pfeme mind, operates either on itself or on body?
Whence, T beseech you, do we acquire any idea of it ?
...
1 I need not examine at Icni^th the rh inrrtiat wliich U so much talked ol
in tbc Dcw p()]losopby» and wbicb is ascribed to matter. We find by eipcrl •
tnce, that a body at rest or in motioD coDtioues for ever in its present state,
till put from it by some new cause ; and iJiai a body irr polled takes as much
motion from tlie impellioft body as It acquires itself. 'I ue$o aro facts. When
we call this a W/ we only mark these facts, without pretendiuK to

bare any Idea of the inert power; in the same tnaoDcr as, when we talk of
gravity, we mean certain effects, without comproliendiDg that active power.
It was never the roeaolog of Sta Isaac Newtoh to rob second causes of all
force or enerity* though some of his followers have eodcavourod to establish
that theory upon Ills authority# On the contrary, that great philosopher had
recourse to an etherial active fluid to explain bis universal attraction ; though
bo was so cautious and modtsi as to allow, that it was a mere hypothesis, not

7e AiV EXQU/RY COXCERXIXG
...
follow ing another, without being able to comprehend
...
10 be insisted on, without more eiperiments. I must confess, that there I’s
something In the fate of opinions n little extraordinary. Dbs Castes Insinu*
ated that doctrine of the universal and sole cflBcacy of tho Deity, without in*
sisting on it. Malebranchb and other Cartbsiams made it the foundation of
all their philosophy. It had, however, no authority in England. Locks,
...
It appears, then, that this idea of a necessary cpji.
nexion among events arises from a number, of similar
instances which occur of the constant conj[unctioiX. of
...
her of instances, different from every single instance,
...
exist. This connexion, therefore, which we fee/ in the
...
or impression from which we form tlie idea of power
...
not pronounce that the one event was but

only that it was conjoitifd with the other. After he has
...
experience, therefore, we may define a cause to be a/ij
objfciy followfd by another, and where alt the objects simi-
lar to the first are followed by objects similar to the seconds
Or in other words where, if the first object had not been,j
she second never had existed. The appearance of a cause
...
/l.v /•.VQ(V/^y COA^CE/fAVA'O

the cause of this particular sound. But what do we
mean by that affirmation ? We either mean Ma/
7'idration is follo7ved by this sounds and that alt similar
...
J According to these explications and definitions, the idea of foiver 1$ re*
lalive as much as that of ; and both have a reference to an effect, or

some other event constantly conjoined with the former. When we consider
ihe circumstance of an object, by which the degree or quantity of

its effect is fixed and determined, we cal) that its power : And accordingly,
...
As to the frequent use of the words. Force, Power, Energy, &c., which er*
ery where occur in common ccoversation, as well as in philosophy; that is
no proof, that we are acquainted, tn any instance, with the connecting princi*
pie between cause and effect, or can account uitimately (or the productionof
...
No animal can put external bodies in motion without the sentiment of a mum
or endeavour; and every animal has a senliment or feeling from the stroke
...
which ore exerted, without our anneiiog to them any idea of communicated
motion, we consider only the constant experienced conjunction of the events ;
and as we /ttl a customary connexion between the ideas, we transfer that
feeling to the objects; as nothing is more usual than to apply to external bodies
every interna) sensation, which they occasion.

HUMA!^ UNDERSTANDING.

Si

sioD, nor consequently can suggest any idea of power
...
I T might reasonably be expected in questions which
liave been canvassed and disputed with great eager-
...
impossible, if meq affix the same ideas to their terms,
that they could so long form different opinions of the
same subject ; especially when they communicate their

HCMAX i \\’DJ:./?STAXD/.y€.

views, and each party turn themselves on nil sides, in
search of arguments which may give them the victory
over tlieir antagonists. It is true, if men attempt the
discussion of questions which lie entirely beyond the
reach of human capacity, sucli as those concerning
the origin of worlds, or the economy of the intelU ctual
system or region of spirits, they may long beat the air
in their fruitless contests, and nc\cr arrive at an\ do*
...
markable a degree tliat, if I be not much mistaken,
...
nitions would immediately have put an enti to the
...
it is no wonder, if a sensible reader indulge his case
...
of llie controversy, and will not mucli disturb liis ease
by any intricate or obscure reasoning.

I hope, therefore, to make it appear that all men
liave ever agreed in the doctrine botli of necessity and

Ay ENQUIRY CONCERNING
...
therefore, form a just and precise idea of
...
Qur idea, therefore, of n ecessity and causation ar ises
I entirely from the uniformity observable injheo^era-

//UAfAN UNDERSTAXDIXG

«5

tions of nature, where similar objects are constantI\'
conjoined together, and the mind is determined l>)
^ustom to infer the one from the appearance of the
other. These two circumstances form the wliole of
...
ages, and Iiuman nature remains still ^le same,
...
English; You cannot l)e much mistaken in transfer-
...
Its cliief use is only to discover the constant and uni-
versal principles of human nature, by showing men in
all varieties of circumstances and situations, and fur-
nisliing us with materials from which we may form our
...
ral pliilosopher becomes acquainted with the nature
of plants, minerals, and other external objects, by the
experiments which he forms concerning them. Nor
arc the earth, water, and other elements, examined
by Aristotle, and Hippocrates, more like to those
which at present He under our observation than the
...
gery in historj', we cannot make use of a more convin-
cing argument, than to prove, that the actions ascribed
to any person arc directly contrary to the course of

I/UMAX CXDERSTAXDIXC

^7

nature, and tliat no liuman motives, in such circum-
stances, could ever induce liim to such a conduct.
...
ural force and activity, by which lie was able to resist
...
which wc could form of this kind irregular and anom-
alous, it were impossible to collect any general obser-
vations concerning mankind ; and no experience, how-
ever accurately digested by reflection, woiild ever
...
serve to direct our behaviour with regard to tlieni.
...
jx /ixoc/z^y coxc/:a‘x/xo

say lliat it does not commonly go right : But an artist
easily perceives that the same force in the spring or
p« lululum lias always the same influence on the wheels;
hut fails of its usual effect, pei^iaps hy reason of a
...
))articular cause ; the philosopher and physician are
...
which are altogether beyond o\ir comprehension ; That
...
//U.\fAy UXDEfiS TAXOJyC. 91

uncommon alacrity in his carriage: But he lias met
with a sudden piece of good fortune. Or even when
an action, as sometimes happens, cannot be particu
larly accounted for, cither by the person himself or by
...
'\ hus it appears, not only that the conjunction be-\
...
and has never been the subject of dispute, cither in
...
whence wo draw in/ertnets concerning them. But in
...
wlien he carries his goods to market, and offers them
...
as well as all the elements, are to contihue, in their
...
would become of hisfory, had we not a dependence on
...
And indeed, when we consider how aptly naturae
...
A^r E.yQCIKY COXCERNfNC

Cl rtainly from the constancy and fidelity of his gu&rds,
as from tlie operation of the axe or wheel. His mind
...
tlie objects present to the memor}- or senses, by a train
...
tilings; but their nature and their operation on the
...
isli; and I no more suspect this event than the fall-
ing of the house itself, which is new, and solidly built
and founded . — But he may haz>e been seized with a sud-
...
assurance, as tliat, if he throw himself out at the win-
dow, and meet with no obstruction, he will not remain

1/VMAX VXDERS TAXDIXG.
...
a feather, as that he will And it untouched an hour
...
and that the mind is carried, by a customary transitjjm^
...
own minds, and /(el no such connexion of the motive
...
j thought and intelligence. ^ But being once convinced
...
I may be more easily led to own the same necessity
...
subsequent inference of the mind from one to anothcr.
...
may, perhaps, find that it is with difficulty we arc in-
...
1 Tbo prevalence of tbe doctrine of liberty may be accoonted for* from
another cau$e* via. a faUe aeotation or aeeming eaperlence which we have.

98

/.V EXQUJRY CONCERNING
...
jirovc, that all mankind have ever agreed in the doc-
...
or may havc» of liberiy or indifference, in many of our actions* The necessity
of any action, whether of matter or of mind, is not, properly spcakingi a qual*
ity in the af;cnt. but in any thinking or inloUigent being, who may consider
the action; and it consists chiefly in the determination of his thoughts to
infer (he eaisteoce of that action from some preceding objects; as liberty,
when opposed to necessity, is nothing but the want of that determination,
and a certain looseness or indifference, which we fed. in passing, or not
passing, from the idea of one object to that of any succeeding one. Now wo
may observe, that, though, in rr/tfciing on human actions, wo seldom feel
...
agent; yet it frequently happens, chat, in tho actions Uremselves,

wc are sensible of something like it; And as all resembling objects are readily
taken for each other, this has been employed as a demonstrative and even
intuitive proof of human liberty. Wc feel, that our actions are subject to our
win, on most occasions; and Imagine we feel, that the will itself is subject
tu nothing, because, when by a denial of it we arc provoked to try, we feeh
that it moves easily every way, and produces an image of itself (or a VtlltMy*
...
been complected into the thing itself; because, should that be dented, we
find, upon a second trial, that, at present, it can. We consider not, that the
fantastical desire of shewing liberty, is here tho inolive of our actions. And
it seems certain, that, however we may imagine wo feet a liberty within our*
selves, a spectator can commonly infer our actions from our motives and
character; and even whore he cannot, he concludes to general, that ho might,
were he perfectly acquainted with every circumstance of our situation and
temper, and the roost secret springs of our complexion and disposition. Now
this is tho very essence of necessity, according to the foregoing doctrine.

HUMA.y UXDE/iSTAXD/iVG.

9 -)

plain and acknowledged matters of fact. Byjiberty, '
then, we can only mean a power of acting or nof acting,
according to the determinations of the will; that is, if we
choose to remain at rest, we may ; if we choose to
move, we also ma}'. Now this hypothetical liberty is
...
IThus.if acausebe that which ^redtictt any thing-, it Is easy to

observe that prcduting is synoDiiuous to earning. In like manner, if a cause
be deSiicd. that hy wkieh any thing exiUf, this Is liable to the same objec-
tion For what Is meant by these words, by which ? Had it been said, that a
cau« \%that thtTyN\,KhanythingconUaHt1yexuts% we should have under-
.lood the terms. For this is. indeed, all we know of the matter. And this
...
to the two dehnitions of cause^ of which it makes an
essential part. It consists either in the r(; ip<;fant
coqiunc tion^ of like objects , or injthe infere ncg^oi the
understandin g from one object to another. Now ne-
...
ma er. But this, it must be acknowledged, can be

morality or religion, whatever it
may be to natural philosophy or metaphysics. We

otLvl'ihe asserting that there is no idea

bLd7 Bu, i" 'he actions of

Se ^nd h ‘he actions

or.hoH ' ^ ‘Change no circumstance in the received

Brit *° ‘h® hut only in

hat with regard to material objects and causes. Noth-

”hf; S"'’ ■■

mm, !,*r ■"'1

ments, it ,s supposed as a fundamental principle that
mind, and both produce the good and prevent the

102

/IX ENQUIRY CONCERNING
...
principle in the mind, operates only by intervals, aiul
...
they can give rise cither to praise or blame, where
they proceed not from these principles, but are derived
altogether frem external violence.

] pretend not to have obviated or removed all ob-
...
causes, pre-ordained and prc-dctcrinincd, reaching
...
jri/AfA.V UXDERKTAXDIA’C.

105

are deduced cannot possibly be true, as being lialde
...
b_e traced up, by a necessary chain, to the Deity, they
...
we mu st retract the attribute of perfection, which we
^^ibe_to the Deity, and must acknowledge him to
...
wise agent, ^vithout giving entrance to greater ill, or
...
io6 AX F.XQIXRV COXCF.RXIXG

ity, goods to tlie universe; and that to an enlarged
view, wl)ich could comprehend the whole system of
...
IIUMAX UXDERSTANDIXC.

\cyj

and security of human society; as the characters which
excite blame are cliiefly such as tend to public detri-
...
siderable sum; does he And his vexation for the loss
anywise diminished by these sublime reflections? Wljy
...
the human mind: And these sentiments arc not to
...
and whatever system she embraces, she must And her-

loS A/\r ENQUIRY CONCERNING
...
S\. founded on a species of Analogy, which leads us
to expect from any cause the same events, which we
liave observed to result from similar causes. Where
...
tomical observations, formed upon one animal, arc,
...
we hnd, that the same theory is requisite to explain

1 to

y4Ar /CtVQCV/^V CO.^rCERNING
...
plin e a nd education on animals, who, by the prope r
application of rewards and punishme nts, may be tau ght
an y cou r^ of acdon, and most contrary to their natu-
...
not even experience, which makes him answ er to his
...
senses : ~ and that this inference is altpgetlxex founded
...
Secondly, I t is impossible, that this inference of the
...
be^ml^eaHty any arguments of this nature, they surely
...
without any exception or reserve. is cu stom alon e,
which engages animals, from every object».that-Sttikes
their senses, to infer its usual attendant, and^ca^rries
their imagination, from the appearance of the one, to
conceive the other, in that particular manner,' which
we denominate hflief. No other explication can be
...
) Since all reasonini;s concerning facts or causes is derived merely from
cusiomi it may be asked how it happens, that ineo so much surpass animals
in reasoning, and one man so much surpasses another? Has nol the same
...
foro)Uy of nature, we acquire a general habit, by which we always transfer
the known to the unknown, and conceive the latter to rcsemblo the former.
By means of this general habitual principle, wo regard even one experiment
...
а. Where there is a complication of causes to produce any effect, one
...
3. One man la able to carry on a chain of consequences to a greater
length than another,
...
S* The circumstance, on which the effect depends, is frequently Involved
...
б. The forming of general maxims from particular observation Is a very
...
7. When we reason from anatomies, the man. who has iho greater cape-
rience or the greater prooiptitude of suggesting analogies, will be the better
reasoner.

8. Hyasses from prejudice, education, passion, party. &€.. hang moic
upon one mind than another.

9. After wo have ac<)uired a ccn6dcnce in human testimony, books and
conversation enlarge much more tbe sphere of one marrs experience and
thought than those of another.

It would be easy to discover many other circumstances that make a dif-
ference to the undersUDdioga of men.
...
T here U, in Dr. Tillotson’s writings, an argument
...
tinent solicitations. 1 flatter myself, that I have dis-
...
he may happen, in the event, to And himself mistaken.
...
Some events arc found, in all countries and all ages,
...
dent, that wc ought not to make an exception to this
...
these, I say, discovered by exptriente to be qualities,
...
proof or ^ probabiliiy, according as the-conjunction be-
...
qiiently hesitate concerning the reports of others. ^Ve
...
these circumst«'inces. We entertain a suspicion con-
...
/ should not believe sueh a story were it told me by
CatOy was a proverbial saying in Rome, even during
...
The Indian prince, wlio refused to believe the first
...
I Plutarcli. in vita Catonis.

t No Indian, il if evident, could have experience that water did not freeze
io cold cUmatei. This if placing nature in a lituation quite unknown to hitu;
and it is impossible for him to tell a fri^ri what will result from it. It \%
making a new cipcrimeot. the consequence of which is always uncertain.
One may sometimes conjecture from analogy what will follow ; but still this
is but conjecture. And il must be confessed, that, in the present case of
freezing, the event follows contrary to the rules of analogy, and Is such as a
rational Indian would not look for. Tlio operations of cold upon water are
not gradual, according to the degrees of cold ; but whenever it conics to the
freezing point, the water passes in a moment, from the utmost liquidity tu
perfect hardness. Such an event, therefore, may be denontinated f.xtraordi-
and requires a pretty strong testimony, to render it credible to people
io a warm climate: Dut still it is not $»tiracuit>us^ nor contrary to uniform ex*
perience of the course of nature in cases where all the circumstances arc the
same. The Inhabitants of Sumatra have always seen water Aui<l in their own
climate« and the freezing of their rivers ought to be deemed a prodigy: Dut
...
here a direct and full proofs from the nature of the fact,
against the existence of any miracle; nor can such a

//C/AfAAT UNDERSTANOmC.
...
worthy of our attention), *That no testimony is sufli-
...
discover, 1 pronounce my decision, and always reject
the greater miracle. If the falsehood of his testimony
would be more miraculous, than the event which he

t Sometimes sd e^ent mzy noli in item to be contrary to the laws

of nature, and yeif It It were real, it tniitbi* by reason of sonic ctrcuin$taticcs«
be denominated a miracle; because, in it is contrary to these laws.

Thus if a person, claiming a divine authority, should command a sick person
to bo well, a healthful mao to fall down dead, the clouds lo pour rain, the
winds to blow, In abort, should order many natural events, which Inimcdiatcly
follow upon hia command ; these might justly bo esteeuicd miracles, because
they arc really, In this case, contrary to the laws of oaturo. For If any suspi-
cioD remain, that the evcoc and command concurred by accident, there is no
miracle and no transgression of the laws of nature. If this suspicion he re*
moved, there is evidently a miracle, and a transgression of these laws; be*
cause nothing can be more contrary tonature than that the voice orconimnnd
of a man should have such an influence. A miracle may be accurately defined,
a irantgrathn p/ a lawp/ nafurp a /urficu/ar vo/sO'pn p/ the Deity ^ or hy
the inier/ptitipn p/ Apptte invisible agent, A miracle may etiber be discoverable
by men or not. This alters not Its nature and essence. The raising of a
bouse or ship into the air Is a visible miracle. The raising of a feather, when
the wind wants ever so little of a force requisite for that purpose, is as real a
miracUi though not so sensible with regard to us.

122

A A' E.yQU/KY CONCERNING
...
of arguments, we ought to give the preference to sncli
...
in an ordinary degree; yet in advancing farther, tlie
mind obser\'es not always the same rule ; but wlien
...
Homan or Athenian audience, every Capuchin^ every
...
F or instance : There is no kind of report which rises
...
death, are never the eflect of those natural causes,
...
ing mysterious or supernatural in the case, b»it that
...
AM EXQVIRY CONCEKNTMG

1 26

the perusal of these wonderful Viistorians, that such
prodigious Ci'cnts nez'cr happen in our days. But it is
...
IIUMAS^ UXDEKSJAXD/NG.

T27

tiire among an ignorant people, that, even though the
...
It is true; Lucian, passing by cliance through Paph-
lagonia, had an opportunity of performing tliis good
...
r 28 A/\r ENQUIRY COA'CERN/NC

ancient Rome, of Turkey, of Siam, and of China
should, ail of them, be established on any solid foun-
...
give any reward, as the price of a lie. Utrumque^ gut
inierfuere^ nunc guoque tnemorani, postquam nullum men-
dado preiium. To which if we add the public nature
...
1 Hilt. Mb. ▼. cip. 9. Suiteolui rlv«i Diirly ih* iim* ■ccoonl it vU»
Vcip.

130

.4.V EXQUIRY COXCERXJXG

nal de Retz, which may well deserve our consideration.
When that intriguing politician fled into Spain, to
avoid the persecution of hisenemies, he passed through
...
tlie stump; and the cardinal assures us that he saw
liim with two legs. This miracle was vouched by all
...
tion of them was published and dispersed cveiy'whcre,
...
timony has the utmost force and authority m some
...
Ha for instance ; that therefore all kinds of testimony
must, in all cases, have equal force and authority?
Suppose that the Cassarean and Pompeian factions
...
est fiame ; because the materials are always prepared
for it. The avidum genus auricuiaruntf^ the gazing
...
themselves often at a loss to distinguish between triith
...
dation for any such sy'stem of religion.
...
plough, perhaps, it will be impossible to find any such
m all the records of history. Thus, suppose, all
...
I should not doubt of her pretended deatli, and of
...
which she could reap from so poor an artifice : Ail
this might astonish me ; but I would still replj’, that
the knavery and follj' of men are such common phe-
...
writers of natural magic or alchimj', or such authors,

If UMAX UXDERUTAXDIXC.

J37

who seem, all o( them, to have an unconquerable ap-
...
Christian Rrfi^ion, who have undertaken to defend it
by the principles of human reason. Our most holy
religion is founded on Faiths not on reason ; and it is
...
Pentalruch^ which we shall examine, according to the
...
and miracles. It gives an account of a state of tlie
...
I Nov. OrR. lib. n. apb. tg.

I iS A .V JiA'Q UTR Y COXCERKmG
...
that the Chrisiian Religion not only was at first attended
...
my memory as accurately as 1 can, in order to submit
...
tlic world; when mankind, being wholly illiterate,
...
HUM AX UXDERS TAXDIXC J ^ \

tlon of mankind between them ; the former claiming
...
Very well : Praj' proceed upon these suppositions.
...
HUMA.V UNDERSTANDING. i43

ficiently admire. I shall not examine the justness of
this argument. I shall allow it to be as solid as mj
antagonists and accusers can desire. It is sufBcient,
...
You then, who arc my accusers, have acknowledged,
...
argument drawn from effects to causes. F rom the
...
nature will justify. These arc your concessions. 1
...
the workman to be possessed of. The cau se must b e
proportioned to t he effect ; and if we exactly and pre-
...
HUMAN UNDLRSTANDINC. M5

we conclude these attributes to exist. The s\ipposition
...
descend downwards, to infer any new efiect from that
...
or, at least, without any foundation in reason j and
...
j 46 an exquiry concerning

preceded the present state of vice and misery, I hear
tliem with attention and with reverence. But when
...
plausible solutions of the ill phenomena. But still 1
...
reasoncr will ever presume to infer from it any single
