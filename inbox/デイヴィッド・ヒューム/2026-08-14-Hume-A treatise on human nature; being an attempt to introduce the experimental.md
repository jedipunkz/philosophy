---
source: "https://archive.org/details/treatiseonhumann01hume"
title: "A treatise on human nature; being an attempt to introduce the experimental method of reasoning into moral subjects; and dialogues concerning natural religion"
author: "Hume, David, 1711-1776, Green, Thomas Hill, 1836-1882, Grose, Thomas Hodge, 1845-1906"
year: "1874"
captured_at: "2026-08-14T07:51:59Z"
updated_at: "2026-08-14T07:51:59Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "デイヴィッド・ヒューム"
query: "Hume A Treatise of Human Nature"
plain_text_url: "https://archive.org/download/treatiseonhumann01hume/treatiseonhumann01hume_djvu.txt"
public_domain: true
...
- 著者: Hume, David, 1711-1776, Green, Thomas Hill, 1836-1882, Grose, Thomas Hodge, 1845-1906
- 初版: 1874
- 情報源: [archive](https://archive.org/details/treatiseonhumann01hume)
- パブリックドメイン: ✓
...
Gift  of  Winifred,. yferr en  Wilson
: __Caj.  »91
...
ATTEMPT  TO  INTRODUCE  THE   EXPERIMENTAL  METHOjD
OF  REASONING   INTO   MORAL  SUBJECTS

AND

I)IA].OGUES    CONCERNING   NATURAL   RELIGION

BY    DAVID    HUME

EDITED,    WITH    PUEUMINAUr    DISSERTATIONS    AND    NOTES,    BY

T.  H.  GREEN        and         T.  H.  GROSE

LATE  FELLOW  AND  TUTOR  OP  BALLIOL.  FELLOW  AND  TLTOR  OP  QUEE.V'S

COLLKUK,  OXKOUD  COLLEGE,  OXFOIID
...
First  printed  May  1874.    Reprinted  April  1878;
July  1882;  November  1886;  Jwwe  1890;  Jit^.y  1898.

Y.I

PEEFACE.

In  this  edition  we  have  sought  to  avoid  the  incon-
veniences which  are  apt  to  attend  commentaries  on
philosophical  writers,  by  the  plan  of  putting  together,  in
the  form  of  continuous  introductions,  such  explanation
and  criticism  as  we  had  to  offer,  and  confinmg  the  foot-
notes almost  entirely  to  references,  which  have  been
carefully  distinguished  from  Hume's  own  notes.  For  the
mtroductions  to  the  first  and  second  volumes  Mr.  Green
alone  is  responsible.  The  introduction  to  the  third  is
the  work  of  Mr.  Grose,  who  also  has  undertaken  the
revision  of  Hiune's  text.

Throughout  the  introductions  to  Volumes  I.  and  II.,
except  where  the  contrary  is  stated,  *Hume'  must  be
understood  to  mean  Hume  as  represented  by  the  '  Treatise
on  Human  Nature.'  In  taking  tins  as  intrinsically  the
best  representation  of  his  philosophy,  we  may  be  thought
to  have  overlooked  the  well-known  advertisement  which
(in  an  edition  posthumously  published)  he  prefixed  to
the  volume  containing  his  '  Inquiries  concerning  the
Human  Understanding  and  the  Principles  of  Morals.'  In
it,  after  stating  that  the  volume,  is  mainly  a  reproduction
of  what  he  had  previously  published  in  the  '  Treatise,'  he
expresses  a  hope  that  '  some  neghgences  in  his  former
reasoning,  and  more  in  the  expression,'  have  been  c.or-

BOSTON  UNIVERSITY  LIBRARIES

vi  PEEFACE.

rected,  and  desires  '  that  the  following  Pieces  may  alone
be  regarded  as  containing  his  philosophical  sentiments
and  principles.'  Was  not  Hume  himself  then,  it  may  be
asked,  the  best  judge  of  what  was  an  adequate  expression
of  his  thoughts,  and  is  there  not  an  unbecoming  assurance
in  disregarding  such  a  voice  from  his  tomb  ?

Our  answer  is  that  if  we  had  been  treating  of  Hume  as
a  great  literary  character,  or  exhibiting  the  history  of  his
individual  mind,  due  account  must  have  been  taken  of  it.
Such,  however,  has  not  been  the  object  which,  in  the
Introductions  to  Volumes  I.  and  II.,  we  have  presented  to
ourselves,  (See  Introd.  to  Vol.  I.  §  4.)  Our  concern
has  been  with  him  as  the  exponent  of  a  philosophical
system,  and  therefore  specially  with  that  statement  of  his
system  which  alone  purports  to  be  complete,  and  which
was  written  when  philosophy  was  still  his  chief  interest,
without  alloy  from  the  disappointment  of  literary  am-
bition.    Anyone  who  will  be  at  the  pains  to  read  the

*  Inquiries  '  alongside  of  the  original  '  Treatise  '  will  find
that  their  only  essential  difference  from  it  is  in  the  way  of
omission.     They  consist  in  the  main  of  excerpts  from  the

*  Treatise,'  re-written  in  a  lighter  style,  and  with  the  more
difficult  parts  of  it  left  out.  It  is  not  that  the  difficulties
which  logically  arise  out  of  Hume's  system  are  met,  but
that  the  passages  which  most  obviously  suggest  them  have
disappeared  without  anything  to  take  their  place.  Thus
in  the  '  Inquiry  concerning  the  Human  Understanding  '
there  is  nothing  whatever  corresponding  to  Parts  II.  and
IV.  of  the  first  Book  of  the  '  Treatise.'  The  effect  of  this
omission  on  a  hasty  reader  is,  no  doubt,  a  feeling  of  great
relief  Common-sense  is  no  longer  actively  repelled  by  a
doctrine  which  seems  to  undermine  the  real  world,  and

PEEFACE.  Vil

can  more  easily  put  a  construction  on  the  account  of  the
law  of  causation,  which  remains,  compatible  with  the
'  objective  validity '  of  the  law — such  a  construction  as  in
fact  forms  the  basis  of  Mr.  Mill's  Lome.  How  inconsistent
this  construction  is  with  the  principles  from  which  Hume
started,  and  which  he  never  gave  up  ;  how  impossible  it
would  be  to  anyone  who  had  assimilated  his  system  as
a  whole ;  how  close  is  the  organic  connection  between  all
the  parts  of  this  as  he  originally  conceived  it — we  must
trust  to  the  follomng  introductions  to  show.  (See,  in
particular,  Introd.  to  Vol.  I.  §§  301  and  321.)

The  only  discussion  in  the  '  Inquiry  concerning  Human
Understanding,'  to  which  nothing  in  his  earlier  publica-
tion corresponds,  is  that  on  Miracles.  On  the  relation  in
which  this  stands  to  his  general  theory  some  remarks
will  be  found  in  the  Introduction  to  Vol.  I.  (§  324,  note).
The  chief  variations,  other  than  in  the  way  of  omis-
sion, between  the  later  redaction  of  his  ethical  doctrine
and  the  earlier,  are  noticed  in  the  Introduction  to  Vol.  II.
(§§  31,  43,  and  46,  and  notes).
...
General  Introbuction 1

/'^TRODUCTION  TO  TREATISE  OF  IIUMAN  NaTUIUi/).           .           ,           .  305

BOOK  I.
OF  TEE   UNDERSTANDING.

PART  I.

OF   IDEAS,  THEIR   ORIGIN,  COMPOSITION,  ABSTRACTION,
CONNEXION,  ETC.

SECT.  PACK

I.  Of  tlie  Origin  of  our  Idecos 311

11.  Division  of  the  Subject 316

III.  Of  the  Ideas  of  the  Memory  and  Imagination          .         .         .  317
...
I.  Of  the  Infinite  Divisibility  of  our  Ideas  of  Space  and  Time  .       334

II.  Of  the  Infinite  Divisibility  of  Space  and  Time     .         .         .  336

III.  Of  the  other  Qualities  of  our  Ideas  of  Space  and  Time    .  .      340

IV.  Objections  answer'd     ........  345

X

CONTENTS   OF  TIIE  FIKST  VOLmiE
...
OP  THE  SCEPTICAL  AND  OTHER  SYSTEMS  OP  PHILOSOPHY.

SECT.  PAGE

I.  Of  Scepticism  with  regard  to  Reason 472

II.  Of  Scepticism  with  regard  to  the  Senses         .         .         .         «  478

in.  Of  the  Antient  Philosophy 605

IV.  Of  the  Modern  Philosophy 510

y.  Of  the  Immateriality  of  the  Soul        .....  516

^Yl)  Of  Personal  Identity 633
...
SUMMAEY   OP   THE    CONTENTS

OF   TUE

GENERAL  INTRODUCTION  TO  VOL.  L
...
This  he  will  passively  observe      ......  6

Is  such  observation  possible  ?.......  7
...
Feehng  and  felt  thing  confused     ......  16
...
Xli  SUMMARY   OF  THE   CONTENTS  OF  THE

PAGH

Only  as  such  can  it  be  named      ......  21

The  same  implied  iu  calling  it  an  idea  of  an  object    ...  21
Made /or,  not  hy,  us,  and  therefore  according  to  Locko  really

existent  ......••..  22

What  did  he  mean  by  this  ?.......  22

Existence  as  the  mere  presence  of  a  feeling    ....  23
...
Yet  reality  involves  complex  ideas  which  are  made  by  the  mind  25
...
ideas  of  substances  the  beginning  is  the  same  as  the  end     .  31
Doctrine  of  abstraction   inconsistent   with  doctrine  of  complex

ideas  ...........  32

The  confusion  covered  by  use  of '  particulars '        .         .         .  33

Locke's  account  of  abstract  general  ideas  .....  33

'  Things '  not  general  ........  34

Generality  an  invention  of  the  mind          .....  35

The  result  is,  that  the  feeling  of  each  moment  is  alone  real     .  35
How  Locke  avoids  this  result    .         .         .         .         .         .         .36

The  *  particular '  was  to  him  the  individual  qualified  by  general

relations          .........  37

This  is  the  real  thing  from  which  abstraction  is  supposed  to  start  38

Yet,  according  to  the  doctrine  of  relation,  a  creation  of  thought  .  39
...
Correlativity  of  cause  and  substance.         .....  43
...
Present  sensation  gives  knowledge  of  existence      ...  4G

GENERAL   INTRODUCTION   TO   THE   FIRST   VOLUME.  xiij

PAGB

Reasons  why  its  testimony  must  be  trusted        ....  47

How  does  this  account  fit  Locke's  definition  of  knowledge'     .  48
...
Rationale  of  this  '  petitio  principii '.....  56
...
Locke  fails  to  distinguish  between  identity  and  mere  unity          .  GU
Feelings  are  the  real,  and  do  not  admit  of  identity.     How  then

can  identity  be  real  ?         .......  61

Yet  it  is  from  reality  that  the  idea  of  it  is  derived      ...  62
...
Locke  not  aware  of  the  fuU  effect  of  his  own  doctrine,  which  is
...
XIV  SmiMAEY  OF  THE   CONTENTS   OF  THE
...
Body  as  qualified  by  circumstances  of  time  and  place  .         .       77

Such  body  Locke  held  to  be  subject  of '  primary  qualities' :  but

are  these  compatible  with  particularity  in  time  ?         .         .  7xS
...
rejoinder.     Locke  gets  out  of  the  difSculty  by  his  doctrine  of
...
Only  the  knowledge  that  something  is,  not  what  it  is     .         .  9>^
...
Are  the  *  primary  qualities '  then,  a  '  nominal  essence '  ?          .  89
...
The  knowledge  expressed  by  a  proposition,  though  certain,  may
...
GENERAL   INTllOUUCTION   TO   TIIE   FIRST   VOLUME.        XV

PAoa

Fatal  to  the  notion  that  mathematical  truths,  though  general,  are
...
What  knowledge  it  can  atFord,  according  to  Locke      .          .          .102
...
'  Matter  '  and  '  mind  '  have  the  same  soiu-ce  in  self-consciousness     1 1 3
Difficulties  in  the  way  of  ascribing  reality  to  substance  as  matter,

re-appe.'ir  in  regard  to  substance  as  mind  .  .  .  .  113
...
An  act,  finite  in  its  natiire,  remains  so,  however  often  repeated     119
...
Locke's  proof  of  the  real  existence  of  God     .         .         .         .  125

VOL.  I.  a

xvi  SUMMARY    OF   THE   CONTENTS   OF   THE
...
What  is  meant  by  relation  of"  mind  and  matter  ?    .          .          .  134

Confrisions  involved  in  Locke's  materialism        ....  134

Two    ways    of    dealing    with     it.      Berkeley    chooses    the  must
...
The  '  esse '  of  body  is  the  *  percipi '  .         .         .         •         .         .  138

What  then  becomes  of  distinction  between  reality  and  iancy  ?  138
The  real = ideas  that  God  causes       .          .          .          .          .          .139
...
He  does  not  even  retain  them  as  '  abstract  ideas '       .          .          .  142
...
His  way  oi  dealing  with  physical  truths    .         .  .         ...     152

GENERAL   INTRODUCTION   TO  THE   FIRST  VOLUME,     xvii

PAaB

If  they  imply  permanent  relations,  his  theory  properly  excludes
them      ..........  152

He  supposes  a  divine  decree  that  one  feeling  shall  follow  another     153
...
Endless  succession  of  feelings  is  not  immortality  in  true  sense     .      15G
...
Hume,  taken  strictly,  leaves  no   distinction  berween  impressions
of  reflection  and  of  sensation  .         .         .         .         .         .163

Locke's  theory  of  sensation  disappears   .  .  .  .  .  1 63
...
lor  ;   by  assuming  that  impression  represents  a  real  world  .  166
...
It  corresponds  to  Locke's  account  of  the  sorts  of  agreement  be-
tween ideas     .........  171
...
Xviii  SUMMARY   OF  THE   CONTENTS   OF  TIIE

Are  there  general  ideas  ?     Berkeley  said,  '  yes  and  no  ' .         .  176
...
Kesult  is  a   theory  which   admits   predication,  but  only  as  sin-
gular      ..........  183
...
taintv — here  following  Berkeley        .  .  .  .  .  187
...
True  rationale  of  Locke's  doctrine  .  .  .  .  .  1 92
...
Significance  with  him  of  such  derivation        .         .         .         .  1 94

It  means,  in  effect,  that  colour  and  space  are  the  same,  and  that
feeling  may  be  extended        .         .         .         .         .         .         .     1 94
...
The  thing  will  have  ceased  before  the  quality  begins  to  be     .  201
...
GENERAL  INTRODUCTION   TO   THE   FIRST   VOLUME.      XIX

PAOB

A    *  compound   impression   '  excluded    by   Hume's    doctrine    of

time         ..........  204

The  fact  that  colours  mix,  not  to  the  purpose     ....     206

How  Hume  avoids  appearance  of  identifying  space  with  colour,
...
tions of  a  felt  thins:  as  if  it  were  itself  the  feeling    .  .  •     210
...
Yet  '  imites  '  and   '  number  '  are  correlative  ;   and  the  supposed
...
relations  between  felt  thino^s .  .  .  .  .  .  .219

He  fails  to  assign  any  impression   or   compound   of  impressions
...
Yet  it  is  admitted  that  there  is  an   idea  of  number  not  made  up
...
What  are  the  ultimate  elements  of  extension  ?     If  not  extended,

what  are  they  ?.......•  227

Colours  or  coloured  points?     What  is  the  difference  ?  .  .     228
...
XX  SUMMARY  OF   THE   CONTENTS  OF  TIIE

pAoa

What  becomes  of  the  exactness   of  mathematics  according  to

Hume? 230

The  universal  propositions  of  geometry  either  untrue  or  unmean-
ing     ...........     231

Distinction  between  Hume's  doctrine  and  that  of  the  hypothetical
nature  of  mathematics      .......  232
...
so  than  that  of  space     .  .  .  .  .  .  .    ,      .     235

Plow  it  is  that  we  talk  as  if  we  had  idea  of  vacuum  according  to
Hume 237

His  explanation  implies  that  we  have  an  idea  virtually  the  same     238

By  a  like  device  that  he  is  able  to  explain  tlie  appearance  of  our

having  such  ideas  as  Causation  and  Identity  .  .  .     238
...
a.  The  original  impression  from  which   the  transition  is  made     245
...
Is  Hume  entitled   to  retain   '  philosopliical  '  relations  as  distinct
...
GENERAL  INTRODUCTION  TO   THE   FIRST   VOLUME.      XXI

PAGB

Identity  of  objects  an  unavoidable  crux  for  Hume  .         .  254
...
the  feelings,  as  described,  are  already  such  objects       .         .  256

Fiction  of  identity  thus  implied  as  source  of  the  propensity  which
is  to  account  fur  it         .  .         .  .....     257

With  Hume  continued  existence  of  j^erceptions  a  fiction  different

from  their  identity   ........  258

Can  perceptions  exist  when  not  perceived  ?         .         .         .         .     259

Existence  of  objects,  distinct  from  perceptions,  a  further  fiction  still     259
...
Hume  quite  right  in  saying  that  we   do   not  go  more  beyond
...
derived  from  a  natural  one        ......  269

Examination  of  his  account  of  cause  and  effect  as  '  natural  rela-
tion '  270
...
xxii     SUMMARY  OF  GENERAL  INTRODUCTION,   VOL.   L
...
This  remembrance,  as  he  describes  it,  supposes  conception  of  a
system  of  nature    .         .  ......     277

This  explains  his  occasional  inconsistent  ascription  of  an  objec-
tive character  to  causation         .....  278

Reality  of  remembered  '  system  '  transferred  to  '  system  of  judg-
ment' ...........     279
...
and  in  this  lies  explanation  of  the  inference  frcm  it  to  '  sys-
tem of  judgment '    ........  281
...
But  if  so,   'system   of  judgment'   must  consist  of  feelings  con-
stantly experienced  which  only  differ  from  remembered  feel-
ings inasmuch  as  their  liveliness  has  faded.  .  .  .  283
...
His  distinction  of  probability  of  causes  from   that  of  chances
might  seem  to  imply  conception  of  nature,   as  determining
inference  .........  287

But  this  distinction  he  only  professes  to  adopt  in  order  to  exj^lain
it  away        ..........     288
...
J'ossibility  of  such  fictitious  ideas  implies  refutation  of  Hume's
doctrine 297

INTEODUCTION.

There  is  a  view  of  the  history  of  mankind,  by  this  time  How  the

familiarised  to  Eng-lishmen,  which  detaches  from  the  chaos  ^[^toryof

1  '  o        T  ■  Til  phuosopny

of  events  a  connected  series  oi  runng  actions  and  behefs —  should  be
the  achievement  of  great  men  and  great  epochs,  ari  assigns  studied.
to  these  in  a  special  sense  the  term  'historical.'  According
to  this  theory — which  indeed,  if  there  is  to  be  a  theory  of
Histoiy  at  all,  alone  gives  the  needful  simplification — the
mass  of  nations  must  be  regarded  as  left  in  swamps  and  shal-
lows outside  the  main  stream  of  human  development.  They
have  either  never  come  within  the  reach  of  the  hopes  and
institutions  which  make  history  a  progress  instead  of  a  cycle,
or  they  have  stifiened  these  into  a  dead  body  of  ceremony
...
lative ideas  which  from  the  strife  of  passions  elicit  moral
...
tivity of  the  progressive  nations.
...
enquiry  is  an  endless  process  of  threshing  old  straw.  Such
...
Hume  the  impulse  to  begin  at  the  beginning-  and  go  to  the  end,  and
Enlifir  "with  the  faculty  of  discerning  the  true  point  of  departure
philoso-  which  previous  speculation  has  fixed  for  them.  The  intervals
^  are  occupied  by  commentators  and  exponents  of  the  last  true

-  philosopher,  if  it  has  been  his  mission  to  construct ;  if  it  has
been  sceptical,  by  writers  who  cannot  understand  the  fatal
v'  question  that  he  has  asked,  and  thus  still  dig  in  the  old  vein
...
tinctively English,   a  like  regime  of  '  strenua  inertia '    has
...
j   differed  from  the  system-making  for  purposes  of  edification
;  to  which  Leibnitz  applied  himself.     It  has  been  unprofitable,
because  its  representatives  have  persisted  in  philosophising
upon  principles  which  Hume  had  pursued  to  their  legitimate
V    issue  and  had  shown,  not  as  their  enemy  but  as  their  advo-
...
Kant  his  3.  As  the  result  of  the  experiment,  the  method,  which

true  sue-  began  with  professing  to  explain  knowledge,  showed  know-
...
own  proof  of  its  insufficiency  to  account  for  an  intelligent,  as
...
miaiE'S  RELATION  TO  LOCKE.  3

to  a  more  vigorous  line  in  Germany.  It  awoke  Kant,  as  he
...
in  knowledge  and  morality.  Thus  the  '  Treatise  of  Human
Nature  '  and  the  '  Critic  of  Pure  Reason,'  taken  together,
form  the  real  bridge  between  the  old  world  of  philosophy
and  the  new.  They  are  the  essential  '  Propsedeutik,'  without
which  no  one  is  a  qualified  student  of  modern  philosophy.
The  close  correspondence  between  the  two  works  becomes
...
Kantian  answer  has  been  so  little  appreciated.  To  trace  the
origin  and  bring  out  the  points  of  the  question,  in  order  to
the  exhibition  of  that  necessity,  will  be  the  object  of  the
following  treatise.  To  do  this  thoroughly,  indeed,  would
carry  us  back  through  Hobbes  to  Bacon.  But  as  present
limits  do  not  allow  of  so  long  a  journey,  we  must  be  content
...
4.  Such  a  task  is  ver}^  different  from  an  ordinary  under-  Distinction
taking  in  literary  history,  and  requires  difi'erent  treatment.  uterarT
To  the  historian  of  literature  a  philosopher  is  interesting,  if  at  history  and
all,  on  account  of  the  personal  qualities  which  make  a  great  ^^^^  hTio°^
writer,  and  have  a  permanent  effect  on  letters  and  general  phical  sys-
...
intense  upon  the  immediately  following  generations,  but  in
Hume's  more  remarkable  as  having  reappeared  after  near  a
...
the  dialectic  movement  that  constitutes  the  progress  of  philo-
...
which  has  made  German  philosophy  almost  a  foreign  litera-
...
peculiarities  of  their  genius  or  on  any  of  the  secondar}'
...
truth  is  to  be  attained.  It  is  otherwise  with  those  who  see  in
philosophy  a  progressive  effort  towards  a  fully-articulated
...
them  our  own,  carry  us  so  far  on  our  way  towards  the  freedom
of  perfect  understanding;  while  to  ignore   them   is   not  to  ^

VALUE  OF  THEIR  STUDY.  5

return  to  the  simplicity  of  a  pre-philosopWc  age,  but  to  con-
demn ourselves  to  grope  in  the  maze  of  'cultivated  opinion,'
...
clearest  expression  in  Hume,  lies  in  its  being  an  effort  to  think  g^qj^^^®"^
to  their  logical  issue  certain  notions  which  since  then  have
become  commonplaces  with  educated  Englishmen,  but  which,
...
bility has  gradually  reduced  them,  but  because  we  do  not
...
intellectual  necessity  to  those  truer  notions  which,  in  fact,
...
failures,  which  ai'e  so  because  they  are  anachronisms,  and
...
to  follow  the  lead  of  Ideas :  their  spirit  was  the  spirit  of
...
6.  About  Locke,  as  about  every   other   philosopher,  the  ppobfg^
...
knowledge  :  his  method  that  of  simply  '  looking  into  his  own
...
rougher  battery  from  the  physiologists.  Our  concern  at
...
insisting :  one,  that  the  object  of  his  investigation  is  his  own
...
thing born  with,  and  dependent  on,  the  particular  animal
...
grotesqueness.  He,  just  as  much  as  the  untutored  Cartesian,
regarded  the  '  minds  '  of  different  men  as  so  many  different
things  ;  and  his  refutation  of  the  objectionable  hypothesis
proceeds  wholly  from  this  view.  Whether  the  mind  is  put
complete  into  the  body,  or  is  born  and  grows  with  it ;  whether
...
LOCKE'S  ElklPIRICAL  PSYCHOLOGY.  7

faculties  are  made  and  operate  alike  in  most  men.  But  if  it
should  happen  not  to  be  so,  I  can  only  make  it  my  humble
request,  iii  my  own  name  and  in  the  name  of  those  that  are
of  my  size,  who  find  theii  minds  work,  reason,  and  know  in
...
Locke's  svstem  flow.  It  was  the  function  of  Hume  to  exhibit
the  radical  flaw  in  his  master's  method  by  following  it  with
more  than  his  master's  rigour.

9.  As  an  observation  of  the  '  thinking  thing,'  the  '  philo-  Is  s"''^  ob
sophy  of  mind  '  seems  to  assume  the  character  of  a  natural  possible  ?
science,  and  thus  at  once  acquires  definileness,  and  if  not  cer-
tainty, at  least  plausibility.  To  deny  the  possibility  of  such
observation,  in  any  proper  sense  of  the  word,  is  for  most  men
to  tamper  with  the  unquestioned  heritage  of  all  educated
...
matter  to  be  observed  consists  for  each  man  firstly  in  certain
...
tuted, performs  upon  the  materials  which  constitute  it.  The
observer,  all  the  while,  is  the  constituted  mind  itself.  Tlie
...
obser\  er  is  past.  If  it  be  replied  that  it  is  recalled  by  me-
moiy,  there  is  the  farther  objection  that  memory  only  recalls
...
what  lias  been  previously  known,  and  how  is  a  man's  own
primitive  consciousness,  as  yet  void  of  the  content  which  is
supposed  to  come  to  it  through  impressions,  orig'inahy  known
...
11.  Let  us  consider  the  passage  where  Locke  sums  up  his
theory  of  the  '  original  of  our  ideas.'  (Book  ii.  chap.  i.
sec.  28,  24.)  '  Since  there  appear  not  to  be  any  ideas  in  the
mind,  before  the  senses  have  conveyed  any  in,  1  conceive
...
its  own  operations  about  tlie  ideas  got  by  sensation,  and
...
12.  Can  we  from  this  passage  elicit  a  distinct  account  of
the  beginning  of  intelligence  ?  In  the  first  place  it  consists
in  an  '  idea,'  and  an  idea  is  elsewhere  (Introduction,  sec.  8)
stated  to  be  '  whatsoever  is  the  object  of  the  understanding,
when  a  man  thinks.'  But  the  primary  idea  is  an  '  idea  of
sensation.'     Does  this  mean  that  the  primary  idea  is  a  sen-

THE  IklETAPHOR  OF  BIPRESSION.  9

sation,  or  is  a  distinction  to  be  made  between  tbe  sensation
and  the  idea  thereof  ?  The  passage  before  us  would  seem  to
imply  such  a  distinction.  Looking  merely  to  it,  we  should
probably  say  that  by  sensation  Locke  meant  '  an  impression
...
perception.'  Here  sensation  is  identified  at  once  with  the
...
guished from  it,  as  '  exercised  about  it.'  '  Perception,  as  it
...
13.  By  insisting  on  Locke's  account  of  the  relation  between  (b)  In  re-
...
'  Cf.  Book  n.  chap.  xix.  sec.  1.    'The  thinking,  furnishes  the   mind    with  a

perception,  which  actually  accompanies  distinct  idea  which  we  call  sensation  ;

and  is  annexed  to  any  impression  on  the  which  is,  as  it  were,  the  actual  entrance

body,  made  by  an  external  object,  being  of  any  idea  into  the  understanding  by

distinct  from  all  other  modifications  of  the  senses.'

10  GENERAL  INTRODUCTION.

ginal  (Book  ii.  c.  xxi.  sec.  73),viz.motivity  or  power  of  moving,
with  whicli  we  are  not  at  present  concerned,  and  perceptivity
...
perceive.'
What  is  14.  Meanwhile  a  perpetual  equivocation  is  kept  up  between

impressed?  ^  supposed  impression  on  the  '  outward  parts,'  and  a  supposed
impression  on  the  '  tablet  of  the  mind.'  It  is  not  the  im-
...
confuse  between  the  object  of  consciousness  and  a  possible
physical  theory'  of  the  conditions  of  that  consciousness.    It  is

'  Cf.    Locke's  own    statement  (Book  ideas ;  and  two  ideas  so  different  and

III.   iv.  sec.  10).     'The  cause    of    any  distant  one  from  another,  that  no  tv\o

6"nsation,  and  the  sensation  itself,  in  all  can  be  more  so.'
the  simple  ideas  of  one  sense,  are  two

WHAT  IS  THE   'TABULA  RASA'?  11

onlj,  however,  by  such  an  equivocation  that  any  idea,  accord-
ing to  Locke's  account  of  the  idea,  can  be  described  as  an
'  impression  '  at  all,  or  that  the  representation  of  the  mind  as
a  tablet,  whether  born  blank  or  with  characters  stamped  on
it,  has  even  an  apparent  meaning.  A  metaphor,  interpreted
as  a  fact,  becomes  the  basis  of  his  philosophical  system.

15.  As  applied  to  the  ideas  of  reflection,  indeed,  the  meta-  Does  the
phor  loses  even  its  plausibility.     In  its  application  to  the  mi^dmake

7  ...  ,       impres-

ideas  of  sensation  it  gains  popular  acceptance  from  the  ready  sious  on
confusion  of  thought  and  matter  in  the  imaginary  cerebral  itself?
...
must  be  supposed,  that  is,  to  make  impressions  on  itself.
There  is  the  further  difficulty  that  as  perception  is  necessary
in  order  to  give  an  idea  of  sensation,  the  impress  of  percep-
tioa  must  be  taken  by  the  mind  in  its  earliest  receptivity ;
or,  in  other  words,  it  must  impress  itself  while  still  a  blank,
still  void  of  any  '  furniture '  wherewith  to  make  the  impres-
sion. There  is  no  escape  from  this  result  unless  we  suppose
...
difficulty  from  himself  and  his  reader  by  constantly  shifting
...
16.  The  real  source  of  these  embarrassments  in  Locke's  Source  of
theory,  it  must  be  noted,  lies  in  the  attempt  to  make  the  in-  ^J^f^g '
...
But  by  this  he  means  consciously  sensitive  of  something
and  consciously  passive  in  relation  to  something.  That  is,  he
supposes  the  primitive  experience  to  have  involved  conscious-
ness of  a  self  on  the  one  hand  and  of  a  thing  on  the  other,
as  well  as  of  a  relation  betv^een  the  two.  In  the  '  idea  of
sensation'  as  Locke  conceived  it,  such  a  consciousness  is
clearly  implied,  notwithstanding  his  confusion  of  terms.  The
idea  is  a  perception,  or  consciousness  of  a  thing,  as  opposed
to  a  sensation  proper  or  affection  of  the  bodily  organs.  Ot
...
But  this  means  no  less  than  that  he  is  finding  there  already
...
in  knowledge  of  the  ideas  of  substrnce  and  relation,  and  the
seemingly  gradual  attainment  of  tluse  'abstractions'  by  the
...
sensation  ; '  a  phrase  which,  if  sensation  means  the  first  act  of
intelligence,  is  pleonastic,  and  if  it  means  the  '  motion  of  the
outward  parts  continued  to  the  brain,'  is  unmeaning  ;  and  (6)
...
1 7.  It  is  not  difficult  to  show  that  to  have  a  simple  idea,
according  to  Locke's  account  of  it,  means  to  have  already  the

USE  OF  THE  TERM   'IDEA.'  13

conception  of  substance  and  relation,  which  are  yet  according
...
18.  An  equivocation  is  not  the  less  so  because  it  is  an-  Locke's
nounced.     It  is  just  because  Locke  allows  himself  at  his  ^rchanc-'
convenience  to  interchange  the  terms  '  idea  '  and  '  quality  '  ing'idea'
that  his  doctrine  is  at  once  so  plausible  and  so  hollow.     The  f^^.^]-.  >
...
we  have  to  face  the  difficulty  of  the  genesis  of  knowledge,  as
...
'  idea '  and  '  quality,'  Locke    disguised   the    dilemma  from
...
impact.  Of  the  fallacies,  one  is  the  confusion  between  this
...
the  statement  that  '  the  mind  is  furnished  with  simple  ideas
as  they  are  found  in  exterior  things.'  (Book  ii.  chap,  xxiii.
...
action  of  matter  upon  itself,  which,  as  the  result  of  a  familiar
...
19.  This  will  appear  more  clearly  upon  an  examination  of
his  doctrine  of '  the  ideas  of  primary  and  secondary  qualities
of  bodies.'  The  distinction  between  them  he  states  as  follows.
The  primary  qualities  of  bodies  are  '  the  bulk,  figure,  number,
situation,  motion,  and  rest  of  their  solid  parts ;  these  are  in
them,  whether  ws  perceive  them  or  no ;  and  when  they  are
of  that  size  that  we  can  discover  them,  we  have  by  these  an
...
semblance of  them  at  all.  There  is  nothing  like  them  exist-
...
the  certain  bulk,  figure,  and  motion  of  the  insensible  pai-ts
...
thereb}^  produce  in  us  the  different  ideas  of  several  colours,
...
body,  as  to  make  it  operate  differently  on  our  senses  from
...
ideas;  but  we  shall  find  Locke  constantly  representing^  this  i<i6a're-
theox^y  as  a  simple  idea  itself,  or  the  simple  idea  as  involving  as  invoiv-
this  theory.     By  this  unconscious  device  he  is  enabled  readily  '"^  ^

to  exhibit  the  genesis  of  knowledge  out  of  '  simple  ideas,'  its  own
...
21.  The  simple  idea  caused  by  a  quality  he  calls  the  idea  phrases  in
of  that  quality.  Under  cover  of  this  phrase,  he  not  only  y^'^h  this
...
servation rather  adds  to  the  confusion.  There  are  in  fact,  ac-
...
»  This  distinction  is  more  fully  treated  below,  paragraphs  88,  &c.
...
hut  an  effect,  of  something  in  a  body),  is  already  in  the
...
forced  him  to  reconsider  his  doctrine  of  the  mere  passivit}'
...
Feeling  22.  Phraseology  of  this  kind,  the  standing  heritage  of  the

and  felt  philosopliy  wliich  seeks  the  origin  of  knowledge  in  sensation,
confused  assumes  that  the  individual  sensation  is  from  the  first  con-
...
our  eyes  a  round  globe  of  any  uiiiform  colour,  it  is  certain

DISTIXCTION  BETWEEN  THE  REAL  AND   APPARENT.  17

that  the  idea  thereby  imprinted  in  onr  mind  is  of  a  flat  circle,
variously  shadowed  with  several  degrees  of  light  and  brigii;;}-
...
II.  chap.  ix.  sec.  8.)  The  theory  here  stated  involves  two
...
wont  to  make  in  us,'  i.e.  '  of  the  alterations  made  in  the  re-
flections of  light  by  the  difference  of  the  sensible  figure  of
bodies.'  This  perception,  indeed,  as  described,  is  already
itself  just  the  instinctive  judgment  which  has  to  be  accounted
for,  and  though  this  objection  might  be  met  by  a  better
statement,  yet  no  statement  could  serve  Locke's  purpose
which  did  not  make  assumption  (6)  that  sensations  of  light
and  colour — '  simple  ideas  of  secondary  qualities ' — are  in
the  very  beginning  of  knowledge  appearances,  if  not  of  convex
bodies,  yet  of  bodies ;  if  not  of  bodies,  yet  of  something  which
they  reveal,  which  remains  there  while  they  pass  away.

23.  The  same  assumption  is  patent  in  Locke's  account  of  mj^    ;     .
the  distinction  between  '  real  and  fantastic,'  '  adequate  and  idea  s,s
inadequate,'  ideas.     This  distinction  rests  upon  that  between  '  ^^^yy^
the  thing  as  archetype,  and  the  idea  as  the  corresponding  mere  seu-
ectype.     Simple  ideas  he  holds  to  be  necessarily  '  real '  and  nation.

*  adequate,'  because  necessarily  answering  to  their  archetypes.

*  Not  that  they  are  all  of  them  im-ages  or  representations  of
what  does  exist :  .  .  .  whiteness  and  coldness  are  no
more  in  snow  than  pain  is  :  .  .  .  yet  are  they  real  ideas
in  us,  whereby  we  distinguish  the  qualities  that  are  really  iu
...
distinguish  things  which  we  have  to  do  with,  our  ideas  do  as
...
(Book  II.  chap.  xxx.  sec.  2.)  The  simple  idea,  then,  is  a
*  mark '  or  '  distinguishing  character,'  either  as  a  coj^y  or  as
an  effect,  of  something  other  than  itself.  Only  as  thus
reo-arded,  does  the  distinction  between  real  and  fantastic
...
as  '  referred  to  something  extraneous  to  it.'  (Book  ii.  chap,
...
external  objects  to  produce  in  us  by  established  laws  and
...
The  idea  is  an  '  appearance '  of  something,  necessarily  true
...
apparent,  between  true  and  false  P  If  its  beginning  is  a  mode
...
tition of  such  modes  give  such  a  judgment?'

'  Cf.      the    ground     of    distinction       ideas ;  (Book  ii.  chap.    xxix.    sec.     2)
between    clearness    and    obscurity    of      '  Our  simple  ideas  are  clear  wheii  they

WHAT.  THE   'SIMPLE  HDEA  '   INVOLVES.  19

24.  The  fact  is  that  the  '  simple  idea'  with  Locke,  as  the  ^'^.^J™^^^^^
beginning  of  knowledge,  is  already,  at  its  minimum,  the  Jq  ^hjeh
judgment,  *  I  have  an ,  idea  different  from  other  ideas,  which  mind  and
I  did  not  make  for  myself.'  His  confusion  of  this  judgment  aistm-*^^^
with  sensation  is  merely  the  fundamental  confusion,  on  which  gdshod,
all  empirical  psychology  rests,  between  two  essentially  dis-
tinct questions — one  metaphysical,  What  is  the  simplest
element  of  knowledge?  the  other  physiological.  What  are
the  conditions  in  the  individual  human  organism  in  virtue  of
which  it  becomes  a  vehicle  of  knowledge  ?  Though  he  fViiled,
however,  to  distinguish  these  questions,  their  difference
made  itself  appear  in  a  certain  divergence  between  the  second
and  fourth  books  of  his  Essay.  So  far  we  have  limited
our  consideration  to  passages  in  the  second  book,  in  which
...
sical theoi-y  can  account.  As  we  have  seen,  the  whole  theory
...
are  such   as    the    objects    themselves,  tell  whether  an  idea  is  clear  or  not,  it

whence  they  are  taken,  did  or  might  in  follows    that    immediate    consciousness

a  well-ordered  sensation  or  perception,  must  tell  of  '  the  object  itself,  whence

present   them.'     As  Locke  always   as-  the  idea  is  taken.'
Bumes  that  immediate  consciousness  can
...
equivalent    treafcinsf  of  ideas  he  had  been  treating^  of  anythino:  else  than

to  wuali  he  o  ./  o

afterwards   knowledge,  he  afterwards  considers  '  knowledge '  in  a  book
calls  ]^y  itself  (the  fourth)  under  that  title,  and  here  the  question

ledge  of  as  to  the  relation  between  idea  and  thing  comes  before  him
idfexitity.'  in  a  somewhat  different  shape.  According  to  his  well-known
...
however,  he  is  faithful  to  his  definition,  and  treats  each  as  a
...
,  he  predicated  of  the  '  idea '  as  merely  single,  but  only  as  a  Only  as
manifold  in  singleness.  To  speak  of  an  idea  as  the  '  same  ?"^g  ''^^
with  itself  is  unmeaning  unless  it  mean  'same  with  itself  w  namod.
its  manifold  appearances-'  i.e.  unless  the  idea  is  distinguished,
...
other  times  of  its  occurrence  he  has  called  'wJiite.'  Such  a
...
of  thought '  is  merely  the  instinctive  result  of  a  series  of  pas.t
resembling  sensations,  and  that  the  common  name  is  merely
the  register  of  this  result.  But  the  question  is  thus  merely
thrown  further  back.  Unless  the  single  fleeting  sensation
was,  to  begin  with,  fixed  and  defined  by  relation  to  and
distinction  from  something  permanent — in  other  words,
unless  it  ceased  to  be  a  mere  sensation — how  did  it  happen
that  other  sensations  were  referred  to  it,  as  different  cases
of  an  identical  phenomenon,  to  which  the  noise  suggested  by
it  might  be  applied  as  a  sign  ?

26.    This  primary  distinction  and  relation  of  the  simple  The  same
idea  Locke  implicitly  acknowledges  when  he  substitutes  for  )^^|',^'\^"
the  simple  idea,  as  in  the  23assage  last  quoted,  the  man's  an  idea  of
knowledge  that  he  has  the  idea ;  for  such  knowledge  implies  ^°  ^^'i^'^k
...
•  Cf.  the  passage  in  Book  ii.  chap.  tion  of  it  as  actually  there,'  as  sensation

vii.  sec.    7.     '  Whea  ideas    are  in   our  is  different  from  thought.     The  'coii-

niindSjWe  consider  them  as  being  actually  sideration,&c.,'  really  means  the  thoufi;ht

there.'     The  mere 'idea'  is  in  fact  es-  of  the  '  idea' (sensation")  as  d i-termiuctl

sentially  different  from  the  '  considera-  by  rehition  to  the  conscious  subject.
...
basis  to  whicli  other  sensations,  like  and  unlike,  may  be
...
the  sensation  is  in  Loclze's  phraseology  'a  testimony'  or
...
'  For  a  recognition  by  Locke  of  the
correlatiTity  of  these  (of  which  more
will  have  to  be  said  below)  cf.  Book  ii.
chap,  xxiii.  sec.  15.  'Whilst  I  know
...
*  Cf.  Book  II.  cbap.  xii.  sec.  1.

IDEA  OF  EXISTENCE.  23

mention  of  '  existence,'  as  one  of  those  '  received  alike  through
all  the  ways  of  sensation  and  reflection.'  It  is  an  idea  '  sug-
gested to  the  understanding  hy  every  object  without  and  every
...
(Book  II.  chap.  ix.  sec.  3,  &c.)

30.  The  designation  of  the  idea   of  existence,  then,  as  Existence
*  suggested  by  every  idea  within,'  covers  every  possible  sug-  ^^

o  o  J  ^  7  J   ±   ^  o      mere  pra-

gestion.  It  can  mean  nothing  else  than  that  it  is  given  in  sonceofa
every  act  and  mode  of  consciousness ;  that  it  is  inseparable  *^^^>°g-
from  feeling  as  such,  being  itself  at  the  same  time  a  distmct
...
senses '  (according  to  Locke's  favourite  subterfuge)  in  order
...
or  recall  the  smell  in  winter ;  whether  I  see  a  horse  or  a
ghost i  or  imagine  a  centaur  or  think  of  gravitation  or  the

94  GENERAL  INTRODUCTION.

pliilosopher's  stone — in  everj  case  alike  the  idea  or  '  imme-
...
which  have  no  such  conformity  (Book  ii.  chap.  xxx.  sec.  1) ;
and  again  in  the  fourth  book  (chap.  i.  sec.  7,  chap.  iii.
sec.  21,  &c.)  he  makes  the  perception  of  the  agreement  of  an
idea  with  existence  a  special  kind  of  knowledge,  diflPerent
from  that  of  agreement  of  idea  with  idea ;  and  having  done
so,  raises  the  question  whether  we  have  such  a  knowledge  of
existence  at  all,  and  decides  that  our  knowledge  of  it  is  very
narrow.
Fotistence  31.  How  are  such  a  distinction  and  such  a  question  to  be
ap  red  i  y,  rg^Q^ciled  with  the  attribution  of  existence  to  every  idea  ?
...
ideas,  there  has  supervened  a  distinction,  which  has  to  be
accounted  for,  of  ideas  from  things  which  they  represent  on
the  one  hand,  and  from  a  mind  of  which  they  are  aflfections
...
as  Locke  suj^posed,  two  separate  considerations,  one  or  other
...
in  the  mind,  the  feeling  is  distinguished  from  the  mind  as  an
affection  from  the  subject  thereof,  and  just  in  virtue  of  this

EXISTENCE  AND  REAL  EXISTENCE.  25

distinction  is  referred  to  a  thing  as  the  cause  of  the  affection,
...
82.  Between  these  two  meanings  of  existence — its  mean-  ~^.*'^°"

°  .  .        tusion  of

mg   as  interchangeable  with  simple  consciousness,  and  its  those  two
meaninof  as  reality — Locke  failed  to  distinguish.     Just  as,  meamugs,
having    announced   'ideas'   to   be   the    sole    'materials   of  its  con-
knowledge,'  he  allows   himself  at  his    convenience  to  put  ^^itions  are
*  things  '  in  the  place  of  ideas ;  so  having  identified  existence  sented  as
with  momentary  consciouness  or  the  simple  idea,  he  substi-  sjven  in
tutes  for  existence  in  this  sense  reality,  and  in  consequence  feeimg,
finds  reality  given  solely  in  the  simple  idea.     Thus  when  the
conceptions  of  cause  or  substance,  or  relations  of  any  kind,
come  under  view,  since  these  cannot  be  represented  as  given
...
33.  In  the  second  book  of  his  Essay,  which  treats  of  ideas.  Yet  reality

involves

he  makes  the  grand  distinction  between  '  the   simple  ideas  complex
which  are  all  from  things  themselves,  and  of  which  the  mind  ^^^'^\
can  have  no  more  or  other  than  what  are  suggested  to  it,'  and

«{)  GENERAL  INTRODUCTION.

made  by  tlie  '  complex  ideas  wliicli  are  the  workmanship  of  the  mind.*
the  mmd.  (Book  II.  chap.  xii.)  In  his  account  of  the  hitter  there  are
...
tude,' '  murder,'  &c.  Of  these  there  are  two  sorts.  First,
...
modes.'  (Book  ii.  chaj).  xii.  sees.  4,  5.)  So  soon  as  he  comes
to  speak  more  in  detail  of  simple  modes,  he  falls  into  ajjparent
contradiction  with  his  doctrine  that,  as  complex  ideas,  they
are  the  mere  workmanship  of  the  mind.  All  particular
sounds  and  colours  are  simple  modes  of  the  simple  ideas  of
sound  and  colour.  (Book  ii.  chap,  xviii.  sees.  3,  4.)  Again,
...
by  the  mind  to  all  simple  ones  as  taken  from  things  them-
selves, he  speaks  of  simple  modes  '  either  as  found  in  things
existing,  or  as  made  by  the  mind  within  itself.'  (Book  ii.
chap.  xiii.  sec.  1.)  It  was  not  for  Locke  to  get  over  this  con-
fusion by  denying  the  antithesis  between  that   which  the

REALITY  IMPLIES  SUBSTANCE   AND   RELATION.        27

mind  'makes'  and  that  which  it  'takes  from  existing  things/
and  for  the  present  we  must  leave  it  as  it  stands.  We  must
further  note  that  a  mode  being  considered  '  as  an  affection  of
...
fore the  idea  of  space — at  any  rate  such  an  idea  as  we  have  of
it  when  we  think  of  distances,  places,  or  figures,  and  when
else  do  we  think  of  it  at  all  ? — must  be  a  complex  and  arti-
...
34.  These  contradictions  are  not  avoidable  blunders,  due  ^^\^^^  ^^^
to    carelessness  or  want  of  a  clear  head  in  the  individual  g^n^  ^eia-
writer,     '  The  complex  idea  of  substance  '  will  not  be  exor-  tion  which
cised ;    the  mind    will  show  its  workmanship  in    the  very  ^q^^j  j^
elements  of  knowlede^e   towards   which   its   relation   seems  every  ob-
most  passive — in  the  '  existing  things  '  which  are  the  condi-  knowledge,
...
place  of  real  existence,  just  Avhere  the  opposition  between
...
informed.  If  the  '  mind,'  then,  means  this  or  that  individual
...
these  things  of  the  mind,  substance  and  relations.  If  nature
...
ness, it  would  seem,  ex  vi  termini,  does  know.  Therefore  not
mei'ely  substance  and  relation  must  be  found  in  the  original
...
made  use  of  for  quick  despatch,  are  called,  so  united  in  one
...
Bubsist  by  themselves,  we  accustom  ourselves  to  suppose
some  substratum,  wherein  they  do  subsist,  and  from  which
they  do  result ;  which  therefore  we  call  substance.'  (Book
II.  chap,  xxiii.  sec.  1.)  In  the  controversy  with  StiUingfleet,
...
plication of  many  ideas  together,'  and  these  alon"  are  complex
...
which  we  accustom  ourselves  to  suppose '  as  that  wherein

LOCKE'S  ACCOUNT  OF  SUBSTANCE.

29

the  complicated  ideas  '  do  subsist,  and  from  whicli  tliey  do
result.'  This,  however,  he  regards  as  itself  one,  'the  first
and  chief,'  among  the  ideas  which  make  up  any  of  the  '  dis-
tinct substances.'  (Book  ii.  chap.  xii.  sec.  6.)  Nor  is  he
...
support.  We  shall  find  each  of  these  ideas,  according  to
Locke's  statement,  presupposing  the  other.

86.  In  the  passage  above  quoted,  our  aptness  to  consider
a  complication  of  simple  ideas,  which  we  notice  to  go  con-
stantly together,  as  one  simple  idea,  is  accounted  for  as  the
result  of  a  presumption  that  they  belong  to  one  thing.  This
presumption  is  again  described  in  the  words  that  '  we  ac-
custom ourselves  to  suppose  some  substratum,  wherein  they
...
'  Upon  a  reference  to  the  chapter  on
'  complex  ideas '  (Book  ii.  chap,  xii.),
it  will  appear  that  the  term  is  used  in  a
stricter  and  a  looser  sense.  In  the
looser  sense  it  is  not  confined  to  com-
•pound  ideas,  but  in  opposition  to  simple
ones  includes  those  of  relation  and  even
'  abstract  general  ideas.'  When  Locke
thinks  of  the  general  idea  of  substance
apart  from  the  complication  of  accidents

referred  to  it,  he  opposes  it  to  the
complex  idea,  according  to  the  stricter
sense  of  that  term.  On  the  other  hand,
■when  he  thinks  of  it  as  '  made  up  '  of
the  idea  of  something  plus  that  of  rela-
tion to  qualities  (as  if  there  could  be  an
idea  of  something  apart  from  such
relation),  it  seems  to  him  to  have  two
elements,  and  therefore  to  be  complex.
2  I.  xxiii.

80  GENERAL   INTRODUCTION.

substance  having  been  formed  by  one  gradual  process,  ideas
of  particular  sorts  of  substances  are  formed  by  another  and
later  one.  But  then  the  very  same  '  collection  of  such  com-
binations of  simple  ideas  as  are  taken  notice  of  to  exist
together,'  which  (according  to  sec.  3)  constitutes  the  later
process  and  follows  upon  the  formation  of  the  general  idea  of
substance,  has  been  previously  described  as  preceding  and
...
objects,  to  become  general.'  (Book  ii.  chap,  xi.  sec.  9.)
Reference  37.  It  may  be  said  perhaps  that  Locke's  self-contradiction
nature  or*'  in  this  regard  is  more  apparent  than  real;  that  the  two  pro-
God,  the  cesses  of  combining  simple  ideas  are  essentially  diflFerent,
same  asre-   -^  because  in  the  later  process  they  are  combined  bv  a  con-

lectMice  to     "^    .  .  .

substance,  scious  act  of  the  mind  as  accidents  of  a  '  something,'  of
which  the  general  idea  has  been  previously  formed,  whereas
in  the  earlier  one  they  are  merely  presented  together  '  by
nature,'  and,  ex  hypothesi,  though  they  gradually  suggest,  do
...
rs  THE  IDEA  OF   SUBSTANCE  GOT  BY  ABSTRACTION  ?    31

relations  to  tlie  same  things,  and  the  observation  of  these
relations  presupposes  just  that  conception  of  the  thing  which
it  is  souo-ht  to  account  for,

38.  We  are  estopped,  however,  from  any  such  explanation  But  it  is
of  Locke  as  would  suggest  these  ulteriox-  questions  by  his  ^xphcitly
explicit  statement  that  '  all  simple  ideas,  all  sensible  quali-  stance  that
ties,  carry  with  them  a  supposition  of  a  substratum  to  exist  Locke
in,  and  of  a  substance  wherein  they  inhere.'    The  vindication  them  refer
of  himself  against  the   pathetic  complaint  of   Stillingfleet,  tliem-
that  he  had  '  almost  discarded  substance  out  of  the  reason-
able i^art  of  the  world,'  in  which  this  statement  occurs,  was
...
39.  The  same  paralogism  appears  under  a  slightly  altered  In  the  pro
form  when  it  is  stated  (in  the  first  letter  to  Stillingfleet)  that  *^®^?  Y^

1  1    •     T  •       1    •  1  i>  '"'liich  we

the  idea  of  substance  as  the  *  general  mdetermmed  idea  of  are  sup-
somethinq  is  by  the  abstraction  of  the  mind  derived  from  the  P*^^.*^*^  *°
...
ideas  that  accompany  it  in  its  real  existence.'     (Book  ii.  the  beo-in-
chap.  xii.  sec.  1.)     It  is  clear  then  that  it  is  impossible  to  ning  is  the
abstract  an  idea  which  is  not  there,  in  real  existence,  to  be  ^he  end.
abstracted.     Accordingly,  if  the  '  general  idea  of  something '
is  derived  by  abstraction  from  simple  ideas  of  sensation  and
...
which  this  something  supports.     How  then  does  the  general
idea  of  substance  or  '  soinething,'  as  derived,  differ  fi'om  the

82  GENERAL  INTRODUCTION.

idea  of  '  something,'  as  given  in  the  original  ideas  of  sensa-
tion and  reflection  from  which  the  sup230sed  process  of  ab-
straction starts  ?     What  can  be  said  of  the  one  that  cannot
be  said  of  the  other?     If  the  derived  general  idea  is  of
something  related  to  qualities,  what,  according  to  Locke,  are
the  original  ideas  but  those  of  qualities  related  to  something  ?
It  is  true  that  the  general  idea  is  of  something,  of  which
nothing  further  is  known,  related  to  qualities  in  general,  not
...
end — i.  e.  the  particular  something — turns  out   to  be   the
same  as  its  beginning.

Doctrine  of  40.  The  fact  is,  that  in  making  the  general  idea  of  sub-
abstraction       1  -I  J.-1-T  X«J.i?1X  /T_

incon-  stance  precede  particular  ideas  oi  sorts  oi  substances  (as  he
fistent  certainly  however  confusedly  does,  in  the  23rd  chapter  of
trine  of°"  ^^®  Second  Book,^  as  well  as  by  implication  in  his  doctrine
complex  of  modes.  Book  ii.  chap.  xii.  sec.  4),  Locke  stumbled  upon  a
*  ^^-  truth  which  he  was  not  aware  of,  and  which  will  not  fit  into
...
'  See  above,  pariigraph  35.

LOCKE'S   ACCOUNT   OF   ABSTRACT   GENERxVL   IDEAS.     33

Locke's  definition  of  abstraction  implies.  Throughout  his
prolix  discussion  of  '  substance  '  and  '  essence  '  we  find  two
opposite  notions  perpetually  cross  each  other :  one  that
knowledge  begins  with  the  simple  idea,  the  other  that  it  be-
...
disguises  the  confusion  of  these  two  notions,  is  to  be  found  fusion
in  the  use  of  the  word  '  particular,'  which  is  sometimes  used   use*of '
for  the  mere  individual  having  no  community  with  anything    '  particu-
...
complex  idea ;  and  the  thing  as  the  collection  of  the  proper-
ties which  the  simple  idea  '  reports,'  all  are  merged  by  Locke
under  the  one  terra  '  particulars.'  As  the  only  consistency
...
42.  '  General  and  universal  belong  not  to  the  real  existence  Locke  s
of  things,  but  are  the  inventions  and  creatures  of  the  under-   'iccount  of
standing,  made  by  it  for  its  own  use,  and  concern  only  signs,   general
whether  words  or  ideas.     Words  are  general  when  used  for  ideas,
...
'  Cf.    Book   ii.   chap,   xxiii.   see.  37.  of  the  idea?  which  make  up  our  complex

'  Most  of  the  simple  ideas  that  make  up  idea  of  gold  .  .  .  are  nothing  else  btit

our  complex   ideas   of  substances  are  so  many  relations  to  other  substances,'
only  powers  .  .  .  e.  g.  the  greater  part
...
those  names  the  signs  ?  And  what  are  the  essences  of  those
...
ranked  under? '  (Book  iii.  chap.  iii.  sees.  11  and  13.)
•Things  43.  In  the  first  of  these  remarkable  passages  we  begin

not  geue-  -vvith  the  familiar  opposition  between  ideas  as  '  the  creatures
of  the  mind '  and  real  things.  Ideas,  and  the  words  which
...
reality,  '  general  and  universal  are  mere  inventions  and
...
things,'  '  horse '  and  '  cruelty  '  a.bstract  general  ideas  to
which  these  are  found  to  agree.

44.  One   antithesis   is  certainly    maintained    throughout  Generality
these   passages — that    between    'real    existence    which    is  ^qjJ^o^^u
always  particular,  and  the  workmanship  of  the  mind,'  which  mind.

*  invents '  generality.  Eeal  existence,  however,  is  ascribed
(a)  to  things  themselves,  (b)  to  words  and  ideas,  even
those  which  become  of  general  signification,  (c)  to  mixed
modes,  for  in  the  proposition  *  this  is  justice,'  the  '  this '
must  represent  a  mixed  mode.  (Cf.  ii.  xii.  5.)  The  charac-
...
being  mere  individuals,  are  reall}^  existent ;  and  conversely,
...
any  one  of  a  multitude  oi  single  (not  necessarily  simple)  ideas,
...
Apart  from  this  relation,  it  would  seem,  or  in  their  mere
singleness,  even  ideas  of  mixed  modes,  e.g.  this  act  of  justice,
may  have  real  existence.

45.  The  result  of  Locke's  statement,  thus  examined,  The  result
clearly  is  that  real  existence  belongs  to  the  present  momen-  is,  that
tary  act  of  consciousness,  and  to  that  alone.  Ascribed  as  it  ^f  eacl/'"^
is  to  the  '  thing  itself,'  to  the  idea  which,  as  general,  has  it  not,  moment  is
...
the  mind.'     As  little  can  it  belong  to  the  content  of  any  idea,

since  this  is  in  all   cases  constituted  by  relation  to  other

ideas.     Thus  if  I  judge  '  this  is  sweet,'  the  real  existence  lies

d2

36

GE^TIRAL   INTRODUCTION.
...
lu  tlie  simple  '  this,'  in  tlie  mere  form  of  presentation  at  an
individual  now,  not  in  the  relation  of  this  to  other  flavours
...
related  to  other  things  which  we  have  called  '  this,'  and  the
...
relations  or  in  their  generality  are  ideas  '  significant.*

46.  He  was  not  the  man,  however,  to  become  speechless
out  of  sheer  consistency.  He  has  a  redundancy  of  terms
and  tropes  for  disguising  from  himself  and  his  reader  the
...
relation  of  similitude  among  things  can  occasion  the  siiperin-
duction ;  and  again  how  it  happens,  if  all  generality  of  ideas
is  a  fiction  of  the  mind,  that  *  things  are  found  to  agree  with

AMBIGUITY   OF  THE   TERM   '  PARTICULAE.'  87

general  ideas.'  How  can  the  real  existence  called  '  this  '  or
'  that,'  which  only  really  exists  so  far  as  nothing  can  be
said  of  it  but  that  it  is  '  this  '  or  '  that,'  agree  with  anything
whatever?  Agreement  implies  some  content,  some  deter-
mination by  properties,  i.e.  by  relations,  in  the  things
...
47.  Such  questions  did  not  occur  to  Locke,  because  while  Tlie  ■  par-
assertinof  the  mere  individuality  of  things  existent,  and  the  ticular '

M'as  to  liim

simplicity  of  all  ideas   as   given,  i.e.  as  real,   he  never  fully  the  indi-
recognised  the  meaning  of  his   own  assertion.     Under  the  viduai
shelter  of  the  ambiguous  'particular'  he  could  at  any  time  by  general
substitute  for  the  mere  individual  the  determinate  individual,   relations.
...
dividual) thing  with  a  general  idea,  he  thinks  of  '  this '  a&
...
parcel  of  that  sort  of  substance  we  denote  by  the  word  gold,
...
'  'All  impressions  are  perishing  f-xistencos.' — HniE.     See  l)eIow,  paragraph  208.
...
and  fixedness  .  .  .  another  its  ductility  and  solubility  in
...
from  any  action  of  the  understanding,  which  then  proceeds
...
labour.  The  qualities  are  assumed  to  be  already  found  by
the  understanding  and  found  as  in  a  thing  ;  otherwise  the
understanding  could  not  abstract  them  from  it.  Why
...
48.  '  The  complex  idea  of  a  species,'  spoken  of  in  the
passage  last  quoted,  corresponds  to  what,  in  Locke's  theory
of  substance,  is  called  the  '  idea  of  a  particular  sort  of  sub-
stance.' In  considering  that  theory  we  saw  that,  according
to  his  account,  the  beginning  of  the  process  by  which  the
'  abstract  idea  of  substance '  was  formed,  was  either  that
...
idea  has  been  formed.  In  the  passage  now  before  us  there
is  no  direct  mention  of  the  abstraction  of  the  '  substratum,'
as  such,  but  only  of  the  quality,  and  hence  there  is  no
ambiguity  about  the  paralogism.  It  is  not  a  mere  '  some-
thing '  that  the  man  '  lights  upon,'  and  thus  it  is  not  thia
...
!^IERE   INDR^IDUAL   AND   QUALIFIED  INDIVIDUAL.      S9

given  in  the  real  thing ;  or  as  he  states  it  in  terms  of  the
multiplication  table  (Book  ii.  chap.  xxxi.  sec.  10),  '  some  who
have  examined  this  species  more  accurately  could,  I  believe,
...
hundred  times  as  many  ideas  go  to  the  complex  idea  of  gold,
...
Locke's  statement  elsewhere  (Book  ii.  chap  xxiii.  sec.  37),
...
and  the  greater  the  fulness  which  they  constitute,  the  further
...
49.  The  real  thing  and  the  creation  of  the  understanding  ygt.  h^-
thus  change  places.     That  which  is  given  to  the  understand-  cording  to
...
superinduced.     Nor  is  it  the  mere  present  feeling,  which  has  ^^J^^f
'  by  the  mind  of  man  '  to  be  made  '  significant,'  or  represen-  tliought.
...
now  appears  as  detaching  fragments  from  the  fulness  of  the

40  GENERAL   INTRODUCTION.

real  to  recombiiie  tliem  in  an  '  abstract  essence  '  of  its  own.
Instead  of  adding  complexity  to  the  simple,  it  subtracts  from
the  complex.
Hummary  50.  To  gather  up,  then,  the  lines  of  contradiction  which
of  the  traverse  Locke's  doctrine  of  real  existence  as  it  appears
contradic-  in  his  account  of  general  and  complex  ideas  : — The  idea
tions.  Qf   substance  is   an   abstract  general   idea,    not   given    di-

rectly in  sensation  or  reflection,  but  '  invented  by  the  un-
derstanding,' as  by  consequence  must  be  ideas  of  particular
sorts  of  substances  which  presuj)pose  the  abstract  idea.  On
the  other  hand,  the  ideas  of  sensation  and  reflection,  from
which  the  idea  of  substance  is  abstracted,  and  to  which  as
real  it  as  an  invention  is  opposed,  are  ideas  of  '  something,'
and  are  only  real  as  representative  of  something.  But  this
idea  of  something  =  the  idea  of  substance.  Therefore  the
...
the  ideas  of  sensation  or  reflection  ft-om  which  it  is  afterwards
abstracted,  i.e.  separated.  But  in  such  conjunction  it  con-
stitutes the  ideas  of  particular  sorts  of  substances.  There-
fore these  latter  ideas,  which  yet  we  '  come  to  have  '  after
...
relations,  and  the  community  which  they  constitute,  really
exist.  On  the  other  hand,  mere  individuals  alone  really
exist,  while  relations  between  them  are  superinduced  by  the
mind.  Once  more,  the  simple  idea  given  in  sensation  or
reflection,  as  it  is  made  for  not  hy  us,  has  or  results  from  real
...
they  are  related  as  qualities.  It  thus  presupposes  at  once
...
ABSTRACT  AND   COIIPLEX  IDEAS,  41
...
tinguishing   between   the   complex   and   confused,  between  ^^^  ^^

°  .     °  .  ■'■  ...  overcome

abstraction  and  analysis.    We  may  say  that  what  is  originally  without
given  in  experience  is  the  confused,  which  to  us  is  simple,  or  violence  ^
in  other  words  has  no  definite  content,  because,  till  it  has  funda-
been  analysed,  nothing  can  be  said  of  it,  though  in  itself  it  mental
is   infinetely  comjjlex;  that  thus  the  process,  which  Locke
roughly  calls  abstraction,    and  which,   as    he    describes    it,
...
that  the  names  of  simple  ideas  are  undefinable  (Book  iii.
...
necessary  to  constitute  even  the  beginnings  of  knowledge,  he
...
standing.
As  real            62.  Tlius  invested,  it  is  already  substance  or  symbolical  of
th^^^^^ni^^l     substance,  not  a  mere  feeling  but  a  felt  thing,  recognised
idea  car-      either  under  that  minimum  of  qualification  which  enables  us
rieswithit  j^^yq\j  to  say  that  it  is  'something,'  or  (in  Locke's  language)
relation  of  abstract  substauce,  or  under  the   greater   complication   of
cause.         qualities  which  constitutes  a  'particular  sort  of  substance' —
gold,  horse,  water,  &c.     Eeal  existence  thus  means  substance.
...
*  If  sugar  produce  in  us  the  ideas  which  we  call  whiteness
...
ihe  idea  so  produced  is  a  real  idea  (and  not  a  fiction  of  the
mind,  which  has  no  power  to  produce  any  single  idea),  and

'  Locke  only  states  this  explicitly  of  which  means  that  they  are  brought  into
...
that  large  tribe  of  ideas,  comprehended  sary  to   constitute  the   beginnings    of

under  relation.'     (Book  ii.  chap.  xi.  sec.  knowledge,  according  to  Locke,  appears

4.)    It  is  clear,  however,  that  the  same  from  Book  ii.  chap.  xi.  sec.  15,  taken  in

remark  must  apply  to  the  '  discernment  connection  with  what  precedes  in  that

of  ideas,'  which  is  strictly  correlative  chapter.
to  comparison,  and  to  their  composition.

SUBSTANCE   AND   CAUSE.  43

cannot  but  be  adequate  ....  and  so  all  simple  ideas  are
adequate.'  (Book  ii.  chap.  xxxi.  sec.  2.)  The  sugar,  which
is  here  the  '  archetype '  and  the  source  of  reality  in  the  idea,
is  just  what  Locke  elsewhere  calls  '  a  particular  sort  of
substance,'  as  the  '  somethinp^ '  from  which  a  certain  set  of
...
but  a  power  to  produce  it.  (Book  ii.  chap.  viii.  sec.  28,  and
c.  xxiii.  37.)

53.  Tn  calling  a  sensation  or  idea  the  product  of  a  power,   Correia-
substance  is  presupposed  just  as  much   as   in  calling  it  a  cause  and
sensible  quality ;  only  that   with  Locke  '  quality  '  conveyed  substauce.
the  notion  of  inherence  in  the  substance,    power   that   of
relation  to  an  effect  not  in  the  substance  itself.     *  Secondary
qualities  are  nothing  but  the  powers  which  substances  have  to
produce  several  ideas  in  us  by  our  senses,  which  ideas  are

not  in  the  things  themselves,  otherwise  than  as  anything  is
in  its  cause.'  (Book  ii.  chap,  xxiii.  sec.  9.)  '  Most  of  the
...
(Book  II.  chap,  xxiii.  sec.  37,  and  xxxi.  8.)  That  this  implies
...
reality.  If  the  consciousness  of  reality  is  implied  in  the  be-
ginning of  knowledge,  so  must  the  correlative  ideas  be  of
cause  and  substance.

54.  On  examining  Locke's  second  rehearsal  of  his  theory  flow  do  we
in  the  fourth  book  of  the  Essay— that  '  On  Knowledge'—   \^°^J^^!:
we  are  led  to  this  result  quite  as  inevitably  as  in  the  book  respond  to
'  On  Ideas.'     He  has  a  special  chapter  on  the    '  reality  of  [f^^^'^^y*^^
human  knowledge,'  where  he  puts  the  problem  thus  : — '  It  is

'  Book  II.  chap.  xxi.  sec.  3.

answer.

44  GENEPt.\L   INTRODUCTION.

Locke's  evident  the  mind  knows  not  things  immediately,  but  only  by
the  intervention  of  the  ideas  it  has  of  them.  Our  knowledge
therefore  is  real  only  so  far  as  there  is  a  conformity  between
our  ideas  and  the  reality  of  things.  But  what  shall  be  here
the  criterion?  How  shall  the  mind,  when  it  perceives  no-
thing but  its  own  ideas,  know  that  they  agree  with  things
themselves  ?  '  (Book  iv.  chap.  iv.  sec.  3.)  It  knows  this,  he
...
which  they  are  fitted  to  produce  in  us ;  whereby  we  are  en-
...
chap.  ii.  sec.  14.)  This,  however,  he  distinguishes  from  two
...
REALITY  OF  KNOWLEDGE.  45

from  an  external  object  is  in  our  minds ;  this  is  intuitive
knowledge.  But  whether  there  be  anything  more  than  barely
...
minds,  when  no  such  thing  exists,  no  such  object  affects
their  senses.'     (Book  iv.  chap.  ii.  sec.  14.)

55.  It  is  clear  that  here  in  his  very  statement  of  the  ques-  it  assumes
tion  Locke  begs  the  answer.     If  the  intuitive  certainty  is  that  sim-

.  ,      ,  .  .      .  pie  ideas

tliat   '  the  idea  we  receive  from  an  external  object  is  m  our  are  con-
minds,'  *  how  is  it  possible  to  doubt  whether  such  an  object  sciousiy
exists  and  affects  our  senses  ?    This  impossibility  of  speaking  things  that
of  the  simple  idea,  except  as  received  from  an  object,  may  cause
...
56.  In  short,  with  Locke  the  simple  idea,  the  perception  Lively
of  existence  corresponding  to  the  idea,  and  the  judgment  of  ^^^^^  ^^^'
identity,  are  absolutely  merged,  and  in  mutual  involution,  they  must
sometimes  under  one  designation,  sometimes  under  another,  ^^  effects
...
is  given,  is  treated  as  involving  the  perception  of  existence,
and  the  reality  is  established.  If  in  turn  this  perception  is
distinguished  from  the  simple  idea,  and  it  is  asked  whether

'  I  do  not  now  raise  the  question,  'intuitive  certainty'  or  knowledge  ac-

What  are  here  the  ideas,  which  must  be  cording    to     Locke's    definition.       See

immediately  perceived  to  agree  or  dis-  below,  paragraphs  59,  101,  and  147.
agree    in   order   to    m;ike   it  a  case  of

46  GENERAL  Ds'TRODUCTION.

the  correspondence  between  idea  and  existence  is  properly
matter  of  knowledge,  the  simple  idea  has  only  to  be  treated
as  involving  the  judgment  of  identity,  which  again  involves
that  of  existence,  and  the  question  is  answered.  So  in  the
context  under  consideration  (Book  iv.  chap.  ii.  sec.  14),  after
raising  the  question  as  to  the  existence  of  a  thing  corres-
...
We  as  plainly  find  the  diiFerence  there  is  between  any  idea
revived  in  our  minds  by  our  own  memory,  and  actually  com-
ing into  our  minds  by  our  senses,  as  we  do  between  any  two
...
knowledge.
Present  67.  With  that  curious  tendency  to  reduplication,  which  is

'  See  above,  paragraph  25.

TESTEVIONY   OF  THE  SENSES.  47

one  of  his  characteristics,  Locke,  after  devoting  a  chapter  to  P^®^.  .
the  '  reality  of  human  knowledge,'  of  which  the  salient  pas-  of  exist-
sage  as  to  simple  ideas  has  been  already  quoted,  has  another  8°ce.
upon  our  '  knowledge  of  existence.'  Here  again  it  is  the
...
have  reason  to  rely  on,  as  so  certain,  that  I  can  no  more
...
58.  Reasons  are  afterwards  sfiven  for  the  assurance  that  Reasons
Ihe  'perceptions'  in  question  are  produced  in  us  by  'exterior  ^^^j^^^^j
causes  affecting  our  senses.'  The  first  (a)  is,  that  '  those  must  be
that  want  the  organs  of  any  sense  never  can  have  the  ideas  trusted.
belonging  to  that  sense  produced  in  their  mind.'  The  nexb
(M,  that  whereas  'if  I  turn  my  eyes  at  noon  toward  the  suu.
...
I  cannot  avoid  the  ideas  which  the  light  or  the  sun  then  pro-
duces in  me ;'  on  the  other  hand,  '  when  my  eyes  are  shut  or
windows  fast,  as  I  can  at  pleasure  recall  to  my  mind  the  ideas
...
afterwards  we  remember  without  the  least  offence.  Thus
the  pain  of  heat  or  cold,  when  the  idea  of  it  is  revived  in
our  minds,  gives  us  no  disturbance ;  which,  when  felt,  "waa
...
them,  and  no  farther.  For  if  I  saw  such  a  collection  of
simple  ideas  as  is  wont  to  be  called  man,  existing  together
one  minute  since,  and  am  now  alone ;  I  cannot  be  certain
that  the  same  man  exists  now,  since  there  is  no  necessarv
connexion  of  his  existence  a  minute  since  with  his  existence
now.  By  a  thousand  ways  he  may  cease  to  be,  since  I  had
the  testimony  of  my  senses  for  his  existence.'  (Book  iv.
chap.  xi.  sec.  9.)

59.  Upon  the  '  knowledge  of  the  existence  of  things,'  thus
established,  it  has  to  be  remarked  in  the  first  place  that,
after  all,  according  to  Locke's  explicit  statement,  it  is  not
properly  knowledge.  It  is  '  an  assurance  that  deserves  the
name  of  knowledge '  (Book  iv.  chap.  ii.  sec.  14,  and  xi.  sec.  3),
yet  being  neither  itself  an  intuition  of  agreement  between
ideas,  nor  resoluble  into  a  series  of  such  intuitions,  the  de-

now    IS   KNOWLEDGE   OF   REALITY    POSSIBLE?        49

flnition  of  knowledge  excludes  it.  Only  if  existence  were
...
assurance  of  agreement  is  no  less  unmeaning  than  the  ques-
tion as  to  the  hiowledge  of  it.  The  raising  of  the  question
...
60.  As  usual,  Locke  disguises  this  difficulty  from  himself,  Locke's  ac-
because  in  answering  the  question  he  alters  it.    The  question,  theTesti-
as  he  asks  it,  is  whether,  given  the  idea,  we  can  have  posterior  mony  of
assurance  of  something  else  corresponding  to  it.     The  ques-  '*'^"^,®  ,  ,  •
tion,  as  he  answers  it,  is  whether  the  idea  includes  the  con-  question
sciousness  of  a  real  thing  as  a  constituent;  and  the  answer  '^.^.'^".•'"'
consists  in  the  simple  assertion,  variously  repeated,  that  it  super-
does.     It  is  clear,  however,  that  this  answer  to  the  latter  fl"o"s-.
...
IKirte  nostra — then  to  ask  if  the  idea  agrees  with  the  thing  is
...
idea)  doth  really  exist  and  hath  a  being  without  me,'  then
consciousness  of  existence — outward,  permanent,  substantive,
...
and  causative  existence — is  involved  in  the  idea,  and  no  ul-
terior question  of  agreement  between  idea  and  existence  can
properly  arise.  But  unless  the  simple  idea  is  so  interpreted,
the  senses  have  no  testimony  to  give.  If  it  is  so  interpreted,
no  extraneous  '  reason  to  rely  upon  the  testimony  '  can  be
...
ledge to  the  latter,  it  seems  only  to  turn  up  as  an  afterthought.
In  the  account  of  the  reality  and  adequacy  of  ideas  it  does
...
sec.  1),  'Perception,'  '  Eetention,'  and  'Discerning'  are  all
...
scribed in  terras  which  imply  activity.  In  the  '  confirmations'
...
produced  is  the  work  of  a  thing,  which  must  exist  in  rerum
naturd,  and  by  way  of  a  fourth  '  confirmation  '  the  man  who
doubts  this  iii  the  case  of  one  sensation  is  invited  to  try  it  in
another.  If,  oh  seeing  a  fire,  he  thinks  it  '  bare  fancy,'  i.  e.
doubts  whether  his  idea  is  caused  by  a  thing,  let  him  put  his
hand  into  it.  This  last  '  confirmation  '  need  not  be  further
noticed  here,  since  the  operation  of  a  producing  thing  is  as

ANTITHESIS   BETWEEN  ^^'ORKS   OF   NATUIIE   AMD   J^IAN.  51

certain  or  as  doubtful  for  one  sensation  as  for  anotlier.'  Two
...
'  To  feel  the  object,  in  th?  sense  of  we  come    to  consider  his    doctrine  of
touching  it,  had  a   special  significjince  '  real  essence,' as  constituted  by  primary
for  Locke,  since  touch  with  him  was  the  qualities    of   bodj.      See    below,   para-
primary   'revelation'    of  body,  as   the  graph  101.
solid.     More  will   be  said  of  this  when

£2

BOSTON  UNIVERSITY
rni  I  FP.F  OF  LIBERAL  ARTS

52

GENERAL  mTllODUCTION.
...
chap.  xxi.  sec.  3,  and  chap.  xxv.  sec.  8),  'is  not  contained  in
...
any  particular  simple  idea,  which  did  not  before  exist,  hath
...
tify '  to  its  being  real,  i.  e.  (in  Locke's  sense)  not  the  work
of  man.
...
other  thinofs  in  an  order  of  nature,  and

causing

an  infinite

series  of  resemblinsr  sensations  to  which  a  common  name  is
...
TESTIMONY  TO  EXISTENCE  IS  NO  TESTIMONY.  63

no  farther  than  such  testimony.  This  statement,  taken  by
itself,  is  ambiguous.  Does  it  mean  that  sensation  testifies
to  the  momentary  presence  to  the  individual  of  a  continuous
...
wont  to  be  called  man,  existing  together  one  minute  since,
...
chap.  xi.  sec.  9.)  At  first  sight,  these  words  might  seem  to-
decide  that  the  existence  is  merely  coincident  with  the  pre-
sence of  the  sensation — a  decision  fatal  to  the  distinction
between  the  real  and  fantastic,  since,  if  the  thing  is  only
...
65.  In  the  very  sentence,  however,  where  Locke  restricts  such  re-
the  testimony  of  sensation  to  existence  present  along  with  it,  stnctiuu,
he  uses  language  inconsistent  with  this  restriction.     The  tiiined,
particular  existence  which  he  instances  as  '  testified  to  '  is  "^^^j^
that  of  '  such  a  collection  of  simple  ideas  as  is  wont  to  be  testimony
called  man.'     But  these  ideas  can  only  be  present  in  succes-  unm«an-
sion.     (See  Book  ii.  chap.  vii.  sec.  9,  and  chap.  xiv.  sec.  3.)
...
minute  ago  ?     How  can  the   '  collection  of  ideas  wont  to  be
called  man,'  as  co-existing,  be  formed  at  all  ?  and,  if  it  cannot,
how  can  the  present  existence  of  an  object  so-called  be  tes-
tified to  by  sense  any  more  than  tlie  past?     The  same  doc-
trine, which  is  fatal  to  the  supposition  of  '  a  necessar}'^  con-
nexion between  the  man's  existence  a  minute  since  and  his

64  GENERAL   INTRODUCTION.

existence  now,'  is  in  fact  fatal  to  the  supposition  of  hia
existence  as  a  complex  of  qualities  at  all.  It  does  not  merelj
mean  that,  for  anything  we  know,  the  man  may  have  died.
Of  course  he  may,  and  yet  there  may  be  continuity  of  existence
according  to  natui'al  laws,  though  not  one  for  which  we
...
times.
But  it  is  ^^'  ^^^  short,  as  we  have  seen  the  simple  idea  of  sensation

not  main-     emerge  from  Locke's  inquiry  as  to  the  beginning  of  know-
tained :  the  \q^q-q  transformed  into  the  iudffment, '  I  have  an  idea  different

testimony  '^  .  .  .

is  to  opera-  from  otlicr  ideas  which  I  did  not  make  for  myself,'  so  now
tionof  per-  fj.Q,jj  ^]^q  inquiry  as  to  the  correspondence  between  knowledf^e

manent  ,,..  ,.  n  ^  •

identical  and  reality  it  emerges  as  the  consciousness  of  a  thing  now
things.  acting  upon  me,  which  has  continued  to  exist  since  it  acted
on  me  before,  and  in  which,  as  in  a  common  cause,  have
existed  together  powers  to  affect  me  which  have  never  affected
ine  together.  If  in  the  one  form  the  operation  of  thought
in  sense,  the  '  creation  of  the  understanding  '  within  the  sim-
ple idea,  is  only  latent  or  j^otential,  in  the  other  it  is  actual
and  explicit.  The  relations  of  substance  and  quality,  of
cause  and  effect,  and  of   identity  — all  'inventions  of   the

TESTIMONY  TO  OPERATION   OF  PERMANENT  THINGS.   55«

mind ' — are  necessarily  involved  in  tlie  immediate,  sponta-
neous testimony  of  passive  sense.

67.  It  will  be  noticed  that  it  is  upon  the  first  of  these,  the  Locke's^
relation  of  substance  and  quality,  that  our  examination  of  ^^rek-"
Locke's  Essay  has  so  far  chiefly  gathered.     In  this  it  follows  tions  of
the  course  taken  by  Locke  himself.     Of  the  idea  of  substance,  ^"^^^^
eo  nomine,  he  treats  at  large :  of  cause  and  identity  (apart

from  the  special  question  of  personal  identity)  he  says  little.
So,  too,  the  *  report  of  the  senses '  is  commonly  exhibited  as
announcing  the  sensible  qualities  of  a  thing  rather  than  the
agency  of  a  cause  or  continuity  of  existence.  The  difference,
of  course,  is  mainly  verbal.  Sensible  qualities  being,  as  Locke
constantly  insists,  nothing  but  '  powers  to  operate  on  our
senses  '  directly  or  indirectly,  the  substance  or  thing,  as  the
...
68.  The  relation  of  cause  and  effect,  according  to  Locke's  That  from
general  statement  as  to  relation,  must  be  something  '  not  con-  J^g^J^rivee
tained  in  the  real  existence  of  things,  but  extraneous  and  idea  of
superinduced.'     (Book  ii.  chap.  xxv.  sec.  8.)     It  is  a  '  com-  gypp^g^a**'
plex  idea,'  not  belonging  to  things  as  they  are  in  themselves,  it.
which  the   mind  makes  by  its  own  act.     (Book  ii.  chap  xii.
...
66  GENERAL   INTIIODUCTION.

dueed  by  the  ai^plication  of  a  certain  degree  of  heat,  we  call
...
substance  called  ashes,  i.e.  another  complex  idea,  consisting
...
their  qualities,  '  received  from  the  due  apjilication  or  opera-
tion of  some  other  being.'  Thereupon  we  infer,  what  is
simply  another  name  for  existence  thus  given  and  received,
a  relation  of  cause  and  effect.  Thus  not  only  does  the  datum
...
Kationalo  69.  Here  again  it  is  necessary  to  guard  against  the  notion
of  this  that  Locke's  obvious  petitio  lyrincipii  might  be  avoided  by
...
find  in  a  '  law  of  nature,'  Locke  found  in  '  things  '  or  '  sulj-
...
LOCKE'S  DOCTRINE  OF  CAUSE.  57

tions,  carrying  with  it  the  observation  that  the  changed  state
...
far  as  the  manifold  appearances  are  referred,  as  its  vicissi-
...
j)roduction  of  a  quality.  He  is  here,  however,  as  he  often
...
sensible parts'  (Book  iii.  chap.  iii.  sees.  18,  &c.),  governed
all  his  speculation,  and  rendered  to  him  what  he  here  calls
substance  virtually  a  mode,  and  its  production  properly  a
'  vicissitude.'

70.  We  thus  find  that  it  is  only  so  far  as  simple  ideas  are
referred  to  things — only  so  far  as  each  in  turn,  to  use  Locke's  cau^a  has
instance,  is  regarded  as  an  appearance  '  in  a  substance  which  !"'  '"^  P"^
was  not  in  it  before  ' — that  our  sensitive  experience,  the  sup-  tivo  ex-
posed datum  of  knowledge,  is  an  experience  of  the  vicissi-  pp"ieiice  in
tudes  of  things ;  and  again,  that  only  as   an  experience   of  p.^^^  j-,,
such  vicissitude  does  it  furnish  the  '  observation  from  which  it
we  get  our  ideas  of  cause  and  efi'ect.'     But  the  reference  of  a
sensation  to  a  sensible  thing  means  its  reference  to  a  cause.
lii   other  words,  the   invented  relation  of  cause  and  effect
must  be  found  in  the  primary  experience  in  order  that  it  may
be  got  from  it. '

'  Locke's  contradiction  of  himself  in  it  his  account  of  the  idea  of  power,

rffrard  to  this  relation   might  be  cxhi-  The  two  are  precisely  similar,  the  idea

bited  in  a  tsLill  more  striking  light  by  of  power  bf:inir  represented  as  got  by  a

putting  side  by  side  with  hie  account  uf  notice  of  the  alteration  of  simple  idea.8
...
71.  The  same  holds  of  that  other  '  product  of  the  mind,*
the  relation  of  identity.  This  '  idea  '  according  to  Locke,  is
formed  when,  '  considering  anything  as  existing  at  any  de-
termined time  and  place,  we  compare  it  with  itself  existing
...
conclude  that  whatever  exists  an^'where,  at  any  time,  excludes
...
about  the  principium  individuationis,  which  he  decides  is
...
and  no  other.'     (Book  ii.  chap,  xxrii.  sees.  1 — 3).

72.  It  is  essential  to  bear  in  mind  with  regard  to  identity,
as  with  regard  to  cause  and  effect,  that  no  distinction
according  to  Locke  can  legitimately  be  made  between  the
relation  and  the  idea  of  the  relation.  As  to  substance,  it  is
true,  he  was  driven  in  his  controversy  with  Stillingfleet  to
distinguish  between  '  the  being  and  the  idea  thereof,'  but
in  dealing  with  relation  he  does  not  attempt  any  such  vio-
lence to  his  proper  system.     Between  the  'idea'  as  such  and

in  thing*  without  (Book  ii.  chap.  sxi.
...
ought  to  be  complex,  he  reckons  it  a
simple  and  original  one,  and  by  using  it
interchangeably  with  '  sensible  quality'
makes  't  a  primary  datum  of  sense.

mS  DOCTRINE  OF   IDENTITY.  59
...
relation,  is  formed  upon  consideration  of  things  as  existing  ^en^ed' re-
in a  certain  way,  this  is  naturally  understood  to  mean — indeed,  forms  the
otherwise  it  is  unmeaning — that  the  things  are  first  Jcnown  as  'very  l,eing
...
having  at  whatever  cost  of  self-contradiction  to  make  his
theory  fit  the  exigencies  of  language,  virtually  adopts  the
latter  alternative,  though  with  an  ambiguity  of  expression
which  makes  a  definite  meaning  difiicult  to  elicit.  We  have,
...
bore  clearly  im^jlied  that  '  things '  or  '  ideas'  exist,  i.e.  are

'  See  aliovo,  par.-igraph  25.

of  tilings.'

60  GENER.1L  INTRODUCTION.

given  to  us  in  the  spontaneous  consciousness  which  we  do
not  make,  as  each  one  and  the  same  throughout  a  multiplicity
of  times.  This,  again,  means  that  the  relation  of  identity  or
sameness,  i.e.  unity  of  thing  under  multiplicity  of  appearance,
...
name  for  the  simple  idea),  resolves  itself  into  a  relation,
which  it  requires  'consideration  by  the  mind'  to  constitute.
Locke  fails  '^'^'  "^^^^  process  of  Self- Contradiction,  by  which  a  '  creation
todis-  of  the  mind'  finds  its  way  into  the  real  or  given,  must  also
between  appear  in  a  contradictoiy  conception  of  the  real  itself.  Kept
identity  pure  of  all  that  Locke  reckons  intellectual  fiction,  it  can  be
anitv"^^^  nothing  but  a  simple  chaos  of  individual  units  :  only  by  the
...
to  ideas  which  are  the  same  at  different  times,  he  goes  on  to
speak  of  a  thing  as  the  same  with  itself,  at  a  single  instant.
So,  too,  by  the  principium  individuationis,  he  understands
*  existence  itself,  which  determines  a  being  of  any  sort  to  a
particular  time  and  place.'  As  it  is  clear  from  the  context
that  by  the  principium  individuationis  he  meant  the  source
...
'  See  above,  paragrnphs  43,  and  the  following.

CAN  IDENTITY   BE   HEAL?  61'

anmoaning  ?  In  fact,  Locke,  having  excluded  it  in  his  defi-
nition, covertly  bring-s  it  back  again  in  his  instance,  which  is
that  of  'an  atom,  i.e.  a  continued  body  under  one  immutable
superficies,  existing  in  a  determined  time  and  place.'  This,
'  considered  in  any  instant  of  its  existence,  is  in  that  instant
the  same  with  itself.'  But  it  is  so  because — and,  if  we  suppose
the  consideration  of  plurality  of  times  excluded,  only  because
— it  is  a  '  continued '  body,  which  implies,  though  its  jilace  be
...
lie  really  thought  of  the  identical  body  under  a  plurality  of
times  ex  parte  post,  if  not  ex  parte  ante.

75.  But  how  is  this  continuity,  or  sameness  of  existence  in  Feelings
plurality  of  times  or  spaces,  compatible  with  the  constitution  are  tho
of  '  real  existence '  by  mere  individua  ?     The  difficulty  is  the  do  not
same,  according  to  Locke's  premisses,  whether  the  simple  admit  of
ideas   by  themselves  are  taken  for   the  real  individua,  or  How 'then
whether  each  is  taken  to  represent  a  single  separate  thing,  can  iden-
In  his  chapter  on  identity  he  expressly  says  that  'things  whose  j-e^l?^
existence  is  in  succession  '  do  not  admit  of  identity.     Such,
he  adds,  are  motion  and  thought ;  '  because,  each  perishing
...
'  It  is  true  that  in  this  place  Locke  tlie  mind'  if  there  is  to  be  any  either

distinguishes   between   the   'suggestion  sensation  or  idea  at  all  (Book  ii.  chap,

by  our  senses' of  the  idcca  of  succession,  ix.  sees.  3  and  4),    the  distinction  be-

und  that  which  passes  in  our  'minds,'  tween  the  'suggestion  by  cur  senses*

by  which  it  is  '  more  constantly  oifered  and  what '  passes  in  our  minds'  cannot

us.'     But  since,  according  to  him,  the  be  maintained,
idea  of  sensation  must  be  'produced  in

62

GENERAL    IKTRODUCTION.
...
when  it  begins,  can  be  stronger  tlian  the  above.  If  ^  ideas'
...
76.  This,  it  may  be  said,  is  just  the  conclusion  that  was
wanted  in  order  to  make  Locke's  doctrine  of  the  particular
relation  of  identity  correspond  with  his  general  doctrine  of
the  fictitiousness  of  relations.  To  complete  the  consistency,
...
dominion  of  language — a  dominion  which,  as  he  did  not
...
stance it  renders  '  perishing '  ideas  into  qualities  by  which
objects  may  be  discerned.  (Book  ii.  chap.  xi.  sec.  1.)  As
...
77.  '  The  very  being  of  things,'  let  it  be  noticed,  according
to  what  Locke  reckoned  their  '  real,'  as  distinct  from  their

LOCKE'S  DOCTIilNE  OF  ESSENCE.  68
...
tinued body,'  brings  us  upon  the  doctrine  of  matter  and  its
...
also  appear.  The  question  will  then  be,  whether  by  the
same  showing  the  ideas  of  body,  of  the  self,  and  of  God,  can
be  other  than  fictions,  and  the  vyray  will  be  cleared  for  Hume's
philosophic  adventure  of  accounting  for  them  as  such.

78.  In   Locke's   doctrine   of    '  ideas   of    substances,'  the  This  re-
'  tliinsf '  appeared  in  two  inconsistent  positions  :  on  the  one  P^^*^^  ^^*

)nconsi8»

hand,  as  that  in  which  they  *  are  found ; '  on  the  other,  as  tency
that  which  results   from   their  concretion,  or   which,  such  ^°.^°^ '°
concretion  having   been   made,  we   accustom   ourselves   to  trine  of
suppose  as  its  basis.     This  inconsistency,  latent  to  Locke  substance.
...
79.  This  latter  theory  has  so  far  become  part  and  parcel  Plan  to  be
of  the  '  common  sense '  of  educated  men,  that  it  might  seem  follo^«^«
scarcely  to  need  restatement.     It  is  generally  regarded  as
completing  the  work,  which  Bacon  had  begun,  of  transferring

•  See  above,  piiragraph  20.

64  GENERAL   INTRODUCTION.

philosophy  from  the  scholastic  bondage  of  words  to  the  frnitful
discipline  of  facts.  In  the  process  of  transmission  and
popular  adaptation,  however,  its  true  significance  has  been
...
possible  function  of  knowledge.  It  will  be  well,  then,  in
...
which  he  disjxuised  it  from  himself.
What  80.  The  essence  of  a  thing  with  Locke,  in  the  only  sense

Locke  iji  which  we  can  know  or  intelligibly  speak  of  it,  is  the
by  cs-  meaning  of  its  name.  This,  again,  is  an  *  abstract  or  general
Wince.'  idea,'  which  means  that  it  is  an  idea  'separated  from  the
...
made,  and  alone  sufl&ces  to  constitute  an  'abstract  idea,'
even  though,  as  is  the  case  with  the  idea  of  the  sun,  there  is
only  one  '  particular  substance  '  to  agree  with  it.  (Book  iii.
...
•  Book  III.  chap,  iii,  sec.  7,  at  the  end.

NOJUINAL  AND  REAL  ESSENCE.  66

idea,  to  Avliicli  a  name — e.g.  man — is  annexed,  and  to  wliicli
as  a  *  species '  or  '  standard  '  other  particular  existences,  on
being  '  found  to  agree  with  it,'  may  be  referred,  so  as  to  be
called  by  the  same  name.  These  ideas  then,  '  tied  tog-ether
by  a  name,'  form  the  essence  of  each  particular  existence,  to
which  the  same  name  is  applied  (Book  iii.  chap.  iii.  sees.  12
and  the  following.)  Such  essence,  however,  according  to
...
'  real  essence  '  of  the  particular  beings ;  an  essence,  how-
ever, of  which  we  can  know  nothing.  (Book  iii.  chap.  vi.
sec.  21,  and  ix.  sec.  12.)

81.  It  is  the  formation  of  'nominal  essences  '  that  renders  0,^^   ^^
general    propositions   possible.      '  General   certainty,'    says  nominal
Locke,  '  is  never  to  be  found  but  in  our  ideas.     Whenever  ^iTiT"'^
we  go  to  seek  it  elsewhere  in  experiment  or  observation  general
without  us,  our  knowledge  goes  not  beyond  particulars.     It  ^o^jfg'^pg.
...
Locke,  however,  having  allowed  himself  in  the  supposition
...
the  original  distinction  between  simple  aixd  complex  ideas,
...
*  Bookni.  cliap.  iii.  sec.  13.  ^  Cf.  Book  iv.  chap.  iii.  sec.  31.
...
the  former  form  that  the  idea,  however  simple,  reports,  and
...
Locke, '  it  is  a  knowledge  which  consists  in  a  consciousness,
...
the  mind  '  agreement  or  disagreement  with  some  other  ab-
...
thinof,  being  already  included   within  the  meaning  of  its

'&?

name ;  e.g.  '  a  rose  has  leaves.'  But  as  expressing  a  relation
...
sec.  4)  ho  distinctly  speaks  of  the  pro-
...
12),  the  simple  idea,  as  abstract,  is
spoken  of  as  a  nominal  essence.

NO  GENERAL  PROPOSITIONS  ABOUT  MATTER  OF  FACT.  67

instance  '  (Book  iv.  cliap.  vi.  sec.  7)  :  i.e.,  though  the  only
channels  by  which  we  can  reach  real  existence,  they  can
never  tell  more  than  the  presence  of  this  or  that  sensation
...
tainty that  the  real  thing  or  '  parcel  of  matter '  (Book  iii.
chap.  iii.  sec.  18),  which  now  causes  the  sensation  of  (and
thus  is)  red,  may  not  at  another  time  cause  the  sensation  of
(and  thus  he)  blue.'

83.  We  thus  come  upon  the  crucial  antithesis  between  How  then
...
*  Cf.  Book  rv.  chap.  vi.  sec.  5.     '  If  simple  ideas  have  been  found  to  coexist

we  could  certainly  know  (which  is  im-  in  any  substance,  these  we  may  with

possible)  where  a  real  essence,   which  confidence  join  together  again,  and  so

we  know  not,  is — e.g.  in  what  parcels  make  abstract  ideas  of  substances.    For

of  matter  the  real  essence  of  gold  is;  whatever  have  once  had  an  union  in

yet  could  we  not  be  sure,  that  this  or  nature,  may  be  united  again.'     In  all

that  quality  could  with  truth  be  affirmed  such  passages,  however,  as  will  appear

of  gold;  since  it  is  impossible  for  us  to  btlow,  the  strict  opposition  between  the

know  that  this  or  that  quality  or  idea  real  and  the  mental  is  lost  sight  of,  the

has  a  necessary  connexion  with  a  real  'nature'  or  '  substance,' in  which  ideas

essence,  of  which  we  have  no  idea  at  'have  a  union,' or  are  '  found  to  coexist,'

all.'  being  a  system  of  relations  which,  ac-

Several  passages,  of  course,  can  be  cording  to  Locke,  it  requires  a  mind  to

adduced  from  Locke  which  are  incon-  constitute,  and  thus  itself  a  'nominal

sistent  with  the  statement  in  the  text:  essence.'

e.g.  Book  rv.  chap.  iv.  sec.  12.       'To  -  Cf.   Book  iv.   chap.   iii.    sec.    29;

make  knowledge  real  concerning  sub-  Book  iv.  chap.  vi.  sec.  14;   Book  iv.
...
its  incompatibility  with  recognized  science  we  can  liave  no
...
ns  is  one  which,  while  professing  to  accept  Locke's  doctrine
...
84.  That,   so    far  as    any  inference   fi'om  past  to  future
uniformities  is  necessary  to  the  science  of  nature,  his  doctrine
does  more  than  justify   such   '  suspicion,'  is  plain  enough.
Does  it,  however,  leave  room  for  so  much  as  a  knowledge  of
past  uniformities  of  fact,  in  which  the  natural  philosopher,
accepting  the  doctrine,   might  probably  seek  refuge  ?     At
...
therein  do  so  ;  it  being  no  m.ore  necessary  that  water  should
...
tude of  past  matters-of-fact  about  water,  I  cannot  gather
them  up  in  any  general  statement  about  it  as  a  real  exist-
ence.    So   soon  as  I  do  so,  I  pass  from  water  as  a  real

IS  A  SCIENCE  OF  NATURE  POSSIBLE?  69

existence  to  its  '  nominal  essence,'  i.e.,  to  the  ideas  retained
in  my  mind  and  put  together  in  a  fictitious  substance,  to
wliicli  I  have  annexed  the  name  '  water.'  If  we  proceed  to
...
qualification  by  ideas  which,  as  retained  in  the  mind,  do  not
...
mean  (Book  iv.  chap.  ii.  sees.  1,  5,  and  9),  because  there  has
...
exist.'  First,  then,  must  disapj^ear  from  reality  the  '  some-
thing,' that  unknown  substratum  of  ideas,  of  which  the  idea
is  emphatically  '  abstract.'  This  gone,  we  naturally  fallback
upon  a  fact  of  co-existence  between  ideas,  as  being  a  reality,
thouffh  the  'thine: '  be  a  fiction.  But  if  this  co-existence  is
...
be  '  real  existences.'  (Book  ii.  chap.  xxv.  sec.  1.)  It  cannot
even  be  a  single  sensation  as  continuously  observed,  for  every
present  moment  of  such  observation  has  at  the  next  become
a  past,  and  thus  the  sensation  observed  in  it  has  lost  its
*  actuality,'  and  cannot,  as  a  '  real  existence,'  qualify  the
sensation  observed  in  the  next.  Restrict  the  '  real  exist-
...
tion,'  whicli  can  only  be  defined  by  opposition  to  an  idea
retained  in  the  mind,  and  at  every  instant  of  its  existence
it  lias  passed  into  tlie  mind  and  thus  ceased  really  to  exist.
Reality  is  in  perpetual  process  of  disappearing  into  the  un-
...
the  limbo  of  nominal  essence,  to  which  ideas,  as  abstract  or
...
86.  By  this  time  we  are  familiar  with  the  difficulties  which
this  antithesis  has  in  store  for  a  philosophy  which  yet  admits
that  it  is  only  in  the  mind  or  in  relation  to  consciousness
— in  one  word,  as  '  ideas ' — that  facts  are  to  be  found  at
all,  while  by  the  '  mind  '  it  understands  an  abstract  generali-
zation from  the  many  minds  which  severally  are  born  and
...
which  the  individual  cannot  help  being  conscious  at  each
...
one  in  a  number  (Book  ii.  chap.  vii.  sec.  7) — it  is  the  multitude

REAL  THAT  OF  WHICH  NOTHING  CAN  BE  SAID.       71
...
sent. Thus,  in  trying  to  get  at  what  shall  be  the  mere  fact  in
detachment  from  mental  accretions,  Locke  comes  to  what  is
still  consciousness,  but  the  merely  indefinite  in  consciousness.
He  seeks  the  real  and  finds  the  void.  Of  the  real  as  outside  con-
sciousness nothing  can  be  said ;  and  of  that  again  within  con-
sciousness, which  is  supposed  to  represent  it,  nothing  can  be
said.

87.  We  have  already  seen  how  Locke,  in  his  doctrine  of  Ground  of
secondary  qualities  of  substances,  practically  gets  over  this  ^1,^^°^^""
difiiculty ;   how  he  first   projects  out  of  the  simple  ideas,  actual
under  relations  which  it  requires   a   mind  to   constitute,  a  sensation

,      ,  .  Ill    '^""  ideas

cognisable  system  of  thmgs,  and  then  gives  content  and  in  the  mind
definiteness  to  the  simple  ideas  in  us  by  treating  them  as  is  itself  a
...
real  to  the  present  simjile  idea,  as  that  of  which  we  cannot
...
the  idea  (i.e.  feeling)  as  in  the  mind,  which  is  not  convertible
...
real  existence  from  whicli  the  feeling,  if  *  actual  sensation,*
is — if  merely  '  in  the  mind  '  is  not — derived.  Such  a  real
...
is  oj^posed  to  '  things  of  the  mind.'
...
gold  depend.'  (Book  iii.  chap.  vi.  sec.  2.)  Here  the  notion
...
become  familiar  in  the  doctrine  of  substance — that,  namely,

TVTIAT  IS   REAL  ESSENCE  ?  73

between  ideas  as  in  us  and  the  same  as  in  the  thing.  (Book  ii,
chap,  xxiii.  sees.  9  and  10. j  No  distinction  is  made  between
the  '  idea  in  the  mind  '  and  the  '  actual  sensation.'  The
ideas  in  the  mind  are  also  in  the  thing-,  and  thus  are  called
its  qualities,  though  for  the  most  part  they  are  so  only
secondarily,  i.e.  as  effects  of  other  qualities,  which,  as  coj)ied
...
produced.  (Book  ii.  chap.  xxxi.  sec.  10.)  Those  which
have  been  so  far  produced,  being  gathered  up  in  a  complex
idea  to  which  a  name  is  annexed,  form  the  '  nominal  essence '
of  the  thing.  Some  of  them  are  of  primary  qualities,  more
are  of  secondary.  The  originals  of  the  former,  the  powers  to
produce  the  latter,  together  with  powers  to  produce  an  in-
definite multitude  niore,  will  constitute  the  '  real  essence,*
...
the  case  of  mixed  modes  to  their  perjjetual  inadequacy  in
the  case  of  ideas  of  substances.  The  combination  in  the
one  case  is  artificially  made,  in  the  other  is  found  and  being
perj^etually  enlarged.  This  he  illustrates  by  imagining  the
...
this  archetype.'  (Book  iii.  chap.  vi.  sees.  46,  47.)  '  It  is
plain,'  however,  '  that  the  idea  made  after  this  fashion  by
this  archetype  will  be  always  inadequate.'

90.  The  nominal  essence  of  a  thing,  then,  according  to  about  r^a]
this  view,  beina'  no  other  than  the   '  complex  idea  of  a  sub-  ffsence  m

'  ^  -^  this  sense

74  GENERAL  INTRODUCTION.

there  may    stance,'  is  a  copj  of  reality,  just  as  the  simple  idea  is.     It  is
kno^ledgp    '  ^  picture  or  representation  in  the  mind  of  a  thing  that  does
...
tog-ether,  as  if  in  a  thing,  which  have  never  been  so  presented
...
existmg  together  constantly  in  things '    (Book  ii.   chap,  xxxii.
...
•  Book  II.  chap.  xxxi.  sec.  12.

TWO  MEANINGS  OF  REAL   ESSENCE.  75

consist!?  in  a  permanent  relation  of  ideas,  said  to  be  of  But  such
secondary  qualities,  to  each  other  in  dependence  on  other  H^^^^^  j^
ideas,  said  to  be  of  primary  qualities.  In  other  words,  in  order  creature  of
to  constitute  reality,  it  takes  ideas  out  of  that  particularity  t^o^g^<^«
...
identity  are  the  framewoi'k.  In  short,  it  brings  reality
...
possible  thought,  but  only  as  the  complete  from  the  incom-
plete. To  one  who  logically  carried  out  this  view,  the
gi-ound  of  distinction  between  fact  and  fancy  would  have  to
...
him  from  Oxford  to  London.  (Book  ii.  chap,  xxiii.  sec.  20.)
Was  the  distinction  then  to  disappear  altogether?
...
by  the  transfer  of  real  existence  froin  the   thing  in  which  ^.^^i
ideas  are  found,  and  whose  qualities  the  complex  of  ideas  essence  as
in  us,  though  inadequate,    represents,  to  something   called  qualities  of
'  body,'  necessarily  unknown,  because  no  ideas  in  us  are  in  unknown
any  way  representative  of  it.     To  such  an  unknown  body     ^  ^'
unknown  qualities  are  supposed  to  belong  under  the  designa-

■^ion  '  real  essence.'  The  subject  of  the  nominal  essence,  just
...
sistent  doctrines  that  renders  his  '  immortal  Third  Book  '  a  ^f!"^,-,,^"

ill  r^dli  I J  l^n

web  of  contradictions.     As  was   said  above,  he   constantly  in  ambig-
speaks  as  if  the  subject  of  the  real  essence  were  the  same  ^o^v''^"''^'
...
76  GENERAL  INTEODUCTION.

*  gold  '  But  '  body,'  as  that  in  wliicli  '  ideas  are  found,'  and
in  which  they  permanently  coexist  according  to  a  natural
law,  is  one  thing  ;  '  bod} ,'  as  the  abstraction  of  the  unknowai,
...
Body  as  94.  Where  Locke  is  insisting  on  the  opposition  between

'parcel  of    j-j^g  ^.g^^j  esseuce  and  any  essence  that  can  be  known,  the

matter  _  J  ^  ,  _    '

without  former  is  generally  ascribed  either  to  a  '  particular  being '  or
essence.  ^^  ^  t  -^^xcel  of  matter.'  The  passage  which  brings  the  oppo-
...
looked  upon  as  the  essence  and  standard  of  a  species  ?  All
...
whether  obe}dng  the  magnet  be  essential  to  iron;  yet  I
think  it  is  very  improper  and  insignificant  to  ask  whether  it
be  essential  to  the  particular  parcel  of  matter  T  cut  my  pen
with,  without  considering  it  under  the  name  iron,  or  as
being  of  a  certain  species.'  (Book  iii.  chap.  vi.  sec.  5.)^
Here,  it  will  be  seen,  the  exclusion  of  the  abstract  idea  from
reality  carries  with  it  the  exclusion  of  that  '  standard  made

'  To  the  same  pm'poso  is  a  passage  in  Book  iii.  chap.  x.  sec.  19,  towards  the
end.

IS  IT  A  COMPLEX   OF  KNOWABLE   QUALITIES  F        77

by  nature,'  wliicli  according  to  the  passages  already  quoted,
is  tlie  '  thing  itself  from  which  the  abstract  idea  is  taken,  and
from  Avhich,  if  correctly  taken,  it  derives  reality.  This
...
95.  We  have  already  seen,'  that  if  by  a  'particular  being'  Iq  this
is  meant  the  mere  individuum,  as  it  would  be  upon  abstrac-  sense  body
tion  of  all  relations  which  according  to  Locke  are  fictitious,  j^^^.
and  constitute  a  community  or  generality,  it  certainly  can  viduum.
have  no  essential  qualities,  since  it  has  no  qualities  at  all.
It  is  a  something  which  equals  nothing.  The  notion  of  this
bare  individuum  being  the  real  is  the  '  protoplasm '  of
Locke's  philosopli}^  to  which,  though  he  never  quite  recog-
...
abstracting  from  the  formed  content  of  consciousness  till  he
came  to  that  which  could  not  be  got  rid  of.  This  is  the
momentarily  present  relation  of  subject  and  object,  which,
considered  on  the  side  of  the  object,  gives  the  mere  atom,
...
relation  to  other  individuals,  and  the  feelino-  is  determined
to  the  present  moment  or  '  the  now  '  by  relation  to  other
'nows.'

96.  To  this  ultimate  abstraction,  however,  Locke,  though  i^ody  as
constantly  on  the  road  to  it,  never  quite  penetrates.     He  is  qu^ilifiod
farthest  from  it — indeed,  as  far  from  it  as  possible — where  he   stances  of
...
removed  by  thought  in  order  to  its  losing  it^s  reality  and
...
the  real,  that  he  is  thinking  in  the  passage  last  quoted.  As
...
remain  the  same,  the  '  it,'  the  particular  being  is  different.
...
tween '  matter '  and  '  body.'  In  Book
ni.  chap.  X.  sec.  15,  however,  he  dis-
tinguishes matter  from  body  as  the  less
...
definition,  involves  the  other  '  primary
qualities,'  this  distinction  does  not  avail
him  much.

'^  See  above,  paragraph  69.

OR  UNKNOWN  QUALiriES  OF  UNKNOWN  BODY?       79

us  is  in  perpetual  flux.  '  In  itself  it  is  a  substance  without
an  essence,  a  '  sonietliing  we  know  not  what '  without  any
ideas  to  '  support ; '  a  '  parcel  of  matter,'  indeed,  but  one  in
which  no  quality  is  really  essential,  because  its  real  essence,
consisting  in  its  momentary  presentation  to  sense,  changes
with  the  moments.'

98.  We  have  previously  noticed'^  Locke's  pregnant  remark.  How  Locke
that  '  things  whose  existence  is  in  succession '  do  not  admit  q^gg^fon  '^
of  identity.  (Book  ii.  chap,  xxvii.  sec.  2.)  So  far,  then,  as
...
made,  where  he  follows  its  lead  the  farthest,  he  is  still  pulled
...
days  after  wiU  become  part  of  a  man  " — we  find  that,  just  as
he  does  not  pursue  the  individualization  of  the  real  in  space
so  far  but  that  it  still  remains  '  a  constitution  of  parts,'  so  he
...
•  Cf.  Book  III.  chap.  vi.  sec.  4 :  '  Take  thought  of  anything  essential  to  any  of

but  away  the  abstract  ideas  by  which  them  instantly  vanishes,'  &c.

•we   sort   individuals    and    rank  them  ^  See  above,  paragraph  75.

under  common    names,   and   then   the  *  Book  iii.  chap.  iii.  sec.  10.

80  GENERAL   INTEODUCTION.

could  not  contain.  Tims  tlirougliout  the  Second  Book  of  the
Essay  the  simple  idea  is  supposed  to  represent  either  as  copy
or  as  effect  a  permanent  reality,  whether  body  or  mind :  and
in  the  later  b(»oks,  even  where  the  representation  of  such
...
sense,^  that  Locke  means  by  an  '  actual  present  sensation,'
and  it  is  properly  in  virtue  of  this  reference  that  such  sensa-
tion is  supposed  to  be,  or  to  repoi-t,  the  real.
Body  and  9^-  According  to  the  doctrine  of  primary  qualities,  as  ori-
its  quali-  ginally  stated,  the  antithesis  lies  between  body  as  it  is  in
posed"k)'be  itsclf  and  body  as  it  is  for  us,  not  between  body  as  it  is  for
outside  us  in  '  actual  sensation,'  and  body  as  it  is  for  us  according  to
ness"°"^"  *  i^i^as  in  the  mind.'  The  primar}^  qualities  '  are  in  bodies
...
would  be  really  in  the  Avorld  as  they  are  whether  there  were
...
tion of  the  texture  of  it?  '  (Book  ii.  chap.  viii.  sec.  20.)  It
...
Essay,  Book  ii.  chap.  i.  sec.  14:  'This  'innate  principles  which  some  contend

source  of  ideas  (tlie  perception  of  the  for.'     '  These  (the  ideas  of  hunger  and

operations  of  the  mind)  every  man  has  warmth)  being  the  effects  of  sensation,

wholly  in  himself;  and  though  it  be  not  are  only  from  some   aifcctions  of   the

sense,  as   having   nothing   to  do   with  body  which  happen  to  them  there,  and

external  objects,  yet  it  is  very  like  it,  so  depend  on  something  exterior  to  the

and  might  properly  enough   be  called  mind,  not  otherwi.se  diifering  in  their

internal  sense.'    For  the  notion  of  outer  manner  of  production  from  other  ideas

sense  Of.  Book  ii.  chap.  ix.  sec.  6,  where  derived  from  sensp,  but  only  in  the  pre-

he  is  distinguishing  the  ideas  of  hunger  cedency  of  time.'

PRIMARY  QUALITIES   AND   CONSCIOUSNESS.  81

awaj.  Yet  it  is  brought  within  consciousness  again  by  the
supposition  that  it  has  qualities  which  copy  themselves  in
our  ideas  and  are  '  the  exciting  causes  of  all  our  various
sensations  from  bodies.'  (Book  ii.  chap.  xxxi.  sec.  3.)  Again,
however,  the  antithesis  between  the  real  and  consciousness
prevails,  and  the  qualities  of  matter  or  body  having  been
...
one  upon  which  the  criticism  of  Berkeley  and  Hume  first  primary
fastened,  as  the  most  obvious  aberration  from  the  *  new  way  be  out'skie
of  ideas.'     That  the  very  notion  of  the  senses  as  '  reporting  '  consciouB-
any thing,  under  secondary  no  less  than  under  primary  quali-  yetkiTow-
...
and  fancy,  as  resting  upon  that  between  the  nature  of  things
...
viii.  sec.  15.)  These  quahties  then  may  be  treated,  according
...
101.  How,  asked  Berkeley,  can  an  idea  be  like  anything  Looke
that  is  not  an  idea  ?     Put  the  question  in  its  proper  strength  »n'^'^'"'s
— ^How  can  an  idea  be  like  that  of  which  the  sole  and  simple  copy  th.m-
determination  is  just  that  it  is  not  an  idea  (and  such  with  *^'^^veB  lu
...
Locke  is  body  *in  itself  or  as  the  real) — and  it  is  clearly
unanswerable.  The  process  by  which  Locke  was  prevented
from  putting  it  to  himself  is  not  difficult  to  trace.  *  Body  '
and  ^  the  solid '  are  with  him  virtually  convertible  terms.
Each  indifferently  holds  the  place  of  the  substance,  of  which
the  primary  qualities  are  so  many  determinations.'  It  is
...
the  mind  solely  by  the  sense  of  touch.  (Book  ii.  chap.  iii.
sec.  1.)  But  no  sooner  has  he  thus  identified  it  with  an  im-
mediate feeling  than,  in  disregard  of  his  own  doctrine,  that
...
bodies,  when  they  are  moving  one  towards  another,  I  call
solidity.'     (Book  ii.  chap.  iv.  sec  1.)

102.  Now  'body'  in  this  theory  is  by  no  means  outside
consciousness.  It  is  emphatically  'in  the  mind,'  a  'nominal
essence,'  determined  by  the  relation  which  the  theory  assigns

'  See  Book  ii.  chap.  viii.  sec.  23 :  The
primary  'qualities  that  are  in  bodies,
are  the  bulk,  figure,  number,  situation,
and  motion  or  rest,  of  their  solid  parts.^
Cf.  Book  II.  chap.  xiii.  sec.  11 :  'Solidity

is  so  inseparable  an  idea  from  body,  that
upon  that  depends  its  filling  of  space,
its  contact,   impulse,   and  communica-
tion of  motion  upon  impulse.'
*  See  Book  iii.  chap.  iv.  sec.  7.

IDEA  OF  SOLIDITY.  83

to  it,  and  which,  like  every  relation  according  to  Loclce,  is  a  ^^  "n-
'  thing  of  the  mind.'     This  relation  is  that  of  outwardness  to  ^"*^^''"      .

■^  opposite  of

other  bodies,  and  among  these  to  the  sensitive  body  through  mind  and
which  we  receive  '  ideas  of  sensation ' — a  body  which,  on  its  !'"''^  ^''  ^
...
the  mind  has  to  be  asserted.  Yet  must  they  be  in  some  sort
ideas,  for  of  these  alone  (as  Locke  fully  admits)  can  we  think
and  speak;  and  if  ideas,  in  the  mind.  How  is  this  contra-
diction to  be  overcome  ?  By  the  notion  that  though  not  in
...
103.  The  case  then  stands  as  follows.     All  that  Locke  says  Rationale
of  body  as  the  real  thing-in-itself,  and  of  its  qualities  as  the  '^^  ^^^**'.
essence  of  such  thing,  comes  according  to  his  own  showing  tloiis.^  "^
...
'  Cf.  also  the  passage  from  Book  ii.  chap.  xiii.  Bee.  11,   quoted  above,  p.  82,
note  1.

a  2

84  GEXEIIAL  introduction.

supposed— a  'substance  of  body,'  a  productive  cause  of
matter.  But  the  substance,  however  remote,  is  determined
by  the  qualities  to  which  it  is  correlative,  as  the  cause  by  ita
effects  ;  and  every  one  of  these — whether  the  most  primary,
solidity,  or  those  which  *the  mind  finds  inseparable  from
every  particle  of  matter,'  i.e.  from  the  'solid  parts  of  a  body,''
— as  defined  by  Locke,  is  a  relation  such  as  the  mind,  '  bring-
ing one  tiling  to  and  setting  it  by  another  '  (Book  ii.  chap.
...
obviously  complex  ide^s  of  relation,  into  simple  feelings  of
touch,"  and  supposing  the  subject  of  this  sensati
