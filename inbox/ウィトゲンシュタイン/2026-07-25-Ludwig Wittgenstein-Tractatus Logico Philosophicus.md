---
source: "https://archive.org/details/in.ernet.dli.2015.218466"
title: "Tractatus Logico Philosophicus"
author: "Ludwig Wittgenstein"
year: "1933"
captured_at: "2026-07-25T14:24:31Z"
updated_at: "2026-07-25T14:24:31Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ウィトゲンシュタイン"
query: "Ludwig Wittgenstein"
plain_text_url: "https://archive.org/download/in.ernet.dli.2015.218466/2015.218466.Tractatus-Logico_djvu.txt"
public_domain: true
...
- 初版: 1933
- 情報源: [archive](https://archive.org/details/in.ernet.dli.2015.218466)
- パブリックドメイン: ✓
...
GENERAL EDITOR— C. K. OGDEN, M.A. {Magdalene College, Cambridgey
...
Speculations {Preface by Jacob Epsieiti) .

The Psychology of Reasoning*

The Philosophy of ‘As If’

The Nature ok Iniei.ligrnce .

Telepathy and Clairvoyance .

The Growth of the Mind
The Mentality of Apes ....
Psychology ok Religious Mysticism
The Philosophy of Music ....

The Psychology ok a Musical Prodigy.
Principles of Literary Criticism
Metaphysical Founuations of Science .
...
Asteriiks denote that other books by the same author are included in the series.
A complete list tvill be found at the end of the volume.
...
KEGAN PAUL, TRENCH, 1 RUBNER & CO., LTD.

NEW YORK; HARCOURT, BRACE 4 COMPANY

1933

First pt£hlisHc4i in this Series . .
Reprinted (^xjuith a fetju corrections')

Alaei^ camd Friwtt^d in Great JBritain by
PERCY LIINO. HUMPHRIES Qsf OO. LXI>.
X2 Metiffcra SQuare, JLantian, IV.C.'t
anti €U Rratiftrrti
...
peculiar literary character of the whole. As a re suit a certain
latitude has been possible in passages to which objection might
otherwise be taken as o%fer- literal.

The proofs of the translation and the version of the original
which appeared in the final number of OstwalcPs Annalen der
Naturphilosophic {1921) have been very carefully revised by
...
Mr Wittgenstein’s Tractatus Logico-Philosophiais^ whether
...
this belong-s to the special sciences dealing with the
...
Symbolism, for Symbolism in which a sentence
...
with in regard to wSymbolism : (i) the conditions for sense
...
in his phraseology, only be shoivn^ not said, for whatever
...
SachvcrhaltCy whereas a fact which may consist of two
or more facts is called a Tatsache: thus, for example,
“Socrates is wise ” is a Sachverhalty as well as a Tatsache^
...
not say, the complex sign ^aRb" says stands in a
certain relation R to 3 ’; but we must say, that
...
They are all in a certain sense one)” (4-oi4)- The
...
is bad grammar, and the best that v/e can hope to achieve
...
as it were, opaque and blurred” (4. m and 4.1 12). In
...
2^ fact: thus if we give a name to the complex the name
...
So<irates.” Mr Wittgenstein maintains, however, for
...
It has been shown by Dr She ffer (Trans. Am. Math. Soc.,
...
ledge of Dr SheflFer’s work. The manner in which other
truth-functions are constructed out of ‘^not-/ and not-y’’
...
since this is the negation of “not-/ and not-^,” ue. of
our primitive function. The development of other truth-
functions out of “ not-/” and “/ or is given in detail
at the beginning of Principia Mathematical This gives all
...
be a propositional function (/.^. a function whose values
...
represented in mathematical logic by the words “/ir
is false for all values of ;r.” The negation of this would
be the proposition “ there is at least one x for which fx is
true” which is represented by If we had

started with noifx instead of fx we should have arrived
at the proposition “/r is true for all values of jr” which
is represented by “(jr)./}r.” Wittgenstein’s method of
dealing with general propositions [i.e. “(;r)./r” and
differs from previous methods by the fact
...
he uses is N {f)). The following is the explanation
...
N (I) stands for the negation of all the propositions
making up

The whole symbol (/, means whatever can be
...
obtained out of simultaneous negation, t\e. out of “ not-/
and not-^ ” ;
...
is easy to see. Not-/ and not-/^^ is equivalent to
‘‘ not-//’ hence we obtain a definition of negation in terms
of our primitive function : hence we can define “/ or y,”
since this is the negation of ‘‘not-/ and not-^,” ue, of
our primitive function. The development of other truth-
functions out of “ not-/” and “/ or y ” is given in detail
at the beginning of Principia Mathematical This gives all
that is wanted when the propositions which are arguments
to our truth-function are given by enumeration. Wittgen-
stein, however, by a very interesting analysis succeeds in
...
started with not-/V instead of fx we should have arrived
at the proposition “/r is true for all values of which
is represented by ^^(x).fx,'' Wittgenstein’s method of
dealing with general propositions [i.e. “(;r)./ir” and
differs from previous methods by the fact
that the generality comes only in specifying the set of
propositions concerned, and when this has been done the
building up of truth-functions proceeds exactly as it would
...
function of atomic propositions ; and that if p follows from
q the meaning of p is contained in the meaning of from
...
of jr is a property of y, but it would, after all, be logically
...
arc often the first sign of philosophical errors, and
...
truth-functions. He says ( 5 * 54 ) • “ the general pro-
...
ficially as if the proposition p stood in a sort of relation
to the object A. But it is clear that ‘A believes that
/,* * A thinks ‘ A says are of the form says p ' ;
...
the logical form of belief, ue. what is the schema repre-
...
in the form “A doubts pf ‘‘A desires etc., which
...
/r is a given propositional function. This belongs to
...
moment I do not know how to answer. Yet 1 do not
...
Motto: . . . und a/les, was man weiss, nicht bJoss rauschen
und brausen gehdrt hat, ISsst sich in drei Worten sagen.
...
ich hier geschrieben habe macht im Einzelnen iiberhaupt
...
The book deals with the problems bf philosophy and
...
endgultig gelost zu haben. Und wenn ich mich hierin
...
2.0H Es ist dem Ding wesentlich, der Bestandteil
eines Sachverhaltes sein zu konnen.

2.012 InderLogikistnichtszufallig : Wenn das Ding
...
Mdglichkeiten sind ihre Tatsachen.)

* Die Decimalzahlen als Nummem der einzelnen SHtsc deoten das lopsche

Gewicht der Siitie an, den Nacbdrack, der auf ihnen in meiner DarsteUnng liegt,

DieSitzen. i, n. 2 , n,3, etc., sind Bcmerkangcn lum Siltee No. n ; die Sitae n.mi,

n.ma, etc. Bemerkungen znin Satze No. n.m ; and so weiter.
...
I. II The world is determined by the facts, and by
...
2.011 It is essential to a thing that it can be a con-
...
The propositions 1, n, 2 , M.3, etc., are comments on proposition No. n ; the pro-
positions «.ini,M.OT2, etc., are comments on the proposition No. n.m ; and so on.
...
mog lichen Sachlagen vorkommen kann, aber
...
auch alle m o g 1 i c h e n Sachverhalte gegeben.
...
2.0124 all objects are given, then thereby are all
...
(A point in space is a place for an argu-
ment.)
...
2.0201 Jede Aussage iiber Komplexe lasst sich in eine
...
^.023 Diese feste Form besteht eben aus den Gegen-
standen.
...
sam haben, dann ist es iiberhaupt unmoglich auf
eines von ihnen zu zeigen.

Denn, ist das Dingdurch nichts hervorgehoben,
...
2.032 The way in \vhich objects hang together in
...
2.11 Das Bildstelltdie Sachlage im logischen Raume,
...
2. 1 1 The picture presents the facts in logical space,
...
2.16 Die Tatsache muss urn Bild zu sein, etwas mit
...
datum stellt das Bild sein Objekt richtig oder
falsch dar.

2.174 I^3.s Bild kann sich aber nicht ausserhalb seiner
...
eine Moglichkeit des Bestehens und Nichtbestehens
...
other hand, for example, notevery picture is spatial.)
...
2.223 Um zu erkennen, ob das Bild wahr oder falsch
...
2.224 It cannot be discovered from the picture alone
...
raumlichen Gegenstanden (etwa Tischen, Stuhlen,
Buchern) zusammengesetzt denken.
...
dass a in der Beziehung R zu b steht“, sondern :
...
says ^ a stands in relation Rxo but we must
...
3.221 Die Gegenstande kann ich nur nennen. Zeichen
...
Allgemeinheitsbezeichnung enthalt ja ein Urbild.)

Die Zusammenfassung des Symbols eines Korn-
...
3.261 Jedes definierte Zeichen bezeichnet fiber jene
...
Every defined sign signifies via those signs
...
3.3 Nur der Satz hat Sinn ; nur im Zusammenhange
...
Dej Ausdruck kennzeichnet eine Form und
einen Inhalt.
...
konstant und alles iibrige v a r i a b e 1 sein.

3*313 Ausdruck wird also durch eine Variable
...
Jcde Variable Ifest sich als Satzvariable auffassen.
...
libereinkunft, mit Teilen jenes Satzes meinen.
Verwandeln wir aber alle jene Zeichen, deren
Bedeutungwillkiirlich bestimmt wurde,in Variable,
...
3.316 What values the propositional variable can
...
(Im Satze „Grun ist grun“ — wo das erste Wort
...
3.325 Um diesen Irrtiimern zu entgehen, miissen
...
(Die Begriflfsschrift Frege’s und Russell’s ist
...
which obeys the rules of logical grammar — of logical
syntax.
...
also einen Satz : „F(F(fx)y‘ und in diesem miissen
...
be a proposition F{F{fx)y\ and in this the outer
function F and the inner function F must have
different meanings ; for the inner has the form
the outer the form Common to

both functions is only the letter “Z'”, which by
...
3*334 Regain der logischen Syntax miissen sich
...
ArtderHervorbringungdesSatzzeichens herriihren.
...
Regain der logischen Syntax zufolge ersetzt werden
kann.
...
Notation von „ ^ („nicht p“)und„p vq^(„p oder q“)
ersetzen lassen.
...
philosophische Dinge geschriebenworden sind, sind
...
4.012 Ofifenbar ist, dass wir einen Satz von der Form
...
Notensprache indieSprache derGrammophonplatte.
...
wahr ist. Und er sagt, dass es sich so verhalt.
...
DerSatzistdieBeschreibungeinesSachverhaltes.
...
4.0311 Ein Name steht fiir ein Ding, ein anderer fur
...
aflfairs, only in so far as it is logically articulated.
...
nicht genugen — wir wiissten nicht, was verall-
gemeinert wurde. Wollten wir es durch einen
Index anzeigen — etwa so: „f(Xa)“ — es wiirde
...
wahre Art bezeichnet, was „ auf die falsche
Art, etc,
...
meinen, und es sich so verhalt wie wir es
...
The propositions ‘V*' and ‘‘ have op-
...
4. 1 1 Die Gesamtheit der wahren Satze ist die
...
place otiier than does the proposition denied.
...
4.1 A proposition presents the existence and non-

existence of atomic facts.

4. 1 1 The totality of true propositions is the total
...
4.112 Der Zweck der Philosophie ist die logische
...
Die Philosophie soil die Gedanken, die sonst,
gleichsam, triibe und verschwommen sind, klar
machen und scharf abgrenzen.

4.1121 Die Psychologic ist der Philosophie nicht ver-
...
4. 1122 Die Darwinsche Theorie hat mit der Philosophie
nicht mehr zu schaffen, als irgend eine andere
Hypothese der Naturwissenschaft.

4.113 Die Philosophie begrenzt das bestreitbare
Gebiet der Naturwissenschaft.

4.114 Sie soil das Denkbare abgrenzen und damit das
Undenkbare.

Sie soil das Undenkbare von innen durch das
Denkbare begrenzen.

4.115 Sie wird das Unsagbare bedeuten, indem sie
das Sagbare klar darstellt.

‘4.116 Alles was iiberhaupt gedacht werden kann,
...
4.I122 The Darwinian theory has no more to do with
philosophy than has any other hypothesis of natural
science.

4.113 Philosophy limits the disputable sphereof natural
science.
...
4.1x6 Everything that can be thought at all can be
...
Was sich in der Sprache ausdruckt, konnen
w i r nicht durch sie ausdriicken.

Der Satz z e i g t die logische F'orm der Wirk-
lichkeit.
...
4.1211 Thus a proposition “yJz” shows that in its sense
the object a occurs, two propositions “/a” and

’’ that they are both about the same object.
...
“ (3Jc,y) : aRx ,xRy .yRR\ etc.

(If b stands in one of these relations to I call
b a successor of <2.)
...
4.1272 So ist der variable Name das eigentliche
...
Dassefbe gilt von den Worten ,,Komplex*‘,
...
Ausdriicke wie ,,i ist eine ZahP^ ,,es gibt nur
...
4.1272 So the variable name is the proper sign of
...
(It is as senseless to say, “there is only one l ”

85

LOGISCH-PHILOSOPHISCHE ABHANDLUNG

eine als es unsinnig ware, zu sagen : 2-f 2 ist
um 3 Uhr gleich 4.)
...
4.1273 Wollen wir den allgemeinep Satz : ,,b ist ein
...
(gx) : aRx . xRb, (3x,y) : aRx . xRy . y Rb, . . . Das
allgemeine Glied einer Formenreihe kann man nur
durch eine Variable ausdrucken, denn der Begriff:
...
4,128 Die logischen Formen sind zahl 1 os.
...
the general proposition is a successor of
we need for this an expression for the general
term of the formal series : aRby (g^r) : aRx . xRby
{^Xyy)\aRx .xRy .yRby . . . The general term of
...
4.2211 Auch wenn die Welt unendlich komplex ist,
...
deute siedurcheinzelneBuchstaben (MX‘S>)y‘S >> 2*0
an.
...
them by single letters {Xyj,c).

The elementary proposition I write as function
of the names, in the form “/r**,
...
4.27 Beziiglich des Bestehens und Nichtbestehens von
...
— (like Russell) in the form Def.”. A

definition is a symbolic rule.)

4.242 Expressions of the form ^^ar=b'* are therefore only
expedients in presentation : They assert nothing
about the meaning of the signs a and ^
...
Expressions like = or expressions
...
„wahr‘S „F“, „falsch“. Die Reihen der „W“ und
...
Verstandnis der allgemeinen Satze hiingt f ii h 1 b a r
von dem der Elementarsatze ab.

4.42 Beziiglich der Ubereinstimmung und Nichtiiber-
...
Die Ubereinstimmung mit den Wahrheitsmo-
92
...
4.31 The truth-possibilities can be presented by
schemata of the following kind means
...
4.4 A proposition is the expression of agreement

and disagreement with the truth-possibilities of
the elementary propositions.

4.41 The truth-possibilities of the elementary pro-
positions are the conditions of the truth and
falsehood of the propositions.

4.411 It seems probable even at first sight that the
...
zontalen und vertikalen Stricken oder den Klam-
...
(Frege’s „UrteiIstrich*‘ ist logisch ganz
...
in etc., then the sense of would by no
...
„(WW— W) (p , q)" Oder deutlicher „( WWF W)
...
4.45 Fiir n Elementarsatze gibtes Ln mogliche Grup-
...
bedingungen gibt es zwei extreme F^lle.
...
propositions can be ordered ih a series.
...
(Ich weiss z. B. nichts iiber das Wetter, wenn
...
(I know, nothing about the weather, when
...
In Russell’s „ + c“ istz. B, „c“ ein Index, der darauf
hinweist, dass das ganze Zeichen das Additions-
zeichen fiir Kardinalzahlen ist. Aber diese Bezeich-
nung beruht auf willkurlicher Ubereinkunft und
man konnte statt „4-c“ auch ein einfaches Zeichen
...
4.51 Suppose < 2 // elementary propositions were given
...
In Russell's “ +c”» example, “ c " is an
...
zugrunde. Fiir Frege waren die Satze der Logik
...
(W WWW) (p, q) Tautologie ( Wenn p, so p ; und wenn q, so q.) (p D p . q D q)
(F W W W) (p, q) in Worten : Nicht beides p und q. ( ^ (p . q))

(W F W W) (p, q) „ „ Wenn q, so p. (q 3 p)

(W W F W) (p, q) Wenn p, so q. (p 3 q)
...
(F W F F)(p, q) q und nicht p. (q. -i' p)

(W F F F)(p, q) qundp. (q . p)

(F F F F) (Pj q)Kontradiktion(pundnichtp;undqundnichtq.)(p. p.q. q)
...
5. 11 Sind die Wahrheitsgrunde, die einer Anzahl
von Satzen gemeinsam sind, samtlich auch Wahr-
heitsgrunde eines bestimmten Satzes, so sagen
...
alle Wahrheitsgrunde des zweiten Wahrheits-
grunde des ersten sind.
...
(TTTT) (^, Tautology (if p then/, and if q then q) [poP- qDq]

(F T T T) (/, q) in words : Not both p and q. [ (p. $?)]

(T F T T) (/, q) „ „ If then /. [q d/]
...
(F T T F) (/, q) „ „ / or but not both, [p'^qiviq.'^p]

(T F F T) (/, q) „ „ If /, then qy and if q, then /. [p=q]

(TFTF){p,q) ,, „ /

(TTFF)(/,^)„ „ q

(F F FT) (/, ^7) „ „ Neither/ nor p- q or p\q]

(F F T F) (/, q) „ „ / and not q, [/. q]

(F T F F) (/, q) „ „ q and not /. [q. /]

(T F F F) (/, q) „ „ / and q, [/. q]

(F F F F) (/, Contradiction (/ and not/y and and not ^.)[/. ^p.q, ^ q]

Those truth-possibilities of its truth-arguments,
which verify the proposition, I shall call its truth-
grounds.

5. 11 If the truth-grounds which are common to a
...
5.1241 ,,P' ist einer der Satze, welche ,,p“ bejahen
...
5.1311 Wenn wir von pvq und p auf q schliessen,
...
„p|q .|. p|q“ und statt „ - p“ „p|p“ (p|q = weder
...
5.122 If p follows from q^ the sense of “ ^ ” is contained
in that of ‘‘ j
...
5. 1241 is one of the propositions which assert
...
5.1311 When we conclude from p\q and p X.o q the
relation between the forms of the propositions
“ pvq ” and is here concealed by the method

of symbolizing. But if we write, e,g, instead of
^^pvq'' ^^p\q ^1?” and instead of “

''P\P'' (^|? = neither p nor j), then the inner
...
sinnlos, und waren iiberflussig.
...
Der Glaube an den Kausalnexus ist der Aber-
glaube.

5. 1362 Die Willensfreiheit besteht darin,dass zukiinftige
Handlungen jetzt nicht gewusst werden kdnnen.
...
(The fact that we can infer fa from (x) .fx shows
that generality is present also in the symbol

If p follows from I can conclude from q to p ;
infer p from q.
...
(“ A knows that p is the case” is senseless \i p
is a tautology.)

If from the fact that a proposition is obvious
to us it does not follow that it is true, then obvious-
...
5.141 Folgt p aus q und q aus p, so sind sie ein und
derselbe Satz.
...
griinde des Satzes „s“,die zugleich W ahrhei tsgr iinde
...
5.101 Wr die Anzahl der im Satze r ; Wrs die
Anzahl derjenigen „W“ im Satze s, die in gleichen
Kolonnen mit des Satzes r stehen. Der Satz
...
(Anwendungauf Tautologie und Kontradiktion.)
...
propos^ition ‘V’, 7 “,., the number of those truth-
grounds of the proposition ‘‘i*” which are at the
same time truth-grounds of then we call the
ratio Tr,: Tr the measure of the probability which
the proposition gives to the proposition s^\
...
eine Kugel nach der andereii und lege sie wieder
...
einer gewissen Sachlage sein, aber er ist imoier
...
5.2 Die Stnikturen der Satze stehen in internen

Beziehungen zu einander.

5.21 Wir konnen diese internen Beziehungen
dadurch in unserer Ausd rucks weise hervorheben,
...
geschehen muss,uni aus ihmden anderen zu machen.
...
Equivalent mit der Operation, durch welche ein
...
5.21 We can bring out these intern^ relation^ in
...
logically significant way ; t,e. where the logical
...
5.242 Dieselbe Operation, die aus „p“ macht,
...
5.251 Fine Funktion kann nicht ihr eigenes Argument
...
dreimaligen successiven Anwendung von „ 0 ’
auf „a“).

In einem ahnlichen Sinne rede ich von der
successiven Anwendung m e h r e r e r Operationen
...
“r”, etc., are variables which give general ex-
...
(“C>’ O' O' a" is the result of the threefold suc-
...
5.2522 The general term of the formal series O
O O' Uy . I write thus : “ [^2:, Xy O' x \ This
...
5.2523 Der BegrifF der success! ven Anwendung der
Operation ist Equivalent mit dem Begrifif„und so
weiter**.

5.253 Fine Operation kann die Wirkung einer anderen
...
“j’’* are truth-functions of elementary proposi-
tions.
...
successive!! Anwendung einer endlichen Anzahl
...
Verneint,,'^ « p“ p,oderbejahtesp; oder beides?
...
truth-functioil of elementary propositions.

5.42 That V, 3, etc., are not relations in the sense of
...
5.43 That from a fact p an infinite number of others

should follow, namely ^ ^ ^ ^ ^ etc., is
...
Does “ ^p'' deny or does it affirm p\

or both ?

The proposition “ ^ does not treat of
...
so rniisste „ ^ p“ etwas anderes sagen als „p“.
Denn der eine Satz wiirde dann eben von ^
handeln, der andere nicht.

5.441 Dieses Verschwinden der scheinbaren logischen
Konstanten tritt auch ein, wenn „ ^ (ax) . ^ fx“
dasselbe sagt wie „(x) . fx“, oder „(ax) . fix . x = a“
dasselbe wie „fa“.

5.442 Wenn uns ein Satz gegeben ist, so sind mit
...
ihr Dasein rechtfertigen. Der Bau der Logik a u s
ihren Urzeichen muss klar werden.

5.451 Hat die Logik Grundbegriffe, so miissen sie von

einander unabhangig sein. Ist ein Grundbegrifif
eingefiihrt, so muss er in alien Verbindungen
eingefiihrt sein, worin er iiberhaupt vorkommt. Man
kann ihn also nicht zuerst fiir eine Verbindung,
dann noch einmal fiir eine andere einfiihren.
...
(Kurz, fiir die Einfuhrung der Urzeichen gilt,
...
5.452 Die Einfuhrung eines neuen Behelfes in den Sym-
bolismus der Logik muss immer ein folgenschweres
Ereignis sein. Kein neuer Bebelf darf in die Logik —
...
constants also occurs if (H-^) • -'/r ” says the
same as ^^{x),fx^\ or “(gjr)./r.;r==fl:” the same
as
...
“ j^st as in propositions like “

others. We may not first
...
signs by definitions holds, miitatis mutandis, for
...
(So kommen in den „Principia Mathematical
...
Hat sich aber die Einfiihrung eines neuen
...
nur „pvq“ sondern auch schon „^(pv-'q)‘' etc.
etc. Man hatte damit auch schon die Wirkung
aller nur mbglichen Kombinationen von Klammern
eingefuhrt. Und damit ware es klar geworden,
...
primitive signs are not “/vy”, “(3^) -A’*! etc.,

125

LOGISCH-PHILOSOPHISCHE ABHANDLUNG

die „pvq“, „(3x).fx“, etc. sind, sondern die all-
...
wie V und D, der Klammern bediirfen — im Gegen-
satz zu den wirklichen Beziehungen.

Die Beniitzung der Klammern mit jenen schein-
baren Urzeichen deutet ja schon darauf bin, dass
...
5.47 Es ist klar, dass alles was sich iiberhauptvon
...
Wo Zusammengesetztheit is\ da ist Argument
...
in the elementary proposition. For “ya’’ says
the same as ‘‘(g;r).7Sr.;r=«”.
...
5 - 47 ^ Es ist klar, dass es sich hier nicht um eine
...
der Form „(^)“ an. ‘ ist eine Variable, deren Werte
...
einer Funktion fx, deren Werte fur alle Werte von
...
2. Giving a function j6r, whose values for all
...
5.51 Hat^nureinen Wert, soist N(^)= ^ p (nicht p),

hat es zwei Werte, so ist N(^)= p . (weder
p noch q).
...
5.512 ist wahr, wenn „p'‘ falsch ist. Also in
...
Das, was in verneint, ist aber nicht das
...
n ^ p“, „ P“, „ ^ p V -- p‘S „ p . p“, etc. etc.

(ad inf.) gebildet werden. Und dies Gemeinsame
spiegelt die Verneinung wieder.

5.513 Man konnte sagen : Das Gemeinsame aller Sym-
...
5.503 As it is obviously easy to express how proposi-
...
5.51 If ^ has only one value, then N (^)= (not /),
...
true proposition ‘V ’ is a false proposition.
...
5 * 5^3 We could say : What is common to all symbols,
which assert both p and is the proposition
What is common to all symbols, which
assert either p or is the proposition ^^pvq^\
...
Diese Regeln sind den Symbolen Equivalent
...
gative Tatsache ausdriicken konnen. (Etwa : Wenn
„a‘‘ nicht in einer bestimmten Beziehung zu „b“ steht,
konnte das ausdriicken, dass aRb nicht der Fall ist.)
...
in does not stand fora complex sign,

then by itself it cannot have sense ; but then also
the signs which have the
...
to “ ^ ”, it could express that aRd is not the case.)
...
5.52 If the values of fare the total values of a func-
tion fx for all values of jt, then N(|)= (gjr) ,fx.
...
logischeii Summe eingefiihrt. So wurde es schwer,
...
Russell dies tut — in Worten durch „fx ist m6glich“
wiederzugeben.

Gewissheit, Moglichkeit Oder Unmoglichkeit
einer Sachlage wird nicht durch einen Satz ausge-
druckt, sondern dadurch, dass ein Ausdruck eine
...
sich daran, dass wir in „(gx , 4 >) . „<#>“ und „x“
...
the propositions ‘‘ (gjr) ./r” and “ (x) .fx'' in which
...
“(g;r).yGr” — as Russell does — in words “yCr is
possible
...
completely generalized propositions, i.e. without
...
pression “there is one and only one a:, which . . •
and this x is a.

5.5261 A completely generalized proposition is like
every other proposition composite. (This is shown
by the fact that in “ (g-r , <^) . we must mention
and “at” separately. Both stand inde-
...
5.531 Ich schreibe also nicht „f(a,b) . a = b‘S sondern
„f(a,a)“ (oder ,i(b,b)“). Und nicht „f(a,b) . a« b“,
sondern „f(a,b)‘‘.

Und analog : Nicht „(3x,y) . f(x,y) . x « y",
...
one considers the proposition “ (x) :/*r. D .
...
a has this relation to <2, but in order to express
...
5 * 53^3 Roughly speaking: to say of two things that
they are identical is nonsense, and to say of one
thing that it is identical with itself is to say
nothing.

5*531 I write therefore not . a^b'\ but

(or And not “/K*) . - a = but

And analogously: nol .f[xy) .x^y ,
...
sondern „(hx) • f(x,x)“; und nicht „(ax,y) . f(x,y) .
^ x = y‘S sondern „(3x,y) . f{x,y)“.

(Also statt des RusseH’schen „(3x,y) . f(x,y)“ :

»(ax,y) . f(x,y) . V . (3x) . f(x,xr.)
...
gerat, Ausdriicke von der Form „a = a“ Oder „p3p“
u. dgl. zu benutzen. Und zwar geschieht dies,
wenn man von dem Urbild : Satz, Ding, etc. reden
mdchte. So hat Russell in den „Principles of
...
but “(ax) ./( 4 r, 4 r)”; and not ^

-'x=j/”, but “ •/(xi^')”.

(Therefore instead of Russell’s “ •/{xj) ” :

“ ( 3 -^.^) -Ax^) • V . (a^) ”.)

5.5321 Instead of (x) : fxz 3 x=a” we therefore write

“ (s-*') ./x . 3 ./* : - (a^.>') • A •./5' ”•

And the proposition one satisfies /*( )”
reads: “{ 3 ,x)./xi - {:^x,y) 'fx ,fy'\
...
“a = a”, ‘'a = ^.<J=c.3a = r”, “(x).x=x”, “(ax).
jir=a'\ etc. cannot be written in a correct logical
notation at all.
...
to use expressions of the form ” or
...
is a proposition” in symbols by and has
...
(It is nonsense to place the hypothesis /D/
...
driicken durch „ ^ (gx) . x = x“. Aber selbst wenn
...
ineinem anderen auch auf andereWeisevorkommen.

Besonders in gewissen Satzforjnen der Psycho-
logic, wie „A glaubt, dass p der Fall ist“, oder
„A denkt p“, etc.
...
urteilt p“ muss zeigen, dass es unmbglich ist, einen
Unsinn zu urteilen. (Russells Theorie geniigt
dieser Beditigung nicht.)
...
no things” by (g^r) . Ar=jr”. But even if this
...
5*55 miissen nun die Frage nach alien mbglichen
...
Bedeutung nicht angeben kOnnen, so k6nnen wir
...
phenomena. For we really see tw^o different facts.
...
It is before the How, not before the WKat.
...
die Logik anwenden? Man kdnnte sagen : Wenn
es eine Logik gabe, auch wenn es keine Welt gabe,
wie k6nnte es dann eine Logik geben, da es eine
Welt gibt.
...
Und wie soli sich das entscheiden? — Durch die
Erfahrung ?
...
5.5541 Es soil sich a priori angeben lassen, ob ich z. B.
in die Lage kommen kann, etwas mit dem
Zeichen einer 27-stelligen Relation bezeichnen zu
miissen.

5*5542 Diirfen wir denn aber liberhaupt so fragen?
...
Und wie ware es auch mdglich, dass ich es in
...
5«556i Empirical reality is limited by the totality of
...
5 * 55^3 Alle Satze unsererUmgangssprache sind tatsach-
...
5*5563 All propositions of our colloquial language are
...
Was wir nicht denken konnen, das kdnnen wir
nicht denken ; wir konnen also auch nicht sagen,
was wir nicht denken kdnnen.
...
Dass die Welt m ei ne Welt ist,daszeigtsichdarin,
...
sie vorfand“, so ware darin auch liber meinen Leib
...
5.633 Wo in der Welt ist ein methaphysisches Subjekt
zu merken ?
...
we cannot therefore saj^ what we cannot
think.
...
only it cannot be said^ but it shows itself.
...
\nd say which members obey my will and which
...
Alles, was wir sehen, kdnnte auch anders
sein.

Alias, was wir iiberhaupt beschreiben kdnnen,
kdnnte auch anders sein.
...
nicht der menschliche Korper, oderdie menschliche
Seele, von der die Psychologic handelt, sondern das
...
6.001 Dies sagt nichts anderes, als dass jeder Satz ein
Resultat der successiven Anwendung der Operation
N’ (^) auf die Elementarsatze ist.
...
6.01 Die allgemeine Form der Operation D' Q) ist
...
The general form of the operation (rj) is
therefore : [^, N (^)]’ (^) ( = 1^, N (^)]).
...
6.02 Undsokommen wirzudenZahlen: Ichdefiniere
...
die Reihe x, fi’ x, Q* x, Q’ f2’ x,

0+Ij O+I + Ij O-tl + I + Ij

so : f 2 X, X, Q X, 12 X,

Also schreibe ich statt „[x, 12 ’ :
...
write the series Xy Q*Xy Q' x, Q* & x

as : 0°’ AT, 0°^'’ jr, Q°+'+'’ jr, jr

Therefore I write in place of “ [x, Q’^] ”,
...
6.I11 Theories which make a proposition of logic
...
die ganze Philosophic der Logik in sich. Und
...
das z e i g t die formalen — logischen — Eigen-
...
Tautologie ergeben, zeigt, dass q aus p und p3q
...
6.1201 That e,g, the propositions and “ in
...
together in the form “ (/D^) . (/) : ID : (^) ” give a
tautology shows that q follows from p a.ndp'Dq.
...
dienen : Ich schreibe statt „p‘‘, „q“, etc.
»WpPs „WqF«, „WrP‘ etc. Die Wahrheits-
...
That (x) ,fx is a tautology shows that

/a follows from (x) ,fx, etc. etc.
...
sent the proposition /DJ. Now I will proceed
to inquire whether such a proposition as — (/ . p')
...
Setzen wir hier statt „p“ ein und untersuchen
...
Diese Methode kdnnte man auch eine Null-
...
Hence the proposition ^{J> • q) runs thus : —
...
proposition is co-ordinated with all the truth-com-
...
6.1221 Ergeben z. B. zwei Satze und „q“ in der
Verbindung „p3q“ eine Tautologie, so ist kar,
dass q aus p folgt.

Dass z. B. „q‘‘ aus „pDq . p“ folgt, ersehen wir
aus diesen beiden Satzen selbst, aber wir k6nnen
es auch s o zeigen, indem wir sie zu „pDq . p : 3 : q“
...
nicht durch eine solche bestatigt werden k6nnen.
...
6.1221 If for example two propositions and ‘‘g”

give a tautology in the connexion then

it is clear that q follows from p,

E.g, that q '' follows from ^^p’Dq ,p ” we see from
these two propositions themselves, but we can also
show it by combining them to ‘‘/Dj ./ * 3 : ^ and
...
6.1224 ^^so becomes clear why logic has been called
the theory of forms and of inference.

6.123 is clear that the laws of logic cannot themselves
...
as opposed to accidental general validity, eg. of the
...
giinstigen Zufall wahr sein k6nnten.
...
Welt. Es ist klar, dass es etwas fiber die Welt
...
den Symbolen, die wir gebrauchen, ware willkfir-
lich, manches nicht. In der Logik drfickt nur
dieses aus : Dass heisst aber, in der Logik drficken
...
6.125 ist moglich, und zwar auch nach der alten
...
6.126 Ob ein Satz der Logik angehfirt, kann man
...
und eine Bedeutung zu kfimmern, bilden wir den
...
weisen kdnnte, und einen logischen Satz auch.
...
Grundgesetze'* willkiirlich ist, denn man k6nnte
166
...
6.1263 would be too remarkable, if one could prove
...
(In der Philosophic fiihrt die Frage „wozu
...
Es ist eine Eigenschaft von + i + l“, dass
man es als „(i + i) + (n-i)“ auffassen kann.
...
It is a property of “ i + 1 + 1 + 1 that it can be
conceived as “ (i -h l) 4 - (i + 1)

169

LOGISCH-PHILOSOPHISCHE ABHANDLUNG

6.232 Frege sagt, die beiden Ausdriicke haben diesel be
...
werden kfinnen, heisst ja nichts anderes, als dass
...
ihrer Bedeutung behaupten zu kdnnen, muss ich
...
hier die nOtige Anschauung liefert.
...
es ei n „Gesetz der kleinsten Wirkung“ geben miisse,
...
sichten a priori iiber die m6gliche Formgebung der
...
6.3 Logical research means the investigation of all
...
Maschen verwenden kdnnen. Es kann sein, dass
...
von Logik und Mechanik. (Man kdnnte das Netz
...
iiber das Bild nichts aus. (Denn dies gilt fur
...
So auch sagt es nichts fiber die Welt aus, dass
...
Auch das sagt etwas fiber die Welt, dass sie sich
...
6.3432 Wir dfirfen nicht vergessen, dass die Weltbe-
...
standlich die Geometrie gar nichts fiber ihre
tatsachliche Form und Lage sagen. Das Netz
aber ist r e i n geometrisch, alle seine Eigenschaften
kfinnen a priori angegeben werden.

Gesetze, wie der Satz vom Grunde, etc., handein
vom Netz, nicht von dem, was das Netz beschreibt.

6.36 Wenn es ein Kausalitatsgesetz gabe, so kfinnte
es lauten : „Es gibt Naturgesetze“.

Aber freilich kann man das nicht sagen : es
zeigt sich.

6.361 In der Ausdrucksweise Hertz’s kdnnte man
sagen: Nur gesetzmassi ge Zusammenhange
sind d e n k ba r.
...
Verlaufs nur so mdglich, dass wir uns auf einen
anderen Vorgang stiitzen.

Ganz Analoges gilt fiir den Raum. Wo man
z. B. sagt, es k 5 nne keines von zwei Ereignissen
...
Und w e n n eine solche Asymmetrie vorhanden i s t,
...
mutually exclude one another) can occur, beoause
...
A right-hand glove could be pul on a left hand
...
Es ist klar, dass kein Grand vorhanden ist, zu
...
neuen System scheinen soil, als sei a 1 1 e s erklart.
...
Zusammenhang k5nnten wir doch nicht selbst
wieder wollen.

6.375 Wie es nur eine logische Notwendigkeit gibt,
so gibt esauch nur eine logische Unm6glichkeit.

6.3751 Dass z. B. zwei Farben zugleich an einem Ort
des Gesichtsfeldes sind, ist unmOglich und zwar
...
one clear terminus, whereas the modem system
...
visual held, is impossible, logically impossible,
...
Satze kCnnen nichts H6heres ausdriicken.
...
Lohn im gew6hnlichen Sinne zu tun hat. Also
...
nicht gesprochen vrerden.

Und der Wille als Phanomen intferessiert nur
die Psychologic.
...
6.432 Wie die Welt ist, ist fiir das H6here voll-
kommen gleichgiiltig. Gott offenbart sich nicht i n
der Welt.

6.4321 Die Tatsachen gehdren alle nur zur Aufgabe,
nicht zur Ldsung.

6.44 Nicht wie die Welt ist, ist das Mystische,
...
so k a n n sie auch beantwortet werden.
...
6.52 Wir fiihlen, dass selbst, wenn alle m 6 g 1 i ch e n
...
6.53 Die richtige Methode der Philosophie ware
...
lasst, also Satze der Naturwissenschaft — also etwas,
was mit Philosophic nichts zu tun hat — , und dann
immer, wenn ein anderer etwas Methaphysisches
...
ihn Philosophie lehrten — aber s i e ware die einzig
streng richtige.

6.54 Meine Satze erlautern dadurch, dass sie der,
...
Er muss diese Satze iiberwinden, dann sieht er
die Welt richtig.
...
To say nothing except what can be said, i>. the
...
The International Library, of which nearly one hundred and twenty
volumes have now been published, is both in quality and quantity a
unique achievement in this department of publishing. Its purpose
...
whether in England and America or on the Continent has met with
a very encouraging reception, and not only have accepted authorities
been invited to explain the newer theories, but it has been found
possible to include a number of original contributions of high merit.
...
Professor L. L. Thurstons

6

The Nature of Lau^ter
