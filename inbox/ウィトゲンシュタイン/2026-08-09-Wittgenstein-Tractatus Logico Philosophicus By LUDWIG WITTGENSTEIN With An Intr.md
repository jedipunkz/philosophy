---
source: "https://archive.org/details/tractatus-logico-philosophicus-by-ludwig-wittgenstein-with-an-introduction-by-be"
title: "Tractatus Logico Philosophicus By LUDWIG WITTGENSTEIN With An Introduction By BERTRAND RUSSELL F. R. S. LONDON Tractatuslogicop 1971witt"
author: "Wittgenstein, Ludwig"
year: "1922"
captured_at: "2026-08-09T13:36:53Z"
updated_at: "2026-08-09T13:36:53Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ウィトゲンシュタイン"
query: "Tractatus Logico-Philosophicus"
plain_text_url: "https://archive.org/download/tractatus-logico-philosophicus-by-ludwig-wittgenstein-with-an-introduction-by-be/Tractatus Logico-Philosophicus  By  LUDWIG WITTGENSTEIN  With an Introduction by  BERTRAND RUSSELL_F.R.S.  LONDON_tractatuslogicop1971witt_djvu.txt"
public_domain: true
...
# Tractatus Logico Philosophicus By LUDWIG WITTGENSTEIN With An Introduction By BERTRAND RUSSELL F. R. S. LONDON Tractatuslogicop 1971witt

- 著者: Wittgenstein, Ludwig
- 初版: 1922
- 情報源: [archive](https://archive.org/details/tractatus-logico-philosophicus-by-ludwig-wittgenstein-with-an-introduction-by-be)
- パブリックドメイン: ✓
...
PHILOSOPHICAL STUDIES . i : : 2 é P . by G. E. Moore
TRACTATUS Locico-PHILosoPHicus : , 5 5 . .  oyeles eae
PsYCHOLOGICAL TYPEs* F : : - a : : Cc. G. June
ScIENTIFIC THOUGHT* ‘ 5 2 F 3 z oe C. D. Broap
THe MEANING OF MEANING s by Cc. K. Ocpen and I. A. RICHARDS
Tue Practicz AND THEORY OF INDIVIDUAL PsycHOLOGY C ¢ by ALFRED ADLER
SrecuLaTions (Preface by Jacob Pee) x 5 : : ‘ by T. E. Hume
Tue Puitosopny or ‘As Ir’ ‘ : : : F ; by H. VarnINGER
PsYcHE . : 0 . i ‘ 9 by E. RouDE
THe GRowTH OF THE Mrnp* : 5 A , , . by K. Korrpxa
THE MENTALITY OF APES A ; . ‘ E . by W. KOHLER
Tue PsycHOLoGy oF A MusIcau Propicy . : 4 : : F by G. REVEsz
PRINCIPLES OF LITERARY CRITICISM* ; : : by I, A, RicHARDS
THE METAPHYSICAL FOUNDATIONS OF Mopern SCIENCE . : : . by E. A. Burtr
THOUGHT AND THE BRAIN* 4 3 2 : : : F by H. Przron
PROBLEMS OP PERSONALITY : , A ‘ ‘ in honour of MorTON PRINCE
Cotour BLINDNESS. : : : : : : : . by M. COoLtins
Tue History oF MATERIALISM . : 0 F F 3 . by F. A. LANGE
PERSONALITY* . : j F ; é ; ; by R. G. Gorpon
EDUCATIONAL PsycHoLocy* i : ; : . by CHARLES Fox
THe LANGUAGE AND THOUGHT oF THE CHILD* ; , ‘ : by J. PIAGET
SEX AND REPRESSION IN SAVAGE SOCIETY* 3 : 0 : by B. MALINowskI
RELIGIous CONVERSION ; : Fi : : : ‘ . by S. DE SANcCTIS
THE SociaAc INsEcTs . 3 . 2 : é : d by W. Morton WHEELER
THEORETICAL BIOLOGY : : A 3 : 3 : , by J. von UEXKULL
PossiBILity * ‘ . : F : : . by Scorr BUCHANAN
THE SyMBOLIC PROcEss . : F ‘ é 5 by J. F. MARKEY
PoLitTIcAL PLURALISM ‘ : . i : : “ "by Ina: CHUuAN Hsiao
INTEGRATIVE PsycHOLOGY* C : : ‘ F : . by W. M. Marston
PLaTo’s THeory oF Etuics* : F : ¢ . by R. C. Lopce
HistoricAL INTRODUCTION TO Mopern PsycHOLOGY ; : : . by G. Murpuy
BIOLOGICAL PRINCIPLES : : : : : , ‘ : by J. H. Woopcer
THE TRAUMA OF BIRTH ; 5 ; 4 - . by Orro Rank
FOUNDATIONS OF GEOMETRY AND INDUCTION A : ' “ rs . by JEAN Nicop
Tue Laws oF FEELING : ; : 5 : : . by F. PAULHAN
THe MENTAL DEVELOPMENT OF THE CHILD . , , a 0 A by K. BUHLER
Erpetic IMAGERY : : : 3 ; : F by E. R. JAeNscH
THE FOUNDATIONS OF MATHEMATICS 3 : - “ : by F. P. RAMSEY
THE PHILOSOPHY OF THE UNCONSCIOUS , : 2 . by E. von HARTMANN
Outunes oF THE History oF GREEK PHILOSOPHY . : i : : by E. ZELLER
THE PsycHOLOGY OF CHILDREN’s DRAWINGS : : : i . by HELGA ENG
INVENTION AND THE UNCONSCIOUS ; ; i Fi by J. M. Montmasson
THe THEORY OF LEGISLATION. . o . : 0 - by JEREMY BENTHAM
Tue Sociat Lire oF MONKEYS . : : : . by S. ZUCKERMAN
THe DEVELOPMENT OF THE SEXUAL IMPULSES , : F by R. E. Money KyRr.E
CONSTITUTION TyPEs IN DELINQUENCY . Fi 5 , : i by W. A. WILLEMSE
Tue PsycHOLOGY OF ANIMALS. : : 5 : : : . by F. ALVERDES
BENTHAM’S THEORY OF FICTIONS* ; . A : : : . by C. K. OcpENn
THE NATURE OF LEARNING F ‘ : Fi : . by G. HUMPHREY
Tne INDIVIDUAL AND THE CoMMUNITY . : : ; c : by WEN Kwert Liao
THe NATuRE oF MATHEMATICS . é i : : : ; . by Max Brack
INPANT SPEECH : : ; : : F : : 3 . by M. M. Lewis
IDEOLOGY AND UTOPIA . : i : : : . by K. MANNHEIM
An EXAMINATION OF LoGIcAL PosttivisM : 2 : : ° . by J. WEINBERG
THE LocicaAL SYNTAX OF LANGUAGE . : F : Fi by R. Carnap
PLato’s CosmoLocy* : : : és : . : by F. M. CoRNFORD
Cuarves Perrce’s EMPIRicisM* : . . : < 5 . by J. BUCHLER
Tue Limits oF ScIENCE : : é : A : : F . by L. CHwIsTEK
Tue ConbDiTIONS OF KNOWING. : . by A. SINCLAIR
BERTRAND RUSSELL’s CONSTRUCTION OF THE EXTERNAL WORLD : . by C. A, Fritz
TREATISE ON INDUCTION AND PROBABILITY . : : é by G. H. von WRIGHT
WHAT IS VALUE : : co Q : : ; 0 . by E. W. HALL
PLATO’s PHAEDO A ‘ : A : : : : ; . by R.S. Biuckx
...
Invrendering Mr Wittgenstein’s Tractatus Logico-Philosophicus
...
. Naturphilosophie (1921) fave been very carefully revised by
...
There are various problems as regards languagew First,
...
as a sentence) have to another in order to be capadle
...
Symbolism,‘ z.e. for Symbolism in which a sentence
...
he contends, be itself in turn sazd in language. It can,
...
or more facts is called a Zatsache: thus, for example,
‘*Socrates is wise” is a Sachverhalt, as wellasa Tatsache,
...
not say, the complex sign ‘a0’ says ‘a stands in a
certain relation R to 4’; but we must say, that ‘a’
stands in a certain relation to ‘6’ says that a R 6”
(3.1432).
...
as it were, opaque and blurred” (4.111 and 4.112). In
...
parts that are facts is called by Mr Wittgenstein a Sackver-
...
truth-function of several propositions ~, g, r.. . 1S one
containing ~, g, r .. . and such that its truth or false-
hood depends only upon the truth or falsehood of
~P:} 9,7... It might seem at first sight as though there
...
truth-functions are constructed out of ‘‘not-f and not-¢”
is easy to see. ‘‘Not-p and not-p” is equivalent to
‘‘not-~,” hence we obtain a definition of negation in terms
of our primitive function: hence we can define ‘‘7 or g,”
since this is the negation of ‘‘not-p and not-g,” ze. of
our primitive function. The development of other truth-
functions out of ‘‘not-p” and ‘‘g or g” is given in detail
...
extending the process to general propositions, z.e. to cases
where the propositions which are arguments to our truth-
function are not given by enumeration but are given as
all those satisfying some condition. For example, let /@
be a propositional function (z.e. a function whose values
are propositions), such as ‘‘z is human ’”’—then the various
values of fx form a set of propositions. We may extend
the idea ‘‘not-f and not-¢”’ so as to apply to simultaneous
denial of all the propositions which are values of fr. In
this way we arrive at the proposition which is ordinarily
represented in mathematical logic by the words ‘‘ fr
is false for all values of x.’ The negation of this would
be the proposition ‘‘ there is at least one x for which /* is
true’’ which is represented by ‘‘(qx)./x.” If we had
Started with not-/ instead of /* we should have arrived
at the proposition ‘‘7% is true for all values of x” which
is represented by ‘‘(z). /%.”” Wittgenstein’s method of
dealing with general propositions [z.e. ‘‘(x)./” and
‘‘(qr).fx”| differs from previous methods by the fact
...
he uses is (~, &, NV (€)). The following is the explanation
of this symbol :
...
The whole symbol (/, £, WV (€)) means whatever can be
...
obtained out of simultaneous negation, z.e. out of ‘‘ not-p
and not-g”’;

(6) Mr Wittgenstein’s theory of the derivation of
...
totality of them); that a proposition 1s always a truth-
function of atomic propositions ; and that if ~ follows from
q the meaning of 7 is contained in the meaning of g, from
...
ing to this principle x is identical with y if every property
of + is a property of y, but it would, after all, be logically
...
a pseudo-concept. To say ‘‘% is an object” is to say
...
with some definite property. Wecan say ‘‘ there are more
...
in the first case the function ‘‘z is human”; in the second
...
to explain, it seems as if a proposition could also oecur
in other ways, e.g. ‘‘A believes ~.” Here it seems super-
ficially as if the proposition g stood in a sort of relation
to the object A. ‘‘ But it is clear that ‘A believes that
p, ‘A thinks ~,’ ‘A says f’ are of the form ‘f says p’;
...
the logical form of belief, z.e. what is the schema repre-
...
in the form ‘‘A doubts f,” ‘‘A desires 7,” etc., which
...
as a fact on its own account, may bea set of words which
...
necessary to consider all propositions of the form /y where
jx is a given propositional function. This belongs to
...
Wittgenstein says, a structure concerning which, zz the
...
the mystical would be abolished. Such an hypothesis 1s
...
beruht. Man koénnte den ganzen Sinn des Buches etwa in
die Worte fassen: Was sich iiberhaupt sagen lasst, lasst
sich klar sagen ; und wovon man nicht reden kann, dariiber
muss man schweigen.

Das Buch will alsodem Denken eine Grenze ziehen, oder
vielmehr—nicht dem Denken, sondern dem Ausdruck der
Gedanken: Denn um dem Denken eine Grenze zu ziehen,
miissten wir beide Seiten dieser Grenze denken k6nnen (wir
miissten also denken kdnnen, was sich nicht denken
lasst).

Die Grenze wird also nur in der Sprache gezogen werden
k6nnen und was jenseits der Grenze liegt, wird einfach
Unsinn sein.

Wieweit meine Bestrebungen mit denen anderer Philo-
sophen zusammenfallen, will ich nicht beurteilen. Ja, was
ich hier geschrieben habe macht im Einzelnen tiberhaupt
...
written makes no claim to noveity in points of detail;
...
sein. Einfach darum, weil meine Kraft zur Bewdltigung
der Aufgabe zu gering ist.—Mégen andere kommen und
es besser machen.
...
On the other hand the ¢ruth of the thoughts communi-
...
T.21 Die Welt ist durch die Tatsachen bestimmt und
dadurch, dass es alle Tatsachen sind.
...
IZ Die Welt zerfallt in Tatsachen.

1.21 Eines kann der Fall sein oder nicht der Fall sein
...
eines Sachverhaltes sein zu kénnen.
...
ZNOn2T Es erschiene gleichsam als Zufall, wenn dem
Ding, das allein fiir sich bestehen k6nnte, nach-
traglich eine Sachlage passen wiirde.

Wenn die Dinge in Sachverhalten vorkommen
kénnen, so muss dies schon in ihnen liegen.
(Etwas Logisches kann nicht nur-méglich sein.
...
Die Satzen.1, n.2, n.3, etc., sind Bemerkungen zum Siatze No. n; die Sdtzen.m1,
...
It is essential to a thing that it can be acon-
...
The propositions 7.1, 2.2, #.3, etc., are comments on proposition No. x ; the pro-
positions ”.m1, ”.mz2, etc.,are comments on the proposition No. #.# ; and so on.
...
nicht ausserhalb des Raumes, zeitliche nicht ausser-
halb der Zeit denken konnen, so k6nnen wir uns
keinen Gegenstand ausserhalb der Moglichkeit
seiner Verbindung mit anderen denken.

Wenn ich mir den Gegenstand im Verbande
des Sachverhalts denken kann, so kann ich thn
nicht ausserhalb der Mo glichkeit dieses Ver-
bandes denken.

Das Ding ist selbstandig, insofern es in allen
moédglichen Sachlagen vorkommen kann, aber
diese Form der Selbstandigkeit ist eine Form des
Zusammenhangs mit dem Sachverhalt, eine Form
der Unselbstaindigkeit. (Es ist unmodglich, dass
Worte in zwei verschiedenen Weisen auftreten,
allein und im Satz.)

Wenn ich den Gegenstand kenne, so kenne ich
auch sdmtliche Moglichkeiten seines Vorkommens
in Sachverhalten.
...
Sind alle Gegenstande gegeben, so sind damit
auch alle moglichen Sachverhalte gegeben.

Jedes Ding ist, gleichsam, in einem Raume
modglicher Sachverhalte. Diesen Raum kann ich
mir leer denken, nicht aber das Ding ohne den
Raum.

Der raumliche Gegenstand muss im unendlichen
...
from time, so we cannot think of anzy object apart
...
atomic fact, a form of dependence. (It 1s im-
...
posstble atomic facts also given.

Every thing ts, as it were, in a space of possible
...
eine Hohe haben, der Gegenstand des Tastsinnes
eine Harte usw.

Die Gegenstande enthalten die Moglichkeit aller
Sachlagen.

Die Moglichkeit seines Vorkommens in Sach-
verhalten, ist die Form des Gegenstandes.

Der Gegenstand ist einfach.

Jede Aussage iiber Komplexe ldsst sich in eine
Aussage tiber deren Bestandteile und in diejenigen
...
Hatte die Welt keine Substanz, so wiirde, ob ein
Satz Sinn hat, davon abhangen, ob ein anderer Satz
wahr ist.

Es ware dann unmoglich, ein Bild der Welt
(wahr oder falsch) zu entwerfen.

Es ist offenbar, dass auch eine von der wirk-
lichen noch so verschieden gedachte Welt Etwas—
eine Form—mit der wirklichen gemein haben muss.

Diese feste Form besteht eben aus den Gegen-
standen.

Die Substanz der Weltkann nureine Form und
keine materiellen Eigenschaften bestimmen. Denn
diese werden erst durch die Sadtze dargestellt—erst
durch die Konfiguration der Gegenstande gebildet.

Beilaufig gesprochen: Die Gegenstande sind
farblos.

Zwei Gegenstinde von der gleichen logischen
Form sind—abgesehen von ihren externen Eigen-
schaften—von einander nur dadurch unterschieden,
...
Dinge, die ihre simtlichen Eigenschaften gemein-
...
The substance of the world caz only determine
...
Two objects of the same logical form are—
...
sam haben, dann ist es itiberhaupt unmdglich auf
...
Die Substanz ist das, was unabhangig von dem
was der Fall ist, besteht.

Sie ist Form und Inhalt.

Raum, Zeit und Farbe (Farbigkeit) sind Formen
der Gegenstande.

Nur wenn es Gegenstande gibt, kann es eine
...
Die Konfiguration der Gegenstande bildet den
Sachverhalt.

Im Sachverhalt hangen die Gegenstande inei-
nander, wie die Glieder einer Kette.

Im Sachverhalt verhalten sich die Gegenstande
in bestimmter Art und Weise zueinander.

Die Art und Weise, wie die Gegenstande im
Sachverhalt zusammenhangen, ist die Struktur
des Sachverhaltes.

Die Form ist die Moglichkeit der Struktur.
...
Das Bestehen und Nichtbestehen von Sachver-
...
Die Sachverhalte sind von einander unabhangig.
36
...
The object is the fixed, the existent ; the con-
...
The totality of existent atomic facts also deter-
...
Za Das Bildstellt die Sachlage im logischen Raume,
das Bestehen und Nichtbestehen von Sachverhalten
vor.

22 Das Bild ist ein Modell der Wirklichkeit.
...
ZuEd. Das Bild besteht darin, dass sich seine Elemente
in bestimmter Art und Weise zu einander verhalten.

Zag gala Das Bild ist eine Tatsache.

2.15 Dass sich die Elemente des Bildes in bestimmter

Art und Weise zu einander verhalten stellt ver,
...
29n 51 Die Form der Abbildung ist die Moglichkeit,
dass sich die Dinge so zu einander verhalten, wie
die Elemente des Bildes.

2.1511 Das Bild ist so mit der Wirklichkeit verkniipft ;
es reicht bis zu thr.

250512 Es ist wie ein Masstab an die Wirklichkeit
angelegt.

2.15121 Nur die dussersten Punkte der Teilstriche
...
2unyr4 Die abbildende Beziehung besteht aus den
Zuordnungen der Elemente des Bildes und der
Sachen.

2.1515 Diese Zuordnungen sind gleichsam die Fihler
38
...
o2003 The total reality is the world.
~2.1 We make to ourselves pictures of facts.

g2501 The picture presents the facts in logical space,
the existence and non-existence of atomic
facts.

22 The picture is a model of reality.
...
2.0510 Thus the picture is linked with reality; it reaches
up to it.
...
sein, damit das eine tiberhaupt ein Bild des anderen
sein kann.

Was das Bild mit der Wirklichkeit gemein
haben muss, um sie auf seine Art und Weise—
richtig oder falsch—abbilden zu kénnen, ist seine
Form der Abbildung.

Das Bild kann jede Wirklichkeit abbiiden,
deren Form es hat.
...
haupt—richtig oder falsch—abbilden zu k6nnen,
ist die logische Form, das ist, die Form der
Wirklichkeit.

Ist die Form der Abbildung die logische Form,
so heisst das Bild das logische Build.

Jedes Bild ist auch ein logisches. (Dagegen
ist z. B. nicht jedes Bild ein radumliches. )
...
eine Méglichkeit des Bestehens und Nichtbestehens
...
In order to be a picture a fact must have some-
thing in common with what it pictures.

In the picture and the pictured there must be
something identical in order that the one can bea
...
Every picture is a/so a logical picture. (On the
...
Das Bild stellt eine mogliche Sachlage im
logischen Raume dar.

Das Bild enthalt die Moglichkeit der Sachlage,
die es darstellt.

Das Bild stimmt mit der Wirklichkeit iiberein
oder nicht; es ist richtig oder unrichtig, wahr
oder falsch.

Das Bild stellt dar, was es darstellt, unabhangig
von seiner Wahr- oder Falschheit, durch die Form
der Abbildung.

Was das Bild darstellt, ist sein Sinn.

In der Ubereinstimmung oder Nichtiiberein-
...
»Hin Sachverhalt ist denkbar“ heisst: Wir
konnen uns ein Bild von ihm machen.

Die Gesamtheit der wahren Gedanken sind
ein Bild der Welt.

Der Gedanke enthalt die Moglichkeit der
Sachlage die er denkt. Was denkbar ist, ist
auch moglich.

Wir konnen nichts Unlogisches denken, weil
...
Etwas ,der Logik widersprechendes“ in der
...
The picture represents what it represents, inde-
...
Wohl konnen wir einen Sachverhalt raumlich
darstellen, welcher den Gesetzen der Physik,
aber keinen, der den Gesetzen der Geometrie
zuwiderliefe.

Ein a priori richtiger Gedanke ware ein solcher,
dessen Moglichkeit seine Wahrheit bedingte.

Nur so kénnten wir a priori wissen, dass ein
Gedanke wahr ist, wenn aus dem Gedanken
selbst (ohne Vergleichsobjekt) seine Wahrheit
zu erkennen ware.

Im Satz driickt sich der Gedanke sinnlich
wahrnehmbar aus.

Wir beniitzen das sinnlich wahrnehmbare
...
Zum Satz gehort alles, was zur Projektion
...
Der Satz ist kein Wortergemisch.—(Wie
...
Only if we could know a priori that a thought
...
Nur Tatsachen kénnen einen Sinn ausdriicken,
...
rdumlichen Gegenstanden (etwa Tischen, Stihlen,
Biichern) zusammengesetzt denken.

Die gegenseitige rdumliche Lage dieser Dinge
driickt dann den Sinn des Satzes aus.

Nicht: ,,Das komplexe Zeichen ,aRb‘ sagt,
dass ain der Beziehung R zu b steht‘, sondern:
Dass ,,a‘‘ in einer gewissen Beziehung zu ,,b‘‘
steht, sagt, dass aRb.

Sachlagen kann man beschreiben, nicht be-
nennen.

(Namen gleichen Punkten, Satze Pfeilen, sie
haben Sinn.)

Im Satze kann der Gedanke so ausgedriickt sein,
...
We must not say, ‘‘ The complex sign ‘akd’
says ‘a stands in relation k to 4’”; but we must
say, ‘‘ That ‘a’ stands in a certain relation to ‘3d’
says that akb”’.
...
meaning. (‘‘4” is the same sign as ‘‘ A ”.)
...
Die Gegenstainde kannichnurnennen. Zeichen
vertreten sie. Ich kann nur von thnen sprechen,
sie aussprechen kann ich nicht. Ein Satz
kann nur sagen, wie ein Ding ist, nicht was es ist.

Die Forderung der Moglichkeit der einfachen
...
Allgemeinheitsbezeichnung enth4lt ja ein Urbild.)

Die Zusammenfassung des Symbols eines Kom-
plexes in ein einfaches Symbol kann durch eine
Definition ausgedriickt werden.

Es gibt eine und nur eine vollstandige Analyse
des Satzes.

Der Satz driickt auf bestimmte, klar angebbare
...
Objects I can only xame. Signs represent them.
I can only speak of them. I cannot assert them.
A proposition can only say ow a thing is, not
what it is.
...
positions in which it occurs. We now that every-
thing is not yet determined by this proposition.
(The notation for generality contazms a prototype.)
...
Every defined sign signifies vza those signs
...
Die Bedeutungen von Urzeichen kénnen durch
...
konstant und alles tibrige variabel sein.
...
An expression has meaning only in a pro-
...
welche simtlich Werte des so entstandenen varia-
blen Satzes sind. Diese Klasse hangt im allge-
meinen noch davon ab, was wir, nach willkirlicher
...
ist die Angabe der Satze, deren gemeinsames
...
The determination of the values zs the variable.

The determination of the values of the pro-
positional variable is done by zndzcatzng the pro-
posttzons whose common mark the variable is.
...
that tt ts only a description of symbols and asserts
nothing about what ts symbolized.
...
ist ja willkiirlich. Man k6nnte also auch zwei ver-
...
Etwas, aber auch davon, dass etwas geschicht.

(Im Satze ,,Griin ist griin“—wo das erste Wort
...
So entstehen leicht die fundamentalsten Ver-
wechslungen (deren die ganze Philosophie voll
ist).

Um diesen Irrtiimern zu entgehen, miissen
wir eine Zeichensprache verwenden, welche sie
ausschliesst, indem sié nicht das gleiche Zeichen
in verschiedenen Symbolen, und Zeichen, welche
auf verschiedene Art bezeichnen, nicht dusserlich
...
of something but also of the fact af something
happening.
...
meanings but they are ad:fferent symbols.)
...
ing the same sign in different symbols and by
not applying signs in the same way which signify
in different ways. A symbolism, that is to say,
which obeys the rules of dog:cal grammar—of logical
syntax.
...
Das Zeichen bestimmt erst mit seiner logisch-
syntaktischen Verwendung zusammen eine logische
Form.

Wird ein Zeichen nicht gebraucht, so 1st
...
hat die Form ¢(fx), die dussere, die Form y(¢(fx)).
...
The sign determines a logical form only to-
gether with its logical syntactic application.

If a sign is ot necessary then it is meaningless.
...
From this observation we get a further view—
into Russell’s Theory of Types. Russell’s error is
...
A function cannot be its own argument, be-
...
be a proposition ‘‘ #(F(/x))”, and in this the outer
function / and the inner function / must have
different meanings; for the inner has the form
¢(/x), the outer the form V¥(¢(/r)). Common to
both functions is only the letter ‘‘*”, which by
itself signifies nothing.

This is at once clear, if instead of ‘‘ F(/(u))” we
write ‘‘(qdp): F(du). du= Fu’.
...
Die Regeln der logischen Syntax miissen sich
...
Art der Hervorbringung des Satzzeichens herriihren.
...
Zweck erfiillen kénnen, gemeinsam haben.

Man konnte also sagen: Der etgentliche Name
ist das, was alle Symbole, die den Gegenstand
bezeichnen, gemeinsam haben. Es wiirde sich so
...
W esen der Notation ab.)

Fine besondere Bezeichnungsweise mag _ un-
wichtig sein, aber wichtig ist es immer, dass diese
eine moOgliche Bezeichnungsweise ist. Und so
verhalt es sich in der Philosophie tiberhaupt: Das
...
Definitionen sind Regeln der Ubersetzung von
einer Sprache ineine andere. Jede richtige Zeichen-
sprache muss sich in jede andere nach solchen
Regeln iibersetzen lassen: Dies ist, was sie alle
gemeinsam haben.

Das, was am Symbol bezeichnet, ist das Gemein-
...
arbitrary, but ¢Azs is not arbitrary, namely that
...
to such rules. It is ¢hkzs which all have in
common.
...
Notation von ,, ~ p“ (,.nicht p“) und,,p v q“(,,p oder q“)
ersetzen lassen.

(Hiermit ist die Art und Weise gekennzeichnet,
wie eine spezielle mdgliche Notation uns allgemeine
Aufschliisse geben kann.)

Das Zeichen des Komplexes l6st sich auch bei
der Analyse nicht willkiirlich auf, so dass etwa seine
Auflésung in jedem Satzgefiige eine andere ware.
...
I’xistenz des sinnvollen Satzes.
...
Elemente—in Koordination—eingefiihrt.)
...
Der Mensch besitzt die Fahigkeit Sprachen zu
...
Wecan, for example, express what is common to
all notations for the truth-functions as follows: It
is common to them that they all, for example, caz
be replaced by the notations of ‘‘~p” (‘‘not p”)
and ‘‘ vq” (“‘porq”’).
...
The propositional sign and the logical co-
...
Es ist menschenunméglich, die Sprachlogik aus
...
kens schliessen kann; weil die dussere Form des
...
Die meisten Sdtze und Fragen, welche tber
philosophische Dinge geschrieben worden sind, sind
nicht falsch, sondern unsinnig. Wir kénnen daher
...
Probleme eigentlich keine Probleme sind.

Alle Philosophie ist ,Sprachkritik“. (Allerdings
...
deepest problems are really zo problems.
...
Und wenn wir in das Wesentliche dieser Bild-
haftigkeit eindringen, so sehen wir, dass dieselbe
durch scheinbare Unregelmadssigkeiten
(wie die Verwendung der# und b in der Notenschrift)
nicht gestort wird.

Denn auch diese Unregelmassigkeiten bilden
das ab, was sie ausdriicken sollen; nur auf eine
andere Art und Weise.

Die Grammophonplatte, der musikalische Ge-
...
Die Moglichkeit aller Gleichnisse, der ganzen
...
of the form aé as a picture. Here the sign is
...
by apparent irregularities (like the use of # and 6 in
the score).
...
score. Itis the rule of translation of this language
...
Der Satz zeigt, wie es sich verhalt, wenn er
wahr ist. Und ersagt, dass es sich so verhalt.

Die Wirklichkeit muss durch den Satz auf Ja
oder nein fixiert sein.

Dazu muss sie durch ihn vollstandig beschrieben
werden.

DerSatzistdie Beschreibung einesSachverhaltes.
...
Die Ubersetzung einer Sprache in eine andere
66
...
The proposition isa picture of reality, for I know
the state of affairs presented by it, if 1 understand
...
The proposition shows how things stand, #/ it is
...
features possessed by reality zf it is true. One can
...
einen in einen S atz der anderen iibersetzt, sondern
...
Ein Satz muss mit alten Ausdriicken einen
...
Im Satz wird gleichsam eine Sachlage pro-
...
Ein Name steht fiir ein Ding, ein anderer fiir
ein anderes Ding und untereinander sind sie
verbunden, so stellt das Ganze—wie ein lebendes
Bild—den Sachverhalt vor.

Die Moglichkeit des Satzes beruht auf dem
Prinzip der Vertretung von Gegensténden durch
Zeichen.
...
constants” do not represent. That the /ogzc of the
...
man natiirlich nicht selbst wieder abbilden. Aus
ihr kann man beim Abbilden nicht heraus.

Wollten wir z. B. das, was wir durch ,,(x) fx“
ausdriicken, durch Vorsetzen eines Indexes vor
»fx“ ausdriicken—etwa so: ,Alg. fx“, es wiirde
nicht geniigen— wir wiissten nicht, was verall-
gemeinert wurde. Wollten wir es durch einen
Index ,,a“ anzeigen—etwa so: ,,f(x,)‘— es wiirde
auch nicht geniigen — wir wiissten nicht den
Bereich der Allgemeinheitsbezeichnung.

Wollten wir es durch Einfihrung einer Marke
in die Argumentstellen versuchen —etwa so:
A, A). F (A, A)“—es wiirde nicht geniigen—wir
k6nnten die Identitat der Variablen nicht feststellen.
U.s.w.

Alle diese Bezeichnungsweisen geniigen nicht,
weil sie nicht die notwendige mathematische
Mannigfaltigkeit haben.

Aus demselben Grunde geniigt die idealistische
Erklarung des Sehens der rdumlichen Beziehungen
...
expressed by ‘‘ (x). fx” by putting an index before
ft, like: ‘‘Gen. fx”, it would not do, we should
not know what was generalized. If we tried to
show it by an index g, like: ‘“/(z,)” it would not
...
Kann man sich nicht mit falschen Satzen, wie
...
Dass aber die Zeichen ,,p“ und ,, ~ p“ das gleiche
sagen kinnen, ist wichtig. Denn es zeigt, dass
...
Fin Bild zur Erklarung des Wahrheitsbegriffes:
Schwarzer Fleck auf weissem Papier; die Form
des Fleckes kann man beschreiben, indem man
fiir jeden Punkt der Flache angibt, ob er weiss
...
by ‘‘p” we mean ~7%, and what we mean is the
case, then ‘‘f”’ in the new conception is true
and not false.

That, however, the signs ‘p” and “ ~” can
...
characteristic of its sense (~ ~f/=)).

The propositions ‘p” and ‘' ~p” have op-
...
to say ‘‘p”’ is true (or false) 1 must have deter-
mined under what conditions I call ‘‘p” true,
...
Jeder Satz muss schon einen Sinn haben;
die Bejahung kann ihn ihm nicht geben, denn
sie bejaht ja gerade den Sinn. Und dasselbe gilt
von der Verneinung, etc.

Man koénnte sagen: Die Verneinung bezieht
sich schon auf den logischen — den der verneinte
Satz bestimmt.
...
Die Gesamtheit der wahren Sdatze ist die
gesamte Naturwissenschaft (oder die Gesamtheit
der Naturwissenschaften).

Die Philosophie ist keine der Naturwissen-
schaften.
...
shows that what is denied is already a_ pro-
...
was tiber oder unter, aber nicht neben den Natur-
...
sophische Sdtze“, sondern das Klarwerden von
Satzen.
...
Die Psychologie ist der Philosophie nicht ver-
wandter als irgend eine andere Naturwissen-
schaft.
...
die Philosophen fiir die Philosophie der Logik fiir
so wesentlich hielten? Nur verwickelten sie sich
meistens in unwesentliche psychologische Unter-
...
Die Philosophie begrenzt das _ bestreitbare
...
Alles was iiberhaupt gedacht werden kann,
...
Philosophy is not atheory but an activity.
...
Philosophy limitsthe disputable sphereof natural
science.
...
It will mean the unspeakable by clearly dis-
...
Der Satz kann die gesamte Wirklichkeit dar-
stellen, aber er kann nicht das darstellen, was er
mit der Wirklichkeit gemein haben muss, um sie
darstellen zu k6nnen—die logische Form.

Um die logische Form darstellen zu kénnen,
miissten wir uns mit dem Satze ausserhalb der
Logik aufstellen kénnen, das heisst ausserhalb der
Welt.
...
wir nicht durch sie ausdricken.

Der Satz zeigt die logische Form der Wirk-
lichkeit.

Er weist sie auf.

So zeigt ein Satz ,,fa“, dass in seinem Sinn der
...
Was gezeigt werden kann, kann nicht gesagt
werden.

Jetzt verstehen wir auch unser Gefiihl: dass wir
im Besitze einer richtigen logischen Auffassung
seien, wenn nur einmal alles in unserer Zeichen-
sprache stimmt.

Wir konnen in gewissem Sinne von formalen
...
That which expresses z¢se/f in language, we-
cannot express by language.

The propositions sow the logical form of reality.

They exhibit it.

Thus a proposition ‘‘/a” shows that in its sense
the object @ occurs, two propositions “fa” and
...
Eine interne Eigenschaft einer Tatsache kénnen
...
unthinkable that ¢/ese two objects should not stand
in this relation.)
...
The existence of an internal property ofa possible
...
moéglichen Sachlagen driickt sich sprachlich durch
eine interne Relation zwischen den sie darstellenden
Satzen aus.

Hier erledigt sich nun die Streitfrage ,,ob alle
Relationen intern oder extern“ seien.

Reihen, welche durch interne Relationen
...
Die formalen Begriffe koénnen ja nicht, wie
...
Now this settles the disputed question ‘‘ whether
all relations are internal or external’’.

Series which are ordered by zxernal/ relations I
call formal series.

The series of numbers is ordered not by an
external, but by an internal relation.

Similarly the series of propositions ‘‘aRd”,

“SG@q7) kr ako”,
 (qx,y) :aRx.xRy.yRb’’, etc.

(If 6 stands in one of these relations to a, I call
6 a successor of a.)
...
Eine Null‘ und alle ahnlichen sind unsinnig.
...
fore a propositional variable in which only this
...
Every variable is the sign of a_ formal
concept.
...
So the variable name ‘‘z” is the proper sign of
the pseudo-concept odject.
...
objects which . . .”, by ‘“‘(qay)...”.

Wherever it is used otherwise, z.e. as a proper
concept word, there arise senseless pseudo-

propositions.
So one cannot, eg. say ‘‘ There are objects”
as one says ‘‘ There are books”. Nor ‘‘ There

are 100 objects” or ‘‘ There are &, objects”.
...
eine I‘‘, als eS unsinnig ware, zu sagen: 2+2 ist
um 3 Uhr gleich 4.)
...
Der Sinn des Satzes ist seine Ubereinstim-
mung, und Nichtiibereinstimmung mit den Még-
...
the general proposition ‘‘4 is a successor of a”
we need for this an expression for the general
term of the formal series: akd, (q+):aRx.xkd,
(q2,y):aRx.xRy.yRb, ... The general term of
...
4.128 The logical forms are anumertcal.
...
Der einfachste Satz, der Elementarsatz, be-
...
Der Name kommt im Satz nur im Zusammen-
hange des Elementarsatzes vor.

Die Namen sind die einfachen Symbole, ich
deute sie durcheinzelne Buchstaben (,,x‘“‘,,,y“‘, ,,z°*)
an.
...
Gebrauche ich zwei Zeichen in ein und der-
selben Bedeutung, so driicke ich dies aus, indem
ich zwischen beide das Zeichen ,, = ‘‘ setze.

»a = b** hetsst also: das Zeichen ,,a‘‘ ist durch
das Zeichen ,,b‘‘ ersetzbar.

(Fihre ich durch eine Gleichung ein neues
...
The simplest proposition, the elementary pro-
position, asserts the existence of an atomic fact.

It is a sign of an elementary proposi-
...
them by single letters (7,y,2).

The elementary proposition I write as function
of the names, in the form ‘‘/r”’, ‘‘¢(x%,y)”, etc.

Or I indicate it by the letters Z,¢,7.

If I use two signs with one and the same
meaning, I ge this by putting between them
the sign ‘‘=

‘‘g=6” means then, ote the sign ‘‘a” is
replaceable by the sign ‘‘6”,

(If I introduce by an equation a new sign ‘‘d”,
...
Ausdriicke von der Form ,,a=b‘‘ sind also nur
Behelfe der Darstellung ; sie sagen nichts uber die
Bedeutung der Zeichen ,,a‘‘, ,,b‘‘ aus.

Konnen wir zwei Namen verstehen, ohne zu
wissen, ob sie dasselbe Ding oder zwei verschie-
dene Dinge bezeichnen ?—Ko6nnen wir einen Satz,
...
beiden gleichbedeutend sind; es ist unmdglich,
dass ich sie nicht ineinander tibersetzen kann.
...
Die Angabe aller wahren, Elementarsatze be-
schreibt die Welt vollstandig. Die Welt ist
volistandig beschrieben durch die Angaben aller
Elementarsatze plus der Angabe, welche von ihnen
wahr und welche falsch sind.

Beziiglich des Bestehens und Nichtbestehens von

n Sachverhalten gibt es K, = 5 ("| Maglichkeiten.

Es kénnen alle Kombinationen der Sachverhalte
...
Die Wahrheitsmoglichkeiten der Elementarsatze
...
—(like Russell) in the form ‘‘a@=6 Def.”. A
definition is a symbolic rule.)

Expressions of the form ‘‘a= 6” are therefore only
expedients in presentation: They assert nothing
about the meaning of the signs ‘‘@a” and “6”,

Can we understand two names without know-
...
The specification of all true elementary pro-
...
With regard to the existence of 2 atomic facts
...
Einfihrung der Elementarsatze fiir das Verstandnis
aller anderen Satzarten grundlegend ist. Ja, das
Verstandnis der allgemeinen Satze hangt fihl bar
von dem der Elementarsatze ab.

Beziiglich der Ubereinstimmung und Nichtiiber-
einstimmung eines Satzes mit den Wahrheits-
moéglichkeiten von n Elementarsdtzen gibt es

K
*7/K,\_ agua uainiane
=( : \=L, Méglichkeiten.

Die Ubereinstimmung mit den Wahrheitsmé6-
...
possibilities of 2 elementary propositions there
are 55 6a) = L, possibilities.
...
glichkeiten ké6nnen wir dadurch ausdriicken, indem
...
Der Ausdruck der Ubereinstimmung und Nicht-
iibereinstimmung mit den Wahrheitsméglichkeiten
...
Nur ist die Erklarung des Wahrheitsbegriffes bet
Frege falsch: Waren ,,das Wahre“ und ,,das Falsche“
wirklich Gegensténde und die Argumente in ~p
...
»/“ und , W“ kein Gegenstand (oder Komplex von
...
Analoges gilt natiirlich fiir alle Zeichen, die das-
...
The expression of the agreement and disagree-
...
in ~/, etc., then the sense of ~f would by no
...
»(W W—W) (p,q)* oder deutlicher ,(WWFW)
(p.q)“.
(Die Anzahl der Stellen in der linken Klammer
ist durch die Anzahl der Glieder in der rechten
bestimmt.)

Fur n Elementarsatze gibt es L, mégliche Grup-
pen von Wahrheitsbedingungen.

Die Gruppen von Wahrheitsbedingungen,
welche zu den Wahrheitsméglichkeiten einer
Anzahl von Elementarsatzen gehoren, lassen sich
in eine Reihe ordnen.

Unter den méglichen Gruppen von Wahrheits-
bedingungen gibt es zwei extreme Falle.

In dem einen Fall ist der Satz fiir simtliche
Wahrheitsmoglichkeiten der Elementarsatze wahr.
Wir sagen, die Wahrheitsbedingungen sind
tautologisch.

Im zweiten Fall ist der Satz fiir simtliche
Wahrheitsméglichkeiten falsch: Die Wahrheits-
...
‘“(T T—T) (f,9)”, or more plainly: ‘*(T TFT)
(2:9):
...
For x elementary propositions there are L,
...
We say that the truth-conditions are sautological.
...
tion erfillt den ganzen logischen Raum und lasst
...
(Gewiss, mdglich, unmédglich: Hier haben wir
...
(I know, e.g. nething about the weather, when
...
The logical product of a tautology and a pro-
...
sind, konnen iiberhaupt keine Zeichenverbindungen
sein, denn sonst kdénnten ihnen nur bestimmte
...
der Zeichenverbindung, namlich thre Auflésung.

Freilich sind auch in der Tautologie und Kon-
...
Sy m bol unwesentlich.

Nun scheint es moglich zu sein, die allgemeinste
Satzform anzugeben: das heisst, eine Beschreibung
der Satze irgend einer Zeichensprache zu geben,
so dass jeder modgliche Sinn durch ein Symbol,
...
(And to no logical combination corresponds zo
...
another in the tautology and contradiction, z.e.
...
most general form of proposition ; z.e. to give a
...
general form of proposition on/y what is essential
...
form could not have been foreseen (z.¢. constructed).

Io

LOGISCH-PHILOSOPHISCHE ABHANDLUNG

konstruieren) kénnen. Die allgemeine Form des
...
4.52 Die Sadtze sind Alles, was aus der Gesamtheit
aller Elementarsatze folgt (natiirlich auch daraus,
dassesdie Gesamtheit aller ist). (Sokénnte
...
erkenne ndamlich sowohl am Argument wie am
...
man konnte statt ,,+.‘ auch ein einfaches Zeichen
wahlen ; in ,, ~ p“ abet ist ,,p“ kein Index, sondern
ein Argument: der Sinn von,,~p“ kann nicht
...
dessen Namen wir ihn anhadngen. Z. B. Der
...
Suppose a// elementary propositions were given
me: then we can simply ask: what propositions I
can build out of them. And these are a@// pro-
...
all propositions are generalizations of the elemen-
tary propositions.)
...
The elementary propositions are the truth-argu-
...
In Russell’s “ +,”, for example, “c” ifs an
...
“4,": but in  ~p” “py” is not an index but
an argument ; the sense of ‘‘ ~p” cannot be under-
stood, unless the sense of ‘‘f” has previously been
understood. (In the name Julius Cesar, Julius is
an index. The index is always part of a descrip-
tion of the object to whose name we attach it, e.g.
The Czsar of the Julian gens.)
...
Namen.
5.1 Die Wahrheitsfunktionen lassen sich in Reihen
ordnen.
Das ist die Grundlage der Wahrscheinlichkeits-
lehre.
5.101 Die Wahrheitsfunktionen jeder Anzahl von

Elementarsatzen lassen sich in einem Schema
folgender Art hinschreiben :

(W W W W) (p, q) Tautologie (Wenn p,sop; undwenngq,soq.) (pp p.q>q)
(F W W W)(p, q) in Worten: Nicht beides p und q. (~ (p.q))

(W FW W) (p, q) ” ” Wenn q, SO p. (q ~ p)

(WWE W) (p, q) ” ” Wenn p, so q- (p> q)

(WW W F)(p, q) poderq. (pvq)

(F FW W)(p,q)»  » Nicht q. (~ q)

(F WF W)(p,q)»  » Nicht p. (~ p)

(F WW F) (p,q) 5, 5 p, oder q, abernicht beide. (p.~q:iviq.~p) ~
(WF FW)(pq)»  » Wenn p, so q; und wenn q, so p. (p==q)
(WF WF)(p,q)5 5 p
...
(F F W F) (p,q) » ” pund nichtq. (p. ~ q)

(F WF F)(pqg»  » qund nicht p. (q. ~ p)

(W F F F)(p,q) 5 qundp. (q-p)

(F F F F)@p, q) Kontraditstion(piedduicht); om igemeiate )(p. ~ p.q. ~ q)

Diejenigen Wahrheitsmoglichkeiten seiner
Wahrheitsargumente, welche den Satz bewahr-
heiten, will ich seine Wahrheitsgriinde
nennen.

5.11 Sind die Wahrheitsgriinde, die einer Anzahl
von Satzen gemeinsam sind, sdmtlich auch Wahr-
heitsgriinde eines bestimmten Satzes, so sagen
wir, die Wahrheit dieses Satzes folge aus der
Wahrheit jener Satze.

5.12 Insbesondere folgt die Wahrheit eines Satzes
,p‘‘ aus der Wahrheit eines anderen ,,q‘‘, wenn
alle Wahrheitsgrinde des zweiten Wahrheits-
...
5.1 The truth-functions can be _ ordered in
series.
...
(T T T T) (Z, 2) Tautology (if g then Z, and if g theng) [fDf. 7D]
...
Notg. [~g]
Not 2 [~ J]
p org, but not both. [f.~¢7:v:¢g.~p]
If Z, theng, andifg,then zg. [f=¢]
...
(F FF F) (J, 7) Gonttaaicrion (ata not~,andgand not¢.)[p. ~ f.9. ~ 9]

5.12

Those truth-possibilities of its truth-arguments,
which verify the proposition, I shall call its ¢ruch-
grounds.
...
In particular the truth of a proposition 7 follows
from that of a proposition q, if all the truth-
...
Die Wahrheitsgriinde des einen sind in denen
des anderen enthalten ; p folgt aus q.

Folgt p aus q, so ist der Sinn von ,,p‘* im
Sinne von ,,q‘‘ enthalten.

Wenn ein Gott eine Welt erschafft, worin
gewisse Satze wahr sind, so schafft er damit auch
schon eine Welt, in welcher alle ihre Folgesatze
stimmen. Und dhnlich k6nnte er keine Welt
schaffen, worin der Satz ,,p‘‘ wahr ist, ohne seine
simtlichen Gegenstande zu schaffen.

Der Satz bejaht jeden Satz der aus ihm
folgt.

»yp.q‘‘ ist einer der Satze, welche ,,p‘‘ bejahen
und zugleich einer der Sdtze, welche ,,q‘
bejahen.
...
Dass die Wahrheit eines Satzes aus der Wahr-
heit anderer Satze folgt, ersehen wir aus der
Struktur der Satze.

Folgt die Wahrheit eines Satzes aus der Wahr-
heit anderer, so druckt sich dies durch Beziehun-
...
Wenn wir von pvq und ~p auf q schliessen,
so ist hier durch die Bezeichnungsweise die Bezie-
hung der Satzformen von ,,pvq“ und ,,~ p“ ver-
hillt. Schreiben wir aber z. B. statt ,,pvq“
»Piq -|. pig“ und statt ,,~p* ,,plp* (plq=weder
...
The truth-grounds of g are contained in those
of p; p follows from q.

If p follows from gq, the sense of ‘‘ p” is contained
in that of ‘‘q”’.

If a god creates a world in which certain pro-
...
in which the proposition ‘‘f” is true without
creating all its objects.

A proposition asserts every proposition which
follows fron it.

‘‘b.q” is one of the propositions which assert
...
When we conclude from pvg and ~?# to g the
relation between the forms of the propositions
‘“‘bvqg” and ‘‘~” is here concealed by the method
of symbolizing. But if we write, e.g. instead of
“pvqg” “dlq .|. p|q” and instead of ‘‘ ~p”
“p|p” (p|q=neither # nor q), then the inner
...
Folgt paus q, so kann ich von q auf pschliessen ;
p aus q folgern.
...
»ochlussgesetze“, welche—wie bei Frege und
Russell—die Schlisse rechtfertigen sollen, sind
sinnlos, und waren iiberflissig.

Alles Folgern geschieht a priori.

Aus einem Elementarsatz lasst sich kein anderer
folgern.
...
Die Ereignisse der Zukunft ko6nnen wir nicht
aus den gegenwartigen erschliessen.

Der Glaube an den Kausalnexus ist der A ber-
glaube.

Die Willensfreiheit besteht darin,dass zuktinftige
Handlungen jetzt nicht gewusst werden kénnen.
Nur dann k6énnten wir sie wissen, wenn die Kau-
...
(The fact that we can infer fa from (+). /¢ shows
that generality is present also in the symbol
ais 9 re ae

If ~ follows from g, I can conclude from ¢ to 2;
infer ~ from g.
...
The events of the future cannot be inferred from
...
only know them if causality were an zzmer necessity,
like that of logical deduction.—The connexion
of knowledge and what is known is that of logical
necessity.

(‘‘ A knows that / is the case” is senseless if p
is a tautology.)

If from the fact that a proposition is obvious
to us it does not fol/ow that it is true, then obvious-
...
Die Tautologie folgt aus allen Satzen : sie sagt
Nichts.
...
Die Kontradiktion ist die dussere Grenze der
Satze, die Tautologie ihr substanzloser Mittelpunkt.

Ist W, die Anzahl der Wahrheitsgriinde des
Satzes ,,r“, W,, die Anzahl derjenigen Warheits-
griinde des Satzes,,s“,die zugleich Wahrheitsgriinde
von ,,r“ sind, dann nennen wir das Verhaltnis: W,,:
W, das Mass der Wahrscheinlichkeit, welche
der Satz ,,r‘ dem Satz ,,s“ gibt.

Sei in einem Schema wie dem obigen in No.
5.101 W, die Anzahl der ,,.W“ im Satze r; W,, die
...
Satze, welche keine Wahrheitsargumente mit
...
»p“ die Wahrscheinlichkeit 1. Die Gewissheit
...
If » follows from g and g from / then they are
one and the same proposition.

A tautology follows from all propositions: it
says nothing.

Contradiction 1s something shared by proposi-
tions, which zo proposition has in common with
...
If 7, is the number of the truth-grounds of the
proposition ‘‘ry”, 7,, the number of those truth-
grounds of the proposition ‘‘s’’ which are at the
same time truth-grounds of ‘‘+”, then we call the
ratio 7,,: 7, the measure of the probability which
the proposition ‘‘7” gives to the proposition ‘‘s”’,

Suppose in a schema like that above in No.
5.101 Z, is the number of the ‘‘T”’’s in the pro-
position 7, Z;,, the number of those “T”’’s in
the proposition s, which stand in the same columns
as ‘©T”’s of the proposition ~; then the proposi-
tion 7 gives to the proposition s the probability
i Aaa ae
...
If p follows from g, the proposition g gives
to the proposition g the probability 1. The
...
in die Urne zurtick. Dann kann ich durch den
...
D as ist also kein mathematisches Faktum.
...
So ist die Wahrscheinlichkeit eine Verallge-
meinerung.
...
So ¢his is not a mathematical fact.
...
Die Strukturen der Satze stehen in internen
Beziehungen zu einander.

Wir k6nnen diese internen Beziehungen
...
Und das wird natirlich von ihren formalen
...
Die Wahrheitsfunktionen der Elementarsatze
...
between the structures of its result and_ its
bases.

The operation is that which must happen toa
...
An operation shows itself ina variable ; it shows
...
Die Operation kennzeichnet keine Form, son-
...
(Operation und Funktion dirfen nicht mitein-
ander verwechselt werden.)

Eine Funktion kann nicht thr eigenes Argument
...
dreimaligen successiven Anwendung von ,,O’ é“
auf ,,a“).

In einem ahnlichen Sinne rede ich von der
successiven Anwendung mehrerer Operationen
auf eine Anzahl von Satzen.

Das allgemeine Glied einer Formenreihe a, O’ a,
O’ O’a, .... schreibe ich daher so:,fa, x, O’ x]*.
...
The same operation which makes ‘‘g” from
“4”, makes ‘‘r” from “fg”, and so on. This
can only be expressed by the fact that ‘“p”, ‘‘¢”,
‘‘y”, etc., are variables which give general ex-
pression to certain formal relations.

The occurrence of an operation does not charac-
...
(‘‘O? O’ O’ a” is the result of the threefold suc-
cessive application of ‘‘ O’ €” to “‘a”’).
...
OF Ome,.. 7.71 ewrite “thus: “faz, 0 2]. This
...
riickgangig machen. Operationen k6nnen ein-
ander aufheben.

Die Operation kann verschwinden (z. B. die
Verneinung in,,~ ~p“ ~ ~ p=p).

Alle Satze sind Resultate von Wahrheitsopera-
tionen mit den Elementarsatzen.

Die Wahrheitsoperation ist die Art und Weise,
wie aus den Elementarsatzén die Wahrheitsfunk-
tion entsteht.
...
Die Schemata No. 4.31 haben auch dann eine
...
funktionen von Elementarsadtzen sind, Eine
Wahrheitsfunktion von Elementarsétzen aus-
drickt.
...
term 2x of the series, and the third the form
...
Operations can vanish (e.g. denial in ‘'~ ~p”’.
~ 7)»
...
propositions, z.e. a proposition. The result of
every truth-operation on the results of truth-
Operations on elementary propositions 1s also
the result of ome truth-operation on elementary
propositions.

Every proposition is the result of truth-opera-
tions on elementary propositions.

The Schemata No. 4.31 are also significant, if
“<p”, “9g”, “xr”, etc. are not elementary pro-
positions.

And it is easy to see that the propositional
sign in No. 4.42 expresses one truth-function of
elementary propositions even when ‘‘f” and
‘‘g” are truth-functions of elementary proposi-
tions.
...
Und es ist offenbar, dass das ,,D“, welches wir
...
Verneint,, ~ ~ p“ ~ p, oder bejahtes p; oder beides?

Der Satz ,,~ ~ p“ handelt nicht von der Ver-
neinung wie von einem Gegenstand ; wohl aber ist
die Moéglichkeit der Verneinung in der Bejahung
...
That v, D, etc., are not relations in the sense of
...
And it is obvious that the ‘‘>” which we define
...
That from a fact # an infinite number of others
should follow, namely ~ ~ ~,~ ~ ~ ~ P, etc., is
...
Does ‘‘ ~ ~p” deny ~/f, or does it affirm 2;
or both?

The proposition ‘‘ ~ ~p” does not treat of
...
so musste ,,~ ~ p“ etwas anderes sagen als ,,p“.
Denn der eine Satz wtrde dann eben von ~
handeln, der andere nicht.

Dieses Verschwinden der scheinbaren logischen
Konstanten tritt auch ein, wenn ,,~ (qx). ~ fx“
dasselbe sagt wie ,,(x). fx“, oder ,,(qx) . fx. x=a“
dasselbe wie ,,fa“.

Wenn uns ein Satz gegeben ist, so sind mit
ihm auch schon die Resultate aller Wahrheitso-
...
Hat die Logik Grundbegriffe, so miissen sie von
einander unabhangig sein. Ist ein Grundbegriff
eingefiihrt, so muss er in allen Verbindungen
eingefiihrt sein, worin er iberhaupt vorkommt. Man
kann ihn also nicht zuerst fir eine Verbindung,
dann noch einmal fiir eine andere einfihren.
Z. B.: Ist die Verneinung eingefiihrt, so miissen
wir sie jetzt in Satzen von der Form ,, ~ p“ ebenso
verstehen, wie in Satzen wie,, ~ (pvq), (qx). ~ fx"
u.a. Wir diirfen sie nicht erst fir die eine Klasse
von Fallen, dann fiir die andere einfiihren, denn es
bliebe dann zweifelhaft, ob inre Bedeutung in beiden
Fallen die gleiche ware und es ware kein Grund
vorhanden, in beiden Fallen dieselbe Art der
Zeichenverbindung zu benttzen.

(Kurz, fiir die Einfiihrung der Urzeichen gilt,
mutatis mutandis, dasselbe, was Frege (,,Grund-
gesetze der Arithmetik“) fir die Einfiihrung von
Zeichen durch Definitionen gesagt hat.)

Die Einfiihrung eines neuen Behelfes in den Sym-
bolismus der Logik muss immer ein folgenschweres
Ereignis sein. Kein neuer Behelfdarf in die Logik—
sozusagen, mit ganz unschuldiger Miene—in Klam-
mern oder unter dem Siriche eingefihrt werden.
...
constants also occurs if ‘‘ ~ (qx). ~/%” says the
same as ‘‘(x). f/x”, or “(q4)./%.2+=a” the same
as “fa”.
...
tion of logic ou¢ of its primitive signs must become
clear.
...
introduce it for ome context and then again for
another. For example, if denial is introduced,
we must understand it in propositions of the form
‘(w”, just as in propositions like ‘ ~ (pvq)”,
“(q2). ~ fe” and others. We may not first
...
Hat sich aber die Einfihrung eines neuen
Behelfes an einer Stelle als noétig erwiesen, so muss
man sich nun sofort fragen: Wo muss dieser
Behelf nun immer angewandt werden? Seine
Stellung in der Logik muss nun erklart werden.

Alle Zahlen der Logik miissen sich rechtfertigen
lassen.
...
Die Lésungen der logischen Probleme missen
...
aller ihrer Kombinationen eingeftthrt; also nicht
nur ,,pvq‘ sondern auch schon ,,~(pv~q)* ete.
etc. Man hatte damit auch schon die Wirkung
aller nur méglichen Kombinationen von Klammern
eingefihrt. Und damit ware es klar geworden,
...
ately ask: Where is this expedient a/ways to be
...
The solution of logical problems must be neat
...
‘‘ovq”’ but also ‘‘~(pv~q)”, etc. etc. Weshould
...
primitive signs are not ‘‘pvqg”, ‘(qx)./%”, etc.,
...
die ,pvq“, ,,(ax). fx“, etc. sind, sondern die all-
...
wie v und 3, der Klammern bedirfen—im Gegen-
...
Die logischen Operationszeichen sind Inter-
punktionen.

Es ist klar, dass alles was sich tiberhaupt von
vornherein tiber die Form aller Satze sagen
lasst, sich aufeinmal sagen lassen muss.
...
Die Logik muss fir sich selber sorgen.

Ein mégliches Zeichen muss auch bezeichnen
koénnen. Alles was in der Logik méglich ist, ist
...
The apparently unimportant fact that the appa-
...
beforehand about the form of a// propositions at
all can be said on one occasion.

For all logical operations are already contained
in the elementary proposition. For ‘‘/a”’ says
theysameas “(azar . ca”.
...
which af propositions, according to their nature,
have in common with one another.
...
wir eine willkirliche Bestimmung nicht getroffen
...
Wir konnen einem Zeichen nicht den unrechten
Sinn geben.

Occams Devise ist natirlich keine willkirliche,
oder durch ihren praktischen Erfolg gerechtfertigte,
Regel: Sie besagt, dass unn6étige Zeichenein-
heiten nichts bedeuten.

Zeichen, die Einen Zweck erfillen, sind logisch
aquivalent, Zeichen, die keinen Zweck erfillen,
logisch bedeutungslos.

Frege sagt: Jeder rechtmassig gebildete Satz
muss einen Sinn haben; und ich sage: Jeder
moégliche Satz ist rechtmassig gebildet, und wenn er
keinen Sinn hat, sokann das nur daran liegen, dass
...
weil wir dem Wort ,identisch“ als Eigenschafts-
...
not because the symbol ts in itself unpermissible. )
...
equivalent, signs which serve xo purpose are
...
because we have given zo meaning to the word
...
Die Anzahl der nétigen Grundoperationen hangt
...
(g¢, ... .) auf Elementarsatze.

Diese Operation verneint samtliche Satze in der
rechten Klammer und ich nenne sie die Negation
dieser Satze.

Einen Kliammerausdruck, dessen Glieder Satze
sind, deute ich—wenn die Reihenfolgeder Glieder in
der Klammer gleichgiiltig ist—durch ein Zeichen von
der Form ,(£)“ an. ,,¢é“ ist eine Variable, deren Werte
die Glieder des Klammerausdruckes sind ; und der
Strich uber der Variablen deutet an, dass sie ihre
...
Wir konnen drei Arten der Beschreibung
...
einer Funktion fx, deren Werte fir alle Werte von
x die zu beschreibenden Satzesind. 3. Die Angabe
...
The number of necessary fundamental opera-
tions depends oz/y on our notation.
...
a number of primitive tdeas which must be signified
but with the expression of a rule.

Every truth-function is a result of the successive
application of the operation (- - - - - TOE, ... .) 80
...
“(g)", “£€ is a variable whose values are the
...
z. Giving a function /*, whose values for all
...
Ich schreibe also statt ,(----- W)(é,... .)
»N(g).

N(é) ist die Negation samtlicher Werte der
Satzvariablen &.

Da sich offenbar leicht ausdriicken lasst, wie mit
dieser Operation Satze gebildet werden kénnen und
wie Sdtze mit ihr nicht zu bilden sind, so muss
dies auch einen exakten Ausdruck finden konnen.

Hat énur einen Wert, so ist N(¢)= ~ p (nicht p),
...
»~ p“ ist wahr, wenn ,,p“ falsch ist. Also in
...
Therefore I write instead of ‘‘(----- T)
(Ex... ae”.

N (€) is the negation of all the values of the
propositional variable €.

As it is obviously easy to express how proposi-
...
If € has only one value, then N (¢)= ~ p (not ),
if it has two values then N (£)= ~p. ~ g (neither
p nor q).
...
which assert both p and g, is the proposition
‘‘~.q’". What is common to all symbols, which
assert either / or g, is the proposition ‘‘pvq”’.
...
Diese Regeln sind den Symbolen 4quivalent
...
Wenn das Zeichen ,,p“ in ,,pvq“ nicht fir ein kom-
plexes Zeichen steht, dann kann es allein nicht
Sinn haben; dann kénnen aber auch die mit ,,p“
...
gative Tatsache ausdriickenkénnen. (Etwa: Wenn
a“ nicht in einer bestimmten Beziehung zu ,,b“ steht,
kénnte das ausdricken, dass aRb nicht der Fall ist.)
...
Sind die Werte von € sdmtliche Werte einer
Funktion fx fiir alle Werte von x, so wird
N(é) = ~ (qx). fx.

Ich trenne den Begriff Alle von der Wahrheits-
funktion.
...
that ‘“‘g:pv ~ p” says the same as ‘‘¢g”; that
“pv ~ p” says nothing.

If a notation is fixed, there is in it a rule accord-
ing to which all the propositions denying / are
constructed, a rule according to which all the
propositions asserting are constructed, a rule
according to which all the propositions asserting
p or g are constructed, and so on. These rules
...
‘‘g” presuppose ‘‘v’’, ‘* ~ ”, etc. If the sign
“‘p” in ‘‘pvq” does not stand for a complex sign,
then by itself it cannot have sense; but then also
the signs ‘‘pvp”, ‘“p.p”, etc. which have the
same sense as ‘‘f”’ have no sense. If, however,
‘‘ovp” has no sense, then also ‘‘pvg” can have
no sense.
...
(Like: if ‘‘a” does not stand ina certain relation
to ‘‘d”, it could express that ad is not the case.)

But here also the negative proposition is in-
directly constructed with the positive.

The positive proposttzon must presuppose the
existence of the negative proposition and con-
versely.

If the values of € are the total values of a func-
tion fx for all values of x, then N(£)= ~ (qx). /&.

I separate the concept @// from the truth-function.
...
logischen Summe eingefihrt. So wurde es schwer,
die Satze ,,(qx) . fx“ und ,,(x) . fx“, in welchen beide
Ideen beschlossen liegen, zu verstehen.

Das Eigentiimliche der Allgemeinheitsbezeich-
nung ist erstens, dass sie auf ein logisches Ur-
bild hinweist, und zweitens, dass sie Konstante
hervorhebt.

Die Allgemeinheitsbezeichnung tritt als Argu-
ment auf.

Wenn die Gegenstande gegeben sind, so sind
...
Es ist unrichtig, den Satz ,,(qx). fx“— wie
...
drickt, sondern dadurch, dass ein Ausdruck eine
...
Man kann die Welt vollstandig durch voll-
...
yes gibt ein und nurein x, welches. . . .“ sagen:
Und dies x ist a.

Ein vollkommen verallgemeinerter Satz ist, wie
jeder andere Satz zusammengesetzt. (Dies zeigt
sich daran, dass wir in ,(qx, ¢). $x“ ,,#“ und ,,x “
getrennt erwahnen missen. Beide stehen unab-
...
the propositions ‘‘(q~) . fx” and ‘‘ (x). fe” in which
...
The generality symbol occurs as an argu-
ment.

If the objects are given, therewith are a// objects
also given.

If the elementary propositions are given, then
therewith a@// elementary propositions are also
given.

It is not correct to render the proposition
“‘(qx).fe”—as Russell does—in words ‘‘f% is
possible’.
...
completely generalized propositions, z.e. without
...
Es verandert ja die Wahr- oder Falschheit jedes
...
Gleichheit des Gegenstandes driicke ich durch
...
Dass die Identitat keine Relation zwischen Ge-
genstanden ist, leuchtet ein. Dies wird sehr klar,
wenn man z. B. den Satz ,(x):fx.D.x=a"
betrachtet. Was dieser Satz sagt, ist einfach,
dass nur a der Funktion f geniigt, und nicht,
...
Russells Definition von ,,=“ geniigt nicht; weil
man nach ihr nicht sagen kann, dass zwei Gegen-
stinde alle Eigenschaften gemeinsam haben.
(Selbst wenn dieser Satz nie richtig ist, hat er
doch Sinn.)

Beiliufig gesprochen: Von zwei Dingen zu
sagen, sie seien identisch, ist ein Unsinn, und von
Einem zu sagen, es sei identisch mit sich selbst,
sagt gar nichts.

Ich schreibe also nicht ,,f(a,b).a=b“, sondern
wf(a,a)* (oder ,,f(b,b)“). Und nicht,,f(a,b). ~ a= b*,
sondern ,,f(a,b)“.

Und analog: Nicht ,,(qx,y). f(x,y).x = y%,
...
The truth or falsehood of every proposition alters
...
any rate, there is one move elementary proposition
true.)
...
That identity is nota relation between objects is
obvious. This becomes very clear if, for example,
one considers the proposition ‘‘ (7): /%#.D.x#=a”.
What this proposition says is simply that only
a satisfies the function 7, and not that only such
...
Roughly speaking: to say of ¢wo things that
they are identical is nonsense, and to say of one
thing that it is identical with itself is to say
nothing.

I write therefore not ‘‘/(a,0).a=6”, but ‘‘f{a,a)”
(or ‘‘/(4,6)”). And not ‘/(a,b).~ a=5”, but
“OT ape)

And analogously: not ‘(qzy)./(4y).r=y”,
...
sondern ,,(qx) . f(x,x)“; und nicht ,,(qx,y). f(x,y).
~ x=y“, sondern ,,(qx,y) . f(x,y)“.

(Also statt des Russell’schen_,,(qx,y) . f(x,y)“:
WAXY) - {(X,y) - Vv. (AX) - f(x,x)".)

Statt ,,(x): fx>x=a“ schreiben wir also z. B.
aes fx. Dufarr<(gm,gamirmiye
...
Und nun sehen wir, dass Scheinsdtze wie:
ya=a“, ,a=b.b=c.Da=c", ,(x).x=x", ,(qx).
...
Alle Probleme, die Russells ,,Axiom of Infinity“
mit sich bringt, sind schon hier zu ldsen.

Das, was das Axiom of infinity sagen soll, wiirde
sich in der Sprache dadurch ausdriicken, dass es
unendlich viele Namen mit verschiedener Bedeu-
tung gabe.

Es gibt gewisse Falle, wo man in Versuchung
gerat, Ausdriicke von der Form ,,a =a“ oder ,p op“
u. dgl. zu bentitzen. Und zwar geschieht dies,
wenn man von dem Urbild : Satz, Ding, etc. reden
méchte. So hat Russell in den ,,Principles of
Mathematics“ den Unsinn ,,p ist ein Satz“ in Sym-
bolen durch ,p3p“ wiedergegeben und als Hypo-
...
pp vor einen Satz zu stellen, um ihm Argumente
der richtigen Form zu sichern, weil die Hypothese
fir einen Nicht-Satz als Argument nicht falsch,
...
ut ‘° (ae) fle)” and mot ‘(qey)./(x7).
~x=y”, but *(qxy) . Ay)”.

(Therefore instead of Russell’s (q2,y) ./(~y)” :
“(qa,y) Sey). Vv. (a4) -F(%2)”-)

Instead of ‘‘(x): /“e2x=a” we therefore write
Ce ge) . fea, & (gay) .fousyy”.

And the proposition ‘‘ only one x satisfies f( )”
reads: ‘‘(q2z). fe: ~(qxy).fx.fy”.

The identity sign is therefore not an essential
constituent of logical notation.

And we see that apparent propositions like:
saa) “a=bwb=c. BSa=c’,“@).¢=x", ‘ee.
#=a”, etc. cannot be written in a correct logical
notation at all.
...
to use expressions of the form ‘‘a=a” or ‘“poap”
As, for instance, when one would speak of the
archetype Proposition, Thing, etc. So Russell in the
Principles of Mathematics has rendered the nonsense “‘p
is a proposition” in symbols by ‘‘f/” and has
put itas hypothesis before certain propositions to
show that their places for arguments could only
be occupied by propositions.

(It is nonsense to place the hypothesis pap
...
wie die zu diesem Zweck angehdngte sinnlose
Hy pothese. )

Ebenso wollte man ,,Es gibt keine Din ge“ aus-
driicken durch ,, ~ (qx).x=x“. Aber selbst wenn
...
Auf den ersten Blick scheint es, als konne ein Satz
ineinem anderen auch aufandere Weisevorkommen.

Besonders in gewissen Satzformen der Psycho-
logie, wie ,,A glaubt, dass p der Fall ist“, oder
»A denkt p“, etc.

Hier scheint es namlich oberflachlich, als stiinde
...
Es ist aber klar, dass ,,A glaubt, dass p“, ,,A
...
Dies zeigt auch, dass die Seele—das Subyekt,
etc.—wie sie in der heutigen oberflachlichen Psy-
chologie aufgefasst wird, ein Unding ist.

Eine zusammengesetzte Seele ware namlich
keine Seele mehr.

Die richtige Erklarung der Form des Satzes ,,A
urteilt p“ muss zeigen, dass es unméglich ist, einen
Unsinn zu urteilen. (Russells Theorie geniigt
...
no things” by ‘‘~ (qx).x=x”. But even if this
...
auf zweierlei Art als Wirfel sehen kann ; und alle
ahnlichen Erscheinungen. Denn wir sehen eben
wirklich zwei verschiedene Tatsachen.

(Sehe ich erst auf die Ecken a und nur flichtig
auf b, so erscheint a vorne; und umgekehrt.)

Wir miissen nun die Frage nach allen méglichen
...
Bedeutung nicht angeben kénnen, so kénnen wir
...
glance at 4, a appears in front and 4 behind, and
vice versa. )
...
The ‘‘experience” which we need to under-
stand logic is not that such and such is the
case, but that something zs, but that is ”o experi-
ence.

Logic precedes every experience—that something
1S 50.
...
Und wenn dies nicht so ware, wie kénnten wir
die Logik anwenden? Man kénnte sagen: Wenn
es eine Logik gabe, auch wenn es keine Welt gabe,
wie kénnte es dann eine Logik geben, da es eine
Welt gibt.

Russell sagte, es gabe einfache Relationen
...
Die Angabe jeder speziellen Form ware voll-
kommen willkiirlich.

Es soll sich a priori angeben lassen, ob teh z. B.
in die Lage kommen kann, etwas mit dem
Zeichen einer 27-Stelligen Relation bezeichnen zu
mussen.

Diirfen wir denn aber tiberhaupt so fragen?
K6nnen wir eine Zeichenform aufstellen und nicht
wissen, ob ihr etwas entsprechen kénne?
...
Und wie ware es auch méglich, dass ich es in
der Logik mit Formen zu tun hatte, die ich erfinden
kann ; sondern mit dem muss ich es zu tun haben,
was es mir méglich macht, sie zu erfinden.

Eine Hierarchie der Formen der Elementar-
satze kann es nicht geben. Nur was wir selbst
konstruieren, k6nnen wir voraussehen.

Die empirische Realitat ist begrenzt durch die
...
were a logic, even if there were no_ world,
...
How could we decide a priori whether, for
...
Die Hierarchien sind, und miissen unabhangig
von der Realitat sein.

Wissen wir aus rein logischen Griinden, dass
es Elementarsatze geben muss, dann muss es jeder
wissen, der die Satze in ihrer unanalysierten Form
versteht.

Alle Satze unserer Umgangssprache sind tatsach-
lich, so wie sie sind, logisch vollkommen geordnet.
...
einander nicht tibergreifen.

Wenn ich die Elementarsatze nicht a priori
angeben kann, dann muss es zu offenbarem Unsinn
fihren, sie angeben zu wollen.

Die Grenzen meiner Sprache bedeuten
die Grenzen meiner Welt.

Die Logik erfillt die Welt; die Grenzen der
Welt sind auch ihre Grenzen.

Wir kénnen also in der Logik nicht sagen: Das
und das gibt es in der Welt, jenes nicht.

Das wiirde namlich scheinbar voraussetzen, dass
wir gewisse Méglichkeiten ausschliessen und dies
kann nicht der Fall sein, da sonst die Logik
iiber die Grenzen der Welt hinaus miisste; wenn
sie ndmlich diese Grenzen auch von der anderen
Seite betrachten kénnte.
...
Was wir nicht denken k6nnen, das kénnen wir
nicht denken; wir kénnen also auch nicht sagen,
was wir nicht denken k6nnen.

Diese Bemerkung gibt den Schlissel zur
Entscheidung der Frage, inwieweit der Solipsismus
eine Wahrheit ist.

Was der Solipsismus namlich meint, ist ganz
richtig, nur lasst es sich nicht sagen, sondern es
zeigt sich.

Dass die Welt meine Welt ist,daszeigtsichdarin,
...
Das denkende, vorstellende, Subjekt gibt esnicht.
...
nadmlich eine Methode, das Subjekt zu isolieren,
oder vielmehr zu zeigen, dass es in einem wichtigen
Sinne kein Subjekt gibt: Von ihm allein namlich
k6nnte in diesem Buche nicht die Rede sein.—

Das Subjekt gehért nicht zur Welt, sondern es
ist eine Grenze der Welt.

Wo in der Welt ist ein metaphysisches Subjekt
zu merken?
...
Das Gesichtsfeld hat namlich nicht etwa eine
solche Form :
...
In fact what solipsism means, is quite correct,
only it cannot be sazd, but it shows itself.
...
and say which members obey my will and whicn
do not, etc. This then would be a method of
isolating the subject or rather of showing that in
an important sense there is no subject: that 1s to
say, of it alone in this book mention could ot be
made.

The subject does not belong to the world but
it is a limit of the world.

Where in the world is a metaphysical subject to
be noted ?

You say that this case is altogether like that of
the eye and the field of sight. But you do ot
really see the eye.

And from nothing tx the field of sight can it be
...
Das hangt damit zusammen, dass kein Teil
unserer Erfahrung auch a priori ist.

Alles, was wir sehen, k6nnte auch anders
sein.

Alles, was wir tiberhaupt beschreiben k6énnen,
k6énnte auch anders sein.

Es gibt keine Ordnung der Dinge a priori.

Hier sieht man, dass der Solipsismus, streng
durchgefiihrt, mit dem reinen Realismus zusam-
...
nicht der menschliche K6rper, oder die menschliche
...
Die allgemeine Form der Operation Q’ (y) ist
also: [& N(@)J'G@) (=[n & N (8).

Das ist die allgemeinste Form des Uberganges
...
_ The_ general form of truth-function is:
B2Me).

This is the general form of proposition.

This says nothing else than that every pro-
position is the result of successive applications
of the operation WV’ (€) to the elementary pro-
positions.
...
The general form of the operation (n) is
therefore: [& N (&)]' (m) (=[n. & N(S).-
...
die Reihe x, ’ x,’ 0’ x, OO’ O’x, .....
o, ott, o+I+t, OFI+I+I,
so: Q x, Q x, Q x, @ x 6 eee
...
allgemeine Formaller speziellen Zahlengleichheiten.
...
nicht die zufallige ist.

Die Satze der Logik sind Tautologien.

Die Satze der Logik sagen also Nichts. (Sie
sind die analytischen Satze.)

Theorien, die einen Satz der Logik gehaltvoll
erscheinen lassen, sind immer falsch. Man k6nnte
...
write the series x, O’x, OD? Ox, VOOx.....
...
The general form of the cardinal number 1s:
[o, & €+1].
...
weniger als selbstverstandlich zu sein, ebensowenig
...
Die richtige Erklarung der logischen Satze
...
logischen Satze nicht am Satz allein erkennen
lasst.

Dass die Satze der Logik Tautologien sind,
das zeigt die formalen—logischen — Eigen-
schaften der Sprache, der Welt.

Dass ihre Bestandteile so verkniipft eine Tauto-
logie ergeben, das charakterisiert die Logik ihrer
Bestandteile.

Damit Satze, auf bestimmte Art und Weise
verkniipft, eine Tautologie ergeben, dazu mussen
...
Dass z. B. die Satze ,p“ und ,,~p“ in der
Verbindung ,,~(p. ~ p)“ eine Tautologie ergeben,
zeigt, dass sie einander widersprechen. Dass
die Satze ,prq“, ,p‘ und ,q“ in der Form
»(p2q)-. (p):2:(q)* miteinander verbunden eine
Tautologie ergeben, zeigt, dass q aus p und pDdq
...
evident, no more so than the proposition ‘‘ All
...
science and this isa certain symptom of its being
falsely understood.
...
It is the characteristic mark of logical pro-
...
falsehood of non-logical propositions can zot be—
...
That its constituent parts connected together zx
...
That e.g. the propositions ‘‘p” and ‘ ~p” in
the connexion “‘ ~(~. ~p)” give a tautology
shows that they contradict one another. That the
propositions “pgDg”, “pg” and ‘¢g” connected
together in the form ‘‘(pD¢).(/):2:(g)” give a
tautology shows that ¢g follows from fp and pDg.
...
kann man sich, in den FaAllen, in welchen in der
...
Dies Zeichen wirde also z. B. den Satz poq
...
That ‘‘(x)./¥:2:/fa” is a tautology shows that
fa follows from (x) ./%, etc. etc.
...
method: I write instead of ‘‘p”, “‘g”, ‘‘r”, etc.,
“TpF”, ‘*TqF”, “TrF”, etc. The truth-com-
...
sent the proposition 3g. Now I will proceed
to inquire whether such a proposition as ~(p. ~ fp)
...
die Verbindung der dussersten W und F mit den
innersten, so ergibt sich, dass die Wahrheit des
ganzen Satzes allen Wahrheitskombinationen
...
Diese Methode kénnte man auch eine Null-
...
Hence the proposition ~ (/. ~ qg) runs. thus :—
...
If here we put ‘‘#” instead of “gq” and examine
...
Ergeben z. B. zwei Satze ,,p“ und ,q“ in der
Verbindung ,pDq“ eine Tautologie, so ist kar,
dass q aus p folgt.

Dass z. B. ,,q“ aus ,,p2q. p“ folgt, ersehen wir
aus diesen beiden Satzen selbst, aber wir kénnen
es auch so zeigen, indem wir sie zu ,pDq.p:D:q“
...
werden k6nnen, ebenso wenig, wie sie durch die
Erfahrung widerlegt werden kénnen. Nicht nur
muss ein Satz der Logik durch keine mégliche Erfah-
rung widerlegt werden kénnen, sondern er darf auch
nicht durch eine solche bestatigt werden kénnen.

Nun wird klar, warum man oft fiihlte, als waren
die , logischen Wahrheiten“ von uns zu ,,fordern*:
Wir kénnen sie namlich insofern fordern, als wir
eine geniigende Notation fordern k6nnen.

Es wird jetzt auch klar, warum die Logik die
Lehre von den Formen und vom Schliessen genannt
wurde.

Es ist klar: Die logischen Gesetze diirfen nicht
selbst wieder logischen Gesetzen unterstehen.

(Es gibt nicht, wie Russell meinte, fiir jede
» ype ein eigenes Gesetz des Widerspruches,
sondern Eines geniigt, da es auf sich selbst nicht
angewendet wird.)

Das Anzeichen des logischen Satzes ist nicht
die Allgemeingiiltigkeit.

Allgemein sein, heisst ja nur: Zufalligerweise
fiir alle Dinge gelten. Ein unverallgemeinerter
Satz kann ja ebensowohl tautologisch sein, als ein
verallgemeinerter.

Die logische Allgemeingiltigkeit kénnte man
...
If for example two propositions ‘‘f” and ‘‘g”
give a tautology in the connexion ‘‘gDq¢”, then
it is clear that g follows from fp.

E.g. that “q” follows from ‘‘pDq.p” we see from
these two propositions themselves, but we can also
show it by combining them to ‘‘fDq¢.:5:q” and
...
be tautologous just as well as a_ generalized
one.
...
giinstigen Zufall wahr sein kénnten.

Es lasst sich eine Welt denken, in der das
...
Die logischen Satze beschreiben das Geriist der
Welt, oder vielmehr, sie stellen es dar. Sie
,handeln“ von nichts. Sie setzen voraus, dass
Namen Bedeutung, und Elementarsaétze Sinn
haben: Und dies ist ihre Verbindung mit der
Welt. Es ist klar, dass es etwas tiber die Welt
...
naturnotwendigen Zeichen selbst aus: Wenn wirdie
logische Syntaxirgendeiner Zeichensprachekennen,
dann sind bereits alle Satze der Logik gegeben.

Es ist méglich, und zwar auch nach der alten
Auffassung der Logik, von vornherein eine Be-
schreibung aller ,,wahren“ logischen Satze zu geben.

Darum kann es in der Logik auch nie Uberra-
schungen geben.

Ob ein Satz der Logik angehé6rt, kann man
berechnen, indem man die logischen Eigen-
schaften des Sy m bols berechnet.

Und dies tun wir, wenn wir einen logischen
Satz , beweisen“. Denn, ohne uns um einen Sinn
und eine Bedeutung zu kimmern, bilden wir den
...
It is possible, also with the old conception of
logic, to give at the outset a description of all “ true ”’
logical propositions.

Hence there can sever be surprises in logic.
...
Nattirlich ist diese Art zu zeigen, dass ihre
...
In der Logik sind Prozess und Resultat aquiva-
lent. (Darum keine Uberraschung.)

Der Beweis in der Logik ist nur ein mecha-
nisches Hilfsmittel zum leichteren Erkennen der
Tautologie, wo sie kompliziert ist.

Es ware ja auch zu merkwiirdig, wenn man
einen sinnvollen Satz logisch aus anderen be-
weisen k6nnte, und einen logischen Satz auch.
Es ist von vornherein klar, dass der logische
Beweis eines sinnvollen Satzes und der Beweis in
...
Alle Satze der Logik sind gleichberechtigt, es
...
Es ist klar, dass die Anzahl der ,,logischen
Grundgesetze“ willkiirlich ist, denn man kénnte
...
a significant proposition /ogzcally from another, and
a logical proposition aéso. It is clear from the
beginning that the logical proof of a significant
proposition and the proof zz logic must be two
...
It is clear that the number of ‘‘ primitive pro-
...
Die Logik ist keine Lehre, sondern ein Spie-
gelbild der Welt.
...
Der Satz der Mathematik driickt keinen Gedan-
ken aus.
...
nicht der Mathematik angehGéren, auf andere zu
...
Die Logik der Welt, die die Satze der Logik in
den Tautologien zeigen, zeigt die Mathematik in
den Gleichungen.

Wenn zwei Ausdriicke durch das Gleichheits-
zeichen verbunden werden, so heisst das, sie sind
durch einanderersetzbar. Ob dies aber der Fall ist
...
Es ist eine Eigenschaft der Beyahung, dass man
sie als doppelte Verneinung auffassen kann.

Es ist eine Eigenschaft von ,I+1I+1+1%, dass
man es als ,(I+1)+(1+1)* auffassen kann.
...
positions oly in order to infer from propositions
...
It is a property of ‘‘1+1+1+41” that it can be
conceived as ‘‘(I1+I1)+(r+1)”.
...
Frege sagt, die beiden Ausdriicke haben dieselbe
...
beiden Ausdriticken selbst ersehen lasst.

Und, dass die Satze der Mathematik bewiesen
werden k6nnen, heisst ja nichts anderes, als dass
ihre Richtigkeit einzusehen ist, ohne dass das, was
sie ausdrticken, selbst mit den Tatsachen auf seine
Richtigkeit hin verglichen werden muss.

Die Identitat der Bedeutung zweier Ausdriicke
lasst sich nicht behaupten. Denn um etwas von
ihrer Bedeutung behaupten zu kénnen, muss ich
ihre Bedeutung kennen: und indem ich ihre Be-
deutung kenne, weiss ich, ob sie dasselbe oder
verschiedenes bedeuten.

Die Gleichung kennzeichnet nur den Stand-
punkt, von welchem ich die beiden Ausdriicke
betrachte, ndmlich vom Standpunkte ihrer Bedeu-
tungsgleichheit.

Die Frage, ob man zur Lésung der mathemati-
schen Probleme die Anschauung brauche, muss
dahin beantwortet werden, dass eben die Sprache
hier die nétige Anschauung liefert.

Der Vorgang des Rechnens vermittelt eben
diese Anschauung.
...
Methode beruht es némlich, dass jeder Satz der
Mathematik sich von selbst verstehen muss.

Die Methode der Mathematik, zu ihren Glei-
...
But what is essential about equation 1s that it
...
The essential of mathematical method is work-
...
So lautet der Beweis des Satzes 2x 2=4:

(QPP x = ("x Det.
(2x2 a, (Q*)?x ee (OREN x = Q??>Q?’x = O1t+VOItV »

= (QO) (OY x = VOOYO x = OMAP x = Ox,

Die Erforschung der Logik bedeutet die Erfor-
schung aller Gesetzmassigkeit. Undausserhalb
...
Das Kausalitatsgesetz ist kein Gesetz, sondern
die Form eines Gesetzes.

,Kausalitatsgesetz“, das ist ein Gattungsname.
...
Thus the proof of the proposition 2x 2=4 runs:

(Q”) 2 =OQ’*'x Def.
02%? = (02)?x = (2) 4x = 070? x = OUVOH Vy

= (QO) (YOY 2 = VOLO = QU te = OP x,

Logical research means the investigation of a//
...
a ‘law of least action”, before they knew
exactly how it ran. (Here, as always, the a
priori certain proves to be something purely
logical. )

We du not deleve a priori in a law of con-
servation, but we £zow a priori the possibility of
a logical form.
...
* Ze. not the form of one particular law, but of any law of a certain
sort (B. R.).
...
schwarze Flecken waren. Wirsagennun: Was fiir
...
Maschen verwenden kénnen. Es kann sein, dass
die Beschreibung mit Hilfe eines Dreiecks-Netzes
einfacher geworden ware ; das heisst, dass wir die
Flache mit einem gréberen Dreiecks-Netz genauer
beschreiben kénnten, als mit einem feineren qua-
...
von Logik und Mechanik. (Man koénnte das Netz
...
iiber das Bild nichts aus. (Denn dies gilt fiir
jedes Bild dieser Art.) Das aber charakterisiert
das Bild, dass es sich durch ein bestimmtes Netz
von bestimmter Feinheit vollstandig be-
schreiben lasst.

So auch sagt es nichts tiber die Welt aus, dass
...
Auch das sagt etwas tiber die Welt, dass sie sich
durch die eine Mechanik einfacher beschreiben
lasst, als durch die andere.

Die Mechanik ist ein Versuch, alle wahren
...
Wir diirfen nicht vergessen, dass die Weltbe-
...
Obwohl die Flecke in unserem Bild geome-
trische Figuren sind, so kann doch _ selbstver-
standlich die Geometrie gar nichts tiber ihre
tatsachliche Form und Lage sagen. Das Netz
aber ist rein geometrisch, alle seine Eigenschaften
k6nnen a priori angegeben werden.

Gesetze, wie der Satz vom Grunde, etc., handeln
vom Netz, nicht von dem, was das Netz beschreibt.

Wenn es ein Kausalitatsgesetz gabe, so kénnte
es lauten: ,,Es gibt Naturgesetze“.

Aber freilich kann man das nicht sagen: es
zeigt sich.

In der Ausdrucksweise Hertz’s kénnte man
sagen: Nur gesetzmassige Zusammenhange
sind denkbar.
...
this kind.) But zs does characterize the picture,
the fact, namely, that it can be completely de-
scribed by a definite net of defiuzte fineness.

So too the fact that it can be described by
Newtonian mechanics asserts nothing about the
world; but zkzs asserts something, namely, that
...
to a single plan all ¢vve propositions which we
need for the description of the world.

Through their whole logical apparatus the
...
particulary material points in it, but always only
of some points or other.

Although the spots in our picture are geometri-
...
Wir kénnen keinen Vorgang mit dem ,,Ablauf
...
Verlaufs nur so méglich, dass wir uns auf einen
anderen Vorgang stiitzen.

Ganz Analoges gilt fiir den Raum. Wo man
z. B. sagt, es kénne keines von zwei Ereignissen
...
Und wenn eine solche Asymmetrie vorhanden ist,
so kénnen wir diese als Ursache des Eintreffens
...
mensionalen Raum, wo die beiden kongruenten
Figuren a und b auch nicht zur Deckung gebracht
werden kénnen, ohne aus diesem Raum
...
Den rechten Handschuh k6nnte man an die
linke Hand ziehen, wenn man ihn im _ vier-
dimensionalen Raum umdrehen k6nnte.

Was sich beschreiben lasst, das kann auch
geschehen, und was das Kausalitatsgesetz aus-
schliessen soll, das lasst sich auch nicht beschreiben.
...
there is ~o cause why the one should occur rather
than the other, it is really a matter of our being
unable to describe ove of the two events unless
there is some sort of asymmetry. And if there zs
...
space; where the two congruent figures @ and 6
...
Hypothese ; und das heisst: wir wissen nicht, ob
sie aufgehen wird.

Einen Zwang, nach dem Eines geschehen musste,
weil etwas anderes geschehen ist, gibtes nicht. Es
...
etwas Unantastbarem stehen, wie die alteren bet
...
neuen System scheinen soll, als sei alles erklart.

Die Welt ist unabhangig von meinem Willen.

Auch wenn alles, was wir wiinschen, geschahe,
...
verbirgte, und den angenommenen physikalischen
Zusammenhang k6nnten wir doch nicht selbst
wieder wollen.

Wie es nur eine logische Notwendigkeit gibt,
so gibt esauch nur eine logische Unméoglichkeit.

Dass z. B. zwei Farben zugleich an einem Ort
des Gesichtsfeldes sind, ist unmdéglich und zwar
logisch unméglich, denn es ist durch die logische
...
assuming the szmplest law that can be made to
harmonize with our experience.

This process, however, has no logical founda-
...
That the sun will rise to-morrow, is an hypothe-
...
So people stop short at natural Jaws as at some-
...
fate, for there is no /ogzca/ connexion between will
and world, which would guarantee this, and the
assumed physical connexion itself we could not
again will.

As there is only a /ogecal necessity, so there is
only a /ogzcal impossibility.

For two colours, e.g. to be at one place in the
...
wie es geschieht ; es gibt in ihr keinen Wert—und
...
Was es nicht-zufallig macht, kann nicht in der
...
Satze kénnen nichts Héheres ausdrticken.
...
Lohn 1m gewohnlichen Sinne zu tun hat. Also
...
cities, z.e. that at the same time it cannot be in
two places, z.e. that particles in different places
...
happens as it does happen. /m it there is no value
...
What makes it non-accidental cannot lie ex
...
guences of an action must therefore be irrelevant.
...
Vom Willen als dem Trager des Ethischen kann
nicht gesprochen werden.

Und der Wille als Phanomen interessiert nur
die Psychologie.

Wenn das gute oder bése Wollen die Welt
...
Kurz, die Welt muss dann dadurch tiberhaupt
...
Wie auch beim Tod die Welt sich nicht andert,
sondern aufhort.
...
The temporal immortality of the human
...
W ie die Welt ist, ist fiir das Héhere voll-
kommen gleichgiiltig. Gott offenbart sich nichtin
der Welt.

Die Tatsachen gehGren alle nur zur Aufgabe,
nicht zur Lésung.
...
Wir fiihlen, dass selbst, wenn alle méglichen
...
Die Lésung des Problems des Lebens merkt
...
Die richtige Methode der Philosophie ware
...
How the world is, is completely indifferent for
what is higher. God does not reveal himself zz the
world.

The facts all belong only to the task and not to
its performance.

Not ow the world is, is the mystical, but ¢haz
it is.
...
If a question can be put at all, then it caz also
be answered.

Scepticism is zo¢ irrefutable, but palpably sense-
...
and this only where something can be sazd.

We feel that even if al possible scientific
...
lasst, also Sdtze der Naturwissenschaft—also etwas,
...
hat. Diese Methode ware fir den anderen un-
befriedigend—er hatte nicht das Gefiihl, dass wir
ihn Philosophie lehrten—aber sie ware die einzig
streng richtige.

Meine Sdtze erlautern dadurch, dass sie der,
welcher mich versteht, am Ende als unsinnig
erkennt, wenn er durch sie—auf ihnen—iiber sie
hinausgestiegen ist. (Er muss sozusagen die Leiter
wegwerfen, nachdem er auf ihr hinaufgestiegen ist.)

Er muss diese Satze tiberwinden, dann sieht er
die Welt richtig.

Wovon man nicht sprechen kann, dartiber muss
man schweigen.
...
To say nothing except what can be said, z.e. the
propositions of natural science, z.e. something that
...
(Note : Numbers in parentheses refer to paragraphs.

Thus

‘6.211 (2) ’ indicates the second paragraph of section 6.211.)
