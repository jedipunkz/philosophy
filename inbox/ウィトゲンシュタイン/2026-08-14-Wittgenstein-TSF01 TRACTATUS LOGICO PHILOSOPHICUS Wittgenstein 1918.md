---
source: "https://archive.org/details/tsf-01-tractatus-logico-philosophicus-wittgenstein"
title: "TSF01 TRACTATUS LOGICO PHILOSOPHICUS Wittgenstein 1918"
author: "Wittgenstein"
year: "1922"
captured_at: "2026-08-14T02:57:57Z"
updated_at: "2026-08-14T02:57:57Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ウィトゲンシュタイン"
query: "Tractatus Logico-Philosophicus"
plain_text_url: "https://archive.org/download/tsf-01-tractatus-logico-philosophicus-wittgenstein/TSF01 TRACTATUS LOGICO PHILOSOPHICUS Wittgenstein_djvu.txt"
public_domain: true
subjects:
tags:
  - "現代哲学"
...
# TSF01 TRACTATUS LOGICO PHILOSOPHICUS Wittgenstein 1918

- 著者: Wittgenstein
- 初版: 1922
- 情報源: [archive](https://archive.org/details/tsf-01-tractatus-logico-philosophicus-wittgenstein)
- パブリックドメイン: ✓
...
en relación con el simbolismo: 1% Las condiciones para que se dé el sentido mejor
que el sinsentido en las combinaciones de símbolos; 2% Las condiciones para que
...
Wittgenstein compara la expresión lingúística a la proyección en geome-
...
la figura original permanecen inmutables, cualquiera que sea el modo de proyec-
...
mo en el hecho. La proposición y el hecho deben manifestar la misma «multiplici-
...
complejo, este nombre sólo tiene sentido en virtud de la verdad de una cierta pro-
...
de p; del mismo modo, una función de verdad de varias proposiciones p, q, Y... es
...
del doctor Sheffer. Es fácil ver el modo en que se construyen otras funciones de
...
representada por «(3x).fx». Si en vez de fx hubiésemos partido de no-fx habríamos
...
ciones generales [es decir «(x).fx» y «(3x).fx »] difiere de los métodos precedentes
...
gumentos dados, por enumeración, p, q, Y...

Sobre este punto, Wittgenstein no da en el texto una explicación suficiente
de su simbolismo. El símbolo que emplea es (-p, -£, NG£)). He aquí la explicación
de este simbolismo:
...
del cual, dadas las proposiciones atómicas, todas las demás pueden construirse. El
proceso depende de:
...
identidad de lo indiscernible parece que no es un principio lógico necesario. De
...
pecto de ella. De acuerdo con este criterio, sólo podríamos decir cosas sobre el
...
A. «Pero es claro que “A cree p”, “A piensa p”, “A dice p” son de la forma ”
...
problema de la forma lógica de la fe, es decir, cuáles el esquema que representa lo
...
debe tomarse demasiada literalmente. El punto esencial es que en el acto de creer,
...
Hay un problema puramente lógico, con relación al cual esas dificultades
...
Motto:... und alles, was man weiss, nicho bloss rauschen und brausen gehórt hat,
lásst sich drei Worten sagen.
...
ausgedrick sind —oder doch áhnliche
Gedanken- schon selbst einmal gedacht
hat. —Es ist also kein Lehrbuch. —Sein
Zweck wáre erreicht, wenn es einem, der
es mit Verstánds  liest, Vernúgen
bereitete. Das Buch  behandelt die
philosophischen Probleme und zeigt - wie
ich glaube - dafí die Fragestellung dieser
Probleme auf dem Mifverstándnis der
Logik «unserer Sprache beruht. Man
kónnte den ganzen Sinn des Buches etwa
in die Worte “Lassen: Was sich iiberhaupt
sagen láft, láft sich klar sagen; und
wovon man nicht reden kann, dariber
muf man schweiCgen. Das Buch will.
also dem Denken eine Grenze ziehen,
oder vielmehr - nicht dem Denken, son-
dern dem Ausdruck der Gedanken: Denn
um dem Denken eine Grenze zu ziehen,
miilten wir beide Seiten dieser Grenze
denken kónnen (wir miiften also denken
kónnen, was sich nicht denken láñt).

Die Grenze wird also nur in der Sprache
gezogen werden kónnen und was jenseits
der Grenze liegt, wird einfach Unsinn
sein.

Wieweit meine Bestrebungen mit denen
anderer Philosophen  zusammentfallen,
will ich nicht beurteilen. Ja, was ich hier
geschrieben habe, macht im Einzelnen
úberhaupt nicht den Anspruch auf
Neuheit; und darum gebe ich auch keine
Quellen an, weil es mir gleichgúltig ist,
ob das, was ich gedacht habe, vor mir
schon ein anderer gedacht hat.

Nur das will ich erwáhnen, daf ich den
groBartigen Werken Freges und den
Arbeiten  meines  Freundes.  Herrn
Bertrand Russell einen grofen Teil der
...
Quizás este libro sólo puedan com-
prenderlo aquellos que por si mismos ha-
yan pensado los mismos o parecidos pen-
samientos a los que aquí se expresan. No
es por consiguiente un manual. Habrá al-
canzado su objeto si logra satisfacer a
...
pensamientos; porque para trazar un lími-
te al pensamiento tendríamos que ser ca-
paces de pensar ambos lados de este lími-
te, y tendríamos por consiguiente que ser
capaces de pensar lo que no se puede
pensar.

Este límite, por lo tanto, sólo puede ser
trazado en el lenguaje y todo cuanto que-
de al otro lado del límite será simplemen-
te un sinsentido.

De en qué medida coincidan mis es-
fuerzos con los de los demás filósofos no
...
mí indiferente que aquello que yo he pen-
sado haya sido pensado por alguien antes
que yo.
...
besteht er in Zwelerle¡. Erstens darin, daf
in ihr Gedanken ausgedriickt sind, und
dieser Wert wird umso grófer sein, je
besser die Gedanken ausgedrúckt sind. -
Hier bin ich mir bewuft, weit hinter dem
Moglichen zuriickgeblieben zu sein.
Einfach darum, weil meine Kraft zur
Bewáltigung der Aufgabe zu gering ist. -
Mógen andere kommen und es besser
machen.

Dagegen scheint mir die Wahrheit der
hier mitgeteilten Gedanken unantastbar
und definitiv. Ich bin also der Meinung,
die Probleme im Wesentlichen endgúltig
gelóst zu haben. Und wenn ich mich
hierin nicht irre, so besteht nun der Wert
dieser Arbeit zweitens darin, daf sie
zeigt, wie wenig damit getan ist, dafi die
Probleme gelóst sind.
...
Si este libro tiene algún valor, este va-
lor radica en dos cosas: Primero, que en él
se expresan pensamientos, y este valor se-
rá mayor cuanto mejor estén expresados
los pensamientos, cuanto más se haya re-
machado el clavo. Soy consciente, aquí,
de no haber profundizado todo lo posible.
Simplemente por esto, porque mis fuerzas
son insuficientes para lograr esta tarea.
Puedan otros emprenderla y hacerlo me-
jor.

Por otra parte la verdad de los pensa-
mientos aquí comunicados me parece
...
hecho de que muestra cuán poco se ha he-
cho cuando se han resuelto estos proble-
mas.
...
bestimmt und dadurch, daf es alle
Tatsachen sind.

1.12 Demn, die Gesamtheit der Tatsachen
...
1.2 Die Welt zerfállt in Tatsachen.

1.21 Eines kann der Fall sein oder nicht
der Fall sein und alles ibrige gleich
bleiben.
...
von Gegenstánden (Sachen, Dingen).

2.011 Es ist dem Ding wesentlich, der
Bestandteil eines Sachverhaltes sein zin
kónnen.

2.012 In der Logik ist nichts zufállig:
Wenn das Ding im  Sachverhalt
vorkommen kann, son  muf die
Moglichkeit des Sachverhaltes im Ding
bereits prájudiziert sein.

' Die Dezimalzahlen als Nummern der einzelnen
Sátze deuten das logishe Gewigcht des Sátze an,
den Nachdruck, der auf ihnen in meiner
Darstellung liegt. Die Sátze n.1, n.2, n,3, etc., sin
Bemerkungeg zum Satze N“.n; die Sátze n.ml,
n.m2, etc. Bemerkungen zum Satze N”. n.m; und
so weiter.
...
proposición N* n; las proposiciones n.ml, n.m2,
etc., son observaciones a ala proposición n” n.m; y
así sucesivamente.

2 Traduzco la palabra Sachverhalt por «echo
...
wenn dem Ding, das allein fúr sich
bestehen kónnte, nachtrálich ein Sachlage
passen wúrde.

Wenn die Dinge in Shachverhalten
vorkommen kónnen, so muf dies schon in
ihnen liegen.

(Etwas Logisches kann nicht nur-móglich
sein. Die Logik handelt von jeder
Moglichkeit, und alle Móglichkeiten sind
ihre Tatsachen.)

Wie  wiruns ráumliche  Gegenstánde
úberhaupt nicht auferhalb des Raumes,
zeitliche nicht auferhalb der Zeit denken
kónnen, so kónnen wir uns keinen
Gegenstand auferhalb del Moóglichkeit
seiner Verbindung mit anderen denken.
Wenn ich mir den Gegenstand im
Verbande des Sachverhalts denken kann,
so kann ich ihn nicht auferhalb der
Moglichkeit dieses Verbandes denken.

2.0122 Das Ding ist selbbstánding,
insofern es in allen móglichen Sachlagen
vorkommen kann, aber diese Form der
Selbstándlichkeit ist eine Form der
Unselbstándichkeit. (Es ist unmoóglich,
dal3 Worte in zwei verschiedenen Weisen
auftreten, allein und im Satz.)

2.0123 Wenn ich den Gegenstand kenne,

so  kenne ich auch  sámtliche
Moglichkeiten seines Vorkomens in
Sachverhalten.

(Jede solche Móglichkeit muf in der
Natur des Gegenstandes liegen.)

Es kann nicht nachtráglich eine neue
Moglichkeit gefunden werden.

2.01231 Um einen Gegenstands zu
kennen, muf ich zwar nicht seine
externen —aber ich muf alle seine

internen Eigenschaften kennen.

/17/

2.0121 Aparecería, por así decirlo, como
...
(Algo lógico no puede ser sólo-
posible. La lógica trata de toda
...
2.01231 Um einen Gegenstand zu
kennen, muf ich zwar nicht seine
externen —aber ich muf alle seine

internen Eigenschaften kennen.

2.0124 Sind alle Gegenstánde gegeben, so
sind  damit auch alle  móglichen
Sachverhalte gegeben.

2.013 Jedes Ding ist, gieichsam, in einem
Resume móglicher Sachverhalte. Diesen
Raum kann ich mir leer denken, nicht
aber das Ding ohne den Raum.

2.0131 Der ráumliche Gegenstand mul
im unendlichen Resume liegen. (Der
Raumpunkt ist eine Argumentstelle.)

Der Fleck im Gesichtsfeld mul zwar
nicht rot sein, aber eine Farbe muf er
haben: er hat sozusagen den Farbenraum
um sich. Der Ton muf eine Hóhe haben,
der Gegenstand des Tastsinnes eine Hárte
uUSWw.

2.014 Die Gegenstánde enthalten die
Moglichkeit aller Sachlagen.

2.0141 Die  Moóglichkeit  seines
Vorkommens in Sachverhalten ist die
Form des Gegenstandes.

2.02 Der Gegenstand ist einfach.

2.0201 Jede Aussage iiber Komplexe láft
sich in eine Aussage úber deren
Bestandteile und in diejenigen Sátze
zerlegen,  welche die  Komplexe
vollstándig beschreiben.

2.021 Die Gegenstánde  bilden die
Substanz der Welt. Darum kónnen sie
...
2.0211 Hátte die Welt keine Substanz, so
wúrde, ob ein Satz Sinn hat, davon
abhángen, ob ein anderer Satz wahr ist.

2.0212 Es wáre dann unmóglich, ein Bild
der Welt (wahr oder falsch) zu entwerfen.

2.022 Es ist offenbar, daf auch eine von
der wirklichen noch so  verschieden
gedachte Welt Etwas —eine Form- mit der
wirklichen gemein haben muñ.
...
werden erst durch die Sátze darge stellt —

erst durch die  Konfiguration der
Gegenstánde gebildet.

2.0232  Beiláufig  gesprochen: Die
Gegenstánde sind farblos.

2.0233 Zwei Gegenstánde von der

gleichen logischen Form sind —abgesehen
von ihren externen Eigenschaften- von
einander nur dadurch unterschieden, dali
...
sámtlichen  Eigenschaften  gemeinsam
haben, dann ist es úberhaupt unmóglich
...
2.024 Die Substanz ist das, was
unabhángig von dem was der Fall ist,
besteht.

2.025 Sie ist Form und Inalt.

2.0251 Raum, Zeit und Farbe (Fárbigkeit)
sind Formen der Gegenstánde.

2.026 Nur wenn es Gegenstánde gibt,
...
Wechselnde, Unbestándige.

2.0272 Die Konfiguration der
Gegenstánde bildet den Sachverhalt.
2.03 Im  Sachverhalt  hángen die

Gegenstánde ineinander, wie die Glieder
einer Kette.

2.031 Im Sachverhalt verhalten sich die
Gegenstánde in bestimmter Art und
Weise zueinander.

2.032 Die Art und Weise, wie die
Gegenstánde im Sachverhalt
zusammenhángen, ist die Struktur des
Sachverhaltes.

2.033 Die Form ist die Móglichkeit der
Struktur.
...
Bildes heife seine Struktur und ihre
Moglichkeit seine Form der Abbildung.

2.151 Die Form der Abbildung ist die
Moglichkeit, dafí sich die Dinge so zu
einander verhalten, wie die Elemente des
Bildes.

2.1511 Das Bild ist so mit der
Wirklichkeit verknúpft; es reicht bis zu
ihr.

2.1512 Es ist wie ein Mafstab an die
Wirklichkeit angelegt.

2.15121 Nur die áufersten Punkte der
Teilstriche berúihren den zu messenden
Gegenstand.

2.1513 Nach dieser Auffassung gehórt
...
2.1515  Diese  Zuordnungen sind
eleichsam die Fiúhler der Bildelemente,
mit denen das Bild die Wirklichkeit
berúhrt.

2.16 Die Tatsache muf, um Bild zu sein,
etwas mit dem Abgebildeten gemeinsam
haben.

2.161 In Bild und Abgebildetem muf
etwas identisch sein, damit das eine
úberhaupt ein Bild des anderen sein kann.

2.17 Was das Bild mit der Wirklichkeit
gemein haben muf, um sie auf seine Art
und Weise —richtig oder falsch - abbilden
zu kónnen, ist seine Form der Abbildung.
...
2.1513 Según esta interpretación
...
Das ráumliche Bild alles Ráumliche, das
...
indem es eine Móglichkeit des Bestehens
und Nichtbestehens von Sachverhalten
darstellt.

2.202 Das Bild stellt eine mógliche
...
2.203 Das Bild enthált die Móglichkeit
...
2.222 In der Ubereinstimmung oder
Nichtiibereinstimmung seines Sinnes mit
der Wirklichkeit besteht seine Wahrheit
oder Falschheit.

2.223 Um zu erkennen, ob das Bild wahr
oder falsch ist, mússen wir es mit der
...
heift: Wir kónnen uns ein Bild von ihm
machen.

3.01. Die  Gesamtheit der  wahren
Gedanken sind ein Bild der Welt.

3.02 Der Gedanke enthált die Móglichkeit
der Sachlage, die er denkt. Was denkbar
ist, ist auch móglich.

3.03 Wir kónnen nichts Unlogisches
denken, weil wir sonst unlogisch denken
múlften.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

3.031 Man sagte einmal, daf Gott alles
schaffen kónne, nur nichts, was den
logischen Gesetzen zuwider wáre. —Wir
kónnten námlich von einer »unlogischen«
Welt nicht sagen, wie sie aussáhe.

127]

2.21 La figura concuerda con la realidad
...
3.0321 Wohl kónnen wir einen

Sachverhalt ráumlich darstellen, welcher
den Gesetzen der Physik, aber keinen, der
den Gesetzen der Geometrie zuwiderliefe.

3.04 Ein a priori richtiger Gedanke wáre
ein solcher, dessen Móglichkeit seine
Wahrheit bedingte.

3.05 Nur so kónnten wir a priori wissen,
dafi ein Gedanke wahr ist, wenn aus dem
Gedanken selbst (ohne Verglgichsobjekt)
seine Wahrheit zu erkennen wáre.

3.1 Im Satz drúckt sich der Gedanke
sinnlich wahrnehmbar aus.

3.11 Wir  beniittzen das  sinnlich
wahrnehmbare Zeichen (Laut- oder
Schriftzeichen etc.) des  Satzes als

Projektion der móglichen Sachlage.
Die Projektionsmethode ist das Denken
des Satz Sinnes.

3.12 Das Zeichen, durch welches wir den
Gedanken ausdriicken, nenne ich das

Satzzeichen. Und der Satz ist das
Satzzeichen in  seiner  projektiven
Beziehung zur Welt.

3.13 Zum Satz gehórt alles, was zur
Projektion  gehórt; aber nicht das
Projizierte.

Also die Móglichkeit des Projizierten,
...
sensiblemente perceptible de la
...
O sea, la posibilidad de lo proyectado,
pero no lo proyectado mismo.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

Im Satz ist also sein Sinn noch nicht
enthalten, wohl aber die Móglichkeit, ¡hn
auszudriúcken.

(O»Der Inhalt des Satzes« heift der Inhalt
des sinnvollen Satzes.)

Im Satz ist die Form seines Sinnes
enthalten, aber nicht dessen Inhalt.

3.14 Das Satzzeichen besteht darin, dal
sich seine Elemente, die Wórter, in ihm
auf bestimmte Art und Weise zueinander
verhalten.

Das Satzzeichen ist eine Tatsache.

3.141 Der Satz ist kein Wórtergemisch. —

(Wie das musikalische Thema  kein
Gemisch von Tónen.) Der Satz ist
artikuliert.

3.142 Nur Tatsachen kónnen einen Sinn
ausdrúcken, eine Klasse von Namen kann
es nicht.

3.143 Dafi das Satzzeichen eine Tatsache
ist, wird durch die  gewóhnliche
...
(So war es móglich, dafí Frege den Satz
einen zusammengesetzten Namen
nannte.)

3.1431 Sehr klar wird das Wesen des
Satzzeichens, wenn wir es uns, statt aus
Schriftzeichen, aus ráumlichen
Gegenstánden (etwa Tischen, Stiihlen,
Biichern) zasammengesetzt denken.

Die gegenseitige ráumliche Lage dieser
Dinge drúckt dann den Sinn des Satzes
aus.
...
*“aRb” sagt, dafi a in der Beziehung R zu b
steht«, sondern: Daf »a« in einer
gewissen Beziehung zu »b« steht, sagt,
dafó aRb.

3.144 Sachlagen kann man beschreiben,
nicht benennen.
(Namen gleichen Punkten, Sátze Pfeilen,
sie haben Sinn.)

3.2 Im Satze kann der Gedanke so
ausgedriickt sein, dalí den Gegenstánden
des Gedankens Elemente des
Satzzeichens entsprechen.

3.201 Diese HFElemente  nenne ich
»einfache  Zeichen« und den  Satz
»vollstándig analysiert«.

3.202 Die im  Satze  angewandten
einfachen Zeichen heifen Namen.

3.203 Der Name  bedeutet den
Gegenstand. Der Gegenstand ist seine
Bedeutung. (»Ax ist dasselbe Zeichen wie
»AX«.)

3.21 Der Konfiguration der einfachen
Zeichen im Satzzeichen entspricht die
Konfiguration der Gegenstánde in der
Sachlage.

3.22 Der Name vertritt im Satz den
Gegenstand.

3.221 Die Gegenstánde kann ich nur
...
3.23 Die Forderung der Móglichkeit der
...
sein. Daf ein Satzelement einen Komplex
bezeichnet, kann man aus  seiner
Unbestimmtheit in den Sátzen sehen,
worin es- vorkommt. Wir wissen, durch
diesen Satz ist noch nicht alles bestimmt.
(Die Allgemeinheitsbezeichnung enthált
ja ein Urbild.)

Die Zusammenfassung des Symbols eines
Komplexes in ein einfaches Symbol kann

durch eine Definition  ausgedriickt
werden.
3.25 Es gibt eine und nur eine

vollstándige Analyse des Satzes.

3.251 Der Satz drickt auf bestimmte, klar
angebbare Weise aus, was er ausdrickt:
...
Anwendung. Was die Zeichen
verschlucken, das spricht ihre
...
kónnen durch  Erláuterungen  erklárt
werden. Erláuterungen sind Sátze, welche
die Urzeichen enthalten. Sie kónnen also
...
Bedeutung. Jede Variable láfit sich als
...
elucidaciones. HElucidaciones son las
...
risiert, nenne ich einen Ausdcadk (ena Sklaribolpartes de la proposición
...
eine Klasse von Sátzen, welche sámtlich
Werte des so entstandenen variablen
Satzes sind. Diese Klasse hángt im allge-
meinen noch davon ab, was wir, nach
willkúrlicher Ubereinkunft, mit Teilen
jenes Satzes meinen. Verwandeln wir
aber alle jene Zeichen, deren Bedeutung
willkiirlich bestimmt wurde, in Variable,
so gibt es nun noch immer eine solche
Klasse. Diese aber ist nun von keiner
Ubereinkunft abhángig, sondern nur noch
...
Satzvariablen ist die Angabe der Sátze,
...
kónnen also das Zeichen (Schriftzeichen
...
variable proposicional es algo
determinado.
...
Merkmal zweier Gegenstánde anzeigen,
daf wir sie mit demselben Zeichen, aber
durch zwWwel verschiedene
Bezeichnungsweisen bezeichnen. Denn
das Zeichen ist ja willkúrlich. Man kónnte
also auch zwei verschiedene Zeichen
wáhlen, und wo  bliebe dann das
Gemeinsame in der Bezeichnung.

3.323 In der Umgangssprache kommt es
ungemein háufig vor, dafi dasselbe Wort
auf verschiedene Art und  Weise
bezeichnet —also verschiedenen Symbolen
angehórt-, oder, dal3 zwei Wórter, die auf
verschiedene Art und Weise bezeichnen,
áuberlich in der gleichen Weise im Satze
ange wandt werden.

So erscheint das Wort «ist» als Kopula,
als Gleichheitszeichen und als Ausdruck
der Existenz; «existierem» als intransitives
Zeitwort wie «gehen»; «identisch» als
Eigenschaftswort; wir reden von Etwas,
aber auch davon, dal efwas geschieht.
(Im Satze «Griin ist grin» -wo das erste
...
3.325 Um diesen Irrtiimern zu entgehen,
mússen wir eine  Zeichensprache
verwenden, welche sie aus schlieñt,
indem sie nicht das gleiche Zeichen in
verschiedenen Symbolen, und Zeichen,
welche auf verschiedene Art
bezeichnen, nicht áuferlich auf die
gleiche Art verwendet. Eine Zeichenspra-
che also, die der logischen Grammatik —
...
«in»; «idéntico», como adjetivo; hablamos
...
erkennen, muf man auf den sinnvollen
Gebrauch achten.
...
reden entod tque Russell, para establecer las

wal Mingarrhepropadsi coón chwedbstdacrihalten sein kann, (
...
Nehmen wir námlich an, die Funktion
F(fx) kónnte ihr eigenes Argument sein;
dann gábe es also einen Satz: «F(E(£x))»
und in diesem «miissen die áulere
Funktion F und die innere Funktion F
verschiedene Bedeutungen haben, denn
die innere hat die Form g(fx), die áufere
die Form wy(fx)). Gemeinsam ist den
beiden Funktionen nur der Buchstabe
«E», der aber allein nichts bezeichnet.
Dies wird sofort klar, wenn wir statt
«E(FE(u))»> schreiben «( Op):
F(pqu).yu=Fu». Hiermit erledigt sich
Russells Paradox.

3.334 Die Regeln der logischen Syntax
mússen sich von selbst verstehen, wenn
man nur weif, wie ein jedes Zeichen
bezeichnet.

3.34 Der Satz besitzt wesentliche und
zufállige Ziige. Zufállig sind die Zúge,
die von der besonderen Art der
Hervorbringung des Satzzeichens herrúh-
ren. Wesentlich diejenigen, welche ,
allein den Satz befáhigen, seinen Sinn
auszudriicken.

3.341 Das Wesentliche am Satz ist also
das, was allen Sátzen, welche den
eleichen Sinn  ausdrúcken  kónnen,
gemeinsam ist.

Und ebenso ist allgemein das Wesentliche
am Symbol das, was alle Symbole, die
denselben  Zweck  erfilllen  kónnen,
gemeinsam haben.

3.3411 Man kónnte also sagen: Der
eigentliche Name ist das, was alle
Symbole, die den Gegenstand
bezeichnen, gemeinsam haben. Es wurde
sich so successive ergeben, dalf3 keinerlei
...
forma (g(fx), la externa, la forma
UAx).
...
«E(E(u))» escribimos «(
0) F(qu).yu=Fu». Así describimos la
paradoja de Russell.
...
etwas willkiirlich, aber das ist nicht
willkiirlich: Daf, wenn wir  etwas
willkúrlich bestimmt haben, dann etwas
anderes der Fall sein muf. (Dies hángt
von dem Wesen der Notation ab.)

3.3421 Eine besondere
Bezeichnungsweise mag unwichtig sein,
aber wichtig ist es immer, daf diese eine,
móogliche Bezeichnungsweise ist. Und so
verhált es sich in der Philosophie
úberhaupt: Das Einzelne erweist sich
immer wieder als unwichtig, aber die
Moglichkeit jedes Einzelnen gibt uns
einen Aufschluf úber das Wesen der
Welt.

3.343 Definitionen sind Regeln der
Ubersetzung von einer Sprache in eine
andere. Jede richtige Zeichensprache muf
sich in jede andere nach solchen Regeln
úbersetzen lassen: Dies ist, was sie alle
gemeinsam haben.
...
aller Notationen fir die
Wahrheitsfunktionen so ausdrúcken: Es
ist ihnen gemeinsam, daf sich alle —z.B.-
durch die Notation von «-p» («nicht p»)
und «p v q» («p oder q») ersetzen lassen.

(Hiermit ist die Art und  Weise
gekennzeichnet, wie eine  spezielle
mógliche  Notation uns  állgemeine

Aufschliisse geben kann.)

3.3442 Das Zeichen des Komplexes lóst
sich auch beider Analyse nicht willkúrlich
auf, so dali etwa seine Auflósung in
jedem Satzgefiige eine andere wáre.

142 /

3.342 En nuestras notaciones hay, es
cierto, algo de arbitrario; pero esto no es
arbitrario, a saber: que sí nosotros hemos
determinado algo arbitrariamente,
entonces algún algo debe acaecer. (Esto
depende de la esencia de la notación.)

3.3421 Uno modo particular de
designación puede carecer de
...
Bestandteile allein verbúrgt, durch die
...
Ort stimmen darin úberein, dafi beide die
Moglichkeit einer Existenz sind.

3.42 Obwohl der Satz nur einen Ort des
logischen Raumes bestimmen darf, so
muf doch durch ihn schon der ganze
logische Raum gegeben sein.

(Sonst wúrden durch die Verneinung, die
logische Summe, das logische Produkt,
etc.  Immer  neue  Elemente  -—in
Koordination- eingefúhrt.)

(Das logische Gerist um das Bild herum
bestimmt den logischen Raum. Der Satz
durchgreift den ganzen logischen Raum.)

3) Das angewandte, gedachte
Satzzeichen ist der Gedanke.

4 Der Gedanke ist der sinnvolle Satz.

4.001 Die Gesamtheit der Sátze ist die
Sprache.

4.002 Der Mensch besitzt die Fáhigkeit
Sprachen zu bauen, womit sich jeder Sinn
ausdriicken láf3t, ohne eine Ahnung davon
...
Und zwar so, dafi man nach der áuferen Form desiKteldeodaockhueyfaditaFanmalex batale dielten Gedankens scl

sind enorm kompliziert.

4.0031 Die meisten Sátze und Fragen,
welche  úber  philosophische  Dinge
geschrieben worden sind, sind nicht
falsch, sondern unsinnig. Wir kónnen da-
her Fragen dieser Art úberhaupt nicht
beantworten, sondern nur ihre
Unsinnigkeit feststellen.

Die meisten Fragen und Sátze der
Philosophen beruhen darauf, daf wir
unsere Sprachlogik nicht verstehen.

(Sie sind von der Art der Frage, ob das
Gute mehr oder weniger identisch sei
als das Schóne.)

Und es ist nicht verwunderlich, daf die

tiefsten Probleme  eigentlich keine
Probleme sind.

4.0031 Alle Philosophie ist
«Sprachkritik». (Allerdings nicht im

Sinne Mauthners.) Russells Verdienst ist
es, gezeigt zu haben, dal3 die scheinbare
...
4.011 Auf den ersten Blick scheint der
...
Lautzeichen-(Buchstaben-)Schrift  kein
Bild unserer Lautsprache. Und doch
erweisen sich diese Zeichensprachen auch
im gewóhnlichen Sinne als Bilder dessen,
was sie darstellen.

4.012 Offenbar ist, daf wir einen Satz
...
wir, daf dieselbe durch scheinbare
Unregelmáfigkeiten (wie die
Verwendung der % und b in der

Notenschrift) nicht gestórt wird.

Denn auch diese UnregelmáfBigkeiten
bilden das ab, was sie ausdriicken sollen;
...
imldgaicaheiChewwadútelifidvalmrelavedb$ferde und ihre Lili
...
4.0141 Daf es eine allgemeine Regel
...
nach der ersten Regel wieder die
Partitur ableiten kann, darin besteht eben
die innere Áhnlichkeit dieser scheinbar so
...
Der Satz zeigt, wie es sich verhált, wenn
er wahr ist. Und er sagt, dal es sich so
verhált.
...
figuración, proviene la escritura
alfabética.

402 Y así vemos que nosotros
...
4.023 Die Wirklichkeit mufi durch den
Satz auf ja oder

Dazu muf sie durch ihn vollstándig
...
eines logischen Geriistes und darum kann
man am Satz auch sehen, wie sich alles
Logische verhált, wenn er wahr ist. Man
kann aus einem falschen Satz Schltisse
ziehen.

4.024 Einen Satz verstehen, heift, wissen
...
4.025 Die Ubersetzung einer Sprache in
eine andere geht nicht so vor sich, dalf3
man jeden Satz der einen in einen Satz
der anderen iibersetzt, sondern nur die
Satzbestandteile werden úbersetzt.

(Und das Wórterbuch úbersetzt nicht nur
Sub stantiva, sondern auch Zeit-,
Eigenschafts- und Bindewórter etc.; und
es behandelt sie alle gleich.)

4.026 Die Bedeutungen .der einfachen
-Zeichen (der Wórter) miissen uns erklárt
werden, daf3 wir sie verstehen.

Mit den Sátzen aber verstándigen wir uns.

4.027 Es liegt im Wesen des Satzes, dal3
er uns einen neuen Sinn mitteilen kann.

4.03 Ein Satz muf mit alten Ausdricken
einen neuen Sinn mitteilen.

/48/

Der Satz teilt uns eine Sachlage mit, also
muBineñixieatseeitlich mit der Sachlage
zusammenhángen.
...
ello es posible ver en la proposición, sí es
...
Und der Zusammenhang ist eben, daf er
...
4.0311 Ein Name steht fúr ein Ding, ein
anderer fir einanderes Ding und
untereinander sind sie verbunden, so stellt
das Ganze —wie ein lebendes Bild- den
Sachverhalt vor.

4.0312 Die Móglichkeit des Satzes beruht
auf dem Prinzip der Vertretung von
Gegenstánden durch Zeichen.

Mein Grundgedanke ist, daf die
»logischen Konstanten« nicht vertreten.
Dafi sich die Logik der Tatsachen nicht
vertreten láft.
...
4.04 Am Satz muf gerade soviel zu
unterscheiden sein, als an der Sachlage
die er darstellt. Die beiden mússen die

gleiche logische (mathematische)
Manmnigfaltigkeit besitzen. (Vergleiche
Hertz?s Mechanik, úber Dynamische
Modelle.)

/50/

4.041 Diese mathematische
Manmnigfaltigkeit kann man  natúrlich
...
durch »(x) fx«  ausdricken, durch
Vorsetzen eines Indexes vor  »fx«
ausdrúcken —etwa so: »Alg. fx«, es wúrde
nicht genúgen- wir wúften nicht, was
verallgemeinert wurde. Wollten wir es
durch einen Index » a « anzeigen —etwa
so: »f(xa)«- es wiirde auch nicht genúgen
wir wiften nicht den Bereich der
Allgemeinheitsbezeichnung.

Wollten wir es durch Einfúhrung einer
Marke in die Argumentstellen versuchen
=etwa so: »(A,A) . F(A,A)J«- es wiirde
nicht geniigen —wir kónnten die Identitát
der Variablen nicht feststellen. Usw.

Alle diese Bezeichnungsweisen geniigen
nicht, weil sie nicht die notwendige
mathematische Mamnigfaltigkeit haben.

4.0412 Aus demselben Grunde genúgt die
idealistische Erklárung des Sehens der

ráumlichen  Beziehungen durch die
»Raumbrille« nicht, weil sie nicht die
Manmnigfaltigkeit dieser  Beziehungen
...
4.061 Beachtet man nicht, dafí der Satz
einen von den Tatsachen unabhángigen
Sinn hat, so kann man leicht glauben, dal
wahr und  falsch  gleichberechtigte
Beziehungen von Zeichen und Bezeich-
netem sind.

Man kónnte dann z. B. sagen, daf3 »p« auf
die wahre Art bezeichnet, was »-p« auf
die falsche Art, etc.

4.062 Kann man sich nicht mit falschen
Sátzen, wie  bisher mit  wahren,
verstándigen? Solange man nur weif3, dalf3

1521

sie falsch gemeint sind. Nein! Denn, wahr
ist ein Satz, wenn es sich so verhált, wie
wir
...
un índice «g», como: «fíxg)», no sería
...
-p meinen, und es sich so verhált wie wir
es meinen, so ist »p« in der neuen
Auffassung wahr und nicht falsch.

4.0621 Daf aber die Zeichen »p« und

»-p« das gleiche sagen kónnen, ist wichtig. Denn epxeyek-$añ dendátedian doanrsder. Wuds ichkeit nichts ent

Daf in einem Satz die Verneinung
vorkommt,
Die Sátze »p« und  »-p« haben
entgegengesetzten Sinn, aber es entspricht
ihnen eine und dieselbe Wirklichkeit.

4.063 Ein Bild zur Erklárung des
Wahrheitsbegriffes: Schwarzer Fleck auf
weifem Papier; die Form des Fleckes
kann man beschreiben, indem man fúr
jeden Punkt der Fláche angibt, ob er weif
oder schwarz ist. Der Tatsache, dafi ein
Punkt schwarz ist, entspricht eine positive
—der, dal3 ein Punkt weif3 (nicht schwarz)

ist, eine negative Tatsache. Bezeichne ich einen Panks dbdarrdáchabarenAirbgelsa hn dq Wa hmheitswert), so ents]

Um aber sagen zu kónnen, ein Punkt sei
schwarz oder weif, mu ich vorerst
wissen, wann man einen Punkt schwarz
und wann man ihn weif nennt; um sagen
zu kónnen: »p« ist wahr (oder falsch),
muf ich bestimmt haben, unter welchen
Umstánden ich »p« wahr nenne, und
damit bestimme ich den Sinn des Satzes.
Der Punkt, an dem das Gleichnis hinkt, ¡st
nun der: Wir kónnen auf einen Punkt des
Papiers zeigen, auch ohne zu wissen, was
weif und schwarz ist; einem Satz ohne
Sinn aber entspricht gar nichts, denn er
bezeichnet kein Ding (Wahrheitswert),
dessen Eigenschaften etwa »falsch« oder
»wahr« hiefen; das Verbum eines Satzes
ist nicht »ist wahr« oder »ist falsch« -wie
Frege

ist noch kein Merkmal seiner Aidads (al-psipno
...
verdaderas; el verbo de una proposición
no es —como creía Frege- «es

1551

elaubte-, sondern das, was »wahr ist«,
muf das Verbum schon enthalten.

4.064 Jeder Satz mul schon einen Sinn
haben; die Bejahung kann ihn ihm nicht
geben, denn sie bejaht ja gerade den Sinn.
Und dasselbe gilt von der Verneinung,
etc.

4.0641 Man  kónnte  sagen: Die
...
indem er jenen aufñerhalb diesem liegend
beschreibt.

Daf man den verneinten Satz wieder
verneinen kann, zeigt schon, dal3 das, was
...
4.11 Die Gesamtheit der wahren Sátze ist
...
(Das Wort »Philosophie« muf  etwas
bedeuten, was úiber oder unter, aber nicht
neben den Naturwissenschaften steht.)

4.112 Der Zweck der Philosophie ist die
logische Klárung der Gedanken.

Die Philosophie ist keine Lehre, sondern
eine Tátigkeit. Ein philosophisches Werk
besteht wesentlich aus Erláuterungen.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

Das Resultat der Philosophie sind nicht
»philosophische Sátze«, sondern das
Klarwerden von Sátzen.

Die Philosophie soll die Gedanken, die
sonst, gleichsam, tribe und
...
Philosophie nicht  verwandter als
...
Philosophen fúr die Philosophie der
Logik fir so wesentlich hielten? Nur
verwickelten sie sich  meistens in
unwesentliche psychologische
...
4.116 Alles was úbberhaupt gedacht
werden kann, kann klar gedach werden.
Alles was sich aussprechen láft sich klar
aussprechen.

4.12 Der Satz kann die  gesamte
Wirklichkeit darstellen, aber er kann nicht
das  darstellen, was er mit der
Wirklichkeit gemein haben muf, um sie
darstellen zu kónnen —die logische Form.
Un die logische Formd darstellen zu
kónnen, miiften wir uns mit dem Satze

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

auferhalb der Logik aufstellen kónnen,
das heif3t auferhalb der Welt.

/58 /

con precisión los pensamientos que de
...
Was sich in der Sprache ausdrickt,
kónnen wir nicht durch sie ausdrúcken.
Der Satz zeigt die logische Form der
Worklichkeit.

Er weist sie auf.

4.1211 So zeigt ein Satz »fa«, daf in
seinem Sinn der Gegenstand a vorkommt,
zwel Sátze »fa« und »ga«, dal in ihnen
beiden von demselben Gegenstand die
Rede ist.

Wenn zwei Sátze einander
...
Gefúhl: daf wir im  Besitze einer
nichtingen logischen Auffassung seien,
wenn nur einmal alles in unserer Zeichen
sprache stimm.

4,122 Wir kónnen in gewissem Sinne von
formalen Eigenschaften der Gegenstánde
und Sachverhalte bzw. von Eigenschaften
der Struktur der Tatsachen reden und in

demselben Sinne von formalen
Relationen und Relationen von
Strukturen.

(Statt Eigenschaft der Struktur sage ich
auch  »interne  Eigenschaft«;  statt
Relation der  Strukturen  »interne
Relation<.

Ich fúhre diese Ausdricke ein, um den
...
nicht durch Sátze behauptet werden,
sondern es zeigt sich in den Sátzen,
welche jene Sachverhalte darstellen und
von jenen Gegenstánden handeln.

/60/

4.121. La proposición no puede
...
Tatsache kónnen wir auch einen Zug
dieser Tatsache nennen. (In dem Sinn, in
welchem wir etwa von Gesichtsziigen
sprechen.)

4.123 Eine Eigenschaft ist intern, wenn es
undenkbar ist, daf ihr Gegenstand sie
nicht besitzt.

(Diese blaue Farbe und jene stehen in der
inter nen Relation von heller und
dunkler eo ipso. Es ist undenkbar, dal
diese beiden Gegenstánde nicht in dieser
Relation stúnden.)
...
Eigenschaft einer móglichen Sachlage
wird nicht durch einen Satz ausgedrúckt,
sondern es drúckt sich in dem sie
darstellenden Satz, durch eine interne
Eigen schaft dieses Satzes aus.

Es wáre ebenso unsinnig, dem Satze eine
formale Eigenschaft zuzusprechen, als sie
ihm abzusprechen.

4.1241 Formen kann man nicht dadurch
voneinander unterscheiden, daf3 man sagt,
die eine habe diese, die andere aber jene
Eigenschaft; denn dies setzt voraus, daf
es einen Sinn habe, beide Eigenschaften
von beiden Formen auszusagen.

4.125 Das Bestehen einer internen
Relation zwischen móglichen Sachlagen.
drúckt sich sprachlich durch eine interne
...
Ebenso die Reihe der Sátze »aRb«.

»(_ Xx): aRx.xRb«,

»( Xx,y): aRx.xRy.yRb<, u.s.f.

(Steht b in einer dieser Beziehungen zu a,
so nenne ich b einen Nachfolger von a.)

4.126 In dem Sinne, in welchem wir von
formalen Eigenschaften sprechen, kónnen
wir nun auch von formalen Begriffen
reden.

(Ich fúhre diesen Ausdruck ein, um den
Grund der Verwechslung der formalen
Begriffe mit den eigentlichen Begriffen,
welche die ganze alte Logik durchzieht,
klar zu machen.)

Daf etwas unter einen formalen Begriff
als dessen Gegenstand fállt, kann nicht
durch einen Satz ausgedriickt werden.
Sondern es-zeigt sich an dem Zeichen
dieses Gegenstandes selbst. (Der Name
zelgt, daf er einen  Gegenstand
bezeichnet, das Zahlenzeichen, daf es
eine Záhl bezeichnet etc.)

Die formalen Begriffe kónnen ja nicht,
...
Gegenstánde, welche unter diesen Begriff
fallen.
...
Ausdrúcke wie »l ist eine Zahl«, »es gibt
nur Eine Nullx und áhnliche sind
unsimnig.
...
nur eine 1«, als es unsinnig wáre, zu
sagen: 2-12 ist um 3 Uhr gleich 4.)

164 /

4.127 La variable proposicional designa
...
Expresiones como «l es un número»,
...
einem Gegenstand, der unter ihn faállt,
bereits gegeben. Man kann also nicht
Gegenstánde eines formalen Begriffes
und den formalen Begriff selbst als
Grundbegriffe einfiihren. Man kann also
Z. B. nicht den Begriff der Funktion, und
auch spezielle Funktionen (wie Russell)
als Grundbegriffe einfiihren; oder den
Begriff der Zahl und bestimmte Zahlen.

4.1273 Wollen wir den allgemeinen Satz:
»b ist ein Nachfolger von ax« in der
Begriffsschrift ausdriikken, so brauchen
wir hierzu einen Ausdruck fúr das
allgemeine Glied der Formenreihe: aRb, (
x):aRx.xRb, (.x,y): aRx.xRy.yRb,... Das
allgemeine Glied einer Formenreihe kann
man nur durch eine Variable ausdriicken,
denn der  Begriff:  Glied dieser
Formenreihe, ist ein formaler Begriff.
(Dies haben Frege und Russell úbersehen;
die Art und Weise wie sie allgemeine
Sátze, wie den obigen ausdrúcken wollen,
ist daher falsch; sie enthált einen circulus
vitiosus.)

Wir kónnen das allgemeine Glied der
...
kein Satz kann eime solche Frage

beantworten.
(Man kann alzo z: B. nicht fragen: »Gibt
es unanalysierbare

Subjekt-Prádikatsátze?«)
...
es keinen philosophischen Monismus
oder Dualismus, etc.
...
funciones especiales como ideas
...
serie formal: aRb, (_x):aRx.xRb, (_x,y):
...
pues ninguna proposición puede
...
Ubereinstimmung, und
Nichtiibereinstimmung mit den
Moglichkeiten des  Bestehens und
Nichtbestehens der Sach verhalte.

4.21 Der  einfachste  Satz, der

Elementarsatz, behauptet das Bestehen
eines Sachverhaltes.

4.211 Ein Zeichen des Elementarsatzes ist
es, dali kein Elementarsatz mit ihm in
Widerspruch stehen kann.

4.22 Der BElementarsatz besteht aus
Namen. Er ist ein Zusammenhang, eine
Verkettung, von Namen.

4.221 Es ist offenbar, dal wir bei der
Analyse der Sátze auf Elementarsátze
kommen mússen, die aus Namen in
...
komplex ist, so dal jede Tatsache aus
unendlich vielen Sachverhalten besteht
und jeder Sachverhalt aus unendlich
vielen Gegenstánden zusammengesetzt
ist, auch dann miifíte es Gegenstánde und
Sachverhalte geben.
...
Oder ich deute ihn durch die Buchstaben
p,q,ran.
...
proposición elemental, afirma la
...
und derselben Bedeutung, so driicke ich
dies aus, indem ich zwischen beide das
Zeichen »=« setze.

»a=bx« heifit also: das Zeichen »ax« ist
durch das Zeichen »b« ersetzbar.

(Fúhre ich durch eine Gleichung ein
...
4.242 Ausdrúcke von der Form »a=b«

sind also nur Behelfe der Darstellung; sie sagen niuhts,iibetadie Brdleutungaasgeichda »ada »b« aus.

4,243 Kónnen wir zwei Namen verstehen,
ohne zu wissen, ob sie dasselbe Ding
oder Zzwel verschiedene Dinge
bezeichnen? —Kónnen wir einen Satz,
worin zwei  Namen  vorkommen,
...
deutschen Wortes, so ist es unmóglich,
daf ¡ich nicht weifi, daf die beiden
gleichbedeutend sind; es ist unmóglich,
daf ich sie nicht ineinander úbersetzen
kann.

Ausdricke wie »a=ax«, oder von diesen
abgelei tete, sind weder
Elementarsátze, noch sonst sinnvolle
...
426 Die  Angabe aller  wahren
Elementarsátze  beschreibt die Welt

vollstándig. Die Welt ist vollstándig
beschrieben durch die Angaben aller
Elementarsátze plus der Angabe, welche
von ihnen wahr iindwelche falsch sind.
...
4.226 La enumeración de todas las
...
elementales más la indicación de cuáles
son verdaderas y cuáles falsas.

/69/

4.27 Beziiglich des Bestehens und
Nichtbestehens von n Sachverhalten gibt
es

K, = Y (7) Moglichkeiten.

Es kónnen alle Kombinationen der
...
ebenso viele Móglichkeiten der Wahrheit
—und Falschheit- von n Elementarsátzen.

4,3 Die Wahrheitsmóglichkeiten der
Elementarsátze bedeuten die
Moglichkeiten des  Bestehens und

Nichtbestehens der Sachverhalte.

4.31 Die Wahrheitsmóglichkeiten kónnen
wir durch Schemata folgender Art
darstellen ( »W« bedeutet »wahr«, »EF«
»falsch«. Die Reihen der »Wx« und »E«

unter der Reihe der Elementarsátze
bedeuten in leichtverstándlicher
Symbolik deren Wahrheits-
moóglichkeiten):
...
Ubereinstimmung und
Nichtiibereinstimmung mit den Wahrheits
moglichkeiten der Elementarsátze.

4.41 Die Wahrheitsmóglichkeiten der
Elementarsátze sind die Bedingungen der
Wahrheit und Falschheit der Sátze.

4.411 Es ist von  vornherein
wahrscheinlich, daf die Einfúhrung der
Elementarsátze fúr das Verstándnis aller
anderen Satzarten grundlegend ist. Ja, das
Verstándnis der allgemeinen Sátze hángt
fúhlbar von dem der Elementarsátze ab.

4.42 bezijglich der Ubereinstimmung und
Nichtiibereinstimmung eines Satzes mit
den  Wahrheitsmóglichkeiten von  n
Elementarsátzen gibt es

Ka E

E (1) = L, Móglichkeiten.

4.43 Die Ubereinstimmung mit den
Wahrheitsmóglichkeiten  kónnen wir
dadurch ausdriicken, indem wir ihnen im
Schema etwa das Abzeichen »W« (wahr)
zuordnen.

Das Fehlen dieses Abzeichens bedeutet
die Nichtúbereinstimmung.

4,431 Der Ausdruck der
Ubereinstimmung und Nicht-
úbereinstimmung mit den
Wahrheitsmóglichkeiten der

Elementarsátze driickt die Wahrheitsbe-
dingungen des Satzes aus.

Der Satz ist der Ausdruck  seiner
Wahrheitsbedingungen. (Frege hat sie
daher ganz richtig als Erklárung der
Zeichen  seiner  Begriffsschrift  vor-
ausgeschickt. Nur ist die Erklárung des
Wahrheitsbegriffes bei Frege  falsch:

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

Wáren »das Wahre« und »das Falsche«
wirklich Gegenstánde und die Argumente
in—p
...
de su simbolismo lógico. Sólo es falsa en
...
etc., dann wáre nach Freges Bestimmung
der Sinn von » -p« keineswegs bestimmt.)

44 Das Zeichen, welches durch die
Zuordnung jener Abzeichen »W« und der
Wahrheitsmóglichkeiten entsteht, ist ein
Satzzeichen.

4,441 Es ist klar, daf dem Komplex der
Zeichen »F« und »Wx« kein Gegenstand
(oder Komplex von  Gegenstánden)
entspricht; so wenig wie den horizontalen
und  vertikalen  Strichen oder den
Klammern. —»Logische Gegenstánde«
gibt es nicht.

Analoges gilt natiúrlich fir alle Zeichen,
die  dasselbe  ausdriicken wie die
Schemata der »W« und »E«.
...
(Frege?”s »Urteilstrichx« » E ist logisch
ganz bedeutungslos; er zeigt bei Frege
(und Russell) nur an, dafí diese Autoren
die so bezeichneten Sátze fir wahr halten.
» ff- < gehórt daher ebensowenig zum
Satzgefiige, wie etwa die Nummer des
Satzes. Ein Satz kann unmóglich von sich
selbst aussagen, date er wahr ist.)

Ist die Reihenfolge der
Wahrheitsmóglichkeiten im Schema
durch eine Kombinationsregel ein fiir
...
signos «V» y «EF» no corresponde ningún
...
(El signo «aseverativo» de Frege « b,
...
este signo « b, que pertenece, pues a la
...
expresión de las condiciones de verdad.
Si
...
deutlicher »(WWFW) (p, gK. (Die
Anzahl der Stellen in der linken Klammer
istdurch die Anzahl der Glieder in der
rechten bestimmt.)

4.45 Fúr n Elementarsátze gibt es L,
moógliche Gruppen von
Wahrheitsbedingungen.

Die Gruppen von Wahrheitsbedingungen,
welche zu den Wahrheitsmóglichkeiten

einer  Anzahl von  Elementarsátzen
gehóren,. lassen sich in eine Reihe
ordnen.

4.46 Unter den móglichen Gruppen von
Wahrheitsbedingungen gibt es  zwel
extreme Fille.

In dem einen Fall ist der Satz fúr
sámtliche Wahrheitsmóglichkeiten der
Elementarsátze wahr. Wir sagen, die
Wahrheitsbedingungen sind tautologisch.
Im zweiten Fall ist der Satz fir sámtliche

Wahrheitsmóglichkeiten  falsch: Die
...
Tautologie und die Kontradiktion, dali sie
nichts sagen.

Die Tautologie hat keine
Wahrheitsbedingungen, denn sie ist
bedingungslos wahr; und die Kontra-
diktion ist unter keiner Bedingung wahr.
...
(Ich weifi z. B. nichts úber das Wetter,
wenn ich weif3, dafí es regnet oder nicht
regnet.)
...
dan L, grupos posibles de condiciones de
verdad.
...
aber nicht unsinnig; sie gehóren zum
Symbolismus, und zwar áhnlich wie die
»o« zam Symbolismus der Arithmetik.

4.462 Tautologie und Kontradiktion sind
nicht Bilder der Wirklichkeit. Sie stellen
keine mógliche Sachlage dar. Denn jene
láft jede mogliche Sachlage zu, diese
keine. In der Tautologie heben die
Bedingungen der UÚbereinstimmung mit
der Welt —die darstellenden Beziehungen-
einander auf, so daf sie in keiner
...
negativen Sinne wie ein fester Kórper, der die Bewélkdo gy ihmitdeclahtbeeembesoleitatiden positiven Sinne,

Die Tautologie láft der Wirklichkeit den
ganzen -unendlichen- logischen Raum;
die Kontradiktion erfúllt den ganzen
logischen Raum und láft der Wirklichkeit

keinen Punkt. Keine von beiden kann
daher die  Wirklichkeit  irgendwie
bestimmen.

4.464 Die Wahrheit der Tautologie ist
gewif, des  Satzes  moóglich, der
Kontradiktion unmóglich.

(Gewif, móglich, unmóglich: Hier haben
wir das Anzeichen jener Gradation, die
wir in der Wahrscheinlichkeitslehre
brauchen.)

4.465 Das logische  Produkt einer
Tautologie und eines Satzes sagt
dasselbe, wie der Satz. Also ist jenes
Produkt identisch mit dem Satz. Denn
man kann das Wesentliche des Symbols
nicht ándern, ohne seinen Sinn zu ándern.
...
4.466 FEiner  bestimmten  logischen
...
Das heifit, Sátze die fúr jede Sachlage
wahr sind, kónnen úberhaupt keine
Zeichenverbindungen sein, denn sonst
kónnten ihnen nur bestimmte
Verbindungen von Gegenstánden
entsprechen. (Und keine  logischen
Verbindung entspricht deine Verbindung
der Gegenstánde.)

Tautologie und Kontradiktion sind die
Grenzfálle der  Zeichenverbindung,
námlich ihre Auflósung.
...
4.5 Nun scheint es móglich zu sein, die
allgemeinste Satzforrn anzugeben: das
heift, eine Beschreibung der Sátze
irgendeiner Zeichensprache zu geben, so
dal3 jeder mógliche Sinn durch ein
Symbol, auf welches die Beschreibung
paft, ausgedrúckt werden kann, und dal3
jedes Symbol, worauf die Beschreibung
paft, einen Sinn ausdriicken kann, wenn
die Bedeutungen der Namen
entsprechend gewáhlt werden.

Es ist klar, daf bei der Beschreibung der
allgemeinsten  Satzform nur ihr
Wesentliches beschrieben werden darf,
-sonst wáre sie námlich nicht die
allgemeinste.

Daf es eine allgemeine Satzform gibt,
wird dadurch bewiesen, dafi es keinen
Satz geben darf, diesen Form man nicht
hátte voraussehen (d. h. konstruieren)
kónnen. Die allgemeine Form des Satze
ist: Es verhált sich so und so.
...
proposiciones de un simbolismo
...
4.51 Angenomen, mir wáren alle
Elementarsátze geben: Dann láft sich
einfach fragen: welche Sátze ich aus
ihnen bilden. Und das sind alle Sátze und
so sind sie begrenzt.

4.52 Die Sátze sind alles, was aus der
Gesamtheit aller Elemenentarsátze folgt
(natúrlich auch daraus, daf e sie
Gesamtheit aller ist). (So kónnte man in
gewissem Sinne sagen, daf alle Sátze
Verallgemeinerungen der Elementarsátze
sind.)
...
(Der Elementarsátz 1st eine
Wahrheitsfunktion seiner selbst.)
5.01 Die  Elementarsátze sind die

Wahrheitsargumente des Satzes.

5.02 Es liegt nahe, die Argumente von
Funktionen mit den Indices von Namen
zu verwechseln. Ich erkenne námlich
sowohl am Argument wie am Index die
Bedeutung des sie enthaltenden Zeichens.
In Russell?s «+.» ist z.B. «c» ein Index,
der darauf hinweist, daf das ganze
Zeichen das  Additionszeichen  fúr
Kardinalzahlen 1st. Aber diese
Bezeichnung beruht auf willkirlicher
Úbereinkunft und man kónnte statt «+.»
auch ein einfaches Zeichen wáhlen; in
«-p» aber ist «p» kein Index, sondern ein
Argument: der Sinn von « - p» kann nicht
vex:standen werden, ohne dafi vorher der
Sinn von «p» verstanden worden wáre.
(Im Namen Julius Cásar ist «Julius» ein
Index. Der Index ist immer ein Teil einer
Beschreibung des Gegenstandes, dessen

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

Namen wir ihn anhángen. Z. B. Der Cásar
...
de «++». pero en «-p» «p» no es un índice,
...
Sátze und Funktionen zugrunde. Fúr
Frege waren die Sátze der Logik Namen,
...
Anzahl von Elementarsátzen lassen sich
in einem Schema  folgender Art
hinschreiben:

(Y WWW) (p, q) Tautologie (Wenn P, 50 p; und wenn q, so q)
E P>p-9>9)
(FW WWW) (p,q)in Worten; Nicht beides p und q. ( « (p. q)

WWF W Wi» Wenn 9, so p. (q > p)

WWF Wipg»  » Wenn p, so q, (p > 9)

(WWW WE) »  poderq(p)

FFWYWiq» o» Nicht q. ( m q)

FEWF Wind» » Nicht p. [ w p)

[F Y Y F) (p,q)» » P, oder q, aber nicht beide, (Pp -q:v:
q mw p)

(W FF W) (pg) Wenn p, so q; und wenn 9, 50 p.
(p=9)
...
(F FF Y) (pq) » » Weder p noch 0. (- p. q) oder (p | q)

(F F Y E) (p,g) » » P und nicht q. (p, 9) Í E

FWEPFR(q) >» q uad nicht p, (q. e p)

(w FEF (po. > q und p. (9. p) ñ

(F F F F)(p,q) Konteadiktion (p und nicht p; und quad niche q.)
(Pp. qu) p

Diejenigen Wahrheitsmóglichkeiten

seiner Wahrheitsargumente, welche den
Satz bewahrheiten, will ich  seine
Wahrheitsgrúnde nemnnen.

5.11 Sind die Wahrheitsgriinde, die einer
Anzahl von Sátzen gemeinsam sind,
sámtlich auch Wahrheitsgrúnde eines
bestimmten Satzes, so sagen wir, die
Wahrheit dieses Satzes folge aus der
Wahrheit jener Sátze.

5.12 Insbesondere folgt die Wahrheit
eines Satzes «p» aus der Wahrheit eines
anderen «q», wenn alle Wahrheitsgrúnde

179]

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

des zweiten Wahrheitsgrinde des ersten
sind.
...
(Y V V V) (p, q) Tautología (Si p, entonces p; y si q, entonces q)

lp>p .9>0l

F Y V V) (p, q) En palabras: No conjuntamente Py l[-[p Y
VEVV (py » Si q, entonces p . [q >p]
(V V EF V) (p, 9) » Si p, entonces q [p > q)
(VVVEP (p 9) » p 04. [pva]
(FF Y V) (p, 9) » No q. [ » q]
FVEV) (p, q) > No p. [' w p]
FVVPF) (p 9) > Pp 0 9, no ambas. [p. q: v: quep)
(VE EV) (», 9) > Si p, entonces q; y si q, entonces p. [p=9)
(WVFVA (pg) » p
(VV FP) (p, 9) $1: 38
(EF FVW) (p, q) » Nipaig.['=p. «090 [p|q]
(F F V EF) (p, q) » p y no q. [p. . 9)

) » q y ro p. [q. «- p]

) (p, q » p ya [p.q)
(F FF F) (p, q) Contradicción (p y no p; y q y no q.)
...
fundamentos de verdad de la segunda son 5.121 Die Wahrheitsgrinde,. des einen
fundamentos de verdad de la primera. sind in denen des anderen enthalten; p ,
folgt aus q.
...
worin gewisse Sátze wahr send, so schafft
er damit auch schon eine Welt, in welcher
alle ihre Folgesátze stimmen. Und áhnlich
kónnte er keine Welt schaffen, worin der
Satz «p» wahr ist, ohne seine sámtlichen
Gegenstánde zu schaffen.

5.124 Der Satz bejaht jeden Satz, der aus
ihm folgt.

5.1241 «p.q» ist einer der Sátze, welche

«p» bejahen und zugleich einer der Sátze, welche «q»
Zwel Sátze sind einander

entgegengesetzt, wenn es  keinen
...
5.13 Dalí die Wahrheit eines Satzes aus
der Wahrheit anderer Sátze folgt, ersehen wir aus der Strukt

5.131 Folgt die Wahrheit eines Satzes aus
der Wahrheit anderer, so drúckt sich dies
durch Beziehungen aus, in welchen die
Formen jener Sátze zu einander stehen;
...
und bestehen, sobald, und dadurch, daf
jene Sátze bestehen.
...
5.1241 «pq» es una de las proposiciones
que aseveran «p» y al mismo tiempo una
de la proposiciones que aseveran «gq».
...
schliefñen, so ist hier durch die
Bezeichnungsweise die Beziehung der
Satzformen von «pvq» und «-p» verhiillt.
Schreiben wir aber z.B. statt «pvq» «plq.|.
pig» und statt «-p» «plp» (plg=weder p,
noch q), so wird der  imnere
Zusammenhang offenbar.

(Daf3 man aus (x).fx auf fa schliefen kann,
das zeigt, dalí die Allgemeinheit auch im
Symbol «(x). fx» vorhanden ist.)

5.132 Folgt p aus q, so kann ich von q auf
pschlies sen; p aus q folgern.

Die Art des Schlusses ist allein aus den
beiden Sátzen zu entnehmen.

Nur sie selbst kónnen den Schluf
rechtfertigen.

«Schlufgesetze», welche —wie bei Frege
und Russell- die Schlisse rechtfertigen
sollen, sind  sinnlos, und  wáren
úberfliissig.

5.133 Alles Folgern geschieht a priori.

5.134 Aus einem Elementarsatz láft sich
kein anderer folgern.

5.135 Auf keine Weise kann aus dem
Bestehen irgendeiner Sachlage auf das
Bestehen einer, von ihr  gánzlich
verschiedenen  Sachlage  geschlossen
werden.

5.136 Einen Kausalnexus, der einen
solchen Schluf rechtfertigt, gibt es nicht.

5.1361 Die Ereignisse der Zukunft
kónnen wir nicht aus den gegenwártigen
erschliefñen.
...
daf zukúnftige Handlungen jetzt nicht
gewubft werden kónnen. Nur  dann

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

kónnten wir sie wissen, wenn die Kau-
salitát cine innere Notwendigkeit wáre,
wie die des
...
«plq..plg» y en vez de «-p» «plp» (p|g=ni
...
logischen Schlusses. —Der
Zusammenhang von  Wissen und
Gewuftem, ist der der  logischen
Notwendigkeit.

(«A weif3, dal p der Fall ist» ist sinnlos,
wenn p eine Tautologie ist.)

5.1363 Wenn daraus, daf ein Satz uns
einleuchtet, nicht folgt, dali er wahr ist, so
ist das  kEinleuchten auch keine
Rechtfertigung fúr unseren Glauben an
seine Wahrheit.
...
Sátzen: sie sagt Nichts.

5.143 Die  Kontradiktion ist das
Gemeinsame der Sátze, was kein Satz mit
einem  anderen  gemein hat. Die

Tautologie ist das Gemeinsame aller
Sátze, welche nichts miteinander gemein
haben.

Die Kontradiktion verschwindet
sozusagen aus serhalb, die Tautologie
innerhalb aller Sátze.

Die Kontradiktion ist die áufere Grenze

der Sátze, die  Tautologie  1st
substanzloser Mittel punkt.
5.15  Ist W, die  Anzahl der

Wahrheitsgrúnde des Satzes »r«, W;s die
Anzahl derjenigen Wahrheitsgrúinde des
Satzes »s«, die zugleich Wahrheitsgrúnde
von »r« sind, dann nennen wir das
Verháltnis: Wi: Wf das Mal der
Wahrscheinlichkeit, welche der Satz »r«
dem Satz »s« gibt.

5.151 Sei in einem Schema wie dem
obigen in No. 5.101 W, die Anzahl der

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

»W« im Satze r; W, die Anzahl
derjenigen »W«u im Satze s, die in
...
dem Satze s die Wahrscheinlichkeit: W:s:
W..

5.1511 Es keinen  besonderen
Gegenstand, der den
Wahrscheinlichkeitssátzen eigen wáre.

gibt

5.152 Sátze, welche keine
Wahrheitsargumente mit einander gemein
haben, nennen wir von  einander
unabhángig.

Zwei Elementarsátze geben einander die
Wahrscheinlichkeit 1/2.

Folgt p aus q, so gibt der Satz »g« dem
Satz »p« die Wahrscheinlichkeit 1. Die
GewifBheit des logischen Schlusses ist ein
...
wieder in die Urne zurúck. Dann kann ich
durch den Versuch feststellen, daf sich
die Zahlen der gezogenen schwarzen und
weifen Kugeln bei fortgesetztem Ziehen
einander náhern.

Das ist also kein mathematisches Faktum.
Wenn ich nun sage: Es ist gleich
wahrscheinlich, daf3 ich eine weife Kugel
wie eine schwarze ziehen werde, so heift
das: Alle mir bekannten Umstánde (die
hypothetisch angenommenen Na-
turgesetze mitinbegriffen) geben dem
Eintreffen des einen Ereignisses nicht
mehr  Wahrscheinlichkeit als dem
Eintreffen des anderen. Das heifBt, sie
geben —wie aus den obigen Erklárungen
leicht zu entnehmen ist- jedem die
Wahrschein lichkeit Y.
...
proposición s la probabilidad V;s: V;.
...
Was ich durch den Versuch bestátige, ist,
dali das Eintreffen der beiden Ereignisse
von den Umstánden, die ich nicht náher
hánglg ist.

3135 Die Einheit des
Wahrscheinlichkeitssatzes ist: Die
Umstánde —die ich sonst nicht weiter ken-
e- geben dem Eintreffen eines bestimmten
...
Nur in Ermanglung der Gewifheit
gebrauchen wir die Wahrscheinlichkeit. —
Wenn wir zwar eine Tatsache nicht
vollkommen kennen, wohl aber efwas
úber ihre Form wissen.

(Ein Satz kann zwar ein unvollstándiges
Bild einer gewissen Sachlage sein, aber er
ist immer ein vollstándiges Bild.)
Der Wahrscheinlichkeitssatz
gleichsam ein Auszug aus
Sátzen.

ist
anderen

5.2 Die Strukturen der Sátze stehen in
internen Beziehungen zu einander.

5.21 Wir  kónnen diese  internen
Beziehungen  dadurch in  unserer
Ausdrucksweise hervorheben, daf wir
einen Satz als Resultat einer Operation
darstellen, die ihn aus anderen Sátzen
...
einen Satz geschehen muf, um aus ¡hm
den anderen zu machen.

/ 88 /

5.231 Und das wird natiirlich von ihren
formalen Eigenschaften, von der internen
Ahnlichkeit ihrer Formen abhángen.
...
e to La unidad de la
proposición-probabilidad es: las
...
5.231 Y esto depende, naturalmente, de
...
ordnet, ist ¿quivalent mit der Operation,
...
logische Konstruktion des Satzes anfángt.

5.234 Die Wahrheitsfunktionen der
Elementarsátze sind  Resultate von
Operationen, die die Elementarsátze als
...
5.242 Dieselbe Operation, die »g« aus
»p« macht, macht aus »gx« »r« usf. Dies
kann nur darin ausgedrickt sein, date
...
Resultat, und dies hángt von den Basen
der Operation ab.

(Operation und Funktion dúrfen nicht
...
und Whiteheads) móglich. (Russell und
Whitehead haben die Móglichkeit dieses
...
»0”0"0”ax« ist das Resultat der drei-
maligen successiven Anwendung von »O”
-E4 auf »ax).

Im einem áhnlichen pinne rede ich von
der successiven Anwendung mehrerer
Operationen auf eine Anzahl von Sátzen.

5.2522 Das allgemeine Glied einer
Formenreihe a, 0” a, 0 0 Ja...
schreibe ich daher so: »[a,x,0'x  ]«.
Dieser  Klammerausdruck ist eine
Variable. Das  erste  Glied des
...
Anwendung der Operation ist áquivalent
mit dem Begriff »und so weiter«.

5.253 Eine Operation kann die Wirkung

einer anderen  riúckgángig  machen.
Operationen kónnen einander aufheben.
...
su sucesiva aplicación («0” O” O” a» es el
...
Operaciones a un número de
proposiciones.

5.2522 El término general de la serie
formal a, O" a, 0" O' a,. . . lo escribo,
...
dann eine Bedeutung, wenn »p«, »qs,
»r«,. etc. nicht Elementarsátze sind. Und
es ist leicht zu sehen, dafi das Satzzeichen
in No. 4.442, auch wenn »p« und »q«
Wahrheitsfunktionen von  Elementar-
sátzen sind, eine Wahrheitsfunktion von
Elementarsátzen ausdriickt.

5.32 Alle Wahrheitsfunktionen sind
Resultate der successiven Anwendung
einer endlichen Anzahl von
Wahrheitsoperationen auf die
Elementarsátze.

5.4 Hier zeigt es sich, dalí es »logische
Gegenstánde«, »logische Konstante« (im
Sinne Freges und Russells) nicht gibt.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

5.254 Las operaciones pueden
...
5.42 Dal v, e, etc. nicht Beziehungen im
Sinne von rechts und links etc. sind,
leuchtet ein.

Die  Moóglichkeit des  kreuzweisen
Definierens der logischen »Urzeichen«
Freges und Russells zeigt schon, dali dies
keine Urzeichen sind, und schon erst
recht, daf sie keine  Relationen
bezeichnen. Und es ist offenbar, daf das
»e«, welches wir durch » - « und »v«
definieren, identisch ist mit dem, durch
welches wir »v« mit » - « definieren und
daf dieses »v« mit dem ersten identisch
ist. Usw.

5.43 Dafí aus einer Tatsache p unendlich
viele andere folgen sollten, námlich - - p,
- - - - p, etc. ist doch von vornherein
kaum zu glauben. Und nicht weniger
merkwiirdig ist, daf die unendliche
Anzahl der Sátze der Logik (der Ma-
thematik) aus einem halben Dutzend
»Grundgesetzen« folgen.

Alle Sátze der Logik sagen aber dasselbe.
Námlich Nichts.
...
doppelte Verneinung erzeugen kann, 1st
...
wohl aber ist die Moóglichkeit der
Verneinung in der Bejahung  bereits
prájudiziert.

194]

Und gábe es einen Gegenstand, der » - «
hiefñe, so miilíte »- -p« etwas anderes
sagen als »p«. Denn der eine Satz wúrde
dann eben von — handeln, der andere
nicht.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

5.41 Así, pues, todos aquellos resultados
...
con el cual definíamos «v» mediante « -
», y que este «v» es idéntico con el
...
5.45 Gibt es logische Urzeichen, so mul
eine  richtige Logik  ihre  Stellung
zueinander klar machen und ihr Dasein
rechtfertigen. Der Bau der logik aus ihren
Urzeichen mulñ klar werden.

5.451 Hat die Logik Grundbegriffe, so
mússen sie von einander unabhángig sein.
Ist ein Grundbegriff eingefúhrt, so muf er
in allen Verbindungen eigefúhrt sein,
worin er úberhaupt vorkommt. Man kann
ihn also nicht zuerst fiir eine Verbindung,
dann noch einmal fir eine andere
einfúhren. Z.B.: Ist die Verneinung
eingefúhrt, so mússen wir sie jetzt in
Sátzen von der Form » - p« ebenso
verstehen, wie in Sátzen wie » - (pvq)«,
»(x) .- fx«u. a. Wir dúrfen sie nicht erst
fiir die eine Klasse von Fállen, dann fiir
die andere einfúhren, denn es bliebe dann
zweifelhaft, ob ihre Bedeutung in beiden
Fállen die gleiche wáre und es wáre kein
Grund vorhanden, in beiden Fállen
dieselbe Art der Zeichenverbindung zu
benútzen.

(Kurz, fir die Einfihrung der Urzeichen
gilt, mutatis mutandis, dasselbe, was
Frege (Grundgesetze der Arithmetik) fúr
die Einfúhrung von Zeichen durch
...
Mathematica« von Russen und
Whitehead Definitionen und

Grundgesetze in Worten vor. Warum hier
plótzlich Worte? Dies bediirfte einer
Rechtfertigung. Sie fehlt und muf fehlen,
da das Vorgehen tatsáchlich unerlaubt
ist.) Hat sich aber die Einfiihrung eines
neuen Behelfes an einer Stelle als nótig
erwiesen, so muf man sich nun sofort
fragen: Wo muf dieser Behelf nun immer
angewandt werden? Seine Stellung in der
Logik muf nun erklárt werden.

5.453 Alle Zahlen der Logik mússen sich
rechtfertigen lassen.

Oder  vielmehr: Es  muf sich
herausstellen, daf es in der Logik keine
Zahlen gibt.
...
5.4541 Die Lósungen der logischen
Probleme miissen einfach sein, denn sie
setzen den Standard der Einfachheit.

Die Menschen haben immer geahnt dal
es ein Gebiet von Fragen geben músse,
deren Antworten —a priori- symmetrisch,
und zu einem abgeschlossenen,
regelmáfigen Gebilde vereintliegen.

Ein Gebiet, in dem der Satz gilt: simplex
sigilum veri.

5.46 Wenn man die logischen Zeichen
richtig so hátte man damit auch schon den
Sinn aller  ihrer  Kombinationen
eingefúhrt; also nicht nur »pvq« sondern
auch schon »-(pv - q)« etc. etc. Man hátte
damit auch schon die Wirkung aller nur

971

moóglichen Kombinationen von Klam-
mern eingefihrt.
...
repente? Esto necesitaría una justifi-
cación. Esta falta, y tiene que faltar
...
de cuestiones cuyas respuestas -a priori-
...
Und damit wáre es klar geworden, dal
die eigentlichen allgemeinen Urzeichen
nicht die »pvq«, »(._x) . fx«, etc. sind,
sondern die allgemeinste Form  ihrer
Kombinationen.

5.461 Bedeutungsvoll ist die scheinbar
unwichtige Tatsache, dafí die logischen
Scheinbeziehungen wie v und e, der
Klammern bediirfen —im Gegensatz zu
den wirklichen Beziehungen.

Die Beniitzung der Klammern mit jenen
scheinbaren Urzeichen deutet ja schon
darauf hin daf diese nicht die wirklichen
Urzeichen sind. Und es wird doch wohl
niemand glauben, dafí die Klammern eine
selbstándige Bedeutung haben.

5.4611 Die logischen Operationszeichen
sind Interpunktionen.

5.47 Es ist klar, daf alles, was sich
úberhaupt von vornherein ¡ber die Form
aller Sátze sagen láft, sich auf einmal
sagen lassen muf.

Sind ja schon im Elementarsatze alle
logischen Operationen enthalten. Denn
»fa« sagt dasselbe wie »( Xx) . fx . x=a«.
Wo Zusammengesetztheit- ist, da 1st
Argument und Funktion, und wo diese
sind, sind  bereits alle  logischen
Konstanten.

Man kónnte sagen: Die Eine logische
Konstante ist das, was alle Sátze, ihrer
...
heifit, das Wesen aller Beschreibung
...
pseudo-relaciones lógicas como v y € -
...
desde luego, nadie creerá que los
...
5.472 Die Beschreibung der
allgemeinsten Satzform ist die
Beschreibung des einen und einzigen
allgemeinen Urzeichens der Logik.

5.473 Die Logik muf fiir sich selber
sorgen.

Ein mógliches Zeichen muf auch
bezeichnen kónnen. Alles was in der
Logik moóglich ist, ist auch erlaubt.
O»Sokrates ist identisch« heift darum
nichts, weil es keine Eigenschaft gibt, die
»identischex« heifit. Der Satz ist unsimnig,
weil wir eine willkiirliche Bestimmung
nicht getroffen haben, aber nicht darum,
weil das Symbol an und fiir sich unerlaubt
waáre.)

Wir kónnen uns, in gewissem Sinne, nicht
in der Logik irren.

5.4731 Das Einleuchten, von dem Russell
so viel sprach, kann nur dadurch in der
Logik entbehrlich werden, dali die
Sprache selbst jeden logischen Fehler
verhindert. —Daf die Logik a priori ist,
besteht darin, daf3 nicht unlogisch gedacht
wer den kann.

5.4732 Wir kónnen einem Zeichen nicht
den unrechten Sinn geben.

5.47321 Occams Devise ist natúrlich
keine willkirliche, oder durch ihren
praktischen Erfolg gerechtfertigte Regel:
Sie besagt, daf umnótige Zeicheneiheften
nichts bedeuten.

Zeichen, die Einen Zweck erfilllen, sind
logisch áquivalent, Zeichen, die keinen
Zweck erfiillen, logisch bedeutungslos.

5.4733 Frege sagt: Jeder rechtmáfig
gebildete Satz mul einen Sinn haben; und
ich sage; Jeder móglichge Satz ist
rechtmáfig gebildet, und wenn er keinen
Sinn hat, so kann das nur daran Liegen,

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

dali wir einigen seiner Bestandteile keine
Bedeutung gegeben haben.

/ 100 /

5.472 La descripción de la forma más
general de la proposición es la
descripción
...
posible, está también permitido.
...
si no tiene sentido esto se debe úni-
...
Manmnigfaltigkeit- zu bilden.

5.476 Es ist klar, daf es sich hier nicht
um eine Anzahl von Grundbegriffen
handelt, die bezeichnet werden miissen,
...
Diese Operation verneint sámtliche Sátze
in der rechten Klammer, und ich nenne
sie die Negation dieser Sátze.

5.501 Einen Klammerausdruck, dessen
Glieder Sátze sind, deute ich —wenn die
Reihenfolge der Glieder in der Klammer
eleichgúltig ist- durch ein Zeichen von
der Form »(-¿)« an. »e« ist eine Variable,
deren  Werte die  Glieder des
Klammerausdrucks sind; und der Strich
úber der Variablen deutet an, daf sie ihre
sámtlichen Werte in der Klammer vertritt.
...
5.501 Una expresión entre paréntesis

cuyos términos son proposiciones la indico —si el orden de los términos entre paréntesis es indiferente- con un

/ 102 /

(Hat also € etwa die 3 Werte P, Q, R, so
ist (-E)(P, Q, R).)
Die Werte der
festgesetzt.

Die Festsetzung ist die Beschreibung der
Sátze, welche die Variable vertritt.

Wie die Beschreibung der Glieder des
Klam  merausdruckes  geschieht, ist
unwesentlich.

Wir kónnen drei Arten der Beschreibung
unterscheiden: 1. die direkte Aufzáhlung.
In diesem Fall kónnen wir statt der
Variablen einfach ihre konstanten Werte
setzen. 2. Die Angabe einer Funktion fx,
deren Werte fiir alle Werte von x die zu
beschreibenden Sátze sind. 3. Die Angabe
eines formalen Gesetzes, nach welchem
jene Sátze gebildet sind. In diesem Falle
sind die Glieder des Klammerausdrucks
sámtliche Glieder einer Formenreihe.

WVariablen werden

5.502 Ich schreibe also statt »(- - - - - W)
(E, ... I»NESI«. N(-8) 1st die Negation
sámtlicher Werte der Satzvariablen £.

5.503 Da sich offenbar leicht ausdriicken
láft, wie mit dieser Operation Sátze
gebildet werden kónnen und wie Sátze
mit ihr nicht zu bilden sind, so muf dies
auch einen exakten Ausdruck finden
kónnen.

5.51 Hat € nur einen Wert, so ist N (-£) =-
Pp (nicht p), hat es zwei Werte, so ist (N(-

E)=-p. -q (weder p noch q).
...
feinen Netzwerk, zu dem grofen Spiegel,
verkniipfen.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

(Así, pues, si € tiene tres valores P, Q,
R; entonces (-£)=(P, Q, R).)
...
5.502 En vez de «(- - - - - (5... >»
escribo, por consiguiente, «N(-S)». N(-
E) es la negación de todos los valores de
la variable proposicional $.

5.503 Puesto que es obvio que es
fácilmente expresable cómo se pueden
construir proposiciones con esta
operación y cómo no se deben construir
mediante ella, esto tiene también que
hallar una expresión exacta.

5.51 Si £ tiene sólo un valor, entonces N(-
EJ-p) (no p). Si tiene dos valores,
entonces, (N-8)= - p. - q (ni p ni q).
...
5.512 » - p« ist wahr, wenn »px« falsch ist.
Also in dem wahren Satz » - p« 1st
»p« ein falscher Satz. Wie kann ihn nun
der Strich » - « mit der Wirklichkeit zum
Stimmen bringen?

Das, was 1ri » - p« verneint, ist aber nicht
...
Verneinung wider.
5.513 Man  kónnte  sagen: Das

Gemeinsame aller Symbole, die sowohl p als q bejahen, ist «

Und so kann man sagen: Zwei Sátze sind
einander entgegengesetzt, wenn sie nichts
miteinander gemein haben, und: Jeder
Satz hat nur ein Negativ, weil es nur
einen Satz gibt, der ganz auferhalb seiner
liegt.

Es zeigt sich so auch in Russells
Notation, dali »q: pv - p« dasselbe sagt
wie »q«; dal »pv - p« nichts sagt.

5.514 Ist eine Notation festgelegt, so gibt
es in ihr eine Regel, nach der alle p
verneinenden Sátze gebildet werden, eine
Regel, nach der alle p bejahenden Sátze
gebildet werden, eine Regel, nach der alle
p oder q bejahenden Sátze gebildet
werden, usf. Diese Regeln sind den
Symbolen áquivalent und in ihnen
spiegelt sich ihr Sinn wider.

5.515 Es muf sich an unseren Symbolen
zeigen, dal3 das, was durch »v«, ».«, etc.
miteinander verbunden ist, Sátze sein
muússen.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

5.512 «- p» es verdadera si « p» es falsa.
Así, pues, en la proposición verdadera « -
p», «p» es una proposición falsa. ¿Cómo
...
Symbol »p« und »g« setzt ja selbst das »v«, » - «, etc. voral

keinen Sinn haben.

5.5151 Muf das Zeichen des negativen
Satzes mit dem Zeichen des positiven
gebildet werden? Warum sollte man den
negativen Satz nicht durch eine negative
Tatsache ausdrúcken kónnen. (Etwa:
Wenn »a« nicht in einer bestimmten
Beziehung zu »b« steht, kónnte das
ausdrúcken, dafí aRb nicht der Fall ist.)
Aber auch hier ist ja der negative Satz
indirekt durch den positiven gebildet.

Der positive Satz muf die Existenz des
negativen  Satzes  voraussetzen und
umgekehrt.

5.52 Sind die Werte von ¿ sámtliche
Werte einer Funktion fx fúr alle Werte
von x, so wird N(¿)= -(_x).fx.

5.521 Ich trenne den Begriff Alle von der
Wahrheitsfunktion.

Frege und Russell haben die
Allgemeinheit in Verbindung mit dem
logischen Produkt oder der logischen
Summe eingefúhrt. So wurde es schwer,
die Sátze »(_x) . fx« und »(x) . fx«, in
welchen beide Ideen beschlossen liegen,
zu verstehen.

3.522 Das Eigentimliche der
Allgemeinheitsbezeichnung ist erstens,
dal3 sie auf ein logisches Urbild hinweist,
und zweitens, dali sie Konstante her
vorhebt.
...
La proposición positiva debe
presuponer la existencia de la proposición
negativa y viceversa.

5.52 Sí los valores de € son todos los
valores de una función fx, para todos los
valores de x entonces N(-5) = N (x).. fx.
...
entender la proposición «(_x) . fx» y «(x) .
...
5.524 Wenn die Gegenstánde gegeben
sind, so sind uns
Wenn die Elementarsátze gegeben sind,
so sind damit auch alle Elementarsátze
gegeben.

5.525 Es ist unrichtig, den Satz »(_x) , fx«
-wie Russell dies tut- in Worten durch »fx
ist móglich« wiederzugeben.

Gewifheit, Moglichkeit oder
Unmoóglichkeit einer Sachlage wird nicht
durch einen Satz ausgedrickt, sondern
dadurch, daf ein  Ausdruck eine
Tautologie, ein sinnvoller Satz, oder eine
Kontradiktion ist.

Jener Prázedenzfall, auf den man sich
immer be rufen móchte, muf schon im
Symbol selber liegen.

5.526 Man kann die Welt vollstándig

durch vollkommen verallgemeinerte Sátze beschreiben, das

Um dam auf die  gewóhnliche
Ausdrucksweise zu kommen, muf man
einfach nach einem Ausdruck »es gibt ein
und nur ein x, welches...« sagen:

Und dies x ist a.

5.5261 Ein vollkommen
verallgemeinerter Satz ist, wie jeder
andere Satz zusammengesetzt. (Dies zeigt
sich daran, daf wir in »(_X, 0) . Ox« »Q«
und »x« getrennt erwáhnen miissen.
Beide stehen unabhángig in
...
damit auch schon alle Gegenstánde
...
en el hecho de que en «(X, Q() . qx»
debemos mencionar «Qp y  «%»
...
5.5262 Es verándert ja die Wahr- oder
Falschheit jedes  Satzes  etwas. am
allgemeinen Bau. der Welt. Und der
Spielraum, welcher ihrem Bau durch die
Gesamtheit der Elementarsátze gelassen
wird, ist eben derjenige, welchen die ganz
allgemeinen Sátze begrenzen.

(Wenn ein Elementarsatz wahr ist, so ist
damit doch jedenfalls Ein Elementarsatz
mehr wahr.)

5.53 Gleichheit des Gegenstandes drúcke
ich durch Gleichheit des Zeichens aus,
und nicht mit Hilfe eines
Gleichheitszeichens. Verschiedenheit der
Gegenstánde durch Verschiedenheit der
Zeichen.

5.5301 Das die Identitát keine Relation
zwischen Gegenstánden ist, leuchtet ein.
Dies wird sehr klar, wenn man z. B. den
Satz »(x): fx . e . x=a« betrachtet. Was
dieser Satz sagt, ist einfach, dal3 nur a der
Funktion f genilgt, und nicht, daf nur
solche Dinge der Funktion f geniigen,
welche eine gewisse Beziehung zu a
haben.

Man kónnte nun freilich sagen, dali eben
nur a diese Beziehung zu a habe, aber um
dies auszudriicken, brauchten wir das
Gleichheitszeichen selber.

5.5302 Russells Definition von  »-«
genúgt nicht; weil man nach ihr nicht
sagen kann, daf zwei Gegenstánde alle
Eigenschaften gemeinsam haben. (Selbst
wenn dieser Satz nie richtig ist, hat er
doch Sinn.)

5.5303 Beiláufig gesprochen: Von zwei
Dingen zu sagen, sie seien identisch, ist
ein Unsinn, und von Finem. zu sagen, es
...
a=b«, sondern »f(a, a)« (oder »f(b, bi).
Und nicht »f(a, b). —a=b«, sondern »(a,
bx.
...
las proposiciones elementales es exacta-
mente aquel que delimitan las
...
simplemente que sólo a satisface la fun-
ción f, y no que sólo aquellas cosas que
...
5.531 Yo no escribo, pues, «fía, b) . a =
b», sino »f(a, al« (o »f(b, bko). Y no »((a,
b). —a=b«, sino »f(a, bi.

5.532 Und analog: Nicht »(_x, y) . AX, y) ,
Ax, y)« sondern »( . Xx). Ax, x)< und
nicht »(_x, y) . Ax, y) . - x=y«, sondern »(

Xx, y) AX, y

/ 108 /

(Also statt des Russell"schen »(_x, y) . Ax,
YI QA Y) AR Y) Vo. (AX, xI«.)

5.5321 Statt »(x) : fx e x=a« schreiben
wir also z. B.»(x).fx.e8e.fa- (Xx, y) . fx

. fy)«. Und der Satz »nur Ein x befriedigt
fO«lauteti(x).fx:-(x,y).fx.fy«.

5.533 Das Gleichheitszeichen ist also

kein  wesentlicher  Bestandteil der
Begriffsschrift.
5.534 Und nun sehen wir, dal

Scheinsátze wie: »a=a«, a=b . b=c . e a=cC
« MAX) . X=x« (Xx) . x=a«, etc. sich in
einer richtigen Begriffsschrift gar nicht
hinschreiben lassen.

5.535 Damit erledigen sich auch alle
Probleme, die an solche Scheinsátze
geknúpft waren.
...
soll, wúrde sich in der Sprache dadurch

ausdricken, daf es unendlich viele
Namen mit verschiedener Bedeutung
gábe.

5.5351 Es gibt gewisse Fálle, wo man in
Versuchung gerát, Ausdrúcke von der
Form »a = a« oder » p e p « u. del. zu
benútzen. Und zwar geschieht dies, wenn
man von dem Urbild: Satz, Ding, etc.
reden móchte. So hat Russell in den
»Principles of Mathematics« den Unsinn
»p 1st ein Satz« in Symbolen durch » p e
p «wiedergegeben und als Hypothese vor
gewisse Sátze gestellt, damit deren

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

A.rgumentstellen nur von Sátzen besetzt
werden kónnten.

/ 109 /

5.532 Y análogamente: no »(_x, y) . Ax, y)
, KR, y)a sino (Xx). AX, XI y no »(_.x,
Y) AR, Y) . - X=y«, SinO »(X, Y) . AX, y)

(Y así en lugar del russelliano »(_x, y) .
AR YAA CA Y) AY) VO (AA
x)«.)

5.5321 En lugar de «(x) : fx e x=a»
escribimos, pues, por ejemplo, «(_x) . fx .
e .fa- (x, y) . fx . fy).« Y la proposición
«sólo una x satisface f ( )», se lee: «(_x) .
fx :-(x, y).fx. fy».
...
Hypothese p e p vor einen Satz zu stellen,
um ihm Argumente der richtigen Form zu
sichern, weil die Hypothese fir einen
Nicht-Satz als Argument nicht falsch,
sonBern unsinnig wird, und well der Satz
...
die zu diesem Zweck angehángte sinnlose
Hypothese.)

5.5352 Ebenso wollte man »Es gibt keine
Dinge« ausdriicken durch » -(_X) . x=x«.
Aber selbst wenn dies ein Satz wáre, -
wáre er nicht auch wahr, wenn es zwar
»Dinge gábe«, aber diese nicht mit sich
selbst identisch wáren?
...
kónne ein Satz in einem anderen auch
auf andere Weise vorkommen.

Besonders in gewissen Satzformen der
Psychologie, wie »A glaubt, dafí p der
Fall ist«, oder »A denkt p«, etc.

Hier scheint es námlich oberfláchlich, als
stúnde der Satz p zu einem
Gegenstand A in einer Art von Relation.
(Und in der modernen Erkenntnistheorie
(Russell, Moore, etc,) sind jene Sátze
auch fal3t worden.)

5.542 Es ist aber klar, dafí »A glaubt, daf3
...
durch Zuordnung ihrer Gegenstánde.

/110/

5.5421 Dies zeigt auch, dali die Seele —
...
5.5421 Esto muestra que el alma -—el
...
oberfláchlichen Psychologie aufgefañt
wird, ein Unding ist.
Eine zusammengesetzte Seele  wáre

námlich keine Seele mehr.

5.5422 Die richtige Erklárung der Form
des Satzes »A urteilt pu muf zeigen, daf
es unmóglich ist einen Unsinn zu urteilen.
(Russells  Theorie  genúgt dieser
Bedingtung nicht.)

5.5423 Einen Komplex wahrnehmen,
heif3th wahrnehmen, daf sich seine
Bestandteile einander verhalten.

Dies erklárt wohl auch, daf3 man die Figur
auf

b

q le)
zweierlei Art als Wirfel sehen kann; und
alle áhnlichen Erscheinungen. Denn wir
sehen eben wirklich zwei verschiedene
Tatsachen.
(Sehe ich erst auf die Ecken a und nur
fliichtig auf b, so erscheint a vorne; und
umgekehrt. )

5.55 Wir mússen nun die Frage nach allen
moóglichen Formen der Elementarsátze a
priori beantworten. Der Elementarsatz
besteht aus Namen. Da wir aber die
Anzahl der Namen von verschiedener
Bedeutung nicht angeben kónnen, so
kónnen wir auch nicht die
Zusammensetzung des Elementar satzes
angeben.

5.551 Unser Grundsatz ist, daf ¡jede
Frage, die sich úberhaupt durch die Logik
entscheiden láft, sich ohne weiteres
entscheiden lassen mul.
...
beantworten zu missen, so zeigt dies, daf
wir auf grundfalscher Fáhrte sind.)

5.552 Die »Erfahrung«, die wir zum
Verstehen der Logik brauchen,- ist nicht
die, daf sich etwas so und so verhált,
sondern, daf etwas ist: aber das ist eben
keine Erfahrung.

Die Logik ist vor jeder Erfahrung —dalf
etwas so ist. Sie ist vor dem Wie, nicht
vor dem Was.

5.5521 Und wenn dies nicht so wáre, wie
kónnten wir die Logik anwenden? Man
kónnte sagen: Wenn es eine Logik gábe,
auch wenn es keine Welt gábe, wie
kónnte es dann eine Logik geben, da es
eine Welt gibt.

5.553 Russell sagte, es gábe einfache
...
5.5542 Diirfen wir denn aber iiberhaupt

so fragen? Kónnen wir eine Zeichenform aufstellgnodnía «mtrespisnearlebalkhoétwas entsprechen kónne?

Hat die Frage einen Sinn: Was mul sein,
...
5.555 Es 1st klar, wir haben vom
...
Und wie wáre es auch móglich, daf3 ich es
in der Logik mit Formen zu tun hátte, die
ich erfinden kann; sondern mit dem mul
ich es zu tun haben, was es mir móglich
macht, sie zu erfinden.

5.556 Eine Hierarchie der Formen der
Elementarsátze kann es nicht geben. Nur
was wir selbst konstruieren, kónnen wir
voraussehen.

5.5561 Die empirische Realitát ist
begrenzt durch die Gesamtheit der
Gegenstánde. Die Grenze zeigt sich
wieder in der  Gesamtheit der
Elementarsátze.

Die Hierarchien sind und  miissen
unabhángig von der Realitát sein.

5.5562 Wissen wir aus rein logischen
Griinden, dalfí es Elementarsátze geben
mul, dann muf es jeder wissen, der die
Sátze in ihrer unanalysierten Form
versteht.

5.5563 Alle Sátze unserer
Umgangssprache sind tatsáchlich, so wie
...
nuestro lenguaje corriente están
...
Aber die Logik muf sich mit ihrer
Anwendung beriihren.

Also  dúrfen die Logik und  ihre
Anwendung einander nicht úbergreifen.

5.5571 Wenn ich die Elementarsátze
nicht a priori atlgeben kann, dann muf es

zu offenbarem Unsinn fúhren, sie
angeben zu wollen.
5.6 Die  Grenzen meiner Sprache

bedeuten die Grenzen meiner Welt.

5.61 Die Logik erfiillt die Dielt; die
Grenzen der Welt sind auch ihre Grenzen.
Wir kónnen also in der Logik nicht sagen:
Das und das gibt es in der Welt, jenes
nicht.

Das wiirde námlich scheinbar
voraussetzen, dal wir gewisse
Moglichkeiten ausschliefen, und dies
kann nicht der Fall sein, da sonst die
Logik úber die Grenzen der Welt hinaus
múfte: wenn sie námlich diese Grenzen
auch von der anderen Seite betrachten
kónnte.

Was wir nicht denken kónnen, das
kónnen wir nicht denken; wir kónnen also
auch nicht sagen, was wir nicht denken
kónnen.

5.62 Diese Bemerkung gibt den Schlússel
zur Entscheidung der Frage, inwieweit
der Solipsismus eine Wahrhett ist.

Was der Solipsismus námlich meint, ist
ganz richtig, nur láft es sich nicht sagen,
sondern es zeigt sich.

Daf die Welt meine Welt ist, das zeigt
sich darin, daf die Grenzen der Sprache
...
so wáre darin auch ¡ber meinen Leib zu
berichten und zu sagen, welche Glieder
meinem Willen unterstehen und welche
nicht etc., dies ist námlich eine Methode,
das Subjekt zu isolieren, oder vielmehr zu
zeigen, daf es in einem wichtigen Sinne
kein Subjekt gibt: Von ihm allein námlich
kónnte in diesem Buche nicht die Rede
sein.

5.632 Das Subjekt gehórt nicht zur Welt,
sondern es

5.633 Wo in der Welt ist ein
metaphysisches Subjekt zu merken?

Du sagst, es verhált sich hier ganz, wie
mit Auge und Gesichtsfeld. Aber das
Auge siehst du wirklich nicht.

Und nichts am Gesichtsfeld láft darauf
schliessen, daf es von einem Auge
gesehen wird.

5.6331 Das Gesichtsfeld hat námlich
nicht etwa eine solche Form:

5.634 Das hángt damit zusammen, daf
kein Teil un serer Erfahrung auch a priori
1St.

Alles, was wir sehen, kónnte auch anders
sein.

Alles, was wir iiberhaupt beschreiben
kónnen, kónnte auch anders sein.

Es gibt keine Ordnung der Dinge a priori.

5.64 Hier sieht man, daf3 der Solipsismus,
streng durchgefiihrt, mit dem  reinen
Realismus zusammenfállt. Das Ich des
Solipsismus schrumpft zum

ausdehnungslosen Punkt zusammen, und
es bleibt die ¡hm koordinierte Realitát.
...
Wahrheitsfunktion ist: [-p, -E N(-8)].
Dies ¡ist die allgemeine Form des Satzes.

6.001 Dies sagt nichts anderes, als daf3
jeder Satz ein Resultat der successiven
Anwendung der Operation N” (-£) auf die
Elementarsátze ist.
...
Q”(-n) ist also: [-E,NGE)J” MG L-ENC
sl).

Das ist die allgemeinste Form des
Uberganges von einem Satz zum anderen.
...
also die Reihe x, Q?x,Q*Q”x, 0 Q* Q?

>
Also schreibe ich statt »[ x, E, Q” ¿]«: »[
Q*x,Q"x, Q0 x]«.
...
(E) a las proposiciones elementales.
...
escribimos también la serie x, Q? x, Q *
PMA MO
así: 00 x, q Xx, Qotit, x, QotitIa,
> A

Yo escribo, pues, en lugar de »[ x, É,
O El« »[ Q*x, Q”x, QU x]a.
...
Mathematik ganz iberfússig.

Dies hángt damit zusammen, dal die
Allgemeinheit, welche wir in der
Mathematik brauchen, nicht die zufállige
1St.

6.1 Die Sátze der Logik sind Tautologien.

6.11 Die Sátze der Logik sagen also
Nichts. (Sie sind die analytischen Sátze.)

6.111 Theorien, die einen Satz der Logik
gehaltvoll erscheinen lassen, sind immer
falsch. Man kónnte z. B. glauben, dafí die
Worte »wahr« und  »falschk zwei
Eigenschaften unter anderen  Eigen-
schaften bezeichnen, und da erschiene es
als eine merkwúrdige Tatsache, daf jeder
Satz eine dieser Eigenschaften besitzt.
Das scheint nun nichts wewiger als
selbstverstándlich zu sein, ebensowenig
selbstverstándlich, wie etwa der Satz,

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

»alle Rosen sind entweder gelb oder rot«
klánge, auch wenn er wahr wáre. Ja, jener
Satz bekommt nun
...
ist das sichere Anzeichen dafiir, daf er

falsch aufgefaf3t wurde.
6.112 Die  richtige Erklárung der
logischen  Sátze  muf  ihnen eine

einzigartige Stellung unter allen Sátzen
geben.

6.113 Es ist das besondere Merkmal der
logischen Sátze, dafí man am Symbol
allein erkennen kann, daf sie wahr sind,
und diese Tatsache schlieft die ganze
Philosophie der Logik in sich. Und so ist
es auch eine der wichtigsten Tatsachen,
dal3 sich die Wahrheit oder Falschheit der
nichtlogischen Sátze nicht am Satz allein
erkennen láft.

6.12 Dal die Sátze der Logik Tautologien
sind, das zeigt die formalen —logischen-
Eigenschaften der Sprache, der Welt.

Dafi ihre Bestandteile so verknipft eine
Tautologie ergeben, das charakterisiert
die Logik ihrer Bestandteile.

Damit Sátze, auf bestimmte Art und
Weise  verkniipft, eine  Tautologie
ergeben, dazu mússen sie bestimmte
Eigenschaften der Struktur haben. Daf sie
so verbunden eine Tautologie ergeben,
zelgt also, dai sie diese Eigenschaften der
Struktur besitzen.

6.1201 Daf z. B. die Sátze »p« und » - p«
in der Verbindung » “(p . - pK eine
Tautologie  ergeben, Zzeigt, daf sie
einander widersprechen. Dal die Sátze »p
e q«, »p« und »q« in der Form »(p e q).

(p): e : (q)« miteinander verbunden
eine Tautologie ergeben, zeigt, daf q aus
p und p e q folgt. Dal »(x) , fx: e : fax

122]

eine Tautologie ist, dafí fa aus (x) . fx
folgt. etc. etc.
...
propiedades de estructura.
6.1201 Que, por ejemplo, las

proposiciones «p» y « - p» en la unión « -
(p . - p)» den una tautología, indica que se
contradicen entre si. Que las
proposiciones «p e q», « p» y «q» unidas
entre sí en la forma «(p e q) . (p) : e : (9)»,
den una tautología, indica que q procede
dep y pe q. Que « (x) . fx : e : fa» sea
una tautología indica que fa se sigue de
(x) . fx, etc., etc.

/123 /

6.1202 Es ist klar, daf man zu demselben
Zweck statt der Tautologien auch die
Kontradiktionen verwenden kónnte.

6.1203 Um eine Tautologie als solche zu
erkennen, kann man sich, in den Fállen,
...
etc. »WpFx«, »WqF«, »WrFx« etc. Die
Wahrheitskombination driicke ich durch
Klammern aus. Z. B.:
...
Dies Zeichen wúrde also z. B. den Satz p
e q darstellen. Nun will ich z. B. den Satz
- (p. - p) (Gesetz des Widerspruchs)
daraufhin “untersuchen, ob er eine
Tautologie ist. Die Form » — ¿x« wird in
unserer Notation
...
Setzen wir statt »g« »p« ein und
untersuchen die  Verbindung der
áufersten W und F mit den innersten, so
ergibt sich, daf die Wahrheit des ganzen

Satzes allen  Wahrheitskombinationen
seines Argumentes, seine  Falschheit
keiner der  Wahrheitskombinationen

zugeordnet ist.

6.121 Die Sátze der Lógik demonstrieren
die logischen Eigenschaften der Sátze,
indem sie sie zu nichtssagenden Sátzen
verbinden.

Diese Methode kónnte man auch eine
Nullmethode nennen. Im logischen Satz
werden Sátze miteinander ins
Gleichgewicht gebracht und der Zustand
des Gleichgewichts zeigt dann an, wie
diese Sátze logisch beschaffen sein
mússen.
...
6.122 Daraus ergibt sich, daf wir auch
ohne die logischen Sátze auskommen
kónnen, da wir ja in einer entsprechenden
Notation die formalen Eigenschaften der
Sátze durch das blofe Ansehen dieser
Sátze erkennen kónnen.

6.1221 Ergeben z. B. zwei Sátze »p« und
»g« in der Verbindung »p € q« eine
Tautologie, so ist klar, dafi q aus p folgt.
Daf z. B. »gx« aus »p e q . p< folgt,
ersehen wir aus diesen beiden Sátzen
selbst, aber wir kónnen es auch so zeigen,
indem wir sie ZU »p:€q.P:€:q«
verbinden und nun zeigen, daf3 dies eine
Tautologie ist.

6.1222 Dies wirft ein Licht auf die Frage,
warum die logischen Sátze nicht durch
die Erfahrung bestátigt werden kónnen,
ebenso wenig, wie sie durch die
Erfahrung widerlegt werden kónnen.
Nicht nur muf ein Satz der Logik durch
keine mógliche Erfahrung  widerlegt
werden kónnen, sondern er darf auch
nicht durch eine solche bestátigt werden
kónnen.

6.1223 Nun wird klar, warum man oft
fiihlte, als  wáren die  »logischen
Wahrheiten« von uns zu »fordern«: Wir
kónnen sie námlich insofern fordern, wir
eine genúgende Notation fordern kónnen.

6.1224 Es wird jetzt auch klar, warum die
Logik die Lehre von den Formen und
vom Schliefen gennant wurde.

6.123 Es ist klar: Die logischen Gesetze
diirfen nicht selbst wieder logischen
Gesetzen unterstehen.

(Es gibt nicht, wie Russell meinte, fúr
jede »Type«  eigenes  Gesetz des
Widerspruches, sondern Eines geniigt, da
...
propiedades formales de las
proposiciones por una simple inspección.

6.1221 Si, por ejemplo, dos
proposiciones, «p» y «q», dan una
tautología en la conexión «peq», entonces
es claro que q se sigue de p.

Que, por ejemplo, »g« se siga de «p €
...
6.1231 Das Anzeichen des logischen
Satzes ist nicht die Allgemeingúltigkeit.

Allgemein sein,  heift ja nur:
Zufálligerwiese fúr alle Dinge gelten. Ein
unverallgemeinerter  Satz kann ja

ebensowohl tautologisch sein als ein
verallgemeinerter.

6.1232 Die logische Allgemeingúltigkeit
kónnte mán wesentlich nennen, im
Gegensatz zu jener zufáligen, etwa des
Satzes »alle Menschen sind sterblich«.
Sátze, wie  Russells  »4Axiom of
reducibility« sind nicht logische Sátze,
und dies erklárt unser Gefúhl: Daf sie,
wenn wahr, so doch nur durch einen
gúnstigen Zufall wahr sein kónnten.

6.1233 Es láfit sich eine Welt denken, in
der das Axiom of reducibility nicht gilt.
Es ist aber klar, daf3 die Logik nichts mit
der Frage zu schaffen hat, ob unesere
Welt wirklich so ist oder nicht.

6.124 Die logischen Sátze beschreiben
das Geriúst der Welt, oder vielmehr, sie
stellen es dar. Sie »handeln« von nichts.
Sie setzen voraus, dalí Namen Bedeutung,
und Elementarsátze Sinn haben: Und dies
ist ihre Verbindung mit der Welt. Es ist
klar, dafí es etwas úber die Welt anzeigen
muf, daf gewisse Verbindungen von
...
wir gebrauchen, wáre willkúrlich, man-
ches nicht. In der Logik driickt nur dieses
aus: Das heif3t aber, in der Logik drúcken
...
sind bereits alle Sátze der Logik gegeben.
...
lenguaje de signos cualquiera, entonces
todas las proposiciones de la lógica están
ya dadas.

www.philosophia.cl / Escuela de Filosofía Universidad ARCIS.

6.125 Es ist móglich, und zwar auch nach
der alten Auffassung der Logik, von
vornherein eine  Beschreibung aller
»wahren« logischen Sátze zu geben.

6.1126 Darum kann es in der Logik auch
nie Uberraschungen geben.

6.126 Ob ein Satz der Logik angehórt,
...
kiimmern, bilden wir den logischen Satz
aus anderen nach blofien Zeichenregeln.
Der Beweis der logischen Sátze besteht
darin, dal wir sie aus anderen logischen
Sátzen durch successive Anwendung
...
Natúrlich ist diese Art zu zeigen, dali ihre
Sátze  Tautologien sind, der Logik
durchaus unwesentlich. Schon darum,
weil die Sátze, von welchen der Beweis
ausgeht, ja ohne Beweis zeigen miissen,
dal3 sie Tautologien sind.

6.1261 In der Logik sind Prozef und
Resultat  áquivalent.  (Darum keine
Uberraschung.)
...
einen Satz ausdricken.)

6.1265 Immer kann man die Logik so
auffassen, daf jeder Satz sein eigener
Beweis ist.

6.127 Alle Sátze der Logik sind
eleichberechtigt, es gibt unter ihnen nicht
wesentlich Grundgesetze und abgeleitete
Sátze.

Jede Tautologie zeigt selbst, daf sie eine
Tautologie ist.

6.1271 Es ist klar, daf die Anzahl der
»logischen Grundgesetzex« willkiirlich ist,
denn man kónnte die Logik ja aus Einem
Grundgesetz ableiten, indem man einfach
z. B. aus Freges Grundgesetzen das
logische Produkt bildet. (Frege wúrde
vielleicht sagen, daf dieses Grundgesetz
nun nicht mehr unmittelbar einleuchte.
Aber es ist merkwúrdig, daf ein so
...
Die  Sátze der  Mathematik sind

Gleichungen, also Scheinsátze.

6.21 Der Satz der Mathematik driickt
keinen Gedanken aus.

6.211 Im Leben ist es ja nie der
mathematische Satz, den wir brauchen,
sondern wir beniitzeir den
mathematischen Satz nur, um aus Sátzen,
welche nicht der Mathematik angehóren,

auf andere zu  schliefen,  welche
eleichfalls nicht der  Mathematik
angehóren.

(In der Philosophie fihrt die Frage »wozu
gebrauchen wir eigentlich jenes Wort,
jenen Satza« immer wieder zu wertvollen
Einsichten.)

6.22 Die Logik der Welt, die die Sátze
der Logik in den Tautologien zeigen,
zeigt die Mathematik in den Gleichungen.

6.23 Wenn zwei Ausdricke durch das
Gleichheitszeichen verbunden werden, so
heif3t das, sie sind durch einander
ersetzbar. Ob dies aber der Fall ist, mul
sich an den beiden Ausdricken selbst
zelgen.

Es charakterisiert die logische Form
zwelier Ausdriicke, daf3 sie durch einander
ersetzbar sind.

6.231 Es ist eine HEigenschaft der
Bejahung, dal man sie als doppelte
Verneinung auffassen kann.

Es ist eine Eigenschaft von » 1+1+1+1<«,
daf3 man es als »(1+1)+(1 + 1)« auffassen
kann.

6.232 Frege sagt, die beiden Ausdriicke
...
aber, daf sie nicht notwendig ist, um zu
zeigen, dal3 die beiden Ausdriicke, die das
Gleichheitszeichen verbindet, dieselbe
Bedeutung haben, da sich dies aus den
beiden Ausdriicken selbst ersehen láñt.

6.2321 Und, daf die Sátze der
Mathematik bewiesen werden kónnen,
heif3t ja nichts anderes, als dafí ihre
Richtigkeit einzusehen ist, ohne daf das,
was sie ausdricken, selbst mit den
Tatsachen auf seine Richtigkeit hin
verglichen werden mul.

6.2322 Die Identitát der Bedeutung
zweier Ausdricke  láft sich nicht
behaupten. Denn um etwas von ihrer
Bedeutung behaupten zu kónnen, muf ich
ihre Bedeutung kennen: undindem ich
ihre Bedeutung kenne, weif3 ich, ob sie
dasselbe oder verschiedenes bedeuten.

6.2323 Die Gleichung kennzeichnet nur
den Standpunkt, von welchem ich die
beiden Ausdriicke betrachte, námlich vom
Standpunkte ihrer Bedeutungsgleichheit.

6.233 Die Frage, ob man zur Lósung der

mathematischen Probleme die
Anschauung  brauche,  muf dahin
beantwortet werden, daf  eben die

Sprache hier die nótige Anschauung
liefert.
...
6.2341 Das Wesentliche der
mathematischen Methode ist es, mit
Gleichungen zu arbeiten. Auf dieser
Methode beruht es námlich, dal ¡jeder

/132 /

Satz der Mathematik sich von selbst
verstehen mulf.
...
silo conozco, entonces sé sí significan la
...
matemático consiste en trabajar
...
Gleichungen driicken die Ersetzbarkeit
zweier Ausdrúcke aus, und wir schreiten
von einer Anzahl von Gleichungen zu
neuen Gleichungen vor, indem wir, den
Gleichungen entsprechend, Ausdriicke
durch andere ersetzen.

6.241 So lautet der Beweis des Satzes 2 X
2=4:
(QN* x=Q**" x Def.
o? x=( Q>> x=<0yub x=0> Q2 x=Q54b ol»
x(Q' 0) (0 0yx=0 0001051»
x=0*x.

6.3 Die Erforschung der Logik bedeutet
die Erforschung aller Gesetzmáfbigkeit.
Und auñerhalb der Logik ist alles Zufall.
...
6.32 Das Kausalitátsgesetz ist kein
Gesetz, sondern die Form eines Gesetzes.

6.321 »Kausalitátsgesetz«, das ist ein
Gattungsname. Und wie es in der
Mechanik, sagen wir, Minimum-Gesetze
gibt, -etwa der kleinsten Wirkung- so gibt
es in der Physik Kausalitátsgesetze,
Gesetze von der Kausalitátsform.

6.3211 Man hat ja auch davon eine
Ahnung gehabt, dafí es ein »Gesetz der
kleinsten Wirkung« geben miisse, ehe
man genau wulite, wie es lautete. (Hier,
...
X 2=4€s la siguiente:
(0 x=0** x Def.
oq x=( Q02y xQ) x=0> 02 x=Q56-> Qro
x<(0' 0) (0 0yx=0 00010505»
x=0*x.
...
priori die Móglichkeit einer logischen
Form.

6.34 Alle jene Sátze, wie der Satz vom
Grunde, von der Kontinuitát in der Natur,
vom kleinsten Aufwande in der Natur etc.
etc., alle diese sind Einsichten a priori
úber die mógliche Formgebung der Sátze
der Wissenschaft.

6.341 Die Newtonsche Mechanik z. B.
bringt die Weltbeschreibung auf eine
einheitliche Form. Denken wir uns eine
weife Fláche, auf der unregelmáfige
schwarze Flecken Uráren. Wir sagen nun:
Was fiir ein Bild immer hierdurch
entsteht, immer kann ich  seiner
Beschreibung beliebig nahe kommen,
indem ich die Fláche mit einem
entsprechend  feinen  quadratischen
Netzwerk bedecke und nun von jedem
Quadrat sage, dalfí es weil3 oder schwarz
ist. Ich werde auf diese Weise die
Beschreibung der Fláche auf eine
einheitliche Form gebracht haben. Diese
Form ist beliebig, denn. ich hátte mit dem
gleichen Erfolge ein Netz aus dreieckigen
oder sechseckigen Maschen verwenden

kónnen. Es kann sein, daf die
Beschreibong mit Hilfe eines
Dreiecks-Netzes  einfacher  geworden

wáre; das heift, daf wir die Fláche mit
einem gróberen Dreiecks-Netz genauer
beschreiben kónnten als mit einem
feineren quadratischen (oder umgekehrt)
usw Den  verschiedenen  Netzen
entsprechen verschiedene Systeme der
Weltbeschreibung. Die Mechanik
bestimmt eine Form der
Weltbeschreibung, indem sie sagt: Alle
Sátze der Weltbeschreibung miissen aus
einer Anzahl gegebener Sátze —den
...
Bau des wissenschaftlichen Gebáudes
und sagt:

/135 /

6.33 Nosotros no creemos a priori en una
...
ejemplo, reduce la descripción del
...
proposiciones de la descripción del mun-
do deben obtenerse de un modo dado por
...
Welches Gebáude immer du auffiihren
willst, jedes muft du irgendwie mit
diesen und nur diesen  Bausteinen
zusammenbringen.

(Wie man mit dem Zahlensystem jede
beliebige Anzahl, so muf man mit dem
System der Mechanik jeden beliebigen
Satz der Physik hinschreiben kónnen.)

6.342 Und nun sehen wir die gegenseitige
Stellung von Logik und Mechanik. (Man
kónnte das Netz auch aus
verschiedenartigen Figuren etwa aus
Dreiekken und Sechsecken  bestehen
lassen.) Dafi sich ein Bild, wie das vorhin
erwáhnte, durch ein Netz von gegebener
Form beschreiben láft, sagt ber das Bild
nichts aus. (Denn dies gilt fiir jedes Bild
dieser Art.) Das aber charakterisiert das
Bild, daf' es sich durch ein bestimmtes
Netz von bestimmter Feinheit vollstándig
beschreiben láñt.

So auch sagt es nichts úúber die Welt aus,
dafí sie sich durch die Newtonsche
Mechanik beschreiben láft; wohl aber,
dal3 sie sich so durch jene beschreiben
láf3t, wie dies eben der Fall ist. Auch das
sagt etwas ¡ber die Welt, dafí sie sich
durch die eime. Mechanik einfacher
beschreiben láft als durch die andere.

6.343 Die Mechanik ist ein Versuch, alle
wahren Sátze, die wir zur
Weltbeschreibung brauchen, nach Einem
Plane zu konstruieren.

6.3431 Durch den ganzen logischen

Apparat — hindurch  sprechen die
physikalischen Gesetze doch von den
Gegenstánden der Welt.

6.3432 Wir diirfen nicht vergessen, daf
die  Weltbeschreibung durch die
...
proposiciones verdaderas que se
...
selbstverstándlich die Geometrie gar
nichts úber ihre tatsáchliche Form und
Lage sagen. Das Netz aber ist rein
geometrisch, alle seine Eigenschaften
kónnen a priori angegeben werden.
Gesetze, wie der Satz vom Grunde, etc.,
handeln vom Netz, nicht von dem,
was das Netz beschreibt.

6.36 Wenn es ein Kausalitátsgesetz gábe,
so kónnte es lauten: »Es gibt
Naturgesetze«. Aber freilich kann man
das nicht sagen: es zeigt sich.

6.361 In der Ausdrucksweise Hertz's
kónnte man sagen: Nur gesetzmáfige
Zusammenhánge sind denkbar.

6.3611 Wir kónnen keinen Vorgang mit
...
gebracht werden kónnen, ohne aus
diesem Raum
==.” 0 X--X O 3-E

herausbewegt zu werden. Rechte und
linke Hand sind tatsáchlich vollkommen
kongruent. Und daf man sie nicht zur
Deckung bringen kann, hat damit nichts
zu tun.

Den rechten Handschuh kónnte man an
die linke Hand ziehen, wenn man ihn im
vierdimensionalen  Ráum  umdrehen
kónnte.

6.362 Was sich beschreiben láft, das
kann auch geschehen, und was das
Kausalitátsgesetz ausschliessen soll, das
láft sich auch nicht beschreiben.

6.363 Der Vorgang der Induktion besteht
darin, daf3 wir das einfachste Gesetz
...
Es ist klar, dafí kein Grund vorhanden ist,
zu glauben, es werde nun auch wirklich
der einfachste Fall eintreten.

6.36311 Dafí die Sonne morgen aufgehen
wird, ist eine Hypothese; und das heift:
wir wissen nicht, ob sie aufgehen wird.

6.37 Einen Zwang, nach dem Eines
geschehen mite, weil etwas anderes
...
vuelta en un espacio cuatridimensional.
...
Weltanschauung liegt die Táuschung
zugrunde,  daf die sogenannten

Naturgesetze die  Erklárungen der
Naturerscheinungen seien.

6.372 So  bleiben sie bei den

Naturgesetzen als bei etwas
Unantastbarem stehen, wie die álteren bei
...
Abschlug anerkennen, wáhrend es bei
dem neuen System scheinen soll, als sei
alles erklárt.

6.373 Die Welt ist unabhángig von
meinem Willen.

6.374 Auch wenn alles, was wir
winschen, gescháhe, so wáre dies doch
nur, sozusagen, cine  Gnade des
Schicksals, denn es ist kein logischer
Zusammenhang zwischen Willen und
Welt, der dies verbiirgte, und den
angenommenen physikalischen
Zusammenhang kónnten wir doch nicht
selbst wieder wollen.

6.375 Wie es nur eine  logische
Notwendigkeit gibt, so gibt es auch nur
eine logische Unmóglichkeit.

6.3751 Daf z.B. zwei Farben zugleich an
einem Ort des Gesichtsfeldes sind, ist
unmóglich und zwar logisch unmóglich,
denn es ist durch die logische Struktur der
Fárbe ausgeschlossen.

Denken wir daran, wie sich d in der
Physik Teilchen nicht digkeiten haben zu
gleicher Zeit zwei Geschwindigkeiten
haben kann; das heift, daf es nicht zu
eleicher Zeit an zwei Orten sein kann; das
heifith daf Teilchen an verschiedenen
...
(Es ist klar, dafí das logische Produkt
zweier  Elementarsátze  weder eine
Tautologie noch eine Kontradiktion sein
kann. Die Aussage, daf ein Punkt des
Gesichtsfeldes zu gleicher Zeit zwei
verschiedene  Farben hat, ist eine
Kontradiktion.)

6.4 Alle Sátze sind gleichwertig.

6.41 Der Sinn der Welt muf aufñerhalb
...
gábe, so hátte er keinen Wert: Wenn es
einen Wert gibt, der Wert hat, so muf er
auñerhalb alles Geschehens und So-Seins
liegen. Denn alles Geschehen und
So-Sein ist zufállig.

Was es nicht-zufállig macht, kann nicht in
der Welt liegen; denn sonst wáre dies
wieder zufállig.

Es mul auferhalb der Welt liegen.

6.42 Darum kann es auch keine Sátze der
Ethik geben. Sátze kónnen nichts Hóheres
ausdrúcken.

6.421 Es ist klar, dafí sich die Ethik nicht
aussprechen láBt.

Die Ethik ¡st transcendental.
...
klar, daf die Ethik nichts mit Strafe und
Lohn im gewóhnlichen Sinne zu tun hat.
...
Also muf diese Frage nach den Folgen
einer Handlung belanglos sein. —Zum
Mindesten diirfen diese Folgen nicht
Ereignisse sein. Denn etwas muf doch an
jener. Fragestellung richtig sein. Es mul
zwar eine A.rt von ethischem Lohn und
ethischer Strafe geben, aber diese mússen
in der Handlung selbst liegen.

(Und das ist auch klar, dafí der Lohn
etwas Angenehmes, die Strafe etwas
Unangenehmes sein mu.)

6.423 Vom Willen als dem Tráger des
Ethischen kann nichtgesprochen werden.
Und der Wille als Phánomen interessiert
nur die Psychologie.

6.43 Wenn das gute oder bóse Wollen die
Welt ándert, so kann es nur die Grenzen
der Welt ándern, nicht die Tatsachen;
nicht dass was durch die Sprache
ausgedrickt werden kann.

Kurz, die Welt muf dann dadurch
úberhaupt eine andere werden. Sie mu
sozusagen als Ganzes abnehmen oder
zunehmen.

Die Welt des Gliúcklichen ist eine andere
als die des Unglúcklichen.

6.4311 Wie auch beim Tod die Welt sich
nicht ándert, sondern aufhórt.
...
Así, pues, la cuestión acerca de las
consecuencias de una acción debe ser
irrelevante. Al menos, estas
consecuencias, no pueden ser
...
Seele des Menschen, das heift also ihr
ewiges Fortleben nach dem Tode, ist
nicht nur auf keine Weise verbúrgt,
sondern vor allem leistet diese Annahme
gar nicht das, was man immer mit ihr
erreichen denn dadurch ein Rátsel gelóst,
dal ich ewig fortlebe? Ist denn dieses
ewige Leben dann nicht ebenso rátselhaft
wie das gegenwártige? Die Lósung des
Rátsels des Lebens in Raum und Zeit liegt
aufserhalb von Raum und Zeit.

(Nicht Probleme der Naturwissenschaft
sind ja zu lósen.)

6.432 Wie die Welt ist, ist fiir das Hóhere
vollkommen gleichgúltig. Gott offenbart
sich nicht in der Welt.

6.4321 Die Tatsachen gehóren alle nur
zur Aufgabe, nicht zur Lósung.

6.44 Nicht wie die Welt ist, ist das
Mystische, sondern daf sie ist.

6.45 Die Anschauung der Welt sub specie
aeterni ist ihre Anschauung als
begrenztes- Ganzes. Das Gefúhl der Welt
...
Das Rátsel gibt es nicht.
Wenn sich eine Frage úberhaupt stellen

láft, so kann sie auch beantwortet
werden.

6.51 Skeptizismus 1st nicht
unwiderleglich, sondern offenbar
...
¿ho es tan enigmática como la presente?
...
6.52 Wir fiihlen, das selbst, wenn alle
móoglichen  wissenschaftlichen Fragen
beantwortet sind, unsere Lebensprobleme
noch gar nicht berihrt sind. Freilich bleibt
dann eben keine Frage mehr; und eben
dies ist die Antwort.

6.521 Die Lósung des Problems des
...
6.522 Es glbt allerdings
Unaussprechliches. Dies zeigt sich, es ist
das Mystische.

6.53 Die  richtige  Methode der
Philosophie wáre eigentlich die: Nichts zu
sagen, als was sich sagen láft, also Sátze
der Naturwissenschaft —also etwas, .was
mit Philosophie nichts zu tun hat-, und
dann immer, wenn ein anderer etwas
Metaphysisches sagen  wollte, ¡hm
nachzuweisen, dafí er gewissen Zeichen
in seinen Sátzen keine  Bedeutung
gegeben hat. Diese Methode wáre fiir den
anderen unbefriedigend —er hátte nicht
das Gefúhl, daf wir ihn Philosophie
lehrten- aber sie wáre die einzig streng
richtige.

6.54 Meine Sátze erláutern dadurch, dal
sie der, welcher mich versteht, am Ende
als unsinnig erkennt, wenn er durch sie —
auf ihnen- úber sie hinausgestiegen ist.
(Er muf sozusagen die Leiter wegwerfen,
nachdem er auf ihr hinaufgestiegen ist.)
Er muf diese Sátze lúberwinden, dann
sieht er die Welt richtig.

/146 /

7 Wovon man nicht sprechen kann,
darúber muf man schweigen.
