---
source: "https://philarchive.org/rec/KARCSM"
title: "Can Social Media Be Seen as a New Public Sphere in the Context of Hannah Arendt's Public Sphere Theory?"
author: "Metehan Karakurt & Aykut Aykutalp"
year: "2020"
publication: "Londra, Birleşik Krallık: IJOPEC Publication ( 2020 )"
download: "https://philarchive.org/archive/KARCSM"
pdf: "https://philpapers.org/archive/KARCSM.pdf"
captured_at: "2026-05-27T13:27:04Z"
updated_at: "2026-05-27T13:27:04Z"
...
- 著者: Metehan Karakurt & Aykut Aykutalp
- 年: 2020
- 掲載情報: Londra, Birleşik Krallık: IJOPEC Publication ( 2020 )
- 情報源: [philarchive](https://philarchive.org/rec/KARCSM)
- ダウンロード: https://philarchive.org/archive/KARCSM
- PDF: https://philpapers.org/archive/KARCSM.pdf
...
Karakurt, Metehan & Aykutalp, Aykut (2020). Can Social Media Be Seen as a New Public Sphere in the Context of Hannah Arendt's Public Sphere Theory?. Londra, Birleşik Krallık: IJOPEC Publication.

## BibTeX

```bibtex
@book{Karakurt2020-KARCSM,
	address = {Londra, Birle\c{s}ik Krall\i{}k},
	author = {Metehan Karakurt and Aykut Aykutalp},
	editor = {},
...
Archival history: Archival date: 2020-09-30 View all versions
Categories: Hannah Arendt in 20th Century Philosophy Philosophy of Political Science in Philosophy of Social Science Social Media in Social and Political Philosophy
Keywords: Hannah Arendt   Public Sphere   Social Media
...
retrieval system, transmitted in any form or by any
...
"+
!
The Perception of Sovereignty and Dignity Among the Belligerent Groups in
Afghanistan
...
"
!
Importance of Restructuring Turkish Banking Sector before and after Global Crisis
...
Banking crises experienced in Turkey in November 2000 and February 2001, it has revealed the problems of the
Turkish banking sector. As a result of this, the Turkish banking system has entered a phase of restructuring as of May
20
...
-
2017 regarding the banking system before
...
#
!
International Trade Challenges in East Africa.

INTERNATIONAL RELATIONS / ULUSLARARASI İLİ$KİLER
...
East Africa is the
Eastern region of the African continent and is defined differently by geography. In the
United Nations Statistics Division's geographical plan, East Africa is used to referring to seven major
countries: Kenya, Uganda, Tanzania, Eritrea, Djibouti, Ethiopia,

and Somalia, The East African region
covers an area of 1.8 million km² with The present population of East Africa is 438,414,363 in 2019, based
on the latest United Nations estimations and has significant natural resources.
...
(State Pedagogy University)

İnşallah Musayev

(Yalova University, Turkey)

musayev54musayev@gmail.com

Azerbaijan

Dünya genelinde büyük tahribata sebep olan Covid
-
19 salgını ya"amı çok ciddi anlamda tehdit etmeye
devam etmektedir. Türkiye’de Covid
-
19’un çalı"ma hayatında ortaya çıkardığı olumsuz etkilere kar"ı çok
ciddi
çözümler ve önlemler alınmaya çalı"ılmı"tır. Bu çalı"madaki amaç Covid
-
19 salgınından etkilenen i"çi
ve i"verenin hukuk çerçevesinde uzaktan çalı"ma, kısa çalı"ma ve kısa çalı"ma ödeneği uygulanması, izin
...
The paper makes an analysis of the costs and benefits of the Kosovo’s political process integration into the
European Union. The focus is in the
political goal of the Kosovo
–

European Union Stabilization and
Association Agreement. Kosovo is the last state from Balkan Peninsula that signed a Stabilisation and
Association Agreement with the European Union. This is the first contractual relationship
between the
...
&
!
Interethnic Integration In Multicultural Education

PEACE & CONFLICT STUDIES

/
BARI$ VE ÇATI$MA ÇALI$MALARI

Agim Sallmani

(University in Tetova)

agim.salmani@unite.edu.mk

Macedonia

The purpose of integrated interethnic education is that pupils learn (get used to) with cooperation which
...
'
!
Resurgence of Sectarianism in Pakistan
...
Today, Pakistan is confronting the “induced resurgence of Sectarianism” heralding the revival of US Cold
War Strategy. However, this time China is the main rival
...
(
!
Push and Pull Factors of Nigerian Migration; An Empirical Analysis

PUBLIC MANAGEMENT / KAMU YÖNETİMİ
...
In todays’ changing world, scandals, fraud and inefficiencies have captured world attention through shady
dealings, poor internal control and diversion of public utilities for private
...
study aimed at identifying the facts and state of affairs at
present and proffer solution to the continuous
challenges affecting human race in Nigeria. Findings from the study reveals that country’s demographics,
climatic location, the economic performance, political instability and insecurity are continuous factors
...
!
The Effect of Social Networking Facebook on Increasing the Social capital in Society:
The study of Iranian Users Actions on Facebook

MEDIA STUDIES / MEDYA ÇALI$MALARI
...
(Sciences and Appyled University)
...
Problem is to study the actions of Iranian users on Facebook and
...
random snowball. Among the undergraduate and graduate communications courses in Allameh Tabataba’i
University and Islamic Azad University in Tehran.

Data collected through questionnaires, using SPSS
software were analyzed and

based on the final results showed that the main hypothesis was accepted.

Key words: social capital, social network, Facebook
...
-
19 pandemic changes the life’s
environment of people as well as the
learning and teaching processes. Online learning is not an emergent concept, it was used in a large scale as
an option for students to adapt to the online learning environment. In principle, this option rendered a
must
during COVID
-
...
results
of students) on the quality of education in undergraduate programs. The study follows the quantitative
...
COVID
-
19 pandemic. Also, the educational institutions, government quality assurance, regulators and
other related parties are expected to utilize the results revealed on the decisions pertaining the online
learning methods.

Key Words: Learning

during pandemic situations; Online learning; Quality of education; University
students’ education.
...
"+
!
Kant And Hugo: The Philosopher And The Poet On Deliberation
...
to Kant, when our action does not conform to the moral
law, we know very well that it is not moral. If it is in accordance with duty, but our incentive for this action
is simply not to act against the law, we are similarly conscious that it is not moral.
...
""
!
Concepts Becoming Empty and Loss of Reality
...
Bu makalede kavramların anlam bakımından bo"alması ile gerçeklik hissinin yitirilmesi arasında, terimleri
Kant dü"üncesi çerçevesinde ele alarak bağlantı kurmaya çalı"acağız. Filozoflar, hatta yanıltıcı
doğası
...
"#
!
On The Objectivity of Scientific Knowledge
...
Bilime ve bilimsel bilgiye ili"kin genel kanı
bilimin objektif bir faaliyet olduğudur. Bu dü"ünce bilimin
belirlenmesi için ortaya konulan tanımlarda da kar"ımıza çıkmaktadır. Mesela bilimi tanımlamak
istediğimizde, kısaca evrenin bir kısmını ya da tamamını sistematik bir "ekilde ele alan, deney ve gö
zlemler
...
D
avid Bloor ve Barry Barnes gibi önde gelen dü"ünürlerin argümanları ile ortaya konulmaktadır.
CUDES 2020
...
"$
!
The Effects of Toxic Leadership and Job Stress on Organizational Commitment

BUSINESS STUDIES / İ$LETME BİLİMLERİ
...
aksoyalptug@gmail.com

Turkey

Employees' performances, satisfaction levels, intentions to remain at work and their commitment are the
result of multiple interactions of many organizational elements. One of these components are leaders.
Leaders may motivate employees for organizational goals and work with higher productivity, on the
contrary, “dark” leader types may reduce job efficiency,

organizational commitment and overall satisfaction
levels of employees (İlhan,2019; Kahveci, Bahadır ve Kandemir, 2019). The aim of this study is to examine
the role of toxic leadership and work stress on the organizational commitment of employees. It is
very
...
Research Question 1:
Is there a relationship between toxic leadership and work stress organizational commitment of

employees?

Research Question 2: What are the effects of toxic leadership and work stress on employees' organizational
commitment?

The population of the research is consist of private bank employees, and the sample is the
branch employees of private banks
in Ankara and Kırıkkale. In the research, convenient sampling and
snowball sampling methods were used together. In this context, the data was collected from a total of 337
...
Baha’i faith is the most recent addition to Abrahamic and Aryan religions which was
...
of
religions, and unity of humanity, Baha’i faith has a unifying vision which is the main source of inspiration
...
"&
!
From Regional GDP to the Organisation of Regional Healthcare Services
...
dr.attila.fabian@gmail.com

Hungary

When it comes to an analysis of the COVID
-
19 pandemic, key aspects include, beside pandemic control
and upkeeping the operability of the economy, a fast restart of the
