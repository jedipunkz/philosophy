...
year: "1909"
captured_at: "2026-07-23T09:12:15Z"
updated_at: "2026-07-23T09:12:15Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ニーチェ"
query: "Nietzsche Beyond Good and Evil"
plain_text_url: "https://archive.org/download/beyondgoodevilpr1909niet/beyondgoodevilpr1909niet_djvu.txt"
public_domain: true
...
- 初版: 1909
- 情報源: [archive](https://archive.org/details/beyondgoodevilpr1909niet)
- パブリックドメイン: ✓
...
HAROLD  Ij.  Lit  l!Hi;/Ii;Y

DRibHAM   YOUr'6   UMvppspv.

Digitized  by  the  Internet  Archive
in  2011  with  funding  from
Brigham  Young  University

http://www.archive.org/details/beyondgoodevilpr1909niet
...
The  First  Qomplete  and  Authorised  English  Translation
...
Printed  at  The  Daribn  Press,  E(imt>ur«^k

BRiCi  H/'.  -  i  O  U  N 1 VERSIT Y
...
Epode:  From  Lofty  Mountains             •  -  265
...
superstition,  has  not  yet  ceased  domg  mischief) ;
...
denial  oi tho,  perspective — the  fundamental  condition
...
Wko  is  it  really  that  puts  questions  to  us  here?
W/iat  really  is  this  "Will  to  Truth"  in  us?  In
...
Granted  that  we  want  the  truth :  w/iy  not  rather
...
having  read  between  their  Hnes  long  enough,  I  now
...
PREJUDICES  OF  PHILOSOPHERS.       9  y
...
condition  of  life :  that  is  certainly  to  impugn  the  ^  iCy^'AXL
...
how  often  and  easily  they  make  mistakes  and  lose  I
...
hinted  at  in  the  remotest  manner.     They  all  pose  i

as  though  their  real  opinions  had  been  discovered
and    attained  through  the  self-evolving  of  a  cold,  i
...
their  heart's  desire  abstracted  and   refined,  is  dc-  i
...
tliat  invincible  maiden,  that  Pallas  Athene  : — how
...
PREJUDICES   OF   PHILOSOPHERS.  I  T
...
PREJUDICES   OF   PHILOSOPHERS.  I3

scene;    or,  to  put  it  in    the  words   of  an  ancient
mystery :

Adventavit  asinus^
Pidcher  et  fortissimus.
...
indifference  as  a  power — how  could  yow  live  in  accord-
...
C  which  in  the  end  always  prefers  a  handful  of
...
which  repels  them  from  modern  reah'ty,  is  unrefuted
...
therefrom.  A  Httle  more  strength,  swing,  courage,
...
V  and  foremost  proud  of  his  Table  of  Categories  ;
...
\J  really  his  answer  ?  *^  By  means  of  a  means  {{diCvAiy)''
...
Cujus  est  natura  senstis  assoupire.
...
PREJUDICES   OF   PHILOSOrHERS.  1 9
...
best  and  longest,  the  soiil-ato7nism.  Let  it  be  per-
...
quently to  the  clumsiness  of  naturalists,  vv^ho  can
...
legitimate  rights  in  science.  In  that  the  riew  psy-
...
7wt  phenomena  in  the  sense  of  the  idealistic
...
"think."  One^\x\Vs\  but  that  this  "one"  is  pre-
...
inadequate  precautions  ot  philosophers  in  all  ages.
...
liis  successful  executive  instruments,  the  useful
...
in  again  a  definite  fundamental  scheme  oi  possible
...
act  once  more  as  we  have  always  acted — inytho-
...
points, but  always  in  a  profoundly /^rj-^;^^^/  manner:
...
^' la  religion  de  la  souffrance  htcmaine" ;  that  is  its
"good  taste."
...
every  one  should  keep  away  from  it  who  ca7i  do  so  !
...
sac7'ifizio  delV  intelletto^  on  the  contrary ! — will  at
...
that  the  incarnated  Tartufifery  of  morals,  which  now
...
that  it  cannot  be  of  any  consequence  if  ;^'^  just  carry
...
of  force  !  How  personal  Ao^^  a  long  fear  make  one,
...
desire  to  be  clear  w/iat  spectacle  one  will  see  in  any
case — merely  a  satyric  play,  merely  an  epilogue
farce,  merely  the  continued  proof  that  the  long,  real
tragedy  z's  at  an  end,  supposing  that  every  philosophy
...
the  exception  1 "  And  he  would  go  down^  and
...
and  zvants  to  see  only  hunger,  sexual  instinct,  and
...
thinks  and  lives  gangas?'otogati*  among  those  only
who  think  and  live  otherwise — namely,  kurmagatif^
or  at  best "  froglike,"  inandeikagati\  (I  do  everything
...
+  Like  the  tortoise  :  lento.     %  Like  the  frog":  staccato.
...
among  the  Roman  comedy-writers — Lcssing  loved
...
allegrissimo,  perhaps  not  v/ithout  a  malicious  artistic
...
whose  sake  onQ  pardons  all  Hellenism  for  having
...
One  should  not  go  into  churches  \{  one  wishes
to  breathe  pure  air.
...
us  call  this  period  the /r^-z/^d^r^/ period  of  mankind  ;
...
something,  but  conceals  still  more?  In  short,  wc
...
every  conscious  or  unconscious  aduocatus  dei  avails
...
saying :  the  philosopher  has  at  length  a  rigJit  to
...
deceived.  Why  not  ?  pit  is  nothing  more  than  a
...
humanely — "  il  ne  cherche  le  vrai  que  pour  /aire  le
...
several  kinds  of  causality,  so  long  as  ths  attempt  to
...
in  this  is  just  our  belief  in  causality  itself — we  tmist
...
As  happened  finally  in  ail  the  enlightenment  of
...
disappeared  under  the  interpret atio7i\  so  a  noble
...
by  the  extent  to  which  it  reqiiired  truth  attenuated,
...
to  German  taste.  "  Pour  etre  bon  philosophe,''  says
this  last  great  psychologist,  ^^  il  faut  etre  sec^  clair,
sans  illusion.  Un  banquier,  qui  a  fait  fortune,  a  mie
paj'tie  du  caractere  requis  pour  f aire  des  decouvertes
en  philosophies  c'est-d-dire  pour  voir  clair  dans  ce
qui  est"
...
opinion  is  tny  opinion :  another  person  has  not
...
be  done  azvay  with.  We  opposite  ones,  however,
...
from,  and  zvhere  perhaps  it  will  then  be  driven  ?  And
as  to  the  import  of  the  dangerous  formula,  "Beyond
Good  and  Evil,"  with  which  we  at  least  avoid  con-
fusion, we  are  something  else  than  ^'-  lih^es-penseursl'
"" liber i  pensatori^'  "free-thinkers,"  and  whatever
...
solitude,  o{  ouv  own  profoundest  midnight  and  mid-
...
sort  of  history  the  problem  of  knoivledge  and  con-
science has  hitherto  had  in  the  souls  of  hommes
...
in  tolerance  which  the  imperiurn  Romanuni  gave —
this  faith  is  not  that  sincere,  austere  slave-faith  by
which  perhaps  a  Uuther  or  "a  Cromwell,' or  some
other  northern  barbarian  of  the  spirit  remained
attached  to  his  God  and  Christianity ;  it  is  muck
...
absurdissivtum^  in  the  form  of  which  "  faith  "  comes
...
— his  many  hidden  sufiferings  make  him  revolt
...
and  which  is  effect,  or  if  ^v^y  relation  at  all  of  cause
...
as  disguised  epilepsy  ?  But  nowhere  is  it  viore
...
far  as  Germ.any  is  concerned),  namely,  Richard
...
succession  of  oppositeSj  of  states  of  the  soul  regarded
...
of  Fort-Royal,  Sainte-Beuve,  in  spite  of  all  his
...
ha7'diinent  que  la  religion  est  un  prodttit  de  Phomine
normal^  que  Thojume  est  le  plus  dans  le  vrai  quand
il  est  le  plus  religieux  et  le  plus  assure  d*ime  destinee
infinie.  .  .  .  C'est  quand  il  est  bon  quHl  veut  que
la  virtu  corresponde  a  un  order  eternel^  cest  quand
il  contemple  les  choses  dune  inaniere  dcsinteressee
qu'il  trouve  la  mort  revoltayite  et  absurde.  Co7nment
ne  pas  supposer  que  cest  dans  ces  moinents~ld^  que
rhomme  voit  le  mieux P"  .  .  .  These  sentences
...
suspicion  :  such  an  enormity  of  se'f-negation  and
...
this  New  Testament  (a  kind  of  7'ococo  of  taste  in
...
revvarder."  Also  his  "  free  will  ":  he  does  not  hear
...
is  diskonouring — that  it  vulgarises  body  and  soul —
...
apart  and  outside  to  feel  even  the  necessity  for  2.  for
...
ages  may  envy  it :  and  how  much  naivete — ador-
...
mdindiging grosser  affairs,  and  for  securing  immunity
...
as  among  all  other  animals,  there  is  a  suiplus  of
...
religions  for  sufferers y  they  take  the  part  of  these
...
ration of  the  European  7'ace  ?  To  7'everse  all  esti-
...
botched  my  finest  stone  !  What  hdMQyou  presumed
...
separate  man  from  man  : — stcch  men,  with  their
...
T/ie  Sage  as  Astronome7\ — So  long  as  thou  feelest
...
his  habits :  two  men  with  tlie  same  principles
...
APOPHTHEGMS   AND    INTERLUDES.  9 1
...
105.
The  pza /rmis  is  still  more  repugnant  to  the  taste
(tke  "pietj/"')  of  the  free  spirit  (the  "pious  man  of
knowledge ")  than  the  irnpia  frmis.  Hence  the
...
133-
He  who  cannot  find  the  way  to  his  ideal,  h'ves
...
veritable  amour  dest  Vdrne  qui  enveloppe  le  corps"
...
Buona  femmina    e  mala  femmina  vuol  bastojie. —
Sacchetti,  Nov.  Z6,
...
THE   NATURAL   HISTORY  OF   MORALS.        IO5
...
all  moralists  are  practically  agreed  :  neminem  IcedCy
hnmo  omnes  quantum  potes  juva — is  really  the  pro-
...
J.06  BEYOND  GOOD  AND   EVIL.

187.
Apart  from  the  value  of  such  assertions  as  "  there
is  a  categorical  imperative  in  us,"  one  can  ahvays
...
cleverly  intercalated /"^j/,  such  as  is  also  frequently
...
langmge  as  well,  what  is  the  Platonic  Socrates,  if
not —

irpocrOi.  TLXdruiv  oTTiBev  re  IIAaTWV  iikcrar)  re  Xi/xaipa.
...
THE   NATURAL   IJISTORY   OF    MURALS.        II3
...
and  pftinful  for  the  ear  to  listen  to  anything  new  ;
...
tion, the  emotions  dominate — such  as  fear,  lov€,
...
193-
Quidquidluce  fuit^  ienebris  agit :  but  also  contrari-
...
trouble  I — how  could  the  man  with  such  dream-
...
stance, Caisar  Borgia)  are  fundamentally  misunder-
...
the  reins,  the  spiritual  and  corporeal  licentia  mormn
...
appearance  of  Napoleon  v/as  the  last  great  proof:
...
war  which  is  in  hhn  should  come  to  an  end ;
...
they  are  still  ultva-jnoral.  A  sympathetic  action,
...
126  IJEYOND   GOOD   AND    EVIL.

nothing  more  to  fear  T'  Some  time  or  other — the
...
willing to  hear  such  truths — ozir  truths.  We  know
...
influence  prevails  :  in  Europe  people  evidently  knoiv
...
tup:  natural  history  of  morals.      127

symptom.  Morality  in  Europe  at  present  is  her  ding-
animal  morality ;  and  therefore,  as  we  understand
the  matter,  only  one  kind  of  human  morahty,
...
**  master  "  and  "  servant " — ni  dieu  ni  mattre,  says  a
...
have  ive  to  fix  our  hopes?  In  neiu philosopliers —
...
resolutely  niontrer  ses  plates ,  according  to  Balzac —
...
shame,  "  it  3\\N3.ys  finds  things  out  I ").  The  declara-
...
naturalists  and  old  ph3^sicians  (not  to  mention  the
...
implai^t  a  dangerous  distrust  in  the  soul  of  a  young
...
imprudently y  and  feels  the  obligation  and  burden  of
a  hundred  attempts  and  temptations  of  life — he
risks  ^w/j-^^  constantly,  he  plays  the  bad  game.

206.
In  relation  to  the  genius,  that  is  to  say,  a  being
\vho  either  engenders  ox  produces — both  words  under-
...
subjectivity  and  its  confounded  ipsissiinosity  I — in
...
far  too  easily  the  caput  mortuiim  of  such  virtues.
...
artificial,  and  rather  tin  tour  deforce^  a  slight  ostenta-
...
preaque  rien  " — he  says,  with  Leibnitz  ;  let  us  not
...
sort  of  slave,  but  nothing  in  Yiw^vs^i— presque  rien  !
...
also,  nothing  for  women,  in  parenthesu
...
ye  demons,  can  ye  not  at  all  ivait  ?  The  uncertain
...
"  the  scientific  spirit,"  ^^  I' art  pour  Tart"  and  "pure
...
ceived himself;  butwho  would nothave  deceivedhim-
...
scepticism — who  knows  to  ivhat  extent  it  was  en-
...
m^phisiophelique,  as  Michelet  calls  it,  not  without  a
...
"  German  spirit."  "  Voild  tin  hoinme  /" — that  was
...
be  steinier  (and  perhaps  not  always  towards  them-
...
smile,  those  rigorous  spirits,  vi^hen  any  one  says  in
...
the  logical,  ihe.  political  (moral),  or  the  a^'tistic.  It
...
and  has  been  obliged  io  find  himself,  in  contradiction
...
duty,  the  higher  responsibiHty,  the  creative  pleni-
potence  and  lordHness  —  at  present  it  belongs  to
...
question:  Is  gvQd^inQss possible — nowadays?
...
around  a  single  ;jlanet,  now  with  red  light,  now
...
ment of  the  betise  bourgeoises  just  as  though  ...  in
...
it  desi?iteresse\  and  wonders  how  it  is  possible  to
...
hnnioral  to  say  that  "  what  is  right  for  one  is
...
laughers  on  one's  ozvn  side ;  a  grain  of  wrong
...
once  and  again  a  new  sample  of  the  past  or  o^
...
quickly  the  order  of  rank  of  the  vahiations  accord-
...
(as  the  French  of  the  seventeenth  century,  Hke
...
/Eschylus  would  have  half-killed  himself  with
...
fixedly  on  still  trembling  ground.  ProportmiatC'
...
tarianism, or  eudsemonism,  all  those  modes  of
