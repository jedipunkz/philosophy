---
source: "https://archive.org/details/genealogyofmoral01niet"
title: "The genealogy of morals /"
author: "Nietzsche, Friedrich Wilhelm, 1844-1900, Samuel, Horace Barnett, 1883-1950"
year: "1918"
captured_at: "2026-07-04T09:06:08Z"
updated_at: "2026-07-04T09:06:08Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ニーチェ"
query: "Nietzsche genealogy of morals"
plain_text_url: "https://archive.org/download/genealogyofmoral01niet/genealogyofmoral01niet_djvu.txt"
public_domain: true
...
- 著者: Nietzsche, Friedrich Wilhelm, 1844-1900, Samuel, Horace Barnett, 1883-1950
- 初版: 1918
- 情報源: [archive](https://archive.org/details/genealogyofmoral01niet)
- パブリックドメイン: ✓
...
https://archive.org/details/genealogyofmoral01  niet
...
Nietzsche  published  The  Genealogy  of  Morals.  This  work
...
The  Genealogy  of  Morals  is  unequalled  by  any  other  of
...
It  is  to  those  hives  that  we  are  always  striving;  as  bom
...
a Book  for  Free  Minds,  the  writing  of  which  was  begun  in
Sorrento,  during  a winter  which  allowed  me  to  gaze  over
...
nomena, but  have  sprung  from  a common  root  from  a
...
taste,  these  fruits  of  ours? — Rut  what  matters  that  to  the
...
the  jather  of  evil.  Did  my  own  “a  priori ” demand  that
precise  solution  from  me?  that  new,  immoral,  or  at  least
“amoral”  “a  priori”  and  that  “categorical  imperative”
...
vacillation.  To  go  into  details,  compare  what  I say  in
...
more  original  kind  of  morality  which  is  toto  codo  different
from  the  altruistic  ethics  (in  which  Dr.  Ree,  like  all  the
English  moral  philosophers,  sees  the  ethical  “Thing-in-
itself”);  finally,  Aph.  92.  Similarly, /Aph.  26  in  Human,
all-too-Human,  part  ii.,  and  Aph.  ii^,  the  Dawn  of  Day,
...
R6e  thinks: — rather  is  it  that  this  object  is  only  imported,
...
tom of  our  modem  European  civilisation;  I realised  that
it  was  the  route  along  which  that  civilisation  slid  on  its
way  to — a new  Buddhism? — a European  Buddhism? —
Nihilism?  This  exaggerated  estimation  in  which  modem
...
granted  as  an  indisputable  fact,  which  was  beyond  all
...
to  an  eye  of  such  keenness  and  such  impartiality.  1
...
saying,  is  the  attribute  of  but  a few.  But  on  that  day
...
bom,  in  its  sunny  brilliance,  its  distance,  its  spaciousness,
...
the  vis  inertias  of  habit,  or  in  forgetfulness,  or  in  a blind
...
those  elements  of  life  which  are  bizarre,  painfully  para-
...
specifically  trained  themselves  to  sacrifice  what  is  desirable
to  what  is  true,  any  truth  in  fact,  even  the  simple,  bitter,
...
whom  they  were  usejul;  subsequently  the  origin  of  this
praise  was  / or  gotten,  and  altruistic  acts,  simply  because,
...
Now  the  first  argument  that  comes  ready  to  my  hand
...
stationed,  the  high-minded,  who  have  felt  that  they  them-
...
is  to  say  of  the  first  order,  in  contradistinction  to  all  the
...
pediency is  always  based — and  not  for  one  occasional,
...
word  “good”  isaar  from  having  any  necessary  connection
...
“altruistic,”  and  “desinter esse”  are  concepts  of  equal
value.
...
contrary  is  the  case.  This  uti’hy  has  rather  been  experi-
...
“schlicht” — (compare  “ schlechtweg”  and  “schlechter-
...
natural  science  and  physiology,  which  prima  jade  is  the
...
it  was  in  Buckle  that  that  plebeianism  of  the  modem
...
Theognis,  the  Megarian  poet.  The  word  ecWILog,  which
...
xoncog  as  in  8edog  (the  plebeian  in  contrast  to  the
dya-fiog)  the  cowardice  is  emphasised.  This  affords  per-
haps an  inkling  on  what  lines  the  etymological  origin  of
the  very  ambiguous  dya-fiog  is  to  be  investigated.  In
the  Latin  malus  (which  I place  side  by  side  with  fAetaxg)
the  vulgar  man  can  be  distinguished  as  the  dark-coloured,
and  above  all  as  the  black-haired  {“hie  niger  est”),  as
...
and  social  qualities.  Who  can  guarantee  that  modem
democracy,  still  more  modem  anarchy,  and  inrlped  that
...
“good”  ar/Lci  “bad,”  in  a sense  which  has  ceased  to  be
...
tain diseased  taint  in  §uch  sacerdotal  aristocracies,  and
...
Humanity  itself  is  still  diseased  from  the  effects  of  the
...
society,  the  sacerdotal  form,  that  pian  really  becomes  for
...
namgly,  “the  wretched-  a the  goSTtrtfte  "poor,  the
...
4 ^horrible,  the  covetous,  the  insatiate,  the  godless;  eter-
...
^ 0 monstrous  and  inordinately  fateful  initiative  which  the
) \t  Jews  have  exhibited  in  connection  with  this  most  funda-
| -^mental  of  all  declarations  of  war,  I remember  the  passage
y which  came  to  my  pen  on  another  occasion  ( Beyond
y ^ Good  and  Evil , Aph.  195) — that  it  was,  in  fact,  with  the
^ iS  Jews  that  the  revolt  of  the  slaves  begins  in  the  sphere  of
. v morals;  that  revolt  which  has  behind  it  a history  of  two
^ \ millennia,  and  which  at  the  present  day  has  only  moved
r'  out  of  our  sight,  because  it— has  achieved  victory.
...
love; — and  from  what  other  trunk  could  it  have  grown?
...
crucifixion of  a god  for  the  salvation  of  man?  It  is  at
least  certain  that  sub  hoc  signo  Israel,  with  its  revenge
...
to  live?  Or  could  man  get  on  without  it?  Quceritur.
...
delicacy,  to  a really  modem  taste.  Should  it  not  at  any
rate  leam  to  be  somewhat  more  subtle?  It  alienates
...
The  revolt-nf  thp -.slaves  in -morals  begins  in  the  very
...
mits sacrilege  on  reality,  this  is  limited  to  that  particular*
...
words  wtiich  are  applied  to  the  vulgar  man  survive  finally
as  expressions  for  “unhappy,”  “worthy  of  pity”  (com-
oare  8stAog,  Ssftmo?,  jtovr|o6g,  pox'O'nQog ; the  latter  two
...
gists remember  the  sense  in  which  6T£v(?6g,  avo?.6og,
tMjixgov,  8uoxnxeiv,  |up<poga  used  to  be  employed.  The
...
counted  as  happiness  (that  is  the  etymology  of  so
nparteiv) — all  in  sharp  contrast  to  the  “happiness”  of
...
with  himself  (yewaiog,  “noble-bom,”  emphasises  the
...
duces forgetfulness:  a good  example  of  this  in  the  modem
...
beast  of  prey;  the  magnificent  blonde  brute,  avidly  ram-
...
and  glory  the  pafinjiia  of  the  Athenians,  their  non-
...
slavery,  especially  of  the  pre-Aryan  population — these
...
man l For  the  position  is  this:  in  the  dwarfing  and  level-
...
Chinese,  more,  Christian^maji,  there  is  no  doubt  about  it,
...
' Tipj  genealogy  Of  MORALS  ${

its  flash,  and  interpret  the  latter  as  a thing  don!,  as  the
...
What  wonder,  if  the  suppressed  and  stealthily  simmer-
ing passions  of  revenge  and  hatred  exploit  for  their  own
advantage  their  belief,  and  indeed  hold  no  belief  with  a
...
trodden, and  overpowered  say  to  themselves  with  the
vindictive  guile  of  weakness,  “Let  us  be  otherwise  than
the  evil,  namely,  good!  and  good  is  every  one  who  does
...
the  interpretation  of  weakness  as  freedom,  of  being
or  being  that,  asjnerit.-.  p
...
jactured— verily  they  reek  with  the  crassest  lies.”
...
refinement  is  attained  by  their  chej  d’ oeuvre,  their  most
...
but  ‘the  triumplToT righteousness’ ; what  they  hate  is  not
...
—but  in  the  meanwhile  ttiey  live  ‘in  faith,’  ‘in  love,’  ‘in
hope^
...
they  are  -someek  in  everything!  Yet  in  order  to  ex-
perience that  kmgdonrlfls  necessary  to  live  long,  to  live
...
lamb,  “videbunt  pcenas  damnatorum,  ut  beatitudo  illis
...
sunt  alia  spectacula,  ille  ultimus  et  perpetuus  judicii  dies,
ille  nationibus  insperatus,  ille  derisus,  cum  tanta  sceculi
...
qui  in  ccelum  recepti  nuntiabantur,  cum  ipso  Jove  et
ipsis  suis  testibus  in  imis  tenebris  congemescentes!  Item
pr resides”  (the  provisional  governors)  “ persecutors  dom-
inici  nominis  scevioribus  quam  ipsi  flammis  scevierunt  in-
sultantibus  contra  Christianos  liquescentes!  Quos  prceterea
sapientes  illos  philosophos  coram  discipulis  suis  una  con-
flagrantibus  erubescentes,  quibus  nihil  ad  deum  pertinere
suadebant,  quibus  animas  aut  nullas  aut  non  in  pristina
corpora  redituras  affirmabant!  Etiam.  poetas  non  ad
Rliadamanti  nec  ad  Minois,  sed  ad  inopinati  Christi
tribunal  palpit antes!  Tunc  magis  tragcedi  audiendi,
magis  scilicet  vocales”  (with  louder  tones  and  more  vio-
lent shrieks)  “in  sua  propria  calamitate;  tunc  histriones
cognoscendi,  solutiores  multo  per  ignem;  tunc  spectandus
auriga  in  flammea  rota  totus  rubens,  tunc  xystici  contem-
plandi  non  in  gymnasiis,  sed  in  igne  jaculati,  nisi  quod  ne
tunc  quidem  illos  velim  vivos,  ut  qui  malim  ad  eos  potius
conspectum  insatiabilem  con  f err  e,  qui  in  dominum
scevierunt.  Hie  est  illes,  dicam  fabri  aut  qucestuarice  filius”
...
dasmonium  habens.  Hie  est  quern  a Juda  redemistis,  hie
est  ille  arundine  et  colaphis  diverberatus,  sputamentis  de
decoratus,  felle  et  aceto  potatus.  Hie  est,  quern  clam
discentes  subripuerunt,  ut  resurrexisse  dicatur  vel  hortu-
lanus  detraxit,  ne  lactucce  suce  jrequentia  commeantium
Icederentur.  Ut  talia  spectes,  ut  talibus  exultes,  quis  tibi

“GOOD  AND  EVIL,”  “GOOD  AND  BAD”  35

prcetor  aut  consul  aut  sacerdos  de  sua  liberalitatd
prcestabit?  Et  tamen  hcec  jam,  habemus  quodammodo
per  fidem  spiritu  imaginante  reprcesentaia.  Ceterum
qualia  ilia  sunt,  quae  nec  oculus  vidit  nec  auris  audivit
nec  in  cor  hominis  ascenderunt?”  (I  Cor.  ii.  9.)  “Credo
...
den of  the  new  Judaised  Rome  that  had  been  built  over
...
rible and  enchanting  counter-war-cry  of  Jji&jnero native  of
the  few!  Like  a final  sign-post  t©  other  ways,  there
...
forgetfulness  which  works  in  opposition  to  it.  Forgetful-
ness is  no  mere  vis  inertice,  as  the  superficial  believe,
...
exist  no  happiness,  no  gladnessj  no  hope,  no  pride,  no
...
as  present  and  to  anticipate  it,  to  fix  with  cei  tainty  what
...
“morality  of  custom”  * (cp.  Dawn  of  Day,  Aphs.  9,  14,
...
sonaLJong,  and  independent  .will,  competent  to  promise,
...
is  bris  superiority  over  everything  incapable  of  binding
itself  by  promises,  or  of  being  its  own  security,  how  great
is  the  trust,  the  awe,  the  reverence  thaL  he  awakes — he
...
necessity  will  he  have  the  heel  of  his  foot  ready  far  the
...
sciousness of  this  rare  freedom.  x.of  this  power  over  him-
...
one  may  imagine,  this  primeval  problem  was  not  solvecf
...
psychology  in  the  world.  It  might  even  be  said  thatr*''
...
pledges,  j.nd  obligations.  The  past,  the  past  with  all  its
...
cruel  rituals  of  all  the  religious  cults  <Lfor  all  .j^imnns
are  really  at  bottom-.-svstem.s  nf  these  things'
...
dear  is  the  price  that  they  have1  exacted!  How  much
bloocLand  cruelty  is  the  foundation  of  all  “good  things”!
...
Just  their  own  five-spans-long  limited  modem  experience;
...
and~was~cons€quently  not  based  on  the  hypothesis  that
...
which  vents i itself  mechanically  on  the  author  of  the
injury — but  this  anger  is  kept  in  bounds  and  modified
througEThelclea^ that  every  injury  has  somewhere  or  other
...
cut  off,  “si  plus  minusve  secuerunt,  ne  fraude  esto.”  Let
...
the  delight  “de  faire  le  mal  pour  le  plaisir  de  la  faire,”
the  jov  in  sheer  violence:  and  this  joy  will  be  relished  in
...
higher  social  position.  TTTanks  to  the  punishment  of  the
...
the  sympathia  malevolens ) into  a normal  characteristic  of
...
The  Dawn  of  Day,  Aphs.  18,  77,  113),  I have  cautiously
...
^rConsti tutes'  it ) . At  any  rate  the  time  is  not  so  long  past

"national  festivals  on  a grand  scale,  without  executions,

when  it  was  impossible  to  conceive  of  royal  weddings  and
^V$na?fonal  festivals  on  a grand  scale,  without  executions,
O^v^iMAortures,  or  perhaps  an  auto-da-fe,  or  similarly  to  conceive

V$f

w vT'df  an  aristocratic  household,  without  a creature  to  serve
.v^las  a butt  for  the  cruel  and  malicious  baiting  of  the  in-
mates.  (The  reader  will  perhaps  remember  Don  Quixote
at  the  court  of  the  Duchess:  we  read  nowadays  the  whole
...
)?prViapg  in  those  days  (this  is  to  solace  the  weaklings)
pain  did  not  hurt  so  much  as  it  does  nowadays:  any
phystefaft  who  has  treated  negroes  (granted' that  these  are
...
(The  curve  of  human  sensibilizes  to  pain  seems  indeed  to
...
allowed  to  admit  the  possibility  of  the  praving- for  cruelty
...
stock-in-trade,  the  tour  de  force  of  self-justification,  of
...
itv-the.  sight  of  which  a god  finds  edification,”  so  rang  the
...
in  good  and  evil,  simply  have  heen  made  for  the  specific
...
trained  the  oldest  form  of  sagacity,  it  was  here  in  this
...
ILT”  AND  “BAD  CONSCIENCE”  ^

antiquity,  moreover,  is  present  or  again  possible  at  all
periods) , the  community  stands  to  its  members  in  that  im-
portant and  radical  relationship  of  creditor  to  his  ow-
ers.’f  Man  lives  in  a community,  man  enjoys  the  advan-
...
tial law  and  triumphant  festival  of  the  vce  victis!  in  all  its
...
the  offenTes'^TtheTnd.ividual  less  seriously,  because  they
...
letting  its  wrong-doers  go  scot-free. — “What  do  my  para-
sites matter  to  me?”  might  society  say.  “Let  them  live
and  flourish!  I am  strong  enough  for  it.” — The  justice
which  began  with  the  maxim,  “Every thing  can  be  paid
...
compare  above,  First  Essay,  paragraph  14),  Jo  sanctify
...
so  forth.  (E.  Diihring,  Value  of  Life;  Course  of  Philoso-
phy, and  passim.)  So  much  against  this  tendency  in
...
it  really  comes  about  that  thejust  remains^iust  even
as  regards  his  injurer  (and^not  merely  cold, -moderate,  re-
semdr1ndiffererit:..being  iust  is  always^ a Jw&tive  state! ;
where  in  spite  of  the  strong  provocation  of  personal  insult,
...
from  it.  The^aetive  man,  the-  attacking,  aggressive  man
is  always  a “hundred  degrees  nearer  to  justice  than  the  man
who  merely  reacts;  he  certainly Jias  no  need  to  adopt  the
tactics,  necessary  in  the  case  of  the  reacting  man,  of  mak-
ing false  ancTblassed  valuations  of  his-objetrtr^LLjs,  in
point  of  fact,  for  this  reason  that  the^ggressive  man'  has
at  all  times  enjoyed  the  stronger*  beM^more  aristocratic,
and  also  freer  outlook,  th ^better  conscience-.  On  the  other
...
on  those  feelings  by  the  powers  of  activity  and  aggres-
...
not,  as  Diihring  maintains,  only  after  the  act  of  violation).
To  talk  of  intrinsicjdght  and  intrinsic  wrong  is  absolutely 1
...
and  dissolver  of  man,  an  outrage  on  the  future  oLman,  a
...
,^Jth  ^present  in  these  cases?  Their  inveterate  naivete.
S'  jToey  find  out  some  ‘ ‘ end  ”JtLfhe_  punishment , for  instance,
l'S  revenge  and  deterrence,  and  then  in  all  their  innocence
...
ends,  are  toto  ccclo  opposed  to  each  other — everything,
...
immemorial  belief  that-understanding-theJanab  cause  or
the  utility  of  a thing, _a.-  form,  an  institution,  means  also
...
as  invented  with  a view  to  punishing.  But  ail  ends  and
all  utilities  are  only  si  ms  that  a Will  fo^ovrer  *has  mas-

tered a less  powerful  force.  haslmpre^d_thereon_o^t  of
"lfshown  self  the  meaning-of.  a function;  anrl.-the,- whole
history  of  a “Thing-.”  an  organ,  a custom,  can  on  the
'same  .pnTVr?pr^p_j^arded-^as  -Continuous  “sign-chain”
of  perpetn abheaftw...i n terprefa  turn  ^ - an  4-ftAj  1 1 Qtrp pn  t wh  ngp
causes,  so  far  fronmeeding  to_have  ey^n.  ^ mnt.uaL.mn-
...
ness of  all  phenomena,  than  with  the  theory  of  a power-
will,  in  exhaustive  play  throughout  all  phenomena.  The
democratic  idiosyncrasy  against  everything  which  rules
and  wishes  to  rule,  the  modem  misar chisrn  (to  coin  a bad
...
hitherto  supposed  by  our  naif  genealogists  of  morals  and
of  law,  who  thought  that  tire  procedure  was  invented  for
...
idea  of  punishment  in  a very  late  stage  of  civilisation  (for
...
for  punishment:  all  ideas,  in  which  a whole  process  is
...
that  now  one  element  and  now  another  stands  out  and  pre-
...
pensation. fo£-4heJhjniy_£iisla^  party,

in  any  form  whatsoever  (including  the  form  of  senti-
mgntarcompensation) . — Puhrshrnentr-fts-^n-:isolation  of
thaL  which  -disturbs  the-equilibrium,  sons  to  prevent  the
...
satiori'  for  advantages  which  the  wrong-doer  has  up  to  that
Time  enioyecLfior  example,  when  he  is  utilised  as  a slave
in  the  mines).- — Punishment,  as  the  elimination  of  an  ele-

ment jjf  decay^  ( sometimes  of  a whole  branch,  as  accord-
Tng  to  the  Chinese  laws,  consequently  as  a means  to  the
...
W the  "guilty  the  consciousness  of  guilt;  in  punishment  is
c/:  sought"  the  proper  instrumentum  of  that  psychic  reaction

which  becomes  known  as  a “bad  conscience,”  “remorse.”
But  this  theory  is  even,  from  the  point  of  view  of  the
' l present,  a violation  of  reality  and  psychology:  and  how
much  more  so  is  the  case  when  we  have  to  deal  with  the
^Hibhgest  period  of  man’s  history,  his  primitive  history!
Genuine  remorse  is  certainly  extremely  rare  among  wrong-
...
ment hardens  and  numbs,  it  produces  concentration, ~1t
sharpens  die  consciousness  of  alienation,  it  strengthens  the
' power  of  resistance.  When  it  happens  that  it  breaks  the
f:  man’s  energy  and  brings  about  a piteous  prostration  and
i.  abjectness,  such  a result.  ]s  certainly  even  less  salutary
...
personally  of  the  celebrated  Morsus  conscientice— Spinoza,
...
God  did  everything  sub  ratione  boni  (“but  this  was  tanta-
...
happened  to  the  morsus  conscientice?  “The  antithesis  of
gaudium,”  said  he  at  last  to  himself, — “A  sadness  ac-

“GUILT”  AND  “BAD  CONSCIENCE”

companied  by  the  recollection  of  a past  event
turned  out  contrary  to  all  expectation”  ( Eth . iii.,  Propos.
xvm.  Schol.  i.  ii.).  Evil-doers  have  throughout  thou-
...
of  the  sense  of  cunning,  the  mastery  of  the  desiresj_so
it  is  that  punishment  tames  man,  but  does  not  make  him  J
...
with  its  terrible  claws  on  a population,  in  numbers  pos-
...
is  elementary — but  it  would  not  have  grown  without  them,
...
— it  is  already  clear — this  instinct  of  freedom  forced  back,
...
Goethe’s  phrase,  and  which  builds  negative  ideals;  it  is,
I repeat,  that  identical  instinct  of  freedom  (to  use  my  own
language,  tjjre  will  to  power)':  only  the  material,  on  which
this  force  with-  all  its  constructive  and  tyrannous  nature
isjet  loose,  is  here  man  himself,  his  whole  old  animal  self
...
at  civil  law  of  the  ower  to  his  creditor  (which  has  al-
...
nal tribal  association — we  are  talking  of  primitive  times
- — each  living  generation  recognises  a legal  obligation  to-
...
and  services.  Thus  is  recognized  the  owing  of  a debt,
...
crudest  sense),  festivals,  temples,  tributes  of  veneration,
...
transcends  imagination— the  jmcestor  becomes  at  last
necessarily  transfigured  into  a god.  Perhaps  this  is  theh
veryhngin  oFthe  gods,  that  is,  an  origin  from  fear!  And
thoseT  who  feel  bound  to  add,  “but  from  piety  also,”  wil^
...
the  social  elements  in  each  great  race-synthesis,  are  mir-
...
eye  has  to  recoil  and  rebound  in  despair  from  off  an  ada-
...
Nature”),  or  in  existence  generally,  on  this  logic  an  abso-
...
Buddhism  and  the  like) — till  suddenly  we  stand  before
...
himself  personally  out  of  apound  of  his  own  flesh,  God
...
seTLmiafraon_and  self-degradation  of  man,  in  which  the
last  two  thousand  years  of  Europe  have Tjeen  past  mas-
...
of  its  god.  They  went  very  far  on  this  principle,  did  these
splendid  and  lion-hearted  children;  and  there  is  no  lesser
authorlfy  than  that  of  the  Homeric  Zeus  for  making  them
realise_xKxasionally  that  they  are  taking  life  too  casually.
“Wonderful,”  says  he  on  one  occasion— it  has  to  do  wftE^
the  case  of  yEgistheus,  a very  bad  case  indeed —
...
and  thinking  evil  of  them  on  this  score.  “How  foolish  they
...
evil  and  fatale — Folly,  not  sin,  do  you  understand?  . . .
...
Greeks,  . . . accordingly  the  gods  in  those  times  sub-
...
understood, how  many  lies  must  be  sanctified,  how  much
...
world  does,  and  “let  ourselves  go”  like  all  the  world.  For
...
from  reality; — while  actually  it  is  only  his  diving,  bur-
...
open  alone  to  Zarathnstra,  Zarathustra  the  godless.
...
piece  of  flesh,  the  angelhood  of  a (at,  pretty  animal;  in
physiological  failures  and  whinqrsy  (in  the  majority  of
mortals),  an  attempt  to  pose  as  “tod  good”  for  this  world,
a holy  form  ofdebauchery,  their  chief  weapon  in  the  bat-
...
for  hibernation,  their  novissima  glorias  cupido,  their  peace
...
to  place  on  the  stage!  “For  what  purpose,  forsooth?”
...
crude  phase  in  the  unnaturalness  oL-the— ascetic  ideal,
that  had  at  length  been^SSerGome.  That;  asTTiave^said,
...
ually change  his  mind  on  the  subject?  For  it  seems  at
...
Christianity,  medievalism,  and  to  say  to  his  disciples,
...
What,  then,  is  the  meaning  of  ascetic  ideals?  In  the
...
in  majorem  musicce  gloriam — that  is  to  say,  by  means  of
the  sovereignty  of  music,  as  Schopenhauer  understood  it;
music  abstracted  from  and  opposed  to  all  the  other  arts,
music  as  the  independent  art-in-itself,  not  like  the  othe.
...
Schopenhauer  has  made  use  of  the  Kantian  treatment
...
is  repudiated  and  eliminated — le  desinter essement.  Who
...
even  naked  female  statues  “without  interest,”  we  can
...
sarily an  “unsesthetic  man.”  Let  us  think  all  the  better
...
woman,  sensuality,  and  the  whole  “will  for  existence”  1
...
as  theirs  was  to  the  ancient  Cynics,  his  balm,  his  recrea-  J
tion,  his  recompense,  his  remedium  against  disgust,  his
happiness.  So  much  with  regard  to  what  is  most  per-
sonal in  the  case  of  Schopenhauer;  on  the  other  hand,
...
them?  They  think  of  that  which  to  them  personally  n
...
•effect  al]  this,  simply  because  it  was  the  dominant  instinct,
...
of  the  physiology  of  the  aesthetic,  a subject  which  up  to
...
may  say,  “je  combats  Vuniverselle  araignee”;  “Hybris”  is
...
is  no  doubt  we  do  violence  to  ourselves  nowadays,  we
...
phase  belongs,  for  instance,  the  jus  primes  noctis,  to-day
...
ject for  shame,  just  as  hardness  is  now  (compare  Beyond
...
ger, being  pitied  for  shame,  work  for  shame,  madness  foi
...
an  even  more  fundamental  need,  the  nefd  of  inspiring  in
...
representatives  of  the  serious.  “What  is  the  meaning  of
...
this  species,  hostile,  as  it  is,  to  lije,  always  grow  again
...
power;  here  does  the  green  eye  of  jealousy  turn  even
...
what!  would  not  that  be  called  intellectual  castration?
...
eyes  and  ears,  he  sniffs  almost  wherever  he  goes  to-day
...
man,  in  ourselves.  Where  shall  we  escape  from  it,  from
that  covert  look  (from  which  we  carry  away  a deep
sadness),  from  that  averted  look  of  him  who  is  misbom
...
away  from  myself?  And,  verily — I am  sick  of  myself!”
...
the  most  malignant  conspiracy — the  conspiracy  of  the  j
sufferers  against  the  sound  and  the  victorious;  here  is  the
sight  of  the  victorious  hated.  And  what  lying  so  as  not  i
...
tatisThey  stalk  about  in  our  midst  as  living  re-
...
Duhring,  who  makes  most  disreputable  and  revolting  use
in  all  present-day  Germany  of  moral  refuse;  Duhring,
...
1 to  themselves  when  they  meet,  “It  is  a shame  to  be
...
future,  they  alone  are  bound  to  man’s  future.  V/hat
...
the  plaguey  and  the  sick  are  heir  to;  he  fights  with  cun-  of
ning,  hardness,  and  stealth  against  anarchy  and  against  be
the  ever  imminent  break-up  inside  the  herd,  where  resent-  po
ment,  that  most  dangerous  blasting-stuff  and  explosive, ; sib
ever  accumulates  and  accumulates.  Getting  rid  of  this  nee
blasting- stuff  in  such  a way  that  it  does  not  blow  up  the  tbi
herd  and  the  herdsman,  that  is  his  real  feat,  his  supreme  bul
utility;  if  you  wish  to  comprise  in  the  shortest  formula  of
the  value  of  the  priestly  life,  it  would  be  correct  to  say  cat
the  priest  is  the  diverter  of  the  course  of  resentment.  \ jjt
Every  sufferer,  in  fact,  searches  instinctively  for  a cause  m
of  his  suffering;  to  put  it  more  exactly,  a doer,- — to  put  or
it  still  more  precisely,  a sentient  responsible  doer, — in  tk
brief,  something  living,  on  which,  either  actually  or  in  1
effigy , he  can  on  any  pretext  vent  his  emotions.  For  ft
the  venting  of  emotions  is  the  sufferer’s  greatest  attempt  fc
at  alleviation,  that  is  to  say,  stupefaction,  his  mechanic-  pa
ally  desired  narcotic  against  pain  of  any  kind.  It  is  in  pa
this  phenomenon  alone  that  is  found,  according  to  my  m
judgment,  the  real  physiological  cause  of  resentment,  re-  a
venge,  and  their  family  is  to  be  found — that  is,  in  a ®
demand  for  the  deadening  of  pain  through  emotion:  this  ft
cause  is  generally,  but  in  my  view  very  erroneously,  ft
looked  for  in  the  defensive  parry  of  a bare  protective  I a
principle  of  reaction,  of  a “reflex  movement”  in  the  case  ] u
of  any  sudden  hurt  and  danger,  after  the  manner  that  a 1
decapitated  frog  still  moves  in  order  to  get  away  from  a j
corrosive  acid.  But  the  difference  is  fundamental.  In  , (
one  case  the  object  is  to  prevent  being  hurt  any  more;  j
in  the  other  case  the  object  is  to  deaden  a racking,  in-  t
...
1 pose  an  emotion  is  needed,  as  wild  an  emotion  as  pos-
...
I cause  (the  cause  may  lie  in  a disease  of  the  nervous
Isympathicus,  or  in  an  excessive  secretion  of  bile,  or  in  a
...
his  “pain  in  the  soul,”  the  cause  is,  speaking  crudely,
...
In  such  a case  there  is  invariably  recourse  to  a war  on  a !
...
webs,  too  much  of  a hole-and-corner  affair,  especially  j
when  pain  is  proved  to  be  a mistake,  on  the  naif  hypothe-  ,
sis  that  pain  mu9t  needs  vanish  when  the  mistake  under-
lying  it  is  recognised — but  behold!  it  does  anything  but  ,
vanish  . . .).  That  dominant  depression  is  primarily  ^
fought  by  weapons  which  reduce  the  consciousness  of  life  (
itself  to  the  lowest  degree.  Wherever  possible,  no  more
wishes,  no  more  wants;  shim  everything  which  produces  ,
emotion,  which  produces  “blood”  (eating  no  salt,  the  j
fakir  hygiene);  no  love;  no  hate;  equanimity;  no  re-
venge;  no  getting  rich;  no  work;  begging!  as  far  as  pos-  j
sible,  no  woman,  or  as  little  woman  as  possible;  as  far  (
as  the  intellect  is  concerned,  Pascal’s  principle,  “il  faut
s’abetir”  To  put  the  result  in  ethical  and  psychological  ,
language,  “self-annihilation,”  “sanctification”;  to  put  it  in
physiological  language,  “hypnotism”— the  attempt  to  find  r
some  approximate  human  equivalent  for  what  hibernation  .
is  for  certain  animals,  for  what  aestivation  is  for  many  j.
tropical  plants,  a minimum  of  assimilation  and  metab-  a
olism  in  which  life  just  manages  to  subsist  without  really  a
...
efficiency  of  virtue:  keep  dear  on  this  point — indeed  it
...
remain  serious  in  view  of  the  appredation  meted  out  to
...
he  sees  no  more  any  vision,  then,  oh  dear  one,  is  he  united
with  Being,  he  has  entered  into  his  own  self — encircled  by
the  Self  with  its  absolute  knowledge,  he  has  no  more  any
consciousness  of  that  which  is  without  or  of  that  which
is  within.  Day  and  night  cross  not  these  bridges,  nor
age,  nor  death,  nor  suffering,  nor  good  deeds,  nor  evil
deeds.”  “In  deep  sleep,”  say  similarly  the  believers  in
this  deepest  of  the  three  great  religions,  “does  the  soul
lift  itself  from  out  this  body  of  ours,  enters  the  supreme
light  and  stands  out  therein  in  its  true  shape:  therein  is  it
the  supreme  spirit  itself,  which  travels  about,  while  it
jests  and  plays  and  enjoys  itself,  whether  with  women,  or
chariots,  or  friends;  there  do  its  thoughts  turn  no  more
back  to  this  appanage  of  a body,  to  which  the  ‘prana’
(the  vital  breath)  is  harnessed  like  a beast  of  burden
to  the  cart.”  None  the  less  we  will  take  care  to  realise
...
“impersonality,”  self-forgetfulness,  “incuria  sui” — with
...
depression  is  the  ordaining  of  a little  joy,  which  is  easily
