---
source: "https://archive.org/details/ethicsofspinoza00joacuoft"
...
year: "1901"
captured_at: "2026-07-02T14:26:20Z"
updated_at: "2026-07-02T14:26:20Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "スピノザ"
query: "Ethica ordine geometrico demonstrata"
plain_text_url: "https://archive.org/download/ethicsofspinoza00joacuoft/ethicsofspinoza00joacuoft_djvu.txt"
public_domain: true
...
- 著者: Joachim, Harold H. (Harold Henry), 1868-1938
- 初版: 1901
- 情報源: [archive](https://archive.org/details/ethicsofspinoza00joacuoft)
- パブリックドメイン: ✓
...
(ii)  Substance  and  Attribute I7~27    v"
...
the  outcome  of  Spinoza's  personal  experience1.
...
on'"^o^Setntng*erEernal  and  "infinite— this  feeds  the  mind
...
conceive  to  be  far  stronger2,  and  more  stable  than  our
...
nature  is  'thaJLin  w^i^b  wft  Vr>AW  f.frq  rmin-n  r>f  mfl.-n's
...
nf  flm  <yp,T]Arp1  -nat.nrp.  r>f  thft  method  is  all-important
for  the  iTnHp.raf.fl.Ti ding  pf  the  Ethics.

The  aim  of  the  method  is  to  fit  the  intellect  for  the
attainment  of  the  'best5  knowledge  of  things.  What
...
which  may  in  turn  become  the  'ideatum'  of  another  idea1.  ;
...
70ft7.  est    ipsa    certitude.'     W1L.    i.
...
i.  e.  which  is  all  reality,  beside  which  there  is  no  reality2.'  method.'
...
in  his  textbook  of  Descartes2,  has  done  so.  But  Des
...
logical  explanation  we  know  strongly  attracted  him1.
...
are  one  and  the  same.  To  say  Mjo.d  is  *-Ti°i
...
thesisoT^Substance  and  its  states  or  modifications2 —
...
the  division  is  within,  or  of,  the  real6:  .the  modes  or
...
between  'what  is'  and  'what  is  known7,'  though  there
...
of  each  definition  with  the  first.  The  second  half8
...
accidents1  (which   he   had   used,  Spinoza's   intention,   as    revealed
...
or  that  Substance  exists  in  no  state  of  itself.  lhe_jm£re
...
tial  nature  of  Substance1.'  The  Attributes  of  a  Substance,
...
tension  is  conceived  per  sef  et  in  se.  But  motion  is
conceived  in  alio,  and  its  conception  involves  Exten
sion4.'  This  apparent  identification  of  Substance  and
...
evitably  accompany  them1.  Each  attribute  is  thus
...
it  has  for  knowledge1.  And,  on  the  other  hand,  the
...
Meyer4 — appears  insoluble,  because  certain  distinctions
...
nature2.  And  it  results  from  these  two  propositions
...
indefinitely  long  time.  rP©r4tsLjeLxis£ence  is  the  necessary
...
Wje  can  conceive  them  as  not  existing.  No  doubt vif  we
...
of  bodies  really  distinct  from  one  another1:.  It  would
...
na.tlirao£Sftbstanoe,  wbic^  necessary  sequence  nonstijrntfts
...
•)  i£-JKe_take  thn  stfflfQfl  o**  Snhptn.nca  in  abstraction  from
...
teor,  me  nullam  aliam  rerum  cor-  'duration1  and  'eternity,'  see
...
but  ways  oF  thinking,  or  rather  picturing,  things1.
...
seemed  to  say2,  that  the  human  mind,  since  it  is
...
we  regardit  as  'made  ups,  of  bodieg^Jjjritfr
...
God1,  and  God  alone,  is  absolutely  self-dependent,
...
positive  being.  In  the  Tractatus1  God  is  said  to  be
...
other  words,  God  is  '  a  substance  (consisting  3jof  infinite^
...
we  attribute  infinite  Attrib^tfaB"tg JP171)  is  therefore  that
...
than  one  God  ;  but,  if  notr  then,  jQod's,  substantial  nature
...
leaves  it  'infinite  in  its  own  kind1.'  But  God,  though
...
nature.  The  necessary  existence  of  God  is  his  '  eternity2';
...
God's  nature  are  'eternal  truths2.'  But  we  can  draw
...
beside  God2:  and  God  is  in  no  sense  determined  or
forced  db  extra  to  be  or  to  act3.  Yet  {  jB.11  t,"h  \  n
...
or  ^jj^ZJLJ^0^  (g*V?ft  rnily  t.hft  perfection  or

reality  of  his  own  nature)  which  stimulates  him  to  action,
te.ia-.thja  JfejaJLjafflflfi-fif  -all  -things5.     God  therefore  is
...
sary_    It^is  oo^gtefti™t.  ab  extra — necessity  in  the  sense j)f
external  compulsion — which  is  opposed  to  freedom  or
necessity  in  the  sense  of  self-determination2.
...
nity  will  persist  in  the  same  actuality2,.'  And  the  same
...
including  'possible6' — is  a  term  expressing  only  our
...
press  what  is  and  what  is  not1.

We  must.  thent   cast  into  the   lumber-room  of  theo
...
action2 — that  man  acts  from  final  causes,  and  that  his
...
against  Descartes1  conception  of  Final  Causes,  see  below,  Bk.  II.
...
modes  of  Godf  and  as  modes  they  are  dependent  and
...
18-24,  and  27  (Spinoza's  Letters  are  19,  21,  23  and  27)  ;  also  cf.
Ep.  78.
...
GOD    in    his   free   causality,    as   '  natura   naturans1,' CHAP.  Ill
...
us  as  a  Being  infinite  in  his  power  of  thinking1:  gts
a  'res  cogitans/  God  is  tha  frea  p.a.nsA  nf  ^Om-^luxU
system  which  necessarily  flows  from-  -4he-  -  Attob«t«~  of
Cogitatio.
...
As  tmdn  it  ja  not  drri^HQ7.     Nor  is  if.  fl.  1ifp.lp.as
...
force  in  which  his  omnipotence  manifests  itself1.  And
...
all  lines  of  force  4.    Nn  •mi-m'hfvivcaii  exhaust  tJn's  ca.TI:ne«s'  ;
...
3X6  dependents*.      All  fl,pfr  rvfTyill   r>-p  {^r  ^P.Sirp.  prpjgnppnsA  l'r>

the  subject  an  {  idea9  —  a  conception  —  of  the  object  willed
...
reflection  or  apprehension  of  them2.  And  since  for
...
Thus   thft    Af.friVmf.ft   r>f  TjhrmgTit.   nn    if.«   foryna.]    sirJq  ia

coextensive  with__Substance  in  thft  qp.-mft  ffiMft  y
every  other  Attribute1.  .  But  since,  as  thought,  it
...
nature2  and  the  more  it  expresses  God's  perfection.
...
It  is  in  '  na.-hirfl.  nfl.fnrfl.fA/  thft  P.t.ftmal  system  of  mndfts3
...
time   or  space,  or   by  any  limiting  condition2.     Thus,
...
e.g^.  if-'  motion1  'follows  directly  from  Extension,  orj
...
on  God  which  Spinoza  develops1.
...
must  themselves  be  infinite  and  eternal2.  Now  in  a  sense
...
system  in  which  their  'essentiae'  are  complete2.
...
out  of  the  system  j  fl-11^  vegard  thfvm
...
in  its  flftpfi-nrJp.Tip.p.  n-p  its  modal  jgystgrn  —  is
...
The  'communis  ordo  naturae3'  presents  itself  to  us  as
...
of  apprehension1.  But  it  is  not  through  and  through
...
actual  operation,  inevitably  flow4.
...
not— as  is  sometimes  said1 — a  cause  the  same  in  kind  as  its  effects
...
its  extendednessf  must  (however
...
ties  of  inof.inn  fl.nrl  rp.sf.  a.nrl  thQ  prop^rti^ri  hntwnf>Ti  t"Hfim;
which  they,  or  f.nftir  nlf.ima.fft — component — corpuscles,
contain2.

Tf.  is  in  this  sense,  that  all  bodies  are  'mediated'  by
the    mode    nf  cmof.inn-fl.nrl-rest>  ;     for   their    distinctive
*-n,AJr     iTninnj    f.np.ir — c  fhingnpss  '    anrl
...
AVftr|    thnngTi^snTYTB^  of    the    parts    rlrnp    pnf,

and  jptliacs-J&ke  their  place,  its  ujutv  and  individuality
will  persist2.  ftj^J^g  ftfr  t-h°  munpi  J^alance  of  the
...
retain.    if«    inrlivirlna.1     -pft^rft     sa\i\     fnrnit    ^yen     though
...
unity  comprehends  more  and  more  complex  and  artit
...
directly    from    the.    jmTn^ifl.^    mnrlp^    >mff    iff
...
itself  ideally1  the  whole  of  Nature  —  its  thoughts  proceed-  CHAP.
...
fnrrns  nfprmgm'nrig  nr  gpirifiTal  ir»fym>y
...
iva±i  vASL^n£..apprehension1  in  the  sense  that
...
nf  T&rf.ftTigim1f  if  we   nonp.P.ivA  +JIA
...
BOOK  i.  JT  wju  be  convenient  to  pause  at  this  point  in  our
...
the  task  of  philosophy  in  an  eminent  degree.     All  the  uJJJJ0**'8
...
c°herent-     Could  they  be  dissolved  in  intelligible  union  ?
...
Spinoza's  theory  where  it  no  longer  applies1.  But  it
...
Cody  °f  ^°d-  But  it  is  precisely  this  '  having  states  '  or  *  being
...
an  infinite  variety  of  grades  of  beingr  every  one  of  which
...
vanced,  there  are  some  confirmations  which  it  will  be  readyt°o°
...
least  in  part3)  illusory,  and  that  Spinoza  either  attempts  'i
...
tion  of  God  as  concretely  One,  constantly  lapses  into  abstrac*
...
the    reader    o,f  a   familiar  truth.     The  cogency  of  all  method1'
geometrical  reasoning  depends  upon  the  assumption  oftendsto
...
from  essence'  or  'the  finite  from  the  infinite1.'  But
...
a  sensitive  subject3.  (2)  But  if  so,  then  temporal
...
mere  *  auxi  Hum  imaginations1';  and  indeed  the  whole
...
c  single '  effect  means  is  not,  and  could  not  be,  d
