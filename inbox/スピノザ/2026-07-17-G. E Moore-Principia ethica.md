---
source: "https://archive.org/details/principiaethica0000gemo"
title: "Principia ethica"
author: "G. E Moore"
year: "1929"
captured_at: "2026-07-17T19:41:49Z"
updated_at: "2026-07-17T19:41:49Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "スピノザ"
query: "Ethica"
plain_text_url: "https://archive.org/download/principiaethica0000gemo/principiaethica0000gemo_djvu.txt"
public_domain: true
...
- 著者: G. E Moore
- 初版: 1929
- 情報源: [archive](https://archive.org/details/principiaethica0000gemo)
- パブリックドメイン: ✓
...
‘
f »
First Edition 1903 _ *
_. Reprinted 1922, 1929 a
...
https://archive.org/details/principiaethica0000gemo

PREFACE.

le appears to me that in Ethics, as in all other philosophical
...
I have tried in this book to distinguish clearly two kinds ot
...
do it, whether it 1s a right action or a duty.
...
kinds and of twotkinds only: it must consist, in the first place,
...
positions of thas kind are not ‘Intuitions, than to maintain that
propositions of my /irst class are Intuitions.
...
sharply into the same two kinds; (8) in holding that the first
...
which I have called the principle of organic umties. In conse-
...
and peculiar to all undoubted ethical judgments; . i 1

2. but this is not that they are concerned with human cordance
...
3. The subjects of the judgments of a arene Ethins are eh ire
those of some studies, ‘particular things’; . : 3

4, ite oe includes all universal judgments ee assert the Pion
f ‘goodness’ to any subject, and hence includes Casuistry . 3

B.

5. It must, however, enquire not only what things are universally
related to goodness, but ses what this predicate, to which

they are related, is: ; : : 5
6. and the answer to this question is ae it is Sindetnable ; F 6
7. or simple: for if by definition be meant the analysis of an object

of thought, only complex objects can be defined; . : s 7
8. and of the three senses in which ‘definition’ can be used, this

is the most important. . 8

9, What is thus indefinable is not the Boca, or the whole af that
which always possesses the siidaicage ‘good,’ but this ities

itself. . , 8
10. ‘Good,’ then, ototec one unique apie aise af Ceenent among
innumerable others; but this object has very commonly been
identified with some other—a fallacy which may be called

‘the naturalistic fallacy’ : ‘ : ; i ‘ : 9
...
meaning of a word. ; 2 : s We kh

12. The nature of this fallacy is castle. sootenisad™ : ; 12

13. and if it were avoided, it would be plain that the only alker:
...
appeal to inspection, but which can be so refuted. ; ee ti
14. The ‘naturalistic fallacy’ illustrated by Bentham; and the im-
portance of avoiding it pointed out. : ; : 5 Pee WF
C.
...
related to something else which is itself ae be ‘good as
a means.’ : 21
16. Our investigations of ie later eat of relate cannot Lie to
establish more than that a certain kind of action will generally
be followed by the best possible results ; : 22
17. but a relation of the former kind, if true at all, ai be ue of
...
19. in which case the part has to the Whole a polation! whieh erithae

an equally important difference from and resemblance to that

of means toend. . é 29
20. The term ‘organic whole’ inighh well be ry to Mencle thes

a whole has this property, since, of the two other sina

which it is commonly used toimply, . : 30
21. one, that of reciprocal causal dependence between pars, hag no
necessary relation to this one, ; 31

22. and the other, upon which most stress ne Heed La can be
true of no whole whatsoever, being a self-contradictory con-
ception due to confusion. 5 : c - 33
...
This and the two following chapters will consider certain proposed
answers to the second of ethical questions: What is good in
wtself? These proposed answers are characterised by the facts
(1) that they declare some one kind of thing to be alone good
in itself ; and (2) that they do so, because they suppose this
one ine to detine the meaning of ‘good.’

Such theories may be divided into two groups (1) Rourphy sical
...
Definition of what is meant by ‘ ear ion :

The common argument that things are good, hoceit ties are
‘natural,’ may involve either (1) the false ao ee that
the ‘normal,’ as such, is good ; ; :

or (2) the false proposition that the ‘necessary,’ as such, is
good.

But a systematised Dred 0 N: sare is now most prevalent in
connection with the term ‘Evolution.’ An examination of
Mr Herbert Spencer’s Ethics will illustrate this form of
Naturalism. . :

Darwin’s scientific Gicory, of aeetacsl eae ich has
...
Mr Spencer’s connection of Evolution with Ethics seems to
shew the influence of the naturalistic fallacy ;

but Mr Spencer is vague as to the ethical relations of iteasune’
and ‘evolution,’ and his Naturalism may be mainly Natural-
istic Hedonism.

A discussion of the third Paice of the (Dee of Highs serves
...
Three possible views as és the deletion of Hivolution to Ethics
...
a criticism of J. S. Mill & H. Sidgwick.

A.

Mill declares that ‘Happiness is the only thing desirable as an
end, and insists that ‘Questions of ultimate ends are not
amenable to direct proof’;

yet he gives a proof of the first propouoe. which oaueiets in

(1) the fallacious confusion of ‘desirable’ with ‘desired,’

(2) an attempt to shew that nothing but pleasure is desired.

The theory that nothing but pleasure is desired seems largely
due to a confusion between the cause and the object of
desire : pleasure is certainly not the sole olyect of desire, and,
even if it is always among the causes of desire, that fact
would not tempt anyone to think it a good.

Mill attempts to reconcile his doctrine that pleasure is ie ms
object of desire with his admission that other things are
desired, by the absurd declaration that what is a means to
happiness is ‘a part’ of happiness.

Summary of Mill’s argument and of my Gritiomarn!

B.

We must now proceed to consider the principle of Hedonism as
an ‘Intuition,’ as which it has been clearly recognised by
Prof. Sidgwick alone. That it should be thus:incapable of
proof is not, in itself, any reason for dissatisfaction.

In thus beginning to consider what things are good in Chien:
selves, we leave the refutation of Naturalism behind, and
enter on the second division of ethical questions. .
...
Mills doctrine that some pleasures are superior ‘in quality’ to
others implies both oy that a cil of ends must be
‘intuitions’ ;

and (2) that Bisasare is not Hite ote Bonane

Prof. Sidgwick has avoided these confusions made by Mill:
considering his arguments we shall, therefore, merely con-
sider the question ‘Is pleasure the sole good?’ . hak:

Prof. Sidgwick first tries to shew that nothing outside of
Human Existence can be ae Reasons are given for
doubting this.

He then goes on to the a more faporane pROROmITN that no
part of Human Existence, except pleasure, is desirable.

But pleasure must be distinguished from consciousness of
pleasure, and (1) it is plain that, when so cri nee
pleasure is not the sole good;

and (2) it may be made equally plain ae consciousness fe
pleasure is not the sole good, if we are equally careful to dis-
tinguish it from its usual accompaniments.

Of Prof. Sidgwick’s two arguments for the contrary view, the
second is equally compatible with the supposition that
pleasure is a mere criterion of what is right;

and in his first, the appeal to reflective intuition, he fails e
put the question clearly (1) in that he does not recognise the
principle of organic unities ;

and (2) in that he fails to emepicasize that the Rereeniow hh:
he has tried to shew, between hedonistic judgments and
those of Common Sense, only holds of judgments of means :
hedonistic judgments of ends are flagrantly paradoxical.

I conclude, then, that a reflective intuition, if proper precau-
...
It remains to consider Egoism and Utilitarianism It is im-
...
Egoism proper is utterly mntouable! fia self. aeneraniolery:
it fails to perceive that when I declare a thing to be my own
good, I must be declaring it to be good aaa, or else not
good atall. .e , ; ‘ ; :
...
This confusion is further brought out by an examination of
Prof. Sidgwick’s contrary view ;

and it is shewn that, in consequence of eae omnenae 1
...
The same confusion is involved in ha Ry ae rat infer
Utilitarianism from aa ia Hedonism, as commonly
held, e.g. by Mill.

Egoism proper seems also to owe its iaaalines to ‘ts Soutien
with Egoism, as a doctrine of means.

Certain ambiguities in the conception of iltarcanteat are
...
The term ‘metaphysical’ is defined as having reference
...
does not exist in Nature, must, at least, evzst, the term also
has reference to a supposed ‘supersensible reality’: ‘

and by ‘metaphysical Ethics’ I mean those systems which
...
fallacy’—by the use of which Naturalism was also defined. .

Metaphysics, as dealing with a ‘supersensible reality,’ may have
...
Metaphysics thus contradicts their Ethics.

B.

But the theory, by which I have defined Metaphysical Ethics,
...
theory has heen refuted by the proof, in Chap. I, that the
naturalistic fallacy is a fallacy: it only remains to discuss
certain confusions which seem to have lent it plausibility.

One such source of confusion seems to lie in the failure to dis-
tinguish between the proposition ‘This is good,’ when it
means ‘This existing thing is good,’ and the same proposition,
when it means ‘The existence of this sind of thing would be
good’ ;

and another seems % foe in the fatlees to deunenich besween
...
important bearing upon Ethics than Metaphysics can have.

C.

But a more important source of confusion seems to lie in the
supposition that ‘to be good’ is edentical with the possession
of some supersensible property, which is also involved in
the definition of ‘reality.’

One cause of this supposition seems to be the eee prejndics
that all propositions are of the most familiar type—that in
which subject and predicate are both existents. ‘

But ethical propositions cannot be reduced to this type: in
...
and (2) from Commands; with which chee are confused both by
Kant and by others. ‘ ‘ : : ‘ :
...
This latter confusion is one of the sources of the prevalent
...
but from neither of Niet papokaligtant ‘awe dees it follow
...
itself and its, supposed crvterion:

and, once this analogy between Volition aad Cosnitien is
...
The argument of the last three §§ is recapitalated; and it is
...
(2) If ‘being good’ and ‘being willed’ are not zdentical, then
...
smnallest assistance.

The fact that the metaphysical witers wae, ike ison athenigh
...
and (2) What things are good in Wisuasives? #e wien we care
one answer in deciding that pleasure was not the only thing
good in itself.

In this chapter we shall deal with the tard Sbjct of pied
...
an assertion of causal connection. “

It is shewn that the assertions ‘This action is eee? or ‘is a
duty’ are equivalent to the assertion that the total results of
the action in question will be the best possible ;

and the rest of the chapter will deal with certain dokdinstons
upon which light is thrown by this fact. Of which the first
is (1) that Intuitionism is mistaken; since no a a
with regard to duty can be self-evident.

(2) It is plain that we cannot hope to prove which among all
...
which we are likely to perform, will produce the best results.
...
The distinction made in the last § is further explained; and it
...
(3) Even this latter task is Srcigahinaly digenls aad no
...
for the attainment of any a goods in considerable
quantities

(2) Other rules are cick that hem general ctacmnes can oe
be shewn to be useful, as means to the preservation of
society, under more or less temporary conditions: if any of
these are to be proved useful in ald societies, this can only
be done by shewing their causal relation to things good or
evil in themselves, which are not saa: recognised to
be such.

It is plain that rules of cee (1) may Be be esaned a the
...
In this way, then, it may be possible . SA ie ere
...
99. And (d) if we consider the distinct queeion of hier a single
...
conclusive, if ether the ete observance or the general
utility is wanting: é ;

100. and that (8) in all other cases, ae ae action should ne be
followed at all, but the individual should consider what
positive goods, fe, in his particular circumstances, seems
likely to be able to effect, and what evils to avoid. 3

101. (4) It follows further that the distinction denoted by the
terms ‘duty’ and ‘expediency’ 1s not primarily ethical :
...
102. The distinction betwee uty? gal ceLereats is sleestis in the
...
its total effects will be the best possible. ‘

103. (5). We may further see that ‘virtues’ are not to be Horned
...
formance of ‘duties’ is ever good in itself—far esi that it
is the sole good:

105. and, if we consider the cateiuate ie of one exercise, it will
...
106. but in order fairly to docile ee the idisticae caine of ine
...
no value even aS @ means:

107. (6) where virtue consists in a Giepusaan ‘a have; aad Be
...
108. finally (c) where virtue sotieiate in ccousemnlfennaeeee 7.6. the
...
always good even aS a means. . : 5 . .

109. Summary of chapter. 4 : 5 : . 5 5
...
but a correct answer to this question is an essential step
towards a correct view as to what’is ‘ideal’ in senses (1)
and (2). ;

In order ¥ obtain a sive answer on si Giieation What i is
good in itself?’ we must consider what value things would
have if they existed absolutely by themselves ;

and, if we use this method, it is obvious that personal efoction
and aesthetic enjoyments include by far the greatest goods
with which we are acquainted.

If we begin by considering I. Aesthetic Fnjewimenté, it is ila
(1) that there is always essential to these some one of a great
variety of different emotions, though these emotions may
have little value by thentselves :

and (2) that a cognition of really beatiful fae is equally
essential, and has equally little value by itself.

But (3) granted that the appropriate combination of these imo
...
whole thus formed is not much more valuable still.

I think that this question should be answered in the affirma-
tive ; but in order to ensure that this igs is correct,
‘we must carefully distinguish it

from the two judgments (a) that icnowdedie is algable as a
...
if, however, we attempt to avoid being Biased by, ee fe
facts, it still seems that mere true belief may be a con-
dition essential to great value. ,

We thus get a therd essential constituent of many gr roa Bode: ;
...
equality with the highest imaginative pleasures.

Finally (4) with regard to the objects of the cognition which is
...
the sum of the values of the admiring aaa of the
parts.

With regard tis its Pesce Afton the once is aH a
...
It follows from what has been said that we have every reason
...
It remains to consider positive evils ne ee soos i ‘Evils
may be divided into three classes, namely

(1) evils which consist in the love, or admiration, or enjoy-
ment of what is evil or ugly

(2) evils which consist in the hatred or ‘contempt of whats is
good or beautiful

and (3) the consciousness of atone pain : ae appears 8 be
...
but pleasure and pain are sf cdeplotaly sualopousk in aXehie that
...
In order to consider Il. Mixed Goods, we must first distingwiek
between (1) the value of a whole as a whole, and (2) its value
on the whole or total value: (1)=the difference between (2)
and the sum of the values of the eo In view of this dis-
tinction, it then appears :

(1) That the mere combination of ect or more ae is never
positively good on the whole, although it may Ayo have
...
2 THE SUBJECT-MATTER OF ETHICS [ CHAP.
...
1] THE SUBJECT-MATTER OF ETHICS 3
...
_ that if we can arrive at any certainty about this, it will be much
...
more general. But it is most important to notice that Casuistry _
...
1] THE SUBJECT-MATTER OF ETHICS 5
...
easuist has been unable to distinguish, in the cases which he
...
_ correct reasons for thinking that this or that is good; and,
...
of the matter. Or if I am asked ‘How is good to be defined 2’
...
1] THE SUBJECT-MATTER OF ETHIOS T
...
and by ‘bon’ in French. But (8) we may, when we define
...
9. But I am afraid I have still not seored the chief
...
_ Well, I cannot deny that propositions of this nature may some-
...
1] THE SUBJECT-MATTER OF ETHICS ii
...
_ good, and although he should prove a million times over the
...
T] THE SUBJECT-MATTER OF ETHICS 13
...
then, should it be ditferent with ‘good’? Why, if good is good
...
unless good 1s something different from pleasure. It is absolutely
useless, so far as Ethics is concerned, to prove, as Mr Spencer

1] THE SUBJECT-MATTER OF ETHICS 15
...
either it 1s a complex, a given whole, about the correct analysis
...
1] THE SUBJECT-MATTER OF ETHICS 17
...
1] THE SUBJECT-MATTER OF ETHICS 19

conducive to it; and, that being so, right can no longer be
defined as ‘conducive to the genera] happiness,’ without in-
...
sought for other reasons, he mzght have found none which he
...
hkely are we to adopt a false one. It may be replied to this:
...
1] THE SUBJECT-MATTER OF ETHICS 21
...
whatever circwmstances it occurs. But this is certainly impossible.
...
1] THE SUBJECT-MATTER OF ETHICS 23
...
1] THE SUBJECT-MATTER OF ETHICS 25
...
26 THE SUBJECT-MATTER OF ETHICS [CHAP.
...
1] THE SUBJECT-MATTER OF ETHICS 27
...
portion to the sum of the values of tts parts. It is certain that a
...
1] THE SUBJECT-MATTER OF ETHICS 29
...
yet (2) the existence of the part may tself have no more
...
30 THE SUBJECT-MATTER OF ETHICS [CHAP.
...
form a more valuable whole. J¢ will not have more intrinsic
value under these circumstances than under others; 7¢ will not
...
1] THE SUBJECT-MATTER OF ETHICS 31
...
Iam proposing that the name should be confined. But those
...
32 THE SUBJECT-MATTER OF ETHICS [CHAP.
...
1] THE SUBJECT-MATTER OF ETHICS 33
...
_ existence of the whole; and this is understood to mean not
...
34 THE SUBJECT-MATTER OF ETHICS [CHAP.
...
(a) The eaistence of a part may be connected by a natural
...
1] THE SUBJECT-MATTER OF ETHICS 35
...
they form part of it. Yet, most certainly, 7f they ever did not
...
belong to zz at all. To have value merely as a part is equivalent
...
38 NATURALISTIC ETHICS: [CHAP

held to define what is meant by ‘good’ itself. In other words
they aré all theories of the end or ideal, the adoption of which
...
the object of Ethics is, indeed, in chief part, to give you _
...
11] NATURALISTIC ETHICS 43

must be good. But is it so obvions that the normal must
...
certainly; but, of course, there may be something in it. Iam
...
that is no reason for praising them, or advising us to ial
...
necessary to life is tpso facto better than what is necessary to
...
Hedonist? And, if so, is hea naturalistic Hedonist? In that case
...
1 See Esquisse d’wne Morale sans Obligation ni Sanction, par M. Guyau.
4me édition. Paris: F. Alcan, 1896.

1] NATURALISTIC ETHICS 47
...
to be wmplications of the Evolution-Hypothesis—there can be
...
1 Data of Hthies, Chap. 1, § 7, ad fin. 2 The italics are mine.

11] NATURALISTIC ETHICS 49
...
cilable opinions [pessimist and optimist] anything in common 2’
...
Mr Spencer means us to understand that it 7s sufficient, then
...
uf only it give a balance of pleasure: and that contention is
...
to the theory of Evolution. Finally, (8) it may be held that,
...
1] NATURALISTIC ETHICS 57

sense, denote a natural Jaw, like the law of gravity. Darwin’s
...
commit it, unless something which zs respectable, were repre-
...
58 NATURALISTIC ETHICS (CHAP. II
...
always good or the only good things (27—28). (8) But a more
...
‘Pleasure is the sole good’ to be a mere wtuttion. It appeared
...
1A. BE. Taylor’s Problem of Conduct, p. 120.
...
end or in itself’: 1 am not attacking the doctrine that ‘Pleasure
ws good as an end or in itself, nor am I attacking any doctrine
...
eare for knowledge for its own sake, then I have nothing to say
...
pain, are the only things desirable as ends’ (p. 107); and again,
...
is upso facto the motive of our actions, and there can be no
...
then be according to him tpso facto its rule; there can be no
...
the Gorgias1, that he has made this fatal admission through
...
in, in this way. The zdea of the drinking causes a feeling of
...
_ that what we want is always pleasure.
...
that it 1s a chair, and that is enough to content us, although
...
because we are agreed onit. In short, our dissatisfaction in these
...
Accordingly, I do not think we need be much deere
...
in pleasures.’ ‘If I am asked, says Mill’, ‘what I mean by
...
Now we see from this that Mull acknowledges ‘quality of
...
colour—blue, red, green, ete. Even in this case, if we are to
...
the other. Yet the opposite of this is what Mull is attempting
...
_ conform equally to this, the only standard, you can have no
...
now invite attention are to be found in I. 1x. 4 and in IIL
XIV. 4—5.

The first of these two passages runs as follows:

“J think that if we consider carefully such permanent results
...
ends, or at least as objects of scientific or esthetic contemplation
...
means that in our present state, im which but a very small
...
“Tt may be said,’ says Prof. Sidgwick (III. xv. §§4—5), “that
...
considered apart from any relation to conscious existénce. Ad-
...
ness to general happiness should be the criterion for peowog
...
Protarchus. Ido. The consequence is absolutely necessary.
...
_ Socrates, we see, persuades Protarchus that Hedonism is
...
_as yet, not nearly so strong. It is far more possible that we
...
another question how far that end may be attainable by ttself,
...
value we should attach to it, if 1t existed in absolute isolation,
...
that pleasure was a good eriterion of right action—that the
...
Good does not meet the facts of intuition, As, on the contrary,
...
each distinguishable quality, in rsolation, in order to decide what
...
_sometimes the best means to this end will be to give pleasure
...
59. Ishall say more later about this second kind of Egoism,
...
Sidgwick points this out (111. xiv. § 5, Div. 111.), he should have also
...
is what J think good, the same still holds: for what I think is
that my possession of it is good simply; and, if I think rightly,

Ti] HEDONISM 99

then the truth is that my possession of it 7s good simply—not,
...
me; any more than a thing can ewist privately or for one person
...
another’s happiness is not for him all-important’ (Iv. i. § 1).
...
‘not for others’; and if it implies ‘not for others,’ then 1t cannot
...
61. Itshould be observed that, since this is so, ‘the relation
of Rational Egoism to Rational Benevolence,’ which Prof.
Sidgwick regards ‘as the profoundest problem of Ethics’
(111. xiii. § 5, n. 1), appears in quite a different light to that in
...
so regarded. The chief reason for adopting the name ‘ Utilita-_
...
to assume them tv mean that the possession of pleasure by
...
point out the errors in his arguments (86-38). (2) Mill’s
...
two errors (89-44). (8) Hedonism is considered as an ‘Intu-
...
it is an Intuition and that it is a false one (46-48); (0) that
...
not therefore parts of Nature, and which, in fact, do not ezist at
...
CHAP. Iv] METAPHYSICAL ETHICS UE

_ duration, and begin and cease to exist—can be objects of per-
...
at least ewist elsewhere, if it is to be at all—that, whatever does
