---
source: "https://archive.org/details/dialoguesplatot01platgoog"
title: "The dialogues of Plato"
author: "B. Jowett"
year: "1876"
captured_at: "2026-07-06T10:50:35Z"
updated_at: "2026-07-06T10:50:35Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Symposium"
plain_text_url: "https://archive.org/download/dialoguesplatot01platgoog/dialoguesplatot01platgoog_djvu.txt"
public_domain: true
...
- 著者: B. Jowett
- 初版: 1876
- 情報源: [archive](https://archive.org/details/dialoguesplatot01platgoog)
- パブリックドメイン: ✓
...
MASTER  or   BALLIOL  COLLBGB;    RBGIUS  PKOPBSSOK  OF  GRSmX   IN  THE  UNIVERSITY  Of  OXFORD
DOCTOR  IN  THBOLOCY  OF  THE  VNIVBRSITT  OF  LBYDEM ;    LL.  D.  OF  THE  UNIVERSITIES

OF  EDINBURGH  AND  CAMBRIDCK

IN    FIVE   VOLUMES:    VOL.  IV.

nmiM  anb  CorrecteH  (drrouobout

WITH  MARGINAL  ANALYSES  AND  OTHBR  ADDITIONS,  AND  AN
INDBX  OF  SUBJBCT8  AND  PROPER  NAMBS
...
The  awe  with  which  Plato  regarded  the  character  of  'the  PamuMtdes.
great'  Parmenides  has  extended  to  the  dialogue  which  he  calls  intuoduc-
...
suasion he  is  induced  to  favour  the  Clazomcnians/  who  come  from
...
The  genuineness  of  Ou  Parmenides.
...
not  asserted,  and  is  therefore  implicitly  denied  in  the  Philcbus ;
...
Plato's  writings,  with  the  exception  of  the  Mcno,  the  Phaedrus,
...
offer  any  answer  to  them.  The  perplexities  which  surround  the  Parmenidex.
one  and  many  in  the  sphere  of  the  Ideas  are  also  alluded  to  in  the  ixtrodu c-
...
Ccphalus  :  can  we  do  anything  for  you  in  Athens  ?  '  *  Why,  yes :
...
last  here ;  — I  know  his  father's,  which  is  Pyrilampcs.'  *  Yes,  and
...
Parmenides.  at  the  ^cat  Panathenaea,  the  former  being  at  the  time  about
...
members,  am  yet  also  one,  and  partake  of  the  one,  being  one  of    Parmunides.
seven  who  are  here  present  (cp.  Philebus  14,  15).     This  is  not    analysis.
an  absurdity,  but  a  truism.     But  I  shoilld  be  amazed  if  there  were
...
Pythodorus  said  that  in  his  opinion  Parmenidcs  and  Zeno  were
...
lo  Aftalysis  I3i-I33-

ParmeHides.  foUow.*  *And  would  you  like  to  say  that  the  ideas  are  really
...
One  of  us  has  a  slave ;  and  the  idea  of  a  slave  in  the  abstract  is    Parmenides.
...
particular.  But  the  ideas  themselves  arc  not  subjective,  and
therefore  arc  not  within  our  ken.*  *Thcy  are  not.*  *Then  the
beautiful  and  the  good  in  their  own  nature  arc  unknown  to  us  ? '
*It  would  seem  so.*  'There  is  a  worse  consequence  yet.*  'What
is  that?  *  '  I  think  wc  must  admit.that  absolute  knowledge  is  the
...
'^ZS  ^^^®  ^^  ours.*  '  Yet,  surely,  to  deprive  God  of  knowledge  is  mon-
...
wonderful  gifc ;  but  I  fear  that  unless  you  discipline  yourself  by
...
But  they  appear  to  him,  as  he  says  in  the  Philcbus  also,  to  be
...
and  displeasure.  He  was  going  out  of  the  received  circle  of  dis-  Parmtnides.
...
something  wider  and  deeper  than  satisfied  the  contemporar>'
...
14,  with  the  teaching  of  Socrates  in  Plato,

ParmenieUs.     the  greatest?    Parmenldes  rebukes  this  want  of  consistency  in
Introduc-       Socrates,  which  he  attributes  to  his  youth.     As  he  grows  older,
TioN.  philosophy  will  take  a  firmer  hold  of  him,  and  then  he  will  despise
...
The  other  criticism  of  Parmcnides  on  Socrates  attributes  to  him
...
at  Megara  or  elsewhere,  with  the  Elcatic  and  Megarian  philo-
...
that  which  is  the  subject  of  the  hypothesis,  and  to ^11  other  things.
...
which  examples  arc  given  in  the  Politicus  and  in  the  Sophist.  It
...
not  only  of  the  morrow,  but  of  all  after-ages  on  the  Platonic  Ideas.    Parmenides.
...
are  in  our  minds  only.'  Neither  realism  i^  the  truth,  nor  nomi-
...
universal  as  well  as  in  particulars.
...
mind,  afler  having  obtained  a  general  idea,  does  not  really  go  on
to  form  another  which  includes  that,  and  all  the  indiAriduals  con-
...
thought.  No  such  perplexity  could  ever  trouble  a  modem  meta-
...
more  under  the  necessity  of  separating  the  divine  from  the  human,    ParmenitUs.
...
imagine  similar  awopiai  raised  on  themes  as  sacred  to  us,  as  tho
...
Parmenides  speaks  of  a  similar  tnethod  being  applied  to  all  Ideas.
...
and  Hcracleitus,  may  have  seen  that  a  contradiction  in  terms  is
...
After  criticizing  the  hypotheses  of  others,  it  may  appear  pre-  Pmrminides,
sumptuous  to  add  another  guess  to  the  many  which  have  been
akeady  offered.  May  we  say,  in  Platonic  language,  that  we  still
...
is  applied  in  thb  instance  to  Zeno's  familiar  question  of  the  '  one
and  maiiy.'  Here,  then,  is  a  double  indication  of  the  connexion
...
some  of  them  had  given  what  Arisfotle  calls  '  a  form,'  others  had
...
ii.  aa.  If  one  b  not  one,  other  things  are  all  (164  B  —  165  £).
ii.  bb.  If  one  has  not  being,  other  things  are  not  (165  £  to
the  end).
...
137  *I  cannot  refuse,' said  Parmenides,  'since,  as  Zeno  remarks,  a.nalysis.
we  are  alone,  though  I  may  say  with  Ibycus,  who  in  his  old  age
fell  in  love,  I,  Uke  the  old  racehorse,  tremble  at  the  prospect  of
...
b  not  a  whole,  which  b  a  sum  of  parts,  and  therefore  has  neither
beginning,  middle,  nor  end,  and  is  therefore  unlimited,  and  there-

22  Analysis  137-140.

Parmenitits.  fore  formless,  being  neither  round  nor  straight,  for  neither  round
Analysis.  nor  Straight  can  be  defined  without  assuming  that  they  have  parts ;  i^g
...
is  capable  cither  of  motion  or  rest.  For  motion  is  either  change
...
parts.  The  one,  then,  is  incapable  of  motion.  But  neither  can  j^g
...
same  are  different.  And  one  having  any  affection  which  is  other  1^0
...
or  other;  nor  can  the  one  have  any  other  affection  than  its  own,  Parmenidts.
...
141  equality  and  inequality.  Therefofe  one  cannot  be  in  time,  because
...
with  itself.  None  of  which,  or  any  other  expressions  6f  time,
...
1^9  the  one,  if  it  is,  becomes  many  and  infinite.  Again,  let  us  con-
...
Parmemde*.     both  partake  of  the  nature  of  other,  which  is  therefore  neither

Analysis.       ^^^  ^^^  being ;  and  whether  we  take  being  and  other,  or  being
...
we  have  even  numbei's  multiplied  into  even,  and  odd  into  even,
...
not  the  same  with  itself  and  other.     For  everything  in  relation    Pamunides.
...
the  other,  this  very  word  other  (trepov)^  which  is  attributed  to  both,

I  jg  implies  sameness.  One,  then,  as  being  other  than  others,  and
...
And  everything  as  being  other  of  everything  is  also  like  ever>'-
...
Parmenidis.  therefore  not  unlike,  and  therefore  like;  or,  as  having  different
...
two,  and  in  two  places.  But  one  cannot  be  two,  and  therefore  ij^q
...
be  exceeded  by  the  others,  and  they  are  therefore  equal  to  one    Parmenidet.
another.     And  this  will  be  true  also  of  the  one  in  relation  to    analysis.
itself:  one  will  be  equal  to  itself  as  well  as  to  the  others  (to^Xo),
...
in  future  time.  And  as  time  is  ever  moving  for>vard,  the  one
...
Parmmidis.  younger  Cannot  become  older  or  younger  in  a  greater  degree  than
...
there  must  be  a  time  of  transition.  And  the  transition  is  a  1^5
...
The  others  are  other  than  the  one  because  they  have  parts,  for  if    ParmtnUes.

they  had  no  parts  they  would  be  simply  one,  and  parts  imply  a    Analysis.
...
a  part  of  one,  must  be  apart  of  all  but  this  one,  and  if  so  not  a  part
...
separated  fi'om  others  and  has  no  parts,*  and  therefore  the  others
...
j5q  some  and  other,  generation  and  corruption,  odd  and  even.  For  if
...
Farmenidts,     all  things,  and  likewise  nothing,  in  relation  to  one  and  to  the
...
though  non-existent  may  and  must  have  plurahty,  if  the  one  only
...
must  be  like  itself;  for  the  unUkeness  of  one  to  itself  is  the
...
becomes  and  is  destroyed,   and  does  not  become  and  is  not   Parmenides.
...
jg^  not  be  the  one,  nor  the  many,  for  in  that  case  the  one  would  be
...
*  not  many.'  Yet,  perhaps,  if  a  strict  Eristic  had  been  present,  oio^
dvijp  £1  Kai  vi/v  irap^v,  he  might  have  affirmed  that  the  not  many  pre-
...
II.  In  tht  first  series  of  propositions  the  word  '  is '  is  really  the
...
now  everything  —  multitude,  relation,  place,  time,  transition.  One  Parmenidtt.
is  regarded  in  all  the  aspects  of  one,  and  with  a  reference  to  all  introduc-
...
quid  ad  dictum  simplicitcr'  and  conversely:  (5)  The  analogy  of
...
is  real,  or  in  any  way  an  assistance  to  thought,  or,  hke  some  other    ParmtHkUt.
logical  forms,  a  mere  figure  of  speech  transferred  from  the  sphere    introdix-
...
are  related  to  indfviduals  or  to  the  ideas  of  the  divine  mind,  they
...
The  true  answer  to  the  difficulty  here  thrown  out  is  the  estabhsh-
...
extended  to  Ideas:  (3)  Thedifficulty  of  participating  in  greatness,
...
The  attack  upon  the  Ideas  is  resumed  in  the  Philebus,  and  is  Parmenides.
...
of  the  language,  in  which,  as  in  some  curious  puzile,  each  word
...
process  of  purg^ation,  which  Bacon  sought  to  introduce  into  philo-
...
Den';  first,  his  own  Ideas,  which  he  himself  having  created  is  ParmenitUs.
unable  to  connect  in  any  way  with  the  external  world ;  secondly,  introduc-
...
earlier  dialogues  the  Socracic  conception  of  universals  is  illus-
...
Metaphysics  required  to  place  us  above  metaphysics,
...
profess  to  base  truth  entirely  upon  £act.  In  an  un  metaphysical
age  there  is  probably  more  metaphysics  in  the  common  sense
(i.  e.  more  a /nan  assumption)  than  in  any  other,  because  there
...
philosophers  by  '  force/  which  seems  to  be  accepted  without  any  Pamunidet.
...
perfect  representation  of  our  meaning.  In  Uke  manner  when
...
from  bis  thoughts  than  scepticbm  (cp.  135  B,  C).  But  before
...
derived  from  the  two-fold  translation  of  the  Greek  owrta.
...
individual,  for  He  is  universal ;  and  that  every  possible  conception  ParmenuUt.
...
but  not  like  ourselves ;  a  mind,  but  ncft  a  human  mind ;  a  cause,
...
understood  by  Os,  and  less  liable  to  be  shaken,  because  we  are
...
steph.     We  had  come  from  our  home  at  Clazomenae  to  Athens,  Pamunides.
'2^  and  met  Adeimantus  and  Glaucon.  in  the  Agora.     Welcome,  Ckphalus,
...
remembers  a  conversation  which  took  place  betwjcen  So-
...
*  Rcdtictio  ad  ivipossibile '  of  the  'plurality  of  being'
...
Accordingly  we  went  to  look  for  him  ;  he  was  at  home,  and  1 27
...
the  dialogue.  At  first  he  was  not  ver)'  willing,  and  complained
...
their  visit.  These  Zeno  himself  read  to  them  in  the  ab.sence
of  Parmenides,  and  had  very  nearly  finished  when  Pytho-
dorus entered,  and  with  him  Parmenides  and  Aristoteles
who  was  aften^-ards  one  of  the  Thirty,  and  heard  the  little
...
again,  and  this  having  been  done,  he  said :  WTiat  is  your
...
other  purpose  except  to  disprove  the  being  of  the  many?  and  Socrates,
is  not  each  division  of  your  treatise  intended  to  furnish  a  ^**^°"
separate  proof  of  this,  there  being  in  all  as  many  proofs  of  "ni»kcatthc
the  not-being  of  the  many  as  you  have  composed  arguments?  which  is  am-
is that  your  meaning,  or  have  I  misunderstood  you?  possible.
128       No,  said  Zeno ;  you  have  correctly  understood  my  general
purpose.

I  see,  Parmenides,  said  Socrates,  that  Zeno  would  hke  to  'The many

be  not  only  one  with  you  in  friendship  but  your  second  self  oIi!iy"another

in  his  writings  too ;  he  puts  what  you  say  in  another  way,  way  of  ex-

and  would  fain  make  believe  that   he  is   telling  us  some-  JhTihl^isof
...
of  this  he  offers  overwhelming  e\'idence.  You  affirm  unity,
...
as  a  Spartan  hound  in  pimjuing  the  track,  you  do  not  fully  *''*"**'"8'
...
the  hypothesis  of  the  being  of  one.  Zeal  for  my  m^ter
...
Parwenidts.     Socratcs ;   though  in  other  respects,  as  I  was  saying,  your

Socrates,       notion  is  a  very  just  one.

Zeno.  J  understand,  said  Socrates,  and  quite  accept  your  account.
...
betw«n  abso-  jjj^g  ^q  bccome  uulike,  or  the  absolute  unlike  to  become  like,

lute  ideas  or  '  '

natures,  and  that,  in  my  opinion,  would  indeed  be  a  wonder ;  but  there
which*"'r  ^^  nothing  extraordinary,  Zeno,  in  showing  that  the  things
...
Socrates,  he  said,  I  admire  the  bent  of  your  mind  towtirds
...
things  which  participate  in  them  will  have  a  part  of  them  ParmttOdts,
only  and  not  the  whole  idea  existing  in  each  of  them?  Socrates,

That  seems  to  follow.  Parm«.,dks.
...
Suppose   that  you  divide  absolute  greatness,  and  that  of  norcanob-
the  many  great  things,  each  one  is  great  in  virtue  of  a  ^^^^f
...
thmg  by  virtue  of  that  portion  only?  ^dkbnS^

Impossible.  a  part  of

Or  suppose  one  of  us  to  have  a  portion  of  smallness ;  this  ^^^^0^
is  but  a  part  of  the  small,  and  therefore  the  absolutely  small  «m*Uncs5.
...
132  idea  of  each  kind  is  as  follows: — You  see  a  number  of  great  Jj^^Jj^
objects,  and  when  you  look  at  them  there  seems  to  you  to  be  uation.
...
recognizes  as  attaching  to  aU,  being  a  single  form  or  nature?
...
idea  also  be  like  the  individual,  in  so  far  as  the  indi\ndual  is
a  resemblance  of  the  idea?  That  which  is  like,  cannot  be
conceived  of  as  other  than  the  like  of  hke.
...
And  will  not  that  of  which  the  two  partake,  and  which  ParmntUUs.
makes  them  alike,  be  the  idea  itself?  Socrates,

Certainly.  Parmehides.

Then  the  idea  cannot  be  like  the  individual,  or  the  indi-
vidual like  the  idea ;  for  if  they  are  alike,  some  fiuther  idea
133  of  likeness  will  always  be  ooming  to  light,  and  if  that  be  like
anything  else,  another ;  and  new  ideas  will  be  always  arising,
if  the  idea  resembles  that  which  partakes  of  it?

Quite  true.

The  theory,  then,  that  other  things  participate  in  the  ideas  ReaemWance
...
And,  fiuther,  let  me  say  that  as  yet  you  only  understand  a
small  part  of  the  difficulty  which  is  involved  if  you  make  of
eacTi  thing  a  single  idea,  parting  it  off  from  other  things.
...
resemblances,  or  whatever  they  are  to  be  termed,  which  are   ^semWances

^  in  our  sphere

m  our  sphere,  and  from  which  we  receive  this  or  that  name  are  related
when  we  partake  of  them.  And  the  things  which  are  within  '^^j^^
oiu*  sphere  and  have  the  same  names  with  them,  are  likewise  only  and
...
with  oiu^elves.     Do  you  see  my  meaning?
...
What  is  it?  Pamunidet.

Would  you,  or  would  you  not  say,  that  absolute   know-  Socratbs,
ledge,   if  there  is  such   a  thing,  must  be  a  far  more  exact  ^^"^•■'"'^■s-
...
And  if  there  be  such  a  thmg  as  participation  in  absolute  But  if  so,  he

knowledge,  no  one  is  more  likely  than  God  to  have  this  most  *^^°!?°^^^*

exact  knowledge  ?  ^r  human
...
will  deny  the  very  existence  of  them  —  and  evfen  if  they  do
...
The  double  method  of  cotisequences
...
And  what  is  the  natiu'e  of  this  exercise,  Parmenides,  which
you  would  recommend?
...
go  a  step  fiuther,  and  consider  not  only  the  consequences
...
of  Zeno's  about  the    many,  you    should  enquire  not  only  Parmumdts.
what  will  be  the  consequences  to  the  many  in   relation  to  Socrates,
themselves  and  to  the  one,  and  to  the  one  in  relation  to  itself  Jarmbnides,
...
speak,  and  I  do  not  quite  understand  you;    will  you  take  ^^J^^^^^
some  hypothesis  and  go  through  the  steps? — then  I  shall  this  process.
apprehend  you  better.

That,  Socrates,  is  a  serious  task  to  impose  on  a  man  of  my  Pamenides
vears  '^  ^^  ^^^  ^'^
...
are  hardly  aware  of  the  extent  of  the  task  which  you  are  *«»*<i"«*«of
...
If  one  is,  what  are  tlu  consequences  ?

teles  and  the  whole  company  entreated  Parmenides  to  gxvt
...
If  one  has  partSy  what  are  the  consequences?  59

Then,  if  the  one  is  to  remain  one,  it  will  not  be  a  whole,  ParmtHku*,
and  will  not  have  parts?  Parmenidbs,

j^Q  Akistotklbs.

But  if   it  has  no    parts,  it  will   have    neither  beginning,  *ndhfvingno
middle,  nor  end ;  for  these  would  of  course  be  parts  of  it.         not  have  a
Right.  ^ft^""**.

"  ,  middle,  and

But  then,  again,  a  beginning  and  an  end  are  the  limits  of  end:  nor
everything?  ^y^»^
...
points  are  equidistant  from  the  centre?  SS*^"^
...
And,  being  of  such  a  natiu'e,  it  cannot  be  in  any  place,  for  it  does  not
it  cannot  be  either  in  another  or  in  itself.  ****'  *f
...
Further  consider,  whether  that  which  is  of  such  a  natiu^e
...
Why,  because  anything  which  comes  into  being  in  any-  Pmmumdet,
thing,  can  neither  as  yet  be  in  that  other  thing  while  still  Parmsmidbs,
coming  into  being,  nor  be  altogether  out  of  it,  if  already  am'^'^'tblbs.
...
has  no  parts,  and  is  not  a  whole,  coming  into  being  anjrwhere,
...
Yes,  we  said  so.  one  i.  never

'  u  the  same

Then  \\  y;  npvpr  in  the  same?  any  more

Why  not?  '  ^-:^

Becausejlit  wer<i  in  the  "inmcU  would  be  in  something.        u  therefore
...
Impossible.  Pamutudis.

And  thus  the  one  can  neither  be  the  same,  nor  other,  either  Pakmsmides,
in  relation  to  itself  or  other?  aristoteles.

"Mo  no»"  y«'  ^«-

ness,  which

Neither  will  the  one  be  like  anything  or  unlike  itself  or  other,  u  sameness  of

Why  not?  affections:  not
...
Again,  being  of  this  nature,  it  can  neither  be  equal  nor  norequaUty,
unequal  either  to  itself  or  to  other.  of  lii^T*"*""^
...
Farmenides.     with  it,  the  ODC  Will  havc  morc  measures  than  that  which  is
parmbmdks*    less,  and  fewer  than  that  which  is  greater?
...
And  not  having  the  same  meastu'es,  the  one  cannot  be
...
measiure ;  yet  it  has  been  shown  to  be  incapable  of  equality.
...
orinequaihy     y^^^^^^  ^^^  anything,  or  of  the  same  age  with  it?
...
Then  one  cannot  be  older  or  younger,  or  of  the  same  age,   ParmeHideu
either  with  itself  or  with  another?  Parmbmdbs,

Clearly  not.  Akistotkles.

Then  the  one,  being  of  this  hature,  cannot  be  in  time  at  "°'  ^"™*'
all ;  for  must  not  that  which  is  in  time,  be  always  growing
older  than  itself?

Certainly.

And  thaf  which  is  older,  must  always  be  older  than  some-
...
66  The  original  hypothesis.

Pamunides.         Then  it  does  not  partake  of  time,  and  is  not  in  any  time?
Parmenidbs,        So  the  argimient  shows.

Aristoteles.       Well,  but  do  not  the  expressions  *  was,'  and  *  has  become,'
nor  modes       ^jj^  i  ^^s  becoming,'  signify  a  participation  of  past  time?

Certamly.

And -do  not  'will  be,'  *will  become,'  *will  have  become,*
sigm'fy  a  participation  of  future  time?
Yes.
...
But  these  But  are  there  any  modes  of  partaking  of  being  other  than

are  the  only        j^ese?
modes  of  par-  ^^^

taking  of  be-         There  are  none

i^and  tf  Then  the  one  cannot  possibly  partake  of  being?

denied  of  it.         That  is  the  inference.

then  the  one  jj^^^  ^^  ^^^  jg  ^^^  ^^  ^jjp

IS  not,  and  has

therefore  no  Clearly  not.

attribute  or  Then  the  one  does  not  exist  in  such  way  as  to  be  one:
...
So  we  must  infer.
Thecondu.  But  can  all  this  be  true  about  the  one?
...
original  hypothesis ;  let  us  see  whether,  on  a  further  review,  Purmemda.
any  new  aspect  of  the  question  appears.  Parmbnidks,

I  shaU  be  very  happy  to  do  so.  aristotelm.

We  say  that  we  have  to  work  out  together  all  the  con-  ».^i>a«wiii
...
Then  the  one  will  have  being,  but  its  being  will  not  be  the  Theoncwhich
same  with  the  one;  for  if  the  same,  it  would  not  be  the  "f^J^^*^*
being  of  the  one;  nor  would  the  one  have  participated  in  wUi therefore
being,  for   the    proposition  that  one  is  would    have  been  ^^,^J3^
identical   with   the  proposition   that   one  is   one;    but  our  being:
...
Does  riot  this  hypothesis  necessarily  imply  that  one  is  of  ^°"f^*^
such  a  nature  as  to  have  parts?  parts  of  itxif:
...
assimied,  is,  must  not  the  whole,  if  it  is  one,  itself  be,  and
...
One  apart  from  beings  still  implies  plurality.
...
diflFer  from  one  another  in  virtue  of  otherness  and  difference.
...
such  case  we  take  two  things,  which  may  be  rightly  called  Pamunuu*.
...
Well,  and  when  I  speak  of  being  and  one,  I  speak  of  them  Tnmndon
both?  ^^^'^
...
Then,  if  the  individuals  of  the  pair  are  together  two,  they  iromoddto
must  be  severaUy  one ?  cvcnnumbefs,
...
are  three  there  must  be  thrice ;  that  is,  if  twice  one  makes  ^  ^"^opu-
...
Pmrm^mdeM.         Here,  then,  we  have  even  taken  even  times,  and  odd  taken  144
Parmbnidss,    odd  times,  and  even  taken  odd  times,  and  odd  taken  even'
...
difierence,  But  if   there  is  number,  there  must  also   be  many,   and

J^^JI^        infinite  multiplicity  of  being ;  for  number  is  infinite  in  multi-
number  of       plicity,  and  partakes  also  of  being:  am  I  not  right?
•^^~**'  Certainly.

I      And  if  all  number  participates  in  being,  every  part  of
\  number  will  also  participate?
Yes.
and  number         Then  being   is  distributed  over  the  whole  multitude  of
"•Abeb**^^  things,  and  nothing  that  is,  however  small  or  however  great,
ia  devoid  of  it?     And,  indeed,  the  very  supposition  of  this  is
...
Contradictory  aspects  of  the  One,  71

And  if  not  in  its  entirety,  then  it  is  divided ;  for  it  cannot  Pamunides.
be  present  with  all  the  parts  of  being,  unless  divided.  parmbnidbs,
...
Then  we  were  wrong  in  saying  just  now,  that  being  was  ^'^''^fL
...
one  itself  distributed  by  being,  must  also  be  many?  MU»rone"

Certainly.  which  i»,  u

Further,  inasmuch  as  the  parts  are  parts  of  a  whole,  the  ^^^l^^
145  one,  as  a  whole,  will  be  limited;  for  are  not  the  parts  con-  and  infinite,
tained  by  the  whole?
...
But,  again,  the  middle  will  be  equidistant  from  the  ex-  ^*i,S**Md
...
Then  the  one  will  partake  of  figure,  either  rectihnear  or
...
And  the  one  is  all  its  piu-ts,  and  neither  more  nor  less
than  all?
...
is  wanting  is  one  of  all,  ai^  if  the  whole  is  not  in  this,  how
...
nor  in  all  of  the  parts,  it  must  be  in  something  else,  of  cease
...
regarded  as  being  all  its  parts,  is  in  itself ;  and  therefore  the  Pawumdes,
one  must  be  itself  in  itself  and  also  in  another.  Parmbnidbs,

Certainly.  Aristotblbs.

The  one  then,  being  of  this  nature,  is  of  necessity  both  at  PlJ"*  .
rest  and  in  motion?  both  at  rest

How?  and  in  mo-

uon :  at  rest.

The  one  is  at  rest  smce  it  is  in  itself,  for  being  in  one,  and  if  in  itself:  in
146  not  passing  out  of  this,  it  is  in  the  same,  which  is  itself.  !^o*th»*^"*
...
same  or  other;  or  if  neither  the  same  nor  other,  then  in  the  '«^'>j^of
...
relation  to  itself,  must  it  not  be  the  same  with  itself?  ***^?*'*!u
...
Parmenides.     '  itsclf,*  if  this  '  itsclf '  Tcmains  in  the  same  place  with  itself,

Parmknidbs,    must  be  other  than  'itself,*  for  it  will  be  in  another  place?
Aristotblbs.        True

Then  the  one  has  been  shown  to  be  at  once  in  itself  and
in  another?
Yes.
butfueidst.        Thus,  then,  as  appears,  the  one  will  be  other  than  itself?
...
Certainly.
The  one  is  And  will  uot  all  things  that  are  not  one,  be  other  than  the

ahnodi^^  One,  and  the  one  other  than  the  not-one?

the  not-one  Of  COUrse.

"^o^         Then  the  one  wiU  be  other  than  the  others?

True.

But,  consider: — Axe  not  the  absolute  same,  and  the  abso-
lute other,  opposites  to  one  another?

Of  course.
Yet  fiom  an-        Then  will  the  same  ever  be  in  the  other,  or  the  other  in
otherpointof    the  Same?

vtew  neitho"

the  one  nor  They  will  nOt.

ain  muru^e  ^^  ^^^^  ^^  Other  is  never  in  the  same,  there  is  nothing  in

of  otherness,  which  the  Other  is  during  any  space  of  time ;  for  during  that

«innoI^***  space  of  time,  however  small,  the  other  would  be    in   the

other  than  Same.     Is  uot  that  truc?
...
in  contact y  yet  not  in  contact ;  T^

Certainly.  Parmemdes.

And  in  that  it  was  other  it  was  shown  to  be  like?  Parmemidbs,
...
otherwise,  and  not  being  affected  otherwise  is  not  imlike,  and  ^*"J°*^^*^
not  being  unlike,  is  like ;  but  in  so  far  as  it  is  affected  by  consequences
other  it  is  otherwise,  and  being  otherwise  affected  is  imlike.       ^*^**^
...
others?- consider.  X^ll^^

I  am  considering.  bothitsdf
...
the  whole  nmnber  of  contacts  by  one  in  like  manner ;  and
for  every  one  which  is  afterwards  added  to  the  number  of
terms,  one  contact  is  added  to  the  contacts.

True.

Whatever  is  the  whole  niunber  of  things,  the  contacts  will
be  always  one  less.
...
How  could  they?
1 50       If,  then,  smallness  is  present  in  the  one  it  will  be  present
...
it  cannot  either  exceed  or  be  exceeded  by  them?  Pahmenides,
...
thus  be  greater  and  less  than  itself.  b^lTl^

It  will.  i«  therefore

Now  there  cannot  possibly  be  anything  which  is  not  in-  £^|^*"**
eluded  in  the  one  and  the  others?  «t»eJf.
...
the  others,  and  they  must  be  in  something,  must  they  not  be  °*"^j~***]
in  one  another,  the  one  in  the  others  and  the  others  in  the  tains  and  is
one,  if  they  are  to  be  anywhere?  ZSTanV"
...
inasmuch  as  the  others  are  in  the  one,  the  9ne  on  the  same
...
But  to  be  {Aval)  is  only  participation  of  being  in  present  Parmenides.

152  time,  and  to  have  been  is  the  participation  of  being  at  a  past  Parmenides,

time,  and  to  be  about  to  be  is  the  participation  of  being  at  a  ^^s^^^*-^

future  time?  '^*?"!i**

and  therefore
Very  true.  partakes  of

Then  the  one,  since  it  partakes  of  being,  partakes  of  time?  *!"*•  f°**.

'  ^  o»  x-  since  tunc  is

Certainly.  always  mov.

And  is  not  time  always  moving  forward?  hb«omM^*
...
Then  since  the  one  becomes  older  than  itself,  it  becomes  But  older  and
younger  at  the  same  time?  S.3.^.

Certainly.  and  therefore

Thus,  then,  the  one  becomes  older  as  well  as  younger  than  ^J^ij!^
...
And  it  is  older  (is  it  not?)  when  in  becoming,  it  gets  to  the  than  itself,
point  of  time  between  *  was  *  and  '  will  be,*  which  is  *  now  * :
for  siurely  in  going  from  the  past  to  the  future,  it  cannot  skip
the  present?

No.

And  when  it  arrives  at  the  present  it  stops  from  becoming  One  becomes
older,  and  no  longer  becomes,  but  is  older,  for  if  it  went  on  ^^"J*^"
it  would  never  be  reached  by  the  present,  for  it  is  the  nature  now  or
of  that  which  goes  on,  to  touch  both  the  present  and  the  2!^t''
futmre,  letting  go  the  present  and  seizing  the  future,  while  in  ceases  to

c  \  •        t     .  ^i_  become  and

process  of  becoming  between  them.  i^  ^,1^^.
...
Then  the  one  is  yoimger  than  itself,  when  in  becoming
...
Then  the  one  of  all  things  that  have  number  is  the  first  to  Pahmbnides,
come  into  being ;  but  all  other  things  have  also  number,  being  ^"stoteles.
...
if  parts,  then  a  beginning,  middle  and  end?  J^Tnlo
...
to  come  into  being  with  the  last ;  and,  since  the  one  cannot  JhTn'Sjc"**'
...
and  according  to  this  argument  the  one  will  be  neither  older  1 54
nor  yoimger  than  the  others,  nor  the  others  than  the  one,  but
...
Just  as  the  one  was  proven  to  be  older  than  the  others  PantuHtde*.
and  the  others  than  the  one.  Parmknidbs,

And  what  of  that  ?  Aristotblbs.
...
a  less  time,  will  the  greater  differ  from  the  less  time  by  an  ^^^^td  to

equal  or  by  a  smaller  portion  than  before  ?  .  a  greater

By  a  smaUer  portion.  '^^^

Then  the  difference  between  the  age  of  the  one  and  the  ference  be-

age  of  the  others  will  not  be  afterwards  so  great  as  at  first,  JminWieB?

but  if  an  equal  time  be  added  to  both  of  them  they  will  differ  and  «©  the

1  J  1  *  •%  one,  which

less  and  less  m  age?  i,  J^er,  wiu

Yes.  '  by  such  ad-

And  that  which  differs  in  age  from  some  other  less  than  younger  t^*
formerly,  from  being  older  will  become  younger  in  relation  A*  others,
to  that  other  than  which  it  was  older?  ^n,  owL"*
...
older,  ^nd  the  older  younger  than  the  younger.  They
...
becoming  older  and  yoimger,  must  it  not  also  partake  of
...
But  can  it  partake  of  being  when  not  partaking  of  being,  or  Pamunid**.
not  partake  of  being  when  partaking  of  being?  parmenides.

Impossible.  ^  Aristotelks.

Then  the  one  partakes  and  does  not  partake  of  being  at  T***  ?"*  *""*'

*  *-     ,  ,     °  therefore  par-

different  times,   for  that  is  the  only  way  m  whtch  it  can   uke  of  being
...
I  c6       And  is  there  not  also  a  time  at  which  it  assumes  being  and  **"*  ^\  ^'
...
certain  states  of  motion  and  rest,«ind  neither  is  nor  is  not,
...
If  one  is  J  how  will  the  others  be  affected?  91

True.  ParmiHid*,.

All  these,  then,  are  the  affections  of  the  one,  if  the  one  has  Parmenidbs,
being.
Of  course.
...
that  also  to  be  considered?  oftheothen,if
...
others  are  not  the  one ;  for  if  they  were  they  could  not  be  ^J^JiI^on*^
other  than  the  one.  and  yet  th<y

Very  true.  i«rticipate  in

^  ^  the  one ;  for

Nor  are  the  others  altogether  without  the  one,  but  in  a  the  others  are
certain  way  they  participate  in  the  one.  ^Se  which
...
And  parts,  as  we  afiirm,  have  relation  to  a  whole?
...
must  participate  in  the  one ;  for  if  each  of  the  parts  is  a  part,  1 58
...
Let  us  look  at  the  naatter  thus: — Is  it  not  a  fact  that
...
They  do  so  then  as  multitudes  in  which  the  one  is  not  Parmbnides,
present?  awstotelks.
...
And  if  we  continue  to  look  at  the  other  side  of  their  nature,  The  odien
regarded  simply,  and  in  itself,  will  not  they,  as  far  as  we  see  JIJ^'l^cJ***
...
Then    they  are    both  like  and  imlike  one  another    and  wherefore
themselves.  S:^«

How  is  that?  unUke.

Inasmuch  as  they  are  unlimited  in  their  own  natiu'e,  they
...
Par$H«nides.     reference  to  both  of  them  together,  most  opposed  and  most

Paxmbnidbs,    imlike.

ARISTOTBL.S.       -That  appears  to  be  true.
...
Then  there  is  no  way  in  which  the  others  can  partake  of  ParmetUdes.
the  one,  if  they  do  not  partake  either  in  whole  or  in  part?  Parmenidss,

It  would  seem  not.  Aristotelks.

Then  there  is  no  way  in  which  the  others  are  one,  or  have
in  themselves  any  imity?

There  is  not.

Nor  are  the  others  many ;  for  if  they  were  many,  each  part  And  the
of  them  would  be  a  part  of  the  whole ;  but  now  the  others,  ^^j^*
...
Then  the  others  are  neither  like  nor  unUke  the  one,  nor  is  Nor  can  they
ikeness  and  unlikeness  in  them;  for  if  they  were  like  and  ^oppo«»*«:

'  ^       ■'  for  they  can-

unhke,  or  had  in  them  likeness  and  unlikeness,  they  would  noti>artake
...
Impossible.
160       Then  the  others  are  neither  like  nor  unlike  nor  botii,  for  if  The  others
...
Therefore  if  one  is,  the  one  is  all  things,  and  also  nothing,  au  things;
both  in  relation  to  itself  and  to  other  things.  nothb°

Certainly.  (141  e,  149).

96  The  one  which  is  not  differs  from  all  other  things,

PartHttudes,         ii.  a.  Well,  and  ought  we  not  to  consider  next  what  will
Parmbniobs.    be  the  consequence  if  the  one  is  not?
AR^TOTEurs.       Yes;  we  ought.

If  the  one  u         What  is  the  meaning  of  the  hypothesis  —  If  the  one  is  not ;
Aoar  ^  there  any  difference  between  this  and  the  h3rpothesis —  If
...
smaUness  is  not,  or  anything  of  that  sort,  does  he  not  mean,
...
What  u  the  And  SO  when  he  says  '  If  one  is  not '  he  clearly  means,

meaning  of      ^^^  ^\idX  *  is  not '  is  Other  than  all  others ;  we  know  what  he

•  the  one

which  is  not'?  meaus  —  do  we  not?

Yes,  we  do.
It  sometimes  When  he  says  *  one,*  he  says  something  which  is  known ;
3»n*or*^  and  secondly  something  which  is  other  than  all  other  things ;
feientfrom  it  mal^es  uo  difference  whether  he  predicate  of  one  being  or
andthcrSe  "ot-t>eing,  for  that  which  is  said  *  not  to  be  *  is  known  to  be
hasdiflRerence,  .Something  all  the  same,  and  is  distinguished  from  other  things.
^"^  Certainly.
...
could  not  have  been  spoken  of,  nor  could  any  attribute  or  parmenidbs,
relative  of  the  one  that  is  not  have  been  or  been  spoken  ^"stoteles.
...
be,  and  we  are  speaking  of  something  of  a  different  natiu-e,
...
And  it  will  have  unlikeness  in  relation  to  the  others,  for  the  it  u  unUke
others  being  different  from  the  one  will  be  of  a  different  kind.   *d**^7'
...
gS  //  is  unequal;  and  also  eqnaL

Pannrmdis.         Again,  it  IS  not  cqual  to  the  others ;  for  if  it  were  equal,  then

Parmenides,  it  would  at  once  be  and  be  like  them  in  virtue  of  the  equality ;

aristotkles.  Ij^^  j£  ^^^  Yi^  j^Q  being,  then  it  can  neither  be  nor  be  like?
Thconcwhich       It  cannot.

iii  not  IS  un-  ...

equal  to  ihc  But  since  it  IS  not  equal  to  the  others,  neither  can  the

othe«andthc  others  be  equal  to  it?
...
Of  course.
Butpaitak-  Then  the  one  partakes  of  inequality,  and  in  respect  of  this

ingofin-         tj^g  Others  are  unequal  to  it?

equality,  it  *■

partakes  also        Very  true.

and^Si»»s        ^"^^  inequality  implies  greatness  and  smallness?

and  therefore  YeS.

whkhHwbe-        'i'hen    the  one,  if    of  such  a  nature,  has  greatness  and

tween  them :      smallneSS  ?
...
Then,  as  would  appear,  the  one,  when  it  is  not,  is ;  for  if  parmenidbs,

it  were  not  to  be  when  it  is  not,  but  *  were  to  relinquish  aristotbles.

something  of  being,  so  as  to  become  not-being,  it  would  at  f**''  ^°'"*fi"^
...
But  can  anything  which  is  in  a  certain  state  not  be  in  that  But  10  be
state  widiout  changing  ?  ^*'  *'  r*'

^     o  change  from

Impossible.  one  to  the

Then  everything  which  is  and  is  not  in  a  certain  state,  ^iJ^^^^^
...
Now  that  which  is  immoved  must  surely  be  at  rest,  and
...
But  if  it  be  in  motion  it  must  necessarily  imdergo  altera-
...
And,  further,  if  not  moved  id  any  way,  it  will  not  be  altered
in  any  way?
...
Then  the  one  that  is  not  is  altered  and  \&  not  altered?
...
If  the  one  is  twt,  it  is  nothing  and  nowhere,  loi

That  is  clear.  Parmenides,

And  must  not  that  which  is  altered  become  other  than  it  Parmenidbs,
previously  was,  and  lose  its  former  state  and  be  destroyed ;  Aristoteles.
but  that  which  is  not  altered  can  neither  come  into  being  Jh«on«ti»«'

^    IS  not  becomcft

nor  be  destroyed?  and  is  de-

Very  true.  siroycd,  and
...
If  one  is  not,  we  ask  what  will  happen  in  respect  of  one?  ifoncUnot,
That  is  the  question.  ^^*'  '^^"  •

Yes.

Do  not  the  words  *  is  not '  signify  absence  of  being  in  that  Ms  not*  im-
...
the  assumption  of  being  and  the  loss  of  being?  ^^not^^iAcr

Nothing  else.  have  or  lose

And  can  that  which  has  no  participation  in  being,  either  ^j^)*™*
assiune  or  lose  being?
...
And  therefore  other  things  can  neither  be  like  or  imlike,
...
Then  the  one  that  is  not  has  no  condition  of  any  kin^d?
...
The  others  must  surely  be ;  for  if  they,  like  the  one,  were  ParmenuUs.
not,  we  could  not  be  now  speaking  of  them.  Parmbmdbs.
...
v»»x,  v^«Aik%,xw.v«  It  cannot

Yes.  mean  other

Then,  if  there  are  to  be  others,  there  is  something   than  ancTtherefore
...
And  it  would  seem  that  niunber  can  be  predicated  of  them
...
Conception  of  a  particle  witfiout  unity.
...
middle  truer  middles  within  but  smaller,  because  no  imity  can
...
And  so  must  the  particles  appear  to  be  like  and  unlike  ParmmuUx.
themselves  and  each  other.  Parmbnidbs,

Certainly.  a»istotbl«s.
...
will  follow.  then?    ITie

Let  us  ask  that  question.  "^^i^Z.
...
•  •.!  .      e        i  i_    •  ^1  •  i_ •   1     •      must  in  some

munion  with  any  sort  of  not-bemg,  nor  can  anything  which  is  ^.^^  partake
...
io6  The  conclusion  of  the  w/wle  matter,

Parmtnidts.         Then  if  One  is  not,  the  others  neither  are,  nor  can  be  con-
Parmbnides,    ceived  to  be  either  one  or  many?
ARISTOTBL.S.       Yx.  would  seem  not.

Nor  as  hke  or  unlike?

No.
Nor  are  they        Nor  as  the  Same  or  different,  nor  in  contact  or  separation,
like  or  unUke,  jjqj.  j^  ^^^  q£  those  States  which  we  enumerated  as  appearing

the  same  (»  '  **  ^

different  to  be ; — the  Others  neither  are  nor  appear  to  be  any  of  these,
if  one  is  not?

True.

Then  may  we  not  sum  up  the  argiunent  in  a  word  and  say
truly :  If  one  is  not,  then  nothing  is?

Certainly.

Let  thus  much  be  said;  and  fiuther  let  us  affirm  what
...
Theaet.  174  D,  E,  and  Soph.  227  A;  Theaet.  188  £,  and  Soph.
...
generalization  and  from  reflectioa  of  the  mind  upon  itself.  The
general  character  of  the  Theactetus  is  dialectical,  and  there  are
...
Better  retained  wJure  Plato  placed  it.

Ill

TION.

Again,  the  Theaetetus  may  be  connected  with  the  Gorgrias,  either  TfuatUHu.
...
called  the  Second  Platonic  Trilogy.  Both  the  Parmcnides  and  the
...
introduction  of  the  founder  of  the  Mcgarian  philosophy.  The  real
...
Theaetetus  a  real  person:   T/ieodorus.
...
Theodorus.  He  is  a  youthful  Socrates,  and  exhibits  the  sa(ne
...
general  conception  of  square  iind  oblong  numbers  (p.  148),  but
...
According  to  a  confused  statement  in  Suidas,  who  mentions  him    Tkeaeutus.
...
Aris tides,  the  son  of  Lysimachus,  who  was  specially  committed
...
closing  words.  At  the  eqd  of  the  dialogue,  as  in  the  Euthyphro,
...
The  dialogue  is  an  enquiry  into  the  nature  of  knowledge,  wnich^
...
serious  side  to  the  image,  which  is  an  apt  similitude  of  the  Socratic    TiuatUhu,
theory  of  education  (cp.  Repub.  vii.  5 18  D,  Sophist  230),  and  accords    Introduc-
...
r  between  opinion  and  knowledge^ —  between  the  conventional  and
the  true.
...
from  the  lower  to  the  higher  by  three  stages,  in  which  perception,V
...
nition which  Tbeaetetus  proposes :  '  Knowledge  is  sensible  per-  \
ception.'    This  is  speedily  identified  with  the  Protagorean  saying, ;
'  Man  is  the  measure  of  all  things;'  nnd  of  this  again  the  founda-  '
...
Frotagorean  thesis  is  pronounced  to  be  suicidal;  for  the  adver-j
saries  of  Protagoras  arc  as  good  a  measure  as  he  is,  and  they\
deny  his  doctrine.  He  is  then  supposed  to  reply  that  the  per-,
ception  may  be  true  at  any  given  instant.  But  the  reply  is  in  thel
...
instant  ?  Sensible  perception,  like  everything  else,  is  tumbling  toj
...
Theaetetus,  when  again  interrogated,  replies  (2)  that '  knowledge  isY
...
not  knowledge.  What  then  is  knowledge  ?  We  answer  (3),  *  Truel
opinion,  with  definition  or  explanation.'  But  all  the  different^
wa}'s  in  which  this  statement  may  be  understood  are  set  aside,
...
Does  Plato  misrepresent  Protagoras?  iiy

I.  In  reply  to  the  firsts  we  have  only  probabilities  to  offer.    Theaetetus.
Three    main    points  have  to   be   decided:    (a)   Would  Prota-    introduc-
...
ments, which  are  cited  in  this  dialogue,  '3fan  is  the  measure  of
...
tagor^  and  Heracleitus  was  not  generally  recognized  in  Greece,
...
ii8  Plato  should  be  read  as  a  dramatic  writer,

TfuaeUius.  of  dramatic  probability.  Could  he  have  pretended  to  cite  from
Introduc-  a  well-known  writing  what  was  not  to  be  found  there?  But  such
...
the  Parmenides,  where  be  is  introduced  as  a  youth) ;  but  he  is
...
and  in  the  spirit  of  his  age,  1 19

dialogues  truth  b  divided,  as  in  the  Laches  and  Protagoras,  and    Theaeuhu.
...
cannot  argue  (Thcact.  155  £  ;  Sopli.  246  A).  No  school  of  Greek
...
analogy,  and  allow  the  negative  as  well  as  the  positive  a  place  in   Tkeaeutus.
...
steph.    Terpsion,  who  has  come  to  Megara  from  the  country,  is  de-  Analysis.
...
had  already  heard.  They  arc  both  tired,  and  agree  to  rest  and
...
TJUtuutus.      he " ;  and  that  Theaetetus,  and  Theodoras,  the  geometrician  of
...
and,  to  say  the  truth,  he  is  very  Uke  you,  for  he  has  a  snub  nose,
...
the  property  of  his  father  has  disappeared  in  th^  hands  of  trustees ;
this  does  not,  however,  prevent  him  from  adding  libe'rality  to  his
...
he  is  not  a  painter,  and  therefore  he  is  no  judge  of  our  faces;  14 r
...
of  anybody ;  and  now  he  has  a  little  question  to  which  he  wants    Tkiaeutus,
Theaetetus  or  Theodorus  (or  whichever  of  the  company  would    Analysis.
not  be  *  donkey '  to  the  rest)  to  find  an  answer.     Without  furlSier
...
148  ^f  ures  which  have  equal  sides,  and  oblong  numbers,  3,  5, 6, 7,  &c.,
which  are  composed  of  unequal  factors,  and  represent  fig^ures
...
mid  wives.  And  he,  Socrates,  is  a  midwife,  although  this  is  a
...
Like  the  midwives,  who  are  '^ast  bearing  children,'  he  too  can  have
...
150  ^^^  most  likely  to  know  on  what  soil  the  plants  will  grow.  But
respectable  midwives  avoid  this  department  of  practice  —  they

124  Analysis  150-152.

Tktaeteius.  do  not  want  to  be  called  procuresses.  There  are  some  other
