---
source: "https://archive.org/details/cu31924092280142"
title: "The dialogues of Plato"
author: "Plato, Jowett, Benjamin, 1817-1893"
year: "1892"
captured_at: "2026-07-18T02:58:33Z"
updated_at: "2026-07-18T02:58:33Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Symposium"
plain_text_url: "https://archive.org/download/cu31924092280142/cu31924092280142_djvu.txt"
public_domain: true
...
- 初版: 1892
- 情報源: [archive](https://archive.org/details/cu31924092280142)
- パブリックドメイン: ✓
...
http://www.archive.org/details/cu31924092280142
...
Sietii.^eb  anb  Comcnb  (3t{iMiu0{iout
...
The  awe  with  which  Plato  regarded  the  character  of  'the  ParmenUes.
great '  Parmenides  has  extended  to  the  dialogue  which  he  calls  introduc-
...
many  have  been  regarded  by  soine  as  transcendental  mysteries;
...
(Theaet.  183  E)i     It  may  be  admitted  that  he  has  ascribed  to  an
...
Parmenides.  which  might  be  urged  against  them  ?  The  consideration  of  this
...
I  The  anamnesis  of  the  Ideas  is  chiefly  insisted  upon  in  the  mythical
portions  of  the  dialogues,  and  really  occupies  a  very  small  space
in  the  enfire  works  of  Plato.  Their  transcendental  existence  is
...
ParmmiJes.  at  the  great  Panathenaea,  the  former  being  at  the  time  about
Analysis.  sixty-five  years  old,  aged  but  well-favoured  —  Zeno,  who  was  said
...
members,  am  yet  also  one,  and  partake  of  the  one,  being  one  of    Parmenides.
seven  who  are  here  present  (cp.  Philebus  14,  15).     This  is  not    analysis.
...
as  I  believe,  only  what  they  appear  to  be :  though  I  arn  sometimes
...
individual  to  partake  of  the  whole,  or,9f  the  part  ? '  '  Why  not  of
...
Parmenides.  follow.'  'And  would  you  like  to  say  that  the  ideas  are  really
...
unnieaningness  of  this,'  says  Socrates,  '  and  would  rather  have  re-
...
One  of  us  has  a  slave ;  and  the  idea  of  a  slave  in  the  abstract  is    Parmmides.
...
a  suspicion,  either  that  they  have  no  existence,  or  are  beyontl
...
Parmenides.  '  Yes  J  because  I  think  that  in  visible  objects  you  may  easily  show
Analysis.  any  number  of  inconsistent  consequences.'  'Yes;  and  you  136
...
must  be  drawn  out  both  on  the  afifirmative  and  on  the  negative
hypothesis, —  that  is,  if  you  are  to  train  yourself  perfecfly  to  the
intelUgence  of  the  truth.'  '  What  you  are  suggesting  seems  to  be
...
rather  truisms  than  paradoxes.  For  every  one  must  acknowle'dge
...
From  the  crude  idea  of  Being  in  the  abstrJfct,  he  was  about  to
...
something  wider  and  deeper  than  satisfied  the  co5itemporary
...
with  the  teaching  of  Socrates  in  Plato.
...
the  greatest?  Parmenides  rebukes  this  want  of  consistency  in
Socrates,  which  he  attributes  to  his  youth.  As  he  grows  older,
philosophy  will  ta;ke  a  firmer  hold  of  him,  and  then  he  will  despise
neither  great  things  nor  small,  and  he  will  think  less  of  the
opinions  of  mankind  (cp.  Soph.  227  A).  Here  is  Ughtly  touched
...
The  criticism  of  Plato  15

not  only  of  the  morrow,  but  of  all  after-ages  on  the  Platonic  Ideas.    Pannenides.
For  in  some  points  he  touches  questions  which  have  not  yet    Introduc-
...
Latter  part  of  dialogue  an  imitation  of  Zeno.  1 7

more  under  the  necessity  of  separating  the  divine  from  the  human,    Partnenida.
as  two  spheres  which  had  no  communication  nith  one  another.         Intboduc-
...
imagine  similar  imopiac  raised  on  themes  as  sacred  to  us,  as  the
...
After  criticizing  the  hypotheses  of  others,  it  may  appear  pre-  Parmenides.
sumptuous  to  add  another  guess  to  the  maxiff  which  have  been
...
137  'I  cannot  refuse,' said  Parmenides,  'since,  as  Zeno  remarks,  •*''A'-'''s>s.
...
Parmmides.  fore  formless,  being  neither  round  nor  straight,  for  neither  round
Analysis.  nor  straight  can  be  defined  without  assuming  that  they  have  parts ;  138
...
jarts.  The  one,  then,  is  incapable  of  motion.  But  neither  can  i,q
...
many  and  not  one.  And  therefore  if  the  one  is  the  same  wirti
...
or  other;  nor  can  the  one  have  any  other  affection  than  its  own,  Parmenides.
that  is,  be  unlike  itself  or  any  other,  for  this  would  imply  that  it  Analysis.
was  more  than  one.  The  one,  then,  is  nefther  like  nor  unlike
...
^A-i  the  one,  if  it  is,  becomes  many  and  infinite.  Again,  let  us  con-
...
Parmenides.  both  partake  of  the  nature  of  other,  which  is  therefore  neither
...
and  even  into  odd  numbers.  But  if  one  is,  and  both  odd  and  144
...
not  the  same  with  itself  and  other.     For  everything  in  relation    Parmenides.

to  every  other  thing  is  either  the  same  with  it  or  other;  or  if    analysis.
...
one  be  number,  for  that  ajso  involves  one.  And  therefore,  not
being  other  than  the  ont  or  related  to  the  one  as  a  whole  to  parts
or  parts  to  a  whole,  riot  one  is  the  same  as  one.  Wherefore  the
...
the  other,  this  very  word  other  (erepoi'),  which  is  attributed  to  both,

i«^8  implies  sameness.  One,  then,  as  being  other  than  others,  and
...
Pamunides.  therefore  not  unlike,  and  therefore  Hke;  or,  as  having  different
...
two,  and  in  two  places.  But  one  cannot  be  two,  and  therefore  j^g
...
smallness  to  be  inherent  in  one:  in  this  case  the  inherence  is  leo
...
follows :  smallness  will  be  equal  to  the  part  cu"  greater  than  the
...
be  exceeded  by  the  others,  and  they  are  therefore  equal  to  one    Parmenides.
another.     And  this  will  be  true  also  of  the  one  in  relation  to    analysis.
itself:  one  will  be  equal  to  itself  as  well  as  to  the  others  [raKKa).
...
being  in  present  tinie,  '  to  have  been '  in  past,  '  to  be  about  to  be '
...
154  the  whole,  contemporaneously  with  the  end,  being  therefore
...
the  whole,  and  must  be  of  the  same  age  with  them.  Therefore
...
Parmenides.  younger  cannot  become  older  or  younger  in  a  greater  degree  than
...
The  others  are  other  than  the  one  because  they  have  parts,  for  if    Parmmides.

they  had  no  parts  they  would  be  simply  om,  and  parts  imply  a    Analysis.
...
jgjj  some  and  other,  generation  and  corruption,  odd  and  even.  For  if
...
30  _  Analysis   160-163.

Parmenides.     all  things,  and  likewise  nothing,  in  relation  to  one  and  to  the
Analysis.         Others.
...
at  once  knowledge  and  difference.  Thus  '  dne '  in  the  proposition  —
...
is  not  partakes  of  equahty.  Further,  the  one  which  is  not  has
...
being  of  not-being,  and  being  the  not-being  df  not-being;  or  more
truly  being  partakes  of  the  being  of  being  and  not  of  the  being  of  162
...
being  and  also,  not-being.  And  the  union  df  being  and  ndt-being
invdlves  change  dr  motidn.  But  hdw  can  not-being,  which  is
...
becomes  and  is  destroyed,   and  does  not  become  and  is  not    Parmmides.
...
164  Neither  can  rest,  or  motion,  or  greatness,  or  smallness,  or  equality,
...
jgg  not  be  the  one,  nor  the  many,  for  in  that  case  the  one  would  be

32  Analysis  166.

Parmenides.     Contained  in  them;  neither  will  they  appear  to  be  one  or  many;

Analysis  because  they  have  no  communion  or  participation  in  that  which  is
not,  nor  semblance  of  that  which  is  not.  If  one  is  not,  the  others
neither  are,  nor  appear  to  be  one  or  many,  like  or  unUke,  in  con-
...
Introduc-  I.  On  the  first  hypothesis  we  may  remark:  first.  That  one  is
...
'  not  many.'  Yet,  perhaps,  if  a  strict  Eristic  had  been  present,  oioq
avi)p  eliml  mv  napijv,  he  might  have  affirmed  that  the  not  many  pre-
...
to  be  equivalent  to  the  not  many ;  so  here  the  affimfative  conse-
...
now  everything  —  multitude,  relation,  place,  time,  transition.  One  Parmenides.
is  regarded  in  all  the  aspects  of  one,  and  wi^i  a  reference  to  all  Introduc-
...
as  a  difficulty  at«ll.  The  only  way  of  meeting  it,  if  it  exists,  is
...
opposite^ :  (8)  There  are  no  degrees  or  kinds  of  sameness,  like-
...
as  discrete :  (lo)  In  some  parts  of  flie  argument  the  abstraction  is
...
is  real,  or  in  any  way  an  assistance  to  thought,  or,  like  some  other    Parmmides.
logical  forms,  a  mere  figure  of  speech  transfe^jfed  from  the  sphere    Introduc-
6f  mathematics,  may  be  doubted.     That  Plato  and  the  most  subtle       "'"'•
...
Ideas,  persons,  things  may  be  one  in  one  sense  and  many  in
...
The  relation  of  the  Parmenides  to  the  other  dialogues.
...
the  dialogue:  (l)  The  thesis  is  the  same  as  that  which  Zeno  has
...
The  Parmenides  a  criticism  of  the  Ideas  and  the  One.

3;

The  attack  upon  the  Ideas  is  resumed  in  the  Philebus,  and  is
followed  by  a  return  to  a  more  rational  philosopl^.  The  perplexity
...
To  sum  up :  the  Parmenides  pf  Plato  is  a  critique,  first,  of  the  Pla-
...
point  of  view.  He  is  criticizing  the  simplest  and  most  general  ot
...
Den';  first,  his  own  Ideas,  which  he  himself  having  created  is  Parmemdes.
unable  to  connect  in  any  way  with  the  exter)|al  world ;  secondly,  Introduc-
...
These  are  the  deficiences  which  Plato  is  seeking  to  supply  in  an
...
would  never  have  been  heard  of,  if,  instead  of  transferring  the_
...
Parmenides.     substance  at  least  two  celebrated  theological  controversies  appear
Introdoc-       to  hinge,  which  would  not  have  existed,  or  at  least  not  in  their
'^^°^'  present  form,  if  we   had  'interrogated'  the  word  siibstance,  as
...
(i.  e.  more  a /riorz  assumption)  than  in  any  other,  because  there
...
are  required  to  place  us  above  metaphysics,  or  how  difiScult  it  is
...
philosophers  by  '  force,'  which  seems  to  be  accepted  without  any  Parmenides.
rigid  examination  of  its  meaning,  as  if  the  g^eral  idea  of  '  force '
...
again,  is  full  of  undefined  terms  which  have  distracted  the  hirman
...
derived  from  the  two-fold  translation  of  the  Greek  miaia.
...
individual,  for  He  is  universal ;  and  that  every  possible  conception  Parmenides.
which  we  can  form  of  Him  is  limited  by^he  human  faculties.  Introduc-
...
Him  under  the  forms  of  time  and  space,  who  is  out  of  time  an,d
...
steph.     We  had  come  from  our  home  at  Clazomenae  to  Athens,  Parmenides.
^^°  and  met  Adeimantus  and  Glaucon. in  the  Agora.     Welcome,  cephalus,
...
I  have  forgotten  ;  he  was  a  mere  child  when  I  last  came  hither  ^Vniaill'.^'"'
...
intimate  with  a  certain  Pythodorus,  a  friend  of  Zeno,  and  v\
remembers  a  conversation  which   took  place   between   So-    N
...
'  Reductio  ad  impossibile'  of  the  'plurality  of  being.''
...
for  him ;  he  dwells  at  Melita,  which  is  quite  near,  and  he  has^_..
...
very  young  man,  eame  to  see  them,  and  many  others  with
...
And  if  the  unlike  cannot  be  like,  or  the  like  unhke,  then
according  to  you,  being  could  not  be  many ;  for  this  would

Zeno  the  'alter  ego'  of  Parmenides.  47

involve  an  impossibility.     In  all  that  you  say  have  you  any  Parmenides.

other  purpose  except  to  disprove  the  being  of  the  many?  and  Sockates,
...
the  not-bemg  of  the  many  as  you  have  composed  arguments  ?   which  is  im-
Is  that  your  meaning,  or  have  I  misunderstood  you?  possible.

128       No,  said  Zeno  ;   you  have  correctly  understood  my  general
purpose.

I  see,  Parmenides,  said  Socrates,  that  Zeno  would  like  to   "The many
be  not  only  one  with  you  in  friendship  but  yoiu:  second  self  ^^""noJher
in  his  writings  too;  he  puts  what  you  say  in  another  way,   wayofex-
and  would  fain  make  believe  that   he  is  telling  us  some-  S^eThcSsof
thing  which   is  new.      For  you,  in   your  poems,   say  The  Parmenides
All  is  one,  and  of  this  you  adduce  excellent  proofs ;  and  he  o^^ .
...
Yes,  Socrates,  said  Zeno.  But  although  you  are  as  keen  Amisunder-
as  a  Spartan  hound  in  pursuing  the  track,  you  do  not  fully  ='^'"'™s-
...
one  stole  the  copy ;  and  therefore  I  had  no  choice  whetjier
...
that  degree  and  manner  Uke ;  and  so  far  as  they  participate
...
both  hke  and  unlike,  by  reason  of  this  participation? — Where

Differences       is  the  wonder?     Now  if  a  person  could  prove  the  absolute

between  abso-  jjj^^g  ^^  become  Unlike,  or  the  absolute  unUke  to  become  like,

lute  ideas  or  '  _  j  i.  i

natures,  and  that,  in  my  Opinion,  would  indeed  be  a  wonder ;  but  there
which"fr  '^  nothing  extraotdinary,  Zeno,  in  showing  that  the  things
take  of  them,  which  Only  partake  of  likeness  and  unlikeness  experience
...
one.  When  he  wanted  to  show  that  I  Tvas  many  he  would
...
mapy  are  one  or  the  one  many ;  he  is  uttering  not  a  paradox
...
Parmenides  proceeded :  And  would  you  also  mak^e  absolute
...
I  should  Uke  to  know  whether  you  mean  that  there  are
...
Then  dp  you  think  that  the  whole  idea  is  one,  and  yfet,
...
Nay,  but  the  idea  may  be  hke  the  day  which  is  one  and
the  same  in  many  places  at  once,  aticTyet  contmuous  with
...
The  origin  and  nature  »f  ideas.  51

things  which  participate  in  them  will  have  a  part  of  them  Parmmidei.

only  and  not  the  whole  idea  existing  in  eaok  of  them?  Socrates,

That  seems  to  follow.  Parmen.d.ss.
...
Suppose   that  you  divide  absolute  greatness,  and  that  of  nor  can  ob.

the   many   great   things,   each   one   is   great  in  virtue  of  a  o^i"*  "^""ts '°f

portion  of  greatness  less  than  absolute  greatness  —  is  that  ideas,  for  this

conceivable?  -^1^^^""

No.  absurdity.

Or  will  each  equal  thing,  if  possessing  some  small  portion  „ot  tgcom""
of  equality  less  than  absolute  equality,  be  equal  to  some  other  great  or  equal
thing  "by  virtue  of  that  portion  only?  addiUoiof

Impossible.  a  part  of

Or  suppose  one  of  us  to  have  a  portion  of  smallness ;  this  ^uaiuy^or
is  but  a  part  of  the  small,  and  therefore  the  absolutely  small  smaiiness.
...
132  idea  of  each  kind  is  as  follows: — You  see  a  number  of  great  ^l™^
...
things  which  are  not  the  idea,  and  to  compare  them,  will  not  erai  and  its

another  greatness  arise,  which  will  appear  to  be  the  source  p*"'''™'^"

of  all  these  ?  a  new  idea ;
...
And  will  not  that  of  which  the  two  partake,  and  which  Parmenides.
makes  them  alike,  be  the  idea  itself?  ^  Socrates,

Certainly.  Pakmenides.
...
The  theory,  then,  that  other  things  participate  in  the  ideas  Resemblance
by  resemblance,  has  to  be  given  up,,  and  some  other  mode  "1""*"=
...
And,  further,  let  me  say  that  as  yet  you  otily  understand  a
...
No,  said   Socrates;    for  then  they  would   be   no   longer  benobnger

absolute.  absolute,  if

True,  he  said ;  and  therefore  -when  ideas  are  what  they  are  within  us.
in   relation  to  one  another,  their  essence  is  determined  by  a  Andifwith-
relation  among  themselves,  and  has  nothing  to  do  with  the  they  and  their
resemblances,  or  whatever  they  are  to  be  termed,  which  are   ^semblances

,  ,    p  i>i  '  t  '  1  *"  our  sphere

m  our  sphere,  and  from  which  we  receive  this  or  that  name   are  related
when  we  partake  of  them.     And  the  things  which  are  within  ^""""s
our  sphere  and  have  the  same  names  with  them,  are  likewise  only  and
...
Yes,  said  Socrates,  I  quite  see  yoiu-  meaning.

Arid  will  not  knowledge  —  I  mean  absolute  knowledge  —
answer  to  absolute  truth?

Certainly.

And  each  kiird  of  absolute  knowledge  will  answer  to  each
...
A  consequence  still  more  strange.  55

What  is  it?  ParmmiOes.

Would  you,  or  would  you  not  say,  th^t  absolute   know-  socrates,
ledge,   if  there  is  such   a  thing,  must   be  a  far  more  exact  p^km^'oes.
knowledge  than  our  knowledge ;  and  the  same  of  beauty  and  •^"'"hcr

°  objection,

of  the  rest?  God  above

Yps  ^^s  absolute

And  if  there  be  such  a  thing  as  participation  in  absolute  But  if  so,  he

knowledge,  no  one  is  more  likely  than  God  to  have  this  most  "=="■""  h^^e

exact  knowledge?  of  human

Certainly.  things  be-

■'  cause  they

But  then,  will  God,  having  absolute  knowledge,   have   a  are  in  another
knowledge  of  human  things?  ^v^eie.
...
attention  on  these  and  the  Kke  difficulties,  does  away  with
...
talking  here  with  yoiu'  friend  Aristoteles,  the  day  before
...
go  a  step  fiurther,  and  consider  not  only  the  consequences
...
of  Zeno's  about  the  many,  you  should  enquire  not  only  Parmmides.
what  will  be  the  consequences  to  the  nmny  in  relation  to  Socrates,
themselves  and  to  the  one,  and  to  the  one  in  relation  to  itself  Parmenides,
...
not  to  be,  if  you  would  train  yoiu'self  perfectly  and  see  the
real  truth.

That,  Parmenides,  is  a  tremendous  business  of  which  you  Socrates  asks
speak,  and  I  do  not  quite  understand  you;    will  you  take  ^™,^°iJof'"'
some  hypothesis  and  go  through  the  steps? — then   I  shall  this  process.
...
Then  will  you,  Zeno?  said  Socrates.  engage  in

Zeno  answered  with  a  smile: — Let  us  make  our  petition  f''*^'*-

...  .  borious  pas-

to  Parmenides  himself,  who  is  quite  nght  in  saying  that  you  time ;  but  at
are  hardly  aware  of  the  extent  of  the  task  which  you  are   *«  request  of

•'  •'  the  company

imposing  on  him ;  and  if  there  were  more  of  us  I  should  not  he  proceeds,
...
pastime?  Shall  I  begin  with  myself,  and  take  my  own  hjrpo-
...
Then,  if  the  one  is  to  remain  one,  it  will  not  be  a  whole,  Par»iemdes.
and  will  not  have  parts?  Paemenides,

jo-Q  '  Aristoteles.

But  if   it  has  no    parts,  it  will    have    neither  beginning,  andhf^ingno
middle,  nor  end ;  for  these  would  of  course  be  parts  of  it.         not  have  a
Right.  ''°.?r'"^'.

^  .  .       ,  middle,  and

But  then,  agam,  a  beginnmg  and  an  end  are  the  limits  of  end;  nor
everything?  ^Il^^^^"
...
points  are  equidistant  from  the  centre?  straS^t""
...
True.
1 38       Then  the  one  would  have  parts  and  would  be  many,  if  it
...
But  if,  on  the  other  handj  one  were  in  itself,  it  would  also
...
Fiu-ther  consider,  whether  that  which  is  of  such  a  nature
...
thing, can  neither  as  yet  be  in  that  othv  thing  while  still
...
The  one  is  neither  other  than  itself,
...
But  if  not  by  virtue  of  being  one,  pot  by  virtue  of  itself ;
...
Impossible.  Parmentdes.

And  thus  the  one  can  neither  be  the  saiti*,  nor  other,  either  Parmenides,
in  relation  to  itself  or  other?  Ae.stoteles.

JJq  nor  yet  like-

Neither  will  the  one  be  like  anything  or  unlike  itself  or  other,   is  sameness  of

Why  not?  affections;  nor

^  unlikeness,

Because  hkeness  is  sameness  of  affections.
...
Again,  being  of  this  nature,  it  can  neither  be  equal  nor  nor  equality,
unequal  either  to  itself  or  to  other.  nor  inequality
...
The  contradiction  involved  in  ascribing
...
How  then  can  one,  being  of  this  nature,  be  either  ol^er  or
...
any  relation  to  unity  leads  to  the  denial  of  it.  65

Then  one  cannot  be  older  or  younger,  or  of  the  same  age,   Panmnides.
either  with  itself  or  with  another?  ^  Parmen.des,
...
i.  b.  If  one  i.  b.    Suppose,   now,    that   we   return   once   more  to   the

The  infinite  multiplicity  of  the  one  which  is.  67,

original  hypothesis ;  let  us  see  whether,  on  a  further  review,   Parmmidu.
any  new  aspect  of  the  question  appears.     «  Parmenides,

I  shall  be  very  happy  to  do  so.  Aristoteles,

We  say  that  we  have  to  work  out  together  all  the  con-  jf.  what  win
...
same  with  the  one:  for  if  the  same,  it  would  not  be  the  '^ ''H' p^'''*''"

'  '  ...       of  being,  and

being  of  the  one ;  nor  would  the  one  have  participated  in  wiu  therefore
being,   for    the    proposition  that  one  is  would    have   been  o^™^"'^'
identical   with   the   proposition   that   orte  is   one;    but   our  being;
...
Once   more  then  let  us  ask,   if  one  is  what  will  follow,   and  each  part
Does  not  this  hypothesis  necessarily  imply  that  one  is  of  ^^f"''^*"^
such  a  nature  as  to  have  parts?  parts  of  itself ;
...
One  apart  from  being,  still  implies  plurality.
...
If  being .  and  the  one  be  two  dififerent  things,  it  is  not
...
such  case  we  take  two  things,  which  may  be  rightly  called  Parmemdes.

both.  ^  Parmenides,

How  so?  Aeistoteies.

In  this  way  —  you  niay  speak  of  being?
...
must  be  severally  one?  even  numbers,
...
And  if  there  are  two  there  must  also  be  twice,  and  if  there  from  addition
are  three  there  must  be  thrice;  that  is,  if  twice  one  makes  '°f"'np''-
two,  and  thrice  one  three?
'  Certainly.

There  are  two,  and  twice,  and  therefore  there  must  be
twice  two ;  and  there  are  three,  and  theye  is  thrice,  and
...
1 70  The  infinite  divisibility  of  being  and  of  one.

Parmenides.         Here,  then,  we  have  even  taken  even  times,  and  odd  taken  144
Parmbnides,    odd  times,  and  even  taken  odd  times,  and  odd  taken  even
...
difference,  But  if   there  is  number,  there  must  also    be   many,   and

differmre        infinite  multiplicity  of  being ;  for  number  is  infinite  in  multi-
number  of       plicity,  and  partakes  also  of  being:  am  I  not  right?
every  sort,  Certainly.

And  if  all  nimiber  participates  in   being,  every  part   of
...
is  devoid  of  jt?     And,  indeed,  the  very  supposition  of  this  is
...
Impossible,
for  every  But  if  it  is  at  all  and  so  long  as  it  is,  it  must  be  one,  and

single  part  of    cannot  be  none  ?

being,  .how-
ever small,  Certainly.

IS  one.  Then  the  one  attaches  to  every  single  part  of  being,  and
...
be  present  with  all  the  parts  of  being,  unlqj^  divided.

True.

And  ±at  which  has  parts  will  be  as  many  as  the  parts  are?
...
one,  as  a  whole,  will  be  Kmited ;  for  are  not  the  parts  con-
tained by  the  whole?
...
and  not  being  in  itself,  it  must  be  in  ^nother.

Very  true.

The  one  then,  regarded  as  a  whole,  is  in  another,  but

at  rest,  yet  in  motion.

regarded  as  being  all  its  parts,  is  in  itself ;  and  therefore  the
one  must  be  itself  in  itself  and  also  in  anqjher.
...
Then  the  one  has  been  shown  to  be  at  onc^  in  itself  and
in  another?
...
one,  and  the  one  otlier  than  the  not-one?
...
That  appears  to  be  tlie  inference.
...
which  is  other  than  the  one,  in  that  the  word    'other 'is  148
...
than  the  others,  every  thing  will  be  hke  every  thing,  for  every
...
in  contact,  yet  not  in  contact ;

77

Certainly.

And  in  that  it  was  other  it  was  shown  to  Ije  like?
...
not  being  unlike,  is  hke ;  but  in  so  far  as  it  is  affected  by
other  it  is  otherwise,  and  being  otherwise  affected  is  unlike.

True.

Then  because  the  one  is  the  same  with  the  others  and
other  tha.n  the  others,  on  either  of  these  two  grounds,  or  on
both  of  them,  it  will  be  both  like  and  unUke  the  others  ?
...
But  if  there  be  only  one,  and  not  two,  there  will  be  no   Parmenides.

contact?  Parmenides,

How  can  there  be?  akistoteles.
...
If  the  one  were  greater  or  less  than  the  others,  or  the  itself  and
...
nor  will  the  one  bie  greater  or  less  than  them  or  others,  if  it
has  neither  greatness  nor  smallness.

Clearly  not.

and  also  unequal  to  itself  and  to  others.  8i

Then  if  the  one  is  neither  greater  nor  less  than  the  others,   Parmenides.
it  cannot  either  exceed  or  be  exceeded  by  tfeem?  Parmenides,

Certainly  not.  Ahistoteles.
...
151  than  itself ;  and,  as  contained  in  itself,  will  be  less ;  and  will  contains  and
thus  be  greater  and  less  than  itself.  Inl^eit  and

It  will.  is  tlierefore

Now  there  cannot  possibly  be  anything  which  is  not  in-  i^s^,h^n"
eluded  in  the  one  and  the  others?  i'seif.
...
it  is  wiU  be  greater ;  in  no  other  way  can  one  thing  be  in  another.

True.

And  since  there  is  nothing  other  or  besides  the  one  and  Unequal  to
the  others,  and  they  must  be  in  something,  must  thev  not  be  °*"'^;~'"-

'  -^  07  J  cause  It  con-

in  one  another,  the  one  in  the  others  and  the  others  in  the  tains  and  is
one,  if  they  are  to  be  anywhere?  contained  in

'  ^    ■'  ^  them,  and

,  That  is  clear.  is  therefore

But  inasmuch  as  the  one  is  in  the  others,  the  others  will  be  ^j^than"''
greater  than  the  one,  because  they  contain  the  one,  which  will  them.
...
and  more  and  less  measures  pr  divisions  than  itself  and  the
...
if  one  partakes  of  time.

But  to  be  (tivai)  is  only  participation  of  being  in  present
152  time,  and  to  have  been  is  the  participationiiof  being  at  a  past
...
Then  the  one  of  all  things  that  have  niijriber  is  the  first  to  Parmenides,
come  into  being ;  but  all  other  things  have  also  number,  being  Amstoteles.
...
if  parts,  then  a  beginning,  middle  and  end?  craiesTnto
...
to  come  into  being  with  the  last ;  and,  since  the  one  cannot  Ihan^lh""^"
come  into  being  except  in  accordance  with  its  own  nature,   others,
its  nature  will  require  that  it  should  come  into  being  after  ^^""p^"'
...
Then  that  which  is,  caijnot  become  older  or  younger  than
...
But  can  it  partake  of  being  when  not  partaking  of  being,  or  Parmenides.

not  partake  of  being  when  partaking  of  bqjng?  Parmenides,

Impossible.  aeistoteles.

Then  the  one  partakes  and  does  not  partake  of  being  at  '^^^  °°°  """"

,.„  .  ,  ,  .         ,  ,  .  ....  therefore  par-

different   times,   for   that   is   the   only   way   m   which   it   can   take  of  being

partake  and  not  partake  of  the  same.  and  not-being

^  and  assume

i  rue.  and  relinquish

them  at  dif-
ferent times.

156       And  is  there  not  also  a  time  at  which  it  assumes  being  and  *='"^'dif-
...
And  surely  there  cannot  bfe  a  time  in  which  a  thing  can  be
...
from  like  to  unhke,  and  from  unlike  to  like,  it  is  neither
...
All  these,  then,  are  the  affections  of  throne,  if  the  one  has  Parmenides,
...
i.  aa.  But  if  one  is,  what  wiU  happen  to  the  others  —  is  not  The  affections
...
others  are  not  the  one ;  for  if  they  were  they  could  not  be  n^ftlhTone'^
other  than  the  one.  and  yet  they

Very  true.  -  participate  in

.'  the  one ;  for

Nor  are  the  others  altogether  without  the  one,  but  in  a  the  others  are
certain  way  they  participate  in  the  one.  whSe  which
...
will  be  a  part  of  each  one  of  the  other  parts,  if  of  aU ;  for
...
They  do  so  then  as  multitudes  in  wlijch  the  one  is  not  Pakmenides,
present?  aristoteles.
...
regarded  simply,  and  in  itself,  will  not  they,  as  far  as  we  see  ^"o™',Jfife°["'^
them,  be  unlimited  in  number?  in  their

Certainly.  nature,

And  yet,  when  each  several  part  becomes  a  part,  then  the
parts  have  a  Hmit  in  relation  to  the  whole  and  to  each  other,
...
them  which  gives  to  them  hmitation  in  relation  to  one
...
Then    they  are    both  like  and  unhke  one  another    and  wherefore

themselves  also  they  are
...
Yes.
1 59       And  opposites  are  the  most  unlike  of  things.
...
Then  there  is  no  way  in  which  the  others  can  partake  of  Pamunides.
the  one,  if  they  do  not  partake  either  in  wWe  or  in  part?  Paemenides,

It  would  seem  not.  Aristoteles.
...
not  partaking  in  any  way  of  the  one,  are  neither  one  nor  from  the  one
many,  nor  whole,  nor  part.  "^fj?""'  *""
...
Then  the  others  are  neither  like  nor  unlike  the  one,  nor  is  Nor  can  they
ikeness  and  unlikeness  in  them;  for  if -they  were  like  and  ^=°PP°sites;

'  •'  for  they  can-

unhke,  or  had  in  them  likeness  and  unlikeness,  they  would  not  partake
have  two  natures  in  them  opposite  to  one  another.  ?/'™  ''""^^

^^  if  they  can-

That  is  clear.  not  partake
...
they  were  like  or  unlike  they  would  partake  of  one  of  those  J^^"  ™^'  '^
...
'  Therefore  if  one  is,  the  one  is  all  things,  and  also  nothing,   all  things;

both  in  relation  to  itself  and  to  other  things.  butaiso
...
attribute  of  '  this ' ;  for  the  one,  or  the  others  than  the  one,  Parmenides.
could  not  have  been  spoken  of,  nor  cou]^  any  attribute  or  parmenides,
relative  of  the  one  that  is  not  have  been  or  been  spoken  Aristoteles.
...
others  being  different  from  the  one  will  be  of  a  different  kind,  ^^^"^nu^t^'

Certainly.  therefore

And  are  not  things  of  a  different  kind  also  other  in  kind?       nesTto  '
...
Then  the  one  must  have  Ukeness  to  itself?
...
but  if  one  has  no  being,  then  it  can  neither  be  nor  be  hke?
...
And  inequaUty  implies  greatness  and  smallness?
...
Then,  as  would  appear,  the  one,  when  |^t  is  not,  is ;  for  if  Parmenides,
it  were  not  to  be  when  it  is  not,  but '  were  to  relinquish  Ahistoteles.
something  of  being,  so  as  to  become  not-being,  it  would  at  f'"' not-being

implies  being
once  be.  and  being

Quite  true.  \mfi^s  not-
...
lieing  partakes  of  the  being  of  being,  and  not  of  the  being  of
not-b^Qg — that  is,  the  perfection  of  being;  and  when  not-
...
But  can  anything  which  is  in  a  certain  state  not  b6  in  that  Bm  to  be
state  without  changing?  both,  it  must

"  change  from

Impossible.  one  to  the

Then  everything  which  is  and  is  not  in  a  certain  state,  °*=''L^"f

.  .  therefore  be

implies  change?  in  motion.
...
It  is  both  in  motion  and  at  rest.
...
But  if  the  one  neither  suffers  alteration,  nor  turns  roimd
...
And  must  not  that  which  is  altered  beSome  other  than  it  pahmenides,
previously  was,  and  lose  its  former  state  and  be  destroyed ;  aristoteles.
but  that  which  is  not  altered  can  neither  come  into  being  The  one  that
...
And  the  one  that  is  not,  being  altered,  becomes  and  is  comes  nor  is
...
If  one  is  not,  we  ask  what  will  happen  in  respect  of  one?   ifoheisnot,
That  is  the  question.  what  then?

Yes.

Do  not  the  words  '  is  not '  signify  absence  of  being  in  that   'is  not'  im-
to  which  we  apply  them?  ^JtifgTnthe
...
And  can  that  which  has  no  participation  in  being,  either  ^^i^^"'
...
related  to  or  the  attribute  of  this  or  that  or  other,  pr  be  past,
present,  or  futiu'e.  Nor  can  knowledge,  or  opinion,  or  per-
...
The  spectre  of  '  one '  still  haunts  us.  1 03

The  others  must  surely  be ;  for  if  they,  like  the  one,  were  Parmenides.
not,  we  could  not  be  now  speaking  of  thAi.  Parmenidbs,
...
Other  means  other  than  other,  and  different,  different  from  other  implies
the  different?  f:^

Yes.  mean  other

Then,  if  there  are  to  be  others,  there  is  something   than  anTtherefore

which  they  will  be  other?  the  others  are
...
And  they  are  each  other  than  one  another,  as  being  plural  and  each  of
and  not  singular ;  for  if  one  is  not,  they  cannot  be  singular,  j'^^'^y  0° "he
but  every  particle  of  them  is  infinite  in  number ;  and  even  if  one,  appears
...
separate  particle  yet  appears  to  have  a  hmit  in  relation  to
itself  and  other.
...
ence, different  in  kind  from,  and  unhke,  themselves?

True.

If  the  one  is  not,  the  others  are  neither  one  nor  many.  105

And  so  must  the  particles  appear  to   be  like  and  unlike  Pamtenida.
themselves  and  each  other.  Pakmenides,

Certainly.  aristoteles.
...
ii.  bb.  Once  more,  let  us  go  back  to  the  beginning,  and  if  one  is  not
...
Let  us  ask  that  question.  oleTnd*e°e-
...
Because  the  others  have  no  sort  or  manner  or  way  of  com-  many  they
munion  with  any  sort  of  not-being,  nor  can  anything  which  is  ""se'"artaj<e
not,  be  connected  with  any  of  the  others;  for  that  which  is  of  not-being;
not  has  no  parts.  "^^^
...
237D;  Theaet.  1 79  A,  and  Soph.  233  B;  Theaet.  172  D,  Soph.  253  C,
...
and  of  ar>)i  doctrine  of  ideas  except  that  which  derives  them  from
...
disclaims  the  qharacter  of  a  professional  eristic  (164  C),  and  also,
...
Better  retained  where  Plato  placed  it.
...
Again,  the  Theaetetus  may  be  connected  with  the  Gorgias,  either  Theaeutits.
dialogue  from  different  points  of  view  containing  an  analysis  of  the
real  and  apparent  (Schleiermacher) ;  and  botft  may  be  brought
...
called  the  Second  Platanic-Irilogy.  Both  the  Parmenides  and  the
...
Theaetetus  a  real  person:   Theodorus.
...
points  is  imitated  by  Cicero  (De  Amicitia,  c.  i),  the  interlocutory
words  are  omitted.
...
geneyal  conception  of  square  and  oblong  numbers  (p.  148),  but
...
According  to  a  confused  statement  in  Suidas,  who  mentions  hiin    Theaeutus.

twice  over,  first,  as  a  pupil  of  Socrates,  and  thea  of  Plato,  he  is  said   inteoduc-
...
may  allow  time  for  the  completion  of  such  a  work  (Miiller).     We
...
and  can  divine  their  future  (142  C) ;  and  he  knows  that  sympathy
is  the  secret  power  which  unlocks  their  thoughts.  The  hit  at
...
bilia, asking  What  is  justice  ?  what  is  temperance  ?  and  the  hke.
...
The  three  definitions:   Knowledge  is  (i)  Sensation;  115

serious  side  to  the  image,  which  is  an  apt  similitude  of  the  Socratic    Tkeaeutus.
theory  of  education  (cp.  Repub.  vii.  5 18  D,  Sopl^jpt  230),  and  accords    introduc-
...
is  realised  in  the  hfe  of  philosophy.  And  the  contrast  is  the
...
moment  the  definition  appears  to  be  accepted.  But  soon  the
Protagorean  thesis  is  pronounced  to  be  suicidal;  for  the  adver-
saries of  Protagbras  are  as  good  a  measure  as  he  is,  and  they
...
Thedetetus,  when  again  interrogated,  replies  (2)  that '  knowledge  is
...
ways  in  which  this  statement  njay  be  understood  are  set  aside,
...
Does  Plato  misrepresent  Protagoras?
...
I.  In  reply  to  the  first,  we  have  only  probabilities  to  offer.  T/uaetetus.
Three  main  points  have  to  be  decided :  ^,(a)  Would  Prota-
goras have  identified  his  own  thesis,  '  Man  is  the  measure  of  all
things,'  with  the  other,  'AH  knowledge  is  sensible  perception '  ?
...
which  is  so  entitled,  but)  'privately  to  his  disfciples,'  —  words
...
dialogues  truth  is  divided,  as  in  the  Laches  and  Protagoras,  and  Theaeutm.
the  interest  of  the  piece  consists  in  the  contr^t  of  opinions.  The
...
and  even  chargia&Jiis__own_arguments  with,  unfairness,  in  the
Theaetetus  he  is  designedly  held  back  from  arriving  at  a  con-
elusion.  For  we  cannot  suppose  that  Plato  conceived  a  definition
...
ideas,  or  illustrated  a  new  mpthod,  his  aim  has  been  sufficiently
accomplished.
...
Xheaetetus,  Sophist,  and  Laws,  of  certain  impenetrable  godless
persons,  who  will  not  believe  what  they  'cannot  hold  in  their
hands';  and  cannot  be  approached  in  argument,  because  they

I20  Conflict  of  abstractions.

Theaeutits.  cannot  argue  (Theaet.  15S  E  ;  Sopli.  246  A).  No  school  of  Greek
Introduc-  philosophers  exactly  answers  to  these  persons,  in  whom  Plato
TioN.  jjjjy  perhaps  have  blended  some  features  of  the  Atomists  with  the
...
Analysis  142,   143.  121

analogy,  and  allow  the  negative  as  well  as  the  positive  a  place  in    Theaetetm.
human  thought.     To  such  a  philosophy  Plat«,  in  the  Theaetetus,    Introdoc-
...
Stepb.     Terpsion,  who  has  come  to  Megara  from  the  country,  is  de-   Analysis.

^4-2  scribed  as  having  looked  in  vain  for  Euclides  in  the  Agora;  the
...
them  from  time  to  time,  when  I  came  to  Athehs.'  .  .  .  Terpsion
...
Theaeutus.      he  " ;  and  that  Theaetetus,  and  Theodorus,  the  geometrician  of
...
other  virtues.  At  the  desiire  of  Socrates  he  invites  Theaetetus  to
sit  by  them.

'Yes,'  says  Socrates,  'that  1  may  see  in  you,  Theaetetus,  the
image  of  my  ugly  self,  as  Theodorus  declares.  Not  that  his
remark  is  of  any  importance ;  for  though  he  is  a  philosopher,
he  is  not  a  painter,  and  therefore  he  is  no  judge  of  our  faces;  141;
...
of  anybody ;  and  now  he  has  a  Uttle  question  to  which  he  wants    Theaeutus.
Theaetetus  or  Theodorus  (or  whichever  o^the  company  would    Analysis.
not  be  '  donkey '  to  the  rest)  to  find  an  answer.     Without  further
preface,  but  at  the  same  time  apologizing  for  his  eagerness,  he

146  asks,  '  What  is  knowledge  ? '  Theodorus  is  tob  old  to  answer
...
148  figuresAvhich  have  equal  sides,  and  oblong  numbers,  3,  5«,  6,  7,  &c.,
...
ICQ  are  most  likely  to  know  on  what  soil  the  plants  will  grow.  But
respectable  midwives  avoid  this  department  of  practice  —  they

124  Andlysis  150-152.

Theiuieius.  do  not  want  to  be  called  procuresses.  There  are  some  other
Analysis.  dififerences  between  the  two  sorts  of  pregnancy.  For  women
...
of  these,  and  there  have  been  others.  The  truants  often  return  to  151
...
sage  who  is  likely  to  suit  them.  1  tell  you  this  long  story  because
...
only  a  "fagon  de  parler,"  by  which  he  imposed  on  the  common  herd

Analysis  152-155.  125

like  you  and  me ;  he  told  "  the  truth  "  [in  allusion  to  the  title  of  his  Theaeutm.
book,  which  was  called  "  The  Truth  "]  in  secret  to  his  disciples,  analysis.
