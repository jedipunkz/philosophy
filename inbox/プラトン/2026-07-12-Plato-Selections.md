---
source: "https://archive.org/details/platoselection0000unse"
title: "Selections"
author: "Plato"
year: "1927"
captured_at: "2026-07-12T19:20:26Z"
updated_at: "2026-07-12T19:20:26Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Symposium"
plain_text_url: "https://archive.org/download/platoselection0000unse/platoselection0000unse_djvu.txt"
public_domain: true
...
- 著者: Plato
- 初版: 1927
- 情報源: [archive](https://archive.org/details/platoselection0000unse)
- パブリックドメイン: ✓
...
PHILOSOPHY SERIES
4 Pon Modern Student’s Library has been en

larged to include a series of volumes con-
taining writings of .the great philosophers.
These volumes are edited by the most competent
authorities at home and abroad. The selections
are comprehensive and suited to the special needs
of students and the general reading public. Each
volume contains an introduction giving a brief
vutline of the system of the author and indicating
his place in the history of thought.
The Philosophy Series is under the general edi-
torship of Ralph Barton Perry, Professor of Phi-
yosophy, Harvard University.

[ For a complete list of THE MopERN STUDENT’S
LipraryY see the pages following the text}
...
All rights reserved. No part af this book
may be +2bproduced in any form without
...
portance of thé mathematical method in the understand-
...
in a field of knowledge distinct from that of science.
...
detailed descriptions of the parts of the human body,
and investigations into the properties of geometricaf
...
osophy, for Plato, is a form of life, in fact, the distine-
...
Pilato found in the person of Socrates a perfect embodi-
ment of his ideal of the philosopher. Is philosophy,
then, coextensive with the whole range of human activ-
...
It would not be an exaggeration to say that Plato’s
...
_ edifice of timeless essences, in his moral seriousness
...
position to whatever is fragmentary and provincial ia
...
picture of a mind caught in the toils of thinking, we
...
in the islands of the Aigean, in Sicily, in the cities
...
where all sorts of sects and religions and philosophies
...
the Orphic cults from the north. The significance of
...
explicit and coérdinated attitude.
...
_ the data, a new pattern into which the elements of the
...
-euse. He was not as successful at court as with the
...
measures and Plato, realizing that his schemes could
...
‘essences’ or ‘universals,’ since the term ‘ideas’ has
...
and that reality is like a river in which one cannot step _
...
which is the world of true knowledge.1 The world of
...
*Both Heraclitus and Parmenides had tried to supplement
...
it that an entomologist, for example, is interested in
...
_ such; the individual case suggests the general essence,
...
angles must be equal to two right angles. -Here then
...
+ Plato would not have admitted the above application of his
...
Action and life reveal similar characteristics. We
...
vividly in the lives of individuals, and still more in in-
...
in a caye describes the condition of the majority of
...
the concrete world as absolute and self-sustaining;
...
fection; in a similar way, the essential nature of par-
...
whiteness, yet I do have the. conception of a pure un-
...
body. ‘There is a story that Shelley, while a youth at
...
higher -to reason. Each side is subdivided in its turn;
...
an aspiration; and it is not physical as with Vreud—

INTRODUCTION xxiii

it is an aspiration for the ideal. Love is the desire of
...
perfection is the principle of reality, and therefore to
desire an object is to desire the good.

One would naturally expect art to play a central réle
in the passion for beauty; in fact, for Plato, it plays.
no role at all, or rather it plays the role of a villain.
...
ticular bed made by the carpenter according to the ideal
...
life. Beauty lies beyond all art and all symbolism; it
...
ticular, Plato is consistent in his attack on art. Orie
...
the subject of long controversy among scholars. Too
...
Why did God make the world? “Let me tell you,
...
in that coriflict the gods and demigods are our allies,
and we are their property.’! Plato’s God bears a re-
...
+Tt is not easy to reconcile this phrase with those passages
in the Republic in which he speaks of the good as the prin-
ciple of being.

XxViii INTRODUCTION

only himself; love is of the world to God. But Plato’s
...
‘mixtures’, i. e., created objects. But they are so cre-
...
surpasses the limits of a theoretical analysis; he is a
...
ception of the state was unrealizable on earth, he re-
...
a pilot in navigation, yet we permit ary one to govern
...
cised responsibly. Democracy affirms that ail men are
...
often he is at politics, and starts to his feet and says and
...
_ greater social revolution than the overthrow’ of mon-
...
we shall now proceed to the first. The individual has
...
The state will be in charge of production in ihe
...
Thus, both the breeding and the rearing of children will
...
ticipate in public affairs and in war cn an equal foot-
...
- illustrated in the case of Plato: Plato gathers together
...
the other hand, thgnugh at no one time is there unanimity
...
things, in the sense that they represent permanent pes-
...
XXxxviii INTRODUCTION

lectual heritage of the human race, Platonism is sure to
...
Jowett: The Dialogues of Plato. Translation. Oxford: Clarendon
Press.

Zeller: Plato and the Older Academicians. Translated by Alleyne
and Goodwin. London, 1888.

Pater: Plato and Platonism. New York, 1902.

More: Platonism. Princeton.

Shorey: The Unity of Plato’s Thought. Chicago University Press,
1903.

Taylor: Plato...London, 1914. A very instructive little book in
the series, Philosophies, Ancient and Modern.

Taylor: Plato, The Man and His Work. New York, 1927. A com-
prehensive work.
...
How you, O Athenians, have been affected by my ac-
cusers, I cannot tell; but I know that they almost made
me forget who I was—so persuasively did they speak;
and yet they have hardly uttered a word of truth. But
...
—unless by the force of eloquence they mean the force
of truth; for if such is their meaning, I admit that I
...
than seventy years of age,.and appearing now for the
...
words, and give heed to that: let the speaker apeak
truly and the judge decide justly.

And first, I have to reply to the older charges and
to my first accusers, and then I will go on to the later
ones. For of old I have had many accusers, who have
accused me falsely to you during many years; and I am
...
here, and cross-examine them, and therefore I must
...
about and saying that he walks in ait, and talking a
...
to him. There is Gorgias of Leontium, and Prodicus
...
I the same, I should havé been very proud and con-
...
that extent I am inclined to believe that I am_ wise;
...
exile of the people, and returned with you. Well,
...
J know that I have no wisdom, small or great. What
...
served him—his name I need not mention; he was a
politician whom I selected for examination—and the
...
by himself; and thereupon I tried to explain to him —
that he thought himself wise, but was not really wise;
and the consequence was that he hated me, and his
enmity was shared by several who were present and
heard me. So I left him, saying to myself, as I went
away: Well, although I do not suppose that either of, us
_knows anything really beautiful and good, I am better

APOLOGY v

_ off than he is,—for he knows nothing, and thinks that he
...
teemed were really wiser and better. I will tell you the
tale of my wanderings and of the ‘Herculean’ labours,
...
Then I knew that not by wisdom do poets write poetry,
but by a sort of genius and inspiration; they are like
diviners or soothsayers who also say many fine things,
but do not understand the meaning of them. The poets

8 PLATO

appeared to me to be much in the same case; and I fur-
...
rance, or like them in both; and I made answer to myself
...
occasion also to many calumnies. And I am called wise,
for my hearers always imagine that I myself possess the
wisdom which I find wanting in others: but the truth is,
O men of Athens, that God only is wise; and by his an-
swer he intends to show that the wisdom of men is worth
little or nothing; he is not speaking of Socrates, he is
only using my name by way of illustration, as if he said,
...
not wise; and my occupation quite absorbs me, and I
...
And this,-O men of Athens, is the truth and the whole
truth; I have concealed nothing, I have dissembled noth-
ing. And yet, I know that my plainness of speech

10 PLATO

makes them hate me, and what is their hatred but a
...
his country, as he calls himself. Against these, too, I
must try to make a defence:—Let their affidavit be read:
it contains something of this kind: It says that Socrates
is a doer of evil, who corrupts the youth; and who does
not believe in the gods of the state, but has other new
divinities of his own. Such is the charge; and now let
...
What, do you mean to say, Meletus, has they are able
...
that you never had a thought about the young: your

IZ PLATO

carelessness is seen in your not caring about the very
...
would have nothing to say te me and refused to teach

APOLOGY 13

me. And now you bring me up in this court, which is
...
about the matter. But still I should like to know, Me-
...
tions of them at the theatre! (price of admission one
...
_guilty of not believing in the gods, and yet of believing
...
Did ever man, Meletus, believe in the existende of
...
answer for yourself. There is no man whe ever did.

* Probably in allusion to Aristophanes who caricatured, and

- to Euripides who borrewed the notions of Anaxagoras, as well
...
ean I help believing in spirits or demigods;—must 1
not? -To be sure I must; and therefore I may assume
that your silence gives consent. Now what are spirits
er demigods? are they not either gods or the sons of
gods?
...
_ will ever believe that there are no gods if they are the
...
only too well how many are the enmities which I have
...
of many more; there is no danger of my being the last
of them.
...
ought only to consider whether in doing anything he is
doing right or wrong—acting the part of a good man or
of a bad. Whereas, upon your view, the heroes who fell
...
ceive and imagine, God orders me to fulfil the philoso-
pher’s mission of searching into myself and other men,
I were to desert my post through fear of death, or any
...
graceful sort, the ignorance which is the conceit that a
...
_ disobedience to a better, whether God or man, is evil
...
you shall die;—-if this was the condition on whicli you

78. PLATO

let me go, I should reply: Men of Athens, I honour and
...
tation, and caring so little about wisdom and truth and
...
young alike, not to take thought for your persons or
...
I shall never alter my ways, not even if I have to die
many times.
...
is not permitted to injure a better than himself. I do
...
_ figure of speech, am a sort of gadfly, given to the state
...
sleep), arid you think that you might easily strike me

20 PLATO

dead as Anytus advises, and then you would sleep on
for the remainder of your lives, unless God in his care
of you sent you another gadfiy. When I say that I am
given to you by God, the proof of my mission is this:—.
if I had been like other men, I shouid have not neglected
all my own concerns or patiently seen the neglect of
them during all these years, and have been doing yours,
coming to you individually like a father or elder brother,
exhorting you to regard virtue; such conduct, I say,
would be unlike human nature. If I had gained any-
thing, or if my exhortations had been paid, there would
have been some sense in my doing so; but now, as you
will perceive, not even the impudence of my accusers
dares to say that I have ever exacted or sought pay of
...
truth is, that no man who goes to war with you or any
other multitude, honestly striving against the many law-
fess and unrighteous deeds which are done in a state,
...
I can give you convincing evidence ld what I say, not
...
but nevertheless true. The only office of state which I
...
only one of the Prytanes who was opposed to the illegal-
ity, and I gave my vote against you; and when the ora--
tors threatened to impeach and arrest me, and you called
and shouted, I made up my mind that I would run the
risk, having law and justice with me, rather than take
part in your injustice because I feared imprisonment
and death. ‘This happened in the days of the democ-
racy. But when the oligarchy of the Thirty was in
power, they sent for me and four others into the ro-
tunda, and bade us bring Leon the Salaminian from
Salamis, as they wanted to put him to death. This was
...
an expression, I cared not a straw for death, and that
my great and only care was lest I should do an un-
righteous or unholy thing. For the strong arm of that
oppressive power did not frighten me into doing wrong;

22 PLATO

and when we came out of the rotunda the other four
...
Now do you really imagine that I could ae sur-
...
puted to me; for I never taught or professed to teach
him anything. And if any one says that he has ever
...
- not true, would be soon refuted. If I am or have been
corrupting the youth, those of them who are now grown
up and have become sensible that I gave them bad ad-
vice in the days of their youth should come forward as
accusers, and take their revenge; or if they do not like
...
he calls to mind how he himself on a similar, or even a
...
self-assertion or want of respect for you. Whether I
am or am not afraid of death is another question, of
which I will not now speak. But, having regard to pub-
lic opinion, I feel that such conduct would be discred-
...
forming and convincing him. For his duty is, not to
...
that which is my due. And what is my due? What re-
turn shall be made to the man who has never had the
wit to be idle during his whole life; but has been care-
less of what the many care for—wealth, and family in-
terests, and military offices, and speaking in the assem-
...
privately to every one of you, thither I went, and sought
to persuade every man among you that he must look to
...
be the order which he observes in all his actions. What
shall be done to such an one? Doubtless some good

APOLOGY 27

’ thing, O men of Athens, if he has his reward 3 and the
...
vinced you.’ But I cannot in a moment refute great
...
Shall I say imprisonment? And why should I live in
...
have none, and cannot pay. And if I say exile (and
...
great difficulty in making you understand my answer to
this. For if I tell you that to do as you say would be
a disobedience to the God, and therefore that I cannot
hold my tongue, you will not believe that I am serious;
...
and that the unexamined life is not worth living, you are
still less likely to believe me. Yet I say what is true,
...
- bulus, and Apollodorus, my friends here, bid me say
...
thought fit to leave nothing undone or unsaid. Not so;
the deficiency which led to my conviction was not of
words—certainly not. But I had not the boldness or
impudence or inclination to address you as you would
have liked me to do, weeping and wailing and lament-
ing, and saying and doing many things which you have
been accustomed to hear from others, and which, as I
maintain, are unworthy of me. I thought at the time
that I ought not to do anything common or mean when
in danger: nor do I now repent of the style of my de-
fence; I would rather die having spoken after my man-
...
thing. The difficulty, my friends, is not to avoid death,
but to avoid unrighteousness; for that runs faster than
death. I am old and move slowly, and the slower run-
ner has overtaken me, and my accusers are keen and
...
things may be regarded as fated,—and I think _ they
are well.
...
have killed because you wanted to éscape the accuser,
...
way of escape which is either possible or honourable;
...
_also to talk with you about the thing which has come
...
~ aman to death for asking questions: assuredly not. For
...
not neglected by the gods; nor has my own approach-
...
done me no harm, although they did not mean to do me
any good; and for this I may gently blame them.

Still I have a favour to ask of them. When my sons
are grown up, I would ask you, O my friends, to pun-
ish them; and I would have you trouble them, as I have
...
this, both I and my sons will have received justice at
your hands.
...
Scenr:—The Prison.of Socrates

Socrates. Wuy have you come at this hour, Crito? it
must be quite early?

Crito. Yes, certainly. is
...
- lar misfortunes, and age does not prevent them from
repining.
...
Soc. Very well, Crito; if such is the will of God, L
...
the opinion of the many? Good men, and they are the
...
_persuaded, then, and do as I say.
...
self anywhete else. For men will love you in other
...
tude could inflict many more imprisonments, confisca-_
...
men riot to be regarded. Now you, Crito, are not going
...
only, are to be valued, and that other opinions, and the
...
other proposition—that not life, but a good life, is to
be chiefly valued?
...
evil and dishonourable, as I was just now saying, and as
has been already acknowledged by us? Are all our for-
mer admissions which were made within a few days to
be thrown away? And have we, at our age, been earn-
estly discoursing with one another all our life long only
to discover that we are no better than children? Or,
in spite of the opinion of the many, and in spite of —
consequences whether better or worse, shall we insist
on the truth of what was then said, that injustice is
...
other when they see how widely they differ. Tell me,
then, whether you agree with and assent to my first
_ principle, that neither injury nor retaliation nor ward-
ing off evil by evil is ever right. -And shall that be the
premiss of our argument? Or do you decline and dis-
sent from this? For so I have ever thought, and con-
tinue to think; but, if you are of another opinion, let me
hear what you have to say. If, however, you remain of
...
_ you lies? Will you, O professor of true virtue, pretend
...
follow as is right; neither may any one yield or retreat
...
given you and every other citizen a share in evefy good
...
and you will confirm in the minds of the judges the jus- _
...
_ Or will you go to them without shame, and talk to them,
...
selves friends are good for spying, they will—to be
sure they will.

‘Listen, then, Socrates, to us a have brought you
...
not a doex of evil; a victim, not of the laws but of men.
But if you go forth, returning evil for evil, and injury
for injury, breaking the covenants and agreements
which you have made with us, and wronging those whom
you ought least of all to wrong, that is to say, yourself,
your friends, your country, and us, we shall be angry
with you while you live, and our brethren, the laws in
the world below, will receive you as an enemy; for they
...
ears, and prevents me from hearing any other. And JI
...
Socratss, who is the narrator of

Pror
the Dialogue to his Companion agri |
...
Crit1as Caritas, a wealthy Athenian

Scenrt:—The House of Callias

Companion. Wuere do you come from, Socrates? And
...
_ ‘Youth is most charming when the beard first appears’?
...
Com. And is this stranger really in your opinion ¥
...
_ these, we shall be only too glad; but if not, then we are
...
They_call him-a Sophist, Socrates, he replied.
...
But suppose a person were to ask this further ques-
...
stances, I suppose that he will make a Sophist_of me.

By the gods; TI said, and are you not ashamed at hav-
...
view of making any of them a profession, but_only-as-a
part of education, and~becausé a private gentleman and
...
de not even know to whom you are committing your soul
...
which makes~men-eloquent ? Meco s
...
stands). vai, as herein ie
- Yes, that may be assumed,

PROTAGORAS 57

And what is that which the Sophist knows and makes
his disciple know?

Indeed, he said, I cannot tell. _
...
deals wholesale or retail in the Sood of the soul? To
me thatappears, to te_his nature;

And what, Socrates, is the food of the soul?

58 PLATO

Surely, I said, knowledge. is the food of the soul; and
...
edge of Protagoras-or-of any one; but if not, then, oO
...
them into the soul_and-go your way, either greatly
...
_and when we have heard what he has to say, we may
take counsel of others; for not only is Protagoras at the
house of Callias, but there is Hippias of Elis, and, if I
am not mistaken, Prodicus of Céos, and several other
wise men.

To this we agreed, and feeeened on our way until
...
part of thera f appeared to be foreigners, whom Protag-

60 PLATO

oras had brought with him out of the various cities
...
astronomical questions, and he, ex cathedra, was deter-
...
and gentle nature. I thought that I heard ‘him called
...
the presence of the company? se
...
I.believe that_he aspires to political eminence; and_this.
...
old or young, and live with him, under the idea that they
...
for I do not believe that they eifected their purpose,
...
knowledge myself to be a Sophist and insracfor of
...
have been now many years in the profession—for all my
years when added up are many: there is no one here
present of whom I might not be the father. Where-
fore I should much prefer convérsing with you, if you
...
When J heard this, I said: Recta cotes! I do not at all
wonder at hearing you say this; even at your age, and

64 PLATO

with all your wisdom, if any one were to teach you what |
...
manner, and he will be able to speak and act for the
best in the affairs of the state. _

Do I understand you, I said; and is your meaning
that you teach the art of politics, and that you promise _
to make men good citizens? Gat ok wide
...
is free tochave a say—carpentér, tinker, cobbler, sailor,
passenger; fich and poor, high and low—any one who
likes gets up, and no one reproaches him, as in the for-
mer case, with not having learned, and having no

66 PLATO

teacher, and yet giving advice; evidently because they
...
To this several of the company answered that he
...
some he made to have few young ones, while those who
...
prosecuted for theft, owing to the blunder of Epes
metheus.
...
structed houses and clothes and shoes and beds, and
...
reverence and justice shall be put to death, for he is a
plague of the state.’
...
not of the favoured few; which, as I reply, is very nat-
...
else. Their notion is, that a man must have some degreé
...
_ would instruct, no one would rebuke, or be angry with

PROTAGORAS al

_ those whose calamities they suppose to be dué to nature
...
cases any man will be angry with another, and _repri-
...
evil-doér under the notion, or for the reason, that he has
done wrong,—only the unreasonable fury of a beast acts
in that manner. But he who desires to inflict _rational
punishment does not retaliate for a past wrong which
cannot be undone; he has regard to the future, and is de-
sirous that the man who is punished, and_he who see
...
mistaken, that your countrymen are right in admitting
...
_tance may cause death and exile to those who have’ no

PROTAGORAS 73

training or knowledge of them—aye, and confiscation
as well as death, and, in a word, may be the ruin of
families—those things, I say, they are supposed not
te teach them,—not to take the utmost care that they
...
and sé more fitted for speech and action; for the life
...
that there could be no state unless we were all flute-
...
est in the justice-and- virtue of one another, | and _this is
...
good than the sons ef bad ones? I think not. Would
...
tue, each one according to his ability; and you say,
...
true of virtue or of anything else; if a man is s better
...
the same of Paralus and Xanthippus themselves, for
...
eulty which. I am sure that Protagoras will easily ex-
...
whom I am more ready to trust. But I marvel at one
...
dom is the noblest of the parts. ag
...
ance,~or like holiness? iM rany Pe Geos
...
proposition that eS is holy and that holiness is just,
for there appears to me to be a difference between them.
But what matter? if you please I please; and let us as-
sume, if you will, that diustice is holy, and that holiness
is just.
...
blance to holiness, fer there is always some point of
...
_ And do you think, I said in a tone of surprise, that
...
And temperance makes tent temperate?
...
There is no other, he said, but thal.

PROTAGORAS 83

Then_every opposite has one opposite_only and no

more?
~~ He assented.

Then now, I said, let us rechpitnlate our admissions.
...
Then, Protagoras, which of the two assertions shall

84 PLATO

we renounce? One says that everything has but one
...
war. ibid this, I minded my business, and gently
said :—
...
_ pedient nor inexpedient for man, but only for horses;

and some for oxen only, and some for dogs; and some
...
that which is the greatest good to the outward parts of ©
...
ticular of virtue. For who is there, but you?—who not
...
conceal their profession, you proclaim in the face_of.
Hellas that-you-are-a Sophist or teacher of virtue and-
education, and are the first who demanded. pay in _re-
...
same thing? or has each of the namésa Separate sunder-
lying essence and corresponding thing having a peculiar
function, no one of them being like anyother of them?
...
some extent. similar, and that the-fifth_of them, which
...
In the next place, you would affirm virtve to be a good
...
And who when fighting with light shields—the pe!l-
tasts or the nonpeltasts?

The peltasts. And that is true of all other things, he
said, if that is your point: those who have knowledge _
are_more confident than those who have no knowledge,
...
Yes, he said, I have seen such persons far too con-
fident.
...
more than in the other, that the able are strong, al-—
...
confident courageous. For confidence may be given to_
...
Ido not know, Socrates, he said, whether I can ven-
...
ing that there are some pleasant things which are not
...
Ther my meaning is, that in as far as they are pleas-
...
slave, and might be dragged about anyhow. Now is
...
TI agree with you, Socrates, said Protagoras; and not
...
~us to discover how courage is related to the other parts
of virtue. If you are disposed to abide by our agree-
ment, that I should show the way in which, as I think,
...
you think them evil for any other reason, except because
...
you will be able to show us that standard. But you hive
...
what is he overcome? the enquirer will proceed to ask.
...
_mean,’ he will say, ‘but that you choose the greater evil
...
_ pleasures and the pains, and their nearness and distance,
...
_ tance,’ you would have laughed at us. But now, in
...
send your children, to the Sophists, who are the teach-
...
Prodicts laughed and assented, as did the others.

Then, my friends, what do you say to this? Are not

100° PLATO’

all actions honourable and useful, of which the tendency
is to make life painless and pleasant? The honourable
work is also useful and good?

This was admitted.

Then, I said, if the pleasant is the good, nobody ie
...
To this also they unanimously assented. i
...
premisses; and I would beg Protagoras to explain to us
...
which- was courage, diifered greatly from the others.
...
coward goes is the opposite of that to which thé cou-
...
And haye they not been shown to be cowards through
...
And the reason why they are cowards is admitted a
you to be cowardice?
...
to know whether you still think that there aré-men who
...
Cauiictes Socrates CHAEREPHON
Goreias Portus
Scense:—The house of Callicles
...
of your measuring beauty by the standard ot pleasure
and -utility.
...
Pol. No, not according to this way of putting the
case, Socrates.
...
of refutations, how enlike they are. All men, with the
...
Soc. And the suffering to him who is stricken is of
...
Soc. Then the punisher does what is attics and .
...
Soc. Then he who is punished suffers what is s good?
...
that the evil is weakness and disease and =)
...
Soc. And which of the evils is the most disgraceful?
. —Is not the most disgraceful of them injustice, and in
...
pleasure | or _advantage or both?

“Pol. Yes.

Soc. But is the being healed_a pleasant thing, and
...
Soc. Yes, because the patient is delivered from a
...
_ Soc. That is, he lives worst who commits the great-
...
evils; they ‘provide t themselves with money and Miata
But if we, Polus, are Sight do you see what follows, or
...
done wrong and_has not been punished, is, and ought to
be, the most miserable of all men; and that the doer ‘on
...
will be immediately punished ; he will run to. the ju udge,
of. Eainsilee may not be rendered chronic and become
...
parents or friends, or children or country; but may be
of use to any one who holds that instead of excusing he_
...
what he has stolen and spend it on him and his, regard-
...
of feelings among mankind, however varying in difier-
...
- opinion; and you do the same with Demus, the fair
...
“wonder at u me; but if you want to silence me, silence
philosophy, who is my love, for she is always telling ne
...
philosophy _ is always true. She is the teacher at whose
...
that I myself s should_be.at.odds with myself, and con-
tradict ‘nyself. aE.
...
rhetoric, and did not know justice, he would teach him
...
tend to be engaged in the pursuit of-truth, are appeal- _
...
he thinks, he is compellea tocontradict himself; and
...
Wher. Polus was speaking of the conventionally dis-
...
_ son, as I conceive, is that the makers of laws are the
...
them; and ised say, that dishonesty is shameful and un-
just; meaning g, by the word injustice, the desire of a
man to ie ae ‘than his neighbours; for knowing
...
justice consists in—the superior ruling over and_hay-
...
rise in rebellion and be lord over us, and the light of
...
numan life. Even if a man has good parts, still, if he
...
- pearance in the arena of philosophy. For, as Euripides
says,
...
comes effeminate. He flies from the busy centre and the
...
the penalty of death. And vet, pie what is the
value of
...
who is helpless, and has no power to save either him-
...
whether they are to be described as foliies or absurdities:
...
soul, he ought to have three qualities—knowledge, good- -
...
that you, Callicles, and Tisander ot Aphidnae, and An-
...
_ to be submitted to any further test. For you could not
...
_ there is no nobler enquiry, Callicles, than that which you
...
or not? Answer, Callisles, and let no modesty be found
...
1, knowing this, was dishonestly playing between them,
...
Cal. This man will never cease talking nonsense.
...
believe that you mean (and you must not suppose that
I am word-catching), if you allow that cee one is supe-
...
Soc. Stop there, and let me ask you what you woula
...
Soc. Either, then, he will have a larger share of the
...
Soc. I understand: then, perhaps, of coats—the skil-

GORGIAS 131

fullest weaver ought to have the largest coat, and the
...
Cal. Fudge about shoes! What nensense are you
talking?
...
ing of cobblers and fullers and cooks and doctors, as if
this had to do with our argument.

Soc. But why will you not tell me in what a mar
...
mean by superiors not cobblers or cooks, but wise poli-_
ticians. who understand the administration of a_ state,
...
defining the better and the superior to be the stronger,
...
perhaps _you-think that there is no necessity for him to —
...
longings. And this I affirm to be natural justiceand

GORGIAS 133

_ nobility. To this however the many cannot attain;
...
awful thing; and indeed I think that eed may
...
that the body (cépal) is our tomb (ofju«), and that the
...
whick he called the soul—because of its believing and
...
invisible world (de:3&), these uninitiated or leaky per-
...
*An untranslateable pun,—dt& td mOavéy te xar mtotexdy preg aa
a(Boy.

GORGIAS 135

should change your mind, and, instead of the intem-

~perate and insatiate life, choose that which is orderly
and sufficient and has a due provision for daily needs.
Do I make any impression on you, and aré you coming
...
intemperate is happier than that of the temperate? De
...
Soc. But the more you pour in, the greater the
...
Cal. I answer, that even the scratcher would lige
pleasantly.
...
_ ture to say, that they too are happy, if they only get

encugh of what they want? é

al. Are you not ashamed, Socrates, of introducing
...
~ there is some pleasure which is net a good?
...
Soc. And do you, Callicles, seriously maintain hee
you are saying?
...
which you would.call_knowledge? —
...
Soc. And were you not saying just now, that some
courage implied knowledge?

Cal. ~“I-was.

Soc. And you were speaking of courage and knowl-:
edge as two things different from one another? _
...
_with one another, or with the good.
...
like health and disease, they exclude one another; « man
...
Soc. I suppose that he is s affected by them, and gets
rid of them in turns?

Cal; Yes.

Soc. And he may have es and weakness in
