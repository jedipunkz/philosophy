---
source: "https://archive.org/details/dialoguesplato04platgoog"
title: "The dialogues of Plato"
author: "B. Jowett"
year: "1876"
captured_at: "2026-08-09T13:06:12Z"
updated_at: "2026-08-09T13:06:12Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Symposium"
plain_text_url: "https://archive.org/download/dialoguesplato04platgoog/dialoguesplato04platgoog_djvu.txt"
public_domain: true
...
- 著者: B. Jowett
- 初版: 1876
- 情報源: [archive](https://archive.org/details/dialoguesplato04platgoog)
- パブリックドメイン: ✓
...
OXrOBS    UIVITSBUTT    FBBBB    WABBHOtTSS
;    PATB&MOBTXB  BOW
...
MASTER    or    BALL10L    COLLBCB

KEG1US     PKOFB5SOK    OP     CRBBK     IN     THB     UNIVBKSITY     OP    OXFORD

DOCTOR     IN     THEOLOGY    OP     THE     UNIVERSITY     OP     LBYDBN
...
heartily  thank  them  for  the  pains  and  time  w^hich  they
...
Miillers  German  Translation  of  Plato  with  Introduc-
...
unworthy  of  Plato,  and  in  several  passages  plagriarized
...
and  essays  on  subjects  of  modem  philosophy  having
...
Its  object  is  not  merely  to  fender  the  words  of  one
...
g^ce,  simplicity,  stateliness,  weight,  precision ;  or  the
...
aXXa  or  yap.  There  is  a  similar  want  of  particles
expressing  the  various  gradations  of  objective  and
subjective  thought — -ttov,  J^,  iki]v,  /jiiinrot,  and  the  like,
...
passage,  varying  them  by  an  *or' — e.g.  eTria-TiifAfj,  *  science'
or  *  knowledge,*  elSog,  'idea*  or  'class,' — at  the  point
...
central  figure,  and  there  are  lesser  performers  a3  well : —
...
poetry — roXX^y  eorri  irelpa^  reXevraiov  iTriyivvfj/xa,  The
...
modern  thought  is  found  in  ancient,  and  we  maydaim
to   have   inherited,  notwithstanding  many  accidents   of

SECOND  EDITION.  xix

time  and  place,  the  spiri$  of  Greek  philosophy.  Yet
there  is  no  continuous  growth  of  one  intotRe  other,
but  a  new  begrinning,  partly  artificial,  partly  arising  out
...
^  Compare  Bentley's  Phalaris,  vol.  ii.  183  foil.
...
The  subject  of  the  Charmides  is  Temperance  or  <rcixl>poavvriy  a
...
require :  for  in  the  philosophy  of  Plato  a^pocrinni  still  retains  an  intel-
lectual element  (as  Socrates  is  also  said  to  have  identified  iT<a<fiptHrv¥ti
with  <ro(ftia :  Xen.  Mem.  iii.  9,  4),  and  is  not  yet  relegated  to  the  sphere
...
1  Cp.  Cic.  Tusc.  iii.  8,  16,  'o-ox^poo'vyi;,  quam  soleo  equidem  tum  temperan-
tiam  tum  moderationem  appellate  nonnunquam  etiam  modestiam:'  foil.
...
between  *  making '  and  '  doing/  and  w^ith  the  help  of  a  misapplied
...
tejidency  of  the  age  to  verbal  distinctions,  which  here,  as  in  the  Prota-
...
a  wUv  and  art  oidfv;  here  too  is  the  first  conception  of  an  absolute
...
the  charm  which  Socrates  is  unable  to  apply.  With  youthful  naYvei/,
...
name  of  a»<f>poavini.  Hence  we  see  with  surprise  that  Plato,  who  in
...
Socrates,  <who  h  the  narrator,  CHARMIDES.
...
Steph.^V/'ESTERDAY  evening  I  returned  from  the  army  at  Poti-
...
arc  just  entering  are  the  advanced  guard  of  the  great  beauty  of
...
beautiful  in  my  i:yQ,s,  But  at  that  moment,  when  I  saw  him
...
Chaerephon  called  me  and  said :  WTiat  do  you  think  of  him,
Socrates  ?     Has  he  not  a  beautiful  face.^

Most  beautiful,  I  said.

But  yKSM  would  think  nothing  of  his  face,  he  replied,  if  you
...
his  talking  to  us  in  the  presence  of  you,  who  are  his  g^uardian
and  cousin.
...
physicians  say  to  a  patient  who  comes  to  them  with  bad  ^y^s^
...
ever  obser\'e  that  this  is  what  they  say?
...
time  making  me  swear  to  his  words,  Met  no  one,  however  rich,
...
that  Charmides  is  not  only  pre-emin6nt  in  beauty  among  his
...
there  is  any  meaning  in  this  ;  and  first  tell  mc  whether  you
would  not  acknowledge  temperance  to  be  of  the  class  of  the
noble  and  good  ?

Yes.

But  which  is  best  when  you  arc  at  the  writing-master's,  to
...
And  to  read  ---licklv  -.r  skwLv-

And  in  oia'.-in;^  the  Ivre,  -"-r  -.vre^tlin;?.  c-icicress  or  cievemess
are  far  better  than  c-ietne«  and  slo'vues^-
Ve:^.
And  the  same  holda  :n  b«:x:ni^  and  :n  the  pancratiun::  r

And  in  leaoin:?  and  ri-xrlvji.  md  txi^iilv  exerdies  ircnenllv.
quicknes^?  and  ag:I:t>'  are  .;^'>:<i  :  slowness,  and  inactiVin.-.  and
cuietness.  are  bad*
...
Then.  I  said,  :n  all  >xi:Iv  ajti'jns.  not  ■::u:etne<2.  but  the
^^reate-st  a^ilirv*"  and  cuickness.  is  noblest  and  best  r

Ves,  certainly.

And  is  teni:>erance  a  !3rro<!  r

Ves,

Then,  in  reference  to  the  bod  v.  not  cuietness.  but  cuickress  will
be  the  hic^'her  degree  of  tenriperance.  if  temperance  is  a  g:«:d  -

True,  he  said.

And  which,  I  said.  \?i  better — fadlity  in  learning,  or  c:.7:c-!t\-
in  learning?

Facilitv.

Ves,  I  said  :  and  faciHt\-  in  leamin:^  is  learning  c-ick!v.  and
difnculn.-  in  leamin;^  is  learning  ouietly  and  slo'vlvr

Tri;e.

And  \?^  it  not  better  to  teach  one  another  quickly  and  ener-
getically, rather  than  quietly  and  slowiy?
...
And  is  not  shrewdne-s  a  quickness  or  cleverness  of  the  soul,  loo

and  not  a  cuietnessr

True.

And  is  it  not  best  to  understand  what  is  said,  whether  at  the
wr;tin:;-master3  or  the  music-masters,  or  aa\-\vhere  else,  not  as
quietly  a.s  fjossibic,  but  as  quickly  as  p^jisible  ?
...
After  a  momenfs  pause,  in  which  he  made  a  real  manly  effort
...
Was  he  right  who  affirmed  diat  ?
...
be  regarded  as  doing  nothing  when  he  reads  or  wntes  ?
...
'  The  English  reader  has  to  observe  that  the  word  'make'  (iroiclv),  in
Greek  has  also  the  sense  of  'do'  (irfiarrfiy).
...
(701^0-619)  of  the  good  you  would  call  doings  (irpof  €is),  for  I  have
...
Please  then  to  b^in  again,  and  be  a  little  plainer.  Do  you  mean
...
ignorant  of  their  own  temperance  t
...
him  who  dedicated  the  inscription,  *Know  thysdf!'  at  Delphi.
...
writing  implies  [o-ox^povei,  yvQiBi  o-cavrrfi^],  and  yet  they  may
...
*  Reading,  according  to  Heusde's  conjecture,  ofioXoy^o-oyrdp  cr<H.
...
Very  true,  he  said.
167  Then  the  wise  or  temperate  man,  and  he  only,  will  kn^w  hiqi-
...
after  the  comparative  in  Greek,  /xcl^oi/  t«i/o5,  creates  an  unavoidable  obscurity
in  the  translation.
...
motion,  and  the  power  of  heat  to  bum,  this  relation  to  self  will
be  regarded  as  incredible  by  some,  but  perhaps  not  by  others.  169
And  some  great  man,  my  friend,  is  ^yanted,  who  will  satis-
...
as  I  was  saying  before,  the  possibilit>%  and  in  the  second  place,
the  ad\'antage,  of  such  a  science ;  and  then  perhaps  you  may
satisfy  me  that  you  are  right  in  your  view  of  temperance.

Critias  heard  me  say  this,  and  saw  that  I  ^-as  in  a  difiiculty ;
and  as  one  person  when  another  }-a^Tis  in  his  presence  catches
the  infection  of  j-awning  from  him,  so  did  he  seem  to  be  driven
...
were  under  us  to  do  an>'thing  which  they  were  not  likely  to  do
well ;  and  they  would  be  likely  to  do  well  just  that  of  which
they  had  knowledge :  and  the  house  or  state  which  was  ordered
or  administered  under  the  guidance  of  ^lisdom,  and  ever>'thing
else  of  which  wisdom  was  the  lord,  would  ha\'e  been  well
ordered ;  for  truth  guiding,  and  error  ha\ing  been  expelled,  in
all  their  doings,  men  would  have  done  well,  and  would  have  172
been  happy.  Was  not  this,  Critias,  what  we  spoke  of  as  the
great  advantage  of  wisdom — to  know  what  is  kno^i'n  and  what
is  unkno^'n  to  us?
...
May  we  assume  then,  I  said,  that  i^-isdom,  \newed  in  this  new
light  merely  as  a  knowledge  of  knowledge  and  ignorance,  has
this  ad\'antage: — that  he  who  possesses  such  knowledge  will
more  easily  learn  an>lhing  which  he  learns;  and  that  every-
thing will  be  clearer  to  him,  because,  in  addition  to  the  know-
ledge of  indi\4duals,  he  sees  the  science,  and  this  also  will  better
enable  him  to  test  the  knowledge  which  others  have  of  vAxaX.  he
knoll's  himself;  whereas  the  enquirer  who  is  without  this  know-
ledge may  be  supposed  to  have  a  feebler  and  weaker  insight  ?
Are  not  these,  my  friend,  the  real  adx-antages  which  are  to  be
gained  from  wisdom?  And  are  not  we  looking  and  seekii^
after  something  more  than  is  to  be  found  in  her  ?

That  is  ver>'  likely,  he  said.

That  is  ver>-  likely,  I  said ;  but  \'er\-  likely,  too,  we  have
been  enquiring  to  no  purpose ;  as  I  am  led  to  infer,  because  I
observe  that  if  this  is  wisdom,  some  strange  consequences
would  follow.  Let  us,  if  you  please,  assume  the  possibilit>'  of
this  science  of  sciences,  and  further  admit  and  allow*  as  n-as
...
Monster  I  I  said ;  you  have  been  carr>'ing  me  round  in  a
...
How  then   can   wisdom   be  advantageous,  ^ving  no  advan-
tage?
...
said  Charmides:  if  you  who  arc  my  guardian  command  me,
...
doct  "Vs ;  for  Hesiod  says  that  *  potter  is  jealous  of  potter,  bard  of
bard ;  Jhd  subtle  doctors  tell  us  that  *  moist  is  the  friend  of  dry,  hot  of
...
Thus  we  arrive  at  the  conclusion  that  like  is  not  the  friend  of  hke,
...
1$  of  what  a  man  wants  and  of  what  is  congenial  to  him.  But  then
...
nezenus,  are  still  unable  to  find  out  what  a  friend  is.
...
he  is  unable  to  teach  them,  and  they  are  free  from  the  cone  of
knowledge.  (Cp.  Charm.)  The  dialogue  is  what  would  be  ci^.cd  in
...
terms  Mike'  or  *good'  is  too  strictly  limited;  Socrates  has  allowed
...
ments. Observe,  first,  thef  scene,  which  is  a  Greek  Palaestra,  at  a  time
...
Socrates,  <wbo  is  the  narrator.  Menexenus.
...
He  is  the  eldest  son  of  Democrates,  of  the  deme  of  Aexonfe.
...
There  will  be  no  difficulty  in  bringfng  him,  he  replied ;  if
...
same  rule  hold  as  about  your  father  i  If  he  is  satisfied  that  you
...
And  oh  I  let  me  put  another  case,  I  said :  There  is  the  g^eat
...
subject  td  others ;  and  these  things  will  not  be  ours,  for  we
...
In  the  meantime  Menexcnus  came  back  and  sat  down  in  his
...
reason  why  I  want  you  to  arg^c  with  him.
...
In  that  case,  the  one  loves,  and  the  other  is  loved  1
...
nor  of  g^'mnastic  exercises,  who  have  no  return  of  love ;  no,  nor
...
'Happy  the  man  to  whom  his  children  arc  dear,  and  steeds  having
...
be  dear,  whether  lox-ing  or  hating :   for  example,  ver>'  >'oung
children,  too  young  to   love,  or  even    hating   their   father  or  213
mother  when  they  are  punished  by  them,  are   ne\-er  dearer  to
...
will  be  our  guide ;   for  they  are  to  us  in  a  manner  the  fathers  a  14
...
that  the  bad,  as  is  often  said  of  them,  arc  never  at  unity  with
one  another  or  with  themselves  ;  for  they  are  passionate  and
restless,  and  anj^hing  which  is  at  variance  and  enmity  with  itself
...
the  exnl  never  attains  to  any  real  friendship,  either  with  good
...
What  place  then  is  there  £pr  friendship,  if,  when  absent,  good
men  have  no  desire  of  oner  another  (for  when  alone  they  are
...
And  what  of  health  ?  I  said.    Is  that  good  or  e\'il,  or  neither  }
...
arc  highly  valued  by  us,  that  is  not  the  truth  ;  for  the  truth  is
...
And  must  not  a  man  love  that  which  he  desires  and  aflfects  ?
...
TThen  the  lover,  who  is  true  and  no  counterfeit,  must  of
...
boys — ^they  appeared  to  us  to  have  been  drinkii^  rather  too
...
This  man  Stcsilaus  has  been  seen  by  him  on  board  ship  making  a
...
as  Nicias  sa3rs,  how  little  he  knows  the  man,  who  will  certainly  not
...
tried  both  amid  pleasures  and  pains.  Laches  replies  that  this  imiver-
...
them,  by  then*  own  confession,  have  been  ill-educated,  as  is  further
...
is  extremely  graceful;  and  his  military  exploits  natiirally  connect  him
...
natural  instinct  Lache$  exhibits  one  aspect  of  courage;  Nicias  the
...
at  any  time  afler  the  battle  of  Delium.
...
Melesias,  son  of  Tbucydides,  LACHES.

Their  Sons.  Socrates.

Stcph.  Lys.  You  have  seen  the  exhibition  of  the  man  fighting  in
'7^  armour,  Nicias  and  Laches,  but  we  did  not  tell  you  at  the
...
Ni€.  That  I  have  the  means  of  knowing  as  well  as  Laches ;
...
of  Sophronigcus  was  the  person  whom  they  meant.  Tell  me,
my  boy,  whether  this  is  the  Socrates  of  whom  you  have  often
spoken  ?

San.  Certainly,  father,  this  is  he.
...
La.  Indeed,  Lysimachus,  you  ought  not  to  give  hifn  up ;  for
...
by  faithful  witnesses  and  for  action^  like  these.  And  let  me
tell  you  the  pleasure  which  I  feel  in  hearing  of  your  fame,-  and
I  hope  that  you  will  r^ard  me  as  one  of  your  best  friends;
...
armour  regard  Lacedaemon  as  a  sacred  inviolabk  territory,
...
either  case  there  is  no  us^  in  such  an  acquirement.  For  my
...
wc  arc  consulting,  when  we  ask  which  of  us  is  or  is  not  skilled
...
accusation  that  can  b^  brought  against  any  one  by  those  nearest
...
objection,  suppose  that  you  take  Socrates  into  partnershi^x ;  and
...
Nk.  I  see  very  clearly,  Lysimachus,  that  you  have  only
...
that  where  Socrates  was,  the  ailment  would  soon  •  pass  from
...
medical  advisers  about  the  ^y^!&  or  the  ears,  or  about  the  best
...
Must  we  not  select  that  to  which  the  use  of  arm3  is  sup-
...
and  thither;'  and  he  passes  an  encomium  on  Aeneas  himself,  a$
...
pleasures,  either  flxed  in  their  rank  or  turning  upon  their
...
Soc,  Then,  according  to  you,  onl^  the  wise  endurance  is
courage  ?
...
La.   No  ;  that  is  not  courage  at  all,  any  more  than  the  last.    '93

LACHES.  95

Soc.  Again,  take  the  case  of  one  who  endures  in  war,  and  is
wining  to  fight,  and  wisely  calculates  and  knows  that  others
...
La.  What  principle?     And  to  what  extent?  i^^
...
La.  1  am  ready  to  go  on,  Socrates ;  and  yet  I  am  unused  to
...
sh£ll  endeavour  to  show.  Let  me  ask  you  a  question  :  Do  not
...
Nk.  Why,  because  he  does  not  see  that  the  physician's
...
'9^  property,  or  victory,  or  defeat  in  war,  or  in  any  sort  of  con-
...
Soc.  Do  you  agree  with  mc  about  the  parts?  For  I  say
...
Sac.  I  will  tell  you.  He  and  I  have  a  notion  that  there  is
...
^S"^.  But  we  were  saying  that  courage  is  one  of  the  parts  of
virtue?
...
Nic.  We  have  not.
200     -^^-  And  yet,  friend  Nicias,  I  imagined  that  you  would  have
...
replies,  *  That  he  will  teach  him  prudence  in  aflfairs  private  and  public ;
in  short,  tlie  science  or  knowledge  of  human  life.'
...
the  Athenian  people,  who  recognise  in  their  assemblies  the  distmction
...
education  of  youth  in  virtue  begins  ahnost  as  soon  as  they  can  speak,
...
a  whole,  or  diifcrent  names  of  the  same  thing  ?  Protagoras  replies  that
...
He  therefore  defends  himself  with  his  favoimte  weapon ;  that  is  to  say,
...
drawn  between  (eW)  to  be,  and  (yeycV^oi)  to  become :  to  become  good
...
to  argue  in  a  higlily  impressive  manner  that  the  whole  composition
...
The  argument  is  ^ow  resumed,  not  without  some  disdainful  remarks
...
proceeds  to  undermine  th^  last  stronghold  of  the  adversary,  first  obtain-
j)(     ing  from  him  the  admission  that  all  virtue  is  in  the  highest  degree  good :

The  courageous  are  the  confident ;  and  the  confident  are  those  who
know  their  business  or  profession :  tliose  who  have  no  such  knowledge
and  are  still  confident  are  madmen.  This  is  admitted.  Then,  says
Socrates,  courage  is  knowledge — an  inference  which  Protagonis  evades
...
ignorance.  The  argimient  is  drawn  out  in  an  imaginary  'dialogue
...
denying,  the  teachableness  of  virtue,  and  now  the  latter  ends  by  aflirm-
...
of  fiction,  aims  only  at  t^e  probable,  and  shows  in  other  Dialogues
...
of  composition;  and  the  affinities  of  the  Dialogues,»when  they  arc  not
...
The  *  great  personage '  is  somewhat  ostentadous,  but  frank  and  honest.
...
received  j)ay.  He  is  remarkable  for  the  good  temper  which  he  exhibits
...
between  hijn  and  Socrates  is  not  the  opposition  of  ^ood  and  bad,  true
...
between  the  Sophists  representing  average  public  opinion  arid  Socrates
...
A  fathers  have  bad  sons ;  (4)  he  is  right  also  in  observing  that  the  virtues
...
^  y^  The  aim  of  Socrates,  and  of  the  Dialogue,  is  to  show  the  unity  of
...
I  panied  with  knowledge;  or  to  point  out  with  Aristotle  that  the  same
...
of  cfiwv  tnalvrifu  a\a$ta>s,  which  is  hardly  consistent  with  the  rational  inter-
pretation of  the  rest  of  the  poem.  The  opposition  of  cuw*  and  yrvftrBai
...
the  same  time  Ilippias  is  desirous  of  substituting  a  new  interpretation
...
claim  of  philosophy  advanced  for  the  I-racedaemonians,  which  is  a  parody
...
too  bad/  that  Simonides  uses  the  Lesbian  (?)  word,  tnaitnjfUy  because  he
is  addrossing  a  T-csbian.  The  whole  may  also  be  considered  as  a  satire
on  those  who  spinj)ompous  theories  out  oj  nothing.
...
who  is  compelKnl  by  the  necessity  of  his  nature  to  be  a  partisan,  lending
offoctual  aid  to  Socrates :  there  is  Critias  assuming  the  tone  of  imparti-
ality ;  C'allias,  here  as  always  inclining  to  the  Sophists,  but  eager  for  any
intellectual  repast ;  Prodicus,  who  finds  an  opportunity  for  displa\-ing
...
by  the  mock  sublime  description  of  them  in  tlie  introduction.  It  may
Iv  remarked  that  Protagoras  is  consistently  presented  to  us  throughout
as  tlie  teacher  of  moral  and  political  virtue  :  there  is  no  allusion  to  the
theories  of  sensation  which  are  attributed  to  him  in  the  Thcaetetus  and
...
opposed  to  his  first  thesis.  The  for£ejDf_arjg[unient,  not  Socrates  or
Protagoras,  ha£_won  Jhfi-  day..
...
rhetorical  discourses  or  citations  from  the  poets,  r  The  second  question,
whether  the  virtues  are  one^pr  many,  though  at  first  sight  distinct,  is  ^
...
reciiniscence ;  and  also  probably  by  the  different  attitude  assumed  to-
...
prcliminar)'  studies  or  sketches  of  the  more  important  work,  at  any  rate
...
Protaf^oras  to  the  Meno  is  more  doubtful.  For  there,  although  the  same
...
and  the  Philcbus  offer  further  corrections  of  the  teaching  of  the  Prota-
...
of  men  and  aspects  of  tlie  truth,  especially  of  the  popular  and  philo-
...
able as  tlie  argument,  we  arrive  at  the  great  Socratic  thesis  that  virtiie
isjcnowledge.  This  is  an  aspect  of  the  truth  which  was  lost  almost  as
...
The  moral  and  intellectual  arc  always  dividing,  yet  they  must  be  reunited,
...
Socrates,  wi&o   u   the  narrator  of  PROTAGORAS,  "I

the  Dialogue  to  his  Compamon.  HiPPlAS,  /  Sophists,

Hippocrates.  Prodicus,     J

Alcibiades.  CklliaSj  a  wealthy  Athenian.
Critias.

Scene  : — The  House  of  Qdlias.
...
Sac.  What  of  his  beard  ?  Are  you  not  of  Homer's  opinion,
who  says  ^
...
Com.*Wh2it  do  you  mean — b,  citizen  or  a  foreigner?
...
Com.   Apd  do  you  just  come  from  an  interview  with  him?
...
to  him,  and  he  came  rushing  in  and  bawled  out :  Socrates,  arc
you  awake  or  asleep  ?
...
And  if  you  had  resolved  to  go  to  Polycleitus  the  Ai^ive,  or
