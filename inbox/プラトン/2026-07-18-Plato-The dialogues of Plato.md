---
source: "https://archive.org/details/cu31924092280126"
title: "The dialogues of Plato"
author: "Plato, Jowett, Benjamin, 1817-1893"
year: "1892"
captured_at: "2026-07-18T02:58:22Z"
updated_at: "2026-07-18T02:58:22Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Symposium"
plain_text_url: "https://archive.org/download/cu31924092280126/cu31924092280126_djvu.txt"
public_domain: true
...
- 初版: 1892
- 情報源: [archive](https://archive.org/details/cu31924092280126)
- パブリックドメイン: ✓
...
http://www.archive.org/details/cu31924092280126
...
DOCTOR  IN  THEOLOGY  OF  THE  UNIVERSITY  OF  LEYDEN  ;    LL.  D.  OF  THE  UNIVERSITIES
...
%UvJi  astiittm
ttfoi^ttx  ant)  SCorrectKb  (Slirous&out
...
The  additions  and  alterations  which  hpiyebeen  made,  both  in  the
...
assisted  me  in  the  Syniposium;  Mr.  Raper,  Fellow  of
...
is  opposed  to  his  own.  The  aim  of  tjie  Introductions  in
these  volumes  has  been  to  represent  Plato  as  the  father  of
Idealism,  who  is  not  to  be  measured  by  the  stkndard  of
utilitarianism  or  any  other  modem  philosophical  system.
H^  is  the  poet  or  maker  of  ideas,  satisfying  the  wants  of
...
light  and  knosuledge  under  which  he  is  living.  He  may  be
illustrated  by  tfee  writings  of  moderns,  but  he  must  be
interpreted  by  his  pwn,  and  by  his  place  in  the  history  of
...
extraordinary  value  and  int^est  for  us.

I  cannot  agree  with  Mr.  Girote  in  admitting  as  genuine
all  the  writings  commonly  attril^ted  to  Plato  in  antiquity,
any  more  than  with  Schaarschmidt  and  some  other  German
critics  who  reject  nearly  half  of  them.  The  German
critics,  to  whom  I  refer,  proceed  clHefly  on  grounds  of
internal  evidence ;  they  appear  to  me  to  lay  too  much  stress
on  the  variety  of  doctrine  and  style,  ijfhich  must  be
equally  acknowledged  as  a  fact,  even  in  ^he  Dialogues
regarded  by  Shaarschmidt  as  genuine,  e.  g.  in  the  Phae-
drus,  or  Symposium,  when  compared  with  the  I^aws.  He
...
Bdliol  College,  who  read  over  the  Republic  in  the  Second
...
the  Platonic  Dialogaaes  have  been  introduced  into  several
...
its  eflfect  on  very  minute  touches;  and  that  it  is  a  work  of
...
must  carry  in  his  mind  a  comprehensive  view  of  th©  whole

■  Dedication  to  the  .lEneis.

Preface  to  the  Second  and  Third  Editions.         xv

work,  of  what  has  preceded  and  of  what  is  to  follow, —  as
well  as  of  the  meaning  of  particular  passages.  His  ver^n
should  be  based,  in  the  first  instance,  cii  an  intimate  know-
ledge of  the  text ;  but  the  precise  order  and  arraB|f£ment  of
the  words  may  be  left  to  fade  Out  of  sight,  wiigsa-  the  transla-
tion begins  to  take  shape.  He  must  iosm  a  general  idea
of  the  two  languages,  and  reduce,  j^  one  to  the  terms  of
the  other.y  His  work  should  jje  rdiythmical  and  varied,  the
right  admixture  of  words  and  syllables,  and  even  of  letters,
.should  be  carefully  .attended  to;  above  all,  it  should  be
equable  in  s^jde.  There  must  also  be  quantity,  which  is
necesaaay  in  prose  as  well  as  in  verse :  fclauses,  sentences,
jiaEagraphs,  must  be  in  due  proportion.  Metre  and  even
rhyme  may  be  rarely  admitted;  though  neither  is  a
legitimate  element  of  prose  writing,  they  may  help  tp
lighten  a  ciftnbrous  expression  (cp.  Symp.  185  D,  197,
198).  nrhe  translation  ■  should  retain  as  far  as  possible
...
first  requirement  of  all,  that  it  be  English.  1  Further,  the
...
writerg  of  Greece,  Thucydides,  Plato,  .^schylus,  Sophocles,
...
to  supply  anything  wljich,  owing  to  the  genius  of  the
...
we  return  to  the  Greek  we  arp  apt  to  cramp  and  overlay
...
upwards  from  the  copy  to  the  originsil,  and  down  again

Preface  to  the  Second  and  Third  Editions.       xvii

from  the  origifial  to  the  copy  (Rep.  vi.  501  A).  His  calling
...
of  the  ^eatest  of  humsm  intelligences,  and  in  some  degree,
...
partly  adversafwe  and  alternative,  and  partly  inferential;
that  is  to  say,  the  members  of  a  sentence  are  either
opposed  to  one  another,  br  one  of  theffl  expresses  the
...
and  inferential  form :  they  have  fewer  links  of  connexionj
...
where  the  Greek  repeats  aXXa  or  ydp.  There  is  a  similar
want  of  particles  expressing  the  various  gradations  of
objective  and  subjective  thought  —  ttoi;,  6fi,  fifiv,.  fievroi,  and
the  like,  which  are  so  thickly  scattered  over  the  Greek
page.     Further,  we  can  only  realize  to  a  very  imperfect

xviii      Preface  to  the  Second  and  Third  Editions.

degree  the  common  distinction  between  ov  and  ju?},  and  the
...
into  one  smAsx.  They  are  also  more  regularly  devekped
from  within.  The  sentence  uia'dfs  ^rairatiser  "step  in  an
...
are  not  always  dertain  where  a  sentence  begins  and  ends ;
...
poetry  or  prose ;  it  was  woAA^f  TS'pof  rekevTolov  eTnyivvTuui.
...
Preface  to  the  Set^md  and  Third  Editions.        xix

in  English  are  mascOliHe  and  fertftsine,  and  there  is  a  simila^r
distinction  of  sex  in  the  words  denfefting  animals;  but  all
things  else,  whether  outward  objects  or  abstract  ideas,  are
relegated  to  the  class  pf  neuters.  Hardly  ffl  some  flight
of  poetry  do  we  ever  endue  any  of  them  with  the  •charac-
teristics of  a  sentient  being,  and  then  only  by  speaMng
of  thern  in  the  feminine  gender..  The  virtues  may  be
pictured  in  female  forms,  but  they  are  not  so  described
in  language;  a  ship  is  hurnorously  supposed  to  be  the
...
tendency  to  personifica,tion  which  is  seen  in  the  Greek
...
general  character  of  the  style.  Hence  arises  a  diffir
...
nojiiis  in  Greek  and  English  create  a  similar  but  lesser
awkwardne.ss.
...
resented  by  us  equally  with  thfe  repetition  of  words.  Yet
...
pf  tautology.  The  tendency  of  modern  languages  is  to
...
xxii      Preface  to  the  Second  and  Thifd  Editions.
...
another ;  as  in  society,  so  in  lettei-s,  we  expect  every  man
...
it  in  a  seilse  not  intended  by  the  author,  {c)  Another
...
uv  Kol  vvv  ETt  apiKpa  AmpoTo  AeAetTTTOt ;  Tlep.  i.  345  E;  ix.
588  C,  &c;  Or  again  the  modern  word,  which  in  substance
is  the  nfearest  equivalent  to  the  Greek,  may  be  found  to
include  associations  alien  to  Greek  life:  e.  g.  diKaarai,
'  jurymen,'  to,  (liaa  rHv  noknuv, '  the  bourgeoisie.'  {d)  The
...
For  example,  in  translating  .  Plato,  it  would  e,qually  be
an  anachronism  to  intrude  on  him  the  feeling  and  spirit
of  the  Jewish  or  Christian  Scripture^  or  the  technical
...
word  by  the  same  English  word.  There  is  po  reason
why  in  the  New  Testament  dmaioavvrj  should  always  be
rendered  '  righteousness,'  or  6ta6rjKri  '  covenant.'  In  such
cases  the  translator  may  be  allowed  to  employ  two  words
—  sometimes  when  the  two  meanings  occur  in  the  same
passage,  varying  them  by  an  '  or ' —  e.  g.  k-niarrifiTi,  '  science '
or  'Jfnowledge,'  stdof,  ' idea '  or  ' class,' ffw^pofftjvj/,  'tem-
perance' or  'prudence,' — at  the  point  where  the  change  of
meaning  occurs.  If  translations  are  intended  not  for  the
Greek  scholar  but  for  tiie  general  reader,  their  worst
...
language  easily  adapted  to  it.  The  rapidity,  aad  abrupt-
ness of  question  and  answer,  the  constant  repetition  of  r\
d'  oq,  eliTE,  e^ri,  &c.,  which  Cicero  avoided  in  Latin  (de
...
,  Protagoras, .  the  self-cortsciousness  of  Prodicus  and  Hip-
pias,  are  ^1  part  of  the  entertainment  To  reproduce  this
...
Although  the  connexion  between  therft  is  sometimes  acci-
...
spirit  of  Greek  philospphy.  There  is,  however,  no  con-
...
which  exist  in  aiicient  arid  modern  philosophy,  it  seems
...
same  thoughts  as  ourselves,  the  same  difBculties  which
...
the  classical  age  of  Greek  literature  are  forgeries  i.  Of
...
ip)  When  one  epistle  out  of  a  number  is  spurious,
...
'  Compare  Bentley's  Works  (Dyce's  Edition),  vol.  ii.  136  foil.,  222.
...
mistakes  of  fact,  as  e.  g.  about  the  Thirty  Tyrants  (p.  324  G),
...
concilable with  their  genuineness.  And  as  they  appear
...
same  .condemnation.-Tr.The  .final  conclusion  is  that  neither
...
of  Qcero,  and  still  more  in  that  of  Diogenes  Laertius  and
...
some  ihetorican  or  sc^ihist,  we  cannot  agree  with  him  in
also  supposing  that  they  are  of  any  historical  value,  the
father   as   there    is   no   early   independent    testimony   by

Preface  to  the  Second  and  Third  Editions,      xxix

which  they  are  sapported  'or  with  which  they  can  be
compared.

IV.  There  is  another  subject  to  wnich  I  must  briefly
call  attention,  lest  I  should  seem  to  have  overlooked  it.
Dr.  Henry  Jackson,  of  Trinity  College,  CMnbridge,  in  a
series  of  articles  which*  he  has  contributed  to  the  Journal
of  Philology  ( 1 88 1-6;  Vol,  x.  132-150,  253-293  ;  xi.  287-
...
Dialogues  he  no  longer  included  in  th-em  manufactured
articles  and  ideas  of  relation,  but  restricted  theni  to  'types
...
be  expressed  under  a  different  form  by  the  Trepof  and  the
oTOtpov  of  the  Philebus  (vol.  x.  275  foil.).  The  wepof  of
the  Philebus  is  the  principle  which  gives  form  and  measure
to  the  a-nupov;  and  in  the  'Later  Theory '  is  held  to  be  the
■Roaov  or  fiifpiov  which  converts  the  Infinite  or  Indefinite
into  ideas.  They  are  ^  neither  irepaivovTa  nor  aneipa,  but
belong  to  the  fiiKrbv  yivog  which  partakes  of  both.
...
(Juestion  v/hich  has  never  ^been  determined,  and  probably
...
argument '  I  do  not  propose  to  asceiid.  But  one  little
...
— Haec  rum  sunt  Aristotelis,  tamen  utitur auctor  Aristotelis  nomine  tahquam  stto.-
...
definite  change  diiring  his  period  of  authorship.  They  are
...
is'  true  that  the  theofy  of  Ideas  takes  several  different
...
ledge and  not  of  opinion ;  and  they  tend,  nbt  to  diversity,
...
ti^ansient,  in  whatever  form  of  words  expressed,  are  always
maintained  in  Plato.  But  the  lesser  logical  distinctions,
as  we  should  call  them,  whether  of  ontology  or  predication.

Preface  to  the  Second  and  Third  Editions,   xxxiii

•

which  troubled  the  ^re-Socratic  philosophy  and  came
to  the  front  in  Aristotle,  are  variously  discussed  and
explained.  Thus  far  we  admit  incon^tency  in  Plato,  but
no  further.  He  lived  in  an  age  before  logic  and  system
had  wholly  permeated  language,  and  therefore  we  must
not  alw^s  expect  to  find  in  him  systematic  arrangement
or  logical  precision:  — ' poema  magis  putahdum.'  But  he
...
of  language  wrote  as  clearly  as  lie  could  in  an  age  when
the  minds  of  men  were  clouded  by  controversy,  and  philo-
sophical terms  had  noi  yet  acquired  a  fixed  meaning.
...
a  greater  distance  than  would  be  allowable  in  a  modem

xxxiv   Preface  to  the  Second  and  Third  Editions.
...
taneously,' or  •  were  intended  to  be  studied  in  the  ordef
...
writer  himself ;  and  they  are  very  likely  to  be  modem  con-
sequences which  would  not  have  been  understood  by
htm.  '  I  cannot  think,'  says  Dr.  Jackson,  '  that  Plato
...
all  things,  are  now  to  be  explained  as  Forms  or  Types  of
sortie  things  only, —  that  is  to  say,  of  natural  objects:
these  we  conceive  imperfectly,  but  ate  always  seeking  in
...
genus,  the  dyad6v,i  in  the  Parmenides  his  aspirations  are
less  ambitious,'  and  so  on.  But  where  does  Dr.  Jackson
find  any  sucL  notion  as  this  in  Plato  or  anywhere  in
...
modem  philosophy,  and  between  physical  and  metaphysical
...
157  B-IS9  E)'in  the  smallest  degree  prove  his  point ' ;  and
...
notions  (Theaet.  176E;  Parm.  i3oBfoll. ;  Soph.  254  B  foil.,
...
PirefacA  to  the  Second  and  Third  Editions,   xxxvii
...
(5)  The  relation  of  the  Republic,  States-
...
The  subject  of  the  Charmides  is  Temperance  or  aaffxxsimi,  a  charmida.
...
Plato  ccMppoaiv^  still  retains  an  intellectual  element  (as  Socrates  is
also  said  to  have  identified  aa^poaiin;  with  mijita:  Xen.  Mem.  iii.  9,
...
i"0  He  answers  characteristically,  (i)' Quietness.'  ' But  Temperance
...
1  Cp.  Cic.  Tusq.  iii.  8,  16,  ' <r<^potrSt>ri,  quam  soleo  equidem  turn  temperan-
tiam,  turn  moderationem  appellare,  nonnunquam  etiam  modestiam :  '  foil.

4  Analysis  162-174.

Ckannides.      division  of  labour  which  exists  in  every  temperate  or  well-ordered
...
Still  an  element  of  knowledge  is  wanting  which  Critias  is  readily  1 64
induced  to  admit  at  the  suggestion  of  Socrates ;  and,  in  the  spirit
of  Socrates  and  of  Greek  life  generally,  proposes  as  a  fifth  defini-  165
tion,  (s)  Temperance  is  self-knowledge.     But  all  sciences  have  a
...
(6)  Temperance  is  the  knowledge  of  what  a  man  knows  and  of  igy
...
knowledge  ?   That  which  is  older,  heavier,  lighter,  is  older,  heavier,   j  68
...
itself<  how  does  the  knowledge  of  what  we   know  imply  the  j^o
...
which  temperance  gives  must  be  of  a  kind  which  will  do  us  good ;   j  y  ^
...
brings  happiness  is  the  knowledge  of  good  and  evil.     To   this  ^-ja
Gritias  replies  that  the  science  or  knowledge  of  good  and  evil,  and

Beginnings  of  Logic  and  Metaphysics.
...
knowledge  of  knowledge.    Socrates  replies  by  again  parting  off  the    analysis.
...
176  had  therefore  better  rest  in  the  knowledge  that  the  more  temper-
ate he  is  the  happier  he  will  be,  and  riot  trouble  himself  with  the
...
'  that  you  know,'  a  oUcv  and  8n  ol6ev;  here  too  is  the  first  conception
...
and  one  of  the  earhest  anticipations  of  the  relation  of  subject  and
...
things'  (Rep.  i.  354).  (7)  And  still  the  mind  of  Plato,  having
...
can  be  no  science  which  is  a  '  science  of  nothing '  (Farm.  132  B).
...
ail  elder.  His  childlike  simplicity  and  ingenuousness  are  con-
...
which  Socrates  is  unable  to  apply.  With  youthful  naiveti,  keeping
...
various  lights,  but  always  either  by  bringing  them  to  ,the  test  of  Inteoduc-
...
of  aa^poaimi.  Hence  we  see  with  surprise  that  Plato,  who  in  his
...
senses  of  the  word  aaijipoaiini,  or  temperance.  From  the  ethical
notion  of  temperance,  which  is  variously  defined  to  be  quietpess,
modesty,  doing  our  own  business,  the  doing  of  good  action^,  the
dialogue  passes  on  to  the  intellectual  conception  of  aaippoaiiv^,
...
distinction  of  Critias  between  noisly,  wpdrrEiv,  epy&ZeoBai,  none  of
...
Place  of  the  Charmides  among  the  Dialogues.
...
to  a  young  man  wlio  is  disturbed  by  theological  difficulties,  '  Do
...
of  search  (jireipaaruml),  which  have  no  conclusion,  (iii)  The  absence
...
which  are  not  found  in  the  later  ones,  (v)  Their  resemblance  to  one
...
steph.VT'ESTERDAY  evening  I  returned  from  the  army  at  Poti-  charmidesi
■^53     J     daea,  and  having  been  a  good  while  away,- 1  thought  Chaerephon,
that  I  should  like  to  go  and  look  at  my  old  haunts.     So  I   Sockates.
went  into  the  palaestra  of  Taureas,  which  is  over  against  the  Socrates,
...
My  visit  was  unexpected,  and  no  sooner  did  they  see  me  visits  Ws
...
me,  seizing   my    hand,  and  saying.  How  did   you   escape,  n™sfrom
...
lo  Return  of  Socrates  from  Potidaea.

Charmides.      Crftias  the  son  of  Callaeschms,  and  when  I  had  saluted  him
...
to  make  en-  began  to  make  enquiries  about  matters  at  home — about  the
quiries  about    present  state  of  philosophy,  and  about  the  youth.     I  asked

the  slate  of^  '^  i    J '  ,,,,  .,  i_

philosophy       whether,  any  of  them  were  remarkable  for  wisdom  or  beauty,
and  about  the    qj.  \^q^^     Critias,  dancing  at  the  door,  invited  my  attention  1 54

youth;  and  IS  ,  ,  .  .  j        n  ■  •  -i

told  of  the        to    some  youths  who  were   coming  m,  and  talking  noisily
beautifiii         j.^    ^^^   another,  followed  by  a  crowd.     Of   the   beauties,
...
thatby  this  time  he  must  be  almost  a  young  man.
...
hne  is  of  chalk ;  for  almost  all  young  persons  appear  to  be
...
a  troop  of  lovers  followed  him.  That  grown-up  men  hke
...
And  to  this  they  aU  agreed.  ,  0™'"°"'

By  Heracles,  I  said,  there  never  was  such  a  paragon,  if
he  has  only  one  other  slight  addition.  t
...
Then,  before  we  see  his  body,  should  we  not  ask  him  to  whose  soul  is
show  us  his  soul,  naked  and  undisguised?  he  is  just  of  an  body"^^^
...
pushing  with  might  and  main  at  his  neighbour  in  order  to  a  ludicrous
make  a  place  for  him  next  to  themselves,  until  at  the  two  endsv  ^
...
I  repUed  that  it  was  a  kind  of  leaf,  which  required  to  be
...
Ayith  yotir  consent,  Socrates,  he  said,  laughing.
...
The  cure  of  Zamolxis.

13

Did  you  ever  observe  that  this  is  what  charmides.
...
head,  or  the  head  without  the  body,  so  neither  ought  you  to  nor  the  body
...
157  the  eyes.  And  therefore  if  the  head  and  body  are  to  be  welly
you  must  begii^  by  curing  the  soul ;  that  is  the  iirst  thing.
...
'  Let  no  one,'  he  said,  '  persuad'e  you  to  cure  the  head,  until
...
rich,  or  noble,  or  fair,  persuade  you  to  give  him  the  ciue,
...
.   The  noble  ancestry  of  Charmides.
...
compels  him  to  improve  Wa  mind :  and  I  can  tell  you,  Socrates,
that  Charmides  is  not  only  pre-eaDaiBetit  in  beauty  among  his
equals,  but  also  in  that  quality  which  is  givezt  by  the  charm ;
...
Athenian  houses,  whose  union  would  be  Ukely  to  produce  a
...
commemorated  in  the  panegyrical  verses  of  Anacreon,  Solorij
and  many  other  poets,  as  famous  for  beauty  and  virtue  and  all
other  high  fortune :  and  your  mother's  house  is  equally  158
...
quired J:his  quality,  I  must  use  the  charm  before  I  give  you  the
medicine.     Please,  therefore,  to  inform  me  whether  you  admit

His  temperance.  15

the  truth  of  what  Critias  has  been  saying ; — have  jrou  or  have   ckarmides.
you  not  this  quality  of  temperance?  Socrates,

Charmides  blushed,  and  the  blush  height^ed  his  beauty,  Chaemides.
for  modesty  is  becoming  in  youth ;  he  then  said  very  ingenu-  ^^  modest
ously,  that  he  really  could  not  at  once  answer,  either  yes,  or  "charmides.
...
therefore  I  do  hot  know  how  to  answer  you.
...
question ;  for  if  temperance  abides  in  you,  you  must  have  an  f''""'

^  '  ^  ...  temperance:

opinion  about  her;    she  must  give  some  intimation  of  her  What  is  it?
...
the  streets,  and  talking,  or  anything  else  of  that  nature.     In  is  quietness,
...
And  the  same  holds  in  boxing  and  in  the  pancratimn?
...
And  in  all  that  concerps  either  body  or  soul,  swiftness
and  activity  are  clearly  better  than  slowness  and  quiet-
ness?

Clearly  they  are.

Then  temperance  is  not  quietness,  nor  is  the  temperate  Temperance

life  quiet, — certainly  not  upon  this  view ;  for  the  life  which  is  ^'^°"'.  f  "°

^      '  J  '^  '  more  quiet-

temperate  is  supposed  to  be  the  good.     And  of  two  things,  ness  than
...
After  a  moment's  pause,  in  which  he  made  a  real  manly  second  defini-
effort    to   think,   he   said:     My   opinion   is,    Socrates,   that  |i™'
temperance   makes   a   man   ashamed   or  modest,   and   that  u  modesty,
...
To  be  siu-e,  I  said ;  yet  I  doubt  whether  we  shall  ever  be
...
The  'riddle'  of  Critias.  19

Because,  I  said,  he  who  uttered  them  seems  to  me  to  have  chamides.
meant    one   thing,    and   said    another.     Is   the   scribe,   for  Socrates,
example,  to  be  regarded  as  doing  nothing  ^hen  he  reads  or  Charmides.
writes?
...
And  yet  if  reading  and  writing  are  the  same  as  doing,  you  writing  is  do-
were  doing  what  was  not  your  own  business?  '"^^  iswritiag

■n         1  1  t    •  y°"^  enemy  s

But  they  are  the  same  as  domg.  name  doing

.    And  the  healing  art,  my  friend,  and  building,  and  weaving,  ^°".''  °*"
and  doing  anything  whatever  which  is  done  by  art, — thesie
all  clearly  come  under  the  head  of  doing?

Certainly.

And  do  you  think  that  a  state  would  be  well  ordered  by  a  Must  a  good
law  which  compelled  every  man  to  weave  and  wash  his  own  ","^'"  ^^^^

'■  •'  his  own  coat,

coat,  and  make  his  own  shoes,  and  his  own  flask  and  strigU,  etc  ?
...
20  Critias  draws  verbal  distinctions,

ckarmides.      a  riddle,  thinking  that  no  one  would  know  the  meaning  of  the

Socrates,       words  '  doing  his  own  business.'

Smrr''         I  ^^  say,  he  replied.
...
The  secret  dis-       Critias  had  long  been  showing  uneasiness,  for  he  felt  that

Cri£^''''°  °^  ^^  ^^'^  ^  reputation  to  maintain  with  Charmides  and  the  rest
...
definition,
who  maintains       I  entirely  agree,  said  Critias,  and  accept  the  definition.

^ain^""'°"        ^^^^  ^°°^'  ^  ^^^^ '  ^^^  "^^^  '^*  ^^  repeat  my  question—
Socrates,         Do  you  admit,  as  I  was  just  now  saying,  that  all  craftsmen
...
which  he  has  learned  from  Prodicus.  21

And  axe  they  temperate,  seeing  that  they  make  not  for  ckarmides.
...
Nay*,  said  he ;  did  I  ever  acknowledge  that  those  who  do  and  is  quickly
the  business  of  others  are  temperate?  I  said,  those  who  make,  ^fc^ons™y
not  those  who  do.  him.
...
admitting  that  the  mating  anything  might  sometimes  become
a  disgrace,  when  the  employment  was  not  honourable,  to
have  thought  that  work  was  never  any  disgrace  at  all.  For  He  tries  to
things  nobly  and  usefully  made  he  called  works ;  and  siich  ^^^^^^
makings  he  called  workings,  and  doings ;  and  he  must  be  sup-  tinctions.
...
the  makings  (Trot^aetf)  of  the  good  you  would  call  doings
(TrpafEtf),  for  I  am  no  stranger  to  the  endless  distinctions  which
Prodicus  draws  about  names.  Now  I  have  no  objection
to  yoiu:  giving  names  any  signification  which  you  please,

'  The  English  reader  has  to  observe  that  the  word  '  make '  (7rot«i>),  in
Greek,  has  also  the  sense  of  '  do '  (vpaTTUv).
...
Yes,  he 'said;  and  yon,  friend,  would  agree.

No  matter  whether  I  should  or  not ;  just  now,  not  wliat  I
...
temperately,  and  be  wise  or  temperate,  but  not  know  his  own  '^"""as.

wisdom  or  temperance?  BmCntias

But  that,  Socrates,  he  said,  is  impossible ;  and  therefore  if  accept  this
this  is,  as  you  imply,  the  necessary  consequence  of  any  of  my  conclusion,
previous  admissions,  I  will  withdraw  them,  rather  than  admit  implies  know-
that  a  man  can  be  temperate  or  wise  who  does  not  know  ^^^J'-  ^""i

*•  the  famous

himself ;  and  I  am  not  ashamed  to  confess  that  I  was  m  error.   Delphic  in-
For  self-knowledge  would  certainly  be  maintained  by  me  to  ^^p"™-
be  the  very  essence  of  knowledge,  and  in  this  I  agree  with  self,-  means
...
imply  [(TW0pdv6i,  yvuiQi  ffowrov],  and  yet  they  may  be  easily  mis-
...
the  previous  discussion  (in  which  I  know  not  whether  you  or  Fifth  defini-
I  are  more  right,  but,  at  any  rate,  no  clear  result  was  attained),  l^""'
and  to  raise  a  new  one  in  which,  I  will  attempt  to  prove,  is  seif-
...
'  Reading,  according  to  Heusde's  conjecture,  d/ioXoy^aovros  not.
...
ot.     Please  then  to  allow  me  time  to  reflect.

Reflect,  he  said.

I  am  reflecting,  I  rephed,  and  discover  that  temperance,  or
...
And  if  you  were  to  asjk  me,  what  is  the  result  or  effect  of
architectiu-e,  which  is  the  science  of  building,  I  should  say
...
in  which  they  are  alike ;  but  they  are  not,  for  all  the  otKer
...
Then,  I  saidj  be  cheerful,  sweet  sir,  and  give  your  opinion
...
Then  the  wise  or  temperate  man,  and  he  only,  will  know  167
...
in  any  parallel  case,  the  impossibility  will  be  transparent
to  you.

How  so?  and  in  what  cases  do  you  mean?

In  such  cases  as  this:  Suppose  that  there  is  a  kind  of
vision  which  is  not  Kke  ordinary  vision,  but  a  vision  of  itself
...
sense  of  itself  and  of  other  senses,  but  which  is  incapable  of  Soceates,

perceiving  the  objects  of  the  senses?  ^  Cmtias.

I  think  not.  it  is  not  sup.

Could  there  be  any  desire  which  is  not  the  desire  of  any  analogy  of  ^

pleasure,  but  of  itself,  and  of  all  other  desires?  sense  or  of
...
I  should  not.
[68       Or  did  you  ever  know  of  a  fear  which  fears  itself  or  other
...
But  siurely  we  are  assuming  a  science  of  this  kind,  which,
...
howevef  as  yet  absolutely  deny  the  possibility  of  such  a
science ;  let  us  rather  consider  the  matter.

You  are  quite  right.       ~  ?

Well  then,  this  science  of  which  we  are  speaking  is  a  and  involves  a
science  of  something,  and  is  of  a  nature  to  be  a  science  of  ^""■''»'J'"'on

,.  •  in  the  case  of

SOmethmg?  comparative

Yes.  '=""'■

Just  as  that  which  is  greater  is  of  a  nattu-e  to  be  greater
than  something  else^?
...
there  is  comparison — greater,  less,  heavier,  lighter,  and  the  like — a  relation
to  self  as  well  as  to  other  things  involves  an  absolute  contradiction ;  and  in
other  cases,  as  in  the  case  of  the  senses,  is  hardly  conceivable.  The  use  of
the  genitive  after. the  comparative  in  Greek,  /iel^ov  nvog,  creates  an  nti-
...
is,  as  w6  say,  of  sound  or  voice.     Is  that  true?
...
is  called  wisdom  or  temperance  is   included.     I  altogether  ckarmides.
distrust  my  own  power  of  determining  these  matters :   I  am  Socrates,
not  certain  whether  there  is  such  a  science  of  *;ience  at  all ;    '^'"■"*^-
and  even  if  there  be,  I  should  not  acknowledge  this  to  be
wisdom  or  temperance,  tmtil  I  can  also  see  whether  such  a
science  would  or  would  not  do  us  any  good ;  for  I  have  an
impression  that  temperance  is  a  benefit  and  a  good.     And
therefore,    O   son    of    CaJlaeschrus,  as   you   maintain    that
temperance  or  wisdom  is  a  science  of  science,  and  also  of
the  absence  of  science,  I  will  request  you  to  show  in  the  first
place,  as   I  was  saying  before,  the    possibiKty,  and   in   the
second  place,  the  advantage,  of  such  a  science ;    and  then
perhaps  you  may  satisfy  me  that  you  are  right  in  yoiu-  view
of  temperance.

Critia's  heard  me  say  this,  and  saw  that  I  was  in  a  diffi-
...
Critias,  if  you  hke,  let  us  assume  that  there  is  this  science  of
...
Yes,  Socrates,  he  said ;  and  that  I  think  is  certainly  true :    ^  knowledge
for  he  who  has  this  science  or  knowledge  which  knows  itself  of  knowledge
will  become  like  the  knowledge  which  he  has,  in  the  same  jedge  of  self
...
Very  likely,  I  said ;  but  I  remain  a,s  stupid  as  ever ;  for  still
...
from  the  art  of  building, — 'jieilher,  from  wisdom  or  temper-
...
false  professor  of  knowledge.  Let  us  consider  the  niatter  in
...
sa3dng,  is  the  only  thing  which  the  physician  understands.
...
wisdom;
■    True.
:7i       And  further,  since  medicine  is  science,  we  must  infer  that
...
to  recognize  a  similar  faculty  of  discernment  in  o±ers,  there
would  certainly  have  been  a  great  advantage  in  being  wise ;
for  then  we-  should  never  have  made  a  mistake,  but  have
passed  through  hfe  the  unerring  gmdes  of  ourselves  and  of
...
have  been  well  orderfed ;  for  truth  guiding,  and  error  having
been  eUminated,  in  all  their  doings,  men  would  have  done
...
And  now  you  perceive,  I  said,  that  no  such  science  is  to   charmides.
be  found  anywhere.  Socrates,

I  perceive,  he  said.  ,  ^  Csitias.

May  we  assume  then,  I  said,  that  wisdom,  viewed  in  this  Yet  the  a
new  Ught  merely  as  a  knowledge  of  knowledge  and  ignor-  ^^^^  ^
ance,  has    this    advantage: — that   he  who    possesses    such  may  make  it
knowledge  will  more  easily  learn  anything  which  he  learns ;   so^"hTng^""
and    that    everything  will   be   clearer  to    him,  because,  in  and  to  test  the
addition  to  the  knowledge  of  individuals,  he  sees  the  science,  ^^^s^  ^^  °
...
Why,  I  said,  we  were  far  too  ready  to,  admit  the  great  a  doubt  raised
benefits  which  mankind  would  obtain  from   their   severally  ^''°"'*=

■'     advantage  of

doing   the   things  which    they  knew,  and    committing    the  a  science  of
things  of  which  they  are  ignorant  to  those  who  were  better  f"™™^'  =^<^"

°  /  o  if  It  IS  assumed

acquainted  with  ±em.  to  be  possible.
...
consequences  would  follow,  and  tiiat  I  was  afraid  we  were
...
What  do  youjnean?  he  said;  I  wish  that  you  could  make
...
dtefining,  and  that  she  has  absolute  sway  over  us;  then
...
Or  of  working  in  brass?  charmides.      ^

Certainly  not.  Sockates,  >

Or  in  wool,  or  wood,  or  anything  of  that  *rt?  Csitias.

No,  I  do  not.

Then,  I  said,  we  are  giving  up  the  doctrine  that  he  who
lives  according  to  knowledge  is  happy,  for  these  hve  accord-
...
1 74  for  example  as  the  prophet,  who,  as  I  was  saying,  knows  the
future.     Is  it  of  him  you  are  speaking  or  of  some  one  else?

Yes»  I  mean  him,  but  there  are  others  as  well.

Yes,  1  said,  some  one  who  knows  the  past  and  present
as  well  as  the  fatture,  and  is  ignorant  of  nothing.  Let  us
suppose  that  there  is-  such  a  person,  and  if  there  is,  you
will  allow  that  he  is  the  most  knowing  of  all  living  men.

Certainly  he  is.

Yet  I  should  like  to  know  one  dung  more :  which  of  the
different  kinds  of  knowledge  makes  \mR.  happy?  or  do  all
equally  make  him  happy?

Not  all  equally,  he  replied.

But  which  most  tends  to  mflke  him  happy?  the  knowledge
of  what  past,  present,  or  futiu-e  thing?  May  I  infer  this  to
...
Monster!  I  said;  you  have  been  carrying  me  round  in  a  Not  universal
circle,  and  all  this  time  hiding  from  me  the  fact  that  the  life  I'""'w'<=<'g«<

'  °  but  the

according  to  knowledge  is  not  that  which  makes  men  act  knowledge  of
rightly  and  be  happy,  not  even  if  knowledge  include  all  the  ?°°e1iB"''  °"''
sciences,  but  one  science  only,  that  of  good  and  evil.     For,  required  by
let  me  ask   you,  Critias,  -whether,   if  you  take   away   this,  ""*"'
...
whether  the  art  of  the  pilot  will  not  equally  save  our  lives
...
And  why,  he  repUed,  will  not  wisdom  be  of  use?  For,
...
Socrates  gives  up  the  enquiry.  37

discover  what  that  is  to  which  the  imposer  of  names  gave   charmides.
...
biUty  of  a  man  knowing  in  a  sort  of  way  that  which  he  does
...
truth ;  but  niocks  us  to  a  degree,  and  has  gone  out  of  its  way
...
And  still  more  am  I  grieved  g,bout  the  charm  which  I  learned  Very  likely
with  so  much  pain,  and. to  so  little  profit,  from  the  Thracian,  i,3s"™„'L
for  the  sake  of  a  thing  which  is  nothing  worth.     I  think  of  the  charm,
indeed  that  there  is  a  mistake,  and  that  I  must  be  a  bad  ,^a  fool  who
enquirer,  for  wisdom  or  temperance  I  believe  to  be  really  a  is  incapable
great  good ;  and  happy  are  you,  Charmides,  if  you  certainly  °  "^so^^s-
...
Charmides  said :   I  am  sure  that  I  do  not  know,  Socrates,  Nevertheless
whether  I  have  or  have  not  this  gift  of  wisdom  and  temper-  Channides  is

°  ^  desirous  to  be

ance ;  for  how  can  I  know  whether  I  have  a  thing,  of  which  chamed.
even  you  and  Critias  are,  as  you  say,  unable  to  discover  the
nature? — (not  that  I  beheve  you.)     And  further,  I  am  sure.

38

Charmides  is  irresistible.
...
Yes,  I  shall  use  violence,  he  replied,  since  he  orders  _me ;
...
Friendship?'  any  more  than  in  the  Chafmides  to  the  question,
...
207  called  away  to  take  part  in  a  sacrifice.  Socrates  asks  Lysis
...
Analysis.        ^j^^j^y  address  to  his  beloved.
...
or  he  who  is  loved  ?  or  are  both  friends  ?    T"rom  the  first  of  these
...
should  be  the  friend  (not  of  the  indifferent,  for  that  would  be  'Uke  217
the  friend  of  like, '  but)  of  the  good,  or  rather  of  the  beautiful  ?

But  T^hy  should  the  indifferent  have  this  attachment  to  the
...
wisdom  stands :  he  is  not  wise,  and  yet  not  unwise,  but  lie  has  Lysis.
ignorance  accidentally  clinging  to  him,  and  he  yearns  for  wisdom  analysis.
as  the  cure  of  the  evU.     (Cp.  Symp.  204.)

After  this  explanation  has  been  received  with  triumphant  acaord,
...
Thus,  as  in  the  Charmides  and  Laches,  and  several  of  the  other  Introduc-
...
44  Characters  of  the  Dialogue.

Lysis.  experience;     But  the  use  of  the  terms  '  like  '  or  '  good '  is  too

iNTKODuc-  strictly  limited ;  Socrates  has  allowed  himself  to  be  carried  away
...
love  of  Hippothales  towards  Lysis,  and  thechildlike  and  innocent
...
drive  the  chariot  ? '  'No  they  do  not. '  When  Menexenps  returns,
the  serious  dialectic  begins.  He  is  described  as  '  very  pugnacious,'
and  we  are  thus  prepared  for  the  part  which  a  more  youth  takes
in  a  difficult  argument.  But  Plato  has  not  forgotte,n  dramatic
...
The  subject  of  friendship  has  a  lower  place  iiuthe  modern  than
...
acknowledge  with  Cicero,  '  Nihil  difficilius  quam  amicitiam  usque
...
life  it  is  ^iractically  certain  that  many  changes  will  occur  of
...
Lysi?.  witft  whom,  we  come  into  contact,  and,  perhaps  in  a  few  pas-

iNTRODue-       sionate  and  exalted. naitures,  all  men  everywhere  ?    7)  The  ancients
™''-  had  their  three  kinds  of  ftiendskLp,  '  for  the  sake  of  the,  pleasant,

the  useful,  and  the  good: '  is  the  lastt»be«esolved  into  the  two  first;
or  are  the  two  first  to  be  included  in  the  last?  The  subject  was
puzzling  to  them  :  they  could  not  say  that  friendsh^  was  only  a
...
Symposium  iSoff.,  218'ff. ;  Lawsviii,  835  flf.).
...
persons  *n  mutual  affection  and  remembrance  of  one  another.
...
complain  of  one  another  for  making  new  fi-iends,  or  for  not
...
Difficulties  of  friendship.  47

a  shipwreck,  in  a  defeat,  in  some  other  failure  or  misfortune,  may  Lysis.   '
restore  the  necessary  courage  and  composure  to  the  paralysed  and  Introduc-
...
expect  too  rnuch  from  them ;  or  we  are  indolent  and  do  not '  keep
...
damusqtie  vicissim.  The  sweet  draught  of  sympathy-  is  not  inex-
...
oft6n  mar  than  make  a  friendship.  It  is  most  likely  to  be  per-
manent when  the  two  friends  are  equal  and  independent,  or  when
they  are  engaged  together  in  some  common  work  or  have  some
public  interest  in  common.  It  exists  among  the  bad  or  inferior  sor
...
ties  of  relationship,  and  without  the  thought  of  love  or  niarriage;

48  Dissolutions  of  friendship.

Lysis.  whether,  again,  a  wife  or  a  husband  should  have  any  intimate  friend,

Introduc-       besides  his  or  her  partner  in  marriage.     The  answer  to  this  latter
"ON.  question  is  rather  perplexing,  and  would  probably  be  different  in
...
love,  there  maybe  manly  friendships  of  men  to  women  and  womanly
friendships  of  women  to  men  ;  and  we  allow  that  the  mind  may  be
drawn  out  and  the  character  enlarged  by  such  attachments.  But  we
also  feel  that  they  are  attended  with  many  dangers,  and  that  this  Ro-
mance of  Heavenly  Love  requires  a  strength,  a  freedom  from  passion,
...
modern  life,  which  he  who  wishes  to  make  or  keep  a  friend  may  profit-
ably study.     (Cp.  Bacon,  Essay  on  Friendship ;  Cic.  de  Amicitia. )

LYSIS,   OR   FRIENDSHIP.

PESSONS  OF  THE -DIALOGUE.
...
steph.  ¥   WAS  going  from  the  Academy  straight  to  the  Lyceum,  LyHs.
■*    \     intending  to  take  the  outer  road,  which  is  close  under  socratbs.

the  wall.  When  I  came  to  the  piostem  gate  of  the  city,
...
not  only  in  love,  but  are  aheady  far  gone  in  your  love.
...
to  his  love;  he  has  a  voice  which  is  truly  appalKng,  and  we
...
retains  his  patronymic,  and  is  not  as  yet  commoiily  called  by
...
205  of  the  c&mpany,  and  then  I  shall  be  able  ta  judge  whether  ""'''°"
...
Yes,  indeed,  said  Ctesippus ;   I  know  only  too  well ;  and  Bm  though  he
very  ridiculous  the  tale  is :  for  although  he  is  a  lover,  and  ^l^^l^
very  devotedly  in  love,  he  has  nothing   particular   to  talk  love  poems
about  to  his  beloved  which  a  child  might  not  say.     Now  is  *'"'*'''

o  ■/  composes  are

not  that  ridiculous?  He  can  only  speak  of  the  wealth  of  made  up  of
Democrates,  which  the  whole  city  celebrates,  and  grandfather  p^^™"
Lysis,  and  the  other  ancestors  of  the  youth,  and  their  stud  of
horses,  and  their  victory  at  the  Pythian  games,  and  at  the
...
honour ;  for  if  you  win  your  beautiful  love,  yoiu:  discourses
and  songs  will  be  a  glory  to  you,  and  may  be  truly  regarded
as  hymns  of  praise  composed  in  honoiu-  of  you  who  have  con-
...
Assuredly  not,  he  said ;  such  a  poet  would  be  a  fool.  Aiid
...
Lysis  and  Menexenus  enter  the  Palaestra.  53

bring  your  love  to  me,  and  will  let  me  talk  with  him,  I  may  LysU.
perhaps  be  able   to   show  you  ho'vv  to  converse  with  him,  Socrates,
instead  of  singing  and  reciting  in  the  fashkn  of  which  you  "^""^^5
are  accused.

There  will  be  no  difficulty  in  bringing  him,  he  repUed ;  if
you  will  only  go  with  Ctesippus  into  the  Palaestfa,  and  sit
...
Upon  entering  we  found  that  the  boys  had  just  been  sacri-  The  boys  at
•ficing ;  and  this  part  of  the  festival  was  nearly  at  an  end.   *"'  games.
They  were  aU  in  their  white  array,  and  games  at  dice  were
going  on  among  them.     Most  of  them  were   in   the  outer
coiurt  amusing  themselves ;  but  some  were  in  a.  comer  of  the
Apodyterium  playing  at  odd  and  even  with  a  number  of  dice,
which  they  took  out  of  Uttle  wicker  baskets.     There  was  also
a  circle  of   lookers-on ;    among   them  was  Lysis.     He  was  The  beauty
207  standing  with  the  other   boys  and  youths,  having  a  crown  ^d  goodness
upon  his  head,  like  a  fair  vision,   and  not  less  worthy  of
...
us.     For  a  time   he  hesitated  and  had  not  the  courage  to  Lysis  and  his
come  alone ;  but  first  of  all,  his  friend  Menexenus,  leaving  Menexenus
his  play,  entered  the  Palaestra  from  the  court,  and  when  he  leave  the  boys
saw  Ctesippus  and  myself,  was  going  to  take  a  seat  by  us ;   ^^Toi  *'
and   then   Lysis,   seeing  him,  followed,  and  sat  down    by  young  men.
his    side;   and   the   other  boys  joined.     I    should   observe
...
The  two  boys  are  questioned  by  Socrates.
...
And  ariother  disputed  point  is,  which  is  the  fairer?
...
that  he  had  to  offer  sacriiice.  So  he  went  away,  and  I  asked
...
And  do  they  then  permjt  you  to  do  what  you  like,  and
never  rebuke  you  or  hinder  you  from  doing  what  you
de^jre?

Yfes,  indeed,  Socrates ;  there  are  a  great  many  things
...
There  is  a  charioteer,  whom  my  father  pay^or  driving,         ^^^'^■

And  do  they  trust  a  hireling  more  than  you?  and  may  he
do  what  he  Ukes  with  the  horses?  and  do  they  pay  him  for
this?

They  do.

But  I  dare  say  that  you  may  take  the  whip  and  guide  the
mule-cart  if  you  like ; — they  will  permit  tjiat?
...
they  prohibit  you?  Answer  me  now :  Are  you  yoiu'  own
...
Surely,  I  said,  this  is  a  strange  thing,  that  a  free  man  Heisafree-
...
lords  and  masters  on  you.     But  at  any  rate  when  you  gp
home  to  your  mother,  she  will  let  you  have  your  own  way,
and  will  not  interfere  with  your  happiness ;  her  wool,  or  the  He  may  not
piece  of  cloth  which  she  is  weaving,  are  at  your  disposal :   J,°"^„°JJ°j?/
I  am  sure  that  there  is  nothing  to  hinder  you  from  touching  spinning
...
hinder  irie,  but  I  should  be  beaten,  if  I  were  to  touch  one  of
them.
...
by  another ;  while  you,  LysiSj  are  master  of  nobody,  and  can
do  nothing?
...
you  know   more   of  housekeeping    than   he   does,   will  he  LyHs.

continue  to  administer  his  affairs  himself,  or  will  he  commit  Socrates,

them  to  you?  ^  ^^^'^■

- 1  think  that  he  will  commit  them  to  me.
...
And  oh!    let  me  put  another  case,  I  said:  There  is  the  to  cook  for

great  king,  and  he  has  an  eldest  son,  who  is  the  Prince  ,*™e'°J"^

of  Asia ; — suppose  that  you  and  I  go  to  him  and  establish  to  he  knows  how

his  satisfaction  that  we  are  better  cooks  than  his  son,  will  he  ^""^  <=»"•'=  ■>'

'  any  use  to

not  entrust  to  us  the  prerogative  of  making  soup,  and  putting  them.
...
to  your  beloved,  humbhng  and  lowering  him,  and  not  as  you
...
Suppose  that  you  tell  him  yotirself,  Lysis,  I  replied ;  for  I
am  sure  that  you  were  attending.

Certainly,  he  replied.  «

Try,  then,  to  remember  the  words,  and  be  as  exact  as  you
can  in  repeating  them  to  hinr,  and  if  you  have  forgotten  any-
thing, ask  me  again  the  next  time  that  you  see  me.

I  will  be  sure  t-o  do  so,  Socrates ;  but  go  on  teUing  him
...
Menexenus.  (.jjg^^  J  myself,  although  I  am  now  advanced  in  years,  am  so
far  from  having  made  a  similar  acquisition,  that  I  do  not  even
As  Lysis  and  know  in  what  way  a  friend  is  acquired.  But  I  want  to  ask
Menexenus  ^^^  ^  question  about  this,  for  you  have  experience :  tell  me
experience  in  then,  when  one  loves  another,  is  the  lover  or  the  beloved  the
wouidtskt'  friend ;  or  may  either  be  the  friend?  ■
question  of  Either  may,  I  should  think,  be  the  friend  of  either,

lo™  OT  the'  ^       D<^  yo^  mean,  I  said,  that  if  only  one  of  them  loves  the
beloved  the      other,  they  are  mutual  friends?

Yes,  he  said ;  that  is  my  meaning.

But  what  if  thf  lover  is  not  loved  in  return?  which  is
...
Yes.
Or  must  there       Then  which  is  the  friend  of  which?  Is  the  lover  the  friend
be  in  friend-     of  (jjg  beloved,  whether  he  be  loved  in  return,  or  hated ;  or

ship  a  return

ofiove?  IS  the  beloved  the  fnend ;  or  is  there  no  friendship  at  all  on
...
thmgs  are        jjqj  jg^g  jjj  retum ;  nor  lovers  of  quails,  nor  of  doss,  nor  of

dear  which  do        .  '      ,  ^  '  "  '

not  love  in       Wmc,  nor  of  gymnastic  exercises,  who  have  no  return  of  love ;
f"".'!U..t"5/°  no,  nor  of  wisdom,  unless  wisdom    loves  them   in   return.
Or  shall  we  say  that  they  do  love  them,  although  they  are

we  arrive  at

The  ambiguity  of  the  words  '  loving  and  beloved.'
...
'  Happy  the  man  to  whom  his  children  are  dear,  aittl  steeds  having
single  hoofs,  and  dogs  of  the  chase,  and  the  stranger  of  another  land '  7
...
'  Omitting  i^iXy,  or  reading  luay  instead.
...
up  with  the  argument ;  there  was  np  mistaking  his  attentive
...
people  who  argue  and  write  about  native  and  the  universe.
...
No,  net  the  like,  hut  only  the  good.  63

Then,  looked  at  in  this  way,  one  half  of  the  saying  is  untrue.  Lysis.
if  the  wicked  are  hke  one  another?  Socrates,

Quite  so.  «  ^™=-

But  what  I  imagine  to  be  the  real  meaning  of  the  words  is,  meaning  that  ^
that  the  good  are  hke  one  another,  and  friends  to  one  another ;
...
Then,  my  friend,  those  who  say  that  the  like  is  friendly  to  but  only  the
the  hke  mean  to  intimate,  if  I  rightly  apprehend  them,  that  |?°„j"^
...
I  will.     Assuming   like,  inasmuch    as  he  is  hke,  to  be  the
friend  of  like,  and  useful  to  him — or  rather  let  me  try  another
way  of  putting  the  matter:    Can  Uke  do  any  good  or  harm  to  But  what
like  which  he  could  not  do  to  himself,  or  suffer  anything  f°°'|h°Jg^j
from  his  like  which  he  would  not  suffer  from  himself?     And  do  to  one
if  neither  can  be  of  any  use  to  the  other,  how  can  they  be  ^eyamid'Mt
loved  by  one  another?     Can  they  now?  do  for
...
as  he  is  hke ;  stiU  the  good  may  be  the  friend  of  the  good  in
so  far  as  he  is  good?

True.

But  then  again,  will  not  the  good,  in  so  far  as  he  is  good.  The  good
be  sufficient  for  himself?     Certainly  he  will.     And  he  who  is  „, fri^^a^"""*
sufficient  wants  nothing— that  is  implied  in  the  word  sufficient.

64  The  like  is  the  enemy  of  like.
...
Another  word  '  Potter  quarrels  with  potter,  bard  with  bard,

of  a  poet:  Beggar  with  beggar ; '
'Potter

quarrels  with  an(j  gf  g,!!  other  things  he  affirmed,  in  like  manner,  '  That  of
necessity  the  most  like  axe  most  full  of  envy,  strife,  and
...
Friendship  and  couTt  him  who  knows.'  And  indeed  he  went  on  to  say
...
216  like.    And  I  thought  that  he  who  said  this  was  a  charming  Lysu.
man,  and  that   he   spoke   well.     What   do  the  rest  of  you  Soceates,
...
Then  we  aie  to  say  that  the  greatest  friendship  is  of  op-
posites?

Exactly.

Yes,  Menexenus ;  but  will  not  that  be  a  monstrous  answer?   But  this  is  a
and  will  not    the    all- wise    eristics    be    down   upon    us    in  doctrinr^For
triumph,  and  ask,  fairly  enough,  whether  love  is  not  the  very  friendship  is  of
opposite  of  hate ;  and  what  answer  shall  we  make  to  them —    '^\^  "°'
must  we  not  admit  that  they  speak  the  truth?

We  must.

They  will  then  proceed  to  ask  whether  the  enemy  i  is
the  friend  of  the  friend,  or  the  friend  the  friend  of  the
enemy?

Neither,  he  replied.

WeU,  but  is  a  just  man  the  friend  of  the  unjust,  or  the
...
Then  neither   like  and   like  nor   unlike  and  unlike   are  Then  neither

friends.  like  an4  like

nor  unhke  and
I  suppose  not.  mlike,  are
...
Why  really,  I  said,  the  truth  is  that  I  do  not  know ;  but  The  beautiful
my  head  is  dizzy  with  thinking  of  the  argument,  and  there-  ^^'gooafs'the
fore  I  hazard  the  conjecture,  that  'the  beautiful  is  the  friend,'  friend  of  the
as  the  old  proverb  says.     Beauty  is  certainly  a  soft,  smooth,  "„" evil*'™
slippery  thing,  and  therefore  of  a  nature  which  easily  slips
in  and  permeates  our  souls.     For  I  affirm  that  the  good  is
...
friend  of  good,  by  reason  of  the  presence  of  aril?  Menexenus.
...
Further,  I  must  observe  that  some  substances  are  assimi-  Eviimaybe
lated  when  others  are   present  with    them ;  and    there   are  ^"^^  *""'
some   which  are    not   assimilated:    take,  for   example,   the  assimilated.   ,
...
Lysis.  Arid  when  anything  is  in  the  presence  of  evil,  not  being  as

Socrates,  yet  evil,  the  presence  of  good  arouses  the  desire  of  good  in
Mknexenus.  ^Yiax  thing ;  but  the  presence  of  evil,  which  makes  a  thing
Jflinrouses  ^vil,  takes  away  the  desire  and  friendship  of  the  good ;  for
in  what  u  not  that  which  was  once  both  good  and  evil  has  now  become  evil
of  good.  '^^  only^  and  the  good  was  supposed  to  have  no  friendship
with  the  evil?
None.
...
wisdom.     There  ren^ain  those  who  have  the  misfortune   to
...
have  already  seen,  neither  is  unlike  the  friend  of  unUke,  nor

like  of  like.     You  remember  that?

Yes,  they  both  said.

Friendship  is        And  SO,  Lysis  and  Menexenus;  we  have  discovered  the

the  love  of  the  nature  of  friendship— there  can  be  no  doubt  of  it:   Friend-

good  when  ^

evil  is  present,  ship'  is  the  love  which  by  reason  of  the  presence  of  evil  the
...
Arguments,  I  am  afraid,  I  said,  that  the  argument  about  friendship  is

often™™'  ^"    isise :  arguments,  like  men,  are  often  pretenders,
pretenders.  How  do  you  mean?  he  asked.
...
And  has,  he  a  motive  and  object  in  being  a  friend,  or  has  ljisU.
he  no  motive  and  object?  Socrates,^

He  has  a  motive  and  object.  «  Mknexenus,

'  »  Lysis.

And  IS  the  object  which  makes  him  a  fnend,  dear  to  him,
or  neither  dear  nor  hateful  to  hini?
...
good  nor  evU,  because  of  disease,  that  is  to  say  because  of  evil,
...
Lysis.  which  has  been  declared  by  us  to  be  an  impossibility ;  but,
...
for  the  sake  of  Only,  but  whete.'  that  first  principle  is,  there  is  the  true  ideal  of
OTinething  friendship.  Let  me  put  the  matter  thus :  Suppose  the  case
...
silver  are  highly  valued  by  us,  that  is  not  the   truth ;  for  Lym.
there  is  a  further  object,  whatever  it  may  be,  which  we  value  Socrates,
most  of  all,  and  for  the  sale  of  which  gdd  and  all  our  menexenus.
...
so-caEed  dear  friendships  terminate.
...
put  the  case  in  this  way :   Suppose  that  of  the  three  principles,  for't^e'sJ^rol'
good,  evil,  and  that  which  is  neither  good  nor  evil,  there  re-  the  evU  is
mained  only  the  good  and  the  neutral,  and  that  evil  went  far  so^'ehi°he!-
away,  and  in  no  way  affected  soul  or  body,  nor  ever  at  all  principle  of
that  class  of  things  which,  as  we  say,  are  neither  good  nor  ,5J™  iJ^x^
evil  in  themselves ; — would  the  good  be  of  any  use,  or  other  required.
...
the  two,  because  of  the  evU?  but  there  is  no  use  in  the  good
for  its  own  sake.
...
7-2  Love  is  of  that  which  is  dear  and  congenial.

Lysis.  be  dear  because  of  the  hated,  and  if  the  hated  were  away

SocRATBs,       it  would  be  no  longer  dear.

Menexenus.        Yery  true,  he  replied :  at  any  rate  not  if  our  present  view

holds  good.
A  passing  But,  oh!  will  you  tell  me,  I  said,  whether  if  evil  were  to

res°'^rctin™the  Parish,  we  should  hunger  any  more,  or  thirst  any  more,  or
nature  of  evil,  have  any  similar  desire?  Or  may  we  suppose  that  hunger  221
...
which  is  not  evir should  perish  with  it?  .
...
True.
Evil  not  the         And  have  we  not  admitted  already  that  the  friend  loves
;friendsh^.°^    Something  for  a  reason?    and  at  the  time    of  making  the
...
must  be  some  other  cause  of  friendship?  ^  ■  Menexenus,

I  suppose  so.

May  not  the  truth  be  rather,  as  we  were  saying  just  now,   is  desire  the
...
Then  love,  and  desire,  and  friendship  would  appear  to  be  Yes,— desire
of  the  natural  or  congenial.  Such,  Lysis  and  Menexenus,  is  "ji**^^'"'
the  inference.  congenial.
...
Here,  intending  to  revise  the  argument,  I  said:   Can  we  But  our  former
...
the  other  argument  as  to  the  uselessness  of  hke  to  like  in  as  far
...
the  lover,  nor  the  hke,  nor  the  unlike,  nor  the  good,  nor  the
...
Here  I  was  going  to  invite  the  opinion  of  some  older
person,  when  suddenly  we  were  interrupted  by  the  tutors  of
Lysis  and  Menexenus,  who  came  upon  us  hke  an  evil
...
and  kept  calling  the  boys — they  appeared  to  us  to  have  been  sochates.
...
'7°  of  the  elder  Thucydides,  two  aged  men  who  lived  together,  are  Analysis.
...
Laches.  are  useless  and  ridiculous.     This  man  Stesilaus  has  been  seen  by
...
*a  bad  memory.  He  earnestly  I'equests  Socrates  to  remain; — in
...
jind  Laches  is  quite  willing  to  learn  from  Socrates,  because  his  189
...
must  be  denied  tq  animals  or  Children,  because  they  do  not  know
...
199  virtue,  but  only  on^  of  the  virtues.  The  terrible  is  in  the  future,
and  therefore  the  k^ipwledge  of  the  terrible  is  a  knowledge  of  the
future.  But  therg  can  be  no  knowledge  of  future  good  or  evil
...
single  virtue  would  be  the  same  as  all  virtues  (cp.  Protagorasj  350
...
Some  points  of  resemblance,  and  some  points  of  difference,      Introduc-
...
of  the  scene ;  the  Laches  has  more  play  and  development  of
...
The  seance  is  of  old  and  elder  men,  of  whom  Socrates  is  the
youngest.
...
the  friend  of  Sophrpniscus,  has  never  heard  of  the  fame  of  So-
...
The  definition  of  courage.  83

Laches  is  made  to  pass  on  from  the  more  popular  to  the  more  Laches.
philosophical ;  it  has  never  occurred  to  him  that  there  was  any  Introduc-
other  courage  than  that  of  the  soldier;  and  onl»,by  an  effort  of  ^'°*''
...
Laches  feU.  But  if  Socrates  was  more  than  seventy  years  of  age
...
MELESiAS,,jtf«  of  Thucydides.  Laches.

Their  Sons.  Socrates.

steph.    Lys.  You  have  seen  the  exhibition  of  the  man  fighting  in  Laches.

'78  annour,  Nicias  and  Laches,  but  we  did  not  tell  you  at  the  lysimachus.

time  the  reason  why  my  friend  Melesias  and  I  asked  you  to  Lysimachus

go  with  us  and  see  him.     I  think  that  we  may  as  well  confess  ^"^  Meiesias

,  ,  .  ^  .    ,  ,  -  request  Nicias

what  this  was,  for  we  certainly  ought  not  to  have  any  reserve  and  Laches  to

with  you.     The  reason  was,  that  we  were  intending  to  ask  '■^'^'^  ^'*

your  advice.     Some  laugh  at  the  very  notion  of  advising  respecting  the

others,  and  when   they  are  asked  will   not  say  what  they  education  of
...
were  intending  at  the  same  tinie,  if  you  did  not  object,  to
...
JVic.  As  far  as  I  am  concerned,  Lysimachus  and  Melesias,
...
to  us,  and  to  every  one  who  is  occupied  with  pubhc  affairs.

and  their  two  sons.  8  7

As  he  says,  such  persons  are  too  apt  to  be  negligent  and  care-  Laches.

less  of  their  own  children  and  their  private  concerns.     There  Lysimachus,

is  much  truth  in  that  remark  of  yours,  Ly^achus.     But  J^"*^;

why,  instead  of  consulting  us,  do  you  not  consult  our  friend  Laci,„

Socrates  about  the  education  of  the  youths?     He  is  of  the  recommends

same  deme  with  you,  and   is  always  passing   his  time  in  ta^lsomate^s

places  where  the  youth  have  any  noble  study  or  pursuit,  into  their

1  .  .  j.^  counsels.

such  as  you  are  enquinng  after.
...
Nic.  That  I  have  the  means  of  knowing  as  well  as  Laches  j
...
Lys.  Those  who  have  reached  my  time  of  life,  Socrates  Lysimachus
and  Nicias  and  Laches,  fall  out  of  acquaintance  with  the  ^  ^"^^ ,

'  ^  the  name  of

young,  because  they  are  generally  detained  at  home  by  old  Socrates,  and
age ;  but  you,  O  son  of  Sophroniscus,  should  let ,  yom-  fellow  ^s^o.^  *°,),at
demesman  have  the  benefit  of  any  advice  which  you  are  able  he  is  the  son
to  give.     Moreover  I  have  a  claim  upon  you  as  an  old  friend  frigid"'**
of  your  father;  for  I  and  he  were  always  companions  and   Sophroniscus.
friends,  and  to  the  hour  of  his  death  there  never  was  a
difference  between  us ;  and  now  it  comes  back  to  me,  at  the
mention  of  your  name,  that  I  have  iieard  these  lads  talking
...
the  name  of  your  father,  who  was  a  most  excellent  man ;    Lachespraises
and  I  further  rejoice  at  the  prospect  of  our  family  ties  being  *=  ™"rage
renewed.  shown  by

Lax.  Indeed,  Lysimachus,  you  ought  not  to  give  him  up ;   ^g^^'^^^^'f
for  I  can  assure  you  that  I  have  seen  him  maintaining,  not  Deiium.
...
gymnastics  could  be  better  or  harder  exercise ;  and  this,  and  182
...
of  the  art  of  fighting  in  armour.

89

assailant.  Certainly  he  who  possessed  the  art  could  not
meet  with  any  harm  at  tiie  hands  of  a  single  person,  or
perhaps  of  several ;  and  in  any  case  he  wouW  have  a  great-
advantage.  Further,  this  sort  of  skill  incUnes  a  man  to  the
...
and  when  he  has  learned  this,  and  his  ambition  is  once  iired,
...
the  Lacedaeiqonians,  whose  whole  life  is  passed  in  finding
...
90  The  misadventure  of  Stesilaus.

Laches.  ouiselves  j  which  is  the  reason  why  be  who  fancies  that  he

Laches,  Can  write  a  tragedy  does  not  go  about  itinerating  in  the

.  neighbouring  states,  but  rushes  hither  straight,  and  exhibits
These  masters  at  Athens;  and  this  is  natural.  Whereas  I  perceive  that
of  fence  never  ^j^^^     fightcrs   in  armour   regard   Lacedaemon  as  a  sacred

venture  on  La-  »-       o  «j  i_       ■  i_      i  •

cedaemonian    inviolable  territory,  .which  they  do  not  touch  with  the  point
ground.  ^£  jjjgjj.  £qjj^  .  ^j^j  jjjgy  make,  a  circuit  of  the  neighbouring
...
many  of  these  gentlemen  in  actual  service,  aad  have  taken
...
practised    the   art,   they   appear-  to   be  a.  most  unfortuna,te
Laches  had      exception.     For  example,  this  very  Stesilaus,  whom  you  and
SesiiauT*"""  ^  ^^^^  J'^®'  witnessed  exhibiting  in  all  that  crowd  and- making
cutting  a  very  such 'great  professions  of  his  powers,  I  have  seen  at  another
fi'^ure'in^        time  making,  in  sober  truth,   an  involuntary  exhibition  of
a  naval  himself,  which  was  a  far  better  spectacle.     He  was  a  marine

engagement,  ^^  boaid  a  ship  which  struck  a  transport  vessel,  and  was
armed  with  a  weapon,  half -spear;  half  scythe;  the  singularity
of  the  weapon  "was  worthy  of  the  singularity  of  the  man.  To
make  a  long  story  short,  I  wtli  -only  -tell  you  what  4rappened
...
be  an  art  of  which  the  advantage  is  so  slight,  m  not  an  art  at  Lvs™a™us,
all,  but  only  an  imposition,  in  either  case  such  an  acquirement  The  an  an
...
not  let  him  go  until  he  has  giveri  you  his  opinion  of  the
matter.

Lys.  I  was  going  to  ask  this  favour  of  you,  Socrates ;  as  is  Our  two
...
them.     Had  they  agreed,  no  arbiter  would  have  been  required,  ^"so^^^s'
But  as  Laches  has  voted  one  way  and  Nicias  another,  I  should
like  to  hear  with  which  of  our  two  friends  you  agree.

Soc.  What,    Lysimachus,   are   you  .going    to   accept    the  what,  and  are
opinion  of  the  majority  ?  Z^ '°  ^!"t ,
...
Soc.  His  one  vote  would  be  worth  more  than  the  vote  of  "^j,"  „"/"""
...
natiu-e  of  the  art  of  which  we  want  to  find  the  masters?
...
Soc.  And  when  you  pall  in  an  adviser,  you  should  see
whether  he  too  is  skilful  in  the  accomplishment  of  the  end
which  you  have  in  view?

to  works  of

W/io  are  qualified  to  teach  ?  93

Nic.  Most  true.      '  z«to.

Soc.  And  at  present  we  have  in  view  some  knowledge,  of  nioas,

which  the  end  is  the  soul  of  youth?  Sochates,

my     Vp«  •  Laches.

IlllC.     XeS.  The  means  is

Soc.  And  we   are   enquiring,  Which   of  us   is   skilful   or  f^^ ''■■'d  "f

,   ,    .        ,  ^  c»  knowledge;

successful  m  the  treatment  of  the  soul,  and  which  of  us  has  the  end  the

had  good  teachers?  improvement

7-        TIT-  n  1  r.  1'  of  the  soul  of

IM.   Well  but,  Socrates ;  did  you  never  observe  that  some  youth,
persons,  who  have  had  no  teachers,  are  more  skilful  than  which  of  us
those  who  have,  in  some  things?  can  teach  and

boc.  Yes,  Laches,  I  have  observed  that;  but  you  would  teachers?
...
formidable  accusation  which  can  be  brought  against  any  one  ™"'^  never
by  those  nearest   to  him.     As  for  myself,  Lysimachus  and  teacher,  but
Melesias,  I  am  the  first  to  confess  that  I  have  never  had  N"^"^^"'^

'  _  Laches  may

a  teacher  of  the  art  of  virtue ;  although  I  have  always  from  have  leamed

my  earliest  youth  desired  to  have  one.     But  I  am  too  poor  soSf;5,s  ^^^

to  give  money  to  the  Sophists,  who  are  the ,  only  professors  their  opinions

of  moral  improvement ;  and  to  this  day  I  have  never  been  ™iue';f  ^°ey

able  to  discover   the  art  myself,  though  I  should   not  be  only  agreed

siuprised  if  Nicias  or  Laches  may  have  discovered  or  learned  anothCT^
...
believe  that  they  are  able  to  educate  a  man ;  for  unless  they
had' been  confident  in  their  own  knowledge,  they  would  never
have  spoken  thus  decidedly  of  the  pursuits  which  are  advan-
tageous or  hurtful  to  a  yetrng  man.  I  repose  confidence
in  both  of  them ;  btrf  I  am  surprised  to  find  that  they  differ
...
yourselves,  let  lis  go  to  them,  and  present  them  with  gifts,  or
...
tors. But  if  you  are  yoiu'selves  original  discoverers  in  that
...
The  zvays  of  Socrates.  95

like  our  own,  are  nearly  of  an  age  to  be  educated.     Well,  Laches.
then,  if  you  have  no  objection,  suppose  that  you  take  Socrates  Nicias,
into  partnership;   and  do  you  and  he  ask  and  answer  one  lIc^es"""''
another's  questions:   for,  as  he  has  well  saSl,  we  are  de-
liberating about  the  most  important  of  our  concerns.     I  hope
that  you  will  see  fit  to  comply  with  our  request.

Nic.  I  see  very  clearly,  Lysimachus,  that  you  have  only  Socrates  will
known    Socrates'   father,   and   have   no    acquaintance   with  ''=="'« '°ask

'  ^  you  about

Socrates  himself:    at  least,  you  can  only  have  known  him  your  soul.
...
whatever  subject  he  may  start,  he  will  b'e  continually  carried
round  and  round  by  him,  uptil  at  last  he  finds  that  he  has  to
188  give  an  account  both  of  h'is  present  and  past  life ;  and  when
he  is  once  entangled,  Socrates  will  not  let  him  go  until  he.
has  completely  and  thoroughly  sifted  him.     Now  I  am  used  Nicias  is  of
to  his  ways ;  and  I  know  that  he  will  certainly  do  as  I  say,   "u^h  con'ver
and  also  that  I  myself  shall  be  the  sufferer ;  for  I  am  fond  sation  is  very
...
says,  he  will  wish  and  desire  to  be  learning  so  long'  as  h€
lives,  and  will  not  think  that  old  age  of  itself  brings  wisdom.
To  me,  to  be  cross-examined  by  Socrates  is  neither  unusual
nor  unpleasant ;  indeed,  I  knew  all  along  that  where  Socrates  Laches,  like
was,  the  argument  would  soon  pass  from  our  sons  to  our-  ready^to  be'"^
selves ;  and  therefore,  I  say  that  for  my  part,  I  am  quite  willing  cross-exam-
to  discourse  with  Socrates  in  his  own  manner ;  but  you  had  especially
better  ask  our  friend  Laches  what  his  feehng  may  be.  by  ^  '™e

La.  I  have  but  one  feeling,  Nicias,  or  (shall  I  say?)  two  "^^^
feelings,  about  discussions.     Some  would  think  that  I  am  a  correspond
lover,  and  to  others  I  may  seem  to  be  a  hater  of  disc'oiu-se ;   actions.
...
of  wisdom,  who  is  a  true  man  and  worthy  of  his  theme,  I  and
delighted  beyond  measure :  and  I  compare  the  man  and  his
words,  iand  note  the  harmony  and  correspondence  of  them;
...
and  shall  be  dehghted  to  be  interrogated  by  a  man  such  as
...
but  that  the  teacher  is  youngefj  or  not  as  yet  in  repute —
...
haye  entertained  of  you  ever  since  the  day  on  which  you
...
Lys.  But  this  is  our  proper  business ;  and  yoiu's  as  well  as
oursi  lor  I  reckon  you  as  one  of  us.  Please  then  to  take  my
...
know,  for  the  sake  of  the  youths,  and  talk  and  consult  with  Laches.
them :  for  I  am  old,  and  my  memory  is  bad ;  and  I  do  not  socraths,
remember  the  questions  which  I  am  going  tg  ask,  or  the  Laches.
answers  to  them ;  and  if  there  is  any  interruption  I  am  quite
lost.     I  will  therefore  beg  of  you  to  carry  on  the  proposed
discussion  by  yoiu:  selves ;  and  I  will  listen,  and  Melesias  and
I  will  act  upon  yoiu:  conclusions.

Soc.  Let  us,  Nicias  and  Laches,  comply  with  the  request
of  Lysimachus  and  Melesias.     There  will  be  no  harni  in
...
would  improve  some  other  thing,  and  were  able  to  make  the  g^fore'^e"
addition,  then,  clearly,  we  must  know  how  that  about  which  can  impart
we   are   advising  may  be  best    and   most   easily   attained,  ^^^mw  '
Perhaps  you  do  not  understand  what  I  mean.     Then  let  me  the  nature
190  make  my  meaning  plainer  in  this  way.     Suppose  we  knew
...
advisers  about  the  eyes  or  the  eais,  or  about  the  best  mode
...
Sac.  And  that  which  we  know  we  must  surely  be  able  to  tell?

Za.  Certainly.

Sac.  I  would  not  have  us  begin,  my  friend,  with  enquiring
...
^c.  And  yet.  Laches,  you  must  except  the  Lacedaer
monkwis  at  Plataea,  who,  when  they  came  upon  the  light
shields  of  the -Persians,  are  said  not  to  have  been  willing  to
stand  and  fight,  and,  to  have  fled ;  but  when  the  ranks  of  the
Persians  were  broke%  they  turned  upon  them  like  cavahy,
and  won  the  battle  of  Plata^^

La.  That  is  true.

Soc.  That  was  my  meaning  whe%  I_  said  that  I  was  to
...
about  the  courage  of  cavahy  and  every  other  style  of  soldier ;
and  not  only  who  are  courageous  in  war,  but  who  are
courageous  in  perils  by  sea,  and  who  in  disease,  or  in
poverty,  or  again  in  poUtics,  are  courageous ;  and  not  only
...
Soc.  And  aU  these  are  courageous,  but  some  have  courage
...
manner,  What  is  that  common  quaUty  which  is  called
tourage,  and  which  includes  all  the  various  tises  of  the  term
when  appUed  both  to  pleasure  and  pain,  and  in  all  the  cases
...
La.  It  would  be  wrong,  Socrates,  to  say  so.
...
all  things  small  as  weU  as  great?     For  example,  if  a  man

possessed  of  knowledge.  lOi

shows  the  quality  of  endurance  in  spending  his  money  wisely,  Laches.
knowing  that  by  spending  he  will  acquire  more  in  the  end;  do  Socrates,
you  call  him  courageous?  _  Laches.
...
193       La.  Not  at  all,  any  more  than  the  last.

Soc.  Again,  take  the  case  of  one  who  endures  in  war,  and  is  he  who
is  willing  to    fight,  and  wisely  calculates,  and    knows  that  f^^h™'
others  will  help  him,  aiid  that  there  will  be  fewer  and  inferior  escapes  a
men  against  him  than  there  are  with  him ;  and  suppose  that  he"w]^' "
he  has  also  advantages  of  position ; —  would  you  say  of  such  a  havii>g  no
one  who  endures  with  all  this  wisdom  and  preparation,  that  enSres'and
he,  or  some  man  in  the  opposing  army  who  is  in  the  opposite  remains
circumstances  to  these  and  yet  endures  and  remains  at  his  post,^he
post,  is  the  braver?  braver?

Zfl.  I    should    say   that    the    latter,    Socrates,    was    the  The  latter,
braver.
...
are  not  attuned  to  the  Dorian  mode,  which  is  a
