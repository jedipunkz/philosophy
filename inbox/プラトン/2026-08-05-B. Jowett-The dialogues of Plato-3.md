---
source: "https://archive.org/details/dialoguesplato04jowegoog"
title: "The dialogues of Plato"
author: "B. Jowett"
year: "1876"
captured_at: "2026-08-05T08:48:45Z"
updated_at: "2026-08-05T08:48:45Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Symposium"
plain_text_url: "https://archive.org/download/dialoguesplato04jowegoog/dialoguesplato04jowegoog_djvu.txt"
public_domain: true
...
- 著者: B. Jowett
- 初版: 1876
- 情報源: [archive](https://archive.org/details/dialoguesplato04jowegoog)
- パブリックドメイン: ✓
...
RFX:iUS    PROPRSSOK    OF     GREEK     IN     THE     UNIVERSITY    OK    OXFORD

DOCTOR    IN     THEOLOGY     OK    THE     UNIVERSITY     OF     LEYDEN
...
KY  HORACB  HART,  PRINTER  TO  THB  UNIVERSITY
...
The  additions  and  alterations  which  hai*€  been  made,  both  in  the
...
ance  which  is  naturally  felt  by  the  ozvner  of  a  book  at  the  possession
of  it  in  an  inferior  fomt,  and  still  more  keenly  by  the  writer  himself,
...
arranged  that  tlwse  who  would  like  to  make  this  exchange,  on  deposit-
...
Mailer's  German  Translation  of  Plato  with  Introduc-
...
ihe  residuum  of  truth  which  remains  for  ourselves.  His
...
considerabl3Mndebted  to  Mr.  J.  W.  Mackail,  late  Fellow  of
...
I.  An  EngHsh  translation  ought  to  be  idiomatic  and
...
the  Greek,  but  is  necessarj'  to  make  the  English  clear  and
consecutive.
...
Preface  to  tlie  Second  and  Third  Editions,  xvii
...
cause  or  effect  or  condition  or  reason  of  anothers     The
...
where  the  Greek  repeats  a\Aa  or  ycfp.     There  is  a  similar
want  of  particles  expressing  the  various  gradations  of
objective  and  subjective  thought — ttov,  6^,  \)}i\v^  tiivToi^  and
the  like,  which  are  so  thickly  scattered  over  the  Greek
page.     Further,  we  can  only  realize  to  a  very  imperfect

VOL.  1.  b

xviii  Preface  to  t/ie  Second  and  Third  Editions,

degree  the  common  distinction  between  ov  and  /jt?/,  and  the
combination  of  the  two  suggests  a  subtle  shade  of  negation
which  cannot  be  expressed  in  English.  And  while  Enghsh
...
(2).  The  fonnation  of  the  sentence  and  of  the  paragraph
...
poetry  or  prose ;    it  was  7roAX7;9  wci^as  TiK^vraXov  l-Riyiwywka,
...
in  language ;  a  ship  is  humoroHsly  supposed  to  be  the
...
been  laid  aside  and  have  dropped  out  of  use.    (i)  A  similar
...
iAV  KoX  vvv  In  (TfALKpa  ovfCpara  AcActTrrat ;    Rep.  i.  345  E ;    ix.

588  C,  &c.  Or  again  the  modem  word,  which  in  substance
is  the  nearest  equivalent  to  the  Greek,  may  be  found  to
include  associations  alien  to  Greek  life :  e.  g.  biKaaraC^
'jurymen,'  rh  fiiaa  tQv  TToAtTwi;,  '  the  bourgeoisie.'  (d)  The
...
why  in  the  New  Testament  hLKato<rvvrj  should  always  be
rendered  'righteousness,'  or  biaSrJKr}  'covenant.'  In  such
cases  the  translator  may  be  allowed  to  employ  two  words
— sometimes  when  the  two  meanings  occur  in  the  same
passage,  varying  them  by  an  '  or ' — e.  g.  cTrtonj/jiTy,  '  science  *
or  '  knowledge,'  clSoy,  '  idea '  or  '  class,'  (r(i><t)po<rvvrjy  '  tem-
...
5'  OS,  ctTTc,  c</)iy,  &c.,  which  Cicero  avoided  in  Latin  (de
...
performers  as  well : — the  insolence  of  Thrasj^machus,  the
...
tp  the  form  of  question  and  answer,  and  so  the  ease  of
...
ization ;  but  in  some  cases  a  mere  word  has  sur\'ived,  while
...
*  Compare  Ikntley^s  Works  (Dycc's  Edition),  vol.  ii.  136  foil.,  222.
...
RepubHc  and  the  Laws  are  continually  recurring  in  them ;
...
Athenian  empire  to  the   empire  of  Darius  (332  A,  By,
...
Preface  to  tfie  Second  and  Third  Editions,    xxix
...
pubhc  and  in  the  Phaedo  he  had  dreamt  of  passing
...
XXX   Preface  to  the  Second  and  Thu'd  Editions,

Metaphysics  (Book  I.e.  6),  a  passage  containing  an  account
of  the  ideas,  whicli  hitherto  scholars  have  found  impos-
...
be  expressed  under  a  different  form  by  the  Trcpas  and  the
aTT€Lpov  of  the  Philebus  (vol.  x.  275  foil.).  The  iripa^  of
the  Philebus  is  the  principle  which  gives  form  and  measure
to  the  &Tr€ipov ;  and  in  the  '  Later  Theory'  is  held  to  be  the
TT6<rov  or  fiirpiov  which  converts  the  Infinite  or  Indefinite
into  ideas.  They  are  neither  -n^palvovra  nor  i-n^ipa^  but
belong  to  the  yuKTov  yivo^  which  partakes  of  both.
...
quoted  by  Dr.  Jackson  (1.6),  about  two  octavo  pages  in
...
Haec  non  sunt  AristoteliSy  tamen  utitur  auctor  Aristotelis  nomine  tanquam  suo.
...
or  logical  precision  : — ^ poema  magis  ptitanditni!  But  he
...
xxxiv    Preface  to  the  Seccntd  and  Third  Editions,
...
Preface  to  the  Second  and  Third  Editiotis,    xxxv
...
Ideas,  which  were  once  regarded  as  the  siimma  genera  of
...
xxxvi  Preface  to  the  Second  and  Third  Edition'^.
...
final  ones  by  tracing  their  connexion  with  the  summtim
gentiSy  the  ayaOor^  in  the  Parmenides  his  aspirations  are
...
for  Geschichte  der  Philosophic,  Vol.  I,  Berlin,  1888,  pp.
617,  618).
...
The  subject  of  the  Charmides  is  Temperance  or  a-otxppoovinj,  a  Charmides.
...
Plato  (rcaippoavinj  Still  retains  an  intellectual  element  (as  Socrates  is
also  said  to  have  identified  o-a></>poo-vin;  with  ao<f)ia :  Xen.  Mem.  iii.  9,
4),  and  is  not  yet  relegated  to  the  sphere  of  moral  virtue,  as  in  the
Nicomachean  Ethics  of  Aristotle  (iii.  10).
Sttpii.  The  beautiful  youth,  Charmides,  who  is  also  the  most  temperate  Analysis.
j|^  of  human  beings,  is  asked  by  Socrates,  *  What  is  Temperance  ? '
...
*  Cp.  Cic.  Tdsc.  iii.  8,  16,  '  aojfpoavyrf,  quam  soleo  equidem  turn  temperan-
tiam,  turn  moderationem  appellare,  nonnnnqaam  etiam  modestiam  : '  folL

B  2

4  Analysis  162-174.

Charmtdes.  division  of  labour  which  exists  in  every  temperate  or  well-ordered
...
(6)  Temperance  is  the  knowledge  of  what  a  man  knows  md  of  167
...
all  the  other  sciences,  are  regulated  by  the  higher  science  or  Chamiides.
...
a  scieiice  of  the  whole  as  well  as  the  parts,  and  of  the  mind  as  well
...
*  that  you  know,'  4  /  W  and  on  oidci* ;  here  too  is  the  first  conception
...
which  Socrates  is  unable  to  apply.  With  youthful  nalv€te\  keeping
...
abstract  he  is  superseded  by  Critias  (cp.  Thcaet.  168  E ;  Euthyd.
290  E).    Socrates  preserves  his  accustomed  irony  to  the  end  ;  he

Tfie  definitions  of  temperance.  7

is  in  the  neighbourhood  of  several  great  truths,  which  he  views  in   Chamiides,
various  lights,  but  always  either  by  bringing  them  to  the  test  of    Intsoduc-
...
of  a-a(l>poavyrj.  Hence  we  see  with  surprise  that  Plato,  who  in  his
...
senses  of  the  word  o-ox/ipoo-uwy,  or  temperance.  From  the  ethical
...
dialogue  passes  on  to  the  intellectual  conception  of  o-a></>poo-i;i^,
...
distinction  of  Critias  between  nouhf  Trpdrrtiv,  €pyd((a-6M,  none  of
...
8  Pl(ue  of  the  Charmides  among  the  Dialogues.

Charmides.   to  a  young  man  who  is  disturbed  by  theological  difficulties,  *  Do
Intboduc-     not  trouble  yourself  about  such  matters,  but  only  lead  a  good  life ;  *
...
of  search  (Trctpaomitat),  which  have  no  conclusion,  (iii)  The  absence
...
Socrates,  who  is  the  narrator.  Charm  ides.
...
stepii.  'X/'ESTERDAY  evening  I  returned  from  the  army  at  Poti-  ChartnUes,
'53      X     daea,  and  having  been  a  good  while  away,  I  thought  Chaerephon,
that  I  should  like  to  go  and  look  at  my  old  haunts.     So  I
went  into  the  palaestra  of  Taureas,  which  is  over  against  the  ^^q  ^^5
...
me,  seizing  my  hand,  and   saying,   How  did  you  escape,  ^^^rom
...
Return  of  Socrates  from  Potidaea.
...
or  both.  Critias,  glancing  at  the  door,  invited  my  attention  154
...
Now  you  know,  my  friend,  that  I  cannet  measure  anything,
...
And  to  this  they  all  agreed.  Cbitias.
...
show  us  his  soul,  naked  and  undisguised  ?  he  is  just  of  an  ^^  as  hL
...
and  me.     Great  amusement  was  occasioned  by  every  one  ap^?^
...
us,  and,  O  rare  I  I  caught  a  sight  of  the  inwards  of  his  gar-
...
head  alone,  and  not  the  rest  of  the  body  also,  is  the  I  iight
...
attempt  to  cure  the  body  without  the  soul ;  and  this,'  he  said,   ^^jj^''**'
...
question  ;  for  if  temperance  abides  in  you,  you  must  have  an  J^gmper-
opinion  about  her ;    she  must  give  some  intimation  of  her  ance :
nature  and  qualities,  which  may  enable  you  to  form  a  notion  ^^^*^'>sit?
...
In  order,  then,  that  I  may  form  a  conjecture  whether  3'ou
...
soul,  and  not  a  quietness  ?  Charm.des.
...
life  quiet, — certainly  not  upon  this  view ;  for  the  life  which  is  ^^^^'
temperate  is  supposed  to  be  the  good.     And  of  two  things,   more  quiet-
one   is  true, — either  never,  or  very  seldom,   do  the  quiet  n^ss^n
...
or  in  an3rthing  else ;  nor  will  the  quiet  life  be  more  temperate
...
effort  to   think,    he  said:    My  opinion   is,    Socrates,    that  ^emj!^^'
...
'  Modesty  is  not  good  for  a  needy  man '  f
...
Bur  temperance,  whose  presence  makes  men  only  good,
...
The  '  riddle '  of  Critias.  1 9

Because,  I  said,  he  who  uttered  them  seems  to  me  to  have  Charmides,
...
were  doing  what  was  not  your  own  business  ?  ^°1"^  •  **

°  "^         ^  wnting

But  they  are  the  same  as  doing.  your

And  the  healing  art,  my  friend,  and  building,  and  weaving,   «n«™y's
...
162  and  other  implements,  on  this  principle  of  every  one  doing  own  coat,
...
And  are  they  temperate,  seeing  that  they  make  not  for  Charmides,
...
the  business  of  others  are  temperate  ?  I  said,  those  who  make,  ^^^^Un

not  those  who  do.  contra-

What !    I   asked ;    do  you   mean   to  say  that,  doing  and  ^jctions  by

,  .  ,  _  him.

makmg  are  not  the  same  ?
...
a  disgrace,  when  the  emplo3rment  was  not  honourable,  to
have  thought  that  work  was  never  any  disgrace  at  all.      For  He  tries  to
things  nobly  and  usefully  made  he  called  works ;   and  such  ^lY^J*^*^"
...
the  makings  (Troi^acir)  of  the  good  you  would  call  doings
(vpcif ftf),  for  I  am  no  stranger  to  the  endless  distinctions  which
Prodicus  draws  about  names.  Now  I  have  no  objection
to  your  giving  names  any  signification  which   you  please,

^  The  English  reader  has  to  observe  that  the  word  *make'  (voicfK),  in
Greek,  has  also  the  sense  of  'do*  (irpdrrcii^).
...
wisdom  or  temperance  ?  explains  as

But  that,  Socrates,  he  said,  is  impossible ;  and  therefore  if  meaning
this  is,  as  you  imply,  the  necessary  consequence  of  any  of  my  *  jate"^'
...
'  Hail ! '  is  not  right,  and  that  the  exhortation  '  Be  temperate  I '
...
imply  [aoM^poVft,  ywiBi  aa\n6v\^  and  yet  they  may  be  easily  mis-
...
*  Reading,  according  to  Heusde*s  conjecture,  6fMXoyii<xovr6s  <roi.
...
And  the  odd  and  even  numbers  are  not  the  same  with  the  Chamiides,
...
You  are  just  falling  into  the  old  error,  Socrates,  he  said.  Tempcr-
You  come  asking  in  what  wisdom  or  temperance  differs  from  ^"^^^  j^
...
And  what  if  I  am  ?     How  can  you  think  that  I  have  any  Personaii-
other  motive  in  refuting  you  but  what  I  should  have  in  ex-  [J^.^
...
But  the  science  of  science,  1  said,  will  also  be  the  science  absence  of
of  the  absence  of  science.  science.

26

No  sense  zvitkout  an  object^
...
Then  the  wise  or  temperate  man,  and  he  only,  will  know  16
...
sense  of  itself  and  of  other  senses,  but  which  is  incapable  of  socratks,
...
*  Socrates  b  intending  to  show  that  science  differs  from  the  object  of
...
genitive  after  the  comparative  in  Greek,  iiu(6v  rtyos,  creates  an  unavoidable
...
distrust  my  own  power  of  determining  these  matters :  I  am  Sochates,
...
for  he  who  has  this  science  or  knowledge  which  knows  itself  kn<^i^ae
...
KiTiAs.        J  j.^.  J  ^^  comprehend  how  this  knowing  what  you  know  and  do
...
for  It  IS  in-  T^       .     ,  ,     ,  ri  11  r  t       1  1      1
...
able.  ^^^  j^^  knows,  but  not  what  he  knows  ?
...
says  that  he  knows  :  he  will  only  know  that  he  has  a  know-  Sockates,
...
*  On  tlie  wrong  track!  33

And  now  you  perceive,  I  said,  that  no  such  science  is  to  Charfnides.
...
new  light  merely  as  a  knowledge  of  knowledge  and  ignor-  qJ^^fww-*^
ance,    has  this   advantage  : — that  he    who   possesses  such  ledge  may
knowledge  will  more  easily  learn  anything  which  he  learns  ;  ^g^J.^^
and  that  ever3rthing  will   be   clearer  to   him, .  because,    in  test  the
addition  to  the  knowledge  of  individuals,  he  sees  the  science,   ^^^jj^fg^^
...
benefits  which  mankind  would  obtain  from  their  severally  ^^^^^hg
doing  the  things  which   they   knew,    and   committing  the  advantage
things  of  which  they  are  ignorant  to  those  who  were  better  ^J*  science
...
that  this  is  wisdom,  I  certainly  cannot  make  out  what  good  173
...
Monster  I    I  said ;  you  have  been  carrying  me  round  in  a  Not  uni-
circle,  and  all  this  time  hiding  from  me  the  fact  that  the  life  J^nXicdee
...
let  me  ask  you,  Critias,  whether,   if  you  take  away  this,   ^^."^'f'
medicine  will    not    equally    give    health,    and    shoemaking  n,an.
...
CharmUts.  whether  the  art  of  the  pilot  will  not  equally  save  our  lives
SocBATRs,      at  sea,  and  the  art  of  the  eeneral  in  war  ?

Cities.  ^     '  *

yuite  so.
Wiihoui  And  yet_  rny  dear  Critias,  none  of  these  things  will  be

oiher  *^"   '>''  beneficially  done,   if  the  science  of  the  good   be
...
and  denied   and  in  this  Way  will  benefit  US.

bySocraies  And  will  wisdom  give  health?  I  said;  is  not  this  rather
w  be  wis-  [j,g  effect  of  medicine  ?  Or  does  wisdom  do  the  work  of  any
...
RecaiHtuia-  You  see  then,  Critias,  that  I  was  not  far  wrong  in  fearing
Theargu-  '^^*  '  could  have  no  sound  notion  about  wisdom ;  I  was
meat  says  quite  right  in  depreciating  myself;  for  that  which  is  admitted
our  defini-  "*  ^^  '^^  ^^^^  °^  ^"  things  would  never  have  seemed  to  us
tjons.  useless,   if  I  had  been  good  for  anything  at  an   enquiry.

But  now  I  have  been  utterly  defeated,  and  have  failed  to

Socrates  gives  up  tJie  enquiry.  37
...
indeed  that  there  is  a  mistake,  and  that  I  must  be  a  bad  ^harm,  and

-  .  T        1  •  Socrates  is

enquirer,  for  wisdom  or  temperance  I  believe  to  be  really  a  a  fool  who
great  good  ;  and  happy  are  you,  Charmides,  if  you  certainly  « incapable
...
38  Channides  is  irresistible.

Charmides.  Socrates,  that  I  do  need  the  charm,  and  as  far  as  I  am
Socrates,  concemcd,  I  shall  be  willing  to  be  charmed  by  you  daily,
CRmAs°^    until  you  say  that  I  have  had  enough.
...
Stepb.  gence :  this  is  carried  on  in  the  absence  of  Menexenus,  who  is
...
When  one  man  loves  another,  which  is  the  friend — he  who  loves,  2 1 3
...
44  Characters  of  tlie  Dialogue.
...
€ui  extremum  viiae  permanere*}  Is  not  friendship,  even  more
than  love,  Hable  to  be  swayed  by  the  caprices  of  fancy?  The
...
Intro-       sionate  and  exalted  natures,  all  men  ever^'where  ?  7)  The  ancients
...
Symposium  180  if.,  218  if. ;  Laws  VIII,  835  if.).
...
mutually  rejoice  in  any  good  which  happens  to  cither  of  them,
...
disordered  mind,  and  convert  the  feeble  person  into  a  hero ;  (cp.      °"*^»o**-
Symposium  179  if.).
...
damusque  vidsstm.  The  sweet  draught  of  sympathy  is  not  inex-
...
'  *  Lysis.      whether,  again,  a  wife  .or  a  husband  should  have  any  intimate

I  Intro-       friend,  besides  his  or  her  partner  in  marriage.     The  answer  to

i  '      this  latter  question  is  rather  perplexing,  and  would  probably  be

J  different  in  different  countries  (cp.  Sympos.  p.  182).    While  we  do
...
and  that  this  Romance  of  Heaveirty  Love  requires  a  strength,  a
freedom  from  passion,  a  self-control,  whic{i,  in  youth  especially,  are
rarely  to  be  found.  The  propriety  \^i  such  friendships  must
...
part  company  whenever  the  relation  b.ctween  them  begins  to
...
Socrates,  who  is  the  narrator.  Menexknus.
...
tepii.  T  WAS  going  from  the  Academy  straight  to  the  Lyceum,      Lyns.
^3     X     intending  to  take  the  outer  road,  which  is  close  under  Soceatm,
the  wall.     When  I  came  to  the  postern  gate  of  the  city,    thalks.
...
not,  in  lov^ ;  the  confession  is  too  late  ;  for  I  see  that  you  are
...
205  of  the  company;  and  then  I  shall  be  able  to  judge  whether  ^JJ^^^
you  know  what  a  lover  ought  to  say  about  his  love,  either  to  Otesippus.
...
about  to  his  beloved  which  a  child  might  not  say.     Now  is  ^°^f  iPfT™*
...
Lysis,  and  the  other  ancestors  of  the  youth,  and  their  stud  of  ^mmon-
...
307  standing  with  the  other  boys  and  youths,  having  a  crown  *"^  ^^'
...
come  alone:  but  first  of  all,  his  friend  Menexenus,  leaving  J»»sfnend

'  '  1  Menexenus

his  play,  entered  the  Palaestra  from  the  court,  and  when  he  leave  the
saw  Ctesippus  and  myself,  was  going  to  take  a  seat  by  us ;  ^y^  ^^
...
av^y  and  ^^^  ^^^^  ^^^  ^^  gymnastic-master  wanted  him.    I  supposed

Socrates  that  he  had  to  offer  sacrifice.    So  he  went  away,  and  I  asked

Mntmucs  Lysis  some  more  questions.     I  dare  say,  Lysis,  I  said,  that

versaiion  your  father  and  mother  love  you  very  much,

with  Lysis  Certainly,  he  said.

alone.

His  parents       ^"^^  ^^^  would  wish  you  to  be  perfectly  happy.

love  him  Yes.

^^iTth"*^^ '       ^"^  ^^  y^^  think  that  any  one  is  happy  who  is  in  the  con-
aiiow  him     dition  of  a  slave,  and  who  cannot  do  what  he  likes  ?
...
piece  of  cloth  which  she  is  weaving,  are  at  your  disposal :  "^^'^/'^ll
I  am  sure  that  there  is  nothing  to  hinder  you  from  touching  mother's
her  wooden   spathe,   or  her  comb,    or    any  other  of  her  fP»»^»*>°g
...
you  when  they  see  that  you  have  wisdom  enough  to  manage  or'^he**'*^
...
not  entrust  to  us  the  prerogative  of  making  soup,  and  putting  gygg  jf  ^^
in  anything  that  we  like  while  the  pot  is  boiling,  rather  than  to  knows  how
the  Prince  of  Asia,  who  is  his  son  ?  ^  ofany
...
Suppose  that  you  tell  him  yourself,  Lysis,  I  replied  ;  for  I      Lysis,
am  sure  that  you  were  attending.  Socrates,

Certainly,  he  replied.  CtesiWus,
...
hoofe,  and  dogs  of  chase,  and  the  stranger  of  another  land  *  ?  elusion  that

what  is

I  do  not  think  that  he  was  wrong.  beloved  is

You  think  that  he  is  right  ?  not  ^hat
...
2 1 3  hating  their  father  or  mother  when  they  are  punished  by  them,  ^^P^«'
are  never  dearer  to  them  than  at  the  time  when  they  are  being  chUdren
hated  by  them.  ^^^"
...
or  indeed  impossible  is  this  paradox  of  a  man  being  an  "^either
...
^  Omitting  ^tXp,  or  reading  /uiof  instead.

62

Tfie  like  are  friends.
...
be  likely  to  hate  him,  for  he  injures  him  ;  and  injurcr  and
...
the  good  are  like  one  another,  and  friends  to  one  another ;  [{jg^^cked
and  that  the  bad,  as  is  often  said  of  them,  are  never  at  unity
wth  one  another  or  with  themselves ;  for  they  are  passionate
and  restless,  and  anything  which  is  at  variance  and  enmity
wth  itself  is  not  likely  to  be  in  union  or  harmony  with  any
...
215  if  neither  can  be  of  any  use  to  the  other,  how  can  they  be  do  to  one
...
316  like.     And  I  thought  that  he  who  said  this  was  a  charming      Lysis,
...
opposite  of  hate  :  and  what  answer  shall  we  make  to  them —  f?'  _, , .
...
my  head  is  dizzy  with  thinking  of  the  argument,  and  there-  ^j^j^h  is
fore  I  hazard  the  conjecture,  that  'the  beautiful  is  the  friend,'  also  the
as  the  old  proverb  says.     Beauty  is  certainly  a  soft,  smooth,   z^^^^^^
slippery  thing,  and  therefore  of  a  nature  which  easily  slips  the  neither
in  and  permeates  our  souls.    For  I  affirm  that  the  good  is  Rood  nor
...
By  reason  of  t/ie  presence  of  evil.
...
That  may  be  assumed  to  be  certain.  21
...
And  sickness  is  an  evil,  and  the  art  of  medicine  a  goo^
and  useful  thing  ?

Yes.

But  the  human  body,  regarded  as  a  body,  is  neither  gnc — ?
nor  evil  ?

True.

And  the  body  is  compelled  by  reason  of  disease  to  ca  ^^m^
...
lated  when  others  are  present  with  them:    and   there  are  Pf.^^^^f^"';
...
Socrates,  yet  evil,  the  prcsence  of  good  arouses  the  desire  of  good  in

RNEXENus.  ^^^  thing ;  but  the  presence  of  evil,  which  makes  a  thing  218
...
not  evil  the  o^^y*  ^nd   the  good  was  supposed   to   have  no  friendship
...
of  the  good  ^^ture  of  friendship — there  can  be  no  doubt  of  it :  Friend-
...
suspicion  came  across  me,  and  1  felt  that  the  conclusion
...
Argu-  1  am  afraid,  I  said,  that  the  argument  about  friendship  is

likTm'en.      ^^^^  '  arguments,  like  men,  are  often  pretenders,
are  often  How  do  you  mean  ?  he  asked.

preten  crs.       Well,  I  said  ;  look  at  the  matter  in  this  way :  a  friend  is
...
He  has  a  motive  and  object.  Lys?^"**"*'
...
there  is  a  further  object,  whatever  it  may  be,  which  we  value  Socratks.
...
And  the  good  is  loved  for  the  sake  of  the  evil  ?     Let  me    1  he  good
put  the  case  in  this  way :  Suppose  that  of  the  three  principles,   \^yl^  /q^
good,  evil,  and  that  which  is  neither  good  nor  evil,  there  re-  the  sake
mained  only  the  good  and  the  neutral,  and  that  evil  went  far  ?  relative
...
than  useless  to  us?  For  if  there  were  nothing  to  hurt  us  any  g^/^^^^j
...
must  be  some  other  cause  of  friendship  ?  Lysis.
...
of  the  natural  or  congenial.     Such,  Lysis  and  Menexenus,  is  ^g^JJ^^^jfj^
...
discover  what  is  a  friend  I

LACHES.

INTRODUCTION.

Lysimachus,  the  son  of  Aristides  the  Just,  and  Melesias,  the  son      Laches.
'      of  the  elder  Thucydides,  two  aged  men  who  live  together,  are     Analysis.
...
fljring,  after  the  manner  of  Aeneas  in  Homer ;  or  as  the  heavy-
...
The  sdaftce  is  of  old  and  elder  men,  of  whom  Socrates  is  the
youngest.
...
Lysimachvs,  son  of  Arisrt'ifgs.  NiciAS.

Melesias,  son  of  Thtuydtdes,  Laches.

Their  Sons.  Socrates.

>b.      Lys,   You  have  seen  the  exhibition  of  the  man  fighting  in     Laches,
armour,  Nicias  and  Laches,  but  we  did  not  tell  you  at  the  Lysimachus.
time  the  reason  why  my  friend  Melesias  and  I  asked  you  to  Lysima-
go  with  us  and  see  him.     I  think  that  we  may  as  well  confess  ^eiedas
what  this  was,  for  we  certainly  ought  not  to  have  any  reserve  request
with  you.     The  reason  was,  that  we  were  intending  to  ask  inches
your  advice.     Some   laugh  at  the  very  notion   of  advising  to  advise
others,   and  when  they  are  asked  will   not  say  what  they  ^^^^^5"*

'  respecting

think.  They  guess  at  the  wishes  of  the  person  who  asks  theeduca-
them,  and  answer  according  to  his,  and  not  according  to  ^jo'^of
...
is  much  truth  in  that  remark  of  yours,  Lysimachus.     But  lach^k.
...
same  deme  with  you,  and  is  always  passing  his  time  in  ^j^^^  ^^^
places  where  the  youth  have  any  noble  study  or  pursuit,  shall  take
such  as  you  are  enquiring  after.  kitotheir
...
and  Nicias  and   Laches,  fall  out  of  acquaintance  with  the  ^g^^^^e
young,  because  they  are  generally  detained  at  home  by  old  name  of
age  ;  but  you,  O  son  of  Sophroniscus,  should  let  your  fellow  ^^^  v*
demesman  have  the  benefit  of  any  advice  which  you  are  able  the  dis-
to  give.     Moreover  I  have  a  claim  upon  you  as  an  old  friend  co^ery  that
of  your  father ;  for  I  and  he  were  always  companions  and  son  ^f  ^s
...
and  I  further  rejoice  at  the  prospect  of  our  family  ties  being  P^«»  ^^«
renewed.  ^hich  was

La.  Indeed,  Lysimachus,  you  ought  not  to  give  him  up ;  shown  by
for  I  can  assure  you  that  I  have  seen  him  maintaining,  not  thebatUe
only  his  father's,  but  also  his  country's  name.     He  was  my  of  Dciium.
...
of  the  art  of  fighting  in  armour,  89

assailant.  Certainly  he  who  possessed  the  art  could  not  Laches.
meet  with  any  harm  at  the  hands  of  a  single  person,  or  Nioas,
...
knowledge  is  not  to  be  learned  :  for  all  knowledge  appears  f^^<^***^  "®

°  ,     '  °        ^^  importance

to  be  a  good :  and  if,  as  Nicias  and  as  the  teachers  of  the  to  the
art  affirm,  this  use  of  arms  is  really  a  species  of  knowledge,  *^'  j^^^*^**
...
but  not  of  a  valuable  sort,  then  what  is  the  use  of  learning  it  ?  by  ^hg
183  I  say  this,  because  I  think  that  if  it  had  been  really  valuable,  Lacedae-
the  Lacedaemonians,  whose  whole  life  is  passed  in  finding  ^^  ^o^^
out  and  practising  the  arts  which  give  them  an  advantage  have  been
over  other  nations  in  war,  would  have  discovered  this  one.  1^^.,^^^

'  among

And  even  if  they  had  not,  still  these  professors  of  the  art  them,  if  it
would  certainly  not  have  failed  to  discover  that  of  all  the  ^f^  *^"
...
as  the  other  ship  passed  by  and  drew  him  afler  as  he  was
...
I  tell  you  my  experience ;  and,  as  I  said  at  first,  whether  this  Socratks,
...
is  not  worth  having.     For  my  opinion  is,  that  if  the  professor  >™P°**^°'^-
...
wll   be  greatly  traduced ;  for  there  is  a  jealousy  of  such
...
the  more  necessary  because  the  two  councillors  disagree,  and  ^Uot<»  "^
some  one  is  in  a  manner  still  needed  who  will  decide  between  and
them.    Had  they  agreed,  no  arbiter  would  have  been  required.   ^*»<^^^o"^
...
Soc.    His  one  vote  would  be  worth  more  than  the  vote  of  °?1°1™*L
...
on  a  horse  and  at  what  time,  he  is  thinking  of  the  horse  anc
not  of  the  bridle  ?

Nic,   True.

Soc,  And  in  a  word,  when  he  considers  anything  for  t
sake  of  another  thing,  he  thinks  of  the  end  and  not  of  i
means  ?

Nic,   Certainly.

Soc,   And  when  you  call  in   an  adviser,  you  should
whether  he  too  is  skilful  in  the  accomplishment  of  th^
which  you  have  in  view  ?

Who  are  qualified  to  teach  ?  93

Nic.    Most  true.  Laches,
...
Soc,  And  we  are   enquiring,    Which   of  us  is  skilful  or  {^^"^J
successful  in  the  treatment  of  the  soul,  and  which  of  us  has  knowledge;
had  good  teachers  ?  f^^  ^'^^  ^"^^

°  improve-

La,  Well  but,  Socrates;  did  you  never  observe  that  some  mentof
...
not  be  very  williner  to  trust  them  if  they  only  professed  to  be  teach  and

;...  ,  1  ,,1  ^-  has  had

masters  of  their  art,  unless  they  could  show  some  proot  ol  ^^^
86  their  skill  or  excellence  in  one  or  more  works.  teachers?

La,  That  is  true.

Soc,  And   therefore.   Laches  and   Nicias,   as  Lysimachus  We  must
and  Melesias,  in  their  anxiety  to  improve  the  minds  of  their  ^{Jj^^^^
...
and  prove  them  to  be  in  the  first  place  men  of  merit  and  vvorks  of
experienced  trainers  of  the  minds  of  youth  and  also  to  have  o«r  own.
...
Melesias,  I  am  the  first  to  confess  that  I  have  never  had  but^Nj^as
a  teacher  of  the  art  of  virtue ;  although  I  have  always  from  and  Laches
my  earliest  youth  desired  to  have  one.     But  I  am  too  poor  J^^^^^
to  give  money  to  the  Sophists,  who  are  the  only  professors  of  the
of  moral  improvement ;   and  to  this  day  I  have  never  been  ^?*)5^^J.
...
r  1  r  1   1    .  1  T  1  \  r  ^^  valuC  if

It ;  for  they  are  far  wealthier  than  1  am,  and  may  therefore  they  only
...
lysimachus.  j^^^^  spoken  thus  decidedly  of  the  pursuits  which  are  advan-
...
l^^^u  us  who  is  the  most  skilful  educator  whom  you  have  ever

teachers,  -^

or  do  they   known ;   and  whether  you  invented  the  art  yourselves,  or
expenment  Jeai^ied  of  another:    and   if  you   learned,  who  were  your  187
...
th^^hould  yourselves,  let  us  go  to  them,  and  present  them  with  gifts,  or
...
sug^^L      friends ;  but  you,  Nicias  and  Laches,  must  determine  whether
that  you  will  be  questioned,  and  give  an  explanation  about  matters

fhSjn^      ^^  ^^*^  ^^^^*     Assuredly,   I  and  Melesias  would  be  greatly
terrogate     pleased  to  hear  you  answer  the  questions  which  Socrates
LAches***^  asks,  if  you  will :  for  I  began  by  saying  that  we  took  you  into
...
like  our  own,  are  nearly  of  an  age  to  be  educated.     Well,      Lachts,
then,  if  you  have  no  objection,  suppose  that  you  take  Socrates  Nicus,
into  partnership ;   and  do  you  and  he  ask  and  answer  one  lIchm!"  *'
...
to  his  ways;  and  I  know  that  he  will  certainly  do  as  I  say,   of  opinion
and  also  that  I  myself  shall  be  the  sufferer ;  for  I  am  fond  conver-
of  his  conversation,  Lysimachus.     And  I  think  that  there  is  ^^"^^^  ^s
no  harm  in  being  reminded  of  any  wrong  thing  which  we  fitabie.
...
selves ;  and  therefore,  I  say  that  for  my  part,  I  am  quite  willing  J^*^y  ^°
...
lover,  and  to  others  I  may  seem  to  be  a  hater  of  discourse ;  ^^h^"
...
show  that  free  and  noble  sentiments  are  natural  to  him.  i8
...
The  nature  of  virttie  to  be  examined:  97

^now,  for  the  sake  of  the  youths,  and  talk  and  consult  with     Inches.
hem :  for  I  am  old,  and  my  memory  is  bad ;  and  I  do  not  Socrates,
emember  the  questions  which  I  am  going  to  ask,  or  the  ^^"^*-
Jisivers  to  them  ;  and  if  there  is  any  interruption  I  am  quite
Dst.     I  will  therefore  beg  of  you  to  carry  on  the  proposed
iscussion  by  your  selves ;  and  I  will  listen,  and  Melesias  and

wll  act  upon  your  conclusions.

S€}C.   Let  us,  Nicias  and  Laches,  comply  with  the  request
f  Lysimachus  and  Melesias.     There  will  be  no  harm  in
sking  ourselves  the  question  which  was  first  proposed  to
s  :     *  Who  have  been  our  own  instructors  in  this  sort  of
aining,  and  whom  have  we  made  better?'     But  the  other
Lode  of  carrying  on  the  enquiry  will  bring  us  equally  to  the
line  point,  and  will  be  more  like  proceeding  from  first
rinciples.     For  if  we  knew  that  the  addition  of  something  Socrates
'ould  improve  some  other  thing,  and  were  able  to  make  the   Before^^e"
ddition,  then,  clearly,  we  must  know  how  that  about  which  can  impart
re    are  advising  may  be  best  and    most  easily  attained,  ^s*^^^

^  J  'f  must  know

^erhaps  you  do  not  understand  what  I  mean.  Then  let  me  the  nature
oake  my  meaning  plainer  in  this  way.  Suppose  we  knew  °^*'*
hat  the  addition  of  sight  makes  better  the  eyes  which
...
oor.  Then,  Laches,  we  may  presume  that  we  know  the
nature  of  virtue  ?
La.  Yes.
...
La,  What  do  you  mean,  Socrates  ?  i'
...
speaking  of  chariots,v  as  you  were  speaking  of  the  Scythian   Socrates,
...
courageous  in  perils   by  sea,    and  who   in   disease,  or  in  ?^  shown
...
tend  against  desires  and  pleasures,  either  fixed  in  their  rank  poveny,
or  turning  upon  their  enemy.    There  is  this  sort  of  courage —  ^pd  in
is  there  not,  Laches  ?  SIJ>  in  "  ^

La,  Certainly,  Socrates.  the  battle

Soc,  And  all  these  are  courageous,  but  some  have  courage  ^^uJes
...
w^hich  is  called  quickness,  and  which  is  found  in  running,
