---
source: "https://archive.org/details/socialcontractdi0000jean_v5q8"
title: "The Social Contract and Discourses"
author: "Jean Jacques Rousseau"
year: "1923"
captured_at: "2026-07-16T03:34:49Z"
updated_at: "2026-07-16T03:34:49Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ルソー"
query: "Jean-Jacques Rousseau"
plain_text_url: "https://archive.org/download/socialcontractdi0000jean_v5q8/socialcontractdi0000jean_v5q8_djvu.txt"
public_domain: true
...
- 初版: 1923
- 情報源: [archive](https://archive.org/details/socialcontractdi0000jean_v5q8)
- パブリックドメイン: ✓
...
SS ee >
ERYMAN, :
NY Fayf | WILL GO-WITH @)\ ZS
YY | BE-THY-GVIDE [
A/A\ PIN: THY: MOST: NEEDS
B/A\\\ \TO-GO BY: THY-SIDE*
...
Lonpon: J. M. DENT & SONS Lop.
Nzw. Yorn: sk. Ps) DUTTON CO:
...
Firsr Issur oF rurs Epirton . +» I9ts
REPRINTED 4 . 3 , - 916, 1920, 1923

PRINTED IN GRRAT BRITAIN

INTRODUCTION

_ For the study of the great writers and thinkers of the past,
...
less than action, is subject to these necessities; the form in _ .
...
‘questions they try to answer will always be those their con-
...
and formulz of tradition to express the deeper truths towards
...
same fundamental contribution to modern thought. He is,
...
ment of the French Revolution, or as one of the greatest books
...
_ loved outspoken criticism, and Rousseau had always to be very
_ careful what he said. This may seem a curious statement to’
...
Rousseau’s theory has often been decried as too abstract and
metaphysical. This is in many ways its great~strength; but
where it is excessively so, the accident of time is to blame.
In the. eighteenth century it was, broadly speaking, safe to
generalise and unsafe to particularise. Scepticism and discon-
tent were the prevailing temper of the intellectual classes, and
...
_ were only regarded as dangerous when they were so put as~to
...
lése-majesté: Voltaire is the typical example of such general-
...
ones. Just as theological writers on politics, from Hooker te
...
represents the maturity of his thought, while the other works
only illustrate his development. Born in 1712, he issued no
...
he had already conceived the idea of a great work on Political
...
been leading among the Paris lumiéres, he composed a violent
...
’ born with, he cannot learn the art of writing in a moment.”
_ This criticism is just. The first Discourse neither is, nor
...
_ brilliant but flimsy rhetorical effort, a sophistical improvisation,
...
_ position as a great writer in Parisian circles. D’Alembert even
devoted the preface of the Encyclopedia to a refutation. The
plan of the first Discourse is essentially simple: it sets out
from the badness, immorality and misery of modern nations,
...
explicitly that he does not- suppose the ‘state of nature’’ ever
...
Rousseau is often blamed, by modern critics, fer pursuing in
the Discourses a method apparently that of history, but in
reality wholly unhistorical. But it must be remembered that
he himself lays no stress on the historical aspect of his work;
he gives himself out as constructing a purely ideal picture, and
...
It is doubtful whether the Discourse on Poktical Economy,
first printed in the great Encyclopedia in 1755, was composed
...
deal of the positive doctrine afterwards incorporated in the
Social Contract. Especially in the closing section, which lays
down the plan of a general treatment of the fundamental ques-
...
The essential features of the Social Contract are present in this
...
especially Emile and the Letters on the Mount (1764), but in
_the main it is self-contained and complete. The title sufficiently
defines its scope. It is called The Social Contract or Prin-
ciples of Political Right, and the second title explains the
first. Rousseau’s object is not to deal, in a general way, like
Montesquieu, with the actual institutions of existing States, but
_to lay down the essential principles which must form the basis
...
object as being something very different from that_of the Spirit
of the Laws, and it is a wilful error to misconstrue his purpose.
When he remarks that ‘tthe facts,’’ the actual history of
political societies, ‘‘do not concern him,’’ he is not contémptu-
ous of facts; he is merely asserting the sure principle that a
...
of all human combination. For the latter purpose facts may
...
reconciled with human freedom? How can man, who is born
free, rightly come to be everywhere in chains?

No-one cuuld help understanding the central problem of the
...
chapter of che Social Contract, ‘‘Man is born free, and every-
...
free,’ or perhaps ‘‘man is born for freedom,’”’ he prefers to say
...
every man born in slavery is born for slavery. ... But if there
...
The Emile is a plea for ‘‘natural’’ education; the Discourses
are a plea for a “‘naturalisation”’ of society; the New Héloise
is the romantic’s appeal for more ‘‘nature ’’ in human relation-
ships. What then is the position of this contrast in Rousseau’s
...
bility of a rational society. His aim is to justify the change
from ‘‘nature ”’ to ‘‘society,” although it has left men in chains.
He is in search of the true society, which leaves men ‘‘as free
as before.” Altogether, the space occupied by the idea of
mature in the Social Contract is very small. It is used of
...
golden age; and where, as in the Emile, he makes use of the ~-
...
These are the Social Contract, Sovereignty and the General
...
quent in medizeval writers, a commonplace with the theorists of
...
to resist the doctrine is that which maintains the divine right
...
to judge of its usefulness when we have seen its chief varieties
at work.
...
government, or between all the individuals composing the
State. Historically, modern theory passes from the first to the
second of these forms.
_ The doctrine that society is founded on a contract between
the people and the government is of medizval origin. It was
often supported by references to the Old Testament, which
contains a similar view in an unreflective form. It is found in
...
sontract theory in its second form, the Parliamentarian Algernon
...
stastical Polity, from which Locke largely borrowed: and it
reappears, in varying forms, in Milton’s Tenure of Kings anad
Magistrates, in Hobbes’s Leviathan, in Locke’s Treatises or
Civil Government, and in Rousseau. The best-known instance(
of its actual use is by the Pilgrim Fathers on the Mayflowen
in 1620, in whose declaration occurs the phrase, ‘‘We dc
solemnly and mutually, in the presence of God and of one
another, covenant and combine ourselves together into a civii
body politic.’’ The natural implication of this view would see
to be the corollary of complete popular Sovereignty whic
Rousseau draws. But before Rousseau’s time it had been usec
to support views as diverse as those which rested on the first
form. We saw that, in Grotius’s great work, De Jure Belli
et Pacts, it was already possible to doubt which of the twc
theories was being advocated. The first theory was, histories
ally, a means of popular protest against royal aggression. As
soon as popular government was taken into account, the act

Introduction XX1

of contract between people and government became in effect
‘merely a contract between the individuals composing the
‘society, and readily passed over into the second form.
...
by Hobbes to support precisely opposite principles. Hobbes
agrees that the original contract is one between all the in-
dividuals composing the State, and that the government is no
party to it; but he regards the people as agreeing, not merely
to form a State, but to invest a certain person or certain

persons with the government of it. He agrees that the _.-
...
government. Hobbes, whose whole aim is to make his govern-

Xxil “> Introduction

ment Sovereign, can only do this by leaving the government:
outside the contract: he thus avoids the necessity of submitting:
...
not merely Statism (étatisme); it is pure despotism.

It is clear that, if such a theory is to be upheld, it can stand |
only by the view, which Hobbes shares with Grotius, that a.
man can alienate not merely his own liberty, but also that of’
his descendants, and that, consequently, a people as a whole:
can do the same. This is the point at which both Locke and.
...
tyrannically. He omits, however, to provide any machinery |
...
Rousseau sees clearly the necessity, if popular consent in
...
newed. He looks back with admiration te the city-states of |
...
bring out the real nature of the ‘‘social tie,’ an alternative
_name which he often uses for the Social Contract. His doctrine
of the underlying principle of political obligation is that of all
great modern writers, from Kant to Mr. Bosanquet. This
...
There were, indeed, writers of his time who latghed at the
“contract, but they were not writers who constructed a general
system of political philosophy. From Cromwell to Montesquieu
...
three different ways in which the basis of political union is
stated, according to the preoccupation of his mind. When he
is thinking quasi-historically, he describes his doctrine as that
of the Social Contract. Modern anthropology, in its attempts
...
from the bulk of a given society.”” Where Sovereignty is
...
able point, to show that such a determinate superior is rarelv
...
~The idea at the back of the philosophical conception of
...
Rousseau unites the absolute Sovereignty of Hobbes and the
‘‘popular consent” of Locke into the philosophic doctrine of
popular Sovereignty, which has since been the established form
ofthe theory. His final view represents a return from the
perversions of Hobbes to a doctrine already familiar to
medizeval and Renaissance writers; but it is not merely a return.
...
self from Hobbes. For Hobbes, the Sovereign is identical with
...
Rousseau, they are so clearly distinct that even a completely
...
the people in every detail, is not, as Rousseau says, a possible
...
_ Rousseau tries to do this by an adaptation of the doctrine
of the ‘three powers.” But instead of three independent
_ powers sharing the supreme authority, he gives only two, and

makes one of these wholly dependent on the other. He sub-
stitutes for the co-ordination of the legislative, the executive,
...
makes, naturally, one of will and power. The government is
...
sions force by setting up authority which, like the brain, may”
...
the grants it has made. Government, therefore, exists only
...
_able part of Rousseau’s theory. Here, we are concerned rather
...
power in the hands of the executive: modern legislation is
...
‘the modern theory of democratic government, in which the

people has little power beyond that of removing its rulers if

they displease it. As long, however, as we confine our view

XXVI11_ Introduction

to the city-state of which Rousseau is thinking, his distinction -
...
essential to remember that his discussion has in view mainly
...
indeed is it, even in the modern world, so satisfactory an
...
criticism of the Polysynodie of the Abbé de Saint-Pierre, a
...
_ most difficulty is his view (Book II, chap. vii) that, for every
...
of mutual justice the General Will is the source.
...
sense which he assigns to it, and even seems to suggest by it
...
and receiving from the act its unity, its common identity (moi
commun), its life and its will’? (Book I, chap. vi). The same
doctrine had been stated earlier, in the Political Economy,
...
interests to the pursuit of pleasure or of something which is
really harmful to it? And, if the whole society may vote what
conduces to the momentary pleasure of all the members and
at the same time to the lasting damage of the State as a whole,
...
and of others? All these questions, and others like them, have
...
‘‘a great deal of difference between the will of all and the
...
pure; but it is subordinated to other wills which encroach upon
...
IV, chap. i). These passages, with many others that may
_be found in the text, make it quite clear that by the General
Will Rousseau means something quite distinct from the Will
of All, with which it should never have been confused. The
only excuse for such confusion lies in his view that when, in a
...
that majority voting will always result in the General Will.
This is clearly not the case, and in this respect we may charge
...
‘ditions, it would be so. -

The second main point raised by critics of thé General Will
...
association of several persons creates a new common will; every
association of a permanent character has already a ‘“‘ person-
ality’ of its own, and in consequence a ‘‘general”’ will; the
State, the highest known form of association, is a fully
developed moral and collective being with a common will which
is, in the highest sense yet known to us, general. All such
wills are general only for the members of the associations
...
becomes a simple being, an individual ’’ (Social Contract, Book
I, chap. vii). In certain passages in the Social Contract, in
his criticism of the Abbé de Saint-Pierre’s Project of Perpetual
...
a still higher individual, ‘‘the federation of the world.”? In
the Political Economy, thinking of the nation-state, he affirms

Introduction XXXiIl1

what in the Social Contract (Book II, chap. iii) he denies of
...
governmental will he there prefers to call corporate will, and
by this name it will be convenient to distinguish the lesser
...
elsewhere, Rousseau would have to admit that it proves nothing
...
autonomy of the will: Kant takes Rousseau’s political theory,
and applies it to ethics as a whole. The germ of this applica-
c 660

XXXIV > Introduction

tion is already found in Rousseau’s own work; for he protests
...
an unlimited right to everything he tries to get and succeeds
in getting; what he gains is civil liberty . . . which is limited
by the general will. . . . We might, over and above all this, add
to what man acquires in the civil state moral liberty, which
alone makes him truly master of himself; for the mere impulse
of appetite is slavery, while obedience to a law which we pre-
scribe to ourselves is liberty.”

This one chapter contains the gist of the Kantian moral
...
passions are not moral. Further, man can only possess freedom
when his whole being is unified in the pursuit of a single end;
...
law.
_ The General Will, then, is the application of human freedom
...
mot enslave its members? This criticism has been made with
...
upon the power of the State; when the people combine into a
State, they must in the end submit to be guided in all things
oy the will of the effective majority. Limited Sovereignty is a
sontradiction in terms; the Sovereign has a right to all that
-eason allows it, and as soon as reason demands that the State
...
sught, or has the moral right, to interfere in every particular
case. Rousseau has been subjected to much foolish criticism
secause, after upholding the State’s absolute supremacy, he
xoes on (Book II, chap. iv) to speak of ‘‘the limits of the
sovereign power.’? There is no contradiction whatsoever.
Wherever State intervention is for the best, the State has a right
o intervene; but it has no moral right, though it must have
a legal right, to intervene where it is not for the best. The

XXXVi- Introduction

General Will, being always in the right, will intervene only
...
fails to satisfy many of his critics. ‘‘Each man alienates, II
...
will be omnipotent, or subject only to the law of reason. q

It has often been held that Rousseau cannot really have in)
spired the French Revolution because this view is totally im

Introduction XXXVIil
...
‘ights’’ afterwards? This, however, is to misrepresent Rous-
seau’s position. The rights of man as they are preached by
he modern individualist, are not the rights of which Rousseau
...
[, chap. iv); the question is then purely one of might. In such
...
Suarantees its maintenance.. The Sovereign must, therefore,
...
ication of the interests of each of the citizens with those of all;
out here, too, most of the critics have abused their opportunity.
He does not maintain that there can be no opposition between
A man’s particular interests and the General Will as present
...
sssential to the preservation of society, which in turn is neces-
sary for the individual. His argument, however, really rests
...
with any other real interest. The interest of the State, in
...
that is, in so far as he is acting universally, rationally ana
autonomously.

Thus the justification of Rousseau’s theory of liberty returns:
to the point from which it set out—the omnipotence of the reas
will in State and individual. It is in this sense that he speaks
of man in the State as ‘‘forced to be free’’ by the Generah
...
however, is so far from destroying the value of the conceptior
that therein lies its whole value. In seeking the universal basis
of society, we are not seeking anything that is wholly actualisec
in any State, though we must be seeking something whict
exists, more or less perfectly, in every State.

The point of the Social Contract theory, as Rousseau state;
it, is that legitimate society exists by the consent of the people
and acts by popular will. Active will, and not force or ever
mere consent, is the basis of the ‘‘republican’’ State, which car
only possess this character because individual wills are no
really self-sufficient and separate, but complementary and inter
dependent. The answer to the question ‘‘ Why ought I to obey
the General Will? ”’ is that the General Will exists in me anc
not outside me. I am ‘‘obeying only myself,’? as Rousseat
says. The State is not a mere accident of human history, :
mere device for the protection of life and property; it respond:

Introduction XXX1X

to a fundamental need of human nature, and is rooted in the
character of the individuals who compose it. The whole com-
plex of human institutions is not a mere artificial structure; it
...
intimate human relationships, and the most trivial, as well as
...
For the General Will is realised not when that is done which
is best for the community, but when, in addition, the com-
munity as a whole has willed the doing of it. The General
Will demands not only good government, but also. self-govern-
ment—not only rational conduct, but good-will. This is what
some of Rousseau’s admirers are apt to forget when they use
his argument, as he himself was sometimes inclined. to use it,
in support of pure aristocracy. Rousseau said that aristocracy

xl > Introduction

was the best of all governments, but he said also that it was
...
can only be embodied in the State when the mass of the citizens
so wills. The will must be “general” in two senses: in the
sense in which Rousseau used the word, it must be general in
its object, i.e. universal; but it must also be generally held,
i. e. common to all or to the majority.}

The General Will is, then, above all a universal and, in the
Kantian sense, a ‘‘rational’’ will. It would be possible to find
in Rousseau many more anticipations of the views of Kant;
but it is better here to confine comment to an important difier-
ence between them. It is surprising to find in Kant, the
originator of modern ‘‘intellectualism,’’ and in Rousseau, the
great apostle of ‘‘sentiment,’”? an essentially similar view on
the nature and function of the will. Their views, however,
present a difference; for, whereas the moving force of Kant’s
moral imperative is purely ‘‘rational,’’ Rousseau finds the sanc-
tion of his General Will in human feeling itself. As we can
...
1 The term ‘general ” will means, in Rousseau, not so much ‘‘ will held by”
...
_ man’s “natural goodness.’ ‘‘Man is born good,’ that is,
...
_ (amour de soi) includes love of others as well as love of self,
_ and egoism, loving one’s self at the expense of others, is an
...
Social Contract itself is still by far the best of all text-books
...
Tuere are few good books in English on Rousseau’s politics.
...
on The Social Contract Theory and another on Sovereignty.
...
Dix-huitiéme siécle—études littéraires and his Politique com-
parée de Montesquieu, Voltaire et Rousseau are useful, though
I am seldom in agreement with them. M. Henri Rodet’s
Le Contrat Social et les idées politiques de J. J. Rousseau is
useful, if not inspired, and there are interesting works by
MM. Chuquet, Fabre and Lemaitre. The French translation
of Professor Héffding’s little volume on Rousseau: sa vie et sa
...
Si le monde que nous habitons est une sphére ou une sphéroide, 1738 ;
Le Verger de Mme. de Warens, 1739; Sur la musique moderne, 17433 Si
le rétablissement des Sciences et des Arts a contribué a épurer les Mceurs,
...
by C. Burney, 1766; Narcisse, ou Amant de Iui-méme, 1753; Lettre sur
la musique Frangaise, 1753; Sur lorigine de Vinégalité parmi les hommes
1755; Discours sur deux principes avancés par Rameau, 1755; Sur

Bibliography xliii

économie politique, 1758; Letter to d’Alembert on his article Genéve
in the Encyclopédie, 1758, translated 1759; Lettres A Voltaire, 1759;
Julie, ou la nouvelle Héloise, first published under the title of Lettres de
deux amants, habitants d’une petite ville au pied des Alpes, etc., 1761 ;
Contrat Social, or Principes du droit politique, 1762; Emile, ou De I’Educa-
tion, 1762; Lettre 4 Christophe de Beaumont, Archevéque de Paris, 1763;
Allée de Silvie (poem), 1763; Lettres écrites de la Montagne, 1764; De
Vimitation théatrale, 1764; Dictionnaire de musique, 1767, translated
by W. Waring, 1779; Lettres sur son exil du Canton de Berne, 1770.

PosTHUMOUS WorKS: Emile et Sophie, 1780; Les consolations des ’
miséres de ma vie, 1781; Considérations sur le gouvernement de Pologne,
1782; Les Confessions, and Réveries du Promeneur Solitaire, 4 vols.,
1782-9 ; Nouveau Dédale, 1801; La Botanique de J. J. Rousseau, 1805;
translated, with additional letters, by T. Martyn, 1785, 7th edition, 1807 ;
Testament de J. J. Rousseau, 1820.

TRANSLATIONS: Heéloise (Eloisa), 1761, with a sequel found after the ~
...
Contrat Social, 1764, 1791, in vol. iii. of Political Classics, 1795 ;
...
_ (privately printed), 2 vols., 1896; with Introduction by Hesketh Milis
(Sisley Books), 1907; the second part, with a new collection of letters,
3 vols., 1791.

Works: 1764 (6 vols.) ; 1769 (11 vols.) ; 1774 (London, 9 vols.) ; 1782,
etc. (17 vols.) ; 1790 (33 vols.) ; 1790 (30 vols., or 35) ; 1788-93 (39 vols.) ;
1793-1800 (Didot, 18 vols.), and later editions from this same firm ;
Musset-Pathay, 1823-6.

MISCELLANEOUS WoRKS: 5 vols., 1767.

PosrHuMous WorKS: 1782, 1783; CEuvres inédites (Musset-Pathay),
1825, 1833; Fragments inédits, etc., by A. de Bougy, 1853; Céuvres et
Correspondance inédites (Streckeisen-Moultou), 1861 ; Fragments inddits ;
Recherches biographiques et littéraires, A. Jansen, 1882.

Works translated from the French, 10 vols., 1773-74.

Letrers: Sur différents Sujets, 5 vols., 1749-53; Lettres nouvelles
sur le motif de sa retraite 4 la Campagne, adressées 4 M. de Malesherbes,
1780 ; Nouvelles lettres, 1789 ; Lettres au citoyen Lenieps, etc., 1793 (?) :
Correspondance originale et inédite avec Mme. Latour de Tranqueville
et M. du Peyrou, 2 vols., 1803; Lettres inédites 4 Mme. d’Epinay (see
“Memoirs of Mme. d’Epinay), 1818 ; Lettres de Voltaire et de Rousseau a
C. J. Panckoucke, 1828; Lettres inédites 4 M. M. Rey, 1858; Lettres a
Mme. Dupin (in Le Portefeuille de Mme. Dupin), 1884 ; Lettres inédites
(correspondence with Mme. Roy de Latour), published by H. de Roth-
schild, with preface by L. Claretie, 1892; Lettres (between Rousseau and
...
Lir®, etc.: J. H. Fuessli, Remarks on the Writings and Conduct of Jean
Jacques Rousseau, 1767 ; Stiel-Holsteim (Baroness de Rocco), Letters on
...
a new criticism, 1906; J. C. Collins, Voltaire, Montesquieu, and Rousseau
in England, 1908.
...
FOREWORD . se Gs : inne wove: kof Oh ly canton eae remmnS

In which it ts inquired why man passes from the state
...
II The first Societies : : . . - - 6
III The Right of the Strongest , : : , : . 8
IV Slavery : A 9
V That we must sigan go hare to a first Convers Sa ates
VI The Social Compact . : : ; . : 3 Sty

VII The Sovereign . . : : : : : Z 1 16
VIII The Civil State. ; : 5 : A . ‘ 5 e3
IX Real Property . : ? . 5 ° . . - 9
Book II
Which treats of legislation.

I That Sovereignty is inalienable . : , 5 . - eze,
II That Sovereignty is indivisible . : : : 3 Sees.
III Whether the general Will is fallible . : 4 ¢ chon Ps
IV The Limits of the Sovereign Power . ; é : nee 20)
V_ The Right of Life and Death . - ; . 5 030
VI Law . : é : 5 A j A i 3 A She

VII The Legislator . § Z P 6 A : ess
...
The various Systems of Legislation . . : F Fi
The Division of the Laws. ; . : é . Fi
Book III
Which treats of political laws, that ts to say, of the form of
government,
Government in General . . 5
The constituent Ee in the various Forme of Gam
ment . . . . . .
The Division of Governments é
Democracy . °
Aristocracy : : . : . : . .
Monarchy .
Mixed Governments . : . .
That all Forms of Government do not suit all Coan biee
...
How the Sovereign Authority maintains itself (continued)
How the Sovereign Authority maintains itself (cordinned) .
Deputies or Representatives . . .

That the Institution of Government is not a Contace
...
Which treats further of political laws and sets forth the
means of strengthening the Constitution of the Siate.
...
CHAP, PAGE
. VII The Censorship . : S - : F F sent
_ VIII Civil Religion . : : - : A - é a grt)
IX Conclusion . 2 * - : 5 : : 5 Te
...
Foderis xquas
Dicamus leges. (Vergil, ncid XI.)

D 660

FOREWORD

Tuis little treatise is part of a longer work which I
...
that justice and utility may in no case be divided. ire
...
_ neither, and that is why I do so. If I were a prince or a
...
YT do not know. What can make it legitimate? That
...
societies: the ruler corresponds to the father, and the
...
_ fight by fact.+ It would be possible to employ a more
logical method, but none could be more favourable to
tyrants.

_ It is then, according to Grotius, doubtful whether the
...
_ the view of Hobbes. On this showing, the human species
...
_ The reasoning of Caligula agrees with that of Hobbes
...
_ petuated the condition.

_ I have said nothing of King Adam, or Emperor Noah,
...
1 «earned inquiries into public right are often only the history of past
abuses ; and troubling to study them too deeply is a profitless infatuation ”
(Zssay on the Interests of France in Relation to its Neighbours, by the
Marquis d’Argenson). This is exactly what Grotius has done. }

® See a short treatise of Plutarch’s entitled ‘‘ That Animals Reason,’

8 ks The Social Contract
...
Tue strongest is never strong enough to be always the
...
iO 4 The Social Contract

lived there very tranquilly, while they were awaiting theit
turn to be devoured.
...
to the ends of nature, and exceeds the rights of paternity.
...
The Social Contract Il

_ But it is clear that this supposed right to kill the con-
...
mor in the social state, where everything is under the
...
_ Furthermore, this principle is in conformity with the
...
‘any other nation on earth, carried their scruples on this head so far that a
citizen was not allowed to serve as a volunteer without engaging himself
...
of war continues to subsist between them: théir mutual
...
_ So, from whatever aspect we regard the question, the
...
a convention wholly at your expensé and wholly to my
...
deliberation. It would be better, before examining the
...
and remain as free as before.” This is the fundamental
...
The Social Contract I5

ecognised, until, on the violation of the social compact,
ach regains his original rights and resumes his natural
iberty, while losing the conventional liberty in favour of
vhich he renounced it.

_ These clauses, properly understood, may be reduced to
me—the total alienation of each associate, together with
ll his rights, to the whole community; for, in the first
lace, as each gives himself absolutely, the conditions are
fhe same for all; and, this being so, no one has any
nterest in making them burdensome to others.

Moreover, the alienation being without reserve, the
inion is as perfect as it can be, and no associate has
inything more to demand: for, if the individuals retained
‘ertain rights, as there would be no common superior to’ —
lecide between them and the public, each, being on one
joint his own judge, would ask to be so on all; the state
9f nature would thus continue, and the association would
vecessarily become inoperative or tyrannical.

Finally, each man, in giving himself to all, gives him-
self to nobody; and as there is no associate over whom he
loes not acquire the same right as he yields others over
uimself, he gains an equivalent for everything he loses,
und an increase of force for the preservation of what he
las.

If then we discard from the social compact what is not
»f its essence, we shall find that it reduces itself to the
ollowing terms—

“Each of us puts his person and all his power in
rommon under the supreme direction of the general will,
ind, in our corporate capacity, we receive each member
is an indivisible part of the whole.”

At once, in place of the individual personality of each
sontracting party, this act of association creates a moral
and collective body, composed of as many members as
the assembly contains votes, and receiving from this act
ts unity, its common identity, its life and its will. This
sublic person, so formed by the union of all other persons,
formerly took the name of city,’ and now takes that of

1 The real meaning of this word has been almost ‘wholly lost in modern
imes ; most people mistake a town for a city, and a townsman for a citizen.
They do not know that houses make a town, but citizens a city. The same
nistake long ago cost the Carthaginians dear. I have never read of the

16 The Social Contract

Republic or body politic; it is called by its members Stat
when passive, Sovereign when active, and Power wher
compared with others like itself. Those who are associate
in it take collectively the name of people, and several
are called citizens, as sharing in the sovereign power, an
subjects, as being under the laws of the State. But thes
terms are often confused and taken one for another: it i
enough to know how to distinguish them when they ar
being used with precision.

CHAPTER VII
THE SOVEREIGN

Tuis formula shows us that the act of association com
prises a mutual undertaking between the public and th
individuals, and that each individual, in making a con
tract, as we may say, with himself, is bound in a doubl
capacity; as a member of the Sovereign he is bound t
the individuals, and as a member of the State to th
Sovereign. But the maxim of civil right, that no one i
bound by undertakings made to himself, does not appl
in this case; for there is a great difference between incur
ring an obligation to-yourself and incurring one to a whol
of which you form a part.

Attention must further be called to the fact that publi
deliberation, while competent to bind all the subject
to the Sovereign, because of the two different capac
ties in which each of: them may be regarded, canno
for the opposite reason, bind the Sovereign to itself; an

title of citizens being given to the subjects of any prince, not even th
ancient Macedonians or the English of to-day, though they are nearer libert
than any one else. The French alone everywhere familiarly adopt th
name of citizens, because, as can be seen from their dictionaries, they have n
idea of its meaning ; otherwise they would be guilty in usurping it, of th
crime of /ése-mayesté: among them, the name expresses a virtue, and not
right. When Bodin spoke of our citizens and townsmen, he fell into a ba
blunder in taking the one class for the other. M. d’Alembert has avoide
the error, and, in his article on Geneva, has clearly distinguished the for
orders of men (or even five, counting mere foreigners) who dwell in o:
town, of which two only compose the Republic. No other French write
to my knowledge, has understood the real meaning of the word citizen.

The Social Contract 17

that it is consequently against the nature of the body
...
that there neither is nor can be any kind of fundamental
...
power need give no guarantee to its subjects, because it
is impossible for the body to wish to hurt all its members.
We shall also see later on that it cannot hurt any in par-
Hicular. The Sovereign, merely by virtue of what it is,
s always what it should be. ; ;

This, however, is not the case with the relation of the
subjects to the Sovereign, which, despite the common
nterest, would have no security that they would fulfil their
indertakings, unless it found means to assure itself of
heir fidelity.

In fact, each individual, as a man, may have a par-
icular will contrary or dissimilar to the general will which

E 660

\

1S The Social Contract

he has as a citizen. His particular interest may speal
to him quite differently from the common interest: hi:
absolute and naturally independent existence may mak
him look upon what he owes to the common cause as %
gratuitous contribution, the loss of which will do les:
harm to others than the payment of it is burdensome tc
himself ; and, regarding the moral person which constitute:
the State as a persona ficta, because not a man, he may
wish to enjoy the rights of citizenship without being read}
to fulfil the duties of a subject. The continuance of sucl
an injustice could not but prove the undoing of the bod;
politic.

In order then that the social compact may not be at
empty formula, it tacitly includes the undertaking, whicl
alone can give force to the rest, that whoever refuses te
obey the general will shall be compelled to do so by the
whole body. This means nothing less than that he wil
be forced to be free; for this is the condition which, by
giving each citizen to his country, secures him against al
personal dependence. In this lies the key to the working
of the political machine; this alone legitimises civil under
takings, which, without it, would be absurd, tyrannical
and lable to the most frightful abuses.
...
the morality they had formerly lacked. Then only, wher
the voice of duty takes the place of physical impulses anc
right of appetite, does man, who so far had considerec
only himself, find that he is forced to act on differen:
principles, and to consult his reason before listening te
...
lated and developed, his ideas so extended, his feeling:
so ennobled, and his whole soul so uplifted, that, did no!
...
_that which he left, he would be bound to bless continually
_the happy moment which took him from it for ever, and,
...
prescribe to ourselves is liberty. But I have already said
...
Eacu member of the community gives himself to it, at

the moment of its foundation, just as he is, with all the

resources at his command, including the goods he pos-
sesses. This act does not make possession, in changing
hands, change its nature, and become property in the
...
prevent them from ever returning? How can a man ora
...
gave them in common? When Nufiez Balbao, standing
...
universe, merely making a subsequent reservation about
what was already in the possession of other princes.

_ We can imagine how the lands of individuals, where
_ they were contiguous and came to be united, became the
_ public territory, and how the right of Sovereignty, extend-
...
_ present day more cleverly call themselves Kings of France,
...
_and changes usurpation into a true right and enjoyment into
...
‘a fact on which the whole social system should rest: 1. e.
that, instead of destroying natural inequality, the funda-

ee wil The Social Contract
...
Tue first and most important deduction from the prin-
ciples we have so far laid down is that the general will
alone can direct the State according to the object for
which it was instituted, 7. e. the common good: for if the
clashing of particular interests made the establishment
of societies necessary, the agreement of these very
interests made it possible. The common element in these
different interests is what forms the social tie; and, were
...
social ae is advantageous to men only when all have something and none
too much,
...
able, is indivisible; for will either is, or is not, general; }
...
1 To be general, a will need not always be unanimous; but every vote
...
as we shail see clearly when the idea attached to the word
...
_ If follows from what has gone before that the general
...
_ people is never corrupted, but it is often deceived, and on
...
1 « Tivery interest,” says the Marquis d’Argenson, ‘has different princi-
ples. The agreement of two particular interests is formed by opposition to
a third.” He might have added that the agreement of all interests is
formed by opposition to that of each. If there were no different interests,
the common interest would he barely felt, as it would encounter no
...
unique system established by the great Lycurgus. But
...
shall be always enlightened, and that the people shall in
no way deceive itself.

CHAPTER IV
THE LIMITS OF THE SOVEREIGN POWER

Ir the State is a moral person whose life is in the union
...
1 «Tn fact,” says Macchiavelli, ‘‘ there are some divisions that are harm-
ful toa Republic and some that are advantageous. Those which stir u
sects and parties are harmful ; those attended by neither are odvantageone
Since, then, the founder of a Republic cannot help enmities arising, he ought

at least to prevent them from growing into sects” (Hz.
" s estory of Flor
Book vii). [Rousseau quotes the Italian.] 7 ee

The Social Contract 27

_members, the social compact gives the body politic abso-
jute power over all its members also; and it is this power
which, under the direction of the general will, bears, as I
_have said, the name of Sovereignty.
...
is it that the general will is always in the right, and that
...
for ali? This proves that equality of rights and the idea
...
its essence; that it must both come from_all and apply
...
1 Attentive readers, do not, I pray, be in a hurry to charge me with con-
...
point the latter can enter into undertakings with them-
selves, each with all, and all with each. 4

We can see from this that the sovereign power, abso-
lute, sacred and inviolable as it is, does not and cannot
“exceed the limits of general conventions, and that every
...
got liberty, instead of the power to harm others security
for themselves, and instead of their strength, which others
might overcome, a right which social union makes jin-
...
but then no one has ever-to fight for himself. Do we not
gain something by running, on behalf of what gives us
...
expense should also, when it is necessary, be ready to give
...
_ Again, every malefactor, by attacking social rights,
...
judge belongs only to the authority which is superior to
...
decision. Frequent pardons mean that crime will soon

a7 The Social Contract

need them no longer, and no-one can help seeing whithen
...
nature of things and independently of human conventions...
...
justice to its object. In the state of nature, where every-
thing is common, I owe nothing to him whom I have.
...
parts; and it follows that the will of one 13 no longer in
...
the decreeing will, general. This act is what I call a law. ~
...
sees it. The general will is always in the right, but the:
...
1 T understand by this word, not merely an aristocracy or a democracy,
bat generally any government directed by the general will, which is the
law. To be legitimate, the government must be, not one with the
Sovereign, but its minister, _ In such a case even.a monarchy is a Republic.
...
sions of men without experiencing any of them would be
...
to enjoy in the next.1 It would take gods to give men
laws.

What Caligula argued from the facts, Plato, in the
dialogue called the Politicus, argued in defining the civil
_ or kingly man, on the basis of right. But if great princes
_ are rare, how much more’so are great legislators? The
...
1 A people becomes famous only when its legislation begins to decline.
We do not know for how many centuries the system of Lycurgus made the

Spartans happy before the rest of Greece took any notice of it. i
Montesquieu, 7%e Greatness and Decadence of the Romans, ch. i.
...
by it. Rome, when it was most prosperous, suffered a _
...
played a large part, does him no less honour than his Zrs¢ztute, What-
ever revolution time may bring in our religion, so long as the spirit of
patriotism and liberty still lives among us, the memory of this great man
will be for ever blessed,

The Social Contract Lyi

He, therefore, who draws up the laws has, or should
have, no right of legislation, and the people cannot, even
if it wishes, deprive itself of this incommunicable right,
...
general will, until it has been put to the free vote of the
...
_ ideas which it is impossible to translate into popular
language. Conceptions that are too general and objects

that are too remote are equally out of its range: each

_ individual, having no taste for any other plan of govern-
...
_ political theory and follow the fundamental rules of state-
...
to either force or reason, must have recourse to an
...
This sublime reason, far above the range of the common
...
} “Tn truth,” says Macchiavelli, ‘‘there has never been, in any country
...
others” (Discourses on Livy, Bk. v, ch. xi). [Rousseau quotes the
Italian. ]
...
Cyrenzans, because he knew that both peoples were rich
_and could not put up with equality; and good laws and
...
_ just as some kinds of illness turn men’s heads and make
...
destroy it, but revolutions cannot mend it: it needs a
master, and not a liberator. Free peoples, be mindful
of this maxim: “Liberty may be gained, but can never
be recovered.”
...
that it was not ripe for civilisation: he wanted to civilise
...
an infant prodigy, and for the rest of his life to be nothing
whatsoever. The empire of Russia will aspire to conquer
...
A thousand arguments could be advanced in favour of
this principle. First, long distances make administration
...
The Social Contract Al

_ by the people: each district its own, still paid for by the
_ people: then comes each province, and then the great
_ governments, satrapies, and vice-royalties, always costing
_more the higher you go, and always at the expense of the
unfortunate people. Last of all comes the supreme
_ administration, which eclipses all the rest. All these over-
...
_femain resources enough to meet emergencies; and, when
recourse must be had to these, the State is always on the
_ eve of destruction.
_ This is not all; not only has the government less vigour
...
_ people has less affection for its rulers, whom it never sees,
...
officials wish to escape or to impose upon, absorb all the
...
its own weight.
_ Again, the State must assure itself a safe foundation,

AZE S. The Social Contract
...
It may therefore be seen that there are reasons for
...
themselves, they were forced to expand ceaselessly. It
...
A sopy politic may be measured in two ways—either
...
free. a
No fixed relation can be stated between the extent of
...
what he sees, but by what he foresees; he should stop not
...
ae, The Social Contract

congregate together more in order to repel pirates, and
further because it is easier to unburden the country of its
...
1 If there were two neighbouring peoples, one of which could not do
...
an that little State, shut upin that great Empire, was finally the instrument
...
which unites the consistency of an ancient people with the
...
it how to preserve what it has won. I havea feeling that
some day that little island will astonish Europe.

CHAPTER XI
THE VARIOUS SYSTEMS OF LEGISLATION

- Ir we ask in what precisely consists the greatest good
of all, which should be the end of every system of legisla-
...
riches are to be absolutely identical for everybody; but
...
to sell himself: 1 which implies, on the part of the great,

1 If the object is to give the State consistency, bring the two extremes as
near to each other as possible; allow neither rich men nor beggars. These
...
If, for instance, the soil is barren ard unproductive, or the
...
shipping, at Sparta war, at Rome virtue. The author of

1 «« Any branch of foreign commerce,” says M. d’Argenson, ‘‘ creates on the
...
nothing by it, and the people is no better off.”
...
mistakes his object and adopts a principle ether than
...
Ir the whole is to be set in order, and the commonwealth
...
The laws which regulate this relation bear the name
of political laws, and are also called fundamental laws, not
without reason if they are wise. For, if there is, in each
...
the end its immovable_keystone.
...
BrroreE speaking of the different forms of government,
...
Causes; one moral, 1. e. the will which determines the act;
...
too force and will are distinguished, will under the namie
of legislative power and force under that.of executive
power. Without their concurrence, nothing is, or should
be, done. -

-_ We have seen that the legislative power belongs to the
...
of the general will, to serve asa means of communication
...
kings, that is to say governors, and the whole body bears
6 660
...
1 Thus at Venice the College, even in the absence of the Doge, is called
46 + »”
Most Serene Prince.

The Social Contract 51

_take as an example the number of a people, which is the
...
ten thousand to one, t. e. each member of the State has
...
this it follows that, the larger the State, theless the liberty.
...
geometry, [ am none the less well aware that moral
...
clusively to the prince and making the office_of magistrate
more honourable in proportion as it is more troublesome.

_ The difficulties lie in the manner of so ordering this sub-
...
_ vigour or promptitude, or from being, so to speak, in
...
_ ment than on those of the Sovereign; for each magistrate
...
the State, the more should the government be tightened,
...
_ It should be remarked that all these forms, or at least
...
_ If, in the different States, the number of supreme magis-
...
impossible to have a better constitution than that in which
...
In fact, | can confidently lay down as a principle that, ,
...
State, where the people can readily be got together andi
where each citizen can with ease know all the rest;
secondly, great simplicity of manners, to prevent business:
from multiplying and raising thorny problems; next, at
large measure of equality in rank and fortune, without!
which equality of rights and authority cannot long subsist;
lastly, little or no luxury—for luxury either comes off

4 The Social Contract 59

riches or makes them necessary; it corrupts at once rich

_and poor, the rich by possession and the poor by covetous-
hess; it sells the country to softness and vanity, and takes
...
the government. a
_ It may be added that there is no government so subject
...
form, or which demands more vigilance and courage for
...
_ Were there a people of gods, their government would
...
1 The Palatine of Posen, father of the King of Poland, Duke of Lor-
raine, [I prefer liberty with danger to peace with slavery. }

ore i The Social Contract ;
...
authority of experience. Hence such names as priests,
elders, senate, and gerontes. The savages of North
...
second is the best, and 1s aristocracy properly so called.
...
born magistrates; but here magistracy is confined to a
...
1 It is clear that the word offimates meant, among the ancients, not the
best, but the most powerful. %

It is of great importance that the form of the election of yj
should be regulated by law ; for if it is left at the discretion of the print
it is impossible to avoid falling into hereditary aristocracy, as the Republiez
...
4 The Social Contract 61

that the wisest should govern the many, when it is assured
that they will govern for its profit, and not for their own.
There is no need to multiply instruments, or get twenty
thousand men to do what a hundred picked men can do
even better. But it must not be forgotten that corporate
...
_ If we are to speak of what is individually desirable,
...
_ But if aristocracy does not-demand all the virtues needed
...
_ Furthermore, if this form of government carries with it
...
4 So far, we have considered the prince as a moral and
collective person, unified by the force of the laws, and the
depositary in the State of the executive power. We have

O28 The Social Contract

now to consider this power when it is gathered together
into the hands of a natural person, a real man, who alone
...
moral unity that constitutes the prince is at the same time
...
government, all answer to a single motive power; al!
the springs of the machine are in the same hands, the
whole moves towards the same end; there are no conflict!
ing movements to cancel one another, and no kind o:
constitution can be imagined in which a less amount o:
effort produces a more considerable amount of action:
Archimedes, seated quietly on the bank and easily drawing
a great vessel afloat, stands to my mind for a skilfu
monarch, governing vast states from his study, ana
moving everything while he seems himself unmoved.

But if no government is more vigorous than this, there
is also none in which the particular will holds more swai
and rules the rest more easily. Everything moves toward:
the same end indeed, but this end is by no means that
the public happiness, and even the force of the administr
tion constantly shows itself prejudicial to the State.

Kings desire to be absolute, and men are always crying
out to them from afar that the best means of being so i
to get themselves loved by their people. This precept i
all very well, and even in some respects very true. Unfors
tunately, it will always be derided at court. The pow
which comes of a people’s love is no doubt the greates
but it is precarious and conditional, and princes will nev.
rest content with it. The best kings desire to be in
position to be wicked, if they please, without forfeitin:
their mastery: political sermonisers may tell them to ther
hearts’ content that, the people’s strength being the#
own, their first interest is that the people should be pros
perous, numerous and formidable; they are well aware the

? The Social Contract 63

this is untrue. Their first personal interest is that the
people should be weak, wretched, and unable to resist
them. I admit that, provided the subjects remained always
_in submission, the prince’s interest would indeed be that
...
-is the book of Republicans.? ae
We found, on general grounds, that monarchy is suit-
able only for great States, and this is confirmed when we
examine it in itself. The more numerous the public
administration, the smaller becomes the relation between
the prince and the subjects, and the nearer it comes to
equality, so that in democracy the ratio is unity, or abso-
lute equality. Again, as the government is restricted in
...
_ If, however, it is hard for a great State to be well
...
An essential and inevitable defect, which will always

’

1 Macchiavelli was a proper man and a good citizen ; but, being attached
...
Cesar Borgia, clearly enough shows his hidden aim ; and the contradiction
between the teaching of the Przmce and that of the Dzscourses on Livy and
...
‘sternly prohibited his book. I can well believe it; for it is that Court it
...
such as to fill them with honour; while in monarchies those
who rise to the top are most often merely petty blunderers,
petty swindlers, and petty intriguers, whose petty talents
cause them to get into the highest positions at Court, but,
as soon as they have got there, serve only to make their
inéptitude clear to the public. The people is far less often
...
ment, intrigue and corruption abound. He to whom the
...
is worse than the disorders of an interregnum.
...
_from arising on the death of kings. That is to say, the
disadvantages of regency have been put in place of those
of election, apparent tranquillity has been preferred to
wise administration, and men have chosen rather to risk
having children, monstrosities, or imbeciles’as rulers to
having disputes over the choice of good kings. It has
not been taken into account that, in so exposing ourselves
...
set in authority over others the sense of justice and reason.
Much trouble, we are told, is taken to teach young princes
...
One result of this lack of coherence is the inconstancy
of royal government, which, regulated now on one scheme

fee Tacitus, Histories, i. 16. ‘‘ For the best, and also the shortest way of
...
where the prince is always the same, causes the State to
be always shifting from principle to principle and from
project to project. Thus we may say that generally, if a
...
revolution in a royal ministry creates a revolution in the:
...
government likened to domestic government, and _ the:
...
all the same, are not troubled by them. The remedy, the .
say, is to obey without a murmur: God sends bad king
...
is independent, but imperfect, as in Poland. This last
form is bad; for it secures no unity in the government,
and the State is left without a bond of union.

Is a simple or a mixed government the better? Political
writers are always debating the question, which must be
answered as we have already answered a question about
all forms of government.
_ Simple government is better in itself, just because it is
simple. But when the executive power is not sufficiently
dependent upon the legislative power, i. e. when the prince
is more closely related to the Sovereign than the people
to the prince, this lack of proportion must be cured by the
division of the government; for all the parts have then
no less authority over the subjects, while their division
makes them all together less strong against the Sovereign.
' The same disadvantage is also prevented by the appoint-
...
Ligerty, not being a fruit of all climates, is not within
the reach of all peoples. The more this principle, laid
down by Montesquieu, is considered, the more its truth is
...
tributions are removed, the more burdensome they become.

The Social Contract 69

_ The charge should be measured not by the amount of the
_ impositions, but by the path they have to travel in order
_ to get back to those from whom they came. When the

circulation is prompt and well-established, it does not

_ matter whether much or little is paid; the people is always
...
It follows that, the more the distance between people

and government increases, the more burdensome tribute

becomes : thus, in a democracy, the people bears the least
charge; in an aristocracy, a greater charge; and, «in
monarchy, the weight becomes heaviest. Monarchy there-

_ fore suits only wealthy nations; aristocracy, States of

*

middling size and wealth; and democracy, States that are
...
_-make them happy, despotism makes them wretched in
...
peoples: in such places all polity is impossible. Lands

_ where the surplus of product over labour is only middling

are suitable for free peoples; those in which the soil is

_ abundant and fertile and gives a great product for a little

‘jabour call for monarchical government, in order that the

surplus of superfluities among the subjects may be con-

sumed by the luxury of the prince: for it is better for this

70 . s The!Soctal Contract
...
South were covered with Republics and all the North with
...
in England, how men must toil! But, where more hands
...
_and indigestion. “We are,” says Chardin, “carnivorous
...
_ the effect of the nakedness of the land, only the poor would
eat little; but everybody does so. Again, less or more >
_ would be eaten in various provinces, according to the
_ land’s fertility; but the same sobriety is found throughout
...
and smooth; while the hue of their subjects, the Arme-
_nians, who live after the European fashion, is rough and
...
sumption. In England, luxury appears in a_ well-filled
...
magnificence is the sole consideration where there is
“nothing to fear from the air. In Paris and London, you
...
_ it evaporates and is lost, like powder scattered on the
...
to answer it in his own way. Subjects extol public tran-
quillity, citizens individual liberty; the one class prefers

security of possessions, the other that of person; the one
_ regards as the best government that which is most severe,
...
ce association? The preservation and prosperity’ of its
members. And what is the surest mark of their preserva-

‘tion and prosperity? Their numbers and_ population.

- Seek then nowhere else this mark that is in dispute. The

rest being equal, the government under which, without

- external aids, without naturalisation or colonies, the

74 oo». The*SocialtGontmch

citizens increase and multiply most, is beyond question
the best. The government under which a people wanes
and diminishes is the worst. Calculators, it is left for
...
As the particular will acts constantly in opposition to
the general will, the government continually exerts itself
...
1 On the same principle it should be judged what centuries deserve the pre-
...
apud imperitos humanitas vocabatur, cum pars servitutis esset.” [‘‘ Fools
...
wars give rulers rude shocks, but they are not the real ills of peoples, who
...
that decay sets in, and that the rulers destroy them at will, and ‘bi soli-
tudinem faciunt, pacem appellant.” [‘‘ Where they create solitude, they
call it peace,” Tacitus, Agricola, 31.] When the bickerings of the great
disturbed the kingdom of France, and the Coadjutor of Paris took a dagger
...
and civil war, our republic only throve: the virtue, morality and inde-
pendence of the citizens did more to strengthen it than all their dissensions
had done to enteeble it. A little disturbance gives the soul elasticity ;
...
_the prince must inevitably suppress the Sovereign and
break the social treaty. This is the unavoidable and
inherent defect which, from the very birth of the body
‘politic, tends ceaselessly to destroy it, as age and death
end by destroying the human body.
There are two general courses by which government
_ degenerates : i. e. when it undergoes contraction, or when.
the State is dissolved.
_ Government undergoes contraction when it passes from
_the many to the few, that is, from democracy to aristo-
‘cracy, and from aristocracy to royalty. To do so is its
natural propensity.’ If it took the backward course from

1 The slow formation and the progress of the Republic of Venice in its
iy lagoons are a notable instance of this sequence ; and it is most astonishing
that, after more than twelve hundred years’ existence, the Venetians seem
_ to be still at the second stage, which they reached with the Serrar dz Con-

sigdzo in 1198. As for the ancient Dukes who are brought up against them,
it is proved, whatever the Syzuzttinio della libertd veneta may say of them,
thet they were in no sense Sovereigns.

_ A case certain to be cited against my view is that of the Roman Republic,
_ which, it will be said, followed exactly the opposite course, and passed from
...
death, as new-born children sometimes perish without reaching manhood.
...
“In fact, the people was then not only Sovereign, but also magistrate and
...
itself no more than presidents of the people. i
...
of patricians and plebeians, and even in the body of tribunes when they began
...
ment is an aristocracy. pe
- The abuse of aristocracy led to the civil wars and the triumvirate. Sulla,

POD ae The Social Contract

the few to the many, it could be said that it was relaxed;
by this inverse sequence is impossible.

Indeed, governments never change their form except
when their energy is exhausted and leaves them too weak
to keep what they have. If a government at once ex-
...
in accordance with the laws, and usurps the Sovereign
power. A remarkable change then occurs: not the
government, but the State, undergoes contraction; I mean
that the great State is dissolved, and another is formed
within it, composed solely of the members of the govern-
ment, which becomes for the rest of the people merely
master and tyrant. So that the moment the government
usurps the Sovereignty, the social compact is broken,
...
government severally usurp the power they should exercise
...
whatever it is, bears the common name of anarchy. To
distinguish, democracy degenerates into ochlocracy, and
aristocracy into oligarchy; and I would add that royalty
degenerates into tyranny; but this last word is ambiguous
and needs explanation.

In vulgar usage, a tyrant is a king who governs violently
and without regard for justice and Jaw. In the exact
sense, a tyrant is an individual who arrogates to himself
Julius Cesar and Augustus became in fact real monarchs; and finally,
...
authority was not legitimate.! Tyrant and usurper are
thus perfectly synonymous terms.

In order that I may give different things different
names, I call him who usurps the royal authority a tyrant,
and him who usurps the sovereign power a despot. The
tyrant is he who thrusts himself in contrary to the laws to
...
' Sucu is the natural and inevitable tendency of the best
...
‘dream of making it eternal. If we are to succeed, we
...
perpetua in ea civitate quz libertate usa est (Cornelius Nepos, Zije of
...
(Micomachean Ethics, Book viii, chapter x) distinguishes ; the tyrant
from the king by the fact that the former governs in his own interest, and
the latter only for the good of his subjects; but not only did all Greek
authors in general use the word ¢yrant in a different sense, as appears most
clearly in Xenophon’s /tero, but also it would follow from Aristotle’s dis-
...
the executive power is its brain, which causes the move-
...
as it might. All that it has once declared itself to will itt
...
long: if the Sovereign had not recognised them ass
throughout salutary, it would have revoked them ai
thousand times. This is why, so far from growing weak,,
the laws continually gain new strength in any well consti-
tuted State; the precedent of antiquity makes them daily,
more venerable: while wherever the laws grow weak as:
they become old, this proves that there is no longer ag
legislative power, and that the State is dead.

CHAPTER XII
HOW THE SOVEREIGN AUTHORITY MAINTAINS ITSELF

Tue Sovereign, having no force other than the legis.
...
assembled. The people in assembly, I shall be told, ig

The Social Contract 79

-amere chimera. It is so to-day, but two thousand years
_ ago it was not so. Has man’s nature changed?

_ The bounds of possibility, in moral matters, are less
narrow than we imagine: it is our weaknesses, our vices
_ and our prejudices that confine them. Base souls have no
belief in great men; vile slaves smile in mockery at the
name of liberty.

Let us judge of what can be done by what has been
done. I shall say nothing of the Republics of ancient’
_ Greece; but the Roman Republic was, to my mind, a great
_ State, and the town of Rome a great town. The last
census showed that there were in Rome four hundred
_thousand citizens capable of bearing arms, and the last
...
_ passed without the Roman people being in assembly, and
_ even being so séveral times. It exercised not only the
_rights of Sovereignty, but also a part of those of govern-
ment. It dealt with certain matters, and judged certain
...
Frankish, had similar councils. In any case, the one incon-
...
_ Ir is not enough for the assembled people to have once
_ fixed the constitution of the State by giving its sanction
to a body of law; it is not enough for it to have set up a

perpetual government, or provided once for all for the

Boe mL The Social Contract
...
The greater or less frequency with which lawful assem-
blies should occur depends on so many considerations that
no exact rules about them can be given. It can only be
said generally that the stronger the government the more
often should the Sovereign show itself.

This, I shall be told, may do for a single town; but
what is to be done when the State includes several? Is
...
without being destroyed. In the second place, one town
...
such a union, we should not expect to avoid its natural
...
no capital, to make the seat of government move from

; The Social Contract 81
...
_of the first magistrate; for in the presence of the person

_ represented, representatives no longer exist. Most of the
...
and the curb on the government, have at all times been
...
1 Tn nearly the same sense as this word has in the English Parliament.
...
there is less for him to seek in particular cares. In a_
...
worse. As soon as any man says of the affairs of the
State What does it matter to me? the State may be given
_ up for lost.

__ The lukewarmness of patriotism, the activity of private
interest, the vastness of States, conquest and the abuse
_ of government suggested the method of having deputies
Or representatives of the people in the national assemblies. ’
These are what, in some countries, men have presumed
_to call the Third Estate. Thus the individual interest of
_two orders is put first and second; the public interest
occupies only the third place.

_ Sovereignty, for the same reason as makes it inalien=
able, cannot be represented; it lies essentially in the
general will, and will does not admit of représentation: it
...
_as they are elected, slavery overtakes it, and it is nothing.
...
from feudal government, irom that iniquitous and absurd
...
_attempted to pass on their own authority a single ple-
‘biscitum. We can, however, form an idea of the diff-
...
longer exists.
_ All things considered, I do not see that it is possible
...
2 [had intended to do this in the sequel to this work, when in dealing
...
First, the supreme authority can no more be modell
...
Unber what general idea then should the act by which
...
_ be a governing body established in this or that form ; this
...
_ first and a function of government.

The difficulty is to understand how there can be a
governmental act before government exists, and how the '
_ people, which is only Sovereign or subject, can, under
_ certain circumstances, become a prince or magistrate.

- It is at this point that there is revealed one of the
_astonishing properties of the body politic, by means of
which it reconciles apparently contradictory operations;
for this is accomplished by a sudden conversion of
_ Sovereignty into democracy, so that, without sensible
_ change, and merely by virtue of a new relation of all to all,
...
_ Parliament, where, on certain occasions, the Lower House
...
_accordance with the principles so far laid down.

= ee

Ns? = Te ere”

88 a The Social Contract

CHAPTER XVIII
HOW TO CHECK THE USURPATIONS OF GOVERNMENT

Wuat we have just said confirms Chapter XVI, and
...
When therefore the people sets up an_ hereditary
government, whether it be monarchical and confined to one
family, or aristocratic and confined toa class, what it enters
...
_be broken, or of irregularities he causes to be committed,
_to assume that he has the support of those whom fear
_ prevents from speaking, and to punish those who dare to
...
_ The periodical assemblies of which I have already spoken
_are designed to prevent or postpone this calamity, above
...
The opening of these assemblies, whose sole object is
...
Jiberty and his goods on leaving the country." It would
be indeed absurd if all the citizens in assembly could not

‘do what each can do by himself.

1 Provided, of course, he does not leave to escape his obligations and
...
As long as several men in assembly regard themselved
...
ayaa that Cromwell would have been put to “the bells ”
by the people of Berne, and the Duc de Beaufort on the
treadmill by the Genevese.

The Social Contract QI

But when the social bond begins to be relaxed and the
State to grow weak, when particular interests begin to
_make themselves felt and the smaller societies to exercise
an influence over the larger, the common interest changes
‘and finds opponents: opinion is no longer unanimous;
the general will ceases to be the will of ail; contradictory
_ views and debates arise; and the best advice is not taken
_ without question. d
_ Finally, when the State, on the eve of ruin, maintains —
only a vain, illusory and formal existence, when in every
_heart the social bond is broken, and the meanest interest
...
'solely to private interest get passed under the name of
laws.
...
_exclusive good he aims at making his own. Apart from
this particular good, he wills the general good in his own
“interest, as strongly as any one else. [ven in selling his
_vote for money, he does not extinguish in himself the
...
‘tight of stating views, making proposals, dividing and
iscussing, which the government is always most careful
...
Ir may be seen, from the last chapter, that the way in
...
‘its territory is to submit to the Sovercign.?
...
_How are the opponents at once free and subject to laws
...
1 This should of course be understood as applying to a free State; for
elsewhere family, goods, lack of a refuge, necessity, or violence may detain
...
3 At Genoa, the word Liberty may be read over the front of the prisons
_and on the chains of the galley-slaves. ‘lhis application of the device is
good and just. It is indeed only malefactors of all estates who prevent the
...
what I thought to be the general will was not ’so. If my
particular opinion had carried the day I should have
...
avoiding this abuse; and I shall have more to say ef
...
a majority of one vote should be enough. The first oe
...
_ “Election by lot,” says Montesquieu, “is democratic
...
_If we bear in mind that the election of rulers is a
...
tage, but a burdensome charge which cannot justly be
...
_ In an aristocracy, the prince chooses the prince, the
government is preserved by itself, and voting is rightly
ordered.

_ The instance of the election of the Doge of Venice
