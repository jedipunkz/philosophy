---
source: "https://archive.org/details/immanuelkantscr08kantgoog"
title: "Immanuel Kant's Critique of pure reason"
author: "Kant, Immanuel, 1724-1804, Müller, F. Max (Friedrich Max), 1823-1900 tr, Noiré, Ludwig, 1829-1889"
year: "1881"
captured_at: "2026-07-25T08:36:46Z"
updated_at: "2026-07-25T08:36:46Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "カント"
query: "Critique of Pure Reason"
plain_text_url: "https://archive.org/download/immanuelkantscr08kantgoog/immanuelkantscr08kantgoog_djvu.txt"
public_domain: true
...
- 著者: Kant, Immanuel, 1724-1804, Müller, F. Max (Friedrich Max), 1823-1900 tr, Noiré, Ludwig, 1829-1889
- 初版: 1881
- 情報源: [archive](https://archive.org/details/immanuelkantscr08kantgoog)
- パブリックドメイン: ✓
...
*' FrcEercQC«  bcLuff  given  to  work«  in  the  Intdlectual
MJkd  Mora}  SäenccB^^
...
^n  Comnumoration  of  tj^i  Cintenarg  oi  its
Jfirst  ^ublkation

TRANSLATED    INTO    ENGLISff
...
1.  PREFACE   BY   P.   MAX  MÜLLER

2.  HISTORICAL  INTRODUCTION  BY  LUDWIG  NOIRfi

8.    SUPPLEMENTS    OP    THE    SECOND    EDITION    OF
THE    CRITIQUE
...
PRINTED     BY     B.    PIOKABD     HALL,    M.A.,    AND     J.    H.    BTAOT.
PBIMTIBB    TO    THE    UNIVEBSITT.

TABLE  OF  CONTENTS.

PAOB

^Tbauslatoe's  Preface i-lxii.

L.  Noise's  Histobigaij  Introduction  1-360

Introduction i

Ancient  Philosophy *   .  ,8

Mediaeval  Philosophy 67

Modem  Philosophy 113
...
Genlinx.     Malebranche.     Berkeley  •  17^
...
The  Individnalistio  Tendency 265

Leibniz 265

L  The  theory  of  intellectual  perception       .         .         .283
...
Pbikcipal  Additions  made  bt  Kant  m  the  Second  Edition
OF  the  Cbitiqüe  of  Pube  Reason 361
...
uniiy  of  apperception  of  the  concepts  contained  therein      .  441

All  sensuous  intuitions  are  subject  to  the  categories  ea
...
ni.  Analogies  of  Experience 467
...
according  to  the  law  of  causality       .         .         .         -41^
...
Befutation  of  Mendelsohn's  proof  of  the  permanence  of
the  soul 497

Conclusion  of  the  solution  of  the  psychological  paralogism  .  506

General  note  on  the  transition  from  rational  psycholc^  to
cosmology 507
...
*  Bvi  how  can  you  waste  your  time  on  a  translation
of  Kant's  Critih  der  reinen  VernunflV  This  question,
...
is  that  an  adequate  translation  of  Kant  mxist  be  the
...
^  I  discovered  too  late  that  Professor  Mahaffyr,  in  his  translation
of  Kano  Fischer's  work  on  ELant  (Longmans,  1866),  has  given  some
excellent  specimens  of  what  a  translation  of  £^t  ought  to  be.  Had
I  known  of  them  in  time,  I  should  have  asked  to  be  allowed  to  in-
corporate them  in  my  own  translation.

tranbultoüb  preface.  VU

German,  I  shall  mention  at  least  a  few  of  the  pas-
sages of  which  I  am  thinking.

On  p.  42 1  (484),  Kant  says :  Da  aho  selbst  die
Auflösung  dieser  Aufgaben  niemals  in  der  Erfahrung
...
Die  dogmatische  Auflösung  ist  also  nicht  etwa  un-
geunss,  sondern  unTnöglichy  i.  e.  '  Hence  the  dog-
...
mitzutheilendes  Schattenbild  ihrer  Producte  oder  auch
...
way  in  which  Eant  arrives  at  that  conclusion.

On  p.  536  (625),  den  einzigmöglichen  Beweisgrund
(wofern  überall  nur  ein  speculativer  Beweis  statt  findet)
...
Wesen  wäre.  Kant  speaks  of  a  schema  which  is  con-
...
messenen Erkenntnisskraft  angemesen,  mithin  auch  der
Einfluss  der  letzteren  auf  jene  unterschieden  wirdy  that
...
anpassenyi.e.  jpulchre  convenire,  the  limitation  remain-
ing much  the  same  in  either  case.

X  TRANSLATOBS  PREFACE.

Doch  is  a  particle  that  may  be  translated  in  many
different  ways,  but  it  can  never  be  translated  by
therefore.  Thus  when  Kant  writes  (Suppl.  xiv.  J  17,
note,  vol.  i.  p.  438),  folglich  die  Einheit  des  Bemusst-
seyns,  ah  synthetisch^  aber  doch  ursprünglich  ange-
...
vol.  i.  p.  466),  K^nt  agrees  that  space  and  time  cannot
...
sie  nicht  von  empirischem  Gebrauch  sein  sollen,  und
von  transcendentalem  nicht  sein  können.

As  regards  single  words,  there  are  many  in  German

TKANSLATORS   PBEFACE.  XI
...
Thus  vorrücken,  no  doubt,  may  mean  *to  place
before,'  but  Jemandem  etwas  vorrücken,  means  *to
reproach  somebody  with  something/  Hence  (vol.  i.
p.  386)  die  der  rationalen  Psychologie  vorgerückten
...
On  p.  41 1  (472),  nachhängen  cannot  be  rendered  by
*  to  append/  Er  erlavht  der  Vernunft  idealischen  Er-
klärungen der  Natur  nachzuhängen  means  *  he  allows
reason  to  indulge  in  ideal  explanations  of  nature/
but  not  *  to  append  idealistic  explanations  of  natural
phenomena/

On  p.  669  (781),  als  oh  er  die  blähende  Parthei  er-
griffen hätte,  does  not  mean  '  to  attack  the  position,'
...
a  translation  that  mil  construe;  and  I  venture  to
say  that  even  to  a  German  student  of  Kant  this
English  translation  will  prove  in  many  places  more
inteUigible  than  the  German  original.  It  is  difficult
...
translatok's  preface.  xiii

the  text,  and  extracting  from  it  a  more  intelligible
sense.

Why  I  thought  I  ought  to  translate  Eant's  Critique.
...
translating  Kant,  bat  I  should  have  blamed  myself;
...
Critik  der  reinen  Vernunfi  drew  near,  I  thought
...
Hegers  disciples,  said  in  1838,  is  almost  as  true
to-day  as  it  was  then :  Engländer y  Franzosen  und
Italiener  müssen,  wenn  sie  vorwärts  wollen^  denselben
Schritt  thuny  den  Kant  schon  1781  machte.  Nur  so
können  sie  sich  von  ihrer  dermaligen  schlechten  Meto-

TRANSLATOR  S   PREFACE.  XV

physik  und  den   aus   einer  solchen  sich  ergehenden
schlechten  Consequenzen  befreien.
...
the  last  century  in  almost  every  language  of  the  worlds
...
^  See  Julius  Walter,  Zum  Gedächtniss  Kant's,  p.  28.
...
was  told  that  space  could  not  be  an  a  ^WoW  intuition,
...
This  wül  explain  why,  for  a  long  time,  I  have  felt
...
another.  This  idea  of  rational  developmenty  which
...
is  as  mythological  aa  the  other,  because  the  category
...
fessor Caird's  work  is  on  aJl  sides  acknowledged  to  be,
...
carry  out  that  idea.  Kant's  philosopty,  and  more
...
of  thinkers  which  Professor  Noirö  has  drawn  for  us
with  the  hand  of  a  master,  what  follows  1  Does  it
foUow  that  we  should  all  and  on  all  points  become
Kantians,  that  we  should  simply  leam  his  philosophy,
...
^  Julius  Walter,  Zum  Gedächtniss  Kant's,  p.  27.

'  '  J'ai  lu  et  relu  avec  un  plaisir  infini  le  petit  traits  de  Kant
(Idee  zu  einer  allgemeinen  Geschichte  in  weltbürgerlicher  Absicht,
17S4)  9  il  est  prodigieux  pour  T^poque,  et  m^me,  ei  je  Tavais  connu
six  ou  sept  ans  plus  tot,  il  m'aurait  ^pargn6  de  la  peine.  Je  suis
charm^  que  vous  Tajez  traduit,  il  peut  tr^s-efficacement  contribuer
k  preparer  les  esprits  k  la  philosophie  positive.  La  conception
g^n^rale  ou  au  moins  la  m6thode  y  est  encore  m^taphysique,  mais
les  details  montrent  k  chaque  instant  Tesprit  positif.  J'avais  tou-
jours  regard^  Kant  non-seulement  comme  une  tr^s-forte  tßte,  mais
comme  le  m^taphysicien  le  plus  rapproch^  de  la  philosophie  positive.
....  Pour  moi,  je  ne  me  trouve  jusqu'ä  present,  apr^s  cette  lecture,
d'autre  valeur  que  celle  d'avoir  systematise  et  arr^t^  la  conception
ebauch^e  par  Kant  a  mon  insu,  ce  que  je  dois  surtout  a  T^ucation
scientifique ;  et  mSme  le  pas  le  plus  positif  et  le  plus  distinct  que
j'ai  fait  apr^s  lui,  me  semble  seulement  d'avoir  d^couvert  la  loi  du
passage  des  id^  humaines  par  les  trois  etats  th^logique,  ro^ta-
physique,  et  scientifique,  loi  qui  me  semble  6tre  la  base  du  travail
dont  Kant  a  conseillö  l'execution.  Je  rends  grace  aujourd'hui  k
mon  d^faut  d'^rudition;  car  si  mon  travail,  tel  qu'il  est  maintenant,
avait  etö  pr^c^^  chez  moi  par  Tetude  du  traits  de  Kant,  il  aurait,
a  mes  propres  yeux,  beaucoup  perdu  de  sa  valeur.'  See  Auguste
Comte,  par  £.  Littr6,  Paris,  1864,  p.  154;  Lettre  de  Gomte  k  M.
d'Eichthal,  10  D^c.  1824.
...
have  iiot  asserted  their  right  of  reopening  questions
...
the  Contemporary  Review  (November,  1881),  writes  :

translator's  prbface.  xxiii
...
enthusiast  of  a  school  expects  the  world  to  be  aU
...
foimders  and  defenders  of  many  unknown  systems
...
*  Vaihinger,  Zum  Jubiläum  von  Kant's  Kritik  der  reinen
Vernunft,  p.  11.

Xxiv  translator's   iPREFACB.
...
general  public  at  large,  which  derives  it«  ideas  of
philosophy  from  them,  Kant's  philosophy  haÄ  not
...
general  at  Balaclava :  C'est  magnifique, — mats  ce nest
...
jwrhich  he  occupies.  But,  after  Kant,  Hume  and
...
work  it  was  unforttmately  impossible  to  find  room  in
...
appreciate  Professor  Noirö  s  accurate  and  luminous
...
*  This  iß  Kant's  statement,  though  it  is  not  quite  accurate.  See
Adamson,  On  the  Philosophy  of  Kant,  p.  202.  That  Kant  knew
Hume's  Treatise  on  Human  Nature  seems  to  follow  from  Hamann's
Metakritik  über  den  Purismus  der  reinen  Vemunß,  p.  3,  note.

translator's  PRfiFACB.  XXVÜ
...
of  dying  or  dead  l^,nguage  on  the  living  thought  of
...
of  Eeason,  Contemporary  Review ,  February,  1878;  my  Lectures  on
Mr.  Darwin's  Philosophy  of  Language,  Fraa&i's  Magazine,  May,
1873 ;  also  in  Professor  Noir6*s  works,  Der  Ursjyrung  der  S2)rache,
1877;  and  Max  MiUler  and  the  Philosophy  of  Language  (Long-
...
abstraction,  the  antitheses  r??  ylrevSwvv/jLov  yvwarewg ;
...
Königsberg  could  spring  forward  to  grasp  the  rudder
of  a  vessel,  cast  away  as  imseaworthy  by  no  less  a
...
tions, definite  in  munber,  carried  on  from  the  outer
...
*  See  NoW,  in  Die  Gegenwart,  June  23,  188 1.

•  Critique,  p.  728  (848).

TRANSLATORS  PREI^ACE.  XXXIU

änd  display  more  brilliant  mental  qualities,  to  show
...
of  nature,  who  had  never  troubled  thöir  heads  about
...
before  Aristotle  forced  the  terms  yevo^  and  ei^o?  to
...
and  belonged  therefore  to  the  same  femily  or  kin.  In
...
the  Hipparion  from  a  common  ancestor.  In  bot^
...
human  knowledge,  and  afler  having  been  debated  for
...
*3rdly,  it  adds  a  law  of  affinity  of  aU  concepts,
which  requires  a  continual  transition  from  every
species  to  every  other  species,  by  a  gradual  increase  of
diversity.  We  may  call  these  the  principles  of  Jtomo-
geneousnesSy  of  specification  and  of  continuity  of  forms.'
...
*  Essai  Bur  TOrigine  des  Connaissances  humaines,'
writes :  *  Soit  que  nous  nous  dlevions,  pour  parier
mötaphoriquement,  jusque  dans  les  cieux,  soit  que
nous  descendions  dans  les  abimes,  nous  ne  sortons  pas
de  nous-mömes  ;  et  ce  n  est  jamais  que  notre  pensöe
...
Kant's  Fhilosophy  as  judged  by  History.
...
and  who  still  draw  their  inteUectual  nutriment
...
bearing  of  the  Critique  of  Pure  Keason.  In  a  letter,
dated  March  i,  1789,  Jung  Stilling  writes  to  Kant:
*Tou  are  a  great,  a  very  great  instrument  in  the  hand
...
able, and  its  beneficent  eflfects  will  bring  back  the
...
only  as  a  hght  of  the  world,  but  as  a  whole  solar
system  in  one/
...
again;  some  things  which  he  foimded  will  never
...
reflection.'  What  he  haa  written  of  Kant  is  indis-
...
idea  chj^nged  the  aspect  of  the  intellectual  world,
...
Keason^  sums  up  his  estimate  in  the  following
...
possibly  Plato's  Kepublic,  Aristotle's  Metaphysics,
...
de  la  Methode  de  Descartes,'  while  Professor  Noirö,
with  his  wider  sympathies  for  every  sphere  of  intel-
lectual activity,  counts  six  books,  in  the  literature  of
modem  Einrope,  as  the  peers  of  Kant's  Critique,  viz.
Copernicus,  De  revolutionibus  orbium  coelestium
(1543) ;  Descartes,  Meditationes  de  prima  philosophia

*  Commentar  zu  Kant's  Kritik  der  reinen  Vernunft,  zum  hun-
dertjährigen Jubiläum  derselben,  herausgegeben  von  Dr.  H.  Vai-
hinger.   Stuttgart,  188 1.

*  Zum  Jubiläum  von  Kant's  Kritik  der  reinen  Vernunft,  von
H.  Vaihinger,  Separatabdruck  aus  der  Wochenschrift,  *  Im  neuen
Keich,'  1881,  No.  23,  p.  14.

'  Bevue  des  deux  Mondes,  1879,  Aoüt.

xliv  translator's  preface.

(1641);  Newton,  Principia  philosophiaö  naturalis  ma-
thematica  (1687);  Montesquieu,  Esprit  des  Lois
(i  748);  Winckelmann,  Geschichte  der  Kirnst  des  Alter-
...
testimonies.  My  only  excuse  is  that  I  had  fx>  defend
...
dressed to  me  by  my  many  friends:  ^ Bvi  how  can
you  waste  your  time  on  a  translation  of  Kant's  Critik
der  reinen  Vernunft  V
...
Secondly,  I  must  confess  that  I  have  alwa^  used
...
Thirdly,  I  certainly  disUke  in  the  Second  Edition
...
Human  Nature,  1739,  where  alone  he  had  fo\md  the
...
Kant  8  system  has  been  taken  from  the  First  Edition.
...
tector, was  not  replaced  by  WöUner  as  minister  till
...
variance  with  aU  we  know  of  the  truthful,  manly,
...
dans  la  science,  ne  se  deploie  dans  toute  sa  plenitude  qu*lk  Tage  oü
Tactivitö  vitale  vient  k  s'affaiblir/  E.  Saisset,  L'Äme  et  la  Vie,
p.  60.

teanslator's  preface.  xlix
...
künftigen  Metaphysik,  pp.  70,  202  sq.).  At  the  same
...
logy. Add  to  this  that  the  great  king,  the  firiend
...
1  tbaksultob's  pbbfacb.

wKat  he  put  in  its  place,  his  whole  doctrine  becomes
fiiU  of  contradictions.  These  I  pointed  out  in  my
...
the  dishonesty  of  this  plea  becomes  dear  if  we  com-
...
evidently  of  its  insufficiencrjr,  Kant  has  tried  to  im«-
...
he  mixed  them  up  at  onoe  with  anticipations  which
...
thus  timidly  yieldiog  he  has  in  reality  retracted,
...
fame  *  at  no  more  than  its  proper  worth,  but  fiilly
...
system  firom  his  First  Edition,  and  then  to  learn,  both
...
criticism,  and  it  certainly  oflfers  as  good  a  field
...
that  he  coxild  detect  in  them  only  one  essential
...
At  the  end  of  the  Fiflii  Edition  of  the  Critique  of
...
be  the  work  of  Bink,  or  some  other  amanuensis  of
...
len  der  Philosophie  und  des  philosophischen  Ödstes,
...
^  See  Eehrbach,  Kritik  der  reinen  Vernunft,  p.  vüL

translator's  preface.  Iv

what  seemed  to  be  misprints  were  in  many  cases
peculiarities  of  Kanf  s  style.  It  is  this  list  of  Professor
...
With  such  materials  before  him,  it  is  dear  that  a
...
Bosenkranz,  in  his  edition  of  Kant's  Critique  (text
...
Wachsthum,  der  Wohlgefallen,  der  Gegentheil,  die  Hin-
derniss,^  die  Bedilrfniss,  die  Verhaltnias,  and  he  varies
even  between  die  and  das  Verhaltniss,  die  and  das
JErkenntniss,  etc.,  so  that  even  the  genders  of  pro-
...
governs  the  accusative,  während  the  dative,  etc.
...
Antithesis  must  be  changed  into  ITiesis.
...
this  into  reine  Privaimeinungen,  i.  e.  they  are  mere
private  opinions.
...
kein  Drittes,  nämlich  reinen  Gegenstand  haben.  This
...
it  wiU  do  some  good.  I  have  called  Kant's  philosophy
the  Lingua  Franca  of  modem  philosophy,  and  so  it  is,
...
and  again  before  they  could  master  it,  wiU  not  yield
...
a  ngEtto  complain  that  he  cannot  understand  higher
...
Critique  which  feil  to  convince,  and  which  have  pro-
...
structure  of  his  philosophy  rmimpaired.  No  first
perusal  will  teach  us  how  much  of  Kent's  Critique
...
have  had  many  commimings  dindng  the  sunny  and
...
The  same  with  Kant's  Critique  of  Pure  Beason.
I  do  not  venture  to  give  the  right  and  full  explana-
tion of  all  that  Eant  has  said  or  has  meant  to  say.
...
precious  afi  the  Veda — a  work  that  may  be  criticised,
...
sailed  *to  count  as  a  mere  collection  of  curiosities,
...
*  Die  PhiloEophie  Herakleitos  des  DunkelD,  i.  p.  xii.
VOL.   L  B
...
I  have  chosen  the  above  words  of  LassaJle  as  a  motto
...
Brpriorists — are  drawn  up  will  be  reconciled  and  meet
...
vellous and  incomprehensible  fa<3ulty  distinguishing
...
Kant's  Critik  der  Beinen  Vemunfi  represents  the
...
thus  been  rendered  doubly  obscure,  as,  for  instance,  by  Bir  J.
...
conquests  of  preceding  labours,  while  aU  further  pro-
...
natuial  interpretation  of  the  universe,  is  no  longer
...
grounds  upon  which  it  rests  wiU  not  become  ap-
parent till  we  reach  the  beginning  of  the  sketch  of
medisBval  philosophy.  For  the  present  it  is  sufl&-
...
earlier  timeR  as  on  a  foreign  soil.  And  of  this  we
...
modern  tendency  nar  e^o^vv — the  Ego  of  Descartes.
...
mingles,  it  struggles  onwaxds  under  quite  diflferent
...
an(J  Newton.  Kant  himself  seems  to  have  foreseen
...
ürsein'),  is  to  the  purpose  here :  *  He  only,  who  has
...
weight] ness  given  clear  and  coherent  expression  to
...
'  Es  kann  die  Spnr  von  meinen  Erdentageu
Nicht  in  ^onen  untergehn.'

ANCIENT   PHIIOSOPHY.

*Ei'  dvrl  irdvrmv. — -"OwflOF  Su,
...
original  in  his  eyes.  In  this  sense  Sokrates  observes  I
...
Noümenon.  The  latter  alone  is  the  really  existing,  it
...
not  being.  His  famous  saying  of  the  imiversal  flux
...
'  Zeno,  the  Eleatic,  whom  Aristotlcl  called  the  father  of  dialectic,
...
first  the  half,  and  then  the  half  of  the  half,  and  so  on  ad  mfinUwniy
...
This  is  clearer  in  all  other  things  than  in  the  chec  of  man,  but  we
too  are  borne  along  in  equally  rapid  course/'

2  Plut.  Plac.  Phil.  i.  23.  ^  Adv.  Math.  vii.  129.
...
thinkers  (XoytKol)  ourselves.  This  •  is  indeed  still  all
...
world  without  (in  the  irepie-xpv^  and  our  own  being  is
too  far  estranged  fi-om  the  world  to  furnish  in  itself
...
fimdamental  principle — ^that  all  things  proceed  from
...
a  better  definition  of  life  than  tliis  one  couched  in
...
^  De  Anim.  et  BesuriBci  p.  138,  ed.  Erab.
...
motion,  whatever  phenomenal  diiferences  may  be
...
had  either  to  attadi  themselves  to  his  doctrine  or
...
thing really  i«,  but  rather  is  always  beginning  to
be  or  to  cease  to  be,  an  eternal  becoming,  a  middle

*  166  a.  '  De  Anim.  L  2.

•  Phys.  AuBcalt.Yiii.  c.  3.

1 6  ANCIENT  PHILOSOPHY.

state  between  being  arid  not  being  ^, — then  reason
...
the  most  extreme  opinion  of  the  ^acr/coio-wv  ^paKXeirl-
...
*  Plato,  Theatet.  152  E :  'Ejc  de  d^  <l>opas  re  «col  icu^o-e»f  Ka\  Kpav€ws
jTpos  aXXrika  ylyvecM  vavra  h,  drj  (jxifieu  cIkoi  ouk  6pOus  irpwayopevovrtt'
JoTi  fjL€»  yhp  ovdiiroT  ovdtv,  dei  de  yiyv^rai,  kcu  irtpi  tovtqv  iravrts  i^^s  oi
(ro<f>oi  irXrjv  Haptitvlbov  (vfi<l>€p€(r6oVf  lIpwTay6pas  re  Koi  *HpaieXetror.

'  Metaph.  iii.  c.  5.

ANaBNT  PHILOSOPHY.  1 7

to  the  spontaneous  breaking  up  of  the  Herakleitean
system  by  the  absurdity  of  the  consequences  deduced
fi*om  it.  Besides  this,  there  was  a  concealed  contra-
...
^  De  Caelo,  iii.  1 :  02  dc  rä  füv  SXXa  iraura  ylvtaBai  re  iftturi  ical  pay,
ciKU  de  irayias  oudev,  tv  hi  Ti  fJL^FOK  öirofi^KCiK,  ef  oS  ravra  wdvra  fierafrxrj-
luniC«r3ai  v€ffivK€jr  o/jrtp  loixaat  ßouXecrOai  X^cii^  aXXoi  re  iroXXot  icai

*  The  passage  in  Flatarch  (De  EI  apud  Delph.  p.  388)  is  very-
important  in  reference  to  this  view :  Uupor  r  ayrafttißea-Bm  iravra  Koi
fFvp  Litavrnbv,  &<nr(p  ;(pvo'ov  ;(/i^/L(ara  «cal  xpriyLor&v  xpv(r($r.  '  Everything
...
of  his  sayings  which  have  been  preserved,  alwajrs  to  know  exactly
...
among  the  most  important  aper^as  transmitted  us  from  the  philo-
...
formations {rpoiral)  and  its  conversions  into  the  op-
posite {evavTiorpoirai)  all  things  and  their  differences,
...
accomplished  with  the  rpoTral  and  ivavTiorpoirat,  the

iiotwithstaiidiDg  that  it  forms,  as  I  shall  show  in  another  place,
the  best  bridge  to  or  preparation  for  the  Kantian  truths,  and
furnishes,  according  to  the  analogy  indicated,  the  eaaiest  means
...
ap.  Delph.  392  C:  Uvpot  Bavaros  dipt  yivta-is  koI  dcpos  Bavaros  vbari
y€V€ais.
...
tion ;  the  utmost  justification  we  can  ofier  for  Hera-
...
neöded  before  this  answer  could  be  found  and
...
pirical, \mite  to  form  a  kind  of  image  of  the  universe,
...
Eophical.  The  correction  of  Herakleitos  is  only
...
somewhat  as  if  the  chemist«  of  the  present  day  were
to  say  their  sixty-four  elements  had  existed  from
eternity,  or  even,  as  an  apostle  of  the  most  modern
wisdom  has  deUvered  himself,  '  In  the  beginning
there  was  carbon.'  A  schoolboy  familiar  with  the
most  elementary  physical  truths  woidd  laugh  nowa-

ANCJIENT  PHILOSOPHY,  21
...
with  obvious  recurring  &cts — widespread  and  long-
...
was  impelled  to  assume  the  presence,  in  single  things,  of  a  quirUa
esmeUia  over  and  aboye  the  others,  with  which  the  ingenuity  of  the
abgtraetev/rs  de  quintessence  might  have  free  scope  !
...
tribntions  of  Crookes  and  Norman  Lockyer.  It  should  also  be
remembered  that  Schopenhauer  and  Biobert  Mayer,  so  long  ignored
or  ridiculed  in  their  own  country,  first  received  due  recognition  of
their  worth  in  England — the  latter  especially  firom  Professor  Tyn-
...
chatter  ^J  Neither  Sokrates  nor  Aristotle,  it  is  true,
...
to  his  Kwy^'  That  consciousness  plays  a  considerable
...
dc  arofia  Koi  k€p6v,  Surtp  voyd(,€Tai  flip  €ipcu  xai  dof  a^croi  ra  al(r6rjTd,  ovk  tern
dc  learh  akriB^iav  ravra,  aKkh,  rh  äroiia  fi6pop  Kai  t6  K€p6p,  Sext.  Empir.
adv.  Math.  vii.  135.  These  words  contain  the  programme  of  the
futore  views  and  conclusions  of  Locke,  Leibniz,  and  Bobert  Mayer.
The  metaphysical  truth  underlying  them,  however,  forms  the  sub-
stance of  the  immortal  work  of  Kant.

ANCIENT  PHILOSOPHY.  Ö5
...
must  naturally  be  sought  in  the  fiindamental  prin-
...
*  Clem.  Alex.  Strom.  V,  c.  14,  p.  711  Pott. :  K6<rfiov  t6v  cnnhv  Airdv-
TOP  oCt€  Tiff  3€&Vy  oÖTt  ovBpwitiüv  inoij}(T€v.  oXX*  Tjv  jcoi  coTiv  vvp  atlC^ov^
AjFTOfuvov  fuTfm  Koi  atroaßevvvfjitvov  fUrpa.
...
the  starting-points  are  diflTerent.
...
wldch  raises  them  into  the  firm  position  of  the  exact
...
kritos,  still  aU  exact  study  of  nature  points  to  some-
...
In  aU  this  there  is  an  implicit  assumption  that
mathematics,  the  theory  of  the  pure  relations  of  spaoe
...
It  will  be  suflScient  here  to  refer  to  the  Pythago-
...
pressed in  terms  of  nimaber.  I  do  not  know  that,
...
diflferences  are  to  be  reduced  at  last  into  pure  relations
...
we  are  told :  *  Not  by  number,  but  according  to
...
^  Stob.  Eel.  i.  p.  302 :  HvBayopas  oifK  i^  dpiBfwv,  Korh  dc  dpißf»6p
tfXeyt  vovra  yiyv€aBai»

'  Metaph.  i.  6  :  Mifi^o-ci  rh  Ztn-a  ifKunv  c&at  r&v  apiBfiMP.

•  Ibid.  i.  5  :  *Apxfiv  cZw»  xai  »s  vXijv  roU  o^ir*.  'A/m^/xAv  cJww  t^v  oü-
irieaf  airaymp.
...
the  famous  dictum  of  Plato,  MtjSeh  ayeoojJLerpiiro^  €i(rir(»,
as  well  as  from  many  other  passages,  among  which
the  following  is  especially  instructive,  as  it  complains
of  the  neglect  of  this  science  amoog  the  Hellenes  and
...
^  As  quoted  by  Cicero,  Qoaest.  Acad.  ii.  39.
'  Plutarch,  De  Placitis  Pbilos.  iii.  13.
...
falsified  the  strict  principle  ofj]ff.f.nra1  -p^f^^^^j,  the
...
•  Robert  Mayer,  Die  Mechanik  der  Wärme,  p.  247.
VOL.  L  D
...
talents  to  mediiottions  upon  the  stationary  point  and
...
truth,  amid  the  deceptions  of  the  senses,  a  fiim  and
...
higher  possessions  of  mankind,  the  existence  of  wliich
...
ideas,  and  w^hat  he  meant  by  the  often  repeated
assertion  thact  virtue  was  knowledge.
...
vovf^y  as  an  explanation  of  the  nature  of  the  world ;
...
is  here  plainly  Tisible^  and  hence  proceeds  another
...
derstanding of  Caeear's  step,  the  whole  history  of  Rome,  psycho-
...
of  organic  nature.  Aristotle  contrasts  very  favoiuubly
...
it  does  not  occur  to  him  to  look  at  the  world  \^ith  a
...
of  Schopenhauer  the  Mlowing  passage  from  a
...
bhnd  sway  of  natural  necessity  (!!).  We  know  that
...
ligence, by  the  motion  of  matter  in  accordance  with  universal  lawsJ

42  ANaENT   PHILOSOPHY.
...
led  natm*ally,  under  his  guidance,  to  human  reason  as
...
Let  U8  invert  the  terms — the  origination  of  the  motions  of  matter,
including  weight  and  all  inorganic  movements,  by  intelligent  prin-
ciples in  accordance  with  tl)e  universal  laws  of  thought, — ^and  the
...
Eeason,  or  the  rational  principle  (to  vofjriKoi'),  is
...
constant  actio»  of  the  outer  world.  Perception  and
sensibility  then  remai«,  notwithstanding  the  dis-
...
j  ciple,  which  combines,  compares,  and  distinguishes
...
for  these  things,  but  *the  soul  perceives  the  xmi-
versals  of  all  things  by  herself  2/  The  soul  perceives
equally  by  the  touch  the  hardness  of  that  which  is
hard  and  the  softness  ofthat  which  is  soft.  'But
...
'Es  ist  niclit  draussen,  da  sucht  es  der  Thor,
...
also  be  iramateriaL  But  it  is  one  thing  for  the  soul
...
the  history  of  mediseval  philosophy.  It  was  received
...
*  TimaoB,  27,  28  (Jowetfc's  Translation).

VOL.  I.  E

50  ANCIENT  PHILOSOPHY.

physics  is  the  sQience  of  the  inconceivable,  upon
...
a  diflSculty  which  presents  the  real  crux  of  modern
...
by  its  mutability  and  diflfusion  in  space,  but  that
...
has  met  with  from  the  modem  representatives  of  the
same  tendency.
...
single  things  rfo  exist,  this  particular  horse,  this  par-
ticular tree  ;  always  and  under  all  circumstances
thought  must  proceed  from  the  particular  substance,
ihe  roSe  ri,  as  to  which  a  general  statement  must  be
...
demands  a  prima  jphilosophia  whence  everything  else
...
abstract  ideas,  are  the  necessaiy  factors  of  the  faculty
of  knowledge.  He  says,  in. agreement  with  his  great
master,  'Ap-j^ij  koI  reXog  vov^^.
...
of  reason,  but  the  latter  has  only  potentiay  a  dis-
...
The  relationship  between  Äristdtle  ana  Plato  may
...
(arvvoXov).  "Rational  knowledge  apprehends  pure  form,
...
L  e.  from  the  world-creating,  absolute  Intelligence.
The  latter  is  a  false  conclusion  a  priori,  the  ori^
...
diflTerence  between  Aristotle  and  Plato  shows  itself
here  also,  the  former  conceiving  human  reason  more
as  an  intellectua  ectypu9,  the  latter  as  an  intellectus
archetypu8.
...
electnc  poles  which  gave  this  direction  to  the  current
of  thought  for  the  next  two  thousand  years.

The  closing  period  of  ancient  philosophy  may  be
briefly  characterised  by  a  summary  of  ite  results.
...
the  action,  nature,  and  ftinction  of  reason.  Having
...
ment  of  the  human  rax;e  are  contained  in  the  fifth
...
came  into  existence  toith  and  by  language.  General
...
world.     This  efiective  action  marks  the  real  boundary
...
and  continues  iminterruptedly  to  act,  and  to  be  acted
...
human  mind  plays  with  marvellous  skUl  so  as  to
...
{wapaScly/uLara^),  after  which  the  actual  beds  and  tables
...
iron  or  wood  and  so  realise  iV.  The  iron  and  the  wood,
...
forehead  the  tokens  of  its  origin.  ''YXij  or  materia  is
...
post  rerriy  and  afterwards  more  frequently  ante  rem.
...
comprehends  aU  forms.  '  All  things  that  become,'  he
^  De  Anima,  ill.  8.
...
'  Loc.  cit.,  Aey«  V  ov<riaP  Smw  vXi/s  rh  tL  r^v  elvai.

ANCIENT  PHILOSOPHY.  65

a  kind  of  matter,  wticli  the  formative  human  mind
...
the  starry  spheres,  of  God  as  the  jprimus  motor,  the
TrpSrrov  kivovv  o/c/i/f/Toi/,  that  maintained  all  things  in
eternal  motion.  We  shall  see  how  this  funda-
mental error  of  a  self-subsisting  quality-less  matter
weighed  upon  Descartes  and  his  successors  xmtil
...
rical explanation  to  be  idtimate  truths,  while  the
...
MEDIJIVAL  PHILOSOPHY.

*Ep  dpxS  ^v  6  'k6yos  km  3t6t  fjv  6  X6yos*   ndvra  dt    axrrov  tytvtro,  koI

;(Ck»pl£   aVTOV   €y4v€TQ  Ovbi    €P. — Ev.  J  OH,  L  I.
...
objectivise,  to  lend  being  and  reality  to  all  thing?,
...
thinga  That  anything  should  exist  only  in  the
...
identical  with  the  motion  of  the  sun  {xP^vog  fi  to5
ovpapov  Kivija-i^  or  ijXiov  Kivij<rig,  Tim.  37)«  And  in  the
...
ligious delirium  which  stiU  enveloped  the  world  in
...
^  OaXijs  ^^6rj  vamra  irX^pi^  Bt&y  cbcu.  ArUt.  de  Anima,  L  5*

MEDLaEVAL  PHILOSOPHY.  7 1
...
^  Oeschichte  des  Materialismus,  i.  95.
...
ea-Tiv  6  Koa-jULOi),  an  uninterrupted  causal  mechanism
...
or  not  ? '  Dikaearchos,  his  disciple,  is  thus  quite  con-
...
aequabiliter  esse  fusam,'  etc.    (Cicero,  Tusc.  i.  lo.)
...
to  aflford  any  satisfaction,  and  rather  left  things  with
...
doctrine  annpunced  itself,  which  was  to  start  from
...
understand  '  Wie  spricht  ein  Oeist  zum  andern  Geld.*
...
eveiywhere  proclaimed.  Enthusiasm,  ecstasy,  subjec-
...
fleeting  and  ülusory  world  of  phenomena.  The  sen-
...
MEDIEVAL  PHILOSOPHY.  77

18  the  soul,'  and  '  Time  must  not  be  assumed  to  exist
outside  the  soul/  The  soid  thus  became  the  creator
...
which  can  hardly  be  given  than  the  mention  that  V
...
firee,  a  region  no  longer  closed  by  fear  or  prejudice
...
to  rejoice  in  the  beauty  of  natiure  and  to  imagine
...
and  adaptations  jfrom  Greek  philosophy.  They  all
agree  in  one  point,  that  an  invisible,  inconceivable,
incomprehensible,  immutable,  primeBval  Being  is  the
cause  and  foundation  of  all  things.  This  primal
monad  (moWj  ayyew^ro^)  has  given  birth  to  all  things.
He  is  the  Bythos  or  Abyssus  by  whom  the  con-
substantial  Silence  {<riyii)  was  impregnated.  Hence
proceeded  Knowledge  (voSg)  and  Truth,  and  these  four
compose  the  Pythagorean  rerpaKTv^y  the  root  of  all
...
nerve-sether,'  etc.  Both  disguise  what  they  ca^nnot
explain.
...
so  there  can  be  bat  one  God  to  rule  the  world*
*  Deus  autem  qui  est  eeterna  mens  ex  omni  utique
parte  perfectae  consummatseque  virtutis  est . . .  Deus
vero,  si  perfectus  est,  ut  esse  debet,  non  potest  esse
nisi  unus.'  (Lact.  Inst,  is.)
...
Unde  scis  ?  Nescio.  Moveri  te  scis  1  Nescio.  Cogi-
...
As  certainly  as  you  live  and  think,  so  cartainly
God  lives  and  is  a  Single  Being,  a  spirit  like  youiv
...
The  diflference  is  that  mediaeval  philosophy  drew
...
18  certsonly  his  weakest  point,  but  we  see  already

MEDLEVAL  PHILOSOPHY.  $3

how  with  him  philosophy  which  had  hitherto  be-
lieved itself  to  be  the  doctrine  of  the  Absolute  In-
telligence, was  to  become  the  doctrine  of  the  8vh^
jedive  Intelligence.

The  knowledge  of  self  was  first  derived  from  the
knowledge  of  GoA  This  is  perhaps  the  most  im-
...
rule  and  the  aim  of  all  spiritual  research  :  'Deum  ei
animam  scire  cupio.  Nihilne  plus  ?  Nihil  omnino.*
(Soliloq.  L  7.)  *  Deus  semper  idem,  noverim  me,
...
Theoeophy  take  the  place  of  the  ancient  ontology.
...
throughout  the  wotW,  so  the  one  soul  is  present
indivisibly  in  every  part  of  the  body.  It  is  there-
fore a  special  spiritual  substance,  which  has  nothing
in  conuuon  with  the  corporeal  nature.     Questions

G  2

84  MEDIiKVAL  PHILOSOPHY.
...
Ü&  the  principle  of  separation  and  incomprehensibility,
...
miiltiplicity,  divisibility,  and  passivity  of  matter.
...
'  operari  sequitur  esse,'  they  cannot  be  conceived  fö
...
^  Thus,  according  to  Aristotle,  Sokrates  eaid  Ovk  c^*  fjfiiv  y€vivBai
r6  avoxftaiovs  c&ai  $  <pav\ovs,  (Eth.  mag.  i.  9.)

MEDIAEVAL  PHILOSOPHY.  85

divine  nature  consist  in  its  necessity,  as  when  lie
says  of  Cato :  *  Homo  virtuti  consimilHmu«,  et  per
omnia  genio  diis  quam  hominibus  proprior :  qui
nunqtram  recte  fecit,  ut  facere  videretur,  sed  quia
aliterfaeere  non  poterat'  (ii.  35.)  But  in  a  yet  higher
...
could  lead  to  an  aflSliation  or  even  comparison  of  the
...
as  we  learn  to  know  Üie  laws  of  nature,  its  classes
...
into  Latin,  so  prociu'ing  for  them  considerable  in-

MSDIMVAJj  PHILOSOPHY.  87

fluence  on  the  philosophy  of  the  West.  In  Diony-
siup,  who  was  also  a  favourite  authority  with  the
medidBval  mystics,  and  had  himself  been  much  under
...
theology  (jcoTa^aTCio;)  and  a  negative,  ahriract  one
(aTTo^ariicjJ) :  the  first  descends  from  Gk)d  to  created
things,  which  multiply  and  specialise  as  we  proceed
(in  which  he  is  approaching  Arißtotle) ;  the  latter  pur-
sues the  opposite  course,  and  by  continuously  ihink*
...
ün-named,  of  which  nothing  may  be  predicated,  the
...
incausale  et  insubstantiaJe  V  The  other  expedient —
that  God  a:^ated  men  free — ^has  been  shown  by  Scho-
...
ratio  vero  nequaquam  ex  auctoritat^/  The  whole
...
a  philosopliy  which  took  its  start  from  the  absolute
intelligence.  Aristotle's  doctrine  of  the  Categories
acquired  the  utmost  importance  in  Scholasticism :  the
Categories  are  properly  kinds  of  afl&rmation.  Lange  ^
...
{to  ovTWff  ov).  Logic,  dialectic,  and  the  rest  were  only
...
^  Genus,  difierentia,  species,  proprium,  aocidens.
...
important  and  indispensable  link  in  the  developüient
of  human  thought.
...
his  treatise  '  De  Niliilo  et  Tenebris,*  when  he  argues
