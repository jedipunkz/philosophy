---
source: "https://archive.org/details/in.ernet.dli.2015.31367"
title: "Critique Of Pure Reason Part. 1"
author: "Kant, Emmanuel"
year: "1881"
captured_at: "2026-07-20T14:42:23Z"
updated_at: "2026-07-20T14:42:23Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "カント"
query: "Critique of Pure Reason"
plain_text_url: "https://archive.org/download/in.ernet.dli.2015.31367/2015.31367.Critique-Of-Pure-Reason--Part-1_djvu.txt"
public_domain: true
...
# Critique Of Pure Reason Part. 1

- 著者: Kant, Emmanuel
- 初版: 1881
- 情報源: [archive](https://archive.org/details/in.ernet.dli.2015.31367)
- パブリックドメイン: ✓
...
1. PREFACE BY P. MAX MULLER

2. HISTORICAL INTRODUCTION BY LUDWIO NOIRfi

3. SUPPLEMENTS OF THE SECOND EDITION OF
...
PRINTED BY E. PICKARD HALL, M.A,, AND J. H.
...
Tkanslatob’s Prbfacb i-lxii.

L. Noire’s Hibtobical Introduction . . . 1-360

Introduction ......... i

Ancient Philosophy . 8

Medii^val PhUosophy . . . . . *67
...
I^i The theory of intellectual perception . . .283
...
Fbikcipal Additions made by Kan[t in the Second Edition
OF the Cbitique op Pubb Beason . . . , . 361

Supplement I . . 363

Supplement II. Preface to Second Edition . . . -364
...
Of the original ^thetical unity of apperception . . 434

The principle of the synthetical unity of apperception is
ti^e highest principle of all employment of the under-
standing 437
...
All sensubus intuitions are subject to the categories as
...
according to tlie law of causality . . . . 47*
...
of Kant’s Critik der reinen Vernunftf’ This question,
which has been addressed to me by several friends, I
think I shall best be able to answer in a prefree to
...
reinen Vemunft? — that is. Were there not other per-
sons more fitted for that task, or more specially
called upon to undertake iti '
...
part to his phrases that peculiar intonation which teUs
...
the English translations by Haywood and Meiklejohn
...
what I know to be a most arduous task. But iii
order to give an idea of what I mean by the danger
arising from a^ neglect of adverbs and pEtrticles in

* I discovered too JIato that Professor MahafFy, in his translation
of Knno Fischer's work on Kant (Longmans, 1866), has given some
excellent specimens of what a translation of Ke nt ought to be. Had
I known of them in time, I should have asked to be allowed to in-
corporate tl}em in my own translation.

tbanslatob’s preface. vii'

German, I shall mention at least a few of the pas-
sages of which I am thinking.

On p. 42 1 (484), Kant says ; Da also sdhst die
Auflosung dieaer Aufgahen niemaU in der IhfaJirung
...
for its solution. Here the particle aho implies that
the writer, aftet what he has said before, feels justified
...
at aU. Kant repeats the s^me statement in the same
page with still greater emphasis, when he says :
Die dogmatische Aujldsung ist also nickt etwa un-
gewiss, sondern unmdglich, i. e. ‘ Hence the dog-
...
low of our changing the words so ist es kluglich gehan-
delt, intcya question. It is the particle so which requires
the transposition of the pronoun {ist ^s instead of es ist),
not the interrogative character of the whole sentence.

On p. 42 7 (49 i), wenn cannot be rendered hyalthmigh,
which is wenn auch in German. Wenn heide nach

■'1

viii TRANSL^ITOB’s il^RKFACE.

■i-,

emjpirischen Geaetzen in einer Erfaihrung ricktig und
durchgdngig zmammenhangen, m^ns, ‘ If botli have
...
which painters liave in their minds, and die ein nicht
‘ m^zvtlmlendes Schattenhild ihrer Produete oder auch
EeiiHkdlungen sein sollen, that is, ‘which, according
...
On p. 536 (625), den einzigmdglicJien Beweisgrund
(wofern iiberall nur ein speculativer Beweis statt findet)
...
p. 586 {684),' solches Schema, als oh es ein wirkliches^
Wesen ware, ^ant speaks of a schema whi6h is con-
ceived to be real, hut is not so, and this implied meaning
...
Wodurch jeder Vorstellung iJire Stelle in der ihr ange-
messenen ErTcenrdnisshraft angevnesen, mithin auch der
Einjluss der letzter en aufjene unterschieden vnrd, that:
...
sonst j^ Vernunft, aher nur nicM hier wol anpassen.
...
Editiorf, because he may have wishe^ to remove even
that slight shade of hesitation which is conveyed by
that particle. Possibly, however, wol may refer to
anjpa 88 en,i.e. pulchre convenire, the limitation remain-
ing much the same in either case.

X TRANSLATOB'S PREFACE.

■V-

Dock is a particle that may be translated in many
different ways, but it can nevef be translated by
therefore. Thus when Kant writes (Suppl. xiv. f 17,
note, vol. i. p. 438), folglich die Einhdt des Bewusst-
seyns, ah syiithetisch, ether doch ursprirnglich ange-
troffen wird, he nieans to convey an opposition be-
...
But the matter becomes mpre serious in other places.

Thus (Supplement xiv. § 26, vol. i. p. 455) Kant says,
ohne diese Taugliclikeit, which means, ‘unless the cate-
gories were adequate for that purpose,’ but not, ‘ if the
categories were adequate.’ Again (Supplement xvit>.
vol. i. p. 466), Kant agrees that space and time canned
be perceived by themselves, but not, that they can be
thus perceived. And it must distiyrb even an atten-
tive reader when, on p. 216 (248), he reads that ‘the
categories must be employed empirically, and cannot
be employed tran^endentally,’ wliile Kant writes : Da
sie nicht von emjgirischem Gehrauch sein sollen, und
von transcendentalem nicht sein honneh.
...
Thus vorrucken, no doubt, may mean ‘to place
before,’ but Jemandem ettoaa vorrucJcen, means ‘to
reproach somebody with something.’. Hence (vol. i.
p. 386) die der rcUionalen Psychologie vorgeruckten
Paralogumen does not mean ‘ the paralogisms which
immediately precede the Rational Psychology,’ but
‘the paralogisms with which Rational Psychology
has been reproached.’

On p. 41 1 {4^2), naehhangen cannot be rendered by
‘ to append.’ Er erlauht der Vernunft idealischen Er-
kldrungen der Naiur nachzuhdngen means ‘ he allows
reason to indulge in ideal explanations of nature,’
but not ‘ to append idealistic explanations of natural
phenomena.’

On p. 669 {781), ah ob er die hejahende Parthd er-
griffen hoMe, does not mean ‘ to attack the position,’
but ‘ to adopt the position of the assenting party.’

On p. 727 (847), Wie kann ich erwarten does not
mean, ‘ How can I desire?’ but, ‘ How can I expect?’
...
Germai# has in translating Kant, as compared with
any other translator who has -deriYed his knowledge
...
xii tbanslatob’s preface.

historical or scientific works. But in order to ^nd
...
that in rendering Knnt’s arguments in English I
...
tences in Kant’^ Critique which I have riot been
...
tbanslatob’s pbbface. xiii

thiB text, and extracting from it a more intelli^ble
sense.

Why I thought 1 ought to translate Kant’s Critique.
...
once leemt from Kant what man can and what he
cannot kno-vy, my plan of life ^was very simple,
...
preachiug Kant ; and nothing I have missed so
much, when wishing to come to an miderstanding
...
the Lingua franca of modem philosophy, and not
to be able to speak it, is like studying ancient phi-
losophy, without being able to speak Aristotle, or
modem philosophy, without bein^ able to speak
Descartes. What Bosenkranz, the greatest among
Hegel’s disciples, said in 1838, is almost ^ tme
to-day as it was ^then ; Englander, Franzosen und
Italiener miissen, wenn sie vorwarts wollen, denselben
Schritt thun, den Kant schon 1781 machie. Nur so
kdnnen sie sich von ihrer dermaligen schlecMen Meta-

TEANSLATOB'S PREFACE. XV

fhy&ih und dm am einer thicken aich erg^enden '
schlechten Comequenzm harden.
...
the last century in almost every language of the world \
speaks for itself. There is no single philosopher of any
note, even among those who are decidedly opposed to
Kant, who has not acknowledged his pre-eminence
among modem philosophers. The great systems of
Fichte, Schclling, Hegel, Herbart, and Schopenhauer
branched ojff from Kant, and now, after a century has
passed away, people begin to see that those systems
were indeed mighty branches, but that the leading
shoot of philosophy was and is still — Kant. No tmer
...
back to Kant. H faut reculer, jpour mieux sauter.
...
work with that of Copernicus®. But ifKant was right
in his estimate of his ovm philosophy, it cannot be
...
® See Julius Walter, Zum Gedachtniss Kant’s, p. a8.

® See Supplement II, vol. i. p. 370.

XVi mANSLATOR’S RBEFACB.

denied that, with huh few, though memorable excep-
tions, philosophy in England is . still Ante-Copernican.
How little Kant is read hy those who ought to read
him, or how little ho is understood by those who
...
was told that space could not be an a jpriori intuition,
...
work ‘ On the Philosophy of Kant,’ had relieved me
...
is in it a central thought which formi^ a real rest
{^d>im entrenched groxmd on the onward march of
thej4ium£tn intellect. ‘

Biit it u a right sentiment after all, that it is

translatob’s PBEPACB^ xvil
...
Whj a study of Kant’s Critique seemed necessary
at present.
...
afterwards applied with such brilliaiit success to the
study of nature also, should now , receive so little *
favour from the very sciences which first gave
to it. Long before we heard of evolution in .n^f^e,
we read of the dialectical evolution of thousrht. and
...
the human mind, ijuite as much, if not more, than in
...
works of natmre. The one expression, it may be said,
is as mythological as the other, because the ^jategory
of substance cahnot apply to either nature or mind.
...
translatob’s preface. six

Aristotle possible or intelligible without Plato ? Is
Spinoza possible or intelligible without Desqartesl
...
did for giving, in a short compass, the ijpsissima verha
by which each of Kant’s ancestors had made and
marked his place in the history of thought. Professor
Noir6 readily complied with my request, and supplied
...
and gracefulness peculiar to Professor Noird’s German
style could hardly have full justice done to them in
an English rendering, particularly as the constant
introduction of the verha ipsissima of various authors
...
of thinkers which Professor Noird has drawn for us
with the hand of a master, what follows 1 Does it
follow that we should all and on {til points become
Kantians, that we should simply learn his philosophy,
and be thankful that we know now all thair can be
...
(gainst what he himself calls ‘ learning philosophy,’

TRANSLATOR^ PREFACE. xd
...
nised Kant as their spiritual father ^ Even Comte,
...
^ Julius Walter, Zum Gedaclitniss Kant's, p. 27.

* J’ai lu et relu avec un plaisir infini le petit traite de Kant
(Idee zu einer allgeineiucn Geschichte in Aveltbiirgcrlicher Absicht,
1 784) ; il est prodigieux pour ropocpie, ct m6mc, si je Tavais connu
six ou sept ans plus tot, il ni'aurait 6pargne de la peine. Je suis
charme que vous Tayez traduit, il pent tr6s-efficacenient contribuer
a pr^jjarer les esprits a la pb'ilosophie positive. La conception
geiwirale ou au inoiiis la inethode y est encore nietaphysique, inais
les details montrent X cliaque instant Tesprit positif. J’avais tou-
jours regarde Kant non-seulement comme line tres-forte tfete, mnis
comme le metapliysicien le plus rapprocli^ do la philosophic positive.
.... Pour moi, je ue me trouve jusqu'^i present, aprfes cette lecture,
d'autre valeur que cellc d'avoir systematise et arrets la conception
6bauch4c par Kant a mon insu, ce que je dois surtout a I'^ducation
scientifique ; ct mcme le pas le plus positif et le plus distinct que
j'ai fait aprfes lui, me Kemble seulemeiit d’avoir ddcouvert la loi du
passage des idees humaiiies par les trois etats th^ologique, meta-
physique et scientifique, loi qui me semble ^tre la base du travail
dont Kant a conseill^ Texecution. Je rends grace aujourd’hui a
mon d^faut d’erudition ; car si mon travail,»tel qu’il est maintenant,
avait etd precede chez moi par Tetude du traits de Kant, il aurait,

mes propres ycdx, beaucoup perdu dc sa valeur.' See Auguste
Comte, par E. Littr6, Paris, 1864, p. 154; Lettre de Comte k M.
d'Eichthal, 10 D6c. 1824.

TEANSLATOrfS PBEFACE.

1%-, n-

I ventured to point out that, as as I could
judge, amid the varying aspects of his philosophical
writings, Mr. Herbert Spencer also, in what he calls
his Transfigured Eealism, was not very far from
...
philosophy, and I feel boimd therefore to withdraw
my conjecture.
...
they ought at least to be taken iip where they were
...
a sect believes vaguely in an tdtimate triumph of
his faith.’
...
the year 1840,’ writes Pr. Vaihinger, ‘there has
...
sophical theism 'put of the pantheism of greater
thinkers, and, as their antipodes, the Materialists,
who om the new discoveries of natural science
founded the saddest, shallowest, and’emptiest system
of philosophy*.’

* Vaihinger, Zuin JubilUam von Kant’s Kritik der reineu
Vemunft, p. r i.

ijdy TBANSLATOB'S PBBFACB.

ip: ,

In England and America, even more than in Ger-
many, I believe that a sti^dy of Kant holds out the
best hope of a phUosopmcal rejuvenescence. In
...
ceived as possible. And thus it i^s happened that
English philosophy, in spite of the large number
of profound thinkers and brilliant writers vdio have
served in its rahks during the last hundred years,
...
Pfofessor Noird, when he had written for this
...
only as the continuation,. b\it as the fulfilment of
...
appreciate Profes%)r Noird’s accurate and luminous
statements. Leaving therefore the task of tracing
minutelji the intimate relation between Kant and
...
the ideas of the pure imderstanding and of reason
only.
...
had overlooked, thovigh they possess exactly the
...
thought, yet in the end even th</ most complicated
...
Adamson, On the Philosophy of Kant, p. 20S. That Kant knew
Hume’s TreatUia on Human Nature sterns to follow from Haiuann’s
Metahritxk iiber Purimnue der reinen Vemunft, p. 3, note.
...
thoughts. And in that respect no ^stem admits of
...
said, is this really aU that pure reason can achieve, in
...
cerns all men, should go beyond the common im-
...
that in matters wh\ch concern all men without dis-
...
xxviii translatob’s Pi&EFACE.

I hope that the time will come when Kant’s works,
and more particularly his Critique of Pure Eeasoii,
...
ill 1867 (ed. 1880, vol. ii. p. 612 seq.); in'my article On the Origin
of Reason, Contem2)orary Review , February, 1878; my Leetures on
Mr. Darwin’s Philosophy of Language, Fraser^s Magazine, May,
1873 ; also in Professor Noire ’s works, Der Ursirrung der Sjtraclie,
1877; and Max Miller and the Philosophy of Language (Long-
...
principles, has been fully treated in my Ilibbert Lectures, 1878,
pp. 30 seq.

translator’s preface. xxix

remained dormant. ‘ Language,’ Hamaun writes, ‘ is
...
abstraction, the antitheses ylrevSavvfiov yvacrewg ;
...
pression that oif reading Kant, or rather, I should
^ Gildemeister, Hamann’s Leben und SchrifteHj vol. iii. p. 71.

XXX transj^tob’s preface.
...
readers, and though I know how often I have faded
...
and Acoustics have carried us deep into the imier
...
and deny that anJithing can be, for instance, green
or sweet, anywhere but in the perceiving subject.
But the ydea that these physical and physiological
...
xxxii trans^jAtoe’s preface.

aud nerves we should ever catch hold of what we call
the soul, or the I, or the self, need only to he stated to
betray its utter folly. That men like Helmholtz and
Du Bois-Eeymond should find Kant’s metaphysical
platform best adapted for supporting their physical
theories is natural enough. But how can any one
who weighs his words say that the modem physiology
of the senses has in any way supplemented or im-
proved Kant’s theory of knowledge^ ? As well might
...
principles as unchangeable as the/J)ple star. It would
...
^ See Noir^, in Die Gegenwart, June 23, 1881.

* Critique, p. 728 (848).

TEANSLATOtl’s PRSlPACB. . XXxiii

and display more biilliant mental qualities, to show
...
What Gsyi have been more delightful to the un-
...
are, first of all, co^jcepts of the understanding, and,
without these concepts, whatever nature might pre-
sent to u^, nothing would ever be to us a genus or a
species. ■ *
...
before Aristotle forced the terms -yeVos and eWoj' to
...
ance as much as a grandfather an<J| a babe. Eidos or
species, on the contrary, meant appearance or form,
and the first eddos was probably the troop o:^ warriors,
...
the theory of evolution really done for them 1 It has
...
that ceiixiin individuals, however different from each
...
in reidity a more correct general concept, i. e. we are
...
cases we are dealing with facts and with facts onlv.
Let it be established that there is no missing link
between them, or between man and monkey, and
we shall simply hive gained a new concept, as we
should gain a new concept by establishing the
unbrokery continuity of the Apostc^ic succession.
Only let us see clearly that in pljysical and his-
...
subject, written one hundred years ago. ‘ Reason b’
he writes, ‘ prepares the field for the understanding,

‘ 1 st. Through the principle of homogeneousnese of
the manifold as arranged under higher genera ;

‘ andly. Through the principle of the variety of the
...
diversity. We may call these the principles of /tomo-
...
existence of certain national chaifecteristics, founded
on descent, or decided and inherited differences of
families, races,^ etc., while .others insist th^t nature
has made the same provision for all, and that aU
differences ai’e due to accidental environment. But
...
‘ The same applies to the asseiiion or denial of the
...
it must /ilways be easy t9 discover certain similarities
...
sa;^, ‘ we speak of facts. You begin with the general,
...
‘ Essai sur rOrigine des Connaissances humaines,’
writes : ‘ Soit que nous nous (Slevions, pour parler
mdtaphoriquement, jusque dans les cieux, soit que
nous descendions dans les abimcs, nous ne sortons pas
de nous-m^mes ; et ce n’est jamais que notre ponsde
que faous apercevons.’ This was written in 1746.
...
be brought back to the broader gf-ound from which
they naturally arise, and be treated by the light of
true philosophy and the experience gained i^ji former
ages. There is d solid ground formed by the thoughts
...
MIANSIATOE’S PBEFAteE. ' 23EJ:ix.

stilts which seem to lift our modem philosophers
...
Lyell, or Darwin, but wluch invariably fall away
...
a tmnslation. They would as little attempt to study
...
from the philosophical sod left by Loeke and
...
Kant is not a nJon that requires testimonials; we
might as well require testimonials of Plato or
Spino^ But to the ^ English reader it may be
of interest to hear at least a few of the utterances
of the great men whose merit it is to have discovered
Kant, a discovfery that may well be called the dis-
covery of a new world.

xl teanslator’s preface.

What Goethe said of Kant, we have mentioned j
before. Schiller, after having declared that he wm
determined to master Kant’s Critique, and if it were
to cost him the whole of his life, says: ‘TKe funda-
...
bearing of the Critique of Pure Reason. In a letter,
...
blessed revolution than Luther’s Reform. As soon
as one has well comprehended the Critique of Reason,
...
Fichte, no mean philosopher himself, and op many
points the antagonist of Kant, writes : ‘ Kant’s phi-
losophy will in time overshadow the whole human
raoe, and call to life a new, more noble, and more
worthy generation.’

translator’s preface, xli

. Jean Paul Friedrich Richter speaks of Kant ‘not
...
been grg^ted to any other mortal We are enabled
to enjoy this with him, if, initiated.by patient and
serious study, we succeed, while reading the pro-
foundest chaptera of the Critique of Pure Reason,
in forgetting ourselves and thinking really with

;:^© ‘go ©^;^‘ 4 ilpi^ ■ tiurov^; -ftie '-jPil^plj^’
: and, iuore pdrid<nalarl j, ;A;nal<^

l^peaence, enter into iilie deep thought of
:tK« synthetical unity of a{^ we feel as if

Bairactdousl^ and carried away out of tbe
Nh^iny existence in which we are here lost, and
pB if holding in our hands the very elements Out
of which that dream consists.’

If, in conclusion, we look at some of the historians
of modem philosophy, we find Erdmann, though a
follower of Hegel, speaking of Sant as ‘the Atlas
that supports the whole of Grerman philosophy.’
...
together before they vanish again in distant placea
...
human thought which it has npt visited, exploted,
^d colonised.’

In more homely language Profp^or Qaird ex-
ptesses much the same idea of Kant’s p^^osophy,
tirheti b(^fays 120) : ‘So puch has Kant’s ferti|e
idea chM^sd the aspect of the intellectual worl^
that there is not a single problem df pmlosophy that
f *Se died NovembeTi 1881.' ^

iidt Meet ibs with » & it is

f net to ewyv tbtrt

‘ who have not leajiQe<d the* lesson el. ^
the point.

Dn Vaihinger, who has idetoted his life to the
study of Kant, and is now bringing out a coni^
f mentaiy in four volumes on his Critique of Pure
Beason S sums up his estimate in the following
words: ‘The Critique is a work to which, whether
, we look to the grandeur of conception, or the ao^
curacy of thought, or the weight of ideas, or the
power of language, few only can be compared—
possibly Plato’s Bepublic, Aristotle’s Metaphysics,
...
immortel, comme rOrganum de Bacon et le Bisconrs
de la M^thode de Descartes,’ while Professor Noir6,
...
Copernicus, Be revolutionibus orbium coelestium
(1543) ; Beacartes,Meclitationes de ptima

‘ OommQntu zif’Xant's Eritik der reinen Yeraunft, com bun-
dertj&hrig «4 Jubiliiiiin derselb^ herai^gegebe||t von. 1 ^. H. Yair
b^ger. i8i8i. > < %

* Zntn Jubiktum von Kant’s Eritik der teineu 'Yemunft, vok
H. Yaibinger, Siparatabdruck ans der Wochenschriit, ‘Im nedw
Beieh,’ p. 14.

® Bevue des^iU' Mondes, i8}0, Aodt.

W G«schiblite der Kunst des Alter-

Adam Inquiiy into the

nature and causes of the Wealth of Nations {1776),— -
h^he places Kant’s Critique at the head of them all.
...
master-works of human genius by mep of greater
weight than I could ever venture to claim for myself,
I might best answer the kindly meant question ad-
dressed to me by my many friends : * Btd how can
you waste your Ume on a translation of Kant’s Critik
der reinen Vemunft V

On the Text of Kant’s Critique of Pure Season.
...
led me to cmry out at last my lohg-cberished idea of
English translation. That text represents an
historical event. It represents the sl^te of philosophy,
it was thep, it repmsentpr Kant’s
them ai^^the moment of the I greatest A 0Fi|^ in thj^
hii^iy W j^hilosb^^ Even if the later jgditions con-

tained improvement)^ these imprbv^ents would
to a later phase in Kant’s dvm

aiid It is tHis first #cifflve pdntic>i:»» as . taken Kant
against lx>tli Hunie and B^kdey, that moid than
anything else, deserves to be presemd in the lostory
of philosophy. ‘ " ?
...
sceptics and unbdlievers.

So far, and so far only, can I understand the feel-
ing against the Se^nd Edition, which is shared by
some of the most ’accurate and earnest stndents nf
Kant.

But ]y^ave never beeni nble^ to undcarstand the ex^'
wh|ch Sbho^nhauer and others

Ining bmissidns and the

additions in thatf Second Edition. What I cdn under*^
stand and Ihlly agree with ie Jacobi’s opinion, when

i IbW ^ iMr jitfMdi the S<»$pnd

B<p^6ia of;Kaiit’a Ontiqtie suffered % omissioi^ and
jidiismiges v^eiy considerable, and I am veiy anxious by
tbe expression of my opinion to induo^ readers, who
seriously care for philosophy and its history, to com-
pare tbe first edition of the Critique of Pure Eeason
with the second improved edition. ... It is not sufS"
ciently recognised what an advantage it is to study
the systems of great thinkers in their first original
form. I was told by Hamann that the very judidouS
Ch. J. Krause (or Kraus) could never suflidently ex-
press his gratitude for having been made acquainted
with Hmne’s first philosophical work, Treatise on
Human Nature, 1739, where alone he had found the
r^ht point of view for judging the later essays.’

Nor do I differ much from Michelet, in his History
of the later systems of Philosophy in Gemiany (1837,
...
fli^ni;^ra<fictory in Kant’s Critique ceased to b^so when
he ^Camei to xean that work in its first ongu^ form.
Bht everything else that Schopenhauer writes on the
difference between the first and second editions of the
* Jacobi’s Works, toLU. p. 291 (1815).

Gritigue ^ins perfectly intoler^^ Kant, in
the !l^flace to his Second Edition, which was pub-
litiied six years after the first, in 1787, gives n clear
and straightfcjfward ac(»unt of the changes which he
introduced. * My new representation,’ he writes,

‘ changes absolutely nothing vdth regard to my pro-
...
stood. His^eedom of thought, his boldness of speech,
...
which Knnt is supposed to have been frightened, date
firom a later period. Zedlitz, Kant’s friend and pro-
tector, wsis'^ riot replaced by Wollner as minister till
...
death ^ong his papers. ‘It is dishonourable,’ h^
writes, ‘to retract or deny one’s rid conyictidhs,
but silence, in a case like my own, is the duty of a
subject ; and tho^ugh all we say must be true, it is
not our duty to declare publicly all that is true.’

!E^nt meter retracted, he never'eyen dediufed hiin^
/HO lehger responsible for any ohe of tho§e ppitjons
of the Cntique which he omitted in the c^nd
Edition. On the contrary, he asked his readers to
look foi^ them in the^ First Edition, mid only ex*
pressed a regret that there was no longer room for
them in the Second Edition.

Now let ns hear what Schopenhauer says. He
...
despise the opinions and motives of ouir Oontempora-
...
to eiteer their course prudently through the conflicts
of pairi^ andfbpinions \ What is the use ^f grow-

^ 'En la^igueur de resprit, soit dans la politique, soit

dans la science ne se d^ploie daus toute sa plenitude qu'il Tage oil
I'activit^ vitale vient k s'affitiblir/ E. Saisiset, L’Zme et la Tie,
p.6o.

’:v ■; ;a’&; tlilfc

ing cA^ gimter confidence in onr

opini^, and to feel justified in expressing them with
perfect freedom? And^as to 'that firmness which
alone enabl^tei to despise the opinions and motives
...
was only a rSehauffe of Berkeley’s Idealism. This
seemed to Hm to endanger that invaluable and
indispensame originality which every founder of a
system values so highly (see Prolegomena zu jeder
klinftigen Metaphysik, pp. *70, 202 sq.). At the same
...
lo^. Add to this that the great king, the firiend
of light and protector of truth, had just died (1786).
Kant allowed himself to be intimidated by all this,
and had the weakness to do what was ni^orthy
of him. This consists in his having entirely changed
the firsV chapter of the Second Booli^ of the. Tran-
scendental Dialectic (first ed., p. 34,1), leaving out
fifjyHaeven pages, which contained ^ what was in-
dispensable for a clear understanding of the whole
work, and the omission of which, as well as by

VOL. L d

. w in its lim

3i^|i: of ^ntimdioJ(pn& l^eso I pointed out
■ ^ Kwit-^pp. becai^e at that time

(in i8i8) I had never sOeh the F|mt E<Htion, m
/vrluch they are really not' contradictiona, but agree
...
pre&ce to the Second Edition (p. xlii), Kant gives
...
tracted by him. “People might read it in the First
...
^e dishonesty of this plea becomes clear if we com-
pare the Second with the First Edition. There, in
the Second Edition, he has not only left out that
important and beautiful chapter, and inserted imder
...
omitte^, chapter, and defends the very errors which
before he had thoroughly refuted, thus contradicting
the whole of bis own doctrine. This reflation of
idealism is so l^roughly bad, such palpable sophistry,
nay, in part, siibh a confused “galimatias,” that it is
unworthy of a place in his immortal work. Conscious
evidently of its instd£cien(^, Kant has tried to im-

prove it the altei^tioa df one pa^ (see Ptej^iee, |^
p; xx±ix) and by a loi^ and oontl^d not^, Bnh he
forgot to cancel at theiil^e time in^e Second Edition
the numerous passt^es w^ch are in contradiction with
the new note, and in agreement with what he had
cancelled. This applies particularly to the whole of'
the sixth section of the Antinomy of Pure Beason,
...
his manhood and cherished through sdl his lifa Tim
he did in his sixty-fourth year with a carelessness,
which is peculiar to old age quite as much as
timidity^ and he thus surrendered hi* system, not
however openly, but escaping firoz# it through a
back-door, evidently ashamed himself of what he
was doing. By this process the Critique of Pure
Beason has, in its Second Edition, become a sSlf-

d 2

(W Mid coirtipt and is no

Ifon^r genuine.’ 4

; ‘ 1 ?he "wrong inj^li^retatioiilpf Critique of Pure
Beason, for whicfi the succd»ors of Kant, both those
...
ments, introduced into his work byKmit’s own hand.
For who can understand what contradicts itself 1 ’
...
Imrmlessness of his Critique, is equally true, and it
...
scendental Idealism But all this leaves Elant’s
moral character quite imtouched. If ever man lived
the life of a true philosopher, making the smallest
possible concessions to the inevitable vanities of the
world, valuing even the shadowy hope of posthmnous
fame ‘ at no more than its proper worth, but fully
enjoying the true enjoyments of this life, an un-
swerving deprotion to truth, a consciotlsness of
righteousness, Hmd a sense of perfect independence,
that man was Kant. If it is ti;ue that on some

^ See CritiqQ^ P* 330 (3^9)*

* See Critique of Fore Beason, Snpp. XXYIL p. go^-

points which may seem more important to others
t£^ they seemed to himself, he changed his mind^j^
or, as we should .noif say, if ^here was a Eter
development in his phUosophicaf Mews, this would
seem to me simply to impose on every student the
duty, which I have tried to fulfil as a transEtor
also, via. first of all, to gain a dear view of Kant’s
^stem from bis First Edition, and then to learn, both
from the additions and from the omissions of the
Second Edition, on what points Kant thought that
the objections raised against hE theory required a
fuller and dearer statement of his arguments.

The additions of the Second Edition will be found
on pp. 361-512, of the first volume, while th^^
passages omitted in the Second Edition have been
induded throughout -between parentheses.

Critioal Treatment of the Text of Zant’s Critique.

•

The text of Kant’s Critique has of Ete years be-
come the subject of the most minute philological
criticism, and it certainly offers as good a; field
for the exercEe of critical scholarship as any of the
Greek and Eoman classics.

We have, first of all, the text of the First Edition,
full of faulta, arising partly from the imperfect state
of Kant’s manuscript, partly from the carelessness of
the printer. Kant received no proof-sheets, and he
examined the first thirty clean she^, which were
in hE hands when he wrote the preEce, so carelessly
that he . could ‘'detect in them only one essential
mEprint. Then followed the Second! ‘ here and there

(i 787)^ iaVliidi Kant not oiijjr v
anti added considerable passages, but piud
j^me little attention also to the correctness of the
improving the spelling and the stopping, and
...
forther attention to the later editions, published
during his lifetime, the Third Edition in 1790, the
^Fourth in 1 794, the Fifth in 1 799.
i, . At the end of the Fifth Edition of the Critique of
Pure Beason, published in 1 799, there is a long list of
Corrigenda, the authorship of which has exerdsed the
...
bh the work of Bink, or some other amanuensis of
KAnt., Dr. Vaihinger has shown that it is the work
, ,of a Professor Grille, who, in the Philosophische
Anzeig&r, a Supplement to L. H. Jacob’s Annor
Isn der' Philosophie und dea jahiloao^hiachm Qeiatea,

1 795, published a collection of Corrigenda, not only for
Kant’s Critique of Pure Beason, but for several other
of his works also. Another contributor to the same
jommal, Meyer,%hereupon defended Kant’s pi^lisher
(Hartknoch) aga^st the charges of Carelessness, re-
jeded some of Grillo’s corrections, add showed that
> See Eehrbach, Eritik der reinen Yemtuift, p. viU.

£K^med to be 'mispnzits in
pN^oi^tiefi of Kant^s style. It is ibia list of Profsis^
^Uo which, with certaui deductions, has been add^
to the Fifth Edition of the Critique. Some of GriUo’s
corrections have been adopted in the text, while othersj
...
Hartfenstein, in his edition of Kant’s Critique (text
...
Paulsen, Versuch einer Entwickelungsgeschichfe
der Kantischen Erkenntnisslehre, 1875.

Erdmann, B., Kritik der reinen Vemunft (text of
Second Edition), 1878, with a valuable chapter on
the Bevisien of the Text.

Many of the alterations introduced by these critics
affect the wording only of Kant’s Critique, without
materi^ly altering the meaning, and were therefore
of no importance in an English transHtion. It often
happens, however, that the constrSictidn of a whole
sentence depends on a very slight alteration oP|he
text. In Kant’s long sentences, the gender of the

' prononiMi <fcr, Me, (Zcw, are oft® our only guide in
discovering to what substantive these pronouns refer,
while in English, where th^ distinction of gender
...
which has become obsolete. Thus he speaks^ of der
WcLchMhim, der WoMg^allen, der GegentJieil, die Hin-
demm, die Bediirfnm, die VerhdUnm, and he varies
even between die and das Verhcdtniss, die and das
ErJcenntniss, etc., so that even the genders of pro-
...
modem German grammar^ Thus ausser with him
...
my translation deviated so much from tlie teastus
rectus might not be. easily perceived, I have added
the emendations adopted by me, in a note. Those
who wish for frdler information on these poinls, will
have to consult* Dr. Vaihinger^s forthcoming Com-
mentary, which, to judge from a few specimens kindly

* See Erdmaim, p. 637. * See Erdmann, p. l 56 o.

communicated to me by the author, will ^ye the
fullest information on ^e subject.

How important some of the emendations are which
have to be taken into account before an intelligible
translation is possible, jnay be seen from a few
specimens. .
...
denten, as printed in the Second ; while on p. 578
(674), transcendenien may be retained, though cor-
rected into transcendentalen in the Corrigenda of the
Fifth Edition.

On p. 670 (781), the First Edition reads, sind also
keine Privaimeinungen. Hartenstein rightly correct^
this into reine Privaimeinungen, i. e. they axe mere
private opinions.

Page 714 (832), instead of ein jeder Theil, it is
proposed to read kein Theil. This would be neces-
sary if wf^ took vermisst werden kann, in the sense of
can he sjpared, while if we take it in the sense of can
...
kein Drittes, ndmlich reinen Oegenstand hahen. This
gives no sense, because Kant never speaks of a

temen In the list of Corrigenda at

the end of the Fifth Edition, rdnen is changed into
Aetnen, which Hartenstein h^ rightly adopted, while
Bosenkranz retains reinen.
...
from Einige wenige Grundsatze to Konnen dar-
geiidU werden interrupts the drift of Kant’s argu-
...
wenig id irgend ein Grundsatz der reinen Geometrie
' 0/nalytisch.
...
Lingua Frartca of modern philosophy, and so it is,
...
and again before^ they could master it, will hot yield
its secrets at the first time of asking. An Indian
proverb says that it is not always tke faidt of the
pc^t, if a blind man cannot see it, nor is it always the

fault of the profound thinker, if his language is unin-
telli^ble to the busy crowd. I am no defender of
...
essential points, a,nd leave the soliditj of the whole
st^ct^rt^' of his philosophy unimpjdred. No first
perusal \^1 teach us how much of Kant’s Critique
may safely be put aside as problematical, or, at all
events, as not essential. But with every jrear, aqd

l97ith every new perusal, some of these mists and
...
of my edition of the Eig-Veda and its ancient com-
mentary. I feel as if an old Mend, with whom I
...
The two Mends, the Rig-Veda and Kant’s Critique
...
expressed, yet |J1 full of a belief in the real pre-
...
Ideals of Reason — no longer tangible — ^not even
within reach of the undeKtanding — yet real, if any-
...
THE CEITIQUE OF PURE REASON

AS ILLUSTBATEB

BY A SKETCH OP THE DEVELOPMENT
...
salle^, * to count as a mere collection of curiosities,
an assemblage of arbitrary or accident opinions.
Thou^t too is seen to be an hisWical product;
...
not firee from the obscurity and confusion of thought
which flourished under the rule of Hegelianism. For
the ‘History of Philosophy’ and the ‘History of
Knowledge ’ are very far from being identicail. If our
...
of philosophy will be a history of thpse reflections,
and win form only a portion, though an important
one, of the ‘ History of Knowledge,’ and this only so
far as, it satisfies*the true test of value by exercising

^ Die FhiloEophie*Herakleitos des Dunkeb, i. p. xii. ‘

VOL. I. B

ISftRODITCnON.'

a lasting isfluence upon the processes of human
thought. It is however possible to regard the
history of knowledge as the c^ef or sole object of
...
these terms: * All future fhilosofhy muet he a philoso-
phy of language.'
...
arpriorists — are drawn up will be reconciled and meet
...
vellous and incomprehensible faculty distingniahing
mankind, — treason, — towards which no Darwinian has
as yet succeeded in the least degree in establishing
a bridge from out the animal world \

Kant’s Critik der Beinen Vernunfl repi'esents the
greatest revokition which has ever taken place in

’ Instead of this, human reason has been imported into, the
animal world, and the problem, so far fromi beii^ cleared np, has
thus been rendered doubly obscure, ae^ for instance, by Sir J.
Lubbock in his obsemtions on ants.

the iJe^iloiB of epeculatiDn. It hius. often been com-
pared, aajd among others by the author himself, witk
the Copemican system- Not less truly it has beer
likened by Bosenkrauz to the head of Janus in the
...
spective survey of all that has been done in thie
...
natural inteipretation of the universe, is no longer
...
whence eveiything else is to be explained.
...
In order to carty out the programme laid down I
...
mediseval philosophy. For the present it is suffi-
...
pge and can never wholly free themselves from the
...
need only say that there is no tendency of modem
thought which has not its prototype in Greek philo-
sophy, none except that which must be called th^
modem tendency kut e^ox^v — the Ego of Descartes.
...
forecasts to appear in a new fight, so that even when •

DilTRODlTCriGN* 5

the original hue of the streatn remains to testify to
its origin, still in the new current with which it
mingles, it stru^les onw^ds under quite different
...
phecy of what is to be Sjaid hereafter. For, since
...
could not be found to resemble every novelty V
...
it, he and he only is its author and originator®.’

' Prolegomena, Preface.

^ Parerga und Paralipomenay i. 144.
...
lend for ever of all mvstical admixtures, all un-
justifiable pretensions, all Icarus-like fiights towards
...
a rallying-poinfc of union for all genuine and honest
lovers of truth in every science and among every
nation. This is the only worthy return which our
gratitude to this great thinker can biing to celebrate
...
all philosophical enquiry. Whai we think and have
td think, was still the chief matter: the question^
how we think had not yet presented itself. Evep*
the highest achievement of ancient philosophy, the
Platonic Idealism, did not escape these fetters of
objectivily ; the rational soul was conceived to be
...
cartes, of startmg from the knowing subject, and,
...
and. enquire further whether it was a special
Iriw rl of being;' or whether it was identical with
matter; whether, it was a kind of sensibility, oi
whether it was. a part of the general world-soul,
iDhe true path of idealism was still undiscovered.
...
jhut projecting its own nature outwards into the
world of Being.

It may be said then of the philosophy of the an-
...
world is always the most certain and tire most
...
day who cannot emancipate themsel^s from this
...
The first attempt to place the One at the eamsui
of a theory of the tmiveise was made by the Eleatics.
They were iospired by the dim consciousness that
rational knowledge is impelled to strive after oom-
pldeness, duration, and unchangeableness. The op-
poffltion or incompatibility between this desired unity
...
Nofimenon. The latter alone is the really existing, it
...
speoting the difference between real or primary and
senribly perceptible qualities, or between the intuitions
of sense and reason ; we see too the first conscious-
ness of the antinomies which led to the immortal

jmsan? philosofhy. ii

achieveinaitB of Kant\ Herakloitos too was seeking
for a seci:£re and durable principle that should be
...
j[s an eternal Becoming, a state between being and
...
fi:om this fruitful idea is that the nature of substance
...
of infinite division. The arrow in its flight is ^ways in one in-
...
principle of life. This is clear fi’om a passage that
runs, ‘Herakleitos baniphed rest and stability from
...
* An imporiaht application of this principle, with obvious re-
...
* Plut. Plac. Phil. i. 23. ® Adv. Math, vii, 129,

ANCIIENT tTOLOSOPHT. t j
...
truth, according to Heiakleitos, resides in this uni-
versal and divine Logos, by which we become
thinkers {\oyiKol) ourselves. This is indeed still all
...
world without (in the Trepiixov), and our own being is
too far estranged fi:om the world to furnish in iteelf
...
pressed by Herakleitos — in full harmpny with his
...
the view that the whole of life* is a simil^ process
...
an incessant intermixture of the two.’ After aU its
progress^ cbntempioriiry physidlo^ can hardly give
...
(1) That primitive condition of the world is
& state of motion, not of rest.

(2) That the material substratum of all pheno-
m^a is an infinitely subtle substance, out of whiifii

* De Anim. et Besonsct. p. 138, ed. £rab.

ANCSDBSNT PHILOSOPHlr. I 5

> all others are ooiusiituted in forms which pass back

I again into simpHcity.

I (3) That the real objective Being is notiiing bnt
motkm, whatever phenomenal differences may be
thrust upon our ndtice by the senses.

The latter view, which is at the same time the
foundation of contemporary science and the essence
of Eobert Mayer’s theories, is warranted by many
passages from ancient writers, including Aristotle and
Plato, to be genuinely Herakleitean. Thus in the
Thesetetos we read\ ‘ That everything is motion,
...
been reproduced by later writers, — ^napely, that no-
thing really ia, but rather is always beginning to
be or to cease to be, an eternal becoming, a middle

* 156 8 . * De Anim. i. 2.

* Fhys. Auscult. viii. c. 3 ,

i6 * ANCTBNT PmiiOSOPHY.

state between being and not being —then reason
'would be in s6me danger of yielding to the temp-
tation of playing with its own paradoxes, and the
dial^tic trifling and tours de force of the sophists,
...
the neban galley which had been the same since the
...
he maintained, finally, according to Aristotle ^ that
...
the most extreme opinion of the (paerKovrav fjpaKXeirl-
^eiv, or ‘ the professed Herakleitizers.’

However this may be, the extreme insistence upon
change or motion as the sole principle of creation
led necessaril;^ to this kind of exaggeration, and hence

^ Plato, Theatet. 152 E : ’Etc de 8^ (l>opas re Kal Kivri<r€m Ka\ Kpaa‘€m
SKkfjka ylyptrai irdvra A 8^ tpapsp ctrai 'OUK irposayop€vovr€s*

Term p€V yhp ovdcTror ov8cv, dec 8e yiyvrrai, Koi %€pi tovtov 7rdvT€s ol
a6<f)Oi irkriv HappevlAov (vp^tpttrBov^ Upwraydpas re leal *H/xucXe(rof.

* Metaph. iii. c. 5. -

ANCIENT PHILOSOPHT. « i ;

to the spontaneous breaking up of the Herakleiteat
^stem by the absurdity of the consequences deduced
...
kleitos regarded fire as the primaeval being* under-

^ Do* Caelo, ill. i: Oi dc ra flip aXXa irdpTa yivttrBcd rc (ftacrt fcal pfiv,
tlpoi di nayicas ovbiv, li' Ti pivov uTTOfidyeiy, e£ ravra irdvra fitrarrx^'
/iarifco-^ac loiKc&cri ^oiSXcoOai X^yciK cfXXoc rc noKkoi koi

*HpdK\tiTos 6 ^E(f)€a‘ios»

* The passage in Plutarch (De El apud Delph. p. 388) is very
important in reference to this view: Jlvpog r dprafiti^eaQai irdvra Kcd
irvp dirdvrav, &airip xpv<fov xpvf^’^^ ;(/>»7/Aara)v xpvirds, * Everything
...
of the commercial world that 1 do not hesitate to rank this notion
among the most important aper^ transmitted us from the philo-
...
l8 ANCIBNT PHn^SOPHY.

lying all appearances, which produces by its traiuj^
'formations {rpoirat) and its conversions into the op-
posite (evavTiorpoTral) all things and their differences,
including life and thought, so that the life jpf one
thing is_^the death of .anpj^er we should then have
'to "honour in him the first prophet of the monistic
theory of the universe, and the ideal which modem
...
antinomy of maMer. It is absolutely incomprehen-
...
to use more modem language, whence the number
...
accomplished with the rpoiral and evavriorpoiral, the
...
famishes, according to the analogy indicated, the easiest means
...
water.’ Mhx. Tyr., dies. xxv. p. 230. Similarly Plutarch. De El.
ap. Delph. 392 C : nvp6s ddwirot dtpi ytvttns icol depot Bavaxot vdan
yfvetrw-
...
I'oiodifications and conversions of things into their
...
jphenomena of sense.. And if it is asked, after this,
for what reason there" is asshmed to be only one
...
mental essence of all things, and oil the other,
...
20 JLNCIENT EHtLOSOPHT.

in HerakleitpOS much insight into these opposites and
...
correspond to what we should caU at the present day
...
by which aU later generations were dominated, that
...
taken by the same thing I How many oenturi^S(
...
psychological problems, from the days of Aristotle down to modem
...
essmtia over and above the others, with which the ingenuity of the
ahatractewrs de quintessence might have free scope !
...
sary to name the chemical theories of Qraham, and the latest con-
tributions of Crookes and Norman Lockyer. It should also be
remembered tliat Schopenhauer and £obert IVfay^r, so long ignored
...
tically together, a vws which continuously ordered
...
icdiatter Neither Sokrates nor Aristotle, it is true,
were edified ^ith the way in which Anaxagoras made
use of his vws or intelligent principle. The latter
ob^rves : ‘ He uses it only like a machine ; tvhen he

^ Parei^ nnd Faralipomena, i. p. 38. ^
...
to his voOs^’ That comciomnesa plays a considerable
jpart in all natural change or growth is an un-^
<juestionable truth involved in this idea, but fatal
errors were introduced by assimilating this man^
...
important it wiis to recognise, with Empedokl^
...
to the Sokratic school to develops this aspect of the
...
its main features, still obtains aniong the students of
...
rmtrustworthiness of our sense-perceptions, Deinp-
kritos fully concurred with him, sa^ng our senses
deceive us as they suggest to us the presence of
different qualities in things. In truth nothing exr
ists e^icept atohis moving in vacancy. Sweetness

» Metaplk. L 3; p. 985. ' * Parerg. i. p. 38.

> ■ S' ■

24, AMCIBa^T PHILOSOPHY.

and hardness, heat, colour and the like, are only
sen^ble appearances, — in reality all this is merely
% Variously ordered assemblage of atoms ^ the move-
• liientS of which are rendered possible by the void
...
mA Lucretius — who continued and carried out the
i^Ime. Here for the first time the demands of the
reason, are satisfied with a more or leSs^ qimntitative
difieierices take the place of the varied; uncertain,
...
and the modus oj^erandi of the atoms may appear
...
r^ube all the multiplicity of phenomena to the
mibtion of the minutest parts.

Before dealing with the importance of the Demo-
kntean doctrine, and its place in the great process
of the evolutionary struggles of reason towards self-
knpwledge, I will just point to the opposition be-
en it and the view of Herakleitos. The two men

jffup -yXvicv feal 7nKp6vy v6fitp Otpp&Vy v6ptp i^vxp^v, v6p(p XP^iri' Irerj

Ic SrpiM Kal K€v 6 p, ibri^ vopl((Tai pkv dual Ka\ do^d^erai ra olirBrjTd, ovk

^ra raC^, ra dropa povov Ka\ t 6 Ktvdv, Sext. Empir.

adv. Math. vii. 135. ; These words contain the program!|tj^^ the
future views and conclusions of Locke, Leibniz* and Bobeii
The metaphysical truth underlying them, however, forms the; miD-
stauce of the immortal work of Kant. ^

ANCIENT PHILOITOPHY.

were often named together in antiquity and that
in opposition to each other, and there mdy be a
deeper reason for this, which the foolish anecdotes
about the laughing and the weeping philosopher
only serve to disguise. The root of this antageuism
must naturally be sought in the fundamental piiU'-
...
sidered as their principal business to discover heii|^
under the veil of appearance, or to distinguish be-
tween phenomena and nohmena, or, in other words,
to discover by the aid of reason the veritable being
(to ovTwg op). We have therefore to enquire what,
according to each of these philosophers, was mere
appearance, bom of the senses, and what was real
...
For, as already observed, the substance of Hora-.i
kleitos accomplishes all its transformations without
any place being allotted to the Why? not’ tW
questioning after a causa prima such as is for ev<^
inaccessible to human reason, — for thisfc^ just what
the Hemkleitean substance with its v^teraal .flux
, presenls^'^a 'with, — but rather the wherefore of se-
par9t0 phenomena, the ground of their existence,
and- of-the connection subsisting between them. It

26 ANCIENT PHILOSOPHT.

will appear later on^ after the Kantian doctrine has
ih^e its revelations, how much of metaphysical
truth nevertheless imderlies the doctrine of Hera-
...
says Herakleitos, * the one which embraces aU things,
...
appearance or experience into the world of a j^iori or
...
: tiot proceed from and cannot pass away into nothing.

‘ This sayings’ observes Lange \ ‘ which in principle

^ Clem. Alex. Strom. Y, c. 14, p. 7 1 1 Pott : IL&vimv rdv ovr&v
r»v o(^€ rc( B€Siv^ oSrt dvOpimmv nroti^frcv. aXX* Kid larof irvp acifcdor,
iarrdpjtvov furpa xol diroa^wvpMVov ptitpa*

* Gteschichte des lllaterialismus, i. 12*

ANCIENT PHILOSOPHS*.

^1

contains the two chief doctrines of modem physics —
...
And this perhaps is tme ; but wherever men have
...
nihil sequUur ; there can be no science of particulars.
...
by him. It was Bacon who, after a Jong period of
...
flS ANCIENT t>HILOSQiPHT,

that Eobert Mayer, at the time when he was medi-
tating on his great and fruitful principle, used in
conversation, according to BUmelin> to repeat again
and again: Ex nihilo nihil fit. Nihil fit ad ni-
hUum.

We might therefore, it seems, call Herakleitos the
father of the a j^ori philosophy and Demokritos of
...
inner principles of coherence. Two things were abr
solutely necessary for this result : (i) the sensible, dis- ^
Crete, particular had to be taken for the starting-
point, and this alone oould be defined and fixed by
means oi nunA&r, or the mathematical conception.

ANjprjai^ i'Bmi)so.p^ 29

» which raises them into the firm position of the exact
I sciences; (2) the causal connection of phenomena
Jhad to be recognised as invariable and unbroken:
(‘Nothing happens without a cause, hut everything
[with a cause and by necessity/

The atomic theory proceeded from the first re-
quirement, and though modem science forms a very
different conception of the atoms from that of Demp-
kiitos, still all exact study of nature points to some-
...
in its original form must not be overlooked. Denio-
...
^liich act only by way of impact and pressure. Des-
...
available for thb explanation of the phenomenal
world. Yet ancient materialism did not rise to a

30

^stinct recognition and formulaxisation of this truth;
still less had it attained to the application of mathe*
matics to the interpretatioft of experimental science.
Mathematics were still too immature, and the cirdei^
...
It will he sufficient here to refer to the Pythago-
...
the flnal and decisive part in all things, and that the
...
differences are to be reduced at last iiito pure relations
of number, so that the whole universe, at least on its

outer side, presents Itself is a malhematico-mechanical
problem. We know too little of Pythagoras and the
soufbes on which he drew for his inspiration. But
howover much he may have owed to Egyp t, we can-
not too much admire tho profound originality of the
man who forestalled the ripest conclusions of modem
...
we are told ; ‘ Not hy number, but according to
number, Pythagoras maintained all things to have
been originated And Aristotle says : ‘ The Pytha-
goreans maintain that things exist only by a kind of
imitation of the relations of number V In other
...
^ Stob. Eel. i. p. 302 : Ilv6ay6pas ovK apiSfiov, Korh apiBphp
cXry€ irdvra yiyv€(r6at»

* Metaph. i. 6 : Mi/i^crct ra Spra (l>a<r\v tlvai rwv dpiOp^p.

* Ibid. i. 5 • e2m ripf ov-
...
same method, matiired and perfected in later genera-
...
the famous dictum of Plato, ayecofieTpiiTOS ela-lrw,

as well as from many other passages, among which
the following is especially instructive, as it complains
of the neglect of this science among the ITollencs and
...
invented for the use of children, which they leain as
...
philosophy of the Pythagoreans Wordd have entered
...
^ As quoted by Cicero, Quaest. ^cad. ii. 39.

* Plutarch, De Flacitis Philos, iii. 13.
...
antiquity, had it not been for tlie reaction which
...
The more or less avowed liostility against Aristotle
...
phice in the sciences of organic life founded by him, and
more especially the dialectical trifling and reasoning
from ready-made formal propositions, the importation
of logical mental processes into the sober obseiwation
of sensible perceptions in the j)hcnomcnal world — all
this was in direqfe' Contradiction to the strictness of
scientific method. The salient point of the stand-
ing controversy is indicated in the following pas-
sage of a distinguished .anti-Aristotelian, \vho was
able, nevertheless, to admire the intellectual great-
ness of his adversaiy ^ : —

‘In the old world the greatest and most merito-
rious student of nature would resort to utterances like

‘ Lange, Gescliichte <les JEaterialismus, i. ig,

® Bxibert Mayer, Die Mechanik der Warmc, p. 247.
...
this to explain, e. g. the properties of the lover : the
...
the 1‘evolving line, as he called the circle, had investi-
gated the numerical proportion between the length of
the lever and the pressure exorcised, ho would have
become the founder of an important branch of human
knowledge. . . . Tlie rule which should have been
followed in order to lav the foundations of natural
knowledge in the shortest conceivable s]iace of time
may be briefly stated. The most obvious and fre-
quent of natural phenomena should have been sub-
jected, by the help of tlie senses, to a careful
investigation, which should have been continued
until tlie chief conditions, which may be expressed
in numbers, hud been elicited.’ ‘ These numbers
are the sought-for foundation of an exact study of
nature.’

Tlie influence of Sokrates is generally represented
as an energetic reaction against the doctrine and
practice of the Sophists. The Creek Sophists bear a
striking family likeness to the French revolutionary

thinkers of the last centurv. The vital characteristic

•/

of both is a kind of intoxicated self-exaltation of
intelligent reason, possessed with an overweening
sense . of its own superiority as it casts olf the
...
The threatening datiger roused among the Greeks,
...
on the contrary, that the practical qtiestion as to
what men should do or leave undone may be ascer-
tained with certainty, and this by themselves witlmut
further tlieoretical preparation. It was the fate of
...
metaphysics, introduced entirely dognuitic systems of
their own ; and further, tliat notwithstanding the
great divergence of their several systenjs, all pro-
...
and irremovable basis for mond action and all the
higher possessions of mankind, tlie existence of which
...
occupied himself j)rinci])ally witli definitions of mond
ideas, and what lie meant by the often re^ieated
assertion that virtue was knowledge.

This may be seen also from ])articular ilhistrations.
The oj iposition to the doctrine of strict natural neces-
sity of an established external causal chain, appears
most clearly in the well-known passage ’ in which
Sokrates speaks of Anaxagoras, who first made the
modest attempt to introduce a rational principle, the
yoOs, as an explanation of the nature of the world ;
...
wliicli had led him to reject the means of flight and
await his destiny where he was ,

The incompleteness of materialism, or tlie expla-
...
motion, there is no reason why the same effect sliould
not be ascribed to the larger and coarser parts.’ But
this, as he expressly insists, does not constitute the
essential nature of the soul, nay cannot so much as bo
...
’ The same thought has been expressed l>y Leibniz wliore he
says one might explain Cjesar’a crossing the Kubicon by the laws
of mechanics, contraction of muscles, ifec., whereas to the true un-
derstanding of Caesar's step, the whole history of Home, psycho-
logical insight into the remarkable personality of the consul, and
mucli else, were indispensable.
...
tains tliat Aristotle failed to understand the greatness
of Demokritos, which consisted precisely in the
rigorous logic with wliich he brought all actions back
...
^ Aiist. do Aniina, cap. 5.

* Geschiclite dcs Muterialismus; i. p. 20.
...
jean only be understood, or indeed exist, with the
...
to bo inseparable from speculative theology, of which
...
his illustrations indiscriminately together. lie then
...
of organic nature. Aristotle contrasts very fixvourably
...
it does not occur to liim to look at the world with a
view to deciding whether it is a bit of machinery or
no. But after honest and diligent study of nature,

5 lie discovers that she works everywhere towards
'^ some purpose, and he concludes, “ Nature does no-
thing in vain h” And agxiin in the book.s De Partibus
Anirnaliura, which are his comparative anatomy :

“ Nature does all things for some purpose or other, t
...
from tliis that there is something of the kind that
...
which is just what Bacon, in his jirejudice, selects for
...
influence of inherited opinions, by no means equidly
at natuml theology, nor at the an thropo- teleology
...
All tills Aristotle was able to accomplisli : he
...
Laime savs : ‘We find in Demokritos no trace of
that false teleology which may be called the arch
enemy of natural science ; but we also find no
attempt to exjilain the development of design hy the
blind sway of natural necessity {!!). We know that
tins last fundamental proposition, common to all
...
adaptation alxiund, because in the nature of things it
hafipens that what serves its ptoyose is preserved,
and what fails to do so perishes at once.’

What a chaos, a medley of opposite and irrecon-
cilable conceptions M And yet the fallacy here iu-

’ Still plainer and more startling is the following passage
{loc. cit. i. 2) about the nuitcriulisiu of tlie Stoic.s : ‘ Tliat

sounds sufficiently materialistic, and yet the decisive feature is
wanting to tliis materialism — the pure material nature of matter ;
the origination of all phenomena, including adaptatiim and intel-
ligence, by the motim of matter in accordance vdth universal laws'

42 ANCIENT PHILOSOPHY.

volved is no other than the veiY programme of the
majority of contemporary Darwinians : ‘ To explain
everything without exception by exclusively me-
chanical causes.’

While Aiistotle had most to sav about Demo-
kritos, we find in Plato frequent j)oint8 of connection
...
the true source of all knowledge, roused Ids greatest
...
Let us invert the terras — the origination of the motions of matter,
including weight and all inorganic movements, by intelligent prin-
ciples in accordance with the universal lav. s of thought, — and the
...
there would never be any knowledge at all b And
...
blance, as we maintain now, to the cuirent of motion.’

We see from this passage, which also contains tlie
...
‘ Und was in schwankender Erscheinung scliwekt,
Eefestiget niit daucriiden Gedaiikcn/

Keason and its conceptions constitute the firm
starting-point of true knowledge in the wliirlpool
of the phenomenal -world, sensible imprcissions, and
vicissitudes. Ami this great truth is of such sig-
nificance that its discovery may also bo said to have
opened the way for the first time to self-examination
and self-knowledge.

Eeason, or the rational principle (to votiriKoi'), is
...
these ideas and the phenomenal woi ld of sense and
matter. For as to the latter Plato held the Hcra-
...
was to be thoroughly ^tablished by Kant. ‘If time and sj)ace
...
doctrine and materialism first presents itself. TOf
...
wishes to hike the spiritual sale of things into
accomit. It explains the latter, like everything else,
...
nature, imprisoned in the ciicle of materialism.
'I'll is opinion is the more probable because the organs
...
other bodily instruments, whUe he shows with vic-
torious cogency the necessity of an intellectual prin-
ciple, which combines, compares, and distinguishes
the common element in aU perceptions, and so

ANCIENT PHILOSOPHY.

45

penetrates to the essential qualities of things, ‘ For,’
...
which they are the instruments, wliether you term
this soul or not, with which througli these we per-
ceive ol'jects of sense h’ Sound and colour, taste and
smell aie different things, but by what power or
...
bcing, likeness and unlikeness, sameness and differ-
ence, unity and other numbers, etc, Theastetos is
comiaelled to reply that there is no separate organ
for these things, but ‘the soul perceives the uni-
versaJs of fdl things by herself'*.’ Tlie soul perceives
equally by the touch tlio hardness of that which is
...
reach the soul through the body are given at l)irth
...
w’ho misses the truth of anything can have no know-
ledge of that thing; therefore knowledge does not
consist in impressions of sense, but in reasoning
about them, and the two are not identical

Starting from this newly-won point of vantage,

’ Thesutetus (Jowett’s translation), 184. ^ Ib. 185. “ Ib. 186.

46

ANCIENT PHILOSOPHY,

whicTi Leibniz and Kant were to take as starting-
...
The first gi’eat truth for which we are indebted to i
him is that, in order to direct human knowledge to i
its proper goal in the interpretation of the true :
nature of things, wc must start from knowledge
itself, from the peculiar gift of reason whicli has
...
possessed tliemselves. The student’s gaze is turned
inwards : —

‘Es ist iiicLt tlrausFon, da siicht es dcr Tlior,

Es ist ill dir, du briiigst cs ewig liorvor/
...
This is tlie positive side. Oti tlie negative side
...
the Avholc ancient world. Philosophy is striving after
...
not persuade the Giants and Gods wlio were fighting
about the nature of essence b and w'no ‘ contended that
...
j on his side when he maintained that justice, reason,
i virtue, etc. are not material entities, and that the
'j^soul to which these qualities belong must therefore
‘ also be iinmateriid. But it is one thing for the soul
to exist and another for it to be self-existent, and the
problem had to wait till Kant came to give it its
due form. Plato exiilted the soul into a self-sub-
sisting subject of pure thought, free from all de-
lusions of sense. He maintained its immortality, and
anticipated tliat after death, when released from the
: obscuration and fetters of a material body, it would
; know with far more perfect knowledge the true nature
1 of things. This is set out more at length in the
Phmdo (lo) and Timajos. The summary of his expo-
sition in the latter dialogue is given by Sextus Em-
piricus in these words: Tt is an old adage, accepted
j too by the physicists, that like can only be explained
if by like. Plato has used this argument in tlie Tiraoeos
}■ to prove that the soul is immaterial. Liglit, he
j says, which perceives light, is of the nature of light,
I hearing which catches the vibrations of the air must
I correspond to the nature of air, and similarly the
5 sense of smell by which vapours are perceived must
Vbe vaporous, and the sense of taste which receives
; fluidity must partake of the nature of fluids. And
i the soul too, which conceives things immaterial, such
as the number and limitations within Avliich bodies
: are contained, must itself be immaterial The
passage is interesting because the reference liere is
only to the j)uro forms of mathematics, which Kant

’ Adv. Math. vii. ii6, rip. (Sec also Schopenhauer’s Parerga,
i. 48-)
...
Tlie second groat truth is that thought is accom-
plished by means of conceptions and ideas, and that
these always contain or represent something uni-
versal, difierent both from material things and from
sensible perceptions ; that these abstract, general
ideas are the true object of rational tliought or in-
...
time, remaining as an apjde of discord throughout
the liistory of medireval philosophy. It was received
...
of the origin and development of the liuinan reason
...
wliicli otherwise can hardly be overjjraised, is due
to the ontological ambition which here again over-
reaches itself by transfonning these ideas into real,
...
distinction to appearance, to phenomenal He saw.
the material world with the correlated sensible per- ,
ceptions in eterind. flux and change, he felt that the
...
veil, while truth and reality were attributed only t
...
the same ; that, on the other hand, which is conceived i
by opinion with the help of sensation and without ;
reason, is in a process of becoming and perishing, '
but never really is'.’ Tbe ideas are the eternal
...
on, 01’, to express it in the more drastic language
of Schopenhauer, the ardent adherent of the d(X3trine '
of ideas, ‘ It is tlie same cat that plays in your yard i
to-day as played and felt and was 4000 years ago.’
The ideas arc the prototypes of things, disgiiised ,
and obscured by matter in the plienomenal world,
which stfiiids with Plato for the manifold, the uncon- '
ditioned, indefinite, fluctuating, the relative, or in ;
fact for the not-being. Even the soul imprisoned in i
...
knowledge is recollection. Tlxe soul, in its purity,
luminous and immaterial, dwelling in a former state ;
of existence with the eternal gods, has beheld in ^
direct vision these ideas or prototypes of thing.s, the |
...
truths necessarily presupposed, which the ciitical
...
prehensive. To claim all ideas, that Is to say, eveiy-
! thing which human language designates by a word,
everything that presents itself as a distinct being in
tlie phenomenal world, wluither it be hairs, dust and
dirt, or tables and chairs and benches, as an a jiriori
possession of the soul, and to foist it upon the ever-
lasting gods, is tantamount to reducing the whole
of philosojdiy to a matter of religious faith ; whereas
its chief aim has always been to attain iude];>endent
existence, and knowledge in the strength of its own
nature, I’o avoid mistakes and misjudgments we
...
sometliing which has a real existence. That matter

ANCIENT PHILOSOPHY. 5 1

opposes itself to the formative power of ideas, tliat it
is tliat wherein the maker of the world reproduces
...
which is easily accounted for by the j)redominance
of the old ontological phantom at this as well as at
every other stage in the history of ancient jjhilo-
sophy.

This difficulty is brought out by Parmenides in
the Dialogue^ when Sokrates makes a cautioiis at-
...
when Sokrates suggests that the ide<as might be the
patterns existing in the realm of being, and single
things only copies of them, Parmenides rej)lies, with
...
idea therefore must presuppose another and tlicn
another, in an infinite series. And he concludes his
objections by admonishing Sokrates: ‘As yet you
understand a smy.ll part of the difficulty which is
...
The limits witliin which logical idealism is con-
...
Ithe phenomenal or the objective world. The only
ltdtcrnatives are, either —
...
ancient pljilosophy as ontological as he found it ;
...
cognise as the gi’eatcst representative in the old
...
inefifective and motionless, how there could be no
...
thought must proceed from the particular substiince,
the ToSe Ti, as to which a general statement must be
made. The real being is that which is and can be
subject only, never predicate.

At the same time Aristotle is far from acquie-scing
in the disintegration of the w’orld according to Demo-
kritos, and seeking for explanation among the phe-
nomena alone. He is a w’orthy follower of Sokrates,
and knows that we must begin with reason and its
functions, with general truths and principles. He
demands a prima iMlosoyhia whence eveiything else
is to be derived by the mind, but which must serve
first as a base for the conception of natuic and its
...
Df knowledge. He says, in agreement with his great
master, ’A.p^^ Ka't reXos yowyk
...
of reason, but the latter has only ^oientia, a dis-
...
of Plato, Aristotle ascribes ^ separate existence, im-
...
from the body. And Schopenhauer ^ says with truth,
...
i founder of the inductive method, which starting from
ithe given particulars proceeds by abstraction to the
• universal and regular. He allowed the rights of
f reason, but demanded also due regard for the actual
...
Kant in a rich grijwtli of philosophic clearness. This
...
{(TvvoXov). national knowledge apprehends pure form, ■
...
of matter to the dignity of self-existence’ (or false
...
as an intellectus ecty^us, the latter as an iniellectus
archetyfus.

With the realisation of the mind and its forms on
the one hand, and of matter with its forms on the
other, the philosopliy of antiquity had reached its
utmost accomplishment. Plato and Aristotle are the
electiic poles which gave this direction to the current
...
Pour elements present themselves as the ultimate
elements of being, and must be opposed or reconciled
tis realities. As it has been the tendency of philoso-
...
^ The effect of this eiTor meets us jarringly in the doctrine of the
Stoics. Real existence is always material, and therefore, God,
the soul, the virtues, the affections, in a word all ideas, must he
material.

ANCIENT PHILOSOPHY. 57

and modem philosophy and the progress from one
to the other.
...
We shall sec how Descartes consciously approached
the task of eliminating the subordinate members
Ab and Bb, and disputing their self-subsistence.
There remained then the two chief opjiosites, which
...
tion must necessarily have led to these groat results
...
book of Lucretius’ didactic poorn, is an honourable
exception to this ride. But as Ids explanation of the
origin of language is throughout materialistic and
seusualistic, Avliile the nature of the reason was not
recognised as an object of investigation, no further
progress wius made beyond this feeble, though me-
ritorious beginning.

The profound study of more extensive linguistic .
material and the important results which comjiarative
pliilology has placed at the service of the philosophy !
ol language enable us to affirm that human reason
came into existence wUh and hy language. General
...
aU roa.son has sprung is the common activity of men
and the creations due thereto. In proportion as the
latter care multiplied, light is thrown upon the two
dark regions, the inner consciousness of man, and the
hitherto uncontprehended outer world which is acces-
sible to impulses of sense alone.

The sensitive, conscious subject is necessarily pre-
sujiposed in all knowledge, but for a length of time
...
But what first made Keason possible ? The action
...
between two otlierwise separate and mutually unin-
telligible worlds, tbe worlds of feeling and of matter.
Tins boundary is tlie proper domain of reason and of
tbe spiritual formative will ; what is formed reappears
in consciousness as perception, but as something well
known, familiar, and intelligible. This is the origin
of the human fiiculty of representation or imagina-
tion, which grows along with reason, strengthens it,
and continues uninteiTuptedly to act, and to be acted
upon by it, so that some eminent thinkers (e. g.
Berkeley and Hume) have taken both to be iden-
tical, and have held all concejytions to be the same
as intuitions or ‘ideas,’ in the sense in which the
word is used by Locke, i. e. mental rcjjresentations
of existing objects.

Tlie formative activity of mankind had to pass
through its period of tlevelopment, of slow and con-
tinuous j)rogress towards perfection. And this was
only possible by the help of language. Langaiage is
...
aTithority of the human Avill, it is at the present day
an instrument upon whose keys (i. e. words) the
human mind inlays with marvellous skill so as to
bring out enchanting harmonies. This power, Avhieh
now seems to call for such astonished iidmiration,
...
germs or roots whence all human speech htis been
regularly developed, notwithstanding all differences
of sound.

This is the origin of words, and it is id the same
...
words, and the community lives a common S 2 )iritual
life, ffdie same cajiacity is developed and educated
in the younger generation, and the life of the com-
munity continues on from millennium to millennium,
with heightened and ])erfectcd intellectual vitality.
...
acconqtlishcd.’ What is the lasting, inalienable ptjs-
scssion of this s;une reason 1 Surely that which it
can ever form and produce again and agjiin at will,
its own creations, whereby' the contemplative faculties
too are constituted, so that the mind learns ffraduallv
to conceive the remaining objects of tlie outei' world
also in their a])propriate forms and to designate them
ly names. 'I’he very word chosen by Plato points
to this origin of his doctrine of ideas.

That which Plato adds to his doctiine as an appen-
dix, oi' as something merely incidental — namely that
human manul'actures too, such as tables or beds, are
formed in acc(jrdancc with eternal ideas — aj)pears to
us as undoul)tedly, what it was unconsciously with
him, the starting-point of his theory of the universe.
This ai)pears too from the expr(\ssion which he often
makes use of as the equivalent of ideas, patterns

ANCIENT PHILOSOPHY, 6 1

{■wapaMjixaTa^), after wliich the actual beds and tables
are supposed to be made ; and again from what he says
of the relations between matter and ideas, showing
liow the earj)enter and the smith must be able respect-
ively to put their idea of a shuttle or an awl into the
iron or Avood and so realise it^. The iron and the wood,
i. e. the material, are of little consequence, the idea
is tlie principal thing.

Thus for Plato, as for the human reason itself in
its infancy, the world of human labour furnisbed tlie
key which was to interpret the mysteries of the
world to human reason.

We can now understand the connection Avith the

universalia ante rem, and tb(^ recollection of a former

state of existence. If Ave start, as Plato does, from

reason as an idtimato as an original property

of the iiuman soul admitting of no further explanation,

it follows necessarily that the smith produces his arvl

and the carpenter Ids shuttle in accordance with the

idea that is present to Ids reason. But the (|uestion

remains hoAV the men of to-dav liave become familiar

with these ideas ; how it comes that they are noAV

re.ally creative so that countless objects are formed in

accordance with tliem % Ccrtainlv only because in

%/ •'

the dim remotest past, the thing itself and the idea
of it Avere formed at once by our ancestors, or rather
developed out of some still earlier creation. This
being, Avhen first created and first thought, passes by
tradition into the thought and action of unnumbered

’ ParnicnidcR, 132 (Jowett’s Translation). ‘The more prol)iil»l(i
view ol* tliose itlpas is that they arc patterns fixe<l in mil lire, and
that other things are like them and rcsenihlancos of them ; and tlnit
...
.generations, and is tliere constantly rencAved, and in
Uact does only become present to the mind of indi-
• viduals through a reminiscence of the former condition
of the race. In the same Avay the present generation
knows famillar’ly all the classes or oi’ders of natural
beings, because from ancient times the image of them
has been imprinted on the mind and thoughts in this
particular manner and under these ]>articular foi*ms.
Language has wrought tins miracle: tills much is
certain, and at the piesent day there is little diffi-
culty in recognising tlui f:ict. ]>ut wo must concede
to Plato that this would haA^e been impossible witli-

out reminiscence, and this is exact! v the chief and
' •/

most fruitful miracle, that the thought and feeling of
I’onuitest ages, borne along’, as upon :i stream, by
language, should make its presence felt, on and on
in every member of an ever-growing, ever- new
Inimaiiity.

Aristotle too shows clearly in all the fcaturi'S of
his docti’ine the irnjiress Avliich the origin of reason
has stamped upon its whole later develofiment.

As he dilfeis from Plato in iemo\ ing the centre of
gi'avity, of being and knowhjdge, more t<.»Avards the
oltjective or actual world, we should expect him to
seek his princijiles also on the objective side of the
boundary we have indicati'd. Ami this is in fact the
ease, lie gives the name of Matter to the unknowui
SomeAvliat, lying in that direction, to which he as-
cribes al«(.>lute being. 'J’lu! name itself bcsirs on its
forehead the tok(,‘ns of its origiu. "YAv or materia is
the ti]nber out of Avhich human activity pre|»ares the
most various obj<>ct.s and implements. Generalised the
wmrd comes to mean the raw material which is the
necessarv substratum of all that is* done or wroufflit.
That w'hich Imman intelligence lends to this material
...
modified by human energy ; hy some force to us un-
known, it is itself always active and creative of new
objects and new effects, which forthwith distinguish
themselves in form. This matter, whicli is imperish-
able througli all the changes of its form, a})j)ears
pro|)crly as a substaucej, though the active, ci'eative,
and foi’mative eh'ment is the world-spirit, the Deity.
And here wo come to the explanation of the uni-
versalia rem. Human knowledge has first to dis-
cover these forms in nature, and to make them its
owm by ex])erience, which becomes possible through
reason ; for feeling is the form of what is felt, but
the reason is the form of the forms. Fc)!' the rest, it
may be observed that our tiieory of the origin of
reason goes as far to justify the view’s of Aristotle as
those of Plato ; for although the creatioiis (d‘ man-
kind indeed jiroceeded from oltscure impulses of the
will, they only grew into thoughts and couc(.'];»tions
by the sensible perception and contemplation of what
was created. Idiev were thus in the bciiinuing more
Xmt rem, and afterw'ards more frcrpiently anfo rem.
Ill many jiassages of Aristotle we si?e clearly how the
true germs of his fundamental principle lay in this
unconsciousness of the origin of human reason and
the 2 iro 2 >erties which it has derived from its origin.
Thus es2^ecially in the famous 2>iLssage ' : ‘ But th<j
Soul may be com 2 :)ared to the hand, for tlie hand is
the tool of tools, as the mind is the form of forms.’
'riicre is a 2)i‘ofound reason for this 2Jf>:rallel between
the hand which sha2^es all things and the mind which
comiirehends all forms. ‘All things that Ijccome,’ he
’ De Anima, iii. 8.
...
says in another place, ‘must become somctluTjg as
something out of sometliing h’ This is just the
scheme of liuman action. But the form is the
essentia] part of the thing, as he says : ‘ The nature
without the matter is Avhat I call the essence of a
thing-.’

It has still to be observed that Aristotle, as he
combined logic and a theory of knowledge with the
explanation from natuial causes, reconciled a greater
number of principles than Plato, who never passed
beyond the sphere of rational thought. His classifi-
cation of causes under four categoi’ios, which I'ears a
remote resemblance to Schopenhauer’s ‘ Fourfold
Boot,’ is a case in j)oint. They are, matter, motion,
form, and purpose ; but hc-re too the a priori form of
Inunau action is unmistakable. As form is the
essential ptunt, it becomes the aim of action, and in
so far it precedes as (imagined) cause the real effective
action (or ihotive cause). I have expressed my
agreement with Schopenhauer in reckoning it among
Aristotle’s chi(‘t‘ merits tltat he introduced the con-
ception of design into the pliilosophy of nature. It
is self-evident that here also human action could oidy
serve as a type and lantern. He observes, with the
obvious intention of explaining one by the other, ‘ If
architecture were in the Avood itself, it would then
work as naturt; does.’

It still remains to note the false a priori track
into which Aristotle was beguiled by his point of
depai tui'c. Because the idea of matter had presented
...
Log. cit., Aeyo) 6’ ova-iav avev vXrjs to rt elvai.
...
contradictions and confusion of tbougbt. The ques-
...
rather, he was obliged to have recourse to a deua
ex madiina, when he assumed the existence, beyond
• the stairy spheres, of God as the j^irinms motor, tlie
vpoyrov Ktvovv aKli/t]Tov, that maintained all things in
eternal motion. We shall see how this funda-
mental error of a sclf-subsi sting quality-less matter
weighed upon Descartes ami his successors until
Leibniz at last throw daylight on the point, by
showing that the true essence of matter lay in
action or force.

We have seen how the two greatest pliilosopliers
of antiqtiity had sounded the problem of metaphysics
to a. certain depth, though they were still far from the
really final question, considering that one assumed
those functions of the reason which a^lmit of histo-
rical explanation to be ultimate truths, while the
other believed himself to have attained the source of
all reality and its tliinkableness by tlm realisation or
...
Much laborious eflbri remained before a mortal could
...
dai'e to boast of having penetrated to the very sanc-
tuary and to ask the decisive questions : —

What is the last inalienable and unquestionable
possession of reason ?

And why does it necessarily think in tins wise, i.e.
^vith the fundamental conceptions of matter and.
form ?

And can we after all over learn anything respect-
ing being itself"? Ai'e we not rather confined within
the bounds of the original forms of reason, and
doomed never to escape from them ^

MEDIyEVAL PHILOSOPHY.

Ev opx5 5*^ ^ A 070? icat ^€Off ijj/ 6 Xoyoff' iruvra 81 avrov cycVero, Kal
XCJpLi' avTOv eyevfTO ovde ej/. Ev. JOJC. L I.

Thu dark niglit of the Middle Ages Ihls long been
the SLiliject of fable. ^J’here is no word of scorn or
contempt whicli has not been hurled at tlie philosophy
of the Schools. This lay in the nature of things.
Every ago in its youthful pride of life thinks itself
justified in picking holes in tlie work of its bygone,
...
last, and that even the fieicest opposition diiected
against the past is oidy a phase of its continued
development.

And accordingly it is now freely admitted that
among the much-despised Schoolmen there were
thinkers of the first rank, Avhose names may be set by
the side of the most brilliant philosophers of ancient
or modern times. But with this we are not now con-
cerned. Every age shoidd be measured by its own
standai’d. The human mind was not, as has been
imagined, asleep during the thousand A’care of medi-
ievalism ; still less’ was it sunk in the rigidity of death.
...
development of pliilosophy as the thought of tlie
...
The greatest acliievements of ancient philosophy
...
been discovered to be the true objects of liuman
...
or, according to Aristotle, as tlie essential forms of
...
sented itself to the minds of the aticients. Hence
all their art too aims at objective creation.

All the 2)hilosophical systems of antiquity bear
this stamp of objectivity. The Godhejid is, even for
Plato, the Demiurgos l)y wliom the world is formed,
and for Aiistotlo the first motionless mover of the
spheres. The enigmatic metaphysical conco2)tions
with which the Middle Ages tormented themselves
were curtly set aside. Time is in Plato’s eyes
identical with tlie motion of the sun {^(povois >/ row
ovpavov Kivtiaris or ^Xlou Kivtja-if, Tim. 37). And in the
same way he idehtifies sj)ace with matter. Accord-
ing to Aristotle, sj)ace is something like a vessel.

70

MEDIEVAL PHILOSOPHY.

separable from the tilings wliicli it contains, and
therefore neither matter nor form: it is in matter,
which is tlierefore the place of place ; it is that
which lies beyond the limits of tlie terrestrial sphere.
...
be any time, if there were no soul (Pliys. iv. c. 14 ), and
...
base of creation and at tlie same time assumes
the whole world to be filled with gods^ ; for
the gods arc individuals who act in or behind phe-
nomemi. The two principles could only lead to
irreconcilable conflicts, for the individual ]:)ersonal
powers were only determined by their own will and
therefore could never become objects of scientific
knowledge, while with the concejjtion of matter
...
own very nature. Keason for the first time be-
^ &aXijs <^rj0q iravra ifKqpq 6f5>v tmu. Alist. de Auiiua, i. 5.

MEDLEVAL PHILOSOPHY.

held its own image in tlie mirror of objective ex-
istence. And although the materialistic school
})roper did little in antiquity to advance the exact
sciences, Lange is right in sriyingb ‘that merely to
refer the enigmatic processes of nature, growth aiul
...
tiquity. All the divine and dcumonic goblin array
was set aside at a single stroke, and whatever
naturally profound minds might be inclined to tliink
of what lay hehind the phenomenal world, this world
itself now lay unclouded before the spectator’s gaze.
Even genuine disciples of Plato and Pythagoras
experimentalised or meditated on tlie processes ot’
nature witliout confounding tlie world of ideas or
mystical numbers with the immediate data of sense.
This confusion, which has been so marked in the
philosophy of some modem Germans, only began to
appear in Classical antiquity with the general decay
of cidture in the time of the Neo-Platonic and Neo-
...
raise them abovb themselves, bears throughout the
’ Geschichtc des Material isnms, i. 95.

72

MEDIAEVAL PHILOSOPHY.

stamp of tin's character. Notwithstanding their affinity
...
ingly the material nature of tlie Deity, of the human
soul, and even of the virtues and abstract concep-
tions, relying on tlie argument that everything real
must be corporeal. ‘ Primura exponam,’ says Seneca,
‘quid Stoicis videatur, turn dicere sententiam au-
debo. Placet nostris quod bonum est, esse corpus ;
quia quod bonum cst, facit ; quidquid facit, corpus
est. Quod bonum est prod est, faciat autem aliquid
oportet, ut possit ; si facit, corpus cst. Sapientiara
bonam esse dicun t, sequitur, ut nccesse sit illam
(forporalem quoque esse.’ (Ejjist. io6.) In the same
way, justice, courage, soul, virtue, arts, en’ors, affec-
...
the school wdiich taught monotheism, the immor-
t:ility of the soul, the universal brotherhood of man,
and recognised virtue and wisdom as the oidy true
good, shoxild have been able to conceive all human
conceptions oidy as corresponding bodies. The
...
accordingly find 'I’ertullian adopting as his own the
views of the Stoics. Tlie world, according to the
Stoics, is the embodied, or objective Logos (\oyiKoy
ea-Tiv 6 Koa-fios), an uninterrupted causal mechanism
presides everywhere, and all things accomplish their
])redestined work in accordance with this order. It
...
ji thing. This is the ruling idea of ancient philo-
Sophy, and hence we see tliat Plato goes so far as
j to doubt the existence of matter because of its
I mutability and perishablencss ; while Aristotle ridi-
' cules the Platonic ideas as phantasms, and in all
I hLs investigations into metaphysical conceptions, such
i, as the infinitude of space, etc., always contrives to
state the q^iestion in this way : ‘ Is it anything Eeal
■ or not ? ’ Dikmarchos, his disciple, is thus quite con-
sistent when he maintains: ^ Nihil esse omnino ani-.
mum, et hoc esse nomen totiim inane frustraque ani-
malia et anirnantes apj)ellari, neque iji homine inesse
animum vel animam, vimque oinnem earn qira vel
agamus quid vel sontiamus in omnibus corporibus vivis
;equabiliter esse fusam,’ etc. (Ciceivj, Tiisc. i. to.)

Wo have seen that the most various forms of
philosophy are possible upon the foundation of ob-
jectivity. Matei-ialisrn, Idealism, Realism or In-
dividualism, Monism, and all the otiier systems
known to us in later pliilosophy, grow out of this
soil. Their significance and their connection with the
common principle of their foundation only appears
from the fact tliat all the different principles sot up
agree in posse.ssing the character of reality : Matter,
...
from this mental fashkni. When it brings together the j
conclusions of the different dogmatic schools and sjiys, ^
...
satisfactoiy explanation or true knowledge of the

74

MEDIEVAL PHirX>SOPHY.

reasons for what exists. There is an (ixisting |
reality, but the tlioudits of men are error and de-
lusion. The sceptics urge as a crushing argument ■
against objective dogmatism the incongruities of ;
thought and reality, tlie relativity of knowledge,
and so to a certain extent the shave of the know-
ing subject in cognition. With the same weaj:)on at
a later date Hume will take up the struggle and give
a decisive bent to the course of modern philosophy.

The objective points of view liad been fairly ex-
.bausted in the old world ; nothing new remained to
...
found, i.e. the riatonic doctrine, in which scarce! v
any allow^ance was made for the essential element
in the objective theory of the universe, namely,
matter and individualism.

II. With the decay of the old culture a new’^ i
doctrine announced itself, which was to start frojii j
the opposite standpoint and tlience attempt to com- \
prehend and explain the universe by a single prin- S
ciple, — the Christian philosophy, n.amcly, wliich is f
...
discovery as yet of the individual subject, the think- j
ing Ego, as the source of all knowledge, nor of the ;;
great truth which followed on the discovery of the ^
Subject to supplement it, with it’s necessary com-
...
growing motion towards the other ])ole, in order to
win there a firm standing-point from whence it might
subdue all things to itself. 1’he world was made
...
the voices that speak within, he must letuai to
understand ‘ IV/'e sprichf ein Geisi ziim andern Geist.’ >
Nature is still haunted by the shades of the old
gods, and is therefore sinful, subject to evil spirits, i
and full of snares and temptations. To turn away
from the world and its seductions, to retire into one’s
own hcvirt, jjenance and asceticism, solitaiy inter-
course with God, become the most serious of duties.

The renujiciatibn of the bright realms of the /
objective world naturally leads to mystery and j
mysticism. We see these accordingly co-operating,
with the first dawn of Christian philosophy to trans- !
form and translate the old philoso])hic doctrine in ;
its own sense ; just as at the close of tliis whole .
period, wlien human wisdom had once more ex- \
...
ot all things in God jis the source of all enlighten-
...
and allowed themselves to be interpmted in its
...
immerical harmonies of the Pythagoreans. We see
...
and in tlte spirit of the new truth that is being
...
Avhom it is only possible to behold, to divine, to feel
immediately, and whose existence the dialectic of the
reason will in vain endeavour to deduce from the
fleeting and illusory world of ])henomona. The sen-
...
find idealism proper in Plotinos (Enn. iii. 7. 10), j
where he says, ‘ The only space or place of the world i

‘ Parerga, L p. 63.

MEDIJSVAL PHILOSOPHY,
...
lost in the abysses of his lieing and so elude the
bondage of impeifect, ever-restless individualism.
On the whole, it may be said of Neo-Platonism that
it Avas comj)letely cloiiiinated by the new tendency
...
Plotinos jtrofesscd to be ashamed of having a body
and Avould never say from Avhat parents he was
descended.

The thought peculiar to IlebreAV monothei.sm,

‘ The world is a creation of tlie Spirit,’ offered a
...
says A. v. Humboldt, ‘ of the nature poetiy of the
...
and discern the pi'ovidence and handiwork of the
Deity within it, until at length when the days are
fulfilled, the time woTild come when they no more
needed to seek in it for light or knowledge.

'J’lie latter was for a long time withheld. The
Grods of nature had been dnven awav from the old

t/

world by the advancing knowledge of nature ; the
conflict between faith and reason had resulted, as it
always does, in the discomfiture of faith. The lieart
of man was Imrning for a new object of reverence,
for a new faith that should tend true value to this
flc'ctiiiff life and biing it into relation with the
Eternal. It tinned away therefore from the cor-
...
liimself directly to the soul of every Christian, For
a Christian, faith was knowledge and wisdom. To
seek for knowledge in nature was to tro;ad tlie old
dark ways, asking wisdom of devils instead of God.

As the life of the mind is hidden and can only be
expressed l)y symbols, i. e. by sensible images wliicli
must be inter])reted in another spirit, it is easy to
understand that the first attempts at a Cliristian
philosophy, whicli Avere made by the Gnostics, con-
...
incomprehensible, immutable, pi’imaAval Eoiiig is the
cause and foundation of all tilings. This primal
monad (/uomy ayyewtjTOi) bas given birth to all things.
He is tlio Bytlios or Aliyssus by whom the con-
substantial Silence {my^) wrus impregnated. Hence
proceeded Knowl(.‘dge {vou<f) and Truth, and these four
compose the Pythagorean TerpaKTUi, the root ot idl
things, etc, Meta])hysical numbers, mons, emana-
tions, beings intermediate between God and the
Avorld, but all of a purely spiritual nature, play a
great And Ave see clearly hoAV a spiritual

mythology might have been developed, from the
unity of tlie Alisolute Spirit, at the root of Chiis-
tianity, whicli Avould lawe differed radically from the
ancient one l)y its allegorical and mystical form as dis-
tinguished from the objective and personal character
of the former. Schopenhauer obseiwes Avith justice*
...
beings like the Pleroma, the iEons, the Ilyle or
Sophia, between the spiritual first cause and the
world was analogous to that made afterwards by
Descfirtes to attenuate the contradictions which the
...
nerve-teiher,’ etc. Botli disguise what they cannot
explain.
...
sei’ve in its purity the simple Christian doctrine, as
...
God we only V.uo'w from him, and with this, whicli is
the true Gnosis, 'we should rest content. There is
but one God from whom all things have proceeded
and by whom all were created. W^e can under-
stand how in that age of passionate enthusiasm,
young ardour, and unbroken energy, Tertullian’s
faith should have exclaimed, in scorn of I'oason and
all the wisdom of philosophy, ‘ Credo quia absui’dum
est : certum est, quia im])0ssibilc est !’

But reason could not long abjure her rights, and
' the very fact that the Christian a})ologi8ts were
...
victions accessible to others. Thus the Auews of tlie
old philosophers, and especially of Plato, were re-
ferred to to show in how many points they approached
to the Christian doctrine. They liad striven by the

MEDIEVAL PHILOSOrHY. 8 1

light of renson towards that which God had made
known by supernatural revelation to Christians.
They had as it were stood in tlie outer court of the
temple. But evciywhcrc the opposition between
the mind and body was insisted uj)on as the most
impoitant argument. Just fus the human mind is
one and rules tlie body with its many members,
so there e:in be l)ut one God to rule the world.
‘Deus an tern qui est seterna mens ex oi nni utique
parte perfccta) consuinmatjeque virtutis est . . . Dous
vero, si perfectus est, ut esse debet, non potest esse
nisi unus.’ (Lact. Inst. i. 3.)

It has often been said, that the great idea of
Descartes u])on which modern philosophy is founded,
is to be met witli in St. Augustine, who appeals to
the certainty of self-(onsciousness in refutation of
scepticism. ‘ I’u qui vis te nosse, scis esse te ? Scio.
Unde scis % Nescio. Moveri te scis ? Nescio. Cogi-
tare to scis? Scio.’ (Sol. ii. 1.) And again : ‘Ornnis
qui se dubitantem intelligit, verum intelligit, et de
hac re quani intelligit certus est. Omnis igitur qui
utrum sit vciitas dubitet, in se ipso habot verum
unde non dulutet, nec ilium verum nisi veritate verum
est. Non itaque oportet cum de veritate dubitare
qui potxiit undecumque dubitai'e.’ (De Vera Kel. 73.)
Doubt may prevail as to whether our souls are fire
or air, but it is impossible for men to doul)t that
they feel, will, thiidc and judge, for doubt itself pre-
su])poscs all this. The soul has no certain know-
ledge except that of itself : ‘ Nihil cnim tarn novit
mens quam id qiujd sibi praisto est, nec raeiiti inagis
quidquam pra.'sto est quam ipsa sibi.’ (De ’I’l'init.
xiv. 7.) We ean only helieve in the existence of
external bodies, stnd we depend in the same way
...
other men. What Ave knoA\^, Ave iilso believe ; belief
itself is a Avay tOAvards knowledge.

There are certainly important and remarkable
points of agreement between these statements and
the fundamental prineiple and reasoning of Des-
cartes. It may be said that Augustine, Avho so
emphatically indicated the direct certitude of seli-
consciousness, and recognised it as tlie foundation
Avhence all other certainty must be derived, is the
real ancestor of Olu’istian pliilosojihy and Christian
Scholasticism, and all that has sprung from these roots,
lie stands thus in opposition to the aa'IioIc of ancient
])hilosophy, in which subjectiA’ity Avas synonymous
Avith insecurity and deception, and Avhich accordingly
strove Avith all its might towards objectivity or being.

Ihit Ave must not overlook tl)e vast divergences
betAveen, the Augustinian and Cartesian doctrines,
if we are to form a correct estimate of the course of
philosophical develo])ment. Augustine uses his own
consciousness only as a stop from vdiich to raise
himself up to eternal truth, tlio certainty of Cod’s
existence. ‘ You doubt ?’ they l»oth begin ; ‘ tl ieiAdbre
you think. Your thought and consciousness ai’e
therefore certain.' But noAv Augustine continues :
As certainly as you live and thiidv, so certainly -
God Ua’cs and is a Single Being, a spirit like your-
self. Descartes takers the reverse Avay and says :
As certainly as God lives and is eternal truth,
so certainly is my thought of an external world not
delusion.

The difference is tliat media3val philosophy drew i
from the Avorld the proof of the existence of God ;
Descartes deduced from the existence of God the ;
certainty of the existence of the Avorld. This indeed
is certainly his weakest pioint, but we see already

MEDI-fEVAL rHILOSOPHV.

83

'how with him philosophy which }iad liitherto be-
: lievecl itself to be the doctrine of the Absolute In-
telligence, was to become the doctrine of the Suh-
jedive Intelligence.

The know^hjdge of self was first derived from tlie
knowledge of God. This is perhaps the most im-
portant and stiongest point of contrast between the
age of Cliristcndom and the preceding ancient and sub-
sequent modern periods. In brief and notable words
Augustine expresses this tliought, as at once the
rule and the aim of all s])iritual research : ‘Demn et
aniinam scii'e cupio. Nihilne plus Nihil omnino.’
(tSoliloq. i. 7.) ‘ Deus semper i<lem, noverirn me,

noverim te.’ (lb. ii. 4.) But human reason must re-
cognise a something higher than itself, seeing that it
is changeable, jierisliable, and suliject to many errors.
This supreme, eternal, unchangeable truth is God, ami
can only be bestowed by him on man. I'lieology and
Theosophy take the place of the ancient ontology.
All the incomprehensibility of the world and our own
natni’c is thrown into the shade by the incomprehen-
sibility of the Godhead, which embraces and includes
all that is, but cannot itself be determined or con-
ditioned by a,ny name, number, space or time, by
any knowdedge under any attribute. And these ques-
...
ticipates in the miture of the unconditioned eternal
Deity— assumed for the first time a transcendental
character. As the one God is present everywhere
throughout the world, so the one soul is pi’escnt
indivisibly in every part of the body. It is there-
fore a special spiVitual subshmee, which has nothing
...
MEDIiKVAL PHILOSOPHY.

as to the nature of time, space, number, divisibility
and the lil<e, bad now become inevitable ; their import-
ance and sigiiificance only revealed themselves in the
course of controversy.

But other contradictions of tlie highest importance,
directly connected with the famlamental principle
of monotheism or the Absolute Intelligence, presented
themselves as well. As ancient olijectivism had a
decided tendency towards materialism us the prin-
...
creatcnl, govei’iied and interpreted, Mdiile the foreign
and incomprehensible element lies in tlie manifold
...
are presented, as the real princqjia mdlviduatioius.
Still more startling is the contrast betwcjen the eternal,
unchangeable All Spirit, or God, and the individual
spirits which are created and called into being
by him : although, in accordance with the ]»rincij)le
...
' Thus, according to Aristotle, Sokrates said Ovk iij} ytvicrOai,
TO (TTrovdaiovs €ivai rj (fyavKovs. (Eth. mag. i, 9.)

MEDIAEVAL PHILOSOPHY.

85

divine nature consist in its necessity, as when lie
says of Cato : ‘ Homo virtuti consiniillirnus, et per
omnia genio diis quam hominibus pioprior : qui
nunquam recte fecit, ut facere videretur, sed quia
aliter faeere nnn qmterat’ (ii. 35.) But in a yet higher
degree, wliether by liis omnipotence or the iiTesisti-
blencss of his working, the Christian God must still
more inevitably have put an end to all possibilities
of individual liberty. I’he finest minds accordingly
begin at once to toirnent tiiemselves over this prob-
lem, how to reconcile the divine forcknowledjre with
the free self-determination of tlie human atrent. The
logical and candid ones, like Augustine, Calvin and
TiUtlier, arrive at the impossibility of human freedom.
While the two first hold flist to this, that a great part of
the human race ‘praiilestinati sunt in adernum ignem
ire cum diabolo,’ the latter speaks without di.sguise:
‘Concessa praiscientia et omnipotentia, sequitur na-
turaliter, ii-refragabili consequentia, nos per nos ijisos
non esse factos, nec vivere, ik'C agero quidquam, sed
lier illius omnipotentiam.’ (De Servo Arbitrio.) And
in anotlier place: ‘We do not exist by free-will, but
of necessity ; we ourselves do not act, but (loil acts
in us in accordance with liis eternal, inl'alliblc, un-
alterable wisdom ; inevitable logic forces us to this
cord'ession.’

In other words, Christian monotlieism has an ir-
...
everywhere ; ii\ the latter it is wholly eliminated.
The scientific knowledge of nature, which only be-
comes possible by the denial of the tirst, had to
wage a bitter war against it in antifjuity; the
latter wais accepted and invoked in the renaissance
...
played their power by breaking through the law's of
causation, as wdien Ju]»iter thunders and lightens from
a cloudless sky: Pantheism is the definite e.xpression,
of a complete natural oi’der, the completed inter-
])enetration of mind and body'. Cod and the w'orld.
The transition was naturally furnished by mono-
theism, the belief in tlie Al)Solute Intelligonce, the
creator and nder of the world, who has ordei’ed all
things well and wisely, whoso thoughts we think
as we learn to know the laws of nature, its classes
and kinds ; and whose power leveals itself there-
fore not merely in the mighty and terrible con-
vulsions of nature, — thougli these, together wdth
...
mai'vellous structure of eveiy living thing, by the
side of which all human art and skill seems the
coarsest bungling.

It is therefore not surprising that we should Ite
encountered at tlie very beginning of the Scholastic
...
MEDIJ5VAL PHILOSOPHY.

87

Alienee on the pliilosophy of the West. In Diony-
sius, who wiis also a favourite authority with the
mediasviil mystics, and had himself been much under
tlie iuAueiice of Neo-Platonism, attention was for the
first time turinxl to the formation of ideas and
loj^ical forms, a subject the study of which was
...
' theology (KaTucjuiTtKi'i) and a negative, ahstract one
.{'nroijxtTiKt]) : the first descends from Cod to created
things, which multiply and specialise as we proceed
(in which he is apjiroaching Aristotle) ; the latter 2>ur-
snes the npfiosite course, and by continuously think-
huj aivaji, attains to higher and higher abstractions,
till at last it reaches the One which embraces all
things in itself, being and not-being together, the
Un-named, of whicjh nothing may bo jiredicated, the
highest knowledge of which consists in negations
and is thus the ignorance ol* mysticism.

In Johannes Scotus, who carried out the ideas of
Dionysius with closer logic and j^rofounder genius,
the difficulty of J’oeouciling the existence of sin and
evil with the divine benehcence presents itself as a
source of tormenting doubts, and with infinite jiains
and ingenuity ho seeks to lessen the difficulty by
treating evil and sin as properly nothing : — ‘periitus
incausale et insubstantiale !’ The other cxjiedient —
that God created men free — ^lias been shown by Scho- j
penhauer in many jiassages * to be a case of ‘ wooden
ii'on,’ since liberty and createdness are essentially i
irreconcilable notions.

For the rest, ^we And in this remarkable man’s
...
writings tlie goiin of all that Soliolasticism was sub*
sequently to set forth at large, cand which was to be-
come the subject of the most far-reaching speculation
and the most embittered controversy. It is interest-
ing to observe here the fii-st rise of these questions, and
to see how at that date views were allowed expres-
sion as harndess which the authority of the Church
was to condemn and anathejuatise a little later. The
...
tainty of his belief tliat all truth was given in the
Christian religion, tlian his frankly expressed con-
...
ratio vero nequacpiam ex auctoritate.’ The whole
woi’ld has proceeded from God ; his beholding is an
act, his act a contemplation ; God is the substance
of all things. Man sums up all j)reccding existence,
spiritual and cor])oreal : — ^lie is a mikrokosm.

The conflict between ideas and thini^s forms the real
substance of the debates and investigations of Scholas-
ticism ; at the same time the Middle Ages were called
uj)on to serve as a period of transition between
ancient and modern philosophy, and to prepare the
minds of men for the momentous thought, which is
even yet hai'dly understood, that there is no reality
precisely corresponding to the notions of men, and

MEDIEVAL riHLOSOrilY. 89

that what constitutes our reality is simply our own
mental representations.

The way could only be prepared for tins truth by
a pliilosopliy which took its start from the absolute
intelligence. Aristotle’s doctrine of the Categories
acejuired the utmost importance in Scholasticism ; the
Categories are properly kinds of affirmation. Lange ^
observes that instead of seeking for the higliest
wisdom behind the Categories, the fact should have
been recognised ' that Aristotle in establishing them
was endeavouring to lay down hoAv many principal
ways there were of sa^dng about anything what it
was, and that hi' w'as misled by the authority of
language into confusing kinds of ^propositions with
kinds of lu-ing.’ He then continues; ‘ Without enter-
ing here into the question how far he may have been
justilied in treating forms of thought and forms of
bei)ig as ])ara!l('l, and in ass\nning a more or less
exact correspondence between the two, it must be
observed that the confusion of objective and subjective
elements in our conception of things, which becainc
in its crassest form the very foundation of Scholas-
ticism, is among the mcpst characteristic traits of
Aristotelian thought. The confusicai was uc)t intro-
duced into philosophy by liim, on the contrary, he it
was who hef/an to distinguish betweciu wluit the
unscientitic consenousness w^as edways inclincid to
identify. But Aristeptic did not get beyond the
very imperfect beginnings of such a distinction ; and
exactly those elements in his Logic and Metapliysics,
which iJi consequence cpf this were most perversec,
wore seized upon by the untutcpred nations of the
West as the corner-stone of wisdom, just because they

* Gcscliiclite des Materialtsnius, i- iSP-

90

MEDIAEVAL rillLOSOPHY.
...
or trcattid as incidentjil.

Aristotle did not distinguish between the objective
and subjective elements of knowledge, because this
distinction is the rij)est fruit of modeiti philosophy;
because the wdiole of ancient philosophy was essen-
tially objective ; and because while the distinction
between sensible perception and thought (ph(momena
and noumena) had been establislajd, that between
thought and being was still unknown ! On the
contrary, in the eyes of all antiquity the points at
wbich tbougbt was held to aim vv'as {and could not
conceivably have been anything but) actual Being
(to oj'tw? or). Logic, dialectic, and the rest wen; only
the sails and mill-stones by the help of which the ])ure
flour of reality was to bo extracted unadultorafed from
the grain.

I’hilosophy therefore had to pass through a great
convulsion before the question of the relation of
thought to being could be stated; all preceding
problems had to assume another asj)ect, as it were
turning tlaur shadow side into the light. This great
revolution was rendered possible by the Chiistian
|)hilosophy. Hence the interest and promise of the
question, which piovokes liange’s shrugs of cornpas-
siori at the outset of Scholasticism whether the five
...
MEDIAEVAL rHILOSOPIlY.

9T

entities. The whole question of the Univorsals, with
which the Middle Ages wore to occupy themselves
so much, connected it.sclf with this problem. Tluis
while antiquity, at its lieight, couhl only discern
true copies of things in the Platonic ideas, it was
reserved for the Middle Ages to consider the nature
of thought in itself, — for the thoughts of (lod were
creative too, — and to formulate the [U’oblem ‘Jlow
do we pass from thought to being "? ’ After which
the final question becomes possible, ‘ What is the
relation of thou<rht to beiiigt’ — which has becai an-
...
oulv a sign of ‘tlie barbarism of th(i western nations’
in the disciple and follower of Alcuin, Fredt'gisus, and
his Ireatise ‘ l)e Nihilo et 'l\‘nebris,’ when ho argues
that Nothing cannot be a pure negation, but must
indicate sometliing real, as darkness does, because
every naiiK! means something, and tlierefon; Nothing
itself must have some kind of being, which is further
confirmed by the suggi^stion that Nothing was tlai
material out of which (lod ci’eated tlie Avorld. We
shall rathiu' see aufl welcome in this the first crea-
tive essays of a healthy vital impulse Avhicli conqiareit
ideas and things, and can therefore proceed to d/s-
thujimh them. On this untrodden ])ath tlam Krigcna
proceeded boldly forward, exjilaining ‘darkness,’ ‘si-
...
guished the uiroipaaris or logical negation from tho

92

MKDT^E VAL PH ILOSOPHY.

iTTeptjerts Of ronl negation. Here the problem of the
relation between thonjjht and beiner obtrudes itself
already; and this important question, which lierc only
aj»pears in the form of an ajterpi, will meet us again
at the jieriod of its approaeliing solution, in the im-
portant work of Kant, ‘ VoT’such den Begritf der ne-
gativeu Grossen in die Weltweisheit einzufiihren.

1 763*’

A different hemisphere from that of ancient philo-
sophy hits been reached when we find ourselves sur-
nninded by such questions as, ‘ Kothing must bo
sonictbing, because every word must mean some-
thing;’ or ‘ Dai’kness and Silence are negative in
thonglit ; there must bo some real negation an-
swering fo them.’ We are here at the antipodes
of the state of mind which accepted as the most
positive of certaijitics that there must be some-
thing in ilia iiiind, and that no other 8tartlng-])oint
eovdd lead towards the world of things and its re-
lations. ’I’he new generation was already accustomed
to imagiiu; the creative world-sjurit surrounded by
hea^■enly beings of a ])urely spiritual nature, with
Seraphim and (Iherubim, Thrones, Dominions, V’irtuos,
Pow(*rs and Principalities, Angeds and Archangels.
And as early as (Uaudianus Mamertus (ob. 477) meta-
physical en<}uiries began as to the immaterial nature
of th(“ sold, to Avhich (juantity, in the way of exten-
sion, cannot be attributed; whose only magnitude is
virtue and wi.sdoin, whose motion is oidy in time
not space, and so forth, in confutation of the antique
materialism of Tertullian’s views.

But the most inq^ortant conception wdiich me-
diaeval philosophy was to originate and bequeath
to modern times, was that of the concepi (con-
ceptus) itself; something purely intellectual, an object

MEDL?iVAL PHILOSOPHY.
...
forward to count as the chief business of jdiilo-
sophy. All the controversies of Scholasticism turn
ujioii the Uiiiversals ; tliese universals are repn?-
sented in modern philosophy by concepts, or general
ideas.

These considerations were aroused, as lias been
shown, by the doctrines of Plato and Aristotle. The
Pantheistic turn of Scotus Erigi'iia, for whom all
things proceed from the Deity as tlie true substance,
and sti'ive to be reabsorbed again in him, who held
the highest abstractions to be tlie highest triitlis, who
understood by the mystical Nothing the supreme
superesscmtial, incomprehensible nature of God him-
self, whilst on the other hand he makes (lod the sum
of all beings and all I'ealities — this Pantheistic bent
prevented the antagonism from becoming sensible as
yet : it is nei.'dless to add that according to him the
Universals exist before the things (i.e. in Gotl) as
well as in thinos.
...
of starting from ideas and thence, bv continued
pro and contra, deducing true conclusions, was tlie
favourite. It was congenial to an epocli which be-
lieved knowledge could only be dei’ived from the
...
tian philosophy, helped the latter to grasp its owm
...
ness vdiicli it could not otherwise have attained.
The incnrable pluralism of Greek philosophy was
...
idea, Avas actually so boldly generalised as to include
Avithin itself the Avorlds of matter and s])irit. I'he
Pluralism of the Platonic ideas was set aside Avhen ^
for the first time men found themselves in a posi-
tion to realise to themselva^s the groAvth of ideas ■
within the human soul, — a clue for alt future philo- ;
Sophy! From this point of vitJAV a passagt^ from Ilen-
ricus of Auxerre (in the 9th century) is of great
int(!rest, as it contains a kind of theory as to the
origin of reason, and seems partly, though of couivse
impci'fectly, to foreshill some of the vIoaa's of Locke
and Leibniii : ‘Sciendnm autem quia propria nomina
sunt inmuncrabilia ad qiue cognosccnda intellectus
nullus sen mcjtioria sufiicit, hmc ergo omnia, coartata
s})ecies ccmiprehendit ct facit primum gradum (pii
latissimus cst, scilicet hominem, equum, leonem et
species hujusmodi omnes continet; sed <|uia hmc
rui'sus erant innumerabilia et inconqu'chensibilia,
alt(!r factus est gradus angustior jam, qui con.stat
in genere, quod est animal, surculus ct lapis : iterum
hacc genera, in unum coacta nomen, tertium fecerunt
gradum arctissimum jam et angustissiinum, utpote
qui uno nomine solum constet quod est usia This
is genuine Nominalism ; but Avhat a change in the
standpoint compared Avith that of Aristotle and the
ancients ! I’lie latter saAv the Universal in things,
and cared for nothing else ; tlie human soul had only I

* UcLerweg, Grundriss dcr Gcscliichtc dci' Pliilosoidiic, ii. p.
...
a special power of perceiving tlie Universal ; but here
we find Christian philosophy, unconcerned about the
nature of actual things, — were they not all tlie work
of God ? — boldly maintaining tliat the soul itself oii-
ginates an orderly course of intuition and designation.
The Christian belief in an immortal, independent,
divine soul, was also connected with the avow'ed ab-
solute subjectivity which permitted tlie development
...
in still harsher form, arc the sounds caused by my
own mouth, jJatiiH vocis’ A passage quoted by Cousin^
from the Conunentary on F<)r])hyry attributed to
Itabanus Maurus is characteristic in this respect ; the
object of tliought is expressly distinguished from the
actual things whicli alone have rca,l existence : ‘Genus
est quod prmdicatur, Jies evim non itrn'dicatur.
Qmjd hoc mode j»robant; si res pra'dicatur, res
dicitur ; si res dicitur, les enuntiatur, res profertur;
sed res profeiTi non potest; nihil cnim profertur nisi
vox, ne(pie enim aliud est prolatio quam aeris plectro
lingum percussio.’ It is true the expression is crude,
but the thoughtful reader will detect in it the im-
plication of a great trutli, which was wholly unknown
to the ancients.

The victory which the doctrine of the Ilealists— -i . e.
those who attributed true reality to Kinds, Universals,
or (Tlatonic) Ideas — gained by the help of ecclesias-
tical authority on the occasion of the public decision
of the coutrovoi’sy at the Gouncil of Soissons (1092),
when the representative of Nominalism wais compelled
to recant, was owing no doubt to a foreboding ot the
...
relatioiisliip between Noiniiialisrn, logically carried
out, and Naturalism or Materialism. 1'lie Cliurcb
felt that its oavu sti'eugtli lay in the rigid upholding of
the jmre .spiritual element. The Nominalist doctrine
had already .shown itself dangerous to the fir.st and
highest doctrine, the niysteiy of the Trinity. If only
single beings possess reality, tritheism becomes un-
avoidable, and this point excited universal notice.
Every age tests tlie truth of a new doctrine by apply-
ing it to that which it has most at heart ; in the ages
of faith this was the (Christian doctrine, as in our own
day we ask whetlier the tendency of Darwinism is
aristocratic (as Haeckel assurc's us), or social-demo-
cratic (as Virchow inclines to tliink). 'J'he arguments
which Anselm of Canterbury brought to boar against
nominalism all turn upon tlie impro[iriety of judging
spiritual natures by the coarse st:uulards of ordinary
sense. He ridicules those dialecticians who think
that words, the jhduH t'oeh, cxhau.st the nature,* of
the uuivoisal substances, who imagine that colour
must be a body and wisdom a soul, who, wholly
swayed by tbeir imagination, can only believe in the
existence of that which is immediately before their
eyes. He calls tlu;in dialectic heretics, pointing there-
by to the discord which was beginning to separate
reason and dogma, wliile earlier times had remained
unshaken in the belief tliat revelation AA*as completely
in harmony with reason and could bo demonstrated
by the hitter. His (.'redo id. iidelliijam thus assumes a
peculiar character ; it may be supplemented : 1 believe
things transcending iny powers of com])rehension,
but which show me the way by wliich I may attain to
true knowledge. Tlie existence of Univcrsals as pure
...
necessary : ‘ Qni eniin nondum intelligit quomodo
plures homines in specie sint homo unus, qualiter
in ilia secretissima natura comprelicndet, qnomodo
phires personjB, quarum singula quajque est per-
iectus ])eus, sint Dens imus 1 et cujus mens obscura
est ad discerncnduin inter equum suum et colorem
ejiis, qualiter discernet inter unum Deum et plures
rationes ; denique qui non potest intelligere aliud
esse homincm nisi individuuni, nullatenus intel-
liget hominem nisi humanam personam,’ (De Fide
Trin. c. 2 .)

The. very feict that in the Middle Ages those whom
we now call Idealists Avere called Idealists, is signifi-
cant and instructive. It shows the assumntion from

X

which opinion started. The Spiritual was taken for.
granted, and from tltence men iiroceeded towards
reality, asking: Are these Beings conceived by the
mind,, these Universals, actual things '{ For Plato
and Aristotle they were only reflections, ISeai, in
the human soul, derived either from memory of a
former state or the direct contemplation of real beings
in tlie present. The one view is objective, the other
subjective.

If the doctrine of Absolute Intelligence forms the
real substance of mediasval philosopliy, the summit
of its unimpaired existence was reached in the w^ell-
known cosmological and ontological 2)roof of the
existence of a deity furnished by this same Anselm
of Canterburv in his Monologium and Proslogiutn :
wdiich, although their weak points were indicated in
...
tbougbt to being. We think the good, the lofty, the
true, theiefore these universals have an existence
independent of things. But we must then also neces-
sarily tliiiik a supreme good, a supreme truth, a
supreme justice, and this is God, the absolute Being :
all individual existences arc conditioned, and prove
by the very fact that there must exist an ultiinate
source, a cavsa pri/ma, witli nothing superior to itself.
Tl lis Absolute Intelligence has cnaited thcAvorld, and
continues to preserve! it in existence : all things
existed first in Ids thoughts, l)cfore they attained
reality. In individxuds nothing is just, good, or true,
except in so far as it jiarticipates in the absolute
Justice, tioodness, and Truth. This is the cosmolo- .
gical proof, which i*easons from our relative thought
to the Absolute. The ontological proof, on the con-
trary, derives its conclusion from the delinitioiA of
the idea itself. It is possible to think of a Greatest,
a Highest, a Necessary Being ; tiiorefiire tliis must
actually exist. For if it did not, it wovdd be only In
intellect u, it would therefore not be really Greatest,
Highest, — id ((uod non cogitari potest non esse. It is
tlie same proof as that which Avill meet us again under
many disguises in Descartes, S|)iuoxa, and J^eibnix,
Avhose dei)endence upon medimval thought is shown
in nothing more clearly than in this. The ejis realissi-
mum, necessarium, tlie causji sui, id quod non cogitari
potest nisi existens, the causa, priina, all trace their
origin to the scholastic argument according to Avhieh
reality, like any other predicjite, is included in the
idea of substance, and then by analytical j\idgmeut
discovered to belong to it of right. No doubt was .
felt at this period tliat necesstuy links of connection '
...
!thc impossibility of tliis was only proved to the
World by Kant.

/J’ho first attempts at reconciliation between tlie
extremes of Nominalism and Ilealism were made in
the twelfth cimturv, bv Abelard, so faTiious for his
eloqnenet; and his ill-fated love, llis keen intellect
AVfis the first to disceni the imjjortant distinction be-
tween Avords, as mere sounds, and the conccjttnal
content con’esp<jnding’ to them. Ilemusat desciibes
his attitude jus fbllow's ’ ; ‘ Cc n est pas le mot, la
voix, mjiis le discoui’S, sermo, e’est a dire l expiA.-ssion
du mot qjii est attribuable a divens, ct quoique les
disconvs soient dos mots, ce nc sont ])as les Mats mai.s
les dheonra (meaning clearly the sense of the words)
qni sont universols. Quant aux ehoses, s'il etait vrai
qn’iino chose put saflir ner de ])lM.sienrs ehoses, uno
scnle et )neme chose se lAtronveralt dgalenuait dans
plusicni's, ee (jni repngne.’ lie had thus a, clearer in-
sight into tin; nature of langua.g<.'i than any of liis
predecessors, wliilc he agreed Avith John of Salislairy
(Metal, ii. 17) in thinking, roii da ra prii.'dlaar!' mon-
struin esse. Tlie esstmee of his doctrine is (Joncep-
tualisjii, and it seems as if tlie impoitjuit determina-
tion of the meaning attached to rniiaaphis, notion or
idea, vnis also due to him. It Avas only in liarmony
Avith the natiuid course of tilings, and of raediteval
thonglit, that lie should first locate this aanccjdus
■maniiii in the Sjiirit of tlie Trinity, Avherc its efi’ects
must be creative, and so turn to the universalia in
rebus. If it is, us Ave believe, one of the most im-
portant discoveries of modern [ihilosojihy tlia.t all
liuman thought takes place by means of idtias, that
these Jire purely mental objects, which liOAveA cr have

* Abclai’d, ii. 105 (ap. Ueberweg, ii. 152)-
H 2
...
no other matter or content tlian what is derived from
the objective world of sense, — it will he easy to
estimate the importance and the fruitfulness of tliis
discovery of Abelard’s. In the same way as he dis-
tinguished tlie word as sound from the idea, he
distinguished the latter also from the things to Avhich
...
of the definition ‘nihil aliud est definiturn, nisi decla-
ratuvi secundiivi sir/iu'ficationem vocalnilum.’ The pro-
...
which is bold for his age : ‘ Dubitando ad inqxilsitio-
nem venimus, inquirendo veritatem pcrcipiinus.’ Ilis
doctrines were condemned in two synods.

The great schoolmen of the next age, among whom
Albert of Bollstiidt (Alb'citus Magnus) and Thomas
Aquinas stand out pre-eminent in comprehensive
learning and acuteness, accepted the former versions
of the ]u-oblem of the Unlversals, and atlmitted their
existence in a threefold sense, as ante rem in the
mind of tlie Creator, as in re, according to the Aristo-
telian conccjption, and also as jjont rem as ideas arrived
at by abstraction. To Thomas Aquinas the universale
in re is the quiddity, or substantial form, which is ab-
stracted by the i-eason, and is distinguished from tlie
accidental forms or non-essential qualities. For the
rest, these great thinkers are not vmaware of the in-
...
clogTnas. Albert tlie Great, whose reseai’ches were
directed towards the hitlierto proscribed or despised
natural sciences, passed beyond the limits of tlio
credo ut intelligarn when he recognised that there
Avere dogmas iiiaceessiblo to the natursd liglit of
reason, aiid tlierelbre necessarily objects of laitli. He
distinguislied between philosophic and theological
trntb, demanding tliat tlie former sliould be con-
sidered pliilosophically, and jn’ofessing in mutters of
religion to })refer tlie authority of Augustine to that of
Aristotle, Avhile in matters of natural science Aristotle
AA’as to be believed in preference, d'be antagonism
appears still more sharply in St. Thomas of Aijuiu,
Avho confesses most of the dogmas of the Church to
be uiiattainablo by natural rijason : this can at most
prove that they are not contra, ry to rea.son, it can
never reach them by its oavu unaided jirinciplcs and
can therefore not demonstrate their truth. On that
very account they are matter of revelation, and faith
becomes a merit, a A'irtm?, an affair of will rather
...
T’he contrast betwiien the general and the particular,
the one and many, rea.son and sense, which lies at
the root of all knowledtje, is also at tlie bottom of
...
Plato and Aristotle. Each spoke only Irom his own

102

MEDIyEVAL PIin^OSOPHY.

standpoint, and under the influence of tlie prevailing
objectivism. Plato attributed reality to ideas ex-
ternal to the ])henoinena, Aristotle to forms within
...
and pluralism is the result. I’he God who orders
the world, the mover of all things that move, is a
mere expedient.

It remains to be s(‘en what answer to the question
regarding the individual was given by the doctrine of
Absolute Intelligence, or Christian pliilosojdiy. The
moat logical I'eply would have been, as has been said
already, that the indivitlnal should be absorbed in the
former, i. e. Pantheism. But the profound ethical
spirit of Christianity was o[)})Osed to this ; morality
is only possible with self-determination, i. c. imlivi-
dualisni. The individual, or rather the self-subsist-
once of separate things by and outside the general,
universal spiilt, is therefore what has to be explained,
and of this problem Seholastiiasni gives various
solutions.

I. St. I'homas, inspired by Aristotle and his com-
mentator Avicenna, placed the principiura individua-
tionis in matter. It i.s only by this that species turn
to individual beings, and a.ssunie material existence in
a dctiTininate place and time, 1ii<; et mine. Matter is
always undetermined, and has only a cpiantitas de-
torminata, it is tlie substratum which receives the
form, tlie uTroKelfieiov or sidyect. Th(;re are, it is trut,‘,
also immaterial forms, forma) sejiaratm, God, angels,
human souls, hut everything perceivable by sense is
a form insejiambly bound up with matter. These
views include the antithesis of matter and mind, tlie
...
essential conditions, form inse]>arable from matter —
all rays of light ])olnting to the patli Descartes and
Kant are to follow in the future. In Aquinas too we
find ideas as to the iiatui’o of human knowledge that
seem to helonix to a later aire than his. Human
knowledge is only jiossible by the action of the objects
...
things, but oidy their external accidents, and yet the
Imiuan intellect requires the phantasms of them,
wliich it renders intelligible' by Its power of abstrac-
tion. His criticism on the J^latonists is as striking
a.s it is profound and. far-sighted : ‘.Tntellectus hnmani,
qui est conjunclus corjtoris, proprinm objectum est
quidditas, sive natura in. materia eorporali cxistens,
I't ]ier liujnsmodi uaturas visibilium rerum etiam in
iiivisibiliuni rennn alhjnalem oognitimiein ascendit,
de ratione autem hujns natura; est quod non est
abs(]ue materia eorporali. Si ]»roprium objectum
nostri ijitellectus (.;ss(!t forma se|)arata, ved si forirue
rerum sensibiiium subsisterent Jion in particide.ribus
secundum Platonicos, non (jporteret, quod intellectiis
noster sempc;r intelligendo converteret ad phantas-
mata.' (Sum. Tlieol. i. qu. 84.)

2. In contradistinction to St. Thomas, 13 uns Scotus
places the essence of Individualism in form, ratlier
than matter. All beings except (lod have a material,
and a form, wliich is liowever indefinitely moie ex-
alted in tlic case of spiritual than of corporeal btdngs.
But from out of this univei'sal existence, the par-
ticular existence of individual beings cojistitutes itself
by the accession of jjositive conditions, so that the
individual nature, the hieceeitas, is superadded to the

104

MEDIEVAL PHILOSOPHY.

universal nature, tlie quidditas. We are generallj
accustomed to regard these abstractions as the acme
of Scholastical absurdity. But it should be re-
membered that this last exjDression means no more
than what Aristotle had maintained against Plato,
namely, that nothing really exists except the in-
dividual, ToSe Tt. Duns Scotus has done nothing
but carry the reality of Aristoth; into the higlier
region of ideas, which is surely an inij)ortant pro-
gress : where else can it belong ? When Kant
comes to explain the case as to Ihis hmcceitas, will
he show it to be somethintr real ? The analysis of
the idea as such and its accurate investigation arc due

to Scholasticism ; and without tljis careful anatomy

•/

of mental processes modern jdulosophy would never
hav(' become possible. Even Lange does not licsitate
...
and logic, would at least derive some |)rotit from the
logicians of that century, for the lattei- tried seriously
to mahe a logical analysis of the whole of Grammar,
in the course of which they succeeded indeed in
creating a nc%v language, the horrors of which were
held to 1)0 past exagg(>ration by the Humanists. . . .
But tiie fundamental intention of all this diliccence
Avas perfectly serious, and sooner or later the whole
problem (of language and thought) will have to be
j’ccojisidered, thougli it may be with a A^eiy different
beai'ing and purpose.’

Duns Scotus Avas an acute but very hierarch ically-
mitided man. He lielieved himself to be servine- the

O

authority of the Church by restricting the rights of

^ Gcscliicl)te ties MatcrialLiuus, i. p. 177.

MEDIEVAL PHILOSOPHY.

105

reason even more than lus j)rede.cessors, and de-
claring the truths wliicli had formerly been recog-
nised tis the subject of natural tlioology, such as the
creation of the world and the immortality of the
soul, to be incapable of proof. Knowledge iic'cording
to his view has nothing to do with faith ; theology
has more practical than theoretical significance, the
will of God ‘ is the only cause of the truths of faith ;
the duty of man is to believe, i.e. to submit willingly
to the authority of tlu; Church. Tlie will of man
is not dependent on his knowledge, but he is able to
determine it without rational m’ounds : voluntas est

O

superior intcllectu.

'J’he breach between faith and knowledge' was com-
pleted by the Fianciscau William of Occam (d. 1347)5
...
In the gohlen age of the Ghristian philosophy the
Absolute Intelligence, God, is tlie source of all truth,
tlio quintessence of all reality, the only true poshdate
needed for kuowledire, and leadino: nocessarilv there-
to. Now however the long-dcs])ised and disregarded
ohject again risi's on the horizon in all its enigmatic

* According io St. Tliomas Aquiiiap, God coinniiinds wiiat is
because it is good: according to Duns Hcotus, good is good
beaiiise (iod wills it. The domain of reason grows more and more
restricted. Wv shall see liow, in Ihe ncxi })eriod, its chdms grew in
tlie same niJiiters in an opposite direction. According to Descartes,
a mathcimdical p]*o]H).-^ion is true (an a^tcriia veritas) hecausc God
so wills ; according to Spinoza, it is an idea of God because it is
in aceordaiiee with reason.

I06 MICDT.'EVAL I’HlLOSOPflY.

obscXirity, and calls for a solution, wliicli antiquity was
uiiablc' to uivc no( withstiuidiiiff its exclusive attention
to this aKpect, and wlilch tbeological wisdom, by re-
stricting itself to tbe domain of faitli, could no longer
even altonqjt. Hut the leturn to Nominalism is by
no means a simple resumption of tlie Aristotelian
standpoint. In the interval tlie whole nature of tlie
question had undergone a change corresponding to
the intelle(;tual work acconqdished, and though the
aspect was the sann; as from tlu^ earlier standpoint,
the outlook was from a higher elevation commanding
a w’i<ler ]iros[>cct. (iradually, and pmliaps still con-
...
trine of id(!as, its pluralism. If we make tin; IJni-
versals into real tilings, e.xisti ng outside our thought,
they turn into single things, individuals. And it is
just as impossihlo to attribute separate existence to
the IJniversals within the things, for this would also
he multiplying them. It is wc ounsel vc.s, our ab-
straetiiig iidelligeuco, that so surveys tbe really ex-
isting single tilings that the coiniuon element belong-
ing to them detaches itself and is conceived and
comprehended l>y the mind, only however as an Idea,
C0Tiee]»tuB mentis ; except iji the mind, this idea has
no existence save as a woid or other conventional

Thus, according to Occam, the principle of in-
dividuation resliles in the individual itself, Avhieli
exists independently and must lie accepted as a
preliminary ]»art of the ju’oblom to be solved. Tlie
individuals alone are truly real, ‘qumlibet res ex co
i['so (jiiod est, est luec res.' We tbink and know

MEDIAEVAL PHILOSOPHY.

107

by meatis of umversals, but it by no means follows
that they thei'cforo j>ossess reality. The real in-
dividuals are represented in due order and connection
by the corresjionding’ ideas : these ideas with their
verbal efprivalents are c;dled termini, and hence the
adherents of Occam were rightly called Tenninists, to
distinguish them from the extreme Nominalists, who
saw in Universals wem nomiria or arbitrary signs
The change may be hailed as the first dawning ray
of inodin’n philosophy, since here for the first time
the I’clation of the subject to the object is conceive<l
as the starting-point and fundamental princi])lo of
knowledge. For tliough the termini as such exist
only in the j)crcijiient mind, they are not ai'bitrary,
like conventional sions or sounds, but tla'v aiiso bv
natural la'cessity of.t of the intca’conrse of the mind
with things, i. e. as an effect ol* the latter. Word,
ide:i, and tiling seem for the first time to be sharjily
distingnished and their interdependence shown ; the
reason has been forbidden to ovcrslioot herself, while
all that I'nllows fi-om the distinction was resei'ved for-
future philosophy to exjdoie. The transformation
of things iirto concepts, the origin of concejits, of
language and similar prolilenis, may lienee forwaral
be detected by keen eyes as luminous spots whii-li
will disclose tliemselves after centuries as the heacons
...
turally and inevitably as our perception lea ves behind
it an image in rnemory (habitus derclictus ex primo

’ See Prantl, Gcscliiehtc der Logik iin Abeudliiiide, iii. 344 ff.

lo8 MKDIJ5VAL PHILOSOPHY.

actit ^), and thus tlie similar perceptions consolidate
...
internal. This alone can tell us iliat anvthini; is ;
the judgment is then completed by the uiidorstand-
ing. Abstract kianvledge warrants no judgment as
to the existence or non-existence of a thing. The
senses give us no certain knowledge of things, tlicv
only i’lCquaint us with certain signs, which liave in-
deed a certain relation to them — as smoke to fire, or
sighs to pain. Just so words are o-wdijKii, arbiti’aiy,
conventional signs of ideas, of the coneejttus mentis ;
they are thus sn/ns of aiyns, and indirectly of things.
Any one wlio aj)preciates the signiticance of these
words will feel that a new age has begun since the
sj)eculations of I'Jiito and Aristotle, or the words in
which Cicero summed up the general theory of an-
tiquity, ‘ vocabula sunt notie rerum

Our mind is most exposed to eiTor in the judg-
ment resjecting external things, suggested by the
external kind of intuition. The senses are less to be
depended on than tlie intuitive knowledge of o\ir
own inward states. ‘Intellectus noster ju'o statu isto
non tantum cognoscit sensibilia, sed etiam in par-
tlculari et intuitive cognoscit aliqua intellectibilla
qiue nullo mode cadunt sub sensu, cujusmodi sunt
intellectioncs, actus voluntatis, delectatio, tristitia

’ Tliis t'.\jircwsi()u is inucli more just Hum those cumnit. in our
owji (lay, such as ‘i^iii'iickhleihou von iiestcu,’ or, \voi>c still, ‘ Nar-
heii ill clou Nervcii,’ ami ‘ sclnviugeudc Wirstellunjfcn,’ words witlioufc
any incaiiiiiff in particular. Occam touches the two real points,
activity and hahit — showing once more how much wc have still
to learn from Hie despised dark ages of niedisovalism.

“ Herder, however, reiicatcd this view in the last century.

MEDL«VAL nilLOSOrHY. IO9

et Inijiisraodi quaj potest homo ea'periri inesse sibi,
qufe tamen non sunt sonsibilia nobis, nee sub aliquo
sensu cadunt.’ But it is onlv the states, not the
nature or essence of the soul wliich is to be known in
this AV’av. Whether tlie sensations and emotions, tlie
acts of thouglit and will proceed from an iinmaterial
being is uncertain'.

Gra.nted that tliese are only loose blocks rather
than a complete edifice, they are tlie blocks witli
wliich the greatest thinkers of modern philosophy,
Descartes, Locke, Hume and Kant, have constructed
their great erections. Especially in the two Englisli
writei's the above argument will meet us in almost
tlu^ same words. As Occam did not shrink from the
tdtirnate consequences of his views and was prepared
to trace back to princi])los which could only be de-
rived from experience, even the syllogistic thought
which was supposed to lee.d to necessary truth and
self-evident knowledge, it may be asked whether
Locke and Hume are not I’eally restorers of his view,
according to which cxpeiieuce was implicitly made
the solo source of knowledge ; and whether the
...
Franciscan mordc of the fifteenth centurv.
...
the latter. The attempt of Itaymond de Sabundo,
which has been iminoitalised by one of Montaigne’s
most interesting essays, to prove the doctrines of
Christianity by natural revelation, continued to stand

' tTeberweg, Gruudiiss, ii. 235.

no

MEDIEVAL PHILOSOPHY.

alone. Religious fiiith drew back into its original
starting-place, the depths of the human soul. Dis-
gusted with tlio diy intellectiial refinements and
...
of tlie soul to reach and mingle with the Absolute
Intell igence, to rest in it, to know and to behold the
supernatural truth. Tlio separation between subject
and object had accomplished itself in tlio conscious-
ness of the age, and modern philosophy was heralded.
The aspirations of the whole preceding period con-
centrated themselves in the souls of the clKJsen few.
In union with the object, they said, is true know-
ledge only to be found ; let us become one with Clod.
...
Gott vergonnst, dass cr in dir Gott sei T

To sum up briefly the lesults of the intellectual
Avork accomplished by Occident;il humanity in the
Middle Ages, we find :

r. By starting from the Al)Solute Intelligence, the
chief cravings of the reason, after unity and spirit-
nalitv, receive due satisfaction.

T1 le individual Gods of popular belief, the in-
dividual atoms of Demokritos, the individual ideas
of Plato, the individual substances of Aristotle, dis-
appear, and in tlieir place there reigns the one God,
...
distinction between extended, and tliinking sub-
stance.

3. Tlie laws of tlie thinking mind are attentively
and assiduously observed. I’Jie place of the objects
and Platonic ideas is taken by concepts.

The special onesidedness of niediawal philosophy
consisted in the absorption of all individuality by the
Absolute Intelligence.

The crisis announced itself bj?^ the threatening re-
assertion of the oljjecdve world, as a relapse towards
the objcctivisni of antiquity.

Put the spiritual standpoijjt was not to be lost :
...
the absolute but tlu; individual intelligence that
Descaj'tes ])rochum.s as the lirst and only certainty.

In the Coijlto the relation of sul ject and object is
imjdied its tlie priruiiry (condition of all knowledge.
It is the vital juinciple of modern philosojdiy.

To investigate this relation, to lay down exac'tly
what belongs to the subject, what to the object,
and how they act upon eacli other, these are the
problems for modern times.

We si tail see grave oscillations towards one or
...
lie will show that there is an element of truth

112

MEDIEVAL PHILOSOPHY.

in every system, but that {dl are incomplete ; lie
will show that they have their origin in the nature
of the human reason ; and he Avill lay bare the
nature of this reason to its very roots, and so put an
end for ever to the controvemies of the schools.

Thus the development of modern philosophy
stretches itself before us as a clearly defined problem
at the outset, witli a complete solutioiT at the close.
Tlie Cartesian Cogito corresponds to the Kantian
...
Novff opa Kal vovs aKovei, rriXXa
scov<fia Kal TV<f)Kd. EnCHAKMOS.

Descaetes is the Atlas on whose powerful shoulders
...
of philosophic thotight, the idealidic, which connects
Spinoza and Leibniz with Kant and Schopenhauer,
and the viechanico-fhysical, which through Hobbes,
...
telian formulas was thrown off, and a now beginning
made for the free observation and independerrt ap-
preciation of facts. For, in spite of his inclination
to the empirical, 'Aristotle started invariably from
causae primae, from jyrincipia et elementa rerum, and

VOL. I. I

1 14 MOibEKN PHILOSOPHY.
...
the senses and experiment as the real souices of
all truly scientific knowledge, which ought never
to follow pieconceived opinions or so-called idols, but
strive to become a faithful copy of the real world.
‘ Science is nothing but the image of truth, for truth
of heing and truth of hnowing are the same, and do
not differ otherwise than as the direct rav differs
from the reflected ray.’ ‘ That alone will be the true
philosophy whieh renders the voices of the world as
...
for, ill that case, lie could not have passed ovei‘ the
...
cussed by real philosophers, Avhilo students of natural
...
expciicnce, may well claim philosophical significance
also, for it indicates hoth the legitimate extent and
the limits of empiricism. That there ai e grave dififi-
...
iierat et resonate has to be proved by real philosophy,
...
the gi'eatest and most significant truths. Doubt as
to the truth and validity of existing explanations is
itself to bo explained only as the fermentation of a
new truth striving to rise to the surface. Doubt is a
disease of privileged spirits only, for oidinary mortals
are satisfied with the nearest and most trivial causes,
such as, that a man walks because he luis two legs.
...
succumbs to sccjiticism, though always waiting and
watching for a coming deliverer.

‘I cannot understand how the apple falls to the
ground’; thus said Newton. ‘I cannot understand
how man can move himself’; thus said liobert Mayer.

^ ScliopcjLiliaucr, Parerga und Parali2)onieiia, i. 72.
...
retie speculation, hut of all practical institutions,
which not long ago had hcen completely wrecked,
namely, that the sun
