---
source: "https://philarchive.org/rec/DELDSA-10"
title: "Del Símbolo a la Estructura: Teoría de la Habitabilidad Dinámica de la Conciencia"
author: "José Carlos del Campo"
year: "manuscript"
publication: ""
download: "https://philarchive.org/archive/DELDSA-10"
pdf: "https://philpapers.org/archive/DELDSA-10.pdf"
captured_at: "2026-05-27T18:58:23Z"
updated_at: "2026-05-27T18:58:23Z"
...
# Del Símbolo a la Estructura: Teoría de la Habitabilidad Dinámica de la Conciencia

- 著者: José Carlos del Campo
- 年: manuscript
...
La Teoría de la Habitabilidad Dinámica de la Conciencia (THDC) propone un desplazamiento conceptual en el estudio de la conciencia: desde el análisis del contenido fenomenológico hacia la evaluación de la estructura del sistema que lo sostiene. A partir de un diálogo crítico con la psicología analítica de Carl Gustav Jung, el modelo reformula conceptos como sombra, ánima, ánimus, self e individuación en términos de variables estructurales (coherencia integrativa h, urgencia U, reactividad R, presencia corporal B y amplitud temporal subjetiva Ts) y los evalúa en función de su impacto sobre la habitabilidad H del campo consciente. La habitabilidad se define como la capacidad del sistema para sostener su dinámica sin pérdida de coherencia, regulación o continuidad experiencial, y se propone como criterio de segundo orden para distinguir entre intensidad y transformación, y entre reorganización y desorganización. El modelo se sitúa en un nivel de formalización pre-matemático riguroso y es compatible con enfoques contemporáneos en neurociencia, ciencias cognitivas y teoría de sistemas.

## Citation

del Campo, José Carlos, Del Símbolo a la Estructura: Teoría de la Habitabilidad Dinámica de la Conciencia.

## BibTeX

```bibtex
@unpublished{delCampoManuscript-DELDSA-10,
	author = {Jos\
```

## Source Details

Archival history: First archival date: 2026-04-19 Latest version: 2 (2026-04-20) View all versions
Categories: Theories of Consciousness, Miscellaneous in Philosophy of Mind
Keywords: habitabilidad dinámica   conciencia   Jung   psicología analítica   sistemas dinámicos   fenomenología
...
TEORÍA DE LA HABITAB
ILIDAD DINÁMICA DE L
A
CONCIENCIA (THDC)
...
Teoría de la Habitabilidad Dinámica
de la Conciencia (THDC)
...
FUNDAMENTOS EPISTEMOLÓGICOS DE LA CONCIENCIA COMO
SISTEMA HABITABLE
...
FORMALIZACIÓN DEL CAMPO CONSCIENTE COMO SISTEMA
DINÁMICO
...
FORMALIZACIÓN DE LA HABITABILIDAD DE LA CONCIENCIA
...
DISTINCIÓN ENTRE FENOMENOLOGÍA Y ESTRUCTURA: MARCO
DE
...
REFORMULACIÓN ESTRUCTURAL DE LA SOMBRA
...
REFORMULACIÓN ESTRUCTURAL DE ÁNIMA Y ÁNIMUS COMO
FUNCIONES DE REORGANIZACIÓN DEL CAMPO CONSCIENTE
...
EL SELF COMO RÉGIMEN EMERGENTE DE ALTA HABITABILIDAD
...
LA INDIVIDUACIÓN COMO PROCESO DINÁMICO DE
...
DISTINCIÓN ESTRUCTURAL ENTRE TRANSFORMACIÓN Y
DESORGANIZACIÓN
...
PATOLOGÍAS DE LA INTERPRETACIÓN SIMBÓLICA
...
MODELO OPERATIVO DE INTERVENCIÓN SOBRE EL CAMPO
CONSCIENTE
...
INTEGRACIÓN FINAL, DELIMITACIÓN E IMPLICACIONES DE LA
THDC
................................
................................
................................
...
Del símbolo a la estructura

Este libro nace de una incomodidad metodológica y de una intuición sencilla. La
incomodidad: gran parte de la psicología de la conciencia
—
y de forma paradigmática,
...
en
“
¿qué le ocurre al sistema cuando esta experiencia aparece, y puede sostenerla sin
degradarse?
”.

Para responder a esta

pregunta, la THDC propone un desplazamiento conceptual que
recorre todo el libro. En lugar de definir la conciencia por el contenido que alberga
—
...
(Φ
h
), urgencia (U), reactividad (R), presencia
corporal (B) y amplitud temporal subjetiva (Ts).
...
Este desplazamiento tiene implicaciones que van más allá del diálogo con Jung. Por
una parte
...
desorganización all
í donde H disminuye, aunque el relato del sujeto pueda insistir en el
carácter
“
espiritual
”
...
El núcleo metodológico del libro puede resumirse en tres decisiones. La primera es
adoptar una delimitación epistemológica estricta entre
...
deja de ser el punto de llegada y se convierte
en punto de partida para un análisis funcional.

En última instancia, lo que la THDC sugiere es que el desarrollo de la conciencia no
consiste en acumular más contenidos ni en descifrar significados cada vez má
s
complejos, sino en incrementar la capacidad del sistema para sostener aquello que ya
vive sin fragmentarse. Si este libro logra ofrecer al lector herramientas para pensar y
...
FUNDAMENTOS
EPISTEMOLÓGICOS DE LA CONCIENCIA
COMO SISTEMA HABITABLE
...
psicología analí
tica de Carl Gustav Jung han ofrecido un lenguaje extraordinariamente
rico para abordar la experiencia subjetiva, articulando patrones recurrentes mediante
conceptos como sombra, ánima o self. Esta capacidad descriptiva ha permitido
mapear regiones amplias

de la vida psíquica, especialmente en su dimensión
simbólica e imaginal.
...
de mí cuando estoy solo en casa
”;
esta formulación describe una experiencia y, por
tanto, se sitúa en el plano de la
observación. Cuando esa misma vivencia se reformula
como
“
hay un ser que me acompaña y me guía
”,
ya no estamos únicamente ante un
fenómeno, sino ante una interpretación que atribuye entidad a lo vivido. Si, además, se
considera que esa presencia constituye
...
determinado tipo de realidad psíquica o espiritual, la interpretación se convierte de
facto en una afirmación ontológica.

Este tipo de deslizamiento entre niveles convierte descripciones fenomenológicas en
afirmaciones
implícitamente ontológicas, dificultando la construcción de modelos
estructurales comparables. El problema no es exclusivo de la psicología analítica. En
distintos enfoques contemporáneos de la conciencia
—
desde el enactivismo (Varela,
Thompson y Rosch, 19
91) hasta los modelos predictivos y de inferencia activa
(Friston, 2010; Seth,
2021)
—
...
1.2 La necesidad de
una delimitación epistemológica estricta
...
El segundo nivel es el de la interpretación, que se define como la asignación de
significado a esa experiencia. En este caso, el observador introduce un marco
conceptual que no está contenido en la experiencia misma, por ejemplo al afirmar que
una emoción
corresponde a un contenido reprimido o que una imagen posee un
determinado valor simbólico. El tercer nivel es el de la hipótesis, entendida como una
proposición estructural que intenta explicar el fenómeno en términos de relaciones
funcionales y que, por
...
Uno de los efectos más relevantes de esta confusión de niveles es la
ontologización
del contenido fenomenológico. Se denomina ontologización al proceso mediante el
cual un contenido de la experiencia es tratado como si poseyera existencia
independiente, es decir, como si fuera una entidad con estatuto propio más allá de la
configuración del sistema que lo produce. Este fenómeno es especialmente visible en
...
espacio interno
”
relativamente reificado.

Desde un punto de vista estructural, este desplazamiento introduce una dificultad
crítica: impide distinguir con claridad entre el fenómeno
—
...
La atención queda fijada en el contenido simbólico (por
ejemplo,
“
mi sombra me ataca
”, “
...
Desde esta perspectiva, el análisis centrado exclusivamente en el contenido presenta
al menos
tres limitaciones fundamentales. En primer lugar, el contenido es altamente
variable: dos sistemas pueden presentar experiencias radicalmente distintas bajo
condiciones estructurales similares, de modo que el contenido, por sí solo, no
constituye una base
...
”,
mientras que, estructuralmente, el sistema se encuentra
en un régimen de alta reactividad R y baja coherencia h,
...
En coherencia con este desplazamiento, la THDC define la conciencia como un
sistema dinámico de integración de información. En este punto, el modelo se
sitúa en
...
procesos se vuelven conscientes
—
,
...
Concebir la conciencia como sistema dinámico implica, por
tanto, preguntarse por su estabilidad, su capacidad de regulación y sus márgenes de
reorganización ante distintos tipos de perturbación.
...
coherencia, regulación o integración,

ni puede reducirse a la suma de estas variables.
Más bien, se define como un criterio de segundo orden cuya función es evaluar la
capacidad del sistema para mantener su funcionamiento bajo condiciones de
perturbación. Esto implica, entre otras cosas, que
dos estados con contenido similar
pueden diferir de forma significativa en habitabilidad. Dos personas pueden atravesar
un duelo con pensamientos e imágenes parecidos
—
recuerdos del fallecido, oscilación
entre tristeza y alivio
—
,
mientras que en un caso el

sistema mantiene una coherencia
suficiente y regula gradualmente la intensidad, y en el otro se produce una progresiva
desorganización con pérdida de funcionamiento cotidiano.

Del mismo modo, dos estados con intensidad experiencial comparable pueden tener
...
1.7 Separación estructural del modelo
...
el marco de la THDC, transformació
...
1.8 Nivel de formalización del modelo
...
el punto de partida de un análisis que
busca comprender bajo qué condiciones un
determinado campo consciente resulta más o menos habitable. La cuestión central ya
no es únicamente qué se experimenta, sino qué le ocurre al sistema cuando
experimenta de determinada manera.

1.10 Conclusión del cap
ítulo
...
El capítulo anterior ha establecido la necesidad de un desplazamiento epistemológico
desde el análisis del contenido hacia la evaluación de la estructura del sistema
consciente. Se ha introducido el concepto de habitabilidad como criterio de
segundo
orden para evaluar la viabilidad de la experiencia, distinguiendo entre estados que el
...
—
como la teoría del espacio global
(Dehaene, 2014) o la teoría de la información integrada (Tononi,
2008)
—
...
el hecho de
que la experiencia no es un producto de un único componente, sino de la
configuración global del conjunto.
...
Dimensión cognitiva: incluye procesos de pensamiento, categorización y
lenguaje interno. Aquí se sitúan actividades como razonar, planificar, nombrar
lo que se vive o elaborar juicios.
...
Dimensión perceptiva: recoge la información proveniente del entorno a través
de los sentidos, así como la forma en que esta información se organiza en la
experiencia.
...
Estas dimensiones no operan como módulos independientes, sino como un sistema
acoplado. Un cambio en la
...
La primera propiedad estructural del campo consciente es su dinamicidad. Se define
como la capacidad
del sistema para modificar su configuración en el tiempo. El campo
no presenta estados estáticos: toda configuración es transitoria y evoluciona en
función de perturbaciones internas (pensamientos, recuerdos, fluctuaciones
fisiológicas) y externas (eventos
, interacciones, cambios ambientales).
...
Esto implica que el comportamiento del sistema no puede modelarse mediante
relaciones lineales simples. Fenomenológicamente, esto se observa cuando una
pequeñ
a variación en el contexto genera un cambio cualitativo en la experiencia: un
comentario menor en una conversación puede activar una cascada de recuerdos,
emociones y reacciones que transforman por completo el estado del campo
consciente. Desde el punto de

vista estructural, pequeñas perturbaciones pueden
mover al sistema a través de umbrales críticos, modificando su régimen de
funcionamiento.
...
La cuarta propiedad es la dominancia. Se define como el grado en que una dimensión
o contenido organiza la configuración del campo en un momento dado. En cada

instante, ciertos procesos adquieren preponderancia y estructuran la experiencia
global.
...
tarea cognitiva exigente puede ocupar la mayor parte de los recursos disponibles,
relegando la conciencia de sensaciones corporales o del entorno. La dominancia no
implica exclusi
ón del resto de dimensiones, pero sí determina qué elementos
organizan el campo.

2.3.5 Capacidad de integración

La quinta propiedad es la capacidad de integración. Se define como el nivel en el que
el sistema puede sostener múltiples contenidos sin generar

conflicto estructural. Un
campo con alta capacidad de integración es capaz de contener simultáneamente
emociones complejas, pensamientos divergentes y sensaciones intensas sin
fragmentarse ni colapsar.

Este concepto presenta afinidad parcial con la noción

de integración de información en
la teoría de la información integrada (IIT, Tononi, 2008), aunque la THDC lo utiliza
como criterio funcional y no ontológico. Lo relevante no es tanto la cantidad abstracta
de información integrada, sino la posibilidad de
que diferentes componentes de la
experiencia coexistan sin generar una pérdida significativa de coherencia o de
habitabilidad.

2.4 Variables estructurales del modelo

Para describir la configuración del sistema, la THDC define cinco variables
estructurales
fundamentales. Estas variables no agotan la complejidad del campo
consciente, pero proporcionan un marco operativo para evaluar su organización:
...
Presencia corporal (B)



Amplitud temporal subjetiva (Ts
)

2.4.1 Coherencia integrativa
(Φ
h)

La coherencia integrativa
(Φ
h) se define como el grado en el que los elementos del
campo consciente pueden coexistir sin generar incompatibilidad estructural.
Φ
h
elevada implica consistencia entre pensamiento, emoción y
experiencia corporal: lo
que se piensa, lo que se siente y lo que se percibe en el cuerpo resultan, en términos
generales, compatibles entre sí.

Cuando
Φ
h es baja, aparecen contradicciones internas persistentes, conflictos entre lo
que se sabe y lo que se
siente, o fragmentaciones en la vivencia del propio estado.
Por ejemplo, un sujeto puede afirmar
“
...
Aunque cierta urgencia puede ser funcional
—
por ejemplo, ante un peligro real
que
requiere una respuesta rápida
—
,
niveles crónicamente elevados de U tienden a
reducir la habitabilidad del sistema, ya que estrechan el margen de maniobra y
favorecen configuraciones reactivas menos integradas.
...
como cambios bruscos de estado,
respuestas desproporcionadas a eventos menores o dificultad para modular la
...
Este concepto
se alinea con el enfoque enactivista de la cognición corporizada (Varela
et al., 1991), según el cual la mente no puede entenderse al margen del cuerpo y de
su interacción con el entorno. Cuando B es baja, tiende a aparecer desconexión
somática, dificultad

para registrar estados internos o, en el extremo opuesto,
hiperfijación en sensaciones específicas sin capacidad de integrarlas en un contexto
más amplio.
...
Las variables del modelo no presentan un comportamiento monotónico; su
contribución a la habitabilidad depende de rangos funcionales. Esto significa que no se
trata de maximizar o minimizar de forma indiscriminada cada variable, sino de
mantenerlas dentro de intervalos que favorezcan la viabilidad del sistema.
...
R: se propone la hipótesis de una relación inversa entre
...
R: se plantea que el aumento de urgencia incrementa la
probabilidad de respuestas reactivas. Cuando el sistema percibe que
“
no hay
tiempo
”,
se reduce el margen para la integración y se favorece la respuesta
automática
.
...
regulación: se sostiene que el aumento de integración somática
favorece la regulación del sistema. Una mayor presencia corporal proporciona
señales que permiten modular la intensidad de estados afectivos y cognitivos.
...
2.7 Configuración del campo consciente

Se define la configuración del campo consciente como el estado resultante de la
interacción
de sus variables en un momento dado. Cada configuración corresponde a
una determinada combinación de valores en
Φ
...
Configuración de alta habitabilidad:
...
Configuración de baja habitabilidad:
...
2.8 Estabilidad del sistema

La estabilidad del sistema se define como
...
(Φ
h,
U, R, B y Ts) y algunas de sus relaciones funcionales más relevantes. Este marco
proporciona la base necesaria para la formalización completa de la habitabilidad en

el
capítulo siguiente, donde se abordará H como propiedad emergente del sistema.
...
FORMALIZACIÓN DE LA
HABITABILIDAD DE LA CONCIENCIA
...
el
sistema puede sostener esa experiencia en el tiempo sin entrar en colapso,
fragmentación o rigidez extrema.

Este desplazamiento sitúa el análisis en un nivel funcional comparable a los criterios
de estabilidad en teoría de sistemas dinámicos (Friston, 2010
), aunque aplicado a la
organización fenomenológica de la conciencia. La pregunta central deja de ser
“
¿qué
significa lo que ocurre?
”
para convertirse en
“
¿qué le ocurre al sistema cuando ocurre
...
Coherencia estructural suficiente
(Φ
h): el sistema mantiene compatibilidad
entre sus componentes
—
cognitivos, afectivos, somáticos, perceptivos y
narrativos
—
...
Regulación funcional adecuada (U y R en rango operativo): la urgencia y la
reactividad no se sitúan en niveles que desborden la capacidad de integración.
...
3.2.1 Naturaleza de H

Desde el punto de vista estructural, H no es una variable independiente. No existe un
“
...
La hipótesis central es que H no puede modificarse de forma directa; solo
puede
alterarse mediante cambios en las variables del sistema. No es posible
“
intervenir en la
habitabilidad
”
como si se tratara de un módulo aislado, del mismo modo que no se
puede intervenir directamente en la estabilidad de un sistema físico sin actuar
sobre
las fuerzas y condiciones que la determinan. Fenomenológicamente, esto implica que
no basta con producir experiencias subjetivamente
“
positivas
”
o
...
”
para
aumentar H: lo decisivo es cómo esas experiencias afectan a la coherencia, la
regulació
n y la continuidad del sistema.

3.3 Habitabilidad como criterio de segundo orden
...
describen la configuración del sistema en un
momento dado
(Φ
h, U, R, B, Ts).
...
Función de habitabilidad (H): evalúa la viabilidad del sistema como
propiedad emergente, derivada de la combinación de las variables
estructurales.
...
del sistema: describe la evolución temporal de H,
incluyendo procesos de transformación, estabilización, desorganización o
colapso.
...
A nivel cualitativo, pueden establecerse varias relaciones direccionales entre las
variables y H:
...
H
↓:
el aumento de urgencia, especialmente si es sostenido, reduce la
capacidad del sistema para sostener su dinámica.
...
H
↑:
una presencia corporal integrada favorece la
regulación y, por tanto, la habitabilidad.
...
más de lo mismo
”
(más presencia corporal, más continuidad temporal,
má
