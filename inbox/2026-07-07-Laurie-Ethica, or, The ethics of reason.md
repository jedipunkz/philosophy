---
source: "https://archive.org/details/ethicaorethicsof00lauriala"
title: "Ethica, or, The ethics of reason"
author: "Laurie, S. S. (Simon Somerville), 1829-1909"
year: "1891"
captured_at: "2026-07-07T10:00:57Z"
updated_at: "2026-07-07T10:00:57Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "スピノザ"
query: "Ethica"
plain_text_url: "https://archive.org/download/ethicaorethicsof00lauriala/ethicaorethicsof00lauriala_djvu.txt"
public_domain: true
...
- 著者: Laurie, S. S. (Simon Somerville), 1829-1909
- 初版: 1891
- 情報源: [archive](https://archive.org/details/ethicaorethicsof00lauriala)
- パブリックドメイン: ✓
...
AUTHOR     OF      "  METAPHYSICA     NOVA      ET     VETUSTA*
...
him  as  "a  being  endowed  with  Will,  and  hence
rational."
...
CHAP.  XI.— SELF-CONSCIOUS  ENDS  OF  VOLITION  ARE  ALWAYS
SUBJECTIVE — PROCEDURE  OF  REASON  IN  DETERMINING
ENDS— THE  LEGISLATIVE  AND  EXECUTIVE  ...  54

CHAP.  XII. — MEDIATION  OF  WILL  THROUGH  SELF-CONSCIOUS
...
The  Supreme,  Formal  End  :  (2)   The  Supreme  Real  End  .       102

CHAP.  XX. — THE   LAW  (OR  CONDITIONS  OF  HARMONY)  IN

THE  SPHERE  OF  APPETITION 114

CHAP.  XXL— THE  ALTRUISTIC  EMOTIONS— TERMINAL  AND
END— QUALITY  AND  QUANTITY  GENERALLY,  DISCUSSED
— IDEA  IN  RELATIONS 130

CHAP.  XXII.— ALTRUISTIC  EMOTIONS  (continued)— QUANTITY
...
ISM AND  EXTERNALISM 156

CHAP.  XXIV. — ALTRUISTIC  EMOTIONS  AND  JUSTICE  (Re-
capitulation). HEDONISM  AS  CRITERION  ....  169
...
CHAP.  XXVIII.— STATE    ACTION    IN    RELATION    TO    THE

ETHICAL  IDEAL 210

CHAP.  XXIX.— EMOTIONS  OF  REASON 234
...
CHAP.  XXXIV.  — SUBJECTIVE  AND  OBJECTIVE  ETHICS — Self-
reference  of  the  Moral  Act  273

CHAP.  XXXV.— THE  CHIEF  GOOD 284

CHAP.  XXXVI.  —LAW  IN  ITS  TWOFOLD  SENSE— MORAL  ORDER  289

CHAP.  XXXVII.— NATURALISM  AND  THE  IDEA      .  292

CHAP.  XXXVIH.-FREE-WILL 298
...
round  and  look  on  Man  ab  extra,  regarding  him  as  one
...
If  our  examination  of  him  were  entirely  db  extra,  we
...
of  observation  arid  dissecting-knife  is  in  his  own  self-
...
either  as  analysts  or  as  historians.1

1  Even  in  the  hands  of  Mr.  Spencer,  ethical  evolution  is  the
...
CHAP.  I. — IDEAS   GENERALLY — MOKAL   IDEAS   AND   THEIR
...
=x,  of  justice  =  x,  x  being  an  attempt  to  make  explicit
...
the  affirmation  of  what  we  have  accurately  (dare  et  dis-

6  Ethica.

tiiicte)  seen  is  a  true  affirmation  or  an  affirmation  of  the
...
legitimate  content  of  will  in  willing1  or  volition.  How
...
1  The  distinction  between  will  and  willing  will  be  considered  in
the  sequel.

Impulse  to  realise  the  Good.  9

by  the  doing.  And  this  for  the  simple  reason  that  (to
begin  with,  for  we  are  of  course  not  speaking  of  trans-
...
none  the  less  Ms  pleasure.  To  say,  however,  that  he
...
basis  of  his  judgment  of  the  character  of  the  volition.1
...
Further,  by  way  of  anticipation,  le.t  me  say :  The
...
The  End  of  Man  is  Self-realisation.       13

same  time,  least  of  all  begs  a  solution  of  ethical  questions.
...
Judgment,  and  Seasoning.  If  this  be  so  even  of  the
...
self-realisation — the  law  of  my  organism — require  that
...
vious treatise)  I  mean  realisation  of  self  by  self.

2o  Ethica.

CHAP.   IV. — NOTION   AND   IDEAS — KNOWLEDGE    OF   MAN —
HIS  DUAL  NATURE  :  (a)  THE  ATTUENT  MAN  :   (6)  THK
RATIONAL  MAN.
...
of  feelings  is  the  Real  in  man.  As  attuent  merely,  he
...
CHAP.  VI. — WILL-REASON  DOES  NOT  do  :  IT  ONLY  acts.
...
affirms,  and  it  does  so  by  subsuming  the  object — i.e.
...
isation  is  utterance  (0w£erance)  or  Speech.
...
end  ; x  but  the  actual  willing,  the  passing  of  the  will
...
1  This  is  further  explained  in  the  sequel.

Will-reason  does  not  do  it :  it  only  acts.    3 1

element  of  personality,  acts  in  the  affirmation  of  the
...
as  Kinetic  initiation.1  I  say  this  Personality  of  which
...
1  Vid.  previous  Treatise.

3  2  Ethica.

CHAP.    VII. — MAN   AS   AN   OBJECT   OF    INVESTIGATION:    HE
HAS  TO   CONSTITUTE   HIS  OWN  ETHICAL   OKGANISM —
...
harmony.  The  latter  indicates  wherein  the  good  for
...
CHAP.  VIII. — SUPEEME  END  IS  THE  EGO  ITSELF,  AND  IS
FORMAL — THE  CRITERION  OF  THE  REAL  END  IS  HAR-
MONY IN  FEELING.
...
The  formal  in  man,  'before  the  subject  rises  through  the
...
Supreme  End  the  Ego  itself  and  is  Formal.  37
...
and  thus  fulfils  the  law  of  his  being.
...
CHAP.  IX. — THE  OBJECT  OF  HUMAN  VOLITION  IS  REASON-
GIVEN  LAW;  FOE  HARMONY  IS  POSSIBLE  ONLY
THROUGH  LAW.
...
of  the  form  of  end  at  the  heart  of  it.1  All  men,  as
...
.  J  mere  sensibility,  there  is  in  man's  rational  organism  a
...
history  and  in  the  reflective,  must,  in  its  search  for  la\v
...
Desire  perhaps  might  be  denned  as  a  feeling  so  intense
...
Under  the  stimulus  of  the  a  priori  form  oi  end,  it  con-
...
must  precede  all  rational  doing.  Kational  doing  (as
...
Thus  man  as  a  reason  must  first  seek  the  truth  of  know-
...
right.  This  consciousness  may  be,  and  will  be,  Aveak  in
...
Rationality  the  Ground  of  Morality.       53
...
CHAPTER  XL — SELF-CONSCIOUS  ENDS  OF  VOLITION  ARE
ALWAYS  SUBJECTIVE — PROCEDURE  OF  REASON  IN
...
the  life  of  man.  The  external  object  and  act  througli
...
therefore  the  true  motive ;  that  is  to  say,  before  the
...
the  end  that  moves  me  to  volitionise.1
...
discriminating  and  affirming  the  truth  or  Tightness
...
desires  and  emotions  of  the  attuent  subject.  Will-
...
acts  within  the  sphere  of  reason,  but  it  does  riot  do.  It
merely  affirms  Tightness  in  doing,  truth  in  doing,  and
guarantees  that  Tightness  and  truth.  It  is  the  sove-
...
and  through  this  idea.1

1  The  question  of  subjectivity  will  be  further  considered  in  the
sequel.
...
moral  beings.  But  we  are  only  as  yet  dealing  witli
...
phrase  reXo?  reXetoy.  The  question  now  is,  wherein
...
ledge when  what  we  already  possess  suffices.1
...
1  The  sense  in  which  we  have  a  "  moral  sense  "  will  be  explained
in  the  sequel.
...
utilitarianism,  i.e.  it  determines  the  moral  character  of
...
and  what  he  ought  to  le.  I  must  find  the  law  in  man
...
number  but)  of  all  men.  (6)  The  greatest  happiness
...
its  sweep  the  diffusion  of  universal  well-being.  I
...
— his  own  self-realisatipn  as  man — the  fulness  and
preservation  of  his  own  distinctive  life.  It  is  a  mis-
take then  to  regard  the  State  or  the  social  organism1
...
1  In  what  sense  an  "  organism  "  we  shall  consider  in  the  sequel.
...
of  the  TeA.09  or  good  for  man,  we  must  regard  him —
...
CHAP.  XIV. — THE  END  Oil  GOOD  FOR  MAN  BEING  LAW  IN
SENSIBILITY,  THE  DOCTKINE  HEEE  EXPOUNDED  IS  NOT
...
&kgr that  the  criterion  is,  therefore,  subjective  is  in  a  sense
...
in)  reason.  Hence  the  name  Ethics  of  Reason.

74  Ethica.

CHAP.  XV. — DOES  LAW  INSTRUCT  AS   TO  ENDS  ? —
...
internal  or  subjective  one ;  but  yet  objective.1
...
be  made ;  which  affirmation  is,  "  This  is  right — this  is
...
made ;  which  affirmation  is  the  utterance,  "  TJiis  is

1  Of  this  again  in  the  sequel.
...
which,  qud  law,  is  stronger  or  more  imperative  than
...
Does  Law  instruct  as  to  Ends  ?          77

to  be  greater  in  one  case  of  immorality  than  in  another  :
...
on  to  say,  "  Thou  oughtest  to  do  a  and  not  I"  then  our
...
~by  reason ;  but  it  is  not  in  reason  nor  through  reason
...
can  be  universally  valid.  How  can  we  tell  this,  until
...
as  we  have  shown  in  our  criticism  of  iutuitionism,  it
cannot  do.

Kant  is,  however,  unquestionably  (as  I  have  said)  so

Does  Law  instruct  as  to  Ends  f          83
...
before  which  it  bows  in  reverence — must  bow,  or  its
...
CHAP.   XVI. — LAW   IS   IMPLICIT   IN   THE   IDEA   OK   END.
...
them.  No  doubt  the  end  is  the  total  of  the  thing — the
...
which  it  is  the  business  of  empirical  psychology  to
make  adequate.
...
end  of  the  thing — its  idea,  reXo?,  essence.
...
The  essential  characteristic  (let  me  repeat  usqiie  ad
...
pears, when  we  regard  man  db  extra  and  deal  with
...
Season,  contains  implicitly  the  law,  it  may  be  asked
...
'beginning  ivith  principles,  and  that  this  is  the  foundation
...
13ut  all  the  while,  if  our  prior  metaphysical  investi-
gation be  sound,  it  is  not  happiness  which  man  is  seek-
ing for,  but  law  as  the  condition  and  prius  of  self-
realisation.  None  the  less,  the  only  happiness  possible
for  man  always  attends  on  the  fulfilment  of  law — the
...
in  the  whole  range  of  sense-phenomena  (a,  posteriori
categories).
...
Moral  Law  is  the  Object  of  Search.     101
...
CHAP.  XIX. — THE  END  OF  MAN,  FOEMAL  AND  KEAL.
...
emotions  of  reason1  can  give  real  content:  but  I  am
...
ascertains  them,  has  the  further  task  imposed  on  it  of
...
in  that  object  for  that  object ;  in  the  case  of  man  they
are  determined  in  him  ly  himself.  Shall  this  or  that
...
the  dynamical  inter-relations,  a1,  &2,  <?,  whereby  the

The  Formal  and  Real.  1 09

statical  elements  a,  I,  c,  constitute  or  make  possible  the
...
a4  or  a2,  the  "  thing  "  would  disappear,  it  would  be  some
...
relations  between  elements  of  the  same  quality  but
differing  in  quantity,  a1,  «2,  a3,  the  rightful  activity  of
«3  may  involve  the  repression  and  consequent  pain  of  a1
and  a2 ;  if  there  be  a  difference  in  higher  and  lower
quality,  then  a  must  yield  to  5  and  b  to  c,  thereby
involving  pain  to  a  and  b  in  order  that  the  resultant
...
in  it.  [See  sequel — Emotions  of  Reason.]
...
satisfaction  of  reason.  For  the  affirmation  of  the  con-
...
precede  the  perception  of  law,  but  it  cannot  arise  save
...
can  the  total  notion  of  Man  he  fulfilled  for  each  man  :
...
self and  seek  what  is  useful  to  himself" — quod  revera
utile  est  (Ft.  iv.,  18.  8.),  et  id  omne  quod  hominem
...
exception  to  either.1  Such  generalisations,  however,  do
...
visional presumption  that  they  alone  exist  in  man.
...
The  Sphere  of  Appetition.  1 1 7
...
pleasure  in  more  refined  forms.  Reputable  acts  may
...
End  in  the  Sphere  of  Appetition.        T  2 1
...
Temperance  or  Self-control — a-wfypoa-vvr),  in  the  more
...
resides — there  found  by  reason,  and  by  reason  affirmed.1
...
enters  the  emotion  of  law  obeyed,  duty  done.2
...
1  See  sequel — Emotions  of  Reason.  2  Ibid.

128  Etkica.

wrong,  because  the  law  is  an  objective  fact  not  depen-
dent on  the  pathological  variations  of  any  individual,1
...
Thus  Freedom,  Eeason,  Law,  Duty,  are  involved  one
...
1  "Conduct,"  says  Mr.  Spencer,  "is  good  or  bad  according  as
...
not,  it  is  scarcely  necessary  to  add,  of  a  moral  faculty,  which  is  the
...
CHAP.  XXI. — THE  ALTKUISTIC  EMOTIONS — TERMINAL  AND
...
Altruistic  Emotions.  131

munity  of  being  with  other  existences ;  and  further,  as
...
as  such  only  quantitative  differences.  But  the  content
...
conscious  that  it  involves  tlie  wellbeing  of  others  as  well  as
...
and  therefore  divine,  right,  control  the  lower.1  But,
...
1  Mr.  Spencer  assigns  an  intrinsic  authority  to  what  he  calls
...
life  in  and  through  nature  and  other  men.  It  is  thus
...
pelled to  ask  the  question :  What,  nmv,  are  the  conditions
...
an  organism  may  be  such  that  the  various  elements  that
...
tion— realisation  of  self  ly  self,  or,  to  put  it  otherwise,
...
Finally,  man  being  an  organism,  the  domiuancy  of  any
...
Altruistic  Emotions.  147

CHAP.  XXII. — ALTKUISTIC  EMOTIONS  (continued)  :  QUAN-
...
possess  ab  initio  a  mass  or  quantity  in  extension
...
depends.  The  prima  mtce  claim  him,  engaged  as
...
Altruistic  Emotions — Benevolence.      1 5 1
...
is  itself  further  evidence  of  the  existence  of  the  feeling.1
...
1  We  are  not  concerned  here  with  abnormal  cases  of  pure  malig-
...
as  that  suppression  is  justified  to  a  man's  conscience
...
For  it  is  precisely  the  deep  sentiment  of  humanity  as  a
...
of  self,  plus  sympathy  with  other  selves,  would  not,
...
the  sentiment  and  idea.  It  is  impossible,  we  said,  for
...
grow,  jus  must  grow  with  them,  or  the  forces  of  society
...
motives  be — rational  or  eesthetic  or  religious — is  an
...
(Recapitulation).       HEDONISM  AS  CRITERION.
...
Moral  Question  an  Inner  Question.      1 7 1
