---
source: "https://archive.org/details/dialoguesplato11jowegoog"
title: "The dialogues of Plato"
author: "B. Jowett"
year: "1876"
captured_at: "2026-07-17T08:21:42Z"
updated_at: "2026-07-17T08:21:42Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ソクラテス"
query: "Plato Crito"
plain_text_url: "https://archive.org/download/dialoguesplato11jowegoog/dialoguesplato11jowegoog_djvu.txt"
public_domain: true
...
- 著者: B. Jowett
- 初版: 1876
- 情報源: [archive](https://archive.org/details/dialoguesplato11jowegoog)
- パブリックドメイン: ✓
...
MASTBS    OF    BALLIOL    COLLBCB

BBOIUB    rBOPBMOK   OF   GUIICK    IM    THK     UNIVKBSITY   OP    OXFOKO

DOCTOR   IM    THBOLOOT   OP  THE   UNIVBKSITY   OP   LBYDBN
...
nSEJ>   AND    CORRECTED   THROUGHOUT,    WITH  MARGINAL  ANALYSES
...
Preu  of  J.  J.  I  Jttte  *  Co.,  Astoc  Ftocc.  New  Yock
...
'  MiJller's    German    Translation    of    Plato    with    Introduc-

tions ;  Zeller's  '  Philosophie  der  Griechen/  and  *  Pla-
tonische    Studien;'    Susemihl's  *  Genetische   Entwickelung

I  der    Platonischen    Philosophie ;  '     Hermann's    *  Geschichte

der     Platonischen     Philosophie ;  '       Bonitz,      '  Platonische

i  Studien ;  '    Stallbaum's    Notes    and    Introductions ;     Pro-
...
Dialogues,  and  is  rich  in  original  thoughts  and  obser\'a-
...
portion  of  this  work  he  will  probably  remark  that  I  ha\e

Preface  to  the  First  Edition,  xi

aj^desi-^voured  to  approach  Plato  from  a  point  of  view  which

is  opIX)sed  to  his  own.     The  aim  of  the  Introductions  in

thes^     volumes  has  been  to  represent  Plato  as  the  father  of

idealism,  who  is  not  to  be  measured  by  the  standard  of

utiUtsi-rianism  or  any  other  modem  philosophical  system.

He  is  the  poet  or  maker  of  ideas,  satisfying  the  wants  of

his   o-wn  age,   providing  the    instruments  of   thought  for

iutiire  generations.     He  is  no  dreamer,  but  a  great  philo-

sopKical  genius  struggling  with  the  unequal  conditions  of
...
drus,  or  Symposilim,  when  compared  with  the  Laws.     He
...
Ix  publishing  a  Second  Edition  (1875)  of  the  Dialogues
...
'  Dedication  to  the  ^^neis.

Preface  to  the  Second  and  Third  Editions.         xv

^orVc,  of  what  has  preceded  and  of  what  is  to  follow, —  as
vjeW   as  of  the  meaning  of  particular  passages.     His  version
sYvoiild  be  based,  in  the  first  instance,  on  an  intimate  know-
...
Mghten  a  cumbrous   expression   (cp.   Symp.    185   D,   197,
'98).     The    translation   should    retain    as   far  as   possible
^e  characteristic    qualities    of    the    ancient    writer  —  his
^''eedom,   grace,    simplicity,   stateliness,   weight,    precision ;
^^  the  best  part  of  him  will  be  lost  to  the  English  reader.
^^  should  read  as  an  original  work,  and  should  also  be  the
''^^st  faithful  transcript  which  can  be  made  of  the  language
''oni  which  the  translation  is  taken,  consistently  with  the
'^t  requirement  of  all,  that  it  be  English.     Further,  the
'"^nslation  being  English,  it  should  also  be  perfectly  intel-
&*ble  in  itself  without  reference  to  the  Greek,  the  English
^ing^really  the  more  lucid  and  exact  of  the  two  languages.
^    some    respects    it    may    be    maintained    that    ordinary
"'^glish  writing,  such  as  the  newspaper  article,  is  superior
^    Plato:   at  any  rate  it  is  couched  in  language  which  is
^ry    rarely    obscure.     On    the    other    hand,    the    greatest
^^'^ters  of  Greece,  Thucydides,  Plato,  iCschylus,  Sophocles,
"^ndar,  Demosthenes,  are  generally  those  which  are  found
...
is  not  held  in  much  honour  by  the  worid  of  scholars ;  yet
...
where  the  Greek  repeats  akXa  or  yap.  There  is  a  similar
want  of  particles  expressing  the  various  gradations  of
objective  and  subjective  thought  —  ttov,  d^,  /t^^v,  fievroi,  and
...
modem  languages  than  in  ancient.  Both  sentences  and
paragpraphs  are  more  precise  and  definite  —  they  do  not  run
...
poetry  or  prose ;  it  was  i{oXXf\q  Tveipag  TeXevralov  ency^wrf^.
...
is  rarely  to  be  found  in  modem  nations;  and  in  order  to
bring  the  Greek  down  to  the  level  of  the  modem,  we
...
feeling  of  the  modem  language  is  more  opposed  to  tau-
...
An.c3  the  evasion  of  tautology  —  that  is,  the  substitution
ot  one  word  of  precisely  the  same  meaning  for  another — is
...
or  cJeamess  can  we  allow  an  important  word  to  be  used
...
of  the  whole  work.  Equability  of  tonq  is  best  attained
...
"been  laid  aside  and  have  dropped  out  of  use.  (^)  A  similar
...
it  in  a  sense  not  intended  by  the  author,  (r)  Another
...
iiv  k.€l\  vvv  sTi  ofuicpa  dveipara  kiXeiTTTai ;   Rep.  i.  345   E ;   ix.
588  C,  &c.     Or  again  the  modem  word,  which  in  substance
is   the  nearest  equivalent  to  the  Greek,  may  be  found  to
include   associations   alien   to    Greek    life:    e.  g.  ducaoTal,
•  jurymen,'  to.  fiiaa  rdv  TroAirwr, '  the  bourgeoisie,'     (d)  The
...
t^or    example,   in   translating   Plato,   it   would    equally  be
...
why  in  the  New  Testament  6ncaioavvri  should  always  be
rendered  'righteousness,'  or  d/a^itty  '  covenant*  In  such
cases  the  translator  may  be  allowed  to  employ  two  words
—  sometimes  when  the  two  meanings  occur  in  the  same
{>assage,  varying  them  by  an  '  or ' —  e.  g.  imaTfjfii]^  '  science '
or  '  knowledge,*  c2doc,  '  idea '  or  '  class,'  a(»><t>po(jvvr]^  *  tem-
...
d'  5c,  ctTTc,  €07/,  &c.,  which  Cicero  avoided  in  Latin  (de
...
tions familiar  to  the  modems,  which  have  no  place  in
...
one  and  continuous  (as  has  been  affirmed  with  more  tmth

VOL.    I. — C

xxvi      Preface  to  the  Second  and  Third  Editions,

respecting  ancient  and  modem  history),  for  they  are
...
strong  opinion  at  variance  with  Mr.  Grote's,  that  th^
so-called  Epistles  of  Plato  were  spurious.  His  frientS:
and  editor,  Professor  Bain,  thinks  that  I  ought  to  giv«^
the  reasons  why  I  differ  from  so  eminent  an  authorit)^^
Reserving  the  fuller  discussion  of  the  question  for  anoth^s
place,  I  will  shortly  defend  my  opinion  by  the  foUowii
arguments: —

{a)  Because    almost   all    epistles   purporting    to   be
the  classical  age  of   Greek  literature   are   forgeries  i.
all  documents  this  class  are  the  least  likely  to  be  preserve
and  the  most  likely  to  be  invented.     The  ancient  worl
swarmed    with    them ;    the   great    libraries   stimulated
demand  for  them ;   and  at  a  time  when  there  was  no  regul
publication  of  books,  they  easily  crept  into  the  world.

(^)  When   one    epistle   out   of    a   number    is   spurious
the    remainder   of   the    series    cannot    be    admitted    to  be
genuine,    unless    there    be   some    independent    ground    fo
thinking  them  so:    when  all  but  one  are  spurious,  ovei
whelming  evidence   is  required  of  the  genuineness  of  t!
one:    when  they  are  all  similar  in  style   or  motive,   Ij
...
'  Compare  Bentley's  Works  (Dyce's  Edition),  vol.  ii.  136  foil.,  2

Preface  to  the  Second  and  Third  Editions,     xxvii

Greek  antiquity  of  a  series  of  Epistles,  continuous  and
yti  coinciding  with  a  succession  of  events  extending  over
a  great  number  of  years.

The    external    probability    therefore    against    them    is
enormous,    and    the    internal   probability   is  not   less:    for
tlxcy  are  trivial  and  unmeaning,   devoid  of  delicacy  and
sultlety,  wanting  in  a  single  fine  expression.     And  even
vf     this  be  matter  of  dispute,  there  can  be  no  dispute  that
tWcre  are  found  in  them  many  plagiarisms,  inappropriately
t>o>rrowed,  which  is  a  common  note  of  forgery  (compare
330C  foil,  with  Rep.  iv.  425  E,  426  B,  vi.  488  A:   347  E
A^^th  Phaedrus  249  D :   326  A,  B  and  328  A  with  Rep.  v.
-4-73  C,  D,  &c.).     They  imitate  Plato,  who  never  imitates
either    himself   or    any    one    else;     reminiscences   of    the
Itepublic  and  the  Laws  are  continually  recurring  in  them ;
...
M  of  egotism,  self-assertion,  affectation,  faults  which  of
^  writers  Plato  was  most  careful  to  avoid,  and  into  which
...
vronguses  of  words  (ib.  pp.  58,  59,  117,  121).     They  also
contain  historical  blunders,  such  as  the  statement  respect-
"^g  Hipparinus  and   Nysaeus,  the  nephews  of  Dion  (328
...
JKJt  have  been  more  than  six  or  seven  years  of  age  —
2lso  foolish    allusions,    such   as    the    comparison    of    the
...
certain  inferior  magistrates,  making  them  in  all  fifty-on<
...
they  took,  at  diff'erent  times  in  his  life,  two  essentially
...
A«n  he  substituted  imitation  of  them  (xi.  292).  To  quote
...
the  Pamienides  and  the  Philebus,  it  is  proposed  to  pass
...
be  expressed  under  a  different  form  by  the  Trepof  and  1
dneipov  of  the  Philebus  (vol.  x.  275  foil.).  The  iripag
the  Philebus  is  the  principle  which  gives  form  and  measi
to  the  dneipov ;  and  in  the  '  Later  Theory  *  is  held  to  be  1
TToaov  or  fierpiov  which  converts  the  Infinite  or  Indefir
into  ideas.  They  are  neither  nepaivovra  nor  aneipa,  1
belong  to  the  lutcrdv  yevo^  which  partakes  of  both.

With  great  respect  for  the  learning  and  ability  of  ]
Jackson,  I  find  myself  unable  to  agree  in  this  ne\
...
(i).  First,  the  foundation  of  his  argument  is  laid  in  t
Metaphysics  of  Aristotle.  But  we  cannot  argue,  eiti
from  the  Metaphysics,  or  from  any  other  of  the  phi
sophical  treatises  of  Aristotle,  to  the  dialogues  of  PI;
until  we  have  ascertained  the  relation  in  which  his  \
called  works  stand  to  the  philosopher  himself.  There
of  course  no  doubt  of  the  great  influence  exercised  up
...
his  writings  have  not  come  down  to  us  in  an  authei
form  like  most  of  the  dialogues  of  Plato.  How  much
them  is  to  be  ascribed  to  Aristotle's  own  hand,  how  mi
...
—  Ha€c  mm  sunt  Aristotelis^  tamen  utitur auctor  Aristotelis  nomine  tanquam  suo.
...
agreement  with  modem  terminology,  in  the  latter  half.
...
limit,  eternity,  essence  (cp.  Philebus  sub  Jin. ;  Timaeus
...
>vhich    troubled    the    pre-Socratic    philosophy    and   came

to    the    front    in   Aristotle,    are   variously    discussed   and

^^plained.     Thus  far  we  admit  inconsistency  in  Plato,  but

^^  further.     He  lived  in  an  age  before  logic  and  system

had  wholly    permeated  language,  and  therefore  we   must

not  always  expect  to  find  in  him  systematic  arrangement

or  logical  precision:  — ' poema  7nagis  putandum.'     But  he
...
who  believe  Plato  to  have  been  a  mystic  or  to  have  had  j
...
'  Sec  J.  of  Philol.  xiii.  38,  and  elsewhere.
...
final  ones  by  tracing  their  connexion  with  the  summutn
genuSy  the  dyaSov^  in  the  Parmenides  his  aspirations  are
...
the  modem  physical  philosopher,  and  the  more  acceptable
...
157  B-i  59  E) '  in  the  smallest  degree  prove  his  point ' ;  and
...
notions  (Theaet.  1 76  E  ;  Parm.  1 30  B  foil. ;  Soph.  254  B  foil.,
...
The  subject  of  the  Charmides  is  Temperance  or  au^poai/vtf,  a  cAarmides.
...
'  makes  a  man  his  owii  master,'  according  to  the  definition  of  the  Re-
public (iv.  430  £).  In  the  accompanying  translation  the  word  has
...
Plato  ou^poci'vrj  still  retains  an  intellectual  element  (as  Socrates  is
also  said  to  have  identified  au^pooifinj  with  ao^ia :  Xen.  Mem.  iii.  9,
4),  and  is  not  yet  relegated  to  the  sphere  of  moral  virtue,  as  in  the
Nicomachean  Ethics  of  Aristotle  (iii.  10).

The  beautiful  youth,  Charmides,  who  is  also  the  most  temperate     Analysis.

159  of  human  beings,  is  asked  by  Socrates,  'What  is  Temperance?'

160  He  answers  characteristically,  (i) 'Quietness.'  *  But  Temperance
...
6 1  application  of  Homer :  for  temperance  is  good  as  well  as  noble,
and  Homer  has  declared  that  '  modesty  is  not  good  for  a  needy
man.'    (3)  Once  more  Charmides  makes  the  attempt.     This  time

62  be  gives  a  definition  which  he  has  heard,  and  of  which  Socrates
...
and  temperance  defined  thus  would  be  opposed  to  the

1  Cp.  Cic.  Tusc.  iii.  8.  16.  'v«4po^yn,  quam  soleo  equidem  turn  temperan-
iam,  turn  moderationem  appellare,  nonnunquam  etiam  modestiam :  '  foil.

4  Analysis  162-174.

CAarmides.      division  of  labour  which  exists  in  every  temperate  or  well-ordered
Analysis.       State.     How  is  this  riddle  to  be  explained?

Critias,  who  takes  the  place  of  Charmides,  distinguishes  in  his  163
answer  between  'making'  and  Moing/  and  with  the  help  of  a
misapplied  quotation  from  Hesiod  assigns  to  the  words  '  doing '
and  *  work '  an  exclusively  good  sense :  Temperance  is  doing  one's
own  business ;  — r  (4)  is  doing  good.
...
Iaxm.  ^  0.  ijr»<.         what  he  does  not  know.     But  this  is  contrary  to  analogy ;  there  is
ifo^>f^  ^^  vision  of  vision,  but  only  of  visible  things ;  no  love  of  loves,  but

[  only  of  beautiful  things ;  how  then  can  there  be  a  knowledge  of

knowledge  ?   That  which  is  older,  heavier,  lighter,  is  older,  heavier,   |5^
...
itself,  how  does  the  knowledge  of  what  we   know  imply  the  1 70
...
which  temperance  gives  must  be  of  a  kind  which  will  do  us  good;   1^3
for  temperance  is  a  good.     But  this  universal  knowledge  does  not
tend  tp  our  happiness  and  good :  the  only  kind  of  knowledge  which
brings  happiness  is  the  knowledge  of  good  and  eviL     To   this  |«j
Critias  replies  that  the  science  or  knowledge  of  good  and  evO,  and
...
1 76  had  therefore  better  rest  in  the  knowledge  that  the  more  temper-
...
Tbracian;  (3)  The  tendency  of  the  age  to  verbal  distinctions,
...
*  that  you  know,'  d  d6tv  and  hn  ciSev;  here  too  is  the  first  conception
of  an  absolute  self-determined  science  (the  claims  of  which,
however,  are  disputed  by  Socrates,  who  asks  cut  bono  f)  as  well  as
...
things'  (Rep.  i.  354).  (7)  And  still  the  mind  of  Plato,  havirs^
...
youth  Charmidesy  with  whom  Socrates  talks  in  the  kindly  spirit  of
...
is  in  the  neighbourhood  of  several  great  truths,  which  he  views  in   Ckarmides.
...
and  partially  true,  Uke  the  first  thoughts  of  an  intelligent  youth ;
the  third,  which  is  a  real  contributioi)  to  ethical  philosophy,  is
...
of  ou^poaiwi.  Hence  we  see  with  surprise  that  Plato,-  who  in  his
...
senses  of  the  word  au^poaiv^f  or  temperance.  From  the  ethical
...
dialogue  passes  on  to  the  intellectual  conception  of  au^poaivti,
...
of  philosophy  in  which  knowledge  and  action  were  not  yet  dis-  j  ^^*'«*''^  .^^./-^^.'^^
tinguished.  Hence  the  confusion  between  them,  and  the  easy  ***«,''''*'•-<'  .
transition  from  one  to  the  other.  The  definitions  which  are
ofiered  are  all  rejected,  but  it  is  to  be  observed  that  they  all  tend
to  throw  a  light  on  the  nature  of  temperance,  and  that,  unlike  the
distinction  of  Critias  between  iroulv,  wpdrreiv,  kpyal^eadai^  none  of
...
8  Place  of  the  Charmides  among  the  Dialogues.

to  a  young  man  who  is  disturbed  by  theological  difficiilties,
Intioduc       not  trouble  yourself  about  such  matters,  but  only  lead  a  good
TioK.  im^  y^  In  either  case  it  is  not  to  be  denied  that  right  ideas  of
...
catalogue  of  the  Platonic  writings,  though  they  are  not  concli
No  arrangement  of  the  Platonic  dialogues  can  be  strictly  ch
logicaL  The  order  which  has  been  adopted  is  intended  ir
for  the  convenience  of  the  reader ;  at  the  same  time,  indicati(
the  date  supplied  either  by  Plato  himself  or  allusions  found  i
dialogues  have  not  been  lost  sight  of.  Much  may  be  said  aboi
...
particular  knowledge  in  this  dialogue  may  be  compared  in
...
^CENS : — The  Palaestra  of  Taareas,  which  is  near  the  Porch  of  the

King  Archon.

'^^•^^VESTERDAY  evening  I  returned  from  the  army  at  Poti-  charmidn.

M.     daea,  and  having  been  a  good  while  away,  I  thought  chabrbphon,

^^^^i-t  I  should  like  to  go  and  look  at  my  old  haunts.     So  I  Socratbs.

^^nt  into  the  palaestra  of  Taureas,  which  is  over  against  the  Socrates,

^  who  has

^^-■Japlc  adjoining  the  porch  of  the  King  Archon,  and  there  I  just  re-

^o-ixnd  a  number  of  persons,  most  of  whom  I  knew,  but  not  all.  ^^^  ^

^^  y  visit  was  unexpected,  and  no  sooner  did  they  see  me  visits  his

^•^^ering  than  they  saluted  me  from  afar  on  all  sides ;  and  ow  fiends

^^-■^i-aerephon,  who  is  a  kind  of  madman,  started  up  and  ran  to  them  the

seizing   my   hand,  and  saying.  How  did   you   escape,  2I7Ir^"*at

tes? — (I  should  explain  that  an  engagement  had  taken  Potidaea.
ce  at  Potidaea  not  long  before  we  came  away,  of  which  the
...
TTiat,  I  replied,  was  not  far  from  the  truth.
^  suppose,  he  said,  that  you  were  present.
I  was.
...
chartmd£9,  Critlas  the  soii  of  Callaeschrus,  and  when  I  had  saluted  him

SocKATBs,  and  the  rest  of  the  company,  I  told  them  the  news  from  the

Crttias,  army,  and  answered  their  several  enquiries.

„          .  Then,  when  there  had  been  enough  of  this,  I,  in  my  tiun,

He  proceeds

to  make  en-  began  to  make  enquiries  about  matters  at  home — about  the
ouiries  about  present  state  of  philosophy,  and  about  the  youth.  I  asked
phHosophy  whether  any  of  them  were  remarkable  for  wisdom  or  beauty,
*outh^and*u  ^'^  hoth.  Critias,  glancing  at  the  door,  invited  my  attention
told  of  the  to  some  youths  who  were  coming  in,  and  talking  noisily
...
tmned  and  looked  at  him,  as  if  he  had  been  a  statue.
...
The  beautiful  Chamtides.  ii

But  you  would  think  nothing  of  his  face,  he  replied,  if  you  ckarmidu.
could  see  his  naked  form :  he  is  absolutely  perfect.  Socratbs,

And  to  this  they  all  agreed.  CRrT^"""**
...
Then,  before  we  see  his  body,  should  we  not  ask  him  to  whoieaouib
show  us  his  soul,  naked  and  imdisguised?  he  is  just  of  an  ^^  ^
age  at  which  he  will  like  to  talk.

That  he  will,  said  Critias,  and  I  can  tell  you  that  he  is  a
philosopher  abready,  and  also  a  considerable  poet,  not  in
...
and  me.     Great  amusement  was  occasioned   by  every  one  ^^^"^^^an^j
...
The  cure  of  Zamolxis.  '3

the  part  together.     Did  you  ever  observe  that  this  is  what  ckarmitUt.
they  say?  Socratbs,

Yes,  he  said.  Char-ide..
...
21amolxis,  he  added,  our  king,  who  is  also  a  god,  sa3rs  further,
...
J  7  the  eyes.  And  therefore  if  the  head  and  body  are  to  be  well,
...
ment of  the  human  body,  that  physicians  separate  the  soul  «'^y '"  '''"*
...
Then  let  me  tell  you  that  he  is  the  most  temperate  of  himian
...
spning.  There  is  your  father's  house,  which  is  descended
...
distinguished;  for  yoiu"  maternal  uncle,  Pyrilampes,  is  re-
...
the  truth  of  what  Critias  has  been  saying ; — ^have  you  or  have  ckarmides,
you  not  this  quality  of  temperance?  Socrates,

Channides  blushed,  and  the  blush  heightened  his  beauty,  C"^***""'**-
for  modesty  is  becoming  in  youth ;  he  then  said  very  ingenu-  ^***  modest
ously,  that  he  really  could  not  at  once  answer,  either  yes,  or  channides.
...
I  said  to  him :  That  is  a  natiu-al  reply,  Charmides,  and  I
...
I  think,  I  said,  that  I  had  better  begin  by  asking  you  a  a  question
question ;  for  if  temperance  abides  in  you,  you  must  have  an  ^"'^5^,^^.
opinion  about  her;   she  must  give  some  intimation  of  her  what u it?
nature  and  quahties,  which  may  enable  you  to  form  a  notion
of  her.     Is  not  that  true?

Yes,  he  said,  that  I  think  is  true.

You  know  yoiur  native  language,  I  said,  and  therefore  you
...
then  he  said  that  he  thought  temperance  was  doing  things  FintdefinU
...
and  difficulty  in  learning  is  learning  quiedy  and  slowly?
...
-AaA  is  not  shrewdness  a  quickness  or  cleverness  of  the  sooum,
o«l,  and  not  a  quietness?  Ch*«udm.

True.

^And  is  it  not  best  to  understand  what  is  said,  whether  at
"K^s  writing-master's  or  the  music-master's,  or  anywhere  else,
Ki^c  as  quietly  as  possible,  but  as  quickly  as  possible?

^es.

.^nd  in  the  searchings  or  deliberations  of  the  soul,  not  the
■JAxetest,  as  I  imagine,  and  he  who  with  difficulty  deliberates
r:K«i  discover,  is  thought  worthy  of  praise,  but  he  who  does
;»     most  easily  and  quickly?

<2uite  true,  he  said.

-ArA  in  all  that  concerns  either  body  or  soul,  swiftness
xm<5  activity   are   clearly   better   than   slowness  and  quiet-

Olearly  they  are.

Then  temperance  is  not  quietness,  nor  is  the  temperate  Tempenncc
lif-^  quiet, — certainly  not  upon  this  view;  for  the  life  which  is  *^°^'"
teEKiperate  is  supposed  to  be  the  good.     And  of  two  things,  q™  <>ui>
<«»^  is  true, — either   never,  or  very  seldom,  do  the  quiet  i""*"™-
»c:tions  in  life  appear  to  be  belter  than  the  quick  and  ener-
8s*ic  ones ;  or  supposing  that  of  the  nobler  actions,  there  are

*  «nany  quiet,  as  quick  and  vehement :  still,  even  if  we  grant
■*ia*,  temperance  will  not  be  acting  quietly  any  more  than
"^■^^g  quickly  and  energetically,  either  in  walking  or  talking
*"  »n  anything  else ;  nor  will  the  quiet  life  be  more  temperate
'  "^■*Jj  the  imquiet,  seeing  that  temperance  is  admitted  by  us

*  te  a  good  and  noble  thing,  and  the  quick  have  been
*-^^wn  to  be  as  good  as  the  quiet.

I  think,  he  said,  Socrates,  that  you  are  right.
""Xhen  once  more,  Charmides,  I  said,  fix  your  attention,
'^^^S  look  within ;  consider  the  effect  which  temperance  has
lltkOn  yourself,  and  the  nature  of  that  which  has  the  effect.
'Y'^iink  over  all  this,  and,  Uke  a  brave  youth,  tell  me — What
i*  ^.emperance?

After  a  moment's  pause,  in  which  he  made  a  real  manly   Second  deSnU
"tort    to    think,    he   said:     My    opinion    is,    Socrates,    that  !
tcopeiance   makes  a  man   ashamed   or  modest,   and   that  1
lenperance  is  the  same  as  modesty.
VOL.  I. — 2
...
1 8  Temperance  is  a  man  doing  his  own  business.

CMarmides.  Very  good,  I  Said ;  and  did  you  not  admit,  just  now,  that

Socrates,       temperance  is  noble?
Charmides,         Yes,  certainly,  he  said.
...
That  is  my  opinion.  na

But  Homer  Well,  I  Said;   but  surely  you  would  agree  with  Homer

always  good.  '  Modesty  is  not  good  for  a  needy  man '  ?
...
a  good?
Third  defini-         All  that,  Socrates,  appears  to  me  to  be  true ;  but  I  should

tion:  Tern-      jji^g  ^q  fcnow  what  you  think  about  another  definition  of  tem-
perance M
doing  our  own  perancc,  which  I  just  now  remember  to  have  heard  from

ck!"*^         some  one,  who  said,  'That  temperance  is  doing  our  own

had  heard  thu  busiuess.*     Was  he  right  who  affirmed  that?

fiomCnuas,         you  monster!     I   said;    this   is   what   Critias,   or    some

who  denies  *  '

that  he  said  it   philosopher  hiEis  told  you.
...
The  terms  of        There  you  are  in  the  right,  Socrates,  he  replied,
the  definition        j^  y^^  ^        j  g^^        ^  j  ^^^^^  whether  we  shall  ever  be

are  ambigu-  »  »    /  "*•

ous.  able  to  discover  their  truth  or  falsehood;   for  they  are  a
...
Because,  I  said,  he  who  uttered  them  seems  to  me  to  have  ckarmitUs.
niea.nt    one   thing,    and   said    another.     Is   the   scribe,   for  Socrates,
^xajnple,  to  be  regarded  as  doing  nothing  when  he  reads  or  Charmides.
?irrites?

X  should  rather  think  that  he  was  doing  something.

And  does  the  scribe  write  or  read,  or  teach  you  boys
to  '^wnrite  or  read,  your  own  names  only,  or  did  you  write  your
eri^inies*  names  as  well  as  your  own  and  your  friends'?
...
And  yet  if  reading  and  writing  are  the  same  as  doing,  you  writing  u  do-

doing  what  was  not  yoiur  own  business?  ing;  IS  writing

*^  '  your  enemy  s

!But  they  are  the  same  as  doing.  name  doing

And  the  healing  art,  my  friend,  and  building,  and  weaving,  y®"*^  °'*'"
and  doing  anything  whatever  which  is  done  by  art, — these
alV  clearly  come  under  the  head  of  doing?
Certainly.

And  do  you  think  that  a  state  would  be  well  ordered  by  a  Must  a  good
Uw  which  compelled  every  man  to  weave  and  wash  his  own  ^"''*^"  "**'''

*  •'  ,  his  own  coat,

coat,  and  make  his  own  shoes,  and  his  own  flask  and  strigil,  etc.  ?
163  and  other  implements,  on  this  principle  of  every  one  doing
...
Then  temperance,  I  said,  will   not  be    doing  on^'s   own

^ness;  not  at  least  in  this  way,  or  doing  things  of  this
sort?

Clearly  not.

Then,  as  I  was  just  now  saying,  he  who  declared  that  tem-
P^^ce  is  a  man  doing  his  own  business  had  another  and  a
...
chamwUs,      a  riddle,  thinking  that  no  one  would  know  the  meaning  of  the
...
Critias.
The  secret  dis.  Critias  had  long  been  showing  imeasiness,  for  he  felt  that
MirirfiacUon  of  jjg  YidA  a  reputation  to  maintain  with  Charmides  and  the  rest
...
at  which  Critias  grew  angry,  and  appeared,  as  I  thou^t,
...
definition,
whomainudns       I  entirely  agree,  said  Critias,  and  accept  the  definition,
the  definition        Very  good,  I  Said ;  and  now  let  me  repeat  my  question —
...
And  are  they  temperate,  seeing  that  they  make  not  for  ckarmutes.
themselves  or  their  own  business  only?  Socratks,
...
NayS  said  he ;  did  I  ever  acknowledge  that  those  who  do  and  »  quickly
the  business  of  others  are  temperate?  I  said,  those  who  make,  ^l^^'o^bl"
not  those  who  do.  him.

What!  I  asked;  do  you  mean  to  say  that  doing  and
making  are  not  the  same?

No  more,  he  replied,  than  making  or  woVking  are  the
...
scnbing,  he  would  have  said  that  there  was  no  disgrace
in  them — for  example,  in  the  manufacture  of  shoes,  or  in
seUing  pickles,  or  sitting  for  hire  in  a  house  of  ill-fame?  That,
...
things  nobly  and  usefully  made  he  called  works ;  and  such  "^^jj^"^
makings  he  called  workings,  and  doings ;  and  he  must  be  sup-  dnctions.
...
the  makings  (troiriaBii;)  of  the  good  you  would  call  doings
(TTpofeif ),  for  I  am  no  stranger  to  the  endless  distinctions  which
Prodicus  draws  about  names.  Now  I  have  no  objection
to  your  giving  names  any  signification  which  you  please,

1  The  English  reader  has  to  observe  that  the  word  '  make '  {noulv),  in
Greek,  has  also  the  sense  of  '  do '  (npdrrtLv).
...
does  good,  and  not  evil:  for  temperance  I  define  in  plai«>
words  to  be  the  doing  of  good  actions.

And  you  may  be  very  likely  right  in  what  you  are  saying  '^
but  I  am  curious  to  know  whether  you  imagine  that  temperat^^
men  are  ignorant  of  their  own  temperance?

I  do  not  think  so,  he  said.

And  yet  were  you  not  saying,  just  now,  that  craftsmec::^
might  be  temperate  in  doing  another's  work,  as  well  as  ii
doing  their  own?

I  was,  he  replied ;  but  what  is  your  drift?

I  have  no  particular  drift,  but  I  wish  that  you  would  tell  nw
...
And  does  not  he  who  does  his  duty  act  temperately  oi^
wisely?
...
is  Apollo's  sahitation  of  his  ivorshippers.

23

1,  as  would  seem,  in  doing  good,  he  may  act  wisely  or
...
3  dedicated  the  inscription,  *  Know  thyself!  *  at  Delphi,
ord,  if  I  am  not  mistaken,  is  put  there  as  a  sort  of
ya  which  the  god  addresses  to  those  who  enter  the
...
5f  him  who  dedicated  the  inscription  was,  as  I  believe,
...
7(Mf>p6veif  yv(o6i  aavTdv]^  and  yet  they  may  be  easily  mis-
...
i  they  dedicated  their  own  inscription  under  the  idea
...
lore  right,  but,  at  any  rate,  no  clear  result  was  attained),
raise  a  new  one  in  which  I  will  attempt  to  prove,
ieny,  that  temperance  is  self-knowledge.
I  said,  Critias ;  but  you  come  to  me  as  though  I  pro-
o  know  about  the  questions  which  I  ask,  and  as  though
,  if  I  only  would,  agree  with  you  ^     Whereas  the  fact

wading,  according  to  Heusde's  conjecture,  dfioXoyijaovTof  aou
...
between  Socrates  and  Critias,  25

And  the  odd  and  even  numbers  are  not  the  same  with  the  CAarmidn.
art  of  computation?  Socratbs,

They  are  not.  Critias.

The  art  of  weighing,  again,  has  to  do  with  lighter  and
heavier ;  but  the  art  of  weighing  is  one  thing,  and  the  heavy
and  the  hght  another.     Do  you  admit  that?
...
You  are  just  falling  into  the  old  error,  Socrates,  he  said.  Temperance
You  come  asking  in  what  wisdom  or  temperance  differs  from  ^^^^^^^ ^
the  other  sciences,  and  then  you  try  to  discover  some  respect  the  adence  of
in  which  they  are  ahke ;  but  they  are  not,  for  all  the  other  ^%n^tf**
...
trying  to  refute  me,  in^ead  of  pursuing  the  argument.

And  what  if  I  am?     How  can  you  think  that  I  have  any  Penonaiidei
other  motive  in  refuting  you  but  what  I  should  have  in  ex-  «« beginning,

to  whicli

amining  into  myself?  which  motive  would  be  just  a  fear  of  my  socratcs
unconsciously  fancying  that  I  knew  something  of  which  I  was  <»"»ckiy  puts
...
Tell  me,  then,  I  said,  what  you   mean   to  affirm  about  ^^^f'JJ,"  ""^

wisdoUL  other  sciences

I  mean  to  say  that  wisdom  is  the  only  science  which  is  ""^^^f^^*

the  science  of  itself  as  well  as  of  the  other  sciences.  aiwence  of
...
Then  the  wise  or  temperate  man,  and  he  only,  will  know  i(
...
But  consider  how  monstrous  this  proposition  \&^  my  friend :
...
and  no  science  without  a  subject-matter,  2^

Or  take  all  the  senses :  can  you  imagine  that  there  is  any  charmidu,

$ense  of  itself  and  of  other  senses,  but  which  is  incapable  of  Socratbs,

J>erceiving  the  objects  of  the  senses?  Critias.

I  think  not.  jtUnotsup-

ported  by  the

Could  there  be  any  desire  which  is  not  the  desire  of  any  analogy  of
I^leasure,  but  of  itself,  and  of  all  other  desires?  •f"**L?*'*?^
...
Tily  for  itself  and  all  other  wishes?
I  should  answer.  No.

Or  would  you  say  that  there  is  a  love  which  is  not  the  love
\^  o-^ beauty,  but  of  itself  and  of  other  loves?

I  should  not.

Or  did  you  ever  know  of  a  fear  which  fears  itself  or  other
i,  but  has  no  object  of  fear?
never  did,  he  said.

>r  of  an  opinion  which  is  an  opinion  of  itself  and  of  other
x^Kions,  and  which  has  no  opinion  on  the  subjects  of  opinion
'"^    general?

^I^ertainly  not.

;ut  surely  we  are  assuming  a  science  of  this  kind,  which,
no  subject-matter,  is  a  science  of  itself  and   of  the
sciences?
es,  that  is  what  is  affirmed.

iut  how  strange  is  this,  if  it  be  indeed  true :  we  must  not
ever  as   yet  absolutely  deny  the    possibility  of  such  a
Bce;  let  us  rather  consider  the  matter.
bu  are  quite  right,
"^^ell  then,  this  science  of  which  we  are  speaking  is  a  and  involves  a
nee  of  something,  and  is  of  a  nature  to  be  a  science  of  |i^'JJ|^^7f
...
ust  as  that  which  is  greater  is  of  a  nature  to  be  greater
1  something  else  ^?

Socrates  is  intending  to  show  that  science  differs  from  the  object  of
3oe,  as  any  other  relative  differs  from  the  object  of  relation.  But  where
is  comparison — greater,  less,  heavier,  lighter,  and  the  like — a  relation
as  well  as  to  other  things  involves  an  absolute  contradiction ;  and  in
T  cases,  as  in  the  case  of  the  senses,  is  hardly  conceivable.  The  use  of
genitive  after  the  comparative  in  Greek,  /le^Cov  tivoq^  creates  an  on-
^aUe  obscurity  in  the  translation.
...
that  which  has  a  natiu-e  relative  to  self  will  retain  also  the
nature  of  its  object :  I  mean  to  say,  for  example,  that  hearing
is,  as  we  say,  of  soimd  or  voice.     Is  that  true?
...
self  will  be  regarded  as  incredible  by  some,  but  perhaps  not  1 1
...
is  called  wisdom  or  temperance  is   included.     I  altogether  CAarmides.

distrust  my  own  power  of  determining  these  matters :  I  am  Socratbs,

not  certain  whether  there  is  such  a  science  of  science  at  all ;   ^"^■»^-

and  even  if  there  be,  I  should  not  acknowledge  this  to  be

wisdom  or  temperance,  imtil  I  can  also  see  whether  such  a

science  would  or  would  not  do  us  any  good ;  for  I  have  an  ,

impression  that  temperance  is  a  benefit  and  a  good.     And  f
...
Critias  heard  me  $ay  this,  and  saw  that  I  was  in  a  diffi-
...
that  the  argiunent  might  proceed,  I  said  to  him,  Well  then,
Critias,  if  you  like,  let  us  assume  that  there  is  this  science  of

science;    whether   the   assiunption  is    right   or  wrong  may  ,
...
we  know  or  do  not  know,  which,  as  we  were  saying,  is  self-  j
...
will  become  like  the  knowledge  which  he  has,  in  the  same  ledgeofsdf
...
ckarmidet.  Because,  Socrates,  they  are  the  same.  i;

Socrates,  Very  likely,  I  said ;  but  I  remain  as  stupid  as  ever ;  for  still

Critias.         j  £j^j|  ^q  comprehend  how  this  knowing  what  you  know  and  do
not  know  is  the  same  as  the  knowledge  of  self.
What  do  you  mean?  he  said,
never  give  us        This  is  what  I  mean,  I  replied :   I  will  admit  that  there  is  a
a  knowledge     science  of  scieuce ; — can  this  do  more  than  determine  that  of

ofother

things:  for  it    two  things  oue  is  and  the  other  is  not  science  or  knowledge?

is  incapable  ^       j^g^  ^^^

of  distinguish-  '  '

ing  them.  But  is  knowledge  or  want  of  knowledge  of  health  the  same
...
That  is  evident.
The  science  or       How  wiU  wisdom,  regarded  only  as  a  knowledge  of  know-
knowiedgeof    le^ge  or  scieuce  of  science,  ever  teach  him  that  he  knows

knowledge  u  °  '

unmeaning      health,  or  that  he  knows  building?
^d^unpiofit.        i^  ig  impossible.
...
"Whether  a  pretender  knows  or  does  not  know  that  which  he  ckarmide*.
says  that  he  knows :  he  will  only  know  that  he  has  a  know-  Socrates,
ledge  of  some  kind ;  but  wisdom  will  not  show  him  of  what  ^""'^'*-
tile  knowledge  is?
Plainly  not.

Keither  will  he  be  able  to  distinguish  the  pretender  in  medi-

from  the  true  physician,  nor  between  any  other  true  and

«  professor  of  knowledge.     Let  us  consider  the  matter  in

tJhi^  way:  If  the  wise  man  or  any  other  man  wants  to  distin-

^ti  the  true  physician  from  the  false,  how  will  he  proceed?

will  not  talk  to  him  about  medicine ;  and  that,  as  we  were

ing,  is  the  only  thing  which  the  physician  understands.

'rue.

.nd,  on  the  other  hand,  the  physician  knows  nothing  of
rnce,  for  this  has  been  assumed  to  be  the  province  of
^om.
'rue.
*  -^^nd  further,  since  medicine  is  science,  we  must  infer  that

^oes  not  know  anything  of  medicine,
.xactly.

len  the  wise  man  may  indeed  know  that  the  physician  has
le  kind  of  science  or  knowledge ;  but  when  he  wants  to
:over  the  nature  of  this  he  will  ask.  What  is  the  subject-
tter?     For  the  several  sciences  are  distinguished  not  by
mere  fact  that  they  are  sciences,  but  by  the  nature  of  their
jects.     Is  not  that  true?
[uite  true.
-^\nd  medicine   is   distinguished   from    other  sciences  as
the  subject-matter  of  health  and  disease?
es.

nd  he  who  would  enquire  into  the  nature  of  medicine
^t  pursue  the  enquiry  into  health   and  disease,  and  not
what  is  extraneous?
rue.
-^nd  he  who  judges  rightly  will  judge  of  the  physician  as
•hysician  in  what  relates  to  these?
e  will
^e  will    consider   whether  what    he    says  is  true,   and
<ther  what  he  does  is  right,  in  relation  to  health  and
?
...
Then,  assiu-edly,  wisdom  or  temperance,  if  only  a  science
...
*0n  the  wrong  track.'  33

And  now  you  perceive,  I  said,  that  no  such  science  is  to   ckarmides.
he  found  anywhere.  Socrates,

I  perceive,  he  said.  Cwtias.

May  we  assume  then,  I  said,  that  wisdom,  viewed  in  this  Vet  the  a
new  light  merely  as  a  knowledge  of  knowledge  and  ignor-  ^f^^^^
ance,  has    this    advantage: — that    he  who    possesses   such  may  make u
knowledge  will  more  easily  learn  anything  which  he  learns ;   ^^^^1**™
and    that    everything  will    be   clearer  to    him,  because,  in  and  to  test  the
addition  to  the  knowledge  of  individuals,  he  sees  the  science,  ^^j^  **
...
things  of  which  they  are  ignorant  to  those  who  were  better  JJ'^^y^^
acquainted  with  them.  to  be  possible.
...
that  this  is  wisdom,  I  certainly  cannot  make  out  what  good  i;
...
Tfie  knowledge  of  good  and  evil.
...
according  to  knowledge  is  happy,  for  these  live  accord-
to  knowledge,  and  yet  they  are  not  allowed  by  you  to  be
py ;  but  I  think  that  you  mean  to  confine  happiness  to
individuals  who  live  according  to  knowledge,  such
example  as  the  prophet,  who,  as  I  was  saying,  knows  the

Is  it  of  him  you  are  speaking  or  of  some  one  else?
es,  I  mean  him,  but  there  are  others  as  well,
es,  I  said,  some  one  who  knows  the  past  and  present
ell  as  the  futiu-e,  and  is  ignorant  of  nothing.     I^et  us
pose  that  there  is  such  a  person,  and  if  there  is,  you
allow  that  he  is  the  most  knowing  of  all  living  men.
ertainly  he  is.

et  I  should  like  to  know  one  thing  more :  which  of  the
erent  kinds  of  knowledge  makes  him  happy?  or  do  all
y  make  him  happy?
ot  all  equally,  he  replied.

ut  which  most  tends  to  make  him  happy?  the  knowledge
hat  past,  present,  or  future  thing?     May  I  infer  this  to
'•he  knowledge  of  the  game  of  draughts?
onsense  about  the  game  of  draughts,
r  of  computation?
o.

of  health?
earer  the  truth,  he  said.

nd  that  knowledge  which  is  nearest  of  all,  I  said,  is  the

wledge  of  what?

e  knowledge  with  which  he  discerns  good  and  evil.

onster!  I  said;  you  have  been  carrying  me  round  in  a

:le,  and  all  this  time  hiding  from  me  the  fact  that  the  life

crding  to  knowledge  is  not  that  which  makes  men  act

^"S^tly  and  be  happy,  not  even  if  knowledge  include  all  the

$piences,  but  one  science  only,  that  of  good  and  evil.     For,

X^'t.  me  ask   you,  Critias,   whether,   if  you  take   away   this,

^edidne   will    not    equally   give    health,   and    shoemaking
...
Nor  does  wisdom  give  advantage,  my  good  friend ;  for  i*
...
discover  what  that  is  to  which  the  imposer  of  names  gave   CAarmidfs.
this  name  of  temperance  or  wisdom.     And  yet  many  more  Socratss,
admissions  were  made  by  us  than  could  be  fairly  granted ;   ^"armides.
for  we  admitted  that  there  was  a  science  of  science,  although
the  argimient  said  No,  and  protested   against  us ;  and   we
...
And  still  more  am  I  grieved  about  the  charm  which  I  learned  voy  lOcdy
with  so  much  pain,  and  to  so  little  profit,  from  the  Thracian.  ^^
for  the  sake  of  a  thing  which  is  nothing  worth.     I  think  ofthecham,
indeed  that  there  is  a  mistake,  and  that  I  must  be  a  bad  ^^  fool  Who
enquirer,  for  wisdom  or  temperance  I  believe  to  be  really  a  »« incapable
great  good ;  and  happy  are  you,  Charmides,  if  you  certainly  °  '^"oning.
5  possess  it.     Wherefore    examine   yourself,  and  see  whether
...
whether  I  have  or  have  not  this  gift  of  wisdom  and  temper-  ^'h^™"<*« »

°  *  desirous  to  be

ance ;  for  how  can  I  know  whether  I  have  a  thing,  of  which  charmed.
...
And  aire  you  about  to  use  violence,  without  even  going
...
anything,  and  in  ihe  mood  of  violence,  are  irresistible.
...
No  answer  is  given  in  the  Lysis  to  the  question,   'What  is  LytU.
...
I.  gence :  this  is  carried  on  in  the  absence  of  Menexenus,  who  is
...
b  still  without  knowledge,  he  can  have  as  yet  no  conceit  of  know-
ledge.    In  this  manner  Socrates  reads  a  lesson  to  Hippothales,  the

42  Analysis  210-218.

Lysis.  foolish  lovcf  of  Lysis^  respecting  the  style  of  conversation  which  he
...
would  become  evil)  —  in  such  a  case  the  indifferent  becomes  a  ai{
...
wisdom  stands :  he  is  not  wise,  and  yet  not  unwise,  but  he  has  LysU.
...
20  therefore  if  there  were  no  evil  there  would  be  no  friendship.
Some  other  explanation  then  has  to  be  devised.     May  not  desire

2 1  be  the  source  of  friendship  ?  And  desire  is  of  what  a  man  wants
and  of  what  is  congenial  to  him.     But  then  the  congenial  cannot

2  3  be  the  same  as  the  like ;  for  like,  as  has  been  already  shown,  cannot
...
axe  still  unable  to  find  out  what  a  friend  is.
...
ctmceit  of  knowledge.  (Cp.  Charm,  pp.  175,  176.)  The  dialogue
...
This,  however,  is  frur  from  being  cleared  of  its  perplexity.  Two
...
Introduc.       strictly  limited ;  Socrates  has  allowed  himself  to  be  carried  away
TioN.  Y^y  2  ^j^  ^f  eristic  or  iUogical  logic  against  which  no  definition  of

friendship  would  be  able  to  stand.  In  the  course  of  the  argument
(217  D,  £)  he  makes  a  distinction  between  property  and  accident
...
Some  questions  relating  to  Friendship.  introduc-
...
pecuhar  attraction  which  draws  together  '  the  neither  good  nor
...
life  it  is  practically  certain  that  ipany  changes  will  occur  of
feeling,  opinion,  locality,  occupation,  fortune,  which  will  divide  us
fit>m  some  persons  and  unite  us  to  others.  6)  There  is  an  ancient
saying.  Qui  amicos  amicum  mm  habet.  But  is  not  some  less
...
Intkoduc-       sionate  and  exalted  natures,  all  men  everywhere  ?    7)  The  ancients
TioN.  ^^^  ^^y^  i^xtit  kinds  of  friendship,  '  for  the  sake  of  the  pleasant,
...
puzzUng  to  them :  they  could  not  say  that  friendship  was  only  a
...
Symposium  180  if.,  218  if. ;  Laws  viii,  835  ff^).
...
The  firiend  can  do  for  his  friend  what  he  cannot  do  for  himsel£
He  can  give  him  counsel  in  time  of  difficulty ;  he  can  teach  him
'  to  see  himself  as  others  see  him';  he  can  stand  by  him,  when  aU
the  world  are  against  him ;  he  can  gladden  and  enUghten  him  by
...
complain   of  one  another  for  making  new  fiiends,   or  for  not
revealing  some  secret  of  their  lives ;  (in  friendship  too  there  most
...
one  another  always  the  same.     The  greatest  good  of  fiiendship  is
not  daily  intercourse,  for  circumstances  rarely  admit  of  this ;  but  on
the  great  occasions  of  life,  when  the  advice  of  a  fiiend  is  needed,
...
inestimable  value.      When  the  heart  is   frdling  and  despair  is
setting  in,  then  to  hear  the  voice  or  grasp  the  hand  of  a  friend,  in

Difficulties  of  friendship,  47

a  shipwreck,  in  a  defeat,  in  some  other  failure  or  misfortune,  may  LysU.
xestore  the  necessary  courage  and  composure  to  the  paralysed  and  Intkoduc
...
bis  faults  too  clearly  and  lose  our  respect  for  him ;  and  he  loses
...
otlieT  human  evils,  is  commonly  due  to  a  want  of  tact  and  insight.
There  is  not  enough  of  the  Scimus  et  hanc  veniam  petimusque
iatMMsque  vicissim.     The  sweet  draught  of  sympathy  is  not  inex-
...
of  mairiage ;  it  affords  rather  a  solace  than  an  arm  of  support.
It  had  better  not  be  based  on  pecuniary  obligations ;  these  more
<^  mar  than  make  a  friendship.     It  is  most  likely  to  be  per-
ouaent  when  the  two  friends  are  equal  and  independent,  or  when
tbey  are  engaged  together  in  some  common  work  or  have  some
public  interest  in  common.     It  exists  among  the  bad  or  inferior  soft
...
Another  question  9)1  may  be  raised,  whether  friendship  can  safely
...
different  countries  (q>.  Symp.  p.  182).  It  would  be  hard  to  deny
...
modem  life,  which  he  who  wishes  to  make  or  keepa  friend  may  profit-
...
•**»•  I   WAS  going  from  the  Academy  straight  to  the  Lyceum,  LysU.
...
the  entertaitmient  is  generally  conversation,  to  which  you  are
welcome.
...
Who  is  Lysis?  I  said:  I  suppose  that  he  must  be  yoimg;
...
love  you  have  found!    I  wish  that  you  would  favour  me  Lytu.
with  the  exhibition  which  you  have  been  making  to  the  rest  Socratbs,
...
or  songs  in  honoiu*  of  yoiu*  favourite,  I  do  not  want  to  hear
...
^vers,  the  sound  of  my  words  is  always  dinning  in  his  ears,
Sie  must  have  a  very  acciu'ate  knowledge  and  recollection  of
CheoL

Fes,  indeed,  said  Ctesippus ;  I  know  only  too  well ;  and  But  though  he
very  ridiculous  the  tale  is :  for  although  he  is  a  lover,  and  l^^""^
^ery  devotedly  in  love,  he  has  nothing   particular   to  talk  lovc  poems
looiit  to  his  beloved  which  a  child  might  not  say.     Now  is  ]1 2 ,«

^  ^  composes  are

ot  that  ridiculous  ?  He  can  only  speak  of  the  wealth  of  nuwie  up  of
cxnocrates,  which  the  whole  city  celebrates,  and  grandfather  p^[^""
;,  and  the  other  ancestors  of  the  youth,  and  their  stud  of
;es,  and  their  victory  at  the  Pythian  games,  and  at  the
lus,  and  at  Nemea  with  four  horses  and  single  horses —
are  the  tales  which  he  composes  and  repeats.  And  there
■eater  twaddle  still.  Only  the  day  before  yesterday  he
e  a  poem  in  which  he  described  the  entertainment  of
^^^X'acles,  who  was  a  connexion  of  the  family,  setting  forth
^"^v-  in  virtue  of  this  relationship  he  was  hospitably  received
ff  5m  ancestor  of  Lysis ;  this  ancestor  was  himself  begotten
O^  Zeus  by  the  daughter  of  the  founder  of  the  deme.  And
O^tse  are  the  sort  of  old  wives'  tales  which  he  sings  and
f^tes  to  us,  and  we  are  obliged  to  listen  to  him.
...
can  you  be  making  and  singing  hymns  in  honour  of  yourselr-.
before  you  have  won?

But  my  songs  and  verses,  he  said,  are  not  in  honour  o: «
myself,  Socrates.
...
Most  assuredly,  I  said,  those  songs  are  all  in  your  o
honour ;  for  if  you  win  your  beautiful  love,  your  discourss^it^
and  songs  will  be  a  glory  to  you,  and  may  be  truly  regard
as  hymns  of  praise  composed  in  honoiu*  of  you  who  have  coi
quered  and  won  such  a  love ;  but  if  he  slips  away  from  y
the  more  you  have  praised  him,  the  more  ridiculous  you
look  at  having  lost  this  fairest  and  best  of  blessings;  ar^.
therefore  the  wise  lover  does  not  praise  his  beloved  until
has  won  him,  because  he  is  afraid  of  accidents.     There
also   another  danger;   the    fair,  when   any  one   praises
magnifies  them,  are  filled  with  the  spirit  of  pride  and  v
glory.     Do  you  not  agree  with  me?

Yes,  he  said.

And  the  more  vain-glorious  they  are,  the  more  difficuL
the  captiu-e  of  them?

I  believe  you.

What  should  you  say  of  a  hunter  who  frightened  away^  Iiis
prey,  and  made  the  captiu'e  of  the  animals  which  he  is  hunting
more  difficult?

He  would  be  a  bad  hunter,  undoubtedly.

Yes ;  and  if,  instead  of  soothing  them,  he  were  to  infuriate
them  with  words  and  songs,  that  would  show  a  great  want  c
wit :  do  you  not  agree?

Yes.

And  now  reflect,  Hippothales,  and  see  whether  you  are  ri
...
and  I  shall  be  glad  of  any  further  advice  which  you  may  ^
...
^oiir  love  to  me,  and  will  let  me  talk  with  him,  I  may
►s  be  able  to  show  you  how  to  converse  with  him,
I  of  singing  and  reciting  in  the  fashion  of  which  you
:used.
...
I  is  fond  of  listening,  Socrates.  And  as  this  is  the
1  of  the  Hermaea,  the  young  men  and  boys  are  all
er,  and  there  is  no  separation  between  them.  He  will
B  to  come :  but  if  he  does  not,  Ctesippus  with  whom  he
[liar,  and  whose  relation  Menexenus  is  his  great  friend,
all  him.

t  will  be  the  way,  I  said.     Thereupon  I  led  Ctesippus

le  Palaestra,  and  the  rest  followed.

jn  entering  we  found  that  the  boys  had  just  been  sacri-
...
amusing  themselves ;  but  some  were  in  a  comer  of  the
...
irent  over    to  the  opposite  side  of   the   room,  where,

I  a  quiet  place,  we  sat  down ;  and  then  we  began  to

This    attracted    Lysis,  who    was    constantly    turning

to  look  at  us — ^he  was  evidently  wanting  to  come  to

''or  a  time   he  hesitated  and  had  not  the  coiu'age  to

alone ;  but  first  of  all,  his  friend  Menexenus,  leaving

ly,  entered  the  Palaestra  from  the  court,  and  when  he
...
And  if  yoiu*  father  and  mother  love  you,  and  desire  that  you
should  be  happy,  no  one  can  doubt  that  they  are  very  ready
to  promote  yoiu"  happiness.
...
^Tlie  heir  so  long  as  he  is  a  child,^
...
Then  I  must  say  that  yotur  father  is  pleased  to  inflict  many
lords  and  masters  on  you.  But  at  any  rate  when  you  go
home  to  your  mother,  she  will  let  you  have  yoiu-  own  way,
...
ill  to  your  father  or  yoiu"  mother?
No,  indeed,  he  replied,
and  he  derives       But  why  then  are  they  so  terribly  anxious  to  prevent  you
dihr**^**"*'  ^^^^  being  happy,  and  doing  as  you  like? — keeping  you  all
wealth.  day  long  in  subjection    to  another,  and,  in  a  word,  doing
...
of  yoiu"  own  fair  person,  which  is  tended  and  taken  care  of
...
anything  read  or  written,  you,  I  presiune,  would  be  the  first
person  in  the  house  who  is  summoned  by  them.
Very  true.
But  he  may         And  you  wouM  be  allowed  to  write  or  read  the  letters
or"tunc  tl^**    ^^  *^y  order  which  you  please,  or  to  take  up  the  lyre  and
lyre  at  hw  own  tuue  the  uotes,  and  play  with  the  fingers,  or  strike  with  the
...
the  other.
People  wiu  Yes,  my  dear  youth,  I  said,  the  reason  is  not  any  de-

tmst  him  in      ficieucy  of  years,  but  a  deficiency  of  knowledge ;  and  when-
understands.     cver  your  father  thinks  that  you  are  wiser  than  he  is,  he  will
...
continue  to  administer  his  affairs  himself,  or  will  he  commit  s<x:ratks,
...
you  when  they  see  that  you  have  wisdom  enough  to  manage  ^^*"**"*ij|^
...
great  king,  and  he  has  an  eldest  son,  who  is  the  Prince  iJl^™*'*^""
of  Asia; — suppose  that  you  and  I  go  to  him  and  establish  to  he  knows  how
his  satisfaction  that  we  are  better  cooks  than  his  son,  will  he  IJUy^t^*^
...
I  remembered  that,  although  he  was  in  the  neighboiu-hood,  he
...
Yes,  indeed,  he  said ;  he  is  very  pugnacioiis,  and  that  is  the
...
secret,  and  keeping  the  ieast  to  ourselves.
...
Tlie  ambiguity  of  the  words  ^loving  and  beloved'  61

not  beloved   by  them;  and  that  the  poet  was  wrong  who  Lyns.

gijjjrs__  '  Socrates,

^  Menexenus.

'  Happy  the  man  to  whom  his  children  are  dear,  and  steeds  having   the  conclusion

single  hoofs,  and  dogs  of  the  chase,  and  the  stranger  of  another  land '  ?      **'  ^hat  is

beloved  is  dear

I  do  not  think  that  he  was  wrong.  ^^T  ^
...
example,  very  young  children,  too  young  to  love,  or  even  as,  for  exam-
hating  their  father  or  mother  when  they  are  punished  by  them,  ?Jm^°*j^
are  never  dearer  to  them  than  at  the  time  when  they  are  being  they  are
hated  by  them.  f"^"***^  *T
...
Then  many  men  are  loved  by  their  enemies,  and  hated  by  what  then  b
their  friends,  and  are  the  friends  of  their  enemies,  and  the  i*  '«*"!'J—

'  '  That  neither

enemies  *  of  their  friends.     Yet  how  absiu'd,  my  dear  friend,  the  lover  nor
or  indeed  impossible  is  this  paradox  of  a  man  being   an  ^0*^,^"^!^
enemy  to  his  friend  or  a  friend  to  his  enemy?  getherare

I  quite  agree,  Socrates,  in  what  you  say.  friends.

But  if  this  cannot  be,  the  lover  will  be  the  friend  of  that
which  is  loved?
True.

And  the  hater  wiU  be  the  enemy  of  that  which  is  hated?
Certainly.

Vet  we  must  acknowledge  in  this,  as  in  the  preceding
...
intndi :  for  example,  when  he  hates  ^  that  which  does  not
irate  him,  or  which  even  loves  him.
ThsLt  appears  to.be  true.

1  Omitting  ^fy,  or  reading  fius%  instead.

62  The  like  are  friends.
...
Lv^is"'"'''"''    ^^  friends  to  one  another?     Do  any  remain?
...
The  poets  say       '  God  is  ever  drawing  like  towards  like,  and  making  them  acquainted.'
that  'God  is

'Z^^    I  dare  say  that  you  have  heard  those  words,
like/  Yes,  he  said ;  I  have.
...
No^  not  the  like,  but  only  the  good,  63

Then,  looked  at  in  this  way,  one  half  of  the  saying  is  untrue,  Lysu.
if  the  wicked  are  like  one  another?  Socratbs,

Quite  so.  L^*«-

But  what  I  imagine  to  be  the  real  meaning  of  the  words  is,  meaning  that
that  the  good  are  like  one  another,  and  friends  to  one  another ;  ^^l^^
...
with  itself  is  not  likely  to  be  in  imion  or  harmony  with  any
other  thing.     Do  you  not  agree?

Yes,  I  do.

Then,  my  friend,  those  who  say  that  the  like  is  friendly  to  but  only  the
the  like  mean  to  intimate,  if  I  righdy  apprehend  them,  that  IJ^^^**
...
I    will.     Asstmiing   like,  inasmuch   as  he  is  like,  to  be  the
...
1 5   if  neither  can  be  of  any  use  to  the  other,  how  can  they  be  SJI^^Jdnot
...
be  sufficient  for  himself?     Certainly  he  will.     And  he  who  is  ^^J^^***
sufficient  wants  nothing — that  is  implied  in  the  word  sufficient.

64  Tlie  like  is  the  enemy  of  like.
...
What  place  then  is  there  for  friendship,  if,  when  absei
good  men  have  no  need  of  one  another  (for  even  when  aloK
they  are  sufficient  for  themselves),  and  when  present  have  ■
...
But  see  now,  Lysis,  whether  we  are  not  being  deceived-
all  this — are  we  not  indeed  entirely  wrong?

How  so?  he  replied.

Have  I  not  heard  some  one  say,  as  I  just  now  recoll^M^v?^
that  the  like  is  the  greatest  enemy  of  the  like,  the  good  of     ^c
good? — ^Yes,  and  he  quoted  the  authority  of  Hesiod,  i^r^o
says:

Another  woid  '  Potter  quarrels  with  potter,  bard  with  bard,

of  a  poet:  Beggar  with  beggar ; '

*  Potter

quaneb  with    ^nd  of  all  Other  things  he  affirmed,  in  like  manner,  *  That  of
...
imlike :   for  example,  the  dry  desires  the  moist,  the  cold  the
...
The  Neutral  is  the  friend  of  the  Neutral^

65

like.  And  I  thought  that  he  who  said  this  was  a  charming
...
And  yet  there  is  a  fiuther  consideration:  may  not  all
...
my  head  is  dizzy  with  thinking  of  the  argiunent,  and  there-
Few^  I  hazard  the  conjectiu-e,  that  '  the  beautiful  is  the  friend,'
IS  the  old  proverb  says.  Beauty  is  certainly  a  soft,  smooth,
ilippery  thing,  and  therefore  of  a  nature  which  easily  slips
n  and  permeates  our  souls.  For  I  affirm  that  the  good  is
lie  beautiful.     You  will  agree  to  that?
...
whichf  as  yet^  has  not  infected  it.  67

Yes.  Lysis.

Then  that  which  is  neither  good  nor  evil  becomes  the  socratbs.
friend  of  good,  by  reason  of  the  presence  of  evil?  Menexbnus.
...
lated  when  others  are    present  with    them;  and    there   are  p"^****"'

*^  '  yet  not

some  which  are    not    assimilated:    take,  for  example,   the  assimilated.
case  of  an   ointment   or  coloiu*  which  is  put  on   another
substance.

Very  good.

In  such  a  case,  is  the  substance  which  is  anointed  the
same  as  the  coloiu*  or  ointment?

What  do  you  mean  ?  he  said.

This  is  what  I  mean :  Suppose  that  I  were  to  cover  yoiu*
...
l>ecome  assimilated,  and  are  white  by  the  presence  of  white.
...
68  Buty  alas  /  we  have  gained  a  shadow  only.
...
MuNEXENus.    ^^j  thing;  but  the  presence  of  evil,  which  makes  a  thing  21I
of  evU*^!!^  ^vil,  takes  away  the  desire  and  friendship  of  the  good ;  for
in  what  is  not   that  which  was  once  both  good  and  evil  has  now  become  evil
oTgood.  only,  and  the  good  was   supposed  to  have   no  friendship
...
Friendships        And  SO,  Lysis  and  Menexenus,  we  have  discovered  the

Aciovcofthc  nature  of  friendship— there  can  be  no  doubt  of  it:   Friend-
...
^^men,  are    £^jgg .  arguments,  like  men,  are  often  pretenders,
...
he  no  motive  and  object?  Socratks,

He  has  a  motive  and  object.  Menhxenus,
...
And  he  is  the  friend  of  the  physician  becaiise  of  disease,
...
which  has  been  declared  by  us  to  be  an  impossibib'ty ;  but,
...
at  some  first  principle  of  friendship  or  deamess  which  is  not
...
of  a  great  treasiu*e  (this  may  be  a  son,  who  is  more  precious
...
But  does  he  therefore  value  the  three  measiu'es  of  wine,  or
...
silver  are  highly  valued  by  us,  that  is  not  the   truth ;  for  Lytu.
there  is  a  further  object,  whatever  it  may  be,  which  we  value  Socrates,
most  of  all,  and  for  the  sake  of  which  gold  and  all  our  Mbnbxbnus.
...
put  the  case  in  this  way :  Suppose  that  of  the  three  principles,  for*Sic*»ake  of
goody  evil,  and  that  which  is  neither  good  nor  evil,  there  re-  the  evil  is
mained  only  the  good  and  the  neutral,  and  that  evil  went  far  ^^"^highcr
away,  and  in  no  way  affected  soul  or  body,  nor  ever  at  all  principle  of
that  class  of  things  which,  as  we  say,  are  neither  good  nor  <J)^"  ^j^j^^j,
...
But,  oh!  will  you  tell  me,  I  saidj  whether  if  evil  were  to
...
But  now  our  view  is  changed,  and  we  conceive  that  there  Socratks.
must  be  some  other  cause  of  friendship?  Menkxenus,
...
Then  love,  and  desire,  and  friendship  would  appear  to  be  Ves,— desire
of  the  natural  or  congenial.  Such,  Lysis  and  Menexenus,  is  ^*Ij*2ie^'
...
saa  another  would  ever  have  loved  or  desired  or  affected  him,  if
...
Hippothales  changed  into  all  manner  of  cploiu^  with  de-
light.

Here,  intending  to  revise  the  argument,  I  said:  Can  we  But  our  former
point  out  any  difference  between  the  congenial  and  the  like?  "K""*"'
...
there  may  be  some  sense  in  our  argument  about  fnendship.
...
and  the  Uke — such  a  distinction  may  perhaps  be  allowed.

By  all  means.

And  shall  we  further  say  that  the  good  is  congenial,  and
the  evil  imcongenial  to  every  one?  Or  again  that  the  evil  is
...
error ;  for  the  unjust  will  be  the  friend  of  the  imjust,  and  the
...
the  lover,  nor  the  like,  nor  the  imlike,  nor  the  good,  nor  the
...
went  on  shouting  in  their  barbarous  dialect,  and  got  angry,  Lytu.
and  kept  calling  the  boys — they  appeared  to  us  to  have  been  Socratbs.
...
discover  what  is  a  friend  1

LACHES.

INTRODUCTION.

i».    Lysimachus,  the  son  of  Aristides  the  Just,  and  Melesias,  the  son  Lackts.
of  the  elder  Thucydides,  two  aged  men  who  lived  together,  are  Analysis.
...
(x  afterwards  recognised  as  the  son  of  his  old  friend  Sophroniscus,
...
e3u:ellent  Damon,  nfusician  and  sophist,  as  a  tutor  for  his  son,  and
...
2  &vour  of  the  new  art,  which  he  describes  as  the  gymnastics  of
...
Lacfus.  are  useless  and  ridiculous.     This  man  Stesilaus  has  been  seen  by

Analysis.        him  on  board  ship  making  a  very  sorry  exhibition  of  himselfl    The
...
childreni  he  would  consult  the  one  skilled  person  who  has  had
...
about  their  past  lives.  Nicias  has  oflen  submitted  to  this  process;
...
wants  a  more  general  definition,  not  only  of  military  courage,  but  191
of  courage  of  all  sorts,  tried  both  amid  pleasures  and  pains.   Laches
replies  that  this  juniversal  courage  is  endurance.     But  courage  Is
a  good  thing,  and  mere  endurance  may  be  hurtful  and  injurkms.
Therefore  (3)  the  element  of  intelligence  must  be  added.   But  then  19^
again  unintelligent  endurance  may  often  be  more  courageous  than
the  intelligent,  the  bad  than  the  good.     How  is  this  contradictioii
...
4  Nicias  is  now  appealed  to ;  and  in  reply  he  offers  a  definition
...
5  '  Intelligence  of  things  terrible.'  '  But  every  man  knows  the
...
6  the  inference  that  the  courageous  man  is  either  a  soothsayer  or
agod.

Again,  (2)  in  Nicias'  way  of  speaking,  the  term  '  courageous '
must  be  denied  to  animals  or  children,  because  they  do  not  know

17  the  danger.  Against  this  inversion  of  the  ordinary  use  of  language
Laches  reclaims,  but  is  in  some  degree  mollified  by  a  compliment
to  his  own  courage.  StiU,  he  does  not  like  to  see  an  Athenian
...
>9  virtue,  but  only  one  of  the  virtues.  The  terrible  is  in  the  future,
...
>o  bttt  also  temperance,  justice,  and  every  other  virtue.  Thus,  a
single  virtue  would  be  the  same  as  all  virtues  (cp.  Protagoras,  350
iblL).  And  after  all  the  two  generals,  and  Socrates,  the  hero  of
Delinm,  are  still  in  ignorance  of  the  nature  of  courage.     They

>i  must  go  to  school  again,  boys,  old  men  and  all.

Some  points  of  resemblance,  and  some  points  of  difference,      Introduo
appear  in  the  Laches  when  compared  with  the  Charmides  and        '"^''*
LjTsis.     There  is  less  of  poetical  and  simple  beauty,  and  more
...
82  C/uiracters  of  the  Dialogue.

Laches.  of  the  scene ;  the  Laches  has  more  play  and  development  of

Introduc.  character.  In  the  Lysis  and  Channides  the  youths  ^e  the  central
...
The  stance  is  of  old  and  elder  men,  of  whom  Socrates  is  the
youngest.
...
silence.  Both  of  them,  by  their  own  confession,  have  been  iU-
educated,  as  is  further  shown  by  the  circumstance  that  Lysimachus,
the  friend  of  Sophroniscus,  has  never  heard  of  the  hxat  of  So-
...
of  whom,  one  has  witnessed  them.  The  characters  oi  Nicias  and
Laches  are  indicated  by  their  opinions  on  the  exhibition  of  the
man  fighting  in  heavy  airmour.  The  more  enlightened  Nicias  is
...
Laches  is  made  to  pass  on  from  the  more  popular  to  the  more  Lactu*.
philosophical ;  it  has  never  occurred  to  him  that  there  was  any  Intkoduc-
...
the  knowledge  of  the  future  is  separable  from  that  oi  the  past  and
...
Protagoras  is  explained  as  the  £du:ulty  of  estimating  pleasures  and
...
Lysimachus,  son  of  ArisHdes,  NiclAS.

Melesias,  son  of  Thucydides.  Laches.  J

Their  Sons.  Socrates.  t

H«     Lys,  You  have  seen  the  exhibition  of  the  man  fighting  in  Locket.

armour,  Nicias  and  Laches,  but  we  did  not  tell  you  at  the  lysimacmus.

time  the  reason  why  my  friend  Melesias  and  I  asked  you  to  Lysimachus

go  with  us  and  see  him.     I  think  that  we  may  as  well  confess  "**  MeUaias

...  ,  .    *  1  1  request  Nicuu

what  this  was,  for  we  certainly  ought  not  to  have  any  reserve  and  Laches  to
with  you.     The  reason  was,  that  we  were  intending  to  ask  jjj^''^^
your  advice.     Some  laugh  at  the  very  notion  of  advising  respecting  the
others,  and  when   they  are  asked  will  not  say  what  they  2^^!*'*°"°'^
...
^9  father ;  and  this  is  mine,  who  is  also  called  after  his  grand-
father, Aristides.     Now,  we  are  resolved  to  take  the  greatest
care  of  the  youths,  and  not  to  let  them  run  about  as  they
Hke,  which  is  too  often  the  way  with  the  young,  when  they
...
Lackts.  you  have  not  attended  to  them,  we  may  remind  you  that  you
...
this  upon  the  lad^,  pointing  out  to  them  that  they  will  not
...
Should  the  art  likely  to  be  most  improving  to  them.  Some  one  com-
of  fighting  m    mended   to   us   the    art   of   fighting  in   armour,   which  he

armour  be  o  o  »

taught  them?  thought  au  excellent  accomplishment  for  a  young  man  to
...
and  their  two  sons,  87

As  he  says,  such  persons  are  too  apt  to  be  negligent  and  care-  Lacktt.
less  of  their  own  children  and  their  private  concerns.     There  Lysimachus,
is  much  truth  in  that  remark  of  yours,  Lysimachus.     But  ^ioas,
...
■%  .^i  J     •         1  •  1  •      ^  •  •       that  they  shall

same  deme  with  you,  and   is  always  passing  his  time  m  takeSoaates
...
Nk,  That  I  have  the  means  of  knowing  as  well  as  Laches ;
...
Lys,  Those  who  have  reached  my  time  of  Ufe,  Socrates  Lysimachus
...
age;  but  you,  O  son  of  Sophroniscus,  should  let  your  fellow  Jiu^^^ihat
demesman  have  the  benefit  of  any  advice  which  you  are  able  he  w  the  son
to  give.     Moreover  I  have  a  claim  upon  you  as  an  old  friend  ^^nV
of  your  father ;  for  I  and  he  were  always  companions  and  Sophroniscus.
friendSy  and  to  the  hour  of  his  death  there  never  was  a
...
the  name  of  your  father,  who  was  a  most  excellent  man;   Laches  praises
and  I  further  rejoice  at  the  prospect  of  our  family  ties  being  ^J^j^"**^*
renewed.  shown  by

La.  Indeed,  Lysimachus,  you  ought  not  to  give  him  up ;   ^^7ue*of
for  I  can  assure  you  that  I  have  seen  him  maintaining,  not  DeUum.
...
companion  in  the  retreat  from  Deliimi,  and  I  can  tell  you
...
they  praise.  Let  me  tell  you  the  pleasure  which  I  fed
...
gymnastics  could  be  better  or  harder  exercise ;  and  this,  and  i8i
...
the  conflict  tiuns.  Moreover  in  actual  battle,  when  you  have
to  fight  in  a  line  with  a  niunber  of  others,  such  an  acquirement
...
of  tlu  art  of  fighting  in  armour,  89

assailant.  Certainly  he  who  possessed  the  art  could  not  Locke*.
...
La,  I  should  not  like  to  maintain,  Nicias,  that  any  kind  Laches
of  knowledge  is  not  to  be  learned ;  for  all  knowledge  appears  f "**=**^  "°
to  be  a  good :  and  if,  as  Nicias  and  as  the  teachers  of  the  the  an,  which
art  affirm,  this  use  of  arms  is  really  a  species  of  knowledge,  ll^^^^:^
then  it  ought  to  be  learned;  but  if  not,  and  if  those  who  discovered  by
profess  to  teach  it  are  deceivers  only ;  or  if  it  be  knowledge,  roonUmTand
but  not  of  a  valuable  sort,  then  what  is  the  use  of  learning  it?  would  have
183  I  say  this,  because  I  think  that  if  it  had  been  really  valuable,  duced"L^ng
the  Lacedaemonians,  whose  whole  life  is  passed  in  finding  them,  if  u  had
out  and  practising  the  arts  which  give  them  an  advantage  ^^J^  *"^
...
be  an  art  of  which  the  advantage  is  so  slight,  or  not  an  art  at  JjJ^g^^"**
all,  but  only  an  imposition,  in  either  case  such  an  acquirement  The  art  an
is  not  worth  having.     For  my  opinion  is,  that  if  the  professor  "npo"**®**-
...
the  more  necessary  because  the  two  councillors  disagree,  and  d°^"*^*"°"„d
some  one  is  in  a  manner  still  needed  who  will  decide  between  therefore  we
them.     Had  they  agreed,  no  arbiter  would  have  been  required.  JJ"|^^
...
the  one  who  had  been  trained  and  exercised  imder  a  skilful
master?

MeL  The  latter,  Socrates ;  as  would  surely  be  reasonable.      No,  the

Soc.  His  one  vote  would  be  worth  more  than  the  vote  of  opjnj^«of«»«

expert  m
all  US  four?  worth  that  of

MeL  Certainly.  au  the  rest
...
IVAo  are  qualified  to  teach  ?  93

Nic.    Most  true.  Lache*.

Soc,  And  at  present  we  have  in  view  some  knowledge,  of  Nioas,
which  the  end  is  the  soul  of  youth?  Sockates,

•'  Laches.

vltC»    Yes.  The  means  is

Sac,  And  we  are   enquiring,  Which   of  us  is  skilful  or  j^"*!^"^^?^
...
those  who  have,  in  some  things?  S!J hS*^!Sc^**

Soc,  Yes,  Laches,  I  have  observed  that;  but  you  would  teachen?
not  be  very  willing  to  trust  them  if  they  only  professed  to  be
masters  of  their  art,  unless  they  could  show  some  proof  of
1S6  their  skill  or  excellence  in  one  or  more  works.

La,  Quite  true.

Soc.  And  therefore.  Laches  and   Nicias,  as  Lysimachus  Wemust
and  Melesias,  in  their  anxiety  to  improve  the  minds  of  their  ^  ^^^J^***
sons,  have  asked  our  advice  about  them,  we  too  should  tell  are,  or  appeal
them  who  our  teachers  were,  if  we  say  that  we  have  had  any,  q^J*^/*^
...
ing the  children  of  friends,  and  thereby  incurring  the  most  Socntes
...
Mdesias,  I  am  the  first  to  confess  that  I  have  never  had  "*<=^*"*»

'  Laches  may

a  teacher  of  the  art  of  virtue;  although  I  have  always  from  haveieamed

my  earliest  youth  desired  to  have  one.     But  I  am  too  poor  ^hi^j,^  ^nd

to  give  money  to  the  Sophists,  who  are  the  only  professors  their  opinions

of  moral  improvement;  and  to  this  day  I  have  never  been  ^ue'ifthey

able  to  discover  the  art  myself,  though  I  should  not  be  only  agreed

surprised  if  Nicias  or  Laches  may  have  discovered  or  learned  ^^^
...
tageous or  hiutful  to  a  young  man.  I  repose  confidence
...
of  the  matter — he  is  xmable  to  decide  which  of  you  speaks
...
learned  of  another;  and  if  you  learned,  who  were  your  187
...
having  been  inferior  persons,  have  become  xmder  your  care
...
asks,  if  you  will :  for  I  began  by  sajdng  that  we  took  you  into
our  counsels  because  we  thought  that  you  would  have
attended  to  the  subject,  especially  as  you  have  children  who.

^

The  ways  of  Socrates.  95

like  our  own,  are  nearly  of  an  age  to  be  educated.     Well,  Locket.
then,  if  you  have  no  objection,  suppose  that  you  take  Socrates  Nicias,
into  partnership;  and  do  you  and  he  ask  and  answer  one  {^^hb^""^
...
Nic*  I  see  very  clearly,  Lysimachus,  that  you  have  only  Socrateswiii
known    Socrates*   father,   and  have  no    acquaintance   with  ^^"'j^'oa*^

'  ^  you  about

Socrates  himself:    at  least,  you  can  only  have  known  him  yoursouL
when  he  was  a  child,  and  may  have  met  him  among  his
f ellow-wardsmen,  in  company  with  his  father,  at  a  sacrifice,
...
round  and  round  by  him,  imtil  at  last  he  finds  that  he  has  to
\%  give  an  accoimt  both  of  his  present  and  past  life ;  and  when
...
to  his  ways ;  and  I  know  that  he  will  certainly  do  as  I  say,  ^ch^contw-
and  also  that  I  myself  shall  be  the  sufferer ;  for  I  am  fond  «aUon  is  very
...
nor  unpleasant ;  indeed,  I  knew  all  along  that  where  Socrates  Laches,  hke

XI*    *  *

was,  the  argument  would  soon  pass  from  our  sons  to  our-  ^^^[q^^

selves ;  and  therefore,  I  say  that  for  my  part,  I  am  quite  willing  cross-exam-

to  discourse  with  Socrates  in  his  own  manner ;  but  you  had  ^peJjiaiiy

better  ask  our  friend  Laches  what  his  feeling  may  be.  ^y  *  ^"e

La.  I  have  but  one  feeling,  Nicias,  or  (shall  I  say?)  two  ^'^^  °**

feelings,  about  discussions.     Some  would  think  that  I  am  a  correspond

lover,  and  to  others  I  may  seem  to  be  a  hater  of  discourse ;  actions.
for  when  I  hear  a  man  discoiu^ing  of  virtue,  or  of  any  sort
...
show  that  free  and  noble  sentiments  are  natural  to  him.  1^9
...
knowy  for  the  sake  of  the  youths,  and  talk  and  consult  witn  Locket.
them :  for  I  am  old,  and  my  memory  is  bad ;  and  I  do  not  sogkatbs,
...
principles.     For  if  we  knew  that  the  addition  of  something  Socntes
would  improve  some  other  thing,  and  were  able  to  make  the  g^b^^"
addition,  then,  clearly,  we  must  know  how  that  about  which  can  impart
we  are  advising  may  be   best    and  most  easily  attained.  *^[\^o^
...
For  how  can  we  advise  any  one  about  the  best  mode  of  *™p*"

vutue  we

attaining  something  of  which  we  are  wholly  ignorant?  must  know

La.    I  do  not  think  that  we  can,  Socrates.  ^^Ihti"'*
...
Sac,  Then  which  of  the  parts  of  virtue  shall  we  select?
...
Sac.  Then,  Laches,  suppose  that  we  first  set  about  deter-
...
speaking  of  chariots,  as  you  were  speaking  of  the  Scythian  Laches,
cavahy,  who  have  that  way  of  fighting ;  but  the  heavy-armed  Socrates,
Greek  fights,  as  I  say,  remaining  in  his  rank.  Lachks.
...
courageous   in  perils  by   sea,   and   who   in   disease,   or  in  f^*l^'^°
*  poverty,  or  again  in  politics,  are  courageous ;  and  not  only  by  sea,
who  are  courageous  against  pain  or  fear,  but  mighty  to  con-  ^^ d***^***
tend  against  desires  and  pleasures,  either  fixed  in  their  rank  poverty,
or  turning  upon  their  enemy.     There  is  this  sort  of  courage —  civiiTtrifc-
is  there  not.  Laches?  also  in

La.  Certainly,  Socrates.  ^j  Jj  *

Soc,  And  all  these  are  courageous,  but  some  have  courage  pleasures
in  pleasures,  and  some  in  pains :  some  in  desires,  and  some  j^sires.
...
possessed  of  knowledge.  101

shows  the  quality  of  endurance  in  spending  his  money  wisely,  Lactut^
knowing  that  by  spending  he  will  acquire  more  in  the  end,  do  Sockatbs,
you  call  him  courageous?  lachbs.
...
Im.  Not  at  all,  any  more  than  the  last.

Soc.  Again,  take  the  case  of  one  who  endures  in  war,  and  ii  he  who
is  willing  to  fight,  and  wisely  calculates  and   knows   that  fo^'J^^r^
others  will  help  him,  and  that  there  will  be  fewer  and  inferior  escapes  a
men  against  him  than  there  are  with  him;  and  suppose  that  h^hij'**
he  has  also  advantages  of  position ; — would  you  say  of  such  a  having  no
one  who  endures  with  all  this  wisdom  and  preparation,  that  enX'^Md
