---
source: "https://archive.org/details/educationofyoung00plat"
title: "The education of the young in The Republic of Plato;"
author: "Plato, Bosanquet, Bernard, 1848-1923, tr"
year: "1901"
captured_at: "2026-07-01T13:07:55Z"
updated_at: "2026-07-01T13:07:55Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "プラトン"
query: "Plato Republic"
plain_text_url: "https://archive.org/download/educationofyoung00plat/educationofyoung00plat_djvu.txt"
public_domain: true
...
- 著者: Plato, Bosanquet, Bernard, 1848-1923, tr
- 初版: 1901
- 情報源: [archive](https://archive.org/details/educationofyoung00plat)
- パブリックドメイン: ✓
...
3LonDon:    C.  J.   CLAY  and  SONS,

CAMBRIDGE    UNIVERSITY    PRESS    WAREHOUSE,

AVE    MARIA    LANE.

inlnsgauj:    50,  WELLINGTON  STREET.

i^VM

isuw

ietpjig:  F.  A.  BROCKHAUS.

$efa)  %ovk:    THE  MACMILLAN  COMPANY.

Bomfaap:    E.  SEYMOUR   HALE.
...
pleter study  of  the  Republic1  and  of  Plato's  ideas.
...
http://www.archive.org/details/educationofyoungOOplat
...
simple  music,  for  which  perhaps  our  hymn  tunes1  afford  the
...
music  master's,  all  together,  without  overcoats1,  even  if  it  were
...
20  to  30,  if  worthy  of  further  education,  he  wras,  while  not  by
...
plete your  studies"  at  twenty-three  or  twenty-four1,  and  then,
...
Rhetoric,  Dialectic,  Arithmetic,  Geometry,  Astrology1,  Music.
...
education  for  a  boy.  And  Dialectic1,  which  in  Plato's  theory
...
Small  as  the  positive  value  of  such  a  course2  may  seem  to
...
within  the  mind  of  the  possessor1,  unknown  to  God  or  man,  no
...
him.  All  that2,  Socrates,  and  perhaps  more  than  that  would
...
the  true  reputation  on  either  side,  and  attach  the  false1,  we
...
keen-sighted  to  read  some  small  letters1  a  long  way  off,  and
...
one  man,  or  it  may  be  of  a  whole  city2  ?
...
Perhaps  there  may  be  more  justice1  in  the  larger  whole,  and
...
the  resemblance  of  the  greater  in  the  form  of  the  less2.
...
ways1.  Or  what  cause  but  this,  do  you  think,  can  set  up
a  city?
...
Then  the  minimum1  city  will  be  of  four  or  five  men  ?
e        So  it  seems.

What  then?  Is  each  one  of  these  to  contribute  his  own
product2  as  common  to  all ;  for  instance,  the  farmer,  being  one
...
business3  for  his  own  purposes  ?
...
too  notice,  now  that  you  have  suggested  it1,  that,  to  begin  with,
people  are  born2  not  quite  like  each  other,  but  with  different  b
...
body  and  incapable  of  discharging  any  other  function1.  For
they  have  to  wait  on  the  spot  in  the  market,  and  take  things
in  exchange  against  money  for  those  who  want  to  sell2,  and  D
...
travel  to  other  states  we  call  merchants1  ?

Quite  so.

Then  further,  as  I  imagine,  there  is  another  class  of  serving

men2,  who  in  their  intelligence  are  not  quite  capable  of  an
...
hire,  take  as  I  imagine  the  name  "workers  for  hire3."
...
the  wheat,  baking  some  and  kneading  some1,  and  serve  up
...
of  pigs1,  is  not  this  just  what  you  would  have  fed  them  on?
...
being,  so  to  speak,  a  healthy  one2;  but  if  you  like  to  go  on
...
taken  in  its  simple1  forms — houses,  clothing,  shoes — but  we
must  set  to  work  the  art  of  painting  and  procure  gold  and
ivory2  and  all  that  kind  of  thing.     Must  we  not  ?  b
...
for  purposes  outside  the  necessary1;  for  example  hunters  of  all
kinds  and  all  the  imitative  artists3,  many  of  them  working  in
form  and  colour,  and  many  dealing  with  music  and  letters,
such  as  poets  and  their  subordinates,  reciters,  actors,  dancers,
contractors4;  and  makers  of  all  sorts  of  apparatus,  including  c
that  of  women's  toilet5.     And  we  shall  want  more  personal
...
small  amount,  but  by  a  whole  army1,  which  will  march  out  and
...
to  be  of  the  nature  of  an  art2?
...
perform  it  well1?  Or  is  it  not  of  the  highest  import  that
...
Well  then,  I  continued,  the  greater  the  guardian's2  work,
...
Then  does  it  not  also  need  a  nature  suitable  to  the  nature1
of  the  calling  ?
...
bred  dog2  is  different  for  the  purpose  of  keeping  guard  from
...
what  an  irresistible  and  unconquerable  thing  is  spirit2,  making
...
a  disposition  at  once  gentle  and  great-hearted3?  for  I  presume
...
that  well-bred1  dogs  naturally  have  this  disposition,  to  be  as
...
to  being  spirited  to  be  also  a  lover  of  wisdom2  in  his  nature?      376  a
...
phenomenon  and  genuinely  philosophic1.
B        In  what  way  ?
...
C  ance3,  he  must  be  by  nature  philosophic  and  fond  of  know-
ledge4.
...
Then  of  one  who  is  to  be  a  perfect1  guardian  of  a  city  we
...
leisure3,  and  so  in  fancy  educate  our  men.
...
is,  I  imagine,  Gymnastic1  for  the  body,  and   Music2  for  the
mind.
...
of  fables,  and  select  any  good2  ones  which  they  compose,  and  c
...
tell,  far  more  really  than  their  bodies  with  their  hands3;  and
...
the  lie1  is  an  ugly  lie.
E        What  is  this  fault  ?

When  anyone  imagines  badly2  in  his  story  about  gods  or
heroes3,  what  they  are  like,  just  as  a  painter  whose  picture  has
...
ugly  lie  to  tell,  that  Uranus  did5,  what  Hesiod  says  he  did,  and
what  vengeance  Kronos  took  upon  him,  and  the  doings  of
378 a  Kronos5,  too,  and  his  treatment  by  his  sons;  even  if  it  had  all
...
few  as  possible  to  hear,  having  to  sacrifice  not  a  pig1,  but  some
...
fellow2,  and  that  to  be  so  is  a  sin,  this  is  rather  what  must  be  d
...
eilOne  of  the  first  simple  lessons  to  young  children;  the  duty  of  gentle-
...
we  must  not  receive  into  the  city1,  whether  the  poet  had  an
allegorical  meaning2  or  had  not.  For  the  young  are  not
...
for  we  have  far  fewer1  good  things  than  evil.  Now  what  is
...
Full  of  lots,  the  one  of  good,  the  other  of  evil  ones1."
...
the  strife  and  altercation  of  the  gods3  by  Themis  and  Zeus;
nor  must  we  permit  the  young  to  hear  how  Aeschylus  says
380 a  that  "God  implants  guilt4  in  mortals  when  he  intends  to  bring
...
House  of  Pelops5  or  the  Trojan  war  or  any  other  subject  of
...
affirming  that  God1,  who  is  good,  can  prove  the  cause  of  evil
...
is  a  wizard3,  and  as  of  malice  prepense  makes  appearance  first
...
effect1;  or  that  his  being  is  single,  and  of  all  things  least
...
same  time  slander  the  gods,  and  make  their  children  cowards2.
...
absolute  falsity1.     Is  it  not  so?  c
...
But  for  the  lie  in  words2,  when  and  to  whom  is  it  ex-
...
Then- the  superhuman1  and  the  divine  is  wholly  free  from
falsehood.

Absolutely  so.

Then  we  may  safely  say  that  God2  is  a  simple  and  true
...
not  approve,  the  sending  of  the  dream  by  Zeus  to  Agamemnon1;
...
guardians   are    to    prove   god-revering   and    god-like4,   to  the
...
they  say  is  not  true,  and  does  no  good1  to  men  whose  duty  it  c
...
fate,  leaving  manhood  and  vigour1,"
...
to  be  free6,  dreading  slavery  more  than  death.
...
make  them  too  hot  and  yet  too  soft3.
...
terrible  to  a  good  man,  whose  comrade  also  he  is4.
...
nently sufficing5  to  himself  in  living  well6,  and  is  least  of  all  E
...
repugnance1  to  behaving  like  them.
...
head,  nor  weeping  and  lamenting3  on  other  occasions,  when
...
the  city,  and  my  heart  laments3,"

and

"Ah  me!    that  it  is  fate  for  Sarpedon,  dearest  to  me  of  men,  to  be  d
subdued  by  Patroclus,  Menoetius'  son4."
...
sort5 ;  but,  more  likely,  without  shame  and  without  endurance
...
But  this  is  wrong,  as  our  argument  indicated  just  now1,
...
saw  Hephaestus  bustling  through  the  banquet-hall3,"
...
falsehoods,  any  of  those  who  are  craftsmen3,
...
But  further,  will  not  temperance1  be  necessary  to  our  young
men  2  ?
...
"Friend,  sit  in  silence,  and  obey  my  word4,"
...
"  O  heavy  with  wine,  dog-faced,  with  the  heart  of  a  deer1,"
...
round  and  pours  it  into  the  cups2,"

does  this  appear  to  you  to  be  conducive  to  self-restraint  in
a  young  man  ?  or  the  words

"  To  die  and  meet  doom  by  hunger  is  the  most  pitiful  thing3  "  ?
...
"Without  their  parents'  knowledge1,"
or  the  binding  of  Ares    and  Aphrodite    by  Hephaestus8  for
similar  reasons?
...
'  Endure,  my  heart;  yea,  a  harder  thing  thou  didst  once  bear4.'"
...
"Gifts  convince  gods,  and  convince  reverend  kings6,"
nor  must  we  approve  of  Phoenix7  the  attendant  of  Achilles  as
...
fact,  that  Achilles1  himself  was  so  covetous  as  to  take  presents
...
surely  I  would  take  vengeance  on  you,  if  I  had  the  power2,"
...
"  Let  me  offer  it  to  Patroclus  the  hero,  to  take  with  him3,"

he  being  a  dead  man,  and  that  he  did  so.  And  the  dragging
of  Hector  round  the  tomb  of  Patroclus,  and  the  slaughter  of
the  captives  over  the  funeral  pile4,  all  of  this  we  shall  deny  to
...
outrages1,   or  that  any  other  hero,  son  of  a  god  or  goddess,
...
that  they  were  sons  of  gods  ;  but  never  to  affirm  both  at  once2,

or  to  set  about  convincing  our  youths  that  gods  produce  evil

E  offspring  and  that  heroes  are  no  better  than  men.     For  as  we

were  saying  above3,  such  stories  are  sinful  and  untrue;  for  we
...
"Whose  altar  to  ancestral  Zeus  is  on  the  hill  of  Ida,  in  heaven4,  and  the
...
good  and  one's  own  loss1;  and  all  this  we  shall  forbid  men  to
...
narrative  by  way  of  imitation2?
...
these  proportions2  the  rest  of  his  narrative  about  what  took
place  at  Ilium,  and  events  in  Ithaca  and  throughout  the
Odyssey.

Exactly  so.

Now  it  is  narrative3  both  when  he  is  repeating  the
...
in  figure,  is  to  "imitate4"  that  person  to  whom  one  assimilates
himself?
...
Achaeans  might  pay  for  his  tears  through  Apollo's  arrows1.
...
in  imitative  shape  and  partly  not,  and  then  of  what  kind6  each
...
guardians  are  to  be  imitative3  or  not;  or  is  this  a  further
...
composing  tragedy  and  comedy1.  Or  did  you  not  call  these
...
tragedy;  and  all  these4  are  cases  of  imitation,  are  they  not?       b
...
that  is  ugly1,  that  they  may  not  from  the  imitation  be  infected
...
men  to  imitate  a  woman2,  whether  young  or  old,  either  abusing
...
trary way  to  what  we  said  but  now2,  reviling  and  satirising  one
...
Then,  I  said,  if  I  understand  what  you  tell  me1,  there  is
...
has  been  bred  and  nurtured  in  the  opposite  way3.
...
standing,  except  for  the  sake  of  amusement4.
...
if  a  suitable  inflexion4  and  rhythm  be  adapted  to  his  mode  of
...
these  into  the  city2,  or  one  of  the  two  unmixed  types,  or  the
mixed  type  ?
...
and  by  far  the  most  pleasant  to  children  and  their  attendants1
and  the  bulk  of  the  crowd  is  the  opposite2  type  to  that  which
you  select.
...
addition  to  his  shoemaking3,  and  the  farmer  a  farmer4  and  not
a  judge  in  addition  to  his  farming,  and  the  soldier  a  soldier  and
not  a  money-maker5  in  addition  to  his  soldiering,  and  so  with
...
perfumes  over  his  head  and  garlanded  him  with  wool1;  but  we
ourselves  should  employ  the  severer  and  less  delightful  poet2,  b
...
tell  within  those  outlines,  which  we  enacted  at  the  beginning3,
...
of  music  which  includes  stories  and  fables1  is  completely
...
down,  and  its  form  be  what  we  prescribed2.
...
Mixo-Lydian,  he  said,  and  syntono-Lydian2,  and  some  of
that  type.
...
and  so  are  softness3  and  indolence.
...
I  am  not  acquainted  with  the  modes4,  I  said,  but  leave  me
...
that  mode  which  will  properly  imitate  the  tones1  and  inflexions
...
ately  and  reasonably,  and  accepting  the  issue2.  These  two
...
strmged  of  all1,  and  the  instruments  of  many  modes  themselves
...
And,  by  the  dog2,  I  said,  without  noticing  it  we  are  purging
...
Next  after  modes  we  must  treat  of  rhythms3,  deciding  not  to
...
aim  at  elaborate  ones  nor  very  varied  movements1,  but  see
what  are  the  rhythms2  of  an  orderly  and  courageous  life  :  and,
...
and  tune3.  But  which  these  rhythms  may  be,  it  is  for  you  to
point  out,  as  you  did  the  modes.

By  Zeus,  he  answered,  I  cannot  say.  I  have  indeed  seen
enough  of  the  subject  to  affirm  that  there  are  some  three  forms4
...
four1,  out  of  which  all  the  modes  arise,  but  which  of  these  are
imitations  of  which  type  of  life,  I  cannot  say.

b  Well,  then,  on  these  points  we  may  take  Damon2  into  our
...
speaking  of  a  cretic3  metre  which  was  compound,  and  a  dactyl
and  heroic  foot,  too,  arranging  them  somehow  so  that  the  up
and  down  were  equal4,  being  resolved  into  long  and  short ;  and
I  fancy  he  named  an  iambus,  and  a  trochee5  too,  and  marked

C  longs  and  shorts  in  them ;  and  in  some  of  them  I  fancy  that  he
censured  and  approved  the  movement  of  the  foot6  no  less  than
...
And  what  of  the  form  of  narrative1  and  the  narrative  itself?
does  it  not  follow  the  character2  of  the  mind?
...
good  proportion3,  attend  upon  a  good  character,  not  the  fool-
...
every  way4  if  they  are  to  do  their  duty5  ?
...
form1.  And  wrongness  of  form  and  bad  proportion2  and  in-
harmoniousness  are  akin  to  bad  thinking3  and  bad  character,
while  their  opposites  are  akin  to  the  opposite,  a  temperate  and
noble  character,  and  are  imitations4  of  it.
...
it  all2,  from  whichsoever  of  the  beautiful  works  a  something
may  strike  upon  their  seeing  or  their  hearing,  like  a  breeze
bearing  health  from  wholesome  places ;  bringing  them  un-  d
consciously  from  early  childhood  both  to  likeness3  and  to
...
which  "music"  is  the  right  nurture1.
...
but  we  were  eager1  to  discern  them  in  every  quarter,  considering
that  we  should  never  be  scholars  till  we  had  that  readiness.

True.

And  so  again,  we  shall  not  recognise  the  reflections2  of
...
not  be  "musical3,''  neither  ourselves  nor  the  guardians4,  whom  c
we  say  that  we  have  to  educate,  until  we  recognise  the  forms  of
temperance  and  courage  and  liberality5,  and  all  akin  to  them,
...
character  in  his  soul  and  qualities2  in  his  form  accordant  and
harmonious  therewith,  partaking  of  the  same  pattern3?
...
a  cultivated4  man  could  love?  but  he  could  not  love  one
...
early   childhood3    throughout   life.     And    as    I    suppose,    the  403°
matter  stands  thus;  but  you  must  help  me  to  consider  it.    I  do
not  think  that  the  body,  however  good  as  a  body4,  can  by  any
...
Well,  we  said  that  they  were  to  abstain  from  drinking1;  for
...
greatest  of  contests2,  are  they  not?
...
Then  would  the  habit  of  the  men  in  training1  whom  we  404  a
...
military2  champions,  since  they  have  to  be  as  wakeful  as  dogs,
...
Why,  I  answered,  Homer4  is  enough  to  teach  us  that.    For
...
cusan  courses  and  Sicilian  multiplicity1  of  savouries  if  our  views
...
of  importance,  because  even  free  men1  run  after  them  in
...
will  have  no  need  of  a  sleepy  judge1  ?
...
Asclepiadae2  to  baptise  our  ailments  with  names  like  flatulence
...
e  infer8  it,  because  his  very  sons,  when  at  Troy  the  nurse  gave
...
Herodicus,  who  was  a  trainer1  and  became  an  invalid,  mixed
...
that  from  no  ignorance3  or  inexperience  did  Asclepius  refuse  to  c
...
to  give  him  a  drug  to  drink  that  he  may  throw  up  the  evil1,  or
to  rid  him  of  it  by  a  downward  purge  or  by  cautery  or  the
knife.  But  if  any  man  orders  him  a  prolonged  cure2,  putting
...
his  health,  and  lives  in  discharge  of  his  duty3 ;  or,  if  his  body
...
let  us  make  it  clear  to  ourselves  whether  the  rich  man  has  this2
...
to  be  produced  by  the  pursuit  of  knowledge1,  so  as  to  present
obstacles  at  every  point  where  excellence  is  practised  and
tested  in  that  direction2;  for  it  makes  you  continually  think
...
and  adding  in  minute  quantities3,  to  make  such  a  man's  life  a
...
offspring  no  better  than  himself1;  but  he  thought  it  wrong,
we  must  say,  to   give  medical  treatment  to  any  one  who  is
unable  to   live  in  the  common  course  of  life,  deeming   him  e
an  unprofitable  person  both  to  himself  and  to  the  State2?
...
Pandarus  shot  him,  "they  squeezed  out  the  blood3,  and
...
ance with  what  we  said  before1,  do  not  believe  both  their
...
We  should  get  the  most  skilful  physicians2,  I  said,  if  from
...
be  by  nature  not  entirely  healthy1.  For,  I  imagine,  they  do
not  treat  the  body  with  the  body2;  if  they  did,  it  would  never
...
But  the  judge,  my  friend,  rules  over  mind3  with  mind,  for  4°9  A
...
knowledge1  and  not  of  his  own  experience,
c        Certainly  such  a  judge  is  of  the  finest  type.

Yes,  and  good  too,  to  answer  your  question2;  for  he  who
...
of  badness  alike1.     So,  as  seems  to  me,  it  is  this  man,  and  not  e
the  villain,  who  learns  to  be  wise.

I  agree,  he  said.

Then  will  you  not  establish  by  law  in  your  State  such  a
medical  art2  as  we  referred  to3,  in  conjunction  with  a  similar
judicial  art2,  which  together  shall  give  treatment  to  those  of  410  a
...
shall  themselves  put  to  death4?
...
which  we  affirmed  to  generate  temperance1.

No  doubt,  he  said.
b        Then  will  not  this  same  be  the2  track  on  which  the  man
trained  in  music  will   pursue  gymnastic  and  attain  it  if  he
chooses,  so  as  not  to  need  the  medical  art3,  except  on  some
special  compulsion  ?
...
that  they  might  treat  the  body  by  the  one4,  and  the  soul  by  the
other  ?

How  then  ?

It  is  probable  that  they  institute  both  of  them  principally
for  the  sake  of  the  soulc.
...
very  mind  of  men  who  spend  their  whole  life  in  gymnastic1,
...
selves to  unmixed  gymnastic2  turn  out  fiercer  than  is  right,
...
loving1  nature;  and  if  it  is  too  much  relaxed  it  will  be  softer
than  it  ought,  but  being  properly  nurtured  will  be  gentle  and
orderly.

It  is  so.

And  we  say  that  the  guardians2  ought  to  have  both  of  these
natures.

They  ought.

Then  ought  not  these  to  be  brought  into  harmony3  with
one  another?
...
0  I.e.  is  not  this  an  essential  of  any  education  which  can  be  called
complete?
...
mentioning1,  and  he  passes  his  whole  life  long  humming  to
himself  and  under  the  glamour  of  song2,  then  to  begin  with,  if  b
he  had  any  spiritedness,  he  softens  it3  like  iron,  and  makes  it
useful,  instead  of  useless  and  hard ;  but  when  he  goes  on
unremittingly  till  it4  is  spell-bound,  from  that  point  onwards
...
pursuit  of  culture1,  the  first  thing  is,  is  it  not?  that  in  his  good
...
of  communion  with  the  Muse2,  then,  even  if  there  was  some-
i>  thing  of  studiousness  in  his  soul,  since  it  is  given  no  taste  of
study  or  research,  and  partakes3  of  no  discourse  or  "music"  in
any  shape,  it  grows  weak  and  deaf  and  blind,  because  it  is
never  awakened  nor  fed  nor  are  its  senses  purged'4.

Just  so.

Such  an  one,  I  imagine,  becomes  a  hater  of  thinking5  and
an  uncultivated  man6,  and  gives  up  making  use  of  persuasion
...
Then,  for  these  two7,  I  shall  say  that — as  seems  natural —
...
for  mind  and  body,  unless  incidentally,  but  for  those  two1,  that
they  may  be  brought  into  tune  with  one  another,  being  strung  412  A
up  and  relaxed  to  the  proper  pitch2.
...
who  tunes  the  strings  to  each  other3.

With  good  reason,  Socrates,  he  said.

Then,  Glaucon,  will  it  not  always  be  necessary  to  have
some  such  controller4  in  our  State,  if  the  polity  is  not  to  perish?  b
...
ship1? For  it  is  pretty  clear  that  they  must  be  in  accordance
...
must  be  the  most  guardian-like  of  the  city1  ?
...
thinks  to  have  the  same  interests2  with  himself,  believing  that
...
ages,  to  note  whether  they  are  guardian-like3  of  this  doctrine,
and  neither  by  witchery  nor  by  force  can  be  brought  to  forget
and  to  let  go  the  opinion4  that  they  ought  to  do  what  is  best
...
voluntarily1?  or  is  it  not  a  bad  thing  to  be  deceived  about
the  truth2,  and  a  good  thing  to  be  true3?  or  does  it  not  seem
to  you  that  to  think4  what  is'3,  is  to  be  true  ?
...
observe  them  from  childhood  up,  setting  them  tasks2  in  which
...
the  mise-en-scene,  and  is  not  essential  to
