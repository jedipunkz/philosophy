---
source: "https://archive.org/details/philosophyofkan00kant"
title: "The philosophy of Kant as contained in extracts from his own writings"
author: "Kant, Immanuel, 1724-1804, Watson, John, 1847-1939"
year: "1901"
captured_at: "2026-07-03T14:36:06Z"
updated_at: "2026-07-03T14:36:06Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "カント"
query: "Critique of Practical Reason"
plain_text_url: "https://archive.org/download/philosophyofkan00kant/philosophyofkan00kant_djvu.txt"
public_domain: true
...
- 著者: Kant, Immanuel, 1724-1804, Watson, John, 1847-1939
- 初版: 1901
- 情報源: [archive](https://archive.org/details/philosophyofkan00kant)
- パブリックドメイン: ✓
...
$nblishers  to  the  gtmbcrsitj).

MACMILLAN    AND   CO.,    LONDON    AND   NEW   YORK.

London,  .     .     .     Simpkifi,  Marshall,  Hamilton,

Kent,  and  Co.,  Limited.
Cambridge,  .     .     M acmillan  and  Bcnves.
...
publishers  tu  the  Bntbersitfi.

1894.

INE  1NSTITUTF  C~  STUDIES
...
Max  Müller,  Dr.  Hutchison  Stirling,  Mr.  Mahaffy,  and
...
really  consists  of  two  prefaces  throwrn  into  one ;  but  the
...
Anticipations  of  Observation,     .         .  96
...
C.  Community,       .         .         .         .  118
Postulates  of  Empirical  Thought,        .  122
...
Critique  of  Teleological  Judgmei

Section  I. — Analytic,  .

Section  II. — Dialectic,
...
This  may  well  be  called  the  age  of  criticism,  a  criti-  vj
...
Metaphysic    has    been     the    battlefield     of    endless  ü
conflicts.     Dogmatism  at  first  held  despotic  sway  ;  but  iii
...
nil.  iKi  i  i.Mi'  mi    i'iJKK  ki  \so\.  3
...
xiv  'ts  point  of  view  entirely  to  the  idea,  that,  while  reason
...
xvj  In  metaphysical  speculations  it  has  always  been
...
knowledge  of  objects  presented  to  it.  To  this  rule,  as
...
THE  CRITIQUE  OF  PI  RE  Rl  \  ION,  5

first  estimate  «»t  the  a  priori  knowledge  of  reason,  that
such  knowledge  relates  not  at  all  to  the  thing  as  it  exists
in  itself,  but  only  to  phenomena.  For  that  which
necessarily  forces  us  to  go  l>eyond  the  limits  of  expericn«  e
and  of  all  phenomena  is  the  unconditioned,  which  reason
demands  ot  things  in  themselves,  and  by  right  and
...
belonging  to  a  thing  in  itself,  it  is  not  subject  to  that  law,  but

xxix  \s  free.  Now,  morality  requires  us  only  to  be  able  to  think
...
each  be  true  in  its  own  sphere  j  which  could  never  have
...
THE  CR1  riQUE  OF  PUF  I    im   \   ON.  7

once  for  all  of  its  pernicious  influence  by  <  losing  up  the

ww  sources  of  its  ermrs.  ( )ur  critique  is  not  opposed  to  the
...
But,  although  all  our  knowledge  begins  with  experience,1
...
THE  CRITIQUE  l  >F  PI  Rl    Rl  *  <>

might  have  known  it  would  fall,  without  waiting  for  the
event  to  take  place  in  his  experience.      But  he  could

not  know  it  completely  a  priori;  lor  it  is  only  from
perience  that  he  could  Kam  that  Ik  »dies  arc  heavy,  and
...
change  has  its  cause  is  a  prioi'i,  but  it  is  not  pure,
...
Evidently  what  we  need  is  a  criterion  by  which  tc
...
IO  THE  PHILOSOPHY  OF  KANT.

has   gone,   there  is  no   exception   to  this  or  that  rule.
If,  therefore,  a  judgment  is  thought  with  strict  univer-i
sality,   so  that  there  can  be  no  possible  exception  to
it,  it  is  not  derived  from  experience,  but  is  absolutely  I
a  priori.     Necessity   and    strict  universality  are,   there- 1
...
that  every^^hange  must  have  a  cause.  To  take  the
...
THE  CRITIQUE  01    PURE  REASON.  i  i

3.    ./   Science  is  needed  to  determine  </  priori  the  possi-
bility, thi  principles,  and  the  extent  of  all  KnowUa
...
to  bear  on  the  one  single  task  of  solving  them  is  1
metaphysic.
...
on  the  wings  of  pure  ideas,  launched  out  into  the  empty( . kj
...
THE  CRITIQUE  OF  PURE  REASON,  I  |

the  greater  part,  consists  in  the  analysis  oj  concepjii
io  which  we  already  possess.     This  analysis  really  gives  us  6

a  kind  of  a  priori  knowledge  that  is  sale  and  useful.
But,  misled  by  this  success,  reason  interpolates  prop'
tions  of  quite  a  different  character,  which  hut  superficially
resemble  the  others.  I  shall  therefore  at  the  very  outset
point  out  the  distinction  between  these  two  kinds  of
knowledge.

4.    The  distinction  between  Analytic  and  Syntlutic
Judgments.
...
way  connected  with  it.  In  the  one  case  I  call  the  judg- 1
j  j  ment  analytic,  in  the  -other  case  synthetic.  Analytic  '7
...
1 2  I  already  possess.  I  have,  for  instance,  the  conception
...
In  a  priori  synthetic  judgments,  on  the  other  hand,  I|q

i  -y  can  get  no  aid  whatever  from  experience.  But,  if  it  is
...
i  in    CR1  i  IQ1  i    "i    PUR]    i  i  \  '  IN,  15

what  right,
vent  to  the  i

mentsmay  be  derived.  1  Uit  the  conception  of  a  cause
lies  entirely  outside  the  conception  oi  an  event,  and
introduces  an  idea  not  contained  in  it.     By

then,  do  I  pass  from  the   conception   of  an    eve:
...
u,ives  support  to  the  understanding,  when  it  seems  to  have
...
mere  conceptions.  And  yet  our  speculative  a  prioi'i^
knowledge  must  rest  upon  such  synthetic  or  ampliative '10
propositions.

14    5.     The  principles  of  all  Theoi'etical  Sciences  of  reason
are  a  priori  Synthetic  Judgments.

(1)  All  mathematical  judgments,  without  exception,
are  synthetic,  v  No  doubt  the  mathematician,  in  his
...
!(3  perception.  The  propositions  of  arithmetic  are  therefore
...
As  these  sciences  actually  exist,  we  may  fairly  ask  ho7c>

_l,       they  are  possible ;    for  that  they   must  be   possible    is
...
22  disposition  to  seek  for  this  kind  of  knowledge.  But  as
...
THE   CRITIQUE   OF    PURE    REASON.  10

disposition  to  metaphysical  speculation,  or,  in  other
words,  with  the  bare  ability  of  pure  reason  to  construe  t
some  sort  ot Hutaphysic.  It  must  be  possible  for  reason
to  attain  to  certainty  oneway  or  the  other  :  we  must  be
...
2  4      7.     Idea  and  Division  of  the  Critique  of  Pure  Reason.
...
error.     By  transcende?ital  knowledge  I  mean  all  know-
...
a  priori  knowledge.
2  7  This  transcendental  criticism  will  afford  a  complete  archi-  x  3
...
in  a  complete  estimate  of  a  prioi-i  synthetic  knowledge.
...
i  HE   CR]  I  [Ql  B   OF    PUR1    Rl  ason.  2\

given  to  us,  .in  investigation  Into  the  nature   of  that
...
object  of  such  a  perception  is  &  phenomenon  (Erscheinung).
...
of  a  phenomenon  is  given  to  us  entirely  a  posteriori,  hut
...
This  pure   form  of  sensibility   is  also  called  pureper-
...
sensation,  as  impenetrability,  hardness,  colour,  etc.  ;  21
...
I  i:  tNSCINDEN  PA1      BSTH1  PIC

The  science  of  all  the  a  priori  principles  of  sensibility
36  I  call  Transcendental  /£sthetüt  in  contradistinction  from
the  science  of  the  principles  of  pure  thought,  which  I
call  Transcendental  Logic,

In  'rranscendent.il  .  Ksthetic  we  shall  firsl  '»fall  isolat
...
In  external  sense  we  are  conscious  of  objects  as  out-i
...
although  not  a  detailed,  statement  of  what  is  implied  ii
...
therefore,  necessarily  presupposed  in  external  perception.  I
...
TRANSCENDENTAL   AESTHETIC.  25

35  we    think    space    to    be   away,    although    wc    can    quite (
...
(3)  Space  is  not  a  discursive  or  general  conception  0^25
the  relations  of  things,  but  a  pure  perception.  For  we  I
...
wider  the  conception  ;  but,  from  its  very  nature,  no
conception    can    possibly  be    supposed   to    contain   an

20  THF.    PHILOSOPHY    OF    KANT.
...
cessful, it  must  prove  (1)  that  there  really  are
...
41  sciousness  of  it  must  be  perception,  for  no  new  truth,
...
(0)  Space  is  nothing  but  the  form  of  all  the  phenomena \
...
IK  \\m  END!  ni\i.   ASTHE1  i<  .  29

true  only  undei  the  limitation  that  we  are  speaking  of  our
own  sensible  perception.  But,  if  we  more  exai  tly  di  fine
the  subject  of  the  proposition  by  saying,  that  all  things

as  (.\tcnial  phenomena  are  side  by  side  in  space,  it  will
...
4.  Metaphysical  Expositor  of  Time.
...
if  time  is  taken  away,   although  we  can   quite  readilv

30  THE    PHILOSOPHY    OF    KANT.
...
one  single  time.  There  must,  therefore,  be  originallv
...
TF  IN SCEN DENTAL   ASTHETIl  ,  31

not  follow  one  another  but  po-exist  Such  propositions
...
lav  down  the  conditions  without  which  no  experience
whatever  is  possible  :  they  are  not  learned  from  experi-
ence, but  anticipate  what  experience  must  be.

Let  me  add  here  that  change,  including  motion  01
...
r0  object,  time  cannot  be  a  determination  of  outer  pheno-
...
51  dition  of  outer  phenomena.  Just  as  I  can  say,  a  priori,
...
but  it  is  no  longer  objective,  if  we  abstract  from  our  ic
...
to  absolute  reality,  because  such  a  claim,  in  paying  no  36
...
(hange  in  our  own  ideas.  Now,  changes  can  take  place
onlv  in  time.     Therefore  time  is  real.

TRANSCENDENTAL   ASTHETIC.  35
...
5  1  tions  as  in  it.  Time  is  therefore  real,  not  as  an  object]
...
eg       8.    General  remarks  on  the  Transcendental  Aesthetic.

,  (1)  A  distinction  is  commonly  drawn  between  what  4-
...
I  RANSCI  Nl'l  N  I  AI.    MS  111  KT  IC.  37
...
He  can  never  be  an  object  of  se?isuous  perception  to
...
it  is  derivative  (intuitu*  dcrivativus)  and  not  original
(intuitus  origin arius),  and  therefore  is  not  an  intellectual
...
our  consciousness.  Perception  and  conception,  there-j
fore,  are  the  two  elements  that  enter  into  all  our
knowledge.  To  every  conception  some  form  of  percep-
tion corresponds,  and  no  perception  yields  knowledges
...
pure  perception  contains  only  the  form  under  which  a  51
...
i  R  \\ ...  ENDENTAL    LOGIC,  41

duces  ideas.     We  arc  so  constituted  that  our  perception

always   IS  sensuous  ;    or  it    shows    merely    the   manner   id

which  we  are  affected  by  objects.  But,  we  have  also
understandings  or  the  faculty  of  thinking  the  object  of
sensuous  perception.  Neither  of  these  is  to  be  regarded  y
...
or  capacities  can  do  the  work  of  the  other.  Under- 1
standing   can   perceive   nothing,   the    senses    can    think

76  nothing.  Knowledge  arises  only  from  their  united  action.  1
...
mind  in    pure   general   logic.     (1)  As  ge??eral  logic,   it\
abstracts  from  all  content  of  thought,  and  from  all  dis- 1
tinction  of  objects,  and  deals  only  with  the  pure  form  of
thought.     (2)   As  pure  logic,  it  has  no  empirical  prin-
ciples.    Psychology  has  no  influence  on  the  canon  of  the1

42  THE    PHILOSOPHY    OF    KANT.
...
8°  case,  there  will  be  a  logic  that  does  not  abstract  from  all
...
TRANSCENDENTAL    LOOK  1",

priori*  Such  a  science,  as  setting  forth  the  origin,  the
limits,  and  the  objective  validity  of  pure  i  on<  eptions,  we
must  call  Transcendental  Logic.

82  3.    Division  of  General  Logic  into  Analytic  and
...
ledge may  be  estimated.  This  part  of  logic,  which  ist
...
87  4.    Division  of  T?-a?iscendental  Logic  into   Analytic   and  62
...
88  found   to   which    the  pure  conceptions    of   understand- J
...
that  may  be  employed  universally  and  without  restriction,  I
...
TF  INSCENDENTAL   LOGK  45

a  criticism  of  understanding  and  rea  on  in  their  hyper
...
Section  L — The  Logical  Use  of  Understanding.
...
rRANSCENDENTAl      ANALYTIC.  17

human  understanding,  is  a  knowledge  by  means  oi  con
ceptions;  it  is  not  perceptive,  but  discursive.     All  per

(options,    as    sensuous,     rest     upon     a!k-<  timis,    whereas'

conceptions  rest  upon  functions.     By  function  1  mean
...
95     Section  II — 9.    The  Logical  Function  of  Understanding    7°
...
ii'  INSCENDENTAL    an.\i.\  i  [I  .  49

102  Section  FIT. — 10.  The  Pure  Conceptions  of  Understanding  76

or  Categories*

Genera]  Logic,  as  has  been  said,  abstracts  from  all  tin
...
dental Esthetic  j  without  this    complex,    as  a  material
...
multiplicity  in  one  consciousness.  Such  synthesis  impure,
...
the  content  of  a  conception  cannot  originally  come  into  I
...
ideas  is  brought  to  conceptions.     The  first  element  that  l
enters  into  the  knowledge  of  all  objects  a  priori  is  the
complex   content    of    pure    perception.       The    second  \  9
element  is  the  synthesis  of  this  content  by  imagination.
But  as  even  this  is  not  enough  to  constitute  knowledge,

Ik  INSCENDEN  ru.    an  \i.vnr.  51

a   third   element  is  Bupplied  by  understanding,  in   the

conceptions  which  give  unity  to  this  pure  synthesis,  and
which  consist  solely  in  the  cons*  iousness  of  this  necesa
...
various  ideas  in  •&  perception  ;  and  this  synthesis,  in  its
...
do  not  fall  within  the  view7  of  general  logic.
...
110  The  four  classes  of  categories  naturally  fall  into  two
...
ence of  those  objects,  as  related  cither  to  one  another

TRANSCENDENTA]      ANALYTIC.  53

>r   to   understands        The   firs!   may   be  called    the
...
1 1 1  the  first.  Thus  totality  or  allness  is  just  plurality  regarded
as  unity,  limitation  is  reality  combined  with  negation,
community  is  causality  in  which  two  substances  mutually
determine  one  another,  and  lastly,  necessity  is  ]ust  existence
given  by  mere  possibility.

n6        Chapter  II. — Deduction  of  the  Categories.       84
...
117  called  its  deduction.  Now,  among  the  variety  of  con- 85
...
synthetic  knowledge  of  objects  which  is  independent  of  I
...
i  u  INSCENDEN  I  'AL    wain  riC  55

empty,  and  without  any  phenomenal  obje<  t  correspondinj

to  it?
1-3      We  cannot  avoid  the   toil  of  such   investigations   by  91
...
[24  altogether  as  a  mere  fiction  of  the  brain.  For  the  con-
ception demands  that  something  A  should  be  of  such  a
nature  that  something  else  B  follows  from  it  ?iecessarily,
...
possible  experience.     Conceptions  which  make  experience  I
...
tion, to  show  that,  apart  from  them,  no  obj ect  ^whatever  97
...
of  various  ideas,  or  modifications  of  the  mind  ;  secondly,  <v,
...
TR  INSC1  M'i •  \  i  iL   an  \i  i  riC.  57
...
1.  Synthesis  of  Apprehension  in  Percept  ion.
...
source  a  priori  or  in  experience,  as  modifications  of  thdoo
...
a  prio?-i  also,  or  in  relation  to  determinations  not  given  in
sensible    experience.       Otherwise    we    should   have   no

58  THE    PHILOSOPHY    OF    KANT.

consciousness  of  space  and  time  a  prioii,  for  these  can  ioo
...
2.  Synthesis  of  Reproductio?i  in  Imagination.
...
imagination,  being  prior  to  all  experience,  rests  upon  as
...
consciousness;  hence  the  object-^,  which  corresponds

TRANSCENDENTAL  ANALYTIC  6l
...
1  various  determinations.  In  saying  that  we  know  the
...
There  can  be  no  knowledge  without  a  conception,  j
...
the  synthesis  of  the  various  determinations  implied  in  I
...
of  that  which  must  7iecessarily  be  numerically  identical.
...
ness I  call  lranscende7ital  apperception.  That  this  is  the
...
together  in  one  experience,  and  subjects  them  to  laws.l
...
129  15.  Possibility  of  any  Combination  whatever.1"
...
the  categories,  as  it  appears  in  the  second  edition  of  the  u  Critique."

64  THE    PHILOSOPHY    OF    KANT.
...
matter  what  may  be  the  form  of  combination  j  and  that
...
it  to  resolve  j  for  without  the  combining  activity  of
...
TRANSCENDENTAL    w  \i.vi  n  .

1 6.    The  original  Synthetic  unity  of  Apperception.
...
saying,  th.it  I  should  not  be  conscious  at  all,  or  at  least
...
the  "It/iink"  in  the  subject  that  is  conscious  of  them.
...
P'or,  the  various  determinations  given  in  a  certain  per-
...
a?ialytic  unity  of  apperception  is,  therefore,  possible  only
...
which  I  am  conscious.  Synthetic  unity  of  the  various  j
...
i  R  INS<  i  NDEM  r  \i.    .\\.\i.\  i  [{  .  67

observing  their  combination.  All  combination  is  the  I
...
determinations  given  in  perception.  The  unity  _of
...
1 36  which  all  the  determinations  given  to  me  must  stand,  but
under  which  they  can  be  brought  only  by  means  of  a
synthesis.

68  THE    PHILOSOPHY    OF    KANT.

17.   Th e  synthetic   unity   of  Apperception  is  the  supreme
...
1-7  capable  of  being  combined  in  one  consciousness.  Apart
from  the  synthetic  unity  of  apperception,  nothing  can  be
thought  or  known,  because  the  determinations  given  in
perception,  not  having  the  act  of  apperception,  "  I  think"
in  common,  would  not  be  comprehended  in  one  self-
consciousness.

Speaking  quite  generally,  understanding  is  the  faculty  1
...
IK  \\s.    I    \M   \  I    \l.     AN  \l.\   I  If.  (><)

The  principle  of  the  original  synthetic  unity  of  apper
ception,  as  being  completely  independent  ol  ill  conditions
oi  sensuous  perception,  is  the  supreme  condition  of  the
...
which  I  must  observe  in  knowing  an  object,  but  it  is  a  I
condition  under  which  every  perception  must  stand,
before  it  can  become  an  object  for  vie  at  all.  Without  this
...
rRANSCENDBNTAl     w  \i  \  PIC.  7  '

through  the  association  of  the  elements  of  perception,  is
itself  a  phenomenon,  and  is  perfectly  contingent  l>ut
the  pure  tonn  of  perception  in  time,  as  merely  perception
in  general,  stands  under  the  original  unity  of  conscious-
ness just  because  the  various  determinations  given  in  it
are  necessarily  related  to  an  "  /  think."  It  ther<  I
stands  under  that  original  unity  by  means  of  the  pure
synthesis  oi  understanding,  which  is  the  a  priori  ground
of  the  empirical  synthesis.  Only  the  original  unit}'  of
...
!42  the  force  of  the  copula  "/V,"  which  just  marks  the' dis-
...
J  43  20.  All  sensuous  Perceptio?is  stand  under  the  Categories  as
...
possibility  oi  empirical  knowledge.  Now,  such  knowledge
...
TRANSCENDENTA]     ANALYTIC.  75

Beyond  those  limits  they  have  do  meaning  whatever,  foi
they  are  only  in  the  senses,  and  have  do  reality  apart
...
ours,  if  only  it  is  sensuous,  and  not  intellectual.  I  hit
...
140  thought,  could  be  applied.  Only  our  sensuous  and
...
contact  with  it.     But  what  most  concerns  us  here,  isT

7 6  THE    PHILOSOPHY    OF    KANT.

that  to  a  thing  of  that  nature,  not  even  a  single  category
...
1150  24.     The  application,  of  the  Categories  to  objects
...
that  intellectual  synthesis  (synthesis  intcllectualis),  which
...
ing to  the  conceptions  of  understanding,  only  under  the  I
...
r  -  q  26.    Transcendental  Deduction  of  the  Categories  as
...
TRANSCE  NDl  NTAL    w  IL1  I  II  .  79

ledge  of  the  laws  by  whirl;  the  combination  of  obji
...
x6?  Categories  are  conceptions  which  a  priori  prescribe
laws  to  phenomena,  and  therefore  to  nature  as  the  sum
total  of  all  phenomena  (?iatura  materialiter  spcctata).
...
a  subject  that  lias  understanding.  Things  in  themselves
would  of  course  have  laws  of  their  own,  even  if  they  did

I  i:  \\:  i    I   \|.|   N  I'M.     AN  \l.\   I  [(  .

not  come  within  the  knowledge  <>i  the  subject  through
his  understanding.  But  phenomena  are  w  xely  the
manner  in  which  things  appear  in  consciousness,  and  j
...
formaliter  spectaid)  has  its  ground  and  origin.  Pure
...
empirically  determined,  cannot  be  co77ipletely  derived  from
...
82  THE    PHILOSOPHY    OF    KANT.

2  7 .  Result  of  the  Deduction  of  the  Categories.
...
1 66  empirical  knowledge  is  experience.  Hence  there  can  be
...
objects  :  either  that  experience  must_make  the  concep-
...
experience  would  be  a  sort  of  gen  erat io  aequivoca.  The
...
168  Short  Statement  of  the  Deduction.

What  has  been  shown  in  the  deduction  of  the  cate-
gories is  that  the  pure  conceptions  of  understanding,  on

rRANS<   I  M'l  N  I  AI.    A\  \l.\  TIC.

which  .ill  theoretical  a  priori  knowledge  is  based,  are  onl)
principles  that  make  experience  possible.  In  other
169  words,  they  are  principles  for  the  general  determination  o!
phenomena  in  space  and  time,  a  determination  that
ultimately  Hows  from  the  principle  of  the  original  syn-
...
1 7  1  Transcendental  Judgment.  132

If  understanding  is  called  the  fa£ujty^f_rules,  judgment
will  be  the  faculty  o(  sub  sumption  under  rules,  that  is,  the
...
J72  pure  form  of  knowledge,  as  expressed  in  conceptions,  133
...
to  make  a  correct  and  certain  use  of  the  conceptions  of  1
...
The  transcendental  doctrine  of  judgment  consists  of  \  36
...
a  category  be  applied  in  determination  of  an  object  <>i
sense?  It  is  because  this  very  natural  and  very  important  1 3H
...
and  sensuous.     Such  an  idea  is  the  transce?idental  schema.
...
but,  as  introducing  it  imagination~does  not  seek  to  set
...
j8o  ness  of  a  universal  process  of  imagination,  by  which  an
...
i  R  tNSCENDENTAL    anai.vi  [(  .

universality  of  an  empirical  conception.  The  direcl
...
tion of  a  dog,  for  instance,  is  a  rule  tor  the  guidance  of
imagination  in  tracing  out  the  figure  of  a  certain  four-
looted  animal  ;  but  it  cannot  be  restricted  to  any  single
...
jgr  human  soul,  the  secret  of  which  we  need  not  hope  to
...
conceptions,  as,  for  instance,  of  figures  in  space,  is  a
...
congruent  with  the  conception.  But  what  distinguishes1
the  schema  of  a  pure  conception  of  understanding  as
such,  is  that  it  cannot  be  presented  in  an  image  at  all,  j
...
Number  is,  therefore,  the  unity  of  synthesis  implied  inU43
...
very  idea  of  which  is  that  it  has_no  being  in  tinie^-  The
...
the  vanishing  point  ( '  =  o  =  negatid).       Hence,  there  is
...
The  schema  of  substancejs  the  permanence  of  the  '
...
so  far  as  that  succession  is  subject  to  ajrule.
...
how  a  thing  is  capable  of  being  known  ajlajxy^Jtime.

The  schema  of  actuality  is  existence  in  a  determinate  145
time.

The_schema  of  necessity  is  the  existence  of  an  object
at  all  times.

90  THE    PHILOSOPHY    OF    KANT.

From  all  this  it  is  plain  that  the  schema  of  every  one
of  the  categories  is  in  some  way  relative  to  time.  The
schemaofj^ujnrtity  is  the  generation  or  synthesis  of  time
itself  in  the  successive  apprehension  of  an  object;  the
schema jrfjmality,  the  synthesis  of  sensation,  as  implied
...
in  its  three  forms,  time  itself  as  the  correlative  ofjhe
...
series  of  time,  the  cotitent  ofjiine,  the  order  of  time,  and  the
...
conditions  under  which  the  categories  obtain  significances
...
PRANSCENDENTAL    ANALYTIC.  9]

uess  in  the  original  unity  oi  apperception.  Thus  it  i
that  the  categories  make  phenomena  tit  for  .1  thorough
going  connection  in  one  experient  e.

Within  this  whole  of  possible  experiem  e  all  our  know
...
But  no  one  can    fail   to  see   that,   although   only  tin

186  schemata  of  sensibility  can  realize  the  categories,  tin  \
...
2 00  guide.  Accordingly  we  find  that  all  the  principles  of  161
...
Tk  \\  ICKNDl  N  i  \i     w  \i  \  nc

the  idea  of  a  line,  howevei  Bmall  it  may  be,  with
out  drawing  it  in  thought  ;  only  by  producing  its  parts
one  alter  the  other,  beginning  from  a  certain  point,  do  i  ■  I
...
is  an  extensive  magnitude.  Xo  phenomenon,  therefore,
...
drawn  j  that  two  straight  lines  cannot  enclose  a  space,
...
no  axioms,  although  several  of  the  propositions  referring  1Ö4

04  THE    PHILOSOPHY    OF    KANT.

lo  it  are  synthetic  and  immediately  certain  {indemon-
...
generated  in  the  one  case  is  identical  with  the  quantity  1
...
rRANSCENDENTA]      ANALYTIC  95

pre<  ision  is  applicable  to  objects  of  experien«  e  uland  this,
so  far  from  being  sell  evident,  has  been  the  occasion  of
...
whatever  geometry  says  of  pure  perception  is  beyond  j
...
hension of  a  phenomenon  even  possible,  and  hence  it  is  1 66
...
and  to  treat  them  as  if  they  were  things  in  themselves  I
...
extensive  magnitude.  The  absence  ot  sensation  from  the
...
reality  (rea/itas phacnomenon) ;  that  which  corresponds  to
...
TR  w   CENDENTAl     \\  w.\  TU  .  07

complete  negation,  Thal  is  to  Bay,  the  real  in  the
phenomenon  always  has  a  quantity,  but  oi  this  quantity
there  is  no  consciousness  in  apprehension,  because
apprehension,  so  far  as  it  is  due  to  the  inner  sensation,
takes  place  in  one  moment,  and  dors  not  consist  in
a  successive  synthesis  of  different  sensations,  and  there-
lore  does  not  advance  from  the  parts  to  the  whole.
...
to  negation  =  o,  I  call  an  intensive  magnitude.  Every
...
tum of  gravity,  to  indicate  a  quantity,  the  apprehension  of  ^9
which  is  not  successive  but  instantaneous.  I  make  this
remark  merely  in  passing,  for  this  is  not  the  place  to  treat
of  causality.
2 1 1  Every  sensation,  then,  and  consequently  every  reality
...
2 1 2  in  time,  the  continuity  of  which  is  usually  designated  by
the  X.wx\flux  or  flowing.
...
ing  sensation,  and  therefore  reality,  they  are  continuous  I
intensive  magnitudes.  When  the  synthesis  of  determina-  1
...
As  all  phenomena,  whether  they  are  viewed  extensively  1 7 I
...
217  The  quality  of  sensation — colour,  taste,  etc., — is  always  [yc
...
21S  ing  the  intensive  magnitude  of  a  phenomenon,  we  may,
...
i  i:  \\m  I  \i»i  \  I  \l      \\  u.ytic.

Bensations  ;is  such  arc  given  a  posteriorly  it  can  be  I. noun
a  prion'  that  to  all  belongs  the  property  of  having  a
degree.  It  is  remarkable  thai  of  quantity  in  general  only
...
sion o{  degree,  can  be  known  a  priori,  while  all  else  has
...
2 1 9  The  three  modi  of  time  are  permanence,  succession,  and  1 7  7
...
2  20  The  principle  of  all  three  analogies  rests  upon  the  neces-
...
phenomenon  may  be  so  determined  a  priori,  that  the  rule
...
be    generated     in     conformity    with    rules    of  a    matbe-

rRANSCENDENTAI     ANALYTIC.  103
...
determined  a  priori,  or  constructed,  by  \  tutting  together,
...
presented  a  priorL  Even  the  solution  of  an  algebraic
...
co?icreto — that  is,  in  pure  perception,  where  every  error  be-
...
titles  of  mathematics.  Such  empty  boasts  can  onl\
...
764  Apodictic  propositions  may  be  distinguished  as  either  17 3 6
dogmata  or  mathemata.     By  a  dogma  is  meant  a  synthetic
proposition  which  is  directly  derived  from  conceptions;

by  a  mathenid,  one  that  is  obtained  by  the  construction,

rRANSCKNDENTAL    INALYTZG  105

|oi    a   conception.      Of  these   two  classes  of  a  priori
synthetic  propositions,  popular  Ian  permits  us  to

apply  the  term  dogma  onl)  to  philosophical  knowledge,
...
experie?ice.  If  something  is  presupposed  as  an  object  of
...
It  must  be  called  zprviciple,  and  not  a  theorem,  because
...
766  our  reason  is  itself  subjectively  a  system,  though,  if  we  73S
...
nothing     bill    SO    many    modes    of    time    in    which    that

permanent  something  exists.     Only  in  the  permanent  <  an
there  possibly  be  the  relations  of  simultaneity  and  su<  <

sion,  which  are  the  sole  relations  in  time.      The  permanent  l8
...
1
possible  at   all.       Permanence   is   time  considered   (mite

generali}-,  as  the  constant  correlate  of  all  change  and  all
...
magnitude.  Apart  from  the  permanent,  there_is  therefore
...
istence as  ifiherence,  to  distinguish  it  from  the  existence
of  the  substance,  which  is  called  subsistejice.  But  this  is
...
although    strictly    speaking  it  does  not  itself  contain
...
existence  that  follows  upon  another  mode  of  existence
...
TP  INSCENDEN1  IL    w  \i  \  I  IC.  i  o<;

thai  only  the  permanent  changes,  while  the  changeable
is  Bubjecl  to  no  <  hange,  but  only  to  an  alternation^  in
which  certain  determination  i  to  be  as  others  begin
to  be.
...
as  alternating  determinations  ofthat  which  is  permanent.
[f  we  suppose  something  absolutely  to  begin  to  be,  we  I
must  also  suppose  that  there  was  a  point  of  time  in  which  '
that  something  was  not.  But  with  what  are  we  to  con-f
...
IK  INSCENDBNTAL    ANALYTIC  i  i  i

apprehension  or  reception  of  them  in  the  synth«  lis  oi
imagination.  So  far  we  must  therefore  Bay  that  the
...
connect  their  various  determinations~ih  time,  while  yet
...
think  of  saying  that  the  determinations  of  the  house  itself  I
...
that  is,  that  something,  or  some  state,  has  come  to  bei
237  which  before  was  not,  unless  there  has  previously  been
...
TRANSCENDENTA1     ANALYTIC.  i  i  ;

instance,  a  ship  moving  down  Btream.  I  first  observe
it  higher  up  the  Btream,  and  then  Lower  down,  and  it  is
impossible  thai  in  the  apprehension  of  the  phenomenon
I  should  Tust  observe  the  ship  lower  down  the  stream
and  then  higher  up.  The  order  in  which  the  percepti
...
perception  follow  one  another  in  myajoprehension  a
necessary_  order.
...
antecedetit point  of  time ;  on  the  other  hand,  the  progression
...
conditioned,    points     back     with     certainty    to     some  I
condition,   and   this  condition  is   what   determines   the  I
event.
...
TR  \\m  i  \i.i  \  i  \i     \\  \i  \  in.  115

presupposition,  and  this  presupposition  only,  is  even
the  experience  oi  an  event  possible  at  all.

No  doubt  this   seems    to   contradict   the  whole  view  oi

the  course  of  thought  that  the  facts  hive  always  been
...
time:  thejrinciple  that  we  can  derive  a  clear  conception
from  experience,  only  because  wejhave  ourselves  put  it
into  experience,  and,  jnxLeecL  -have  thereby  .made  £x-
perience  possible_at_-§ll-  No  doubt  we  cannot  have  a
...
position  in  time,  making  the  order  in  time  in  which  eacrr
occurs  necessary.     That  which  follows  or  occurs,  must
follow  in  conformity  with  a  universal  rule,  on  that  which
was  contained  in  a  preceding  state.      Thus  arises  a  seriesi
...
The  proof  of  this  proposition  rests  entirely  upon  the  201

TB  w  <  i  \i.i  \  i  \i.    \\.\i.\  i  k  .  117

following  pounds.     All  empirical  knowledge  implies  the
synthesis    by    imagination    ol    various    determinations,
...
event  inquestion  is  preceded  by  something  else,  which  it
...
empirical  judgments  with  regard  to  the  series  ofpercep-

Il8  THE   PHILOSOPHY    OF    KANT.

tions,  and  therefore  the  condition  of  experience.     The
principle    of  causality    thus    applies    to    all    objects    of!
experience  that  stand  under  the  conditions  of  succession,1
just  because  it  is  itself  the  ground  of  the  very  possibility'
of  such  experience.

236  C. — Th  ird  A  nalogy.  211

Principle  of  Co?n??iu?iity.
...
is  quite  empty,  do  doubt  the  existem  <  h  might  be

presented  in  turn  in  a  scries  of  observations;  but  this
...
contain  in  itself  at  once  the  causality  ^£jcejtaindeter-
minations   in   another  substance,  and  the   effects  of  the

causality  ofthat  other  substance.  In  other  words,  if
...
dynamical  community  (commerciiwi),  without  which  even
local  community  (commumo  spalii)  could  never  be  empiri-
...
fore, no  empirical  knowledge  of  co-existent  objects  ;  but
...
I  U.W     i    I   Mil   N  I AL     ANAI.N   IK.  I    '  I
...
snl »stances.  Through  this  commercium  phenomena,  in  so  215
far  as  they  are  external  to  one  another  and  yet  stand  in
...
a  prio7'i  unity,  there  could  be  no  unity  of  experience,  and
...
Ik  \\s(  i  \i,i  \  i  \i.    \\  tLYTIG  123

relation  to  the  faculty  oi  knowledge.     Granting  the  con
ception  of  a  thing  to  be  quite  complete,  l  may  yet  ask

whether  the  object  is  possible  or  actual,  and  if  actual,]
whether  it  is  also  necessary.  Such  determinations  arc
not  conceived  to  belong  to  the  object  itself;  the  only
point  is  how  the  object,  together  with  its  determinations,
is  related  to  understanding  in  its  empirical  use,  to  I
empirical  judgment  and  to  reason  as  applied  to  experience.  I
...
these  conditions  have  an  objective  reality  of  their  own,  i

or  apply  only  to  possible  things,  because  they  contain  in  1
...
(2)  The  postulate  which  relates  to  the  knowledge  of225
things  as  actual  demands  perceptio?is  of  sense,  and  therefore
...
iiw   i  END]  vi  \i      \\  \i  \  i  i    .  i  25

for«*  is  in  a  sense  a  priori,  if  we  can  but  show  that  it  is
...
observation  ot  the  attraction  of  iron  filings,  we  know  that
...
274  from  experience,  and  proceed  in  accordance  with  the
laws  of  the  empirical  connection  of  phenomena,  wre  shall
...
completely  a  priori,  but  only  comparatively  a  prio7'i,  or
reJatiyj?ly_J^o_j50j^  ^xi^tence  of  which  is  227
...
that  other  phenomena  have  been  presented,  except  the1
...
1 26  THE    PHILOSOPHY    OF    KANT.

be  necessary,  biul^onijL-the ^^  jej^t^nc^_^£jj]£ir_state  ;  and
280  the  existence  of  their  state  we  can  know  to  be  necessary
only  from  its  connection,  in  accordance^vvith  empirical
laws  of  causality,  with  other  states  given  in  perception.
From  this  it  follows  that  the  criterion  of  necessity  lies v
entirely  in  the  law  of  possible  experience,  the  law  that
whatever  happens  is  determined  a  priori  in  the  object  I
...
something  that  happens  and  begins  to  be.      Necessity I2 28
...
Ik  w  Si  i:m 'i  N  i  \i.    ANALYTIC.  i  ->7

aid  not  only  of  perceptions,  but  even  of  external percepA
turns*      Take,   tor    instance,   the    pure    conceptions  of
...
corresponds  to  the  conception  of  causality  is  cliange.
...
128  THE    PHILOSOPHY    OF    KANT.

successive  states  in  which  we  ourselves  exist.  The  truel
explanation  of  this  is  that  no  change  can  possibly  be  ani
...
I  K  \N  5<    I   M'l   N  I    M       AN  \l .",   II'.  I  29

principles  oi  pure  understanding  arc  nothing  but  apn
principles  of  the   possibility  of  experience;  and  all  a

priori  synthetic    propositions    relate   only  to  expend
...
29Ö  experience.  The  principles  of  pure  understanding,
whether  as_rnathematical  they  are  a  priori  constitutive
...
2qj      Now  the  proposition   that   understanding   can    never  2^8
...
TB  w  >  i  \m  NTAL   ANA!  VTIC  I  |  I

the  principles  of  pure  understanding  can  apply  only  t<>
...
an  object  of  experience,  it  Jias  taught  us  that  under-
stajiding  cannot  possibly^  transcend  the  limits  of  sensi-
bility, beyond  which  no  objects  _ai  e  presented  to  us.  The
...
noumenon,  that  is,  of  a  thing  that  cannot  be  an  object  of  j
sense,  but  is  thought,  by  pure  understanding  alone,  as  a
thing  in  itself,  is  certainly  not  self-contradictory  j  for  we
...
We  have  indeed  an  understanding   that  problematically j
...
cannot  be  employed  assertorically  beyond  the  world  ofj
...
as  it  does  to  define  the  limits  of  sensibility.  In  thati
sense,  however,  a  noumenon  is  not  a  special  kind  of'
object  for  our  understanding,  namely,  an  intdligible\
object  \  on  the  contrary  it  is  problematic  whether  there  is
any  understanding  that  could  have  such  an  object  actually  f
312  before  it.  Such  an  understanding  would  not  know  itsc
...
its  fallacy  has  been  clearly  detected  j  as  is  the  case,
...
I  |  .  M  \ TAI     DIA]  i  «   i  IC.  i     ,

3   i      Transcendental    Dialectic  must  therefore  l  Bed

with  bringing  to  light  the  illusion  in  transcendent  judg-
ments, and  guarding  us  against  its  deceptive  influent

but  it  can  never  put  an  end  to  the  illusion  and  cause  298
it  to  disappear,  as  in  the  case  of  logical  illusion.  For,1
...
at  all.  Every  general  proposition,  which  can  stand  in_a
syllogism  as  its  major  premise,  is  in  this,  .sense  called__a
...
359  If,  _then,  understanding  is  the  faculty  of  reducing^?
phenomena  to  the  unity  of  rules,  reason  is  the  faculty  of
bringing  the_rules^  of  understanding  jander  principles.
...
From  the  formal  and  logical  procedure  of  reason  im
...
does  with  its  categories,  but  dealsjvvith  conceptions  and
...
I  R  \\  S(  i DNDI  N  i  \J.    Dl  U  .1  CTIC

The  proposition  thai  whatever  happens  has  a  cause,  is  nol
;i  principle  known  and  prescribed  by  reason,     ii  m
...
and  the  syllogism  is  itself  simply  a_Judgirient  in  which
...
subordination  to  one  another,  and  therefore  the  uncon-  30S
...
377  Section  II. — Transcendental  Ideas.  321
...
rRANSCBNDENTAL  DIALECTIC.  I  J  i

categoi  ies,  will  arise  a  special  class  ol  a  priori  i  oik  eptions,
which  may  be  called  pure  conceptions  <>i  reason  or  (ran-

mUntal  ideas,  and  which  will  determine  how  under
standing  is  tu  be  emplo)  ed  within  the  realm  of  experieni  e
as  a  whole  in  conformity  with  principl  i

379  A  transcendental  conception  ol  reason  is,  therefore,  322
...
There  are  as  many  pure  conceptions  of  reason  asi323
...
of  the  hypotJietical  synthesis  of  the  members  of  a  series  ;
...
make  the  transition  possible  from  the  sphere  of  nature  tol
...
393  It  is  readily  seen,  that  the  sole  aim  of  pure  reason  is
...
397  perience.    But  it  is  better,  because  less  misleading,  to  say,  33g
...
TB  w    '  i  \  DENTAL  DIALECT]  I  ;

conditions  of  the  possibilit)  of  things  in  general  ;  in  othei
words,  I  reason  from  things  that  I  cannot  know  through
the  mere  transcendental  conception  of  them  to  a  Urin
...
preferred,  the  judgment,  "  /  think."  It  is  easy  to  see,
...
the  I  in  concreto  as  a  particular  object  of  experience.
...
empirical  doctrine  of  the  soul.  We  have  before  us,  thenJ
...
I  i:  \\    CBNDBN1  \i.    DIAL»   i  IC.  I  |;

knowledge,  but  only  as  the  knowledge  ol  what  any
...
which  is  predicated  of  the  I  as  a  thing  in  itself.  The
...
nothing  whatever.
406  Now,  as  the  proposition,  "  /  think"  taken  problem-  34$
...
TRANS«  i  M'i  n  I  \i.    DIALECT]  149

simply  to  be  const  ions  oj  m\  [CJf  as  thinkinur,  but  I  um  t
be  conscious  of  the  perception  of  mysell  as  determined
relatively  to  the  junction  ol  thought     Now,  none  of  the

407  modi  of  self-consciousness  in  thinking  arc  by  themselves
...
regarded  as  apredicate  pertaining  to  thought,  is  not  only
a  necessary  but  even  an  idetitical  proposition.  But  this
...
150  THE    PHILOSOPHY    OF    KANT.

mean  that  the  thinking  I  is  a  simple  substance,  which
would  be  a  synthetic  proposition.  The  conception  of,
substance  is  always  relative  to
