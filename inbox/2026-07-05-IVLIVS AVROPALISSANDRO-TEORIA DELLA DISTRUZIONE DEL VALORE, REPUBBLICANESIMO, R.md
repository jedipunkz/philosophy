---
source: "https://archive.org/details/TeoriaDellaDistruzioneDelValoreRepubblicanesimoRepublicanism"
title: "TEORIA DELLA DISTRUZIONE DEL VALORE, REPUBBLICANESIMO, REPUBLICANISM, NEO-REPUBLICANISM, NEO-REPUBBLICANESIMO, KARL MARX, MASSIMO MORIGI"
author: "IVLIVS AVROPALISSANDRO"
year: ""
captured_at: "2026-07-05T04:22:12Z"
updated_at: "2026-07-05T04:22:12Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ルカーチ・ジェルジュ"
query: "Lukács reification"
plain_text_url: "https://archive.org/download/TeoriaDellaDistruzioneDelValoreRepubblicanesimoRepublicanism/TeoriaDellaDistruzioneDelValoreRepubblicanesimoRepublicanismNeo-republicanismNeo-repubblicanesimoKarlMarxMassimoMorigi_djvu.txt"
public_domain: true
subjects:
tags:
  - "現代哲学"
...
# TEORIA DELLA DISTRUZIONE DEL VALORE, REPUBBLICANESIMO, REPUBLICANISM, NEO-REPUBLICANISM, NEO-REPUBBLICANESIMO, KARL MARX, MASSIMO MORIGI

- 著者: IVLIVS AVROPALISSANDRO
- 情報源: [archive](https://archive.org/details/TeoriaDellaDistruzioneDelValoreRepubblicanesimoRepublicanism)
- パブリックドメイン: ✓
...
Massimo  Morigi,  Teorìa  della  Distruzione  del  Valore,  p.l  di  3
...
tradizione  della  crìtica  marxiana  e  marxista  all'economia  politica  classica  e  neoclassica  e
...
contrarìamente  alla  teorìa  del  plusvalore,  che  il  modo  di  produzione  capitalistico  non  si
caratterìzza  per  una  sottrazione  del  plusvalore  generato  dal  pluslavoro  erogato  dal  lavoratore
...
non  produce  da  un  lato  possessorì  di  denaro  o  di  merci  e  dall'altro  semplici  possessori  della
proprìa  forza  lavorativa.  Tale  rapporto  non  rìsulta  dalla  storìa  naturale  né  da  quella  sociale  ed
...
opera  una  distruzione  reale  e  concreta  del  valore  del  lavoro  rìchiesto  al  dipendente  operaio
...
sociali  precedenti  o  non  rìconducibili  al  prìmo  capitalismo  industrìale  e  successive  sue
...
entrambi,  del  lavoratore  salarìato  e  dell'agente  capitalista,  in  realtà  in  un  rapporto  totalmente

Massimo  Morigi,  Teorìa  della  Distruzione  del  Valore,  p.2  di  3
...
strategici'  0  'omega-strategie  decisors').  In  questo  modo,  la  'Teoria  della  Distruzione  del
...
strategici'  0  'alpha-strategie  decisors'),  che  agiscono  (o,  meglio,  decidono)  costantemente  per
...
comune  pohticità.  Nella  presente  situazione  postdemocratica  che  accomuna  tutte  le
...
azione  dei  'decisori  omega-strategici-la voratori  di  bassa  fascia/non  capitalisti').  Per  tornare
...
lavoratori  di  bassa  fascia/non  capitalisti'  afferenti  all'  impresa  capitalista,  formalmente  Uberi
nello  scambiare  con  i  'decisori  alfa  strategici-imprenditori  capitaUsti'  la  loro  forza  lavoro  ma
...
Krìege  di  Cari  von  Clausewitz...  e  viene  facile  notare  la  profonda  analogia  e  legame  fra  la
...
Massimo  Morigi,  Teorìa  della  Distruzione  del  Valore,  p.3  di  3
...
dei  olimpici,  e  alle  forme  sempre  più  evolute  di  intelligenza  artifìciale  e  alla  possibilità  di
manipolazioni  della  pubblica  opinione  e  della  natura  fisica  e  biologica,  "un  lavoro  che,  lungi
dallo  sfìiittare  la  natura,  è  in  grado  di  sgravarla  dalle  creature  che  dormono  latenti  nel  suo
grembo"-,  rendono  persino  la  guerra  totale  di  settanta  anni  fa,  compresa  la  stessa  arma
atomica,  un  gioco  da  ragazzi  e  dove  il  capitaUsmo  del  XXI  secolo  non  solo  ha  eUminato,
almeno  in  tempi  commensurabiU  con  l'umana  esistenza,  ogni  realistica  possibilità  di  poter
...
valore  del  lavoro  sul!' apparentemente  libero  mercato  e  dei  diritti  dello  stesso  a  livello
...
in  altre  epoche  storiche  possono  essere  state  prevalenti  modalità  predatorìe,  e.g.  la  schiavitù
...
dall'epoca  storica  e  predazìone  o  distruzione  del  valore  che  sia,  la  condizione  vitale  ed
esistenziale  -  "dove  anche  i  morti  non  saranno  al  sicuro  dal  nemico,  se  egli  vince.  E  questo
nemico  non  ha  smesso  di  vincere."-  descritta  daìViperdecisionista  Walter  Benjamin  -
