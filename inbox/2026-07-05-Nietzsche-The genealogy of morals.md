---
source: "https://archive.org/details/genealogyofmoral00niet"
title: "The genealogy of morals"
author: "Nietzsche, Friedrich Wilhelm, 1844-1900"
year: "1918"
captured_at: "2026-07-05T14:13:08Z"
updated_at: "2026-07-05T14:13:08Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ニーチェ"
query: "Nietzsche genealogy of morals"
plain_text_url: "https://archive.org/download/genealogyofmoral00niet/genealogyofmoral00niet_djvu.txt"
public_domain: true
...
- 初版: 1918
- 情報源: [archive](https://archive.org/details/genealogyofmoral00niet)
- パブリックドメイン: ✓
...
eaajiaaiiaiuaiBia'af
■—f  waaiaiaianrajji
icaiiaiEaraiaifliiir*.
■■-<:  ibuseu;^-  ei
...
f  Nietzsche  published  The  Genealogy  of  Morals.  This  work
...
a  Book  jot  Free  Minds,  the  writing  of  which  was  begun  in
...
Human j  all-too-Human,  part  i.,  about  the  parallel  early
...
more  original  kind  of  morality  which  is  toto  ccelo  different
...
all-too-Human,  part  ii.,  and  Aph.  112,  the  Dawn  of  Day,
...
blue  for  a  genealogy  of  morals: — fof  instance,  grey,  by
...
"altruistic,"  and  " disinter esse"  are  concepts  of  equal
value.
...
contrary  is  the  case.  This  uti^'ty  has  rather  been  experi-
...
Theognis,  the  Megarian  poet.  The  word  ecOAog,  which
...
%a%bc,  as  in  oedog  (the  plebeian  in  contrast  to  the
dya-frog)  the  cowardice  is  emphasised.  This  affords  per-
haps an  inkling  on  what  lines  the  etymological  origin  of
the  very  ambiguous  ayaftbt;  is  to  be  investigated.  In
the  Latin  malus  (which  I  place  side  by  side  with  \n£,Xaq)
the  vulgar  man  can  be  distinguished  as  the  dark-coloured,
and  above  all  as  the  black-haired  ("tec  niger  est"),  as
...
badges  of  class  distinction;  here  agairuVre  di  slops  a
"good"  and  a  "bad,"  in  a  sense  which"'-  -  .1  to  be

merely  social.     Moreover,  care  should  be*  not  to

take  these  ideas  of  "clean"  and  "unclean"  i  riously,
too  broadly,  or  too  symbolically:  all  the  idea  ancient
...
jHumaTv*  itself  *s  still  diseased  from  the  effects  of  the
r  iiestly  cure.    Take,  for  instance,  certain

kinv  .abstention  from  flesh),  fasts,  sexual  con-

tinen  into  the  wilderness  (a  kind  of  Weir-Mitchell

isolatic  ough  of  course  without  that  system  of  ex-
...
forms  of  the  superiority  which  up  to  the  present  mac  has
exhibited  over  every  other  animal.

7-

The  reader  will  have  already  surmised  with  what  «sase
...
accomplished  against  those  classes  by  the  Jews—\hz
...
Jews  that  the  revolt  0}  the  slaves  begins  in  the  sphere  of
...
"GOOD  AND  EVIL,"  "GOOD  AND  BAD"       r*

that  hate,  as  its  crown,  as  its  triumphant  crown,  circling
wider  and  wider  amid  the  clarity  and  fulness  of  the  suny
...
tiiat  degree  of  falsity  which  will  always  characterise  the
...
words  wnich  are  applied  to  the  vulgar  man  survive  finally
as  expressions  for  "unhappy,"  "worthy  of  pity"  (corn-
Dare  bsiMc;,  oEitaciog,  Jtovnoo?,  uoxfrnQog;  the  latter  two
...
gists remember  the  sense  in  which  ofcvQoq,  avoX6o£,
tXtijjxov,  5vgti>xeIv,  |vpiqpoQa  used  to  be  employed.  The
...
counted  as  happiness  (that  is  the  etymology  of  efi
jtodrreiv)—  all  in  sharp  contrast  to  the  "happiness"  of
...
with  himself  (yevvaTog,  "noble-born,"  emphasises  the
...
"GOOD  AND  EVIjw    "GOOD  AND  BAD"      21
...
and  glory  the  Qocdupiia  of  the  Athenians,  their  non-
...
the  hope  in  man,  yea,  the  will  to  be  man.  The  light  of
...
being  a  iamb."  Thereby  do  they  win  for  themselves  the
...
lamb,  "videbunt  poenas  damnatorum,  ut  beatitudo  Mis
...
Me  nationibus  insperatus,  ille  derisus,  cum  tanta  sceculi
...
qui  in  cozlum  recepti  nuntiabantur,   cum  ipso  Jove  et
ipsis  suis  testibus  in  imis  tenebris  congemescentes !    Item
prcesides"  (the  provisional  governors)  upersecutores  dom-
inici  nominis  scevioribus  quam  ipsi  flammis  scevierunt  in-
sult antibus  contra  Christianos  liquescentes!  Quos  prceterea
...
Rhadamanti  nee   ad   Minois,   sed   ad   inopinati   Ckristi
tribunal    palpitantes!      Tunc    magis    tragoedi    audiendi,
...
sozvierunt.    Hie  est  illes,  dicam  jabri  aut  quoestuarice  filius"
...
dcemonium  habens.    Hie  est  quern  a  Juda  redemistis,  hie
...
loederentur.    Ut  talia  species,  ut  talibus  exultes,  quis  tib'i
...
nee  in  cor  hominis  ascenderuntV  (I  Cor.  ii.  9.)  "Credo
...
tive  of  the  most,  in  opposition  to  the  will  to  lowliness,
...
rible and  enchanting  counter-war-cry  of  the  prerogative  oj
...
N0TE— I  avail  myself  of  the  opportunity  offered  by  this
...
ness  is  no  mere  vis  inertias,  as  the  superficial  believe,
...
"morality  of  custom"  *  (cp.  Dawn  of  Day,  Aphs.  o,  14^
...
competent  to  promise,  this  lord  of  the  free  will,  this  sov-
...
wherever  solemnity,  seriousness,  mystery,  and  gloom^
...
are  really  at  bottom  systems  of  cruelty) — all  these  things
...
cut  off,  "si  plus  minusve  secuerunt,  ne  jraude  esto."  Let
...
tortures,  or  perhaps  an  auto-da-fe,  or  similarly  to  conceive
of  an  aristocratic  household,  without  a  creature  to  serve
as  a  butt  for  the  cruel  and  malicious  baiting  of  the  in-
...
Deople  of  about  equal  power  to  come  to  terms  with  each
...
so  forth.     (E.  Duhring,  Value  of  Life;  Course  of  Philoso-
...
fhe  just  and  judging  eye  (whose  glance  is  as  profound  as
...
and  also  freer  outlook,  the  better  conscience.  On  the  other
...
ends,  are  toto  ccelo  opposed  to  each  other — everything,
...
has  been  denned  (by  Herbert  Spencer)  as  an  increasingly
...
sary to  emDhasise,  absolutely  defies  definition.      (It  is
...
sought  the  proper  instrumentum  of  -that  psychic  reaction
...
turned  out  contrary  to  all  expectation"  (Eth.  hi.,  Propos.
...
make  it  fully  appreciated,  arid  it  requires  continuous  med-
...
"GUILT"  AND  "BAD  CONSCIENCE"  81

fractory,  and  suffering  material,  in  burning  in  a  wn%  a
...
the  case  of  iEgistheus,  a  very  bad  case  indeed —
...
aret"  so  thinks  he  of  the  misdeeds  of  mortals — and  "folly,"
...
marise the  awful  truth)  just  this  great  healthl
...
open  alone  to  Zarathustra,  Zarathustra  the  godless.
...
any  rate  that  he  eventually  wished  to  change  Ms  teach-
...
Christianity,  mediaevalism,  and  to  say  to  his  disciples,
...
in  major  em  musicce  gloriam — that  is  to  say,  by  means  of
the  sovereignty  of  music,  as  Schopenhauer  understood  it;
music  abstracted  from  and  opposed  to  all  the  other  arts,
music  as  the  independent  art-in-itself,  not  like  the  other
...
But  that  which  Heracieitus  shunned  is  still  just  what  we
...
"high  falutin'  "  ring.  Finally,  as  far  as  the  chastity  oi
...
Reason,  which  even  Luther  chose  to  call  Frau  Kluglin*
...
may  say,  "je  combats  VuniverseUe  araignee";  "Hybris"  is
...
phase  belongs,  for  instance,  the  jus  primce  noctis,  to-day
...
another  kind,  an  existence  on  another  plane, — he  is,  hi
...
away  from  myself?  And,  verily — /  am  sick  oj  myself/"
...
sight  of  the  victorious  hated.  And  what  lying  so  as  not
...
the  priest  is  the  diverter  of  the  course  of  resentment.
...
ing of  "heaier"  and  "saviour." — H.  B.  S.
...
formula  for  what  is  generally  called  a  il religion").  Such
...
is  for  certain  animals,  for  what  cestivation  is  for  many
tropical  plants,  a  minimum  of  assimilation  and  metab-
olism in  which  life  just  manages  to  subsist  without  really
...
cof  implicit  gratitude  that  rings  in  the  very  will  for  an
I  explanation  of  such  a  character.     The  supreme  state,  sal-
...
i44  THE  GENEALOGY  OF  MORALS

lability  to  pain,  which  presupposes  somewhat  rare  powers,
...
the  little  joy  experienced  in  mutual  benefits,
