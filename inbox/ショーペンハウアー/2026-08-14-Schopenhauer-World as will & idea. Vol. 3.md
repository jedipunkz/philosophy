---
source: "https://archive.org/details/worldaswillandi02schogoog"
title: "World as will & idea. Vol. 3"
author: "Schopenhauer, Arthur, 1788-1860"
year: "1906"
captured_at: "2026-08-14T13:51:59Z"
updated_at: "2026-08-14T13:51:59Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ショーペンハウアー"
query: "Arthur Schopenhauer"
plain_text_url: "https://archive.org/download/worldaswillandi02schogoog/worldaswillandi02schogoog_djvu.txt"
public_domain: true
...
# World as will & idea. Vol. 3

- 著者: Schopenhauer, Arthur, 1788-1860
- 初版: 1906
- 情報源: [archive](https://archive.org/details/worldaswillandi02schogoog)
- パブリックドメイン: ✓
...
BALLANTVNK,    HANSON   AND  CO.
EDINbUKUH   ANU   LUNLtON

CONTENTS.

SUPPLEMENTS  TO   THE   SECOND  BOOK.

NCXI.  Rbtrospeot  and  Mors  Gbniral  View     .        .        .  i

^KXIT.  Objbotivr  Virw  op  the  Intellbot    ....  5
tCXIIT.  On  the  Objectifioation  op  the   Will   in   Unoon-

8C10UR  Nature 32

XXIV.  On  Matter 48

^^XXV.  Transcendent  Considerations  Concerning  the  Will

as  Thing  in  Itself 65

XXVI.  On  Teleology 77

■^  XXVII.  On  Instinct  and  Mechanical  Tendenct  ...  96

^^XVIII.  Characterisation  op  the  Will  to  Live  .  105
...
On  the  Esthetics  op  Architecture
Isolated  Remarks  on  the  /Esthetics  op

tic  and  Pictorial  Arts
On  the  .^Esthetics  op  Poetry  .

On  History

On  the  Metaphysics  op  Mvair  .
...
^   ^KLI.  On  Death  and  its  Relation  to  the  Indestbucti-

BILITY   OF  OUR  TuUE  NATURE  ....  249

^x  XLII.  Thk  Life  of  the  Species 309

kLlII.  On  Heredity 318

XLIV.  The  Metaphtsich  of  the  Love  of  the  Sexes  .        .  336

^>KLV.  On  the  Assertion  of  the  Will  to  Live  .        .        .  376

V  ^LVI.  On  the  Vanity  and  Suffering  of  Life    .        .        .  382

XLVII.  On  Ethics 402

^CLVIII.  On  the  Doctrine  of  the   Denial  of  the  Will  to

Live 420

'^LIX.  The  Way  of  Salv.\tion 460

L.  Epiphilosophy 468

APPENDIX.

Analysis  of  •*  The  Fouufold  Root  of  the  Pri.nciple  of  Suf-
ficient Reason." 477
...
RE1*R0SPECT  AND   MORE  GENERAL  VIEW.

If  the  intellect  were  not  of  a  subordinate  nature,  as  tlie
...
that  which  operates,  acts,  performs  without  tlie  assistance
of  the  intellect  Now,  that  this  is  really  identical  with
what  we  find  in  ourselves  as  toill  is  the  general  theme  of
this  second  book,  and  also  of  the  essay,"  Ueber  den  Willen
in  der  Nature  The  possibility  of  this  fundamental  know-
...
direct  antipode  among  pliilosophers  is  Anaxagoras  ;  for  he
assumed  arbitrarily  as  that  which  is  first  and  original,
from  w^hich  everything  proceeds,  a  i/ou?,  an  intelligence,
...
me  it  is  the  unconscious  mill  wliich  constitutes  the  reality
...
not  know  how  to  begin  much  with  his  vov<;,  but  merely
set  it  up,  and  then  left  it  standing  like  a  painted  saint  at
the  entrance,  without  making  use  of  it  in  liis  develop-
...
iis  metaphysical  nature,  its  immateriality,  and  immortality
...
thus  shares  the  fate  of  this, — that  the  vrUl,  on  the  contrary,
...
of  it,  but  its  Privs  ;  and  the  phenomenon  depends  upon  it,
not  it  upon  the  phenomenon.  But  the  body  is  reduced  in-
deed to  a  mere  idea,  for  it  is  only  the  manner  in  which  the
fviU  exhibits  itself  in  the  perception  of  the  intellect  or  brain.
The  ivill,  again,  which  in  all  other  systems,  different  as
...
body,  but  the  luill  is  by  no  means  so.  From  this  hetero-
...
the  causal-nexus,  is  only  possible  in  the  idea,  for  all  those
determinations  rest  upon  its  forms,  thus  in  a  brain,  in
which  accordingly  such  an  existeuce  appears  as  something
...
both  of  which  primarily  and  directly  belong  to  the  unlL
But  the  combination  of  these  two  dilBferent  kinds  of  know-
...
are  not  therefore  entirely  non-existent  apart  from  it,  buc
must  also  ultimately  in  themselves  be  that  which  makes
itself  known  in  self -consciousness  as  ivUl,
...
There  are  two  fundamentally  diflferent  ways  of  regarding
the  intellect,  which  depend  upon  the  diflference  of  the
point  of  view,  and,  much  as  they  are  opposed  toieach  other
in  consequence  of  this,  must  yet  be  brought  into  agree-
ment. One  is  the  subjective,  which,  starting  from  loithin
...
^  Thif  chapter  is  connected  with  the  lait  half  of  §  27  of  the  first  volume.

6  SECOND  BOOK.    CHAPTER  XXIL
...
the  discussions  to  be  found  under  the  heading,  "  P/tan-
zenphysiologie**  in  the  essay,  "  Ueher  den  Willen  in  der
Natur"  and  also  a  portion  of  those  under  the  heading
"  Verglcichende  Anatomie"  are  devoted  to  it,  the  following
...
OBJECTIVE  VIEW  OP  THE  INTELLECT,  7
...
which  merely  dwelt  in  the  brain.  We  say  boldly :  tliis
...
idea,  the  brain  also,  like  everything  else,  is  loUL  For
...
and  the  yolk  of  an  egg,  as  well  as  its  shell  On  the  other
...
of  being  known,  i,e.y  of  exhibiting  itself  in  an  intellect,
...
and  concept.  It  would  Usclf  already  be  all  in  all,  and
...
like,"  which  was  a  veiy  indefinite  and  ambiguous  proposi-
...
beautifully  and  happily:  **//  ny  a  que  Vcsprit  qui  serUe
Vesprit :  c'cst  une  corde  qui  ne  fr&init  qxCdj  V unison"  which
corresponds  with  Xenophon's  "  a-o(f>ov  eivai  Set  rov  einrfvto^
aofuvov  TOP  ao(f>op  "  (sapientem  esse  opportct  cuvi,  qui  sapien-
tern  a^iitums  sit),  and  is  a  great  sorrow.  But  now,  again,
fi-om  the  other  side  we  know  that  multiplicity  of  similars
...
OBJECTIVE  VIEW  OF  THE  INTELLECT.  g

dififerent  from  itself.  But  we  also  saw  knowledge  in
general  conditioned  by  multiplicity  and  difiference.  Thus
...
ledge (J.  J.  Schmidt,  "  On  the  Maha- Jana  and  Pratschn  a
Paramita").  Acknowledge  of  things  in  themselves,"  in
...
will,  that  is,  without  being  either  painful  or  agi-eeable,  and
...
sensation  of  the  senses  to  its  caiLse ;  and  since  the  brain
...
itself  and  is  original,  is  exclusively  the  vnll;  for  it  is  the

OBJECTIVE  VIEW  OF  THE  INTELLECT.  ii
...
ceptions, and  ccternce  vcritates  for  its  objects,  and  leaves
...
unity  of  apperception  {cf.  vol.  il  p.  475).  Only  by  means
...
he  nding  the  external  world  in  a  purely  objective  manner.
...
lation of  that  of  which  it  is  a  state.  This  knotving  and
...
ference which  the  presence  and  the  diflferent  degree  of
...
(t.g.,  the  will  which  objectifies  itself  in  it)  produces  nothing,
least  of  all  the  hardest  of  its  productions — a  more  perfect
brain :  in  consequence  of  its  lex  parsirrionice :  natura  nihil
agitfrustra  et  nihil  facit  supervacaneum.  It  has  provided
every  animal  with  the  organs  which  are  necessary  for  its
sustenance  and  the  weapons  necessary  for  its  conflict,  as
I  have  shown  at  length  in  my  work,  "  Ucber  den  Willen  in
der  Natur"  under  the  heading,  "  VergleicJiende  AnatomieJ*
...
tlie  more  difficult  and  the  more  dependent  upon  opportunity
...
of  knowing  and  vrilling  take  place.  This  is  an  important
...
needs,  thus  in  the  service  of  the  ^dll.  What  this  aims  at
...
wants  which  liad  now  become  so  manifold.  Therefore  she
...
themselves  to  be  packed  in  a  cart  and  carried  ofi*;  but
...
OBJECTIVE  VIEW  OP  THE  INTELLECT.  17
...
lowest  species  of  animals  is  related  to  the  quad  conscious-
...
for  this  other,  consequently  quite  indirect.  Through  tlie
...
external  world,  it  is  to  another  a  camera  obsctira  in  which
the  macrocosm  exhibits  itself  :

"  He  feels  tlint  he  holds  a  little  world
...
OBJECTIVE  VIEW  OP  THE  INTELLECT.  19
...
standing, are  hei*e  sufficient;  and  whatever  goes  beyond
...
OBJECTIVE  VIEW  OP  THE  INTELLECT.  21
...
because,  through  the  gi'eat  inequality  of  the  relation,  the
...
countenance  and  vacancy  of  tlie  glance.  Another  symptom
...
peculiar,  absolutely  real  nature  of  these  things.  Eather,
...
consciousness,  reveals  itself  to  this  as  itdll,  attains  to  this
...
plain tliis  mere  brain  phenomenon,  with  the  conformity
...
us  in  making.  From  this  mundus  phcpn<mienon,  however,
...
alone  it  is  the  subject.  The  thouglit  from  which  the  Critique
of  Pure  Eeason  has  sprung  really  lies  already  at  the
foundation  of  this  expression.  That  we  cannot  compre-
hend the  world  on  the  direct  path,  ie.,  through  the  un-
...
the  nature  of  which  exhibits  itself  as  mil  to  the  self-con-
...
hended by  it ;  as  the  eye  cannot  see  itself.  It  is  ratlier
...
naturali&m  proper  consists.  If,  therefore,  nature  presents
...
its  name  appears  to  be  derived  from  Ttiater  rcrum,  and
along  with  it,  as  the  father  of  things, /orm,  which,  just  as
...
OBJECTIVE  VIEW  OF  THE  INTELLECT,  27
...
twnal  truth,  which  Kant  has  appropriately  indicated  as
such  by  calling  it  the  phenovunon  in  opposition  to  the
thing  in  itself.
...
doctrine  the  Critique  of  Beason.  He  accomplished
...
lie  attrilDuted  absolutely  only  a  practical  validity,  and
...
OBJECTIVE  VIEW  OP  THE  INTELLECT.  29

started  Therefore  also,  in  the  ease  of  the  important  fun-
...
separates  itself  more  distinctly  from  ivill,  and  thereby
becomes  purer.  What  is  essential  upon  this  point  will  be
found  in  my  work,  "  Ueber  den  Willen  in  der  Natur,'*  under
the  heading,  "  P/lanzenphysiologie'*  (p.  68-72  of  the  second,
...
does  the  motive  separate  ever  more  distinctly  in  consdous-
ncss  from  the  act  of  vnll  wliich  it  calls  forth,  thus  the  idea
from  the  ivill;  and  thereby  the  objectivity  of  consciousness
...
and  then  in  self-consciousness.  Upon  tlie  degree  of  this
separation  ultimately  depends  the  difference  and  the
gradation  of  intellectual  capacity,  both  between  dififerent
...
by  the  fact  that  in  tliis  case  the  will  entirely  vanishes
from  consciousness.  Here  is  the  point  at  which  tlie  pre-
...
pure,  i,e,,  perfectly  will-less,  and  on  that  account  com-
...
iTig  of  tlie  intellect  from  tJte  toill,  which  appears  complete,
...
recognised  and  confessed  it;  for  Jul.  C8os.Vaninus  (that  well-
known  sacrifice  to  fanaticism  and  priestly  fury),  who  was
thoroughly  versed  in  their  philosophy,  says  in  his  "  Amphi-
tJuatro"  p.  i8i  :  "  Voluntas poterUia  ccRca  est,  ex  scholastico-
...
and  that  in  general,  as  the  true  and  only  avrofAaTov,  in  the
...
THB  WILL  IN  UNCONSCIOUS  NATURE.  33

brought  about  by  further  reflection.  But  it  would  be  the
grossest  misunderstanding  to  suppose  that  this  is  a  mere
...
we  denote  by  the  words  farce  of  nature,  to  that  which  is
...
exists  as  that  ^ofM,  which  is  what  is  most  intimately
...
As  my  essay,  **  Ueber  den  Wilten  in  der  Natur,*'  spe-
...
their  indwelling  desires  {erruBvfiia)  \  nay,  that  they  also
...
the  "  Timanis,"  p.  403,  Bip.)  Aristotle,  on  the  other  hand,
...
promptly  in  as  deputy,"  namely,  to  OpeimKov,  the  faculty
of  nourishing.  Plants  have  this,  and  thus  a  part  of  the
so-called  soul,  according  to  his  favourite  division  into
anima  vegetativa,  sensitiva^  and  inteUectiva.  This,  however,
is  just  a  scholastic  Quidditas,  and  signifies  plantoR  ntUrir
untur  quia  habent  factUtatem  ntUritivam.  It  is  therefore
...
work, "  Ueber  die  Erscheinungen  und  Oesdze  de$  organischen
Zebens,"  1832,  Bd.  2,  Abth.  i,  §  49,  has  said  what  follows  :
"A  form  of  life  is,  however,  conceivable  in  which  the
eflfect  of  the  external  upon  the  internal  produces  merely
...
as  of  the  corUradictio  in  adjecto  which  lies  in  the  concep-
...
In  fact,  in  the  life  of  plants  the  truth  that  will  can
exist  without  knowledge  is  apparent — one  might  say
palpably  recognisable.  For  here  we  see  a  decided  efifort,
...
this  is  less  apparent.    If,  therefore,  we  find  the  recogui-

36  SECOND  BOOK.    CHAPTER  XXIIL
...
of  no  transgressions;  so  that  ncutura  nan  fadJt  scUttts
...
a  fundamental  and  essential  difference.  In  the  «<nor$fa-
...
•  body  the  case  is  exactly  reversed;  for  its  life,  t.«.,  its
existence  as  an  organised  being,  simply  consists  in  the
constant  change  of  the  m^Uerial,  while  the  form  remains
permanent  Its  being  and  its  identity  thus  lies  in  the
form  alone.     Therefore  the  continuance  of  the  unorga-

■  nised  body  depends  upon  rqpose  and  exclusion  from  external
...
just  depends  upon  continual  m/y&emmt  and  the  constant
...
organism,  is  entirely  inadmissibla  The  predicate  life
belongs  only  to  what  is  organised.    Every  oiganism^  how-
...
poaed  by  aggregation  of  what  is  unorganised.  Thus  if
...
qualities,  which  cannot  be  further  explained, — tlus  is  an
essential  point  in  my  doctrine;  although  the  trace  of
Buch  a  thought  is  far  aeldomer  found  in  ¥rriters  who  have
...
ment is  not  enclosed  in  a  skir^  as  is  always  the  case
with  the  latter,  and  consequently  it  has  neither  vessels  in
whioh  that  movement  could  go  on,  nor  does  anything
...
Goethe's  *'  WaMtferv^andtschaften,"  as  the  title  indeed  indi-
cates, although  he  himself  was  unconscious  of  this.

Meohanics  and  astronomy  specially  show  us  how  this
will  conducts  itself  so  far  as  it  appears  at  the  lowest
grade  of  its  manifeatation  merely  as  gravity,  rigidity,  and

38  SECOND  BOOK.    CHAPTER  XXI 1 1.
...
noted by  "elective  aflBnity  "  (an  expression  which  is  entirely
borrowed  from  the  conscious  will).  But  Anatomy  and
Physiology  allow  us  to  see  how  the  wiU  conducts  itself
...
he  brings  before  us  in  the  Drama,  the  Epic,  the  Komance,
...
vuU  esse  canservatrix  sui.  But  all  manifestations  of  this
...
shunning  as  the  receiving  of  motion ;  and  the  movablenesd
...
one  may  regard  elastic  bodies  as  the  more  courageotcs,  which
...
case  of  every  physical  phenomenon,  of  every  charige  of
...
cause  was  capable  of  acting.  And  first  of  all  the  rjoUl  is
...
active  hera  Tliis  is  certainly  the  universal  force  of  nature,
which,  however,  in  itself  identical  with  the  wiU^  becomes

THE  WILL  IN  UNCONSCIOUS  NATURE.  41

here,  as  it  were,  the  soul  of  a  very  brief  qtuisi  life.  Thus
...
the  actually  completed  case,  for  besides  vis  inertice  it
...
of  ncUure,  winch  manifest  themselves  in  that  rotation,  and,
...
to  explain  every  natural  phenomenon  m^Aani(^%;  doubt-
...
hensibility  and  cleamesa  However,  in  the  "  Metaphysi-
...
combination  or  the  dfiference  of  the  three  states  of  aggre-
gation will  ever  admit  of  mechanical  explanation,  much
less  the  properties  of  light,  of  heat,  and  electricity.  These
will  always  admit  only  of  a  dynamical  explanation,  t.e.,
...
weighty  &c.,  and  are  therefore  of  a  higher  kind,  i,e.,  are
...
which  is  to  be  found  in  the  April  number  of  the  **  AnnaUa
de  chimie  et  fhysique^'  of  1 83 5,  may  be  considered  ajs  a
...
nation  £is  the  French  can  hold  so  firmly  to  a  completely
...
state  of  the  metaphysics  they  shun  so  much,  ^hich  is
...
earlier  influence  of  Gondillac    Therefore  for  them  the
thing  in  itself  is  really  matter,  frem  the  fundamental
...
forces.    In  Grermany  Kant's  teaching  has  prevented  the
...
but  also  two  special  doctrines  of  modem  physics,  appa-
...
as  Utile  as  I  am  obliged  to  think  that  the  slow  but  con-
...
my  well  that  the  stone  tiiat  has  been  thrown  flies  more
...
mass  of  a  body  as  consisting  of  atoms  and  the  spacer  be-
tween them,  ie.,  of  absolute  density  and  absolute  vacuity ;
but  I  comprehend  those  two  phenomena  without  difficulty
as  constant  amtiniui,  one  of  which  uniformly  fills  time
...
tain more  matter :  in  both  cases  the  di£ference  depends
...
difiference  of  specific  gravity  can  only  have  its  ground  in
porosity,  even  this  assumption  would  always  lead,  not
to  atoms,  but  only  to  a  perfectly  dense  matter,  unequally
distributed  among  diflferent  bodies ;  a  matter  which  would
certainly  be  no  longer  compressihle,  when  no  pores  ran
...
extending  the  akeady  existing  intervals  is  a  purely  arbi«
trary  assertion.
...
Imagine  two  bodies  of  very  dififerent  kinds,  entirely
freed  from  aU  pores  by  compression,  as  by  means  of
...
vestigated it  only  from  the  subjective  side,  t.e.,  so  far  as
it  is  an  idea,  and  not  from  the  objective  side,  i^.,  with
...
become  preceptible,  i.^.,  present  itself  as  a  body  and  an
...
content  of  the  conception  of  stibstance,  is  causality  itself,
...
only  a  conception,  no  percq>tion.    It  enters  into  all  external
...
thyaght  a  priori,  is  distinguished  from  the  a  priori  intui'
...
think  away,  t.e.,  imagine  it  as  vanished  and  annihilated,
...
belong  so  entirely  and  in  every  regard  to  the  fomud  part
...
ing, does  that  mil  reveal  itself  which  we  have  already
...
jective forms  of  our  intellect,  t.«.,  they  only  become  visible
...
whereby  the  vnll,  which  constitutes  the  inner  nature  of
...
existences,  t.«.,  phenomena  is  the  will.  Therefore  every
object  is,  as  thing  in  itself,  will,  and  as  phenomenon,
matter.  If  we  could  strip  any  given  matter  of  all  the
properties  that  come  to  it  a  priori,  ie,,  of  all  the  forms  of
...
active  ;  i,e,,  we  would  no  longer  have  matter  before  us,  but
the  wilL  This  very  thing  in  itself,  or  the  will,  in  that  it
becomes  a  phenomenon,  ie.,  enters  the  forms  of  our  intel-
lect, appears  as  matter,  t.e.,  as  the  invisible  but  necessarily
assumed  supporter  of  the  properties  which  are  only  visible
through  it.  In  this  sense,  then,  matter  is  the  visibility  of
the  ioiU^     Consequently  Plotinus  and  Giordano  Bruno
...
quently upon  the  form  of  our  understjuiding.  On  the  other
...
in  general;  and  causality  depends  upon  the  a  priori  form
of  our  understanding,  and  therefore  cannot  be  thought
away.

Matter  is  accordingly  the  vrill  itself,  but  no  longer  in
...
abstractly,  ie.,  regarded  apart  from  all  form.  Matter  is
...
ie.,  for  the  idea,  is  matter  is  in  itself  wUl.  Therefore,
...
general,  ie.,  as  absolute  will,  but  always  as  particular,  t.e.,
...
the  wUl  itself.     But  the  will   cannot  be  apprehended
...
Because,  then,  matter  is  the  visibility  of  the  wiU,  and
...
is  called  substance  (Stofi).  Force  and  substance  are  in-
...
poral m^yin  of  forms,  shapes,  or  species  cannot  reasonably
...
itself,  i.e.y  presents  itself  objectively  to  the  intellect,  matter,
as  its  visibility,  assumes  fomi  by  means  of  the  functions
of  the  intellect.  Hence  the  Schoolmen  said:  "Materia
appeiit  formam."  That  such  was  the  origin  of  all  forms  of
...
generatio  cBguivoca  still  takes  place,  can  only  be  decided
by  experience ;  especially  since  the  saying,  Natura  nihil
fadt  fmstra,  might,  with  reference  to  the  paths  of  regular
...
in  accordance  with  them,  pedicuius  capitis  or  p^iMs  or
...
was  foreign  to  that^oc^.  Thus  August  St.Hilaire  saw  in
...
the  AeacUmie  des  sciences  that  upon  the  growing  coral
...
for  a  favourable  opportimity,  is  more  paradoxical  than
that  of  generatio  cequivoca.  Putrefaction  is  the  decom-
position of  an  organised  body,  first  into  its  Tnore  imr-
...
is  resolved  into  its  vltirndte  constituent  parts,  which  are
...
a^quivoca,  with  its  premature  shouts  of  victory,  was  the
...
For  our  own  inner  nature  is  the  will,  whose  mere  visihility
...
things,  imder  all  differences  of  quality  and  form.  On
...
ly,  and  have  also  shown  that  physics  can  never  be  set
...
only  something  apprehended,  something  known,  remains
...
sel/'canscumsness  fulfils  this  condition,  that  which  is  within,
the  mbjective.  And  hence  it  is  so  eminent  a  merit  of
...
quence of  their  investigations  I  was  led  to  recognise  and
...
considered  turns  out  indeed  to  be  a  irptoTov  ^ei/So?.  It
...
measure  of  the  quantity  of  the  matter.    This  path  neces-
...
hood than  in  its  first.  Kot  merely  solid  bodies  are  sup-
...
Crcdat  Judceus  Apella  !  Certainly  the  nature  of  light  is
...
series  of  which  was  recently  laid  before  the  AcacUmie
...
fall  into  time  again  ?  (Comptes  rendm  of  20th  December
...
is  soon  a  case  of  Spartam,  quam  Tuictus  es,  oma  !  Different
...
the  first  place,  are  unjable  to  think  any  other  reality  than
...
it  had  taken  the  actual  and  empirically  given  matter  (t.6.,
...
itself,  thus  the  true  mater  rertmi,  from  the  obscurity  of
whose  womb  all  phenomena  and  forms  come  forth,  to  fall
back  into  it  some  time  again ;  from  this,  tie.,  from  matter
...
would  then  consist  in  this,  that  the  QuassUa  had  been
...
DcUa.  But  what  is  accomplished  with  this  will  no  longer
...
tion of  which  lies  eodemal  perception,  so  distinct  and  com-
...
TRANSCENDENT  CONSmERATIONS  CONCERNING  •  THE  WILL
...
most  part  fluctuating,  limits.  Seflection,  following  this
...
hf  tcai,  irav  early  appeared  both  in  the  east  and  in  the  west,
...
any  phenomenon  a  knonring  consciousness  is  added  to  that
inner  being  which  lies  at  the  foundation  of  all  phenomena,
a  consciousness  which  when  directed  inwardly  becomes
self-cansciotLsness,  then  that  inner  being  presents  itself  to
...
80  mysterious,  and  is  denoted  by  the  word  vrilL  Accord-
...
by  motives,  for  these  difierences  refer  only  to  the  grade  of
...
mined the  one  succeeding  it,  and  so  on  per  secula  sectdorum,
...
table and  inexorable  Avarytcrf.  Now,  what  is  objectionable,
...
in  itself  toill,  and  indeed  absolutely  free  will,  for  necessity
only  arises  through  the  forms  which  belong  entirely  to
the  phenomenon,  Uirough  the  principle  of  sufficient  reason
...
directly  the  action  but  primarily  the  existence  and  ncUure
...
with  rigid  consistency,  and  the  most  perfect /rceiom,  rising
...
and  doing  {Operari),  and  the  whole  freedom  in  the  being  and
nature  (Fsse).    Thereby  a  riddle  is  solved  which  is  as  old
...
sity, but  it  exists  and  is  what  it  is  by  virtue  of  its  freedom.
...
ing as  one  takes  offence  that  imU  is  attributed  to  pro-
...
thing  in  itself,  ie.,  the  true  nature  of  the  world,  so  also
does  mtUtiplicity.  This  is  sufficiently  explained  in  §  25  of
...
labour  as  if  each  work  of  nature  had  been  its  onlj  one,
...
working  force,  the  natura  ncUurans,  in  each  of  its  in-
numerable works,  in  the  least  as  in  the  greatest,  in  the
last  as  in  the  first,  is  immediately  present  whole  arid  un^
...
handy  if  favoured  by  chance  or  directed  by  human  pur-
...
in  itself,  «.«.,  to  the  inner  primary  force  which  shows  itself
...
The  uniiy  of  that  vnll,  here  referred  to,  which  lies  beyond
...
«.e.,  does  not  depend  upon  the  functions  of  our  intellect,
...
present  velocity  and  no  other,  becaiise  if  it  went  faster  it
...
snblate  themselves  again,  like  dissonances  in  music  which
...
also  in  m^netic  or  magic  influences ;  for  these  all  lead
...
at  a  tangent  £ut  immortality,  by  virtue  of  the  eternal
...
tegral part  of  eveiy  radius;  while  the  peripherical  end
...
**JIaud  distrSmtum  animarUibus,  et  quasi  distrihUum  tamen
iiundens,  anwuintium^  in^mUuntium  id  cogruyscendum,
edax  et  rursvs  genitcUe"  (Lect.  13,  16  vers.  Schlegel).  Cer-
...
cially those  which  swim,  such  as  Veretillum^  Funicvlina,
...
ferent from  every  other  on  account  of  the  infiuxus  physums
...
that  as  in  the  geTieratio  oeguivoca  there  sometimes  and
...
special  clearness  and  fulness  in  "The  WiU  in  Nature,"
...
^  Thu  oh^iter  and  the  following  one  are  oonneoted  with  §  28  of  the  first
▼dame.
...
regular  and  confonning  to  law,  such,  for  example,  as  every
...
I  about  the  form  which  is  organised  and  furnished  with
...
I  is  bound  to  the  conceptions  of  end  and  means.    If  direct
...
I  of  a  bottle  of  beer  which  had  just  been  opened,  and  ex-
l  pressed  his  wonder  not  that  it  should  come  out,  but  that
f  any  one  had  ever  been  able  to  get  it  in ;  for  we  also  assume
...
which  by  means  of  its  own  f orms,-8pace,  time,  and  causality,
...
has  been  set  forth,  teleology,  as  the  assumption  of  the  ii
adaptation  of  every  part  to  its  end,  is  a  perfectly  safe  1
guide  in  considering  the  whole  of  organised  nature ;  on  1
...
organism  is  simply  and  solely  its  own  wUl ;  for  then  the
...
be  designed;  and  therefore  final  causes  (cavsx finales)  atb
the  clue  to  the  understanding  of  organised  nature,  as  effici-
ent causes  {caiosoe  efficientes)  are  the  clue  to  the  understand-
...
firmat  regulam  applies,  since  they  can  be  accounted  for  j
...
the  Mus  typhltis,  a  rat,  has  eyes,  although  very  small  ones,
without  any  opening  for  them  in  the  outer  skin,  which
thus  covers  them,  clothed  with  hair ;  and  that  the  moles  of
the  Apennines,  and  also  two  fishes — Murena  ccecilia  and
Gastrobratickus  ccecus — are  in  the  same  case ;  of  like  kind
...
{Mu^  tyj^hhis)  as  superfluous;  but  here  also  it  must  at
...
all  vertebrates,  which  has  been  so  fuUy  explained,  espe-
cially by  Richard  Owen  in  his  "  OsUologu  compart,"  and
...
given  material  for  its  works,  and  just  that  which  Geofifroy
St.  Ililaire  has  explained  as  the  "anatomical  element"
It  is  the  unitd  de  playi,  the  fundamental  type  of  the  higher
animal  world,  as  it  were  the  arbitrarily  chosen  key  upon
which  nature  here  plays.

j      Aristotle  has  already  correctly  defined  the  difierence

!  between  the  efllicient  cause  {causa  cfficiens)  and  the  final

•  cause  (causa  Jinalis)  in  these  words:  ^^ Avo  rpoirot  rry:

ai/TUL^y  TO  ov  €V€Ka  Kai  TO  €^  avaytcrjf;,  xai  Bei  T^ovra^

Tirf)(av€iv  fiaXiaTa  fiev  afi<l>oiv"     (Duo  smit  causa}  modi  :

alter  cujus  gratia,  ct  alter  e  necessitate;   ac  potissimuvi

utnimque  eiiure  oportct)     De  part,  anim.,  i.  i.      The  effi-

j  cient  cause  is  that  whcrehy  something  is,  the  final  cause
...
is  always  the  true  and  proper  cavse  of  the  action,  is
...
the  act  of  will  and  the  corporeal  movement,  the  vnll
...
ception. This  union  of  the  catisa  finalis  with  the  efficient  '(^
...
a  will  is  the  forming  power.  In  fact,  we  cannot  otlierwise
distinctly  think  a  final  cause  except  as  an  end  in  view,  t.c.,
...
final  cause  is  a  motive  which  acts  upon  a  being,  by  whicli
it  is  not  known.  For  certainly  the  termite  nests  are  the  mo-
tive which  has  produced  the  toothless  muzzle  of  the  aut-
...
provided  in  order  to  break  through  that  sbell,  after  which
it  throws  it  off  as  of  no  further  use.  And  in  the  same  way
the  laws  of  the  reflection  and  refraction  of  light  are  tlie
...
it  may  sound.  For  here  is  the  transition  of  the  physiccd
...
of  organised  nature  we  are  entirely  referred  to  final  caiLscs,
everywhere  seek  for  these  and  explain  everything  from
them.  The  efficient  caicses,  on  the  contrary,  here  assume
...
out.  In  explaining  the  physiological/wnc^ioTW  we  certainly
...
general  principle  as  that  the  larger  the  part  is  to  ba  the
...
we  knew  the  final  cause,  that  the  hlood  must  go  into
...
cause ;  although  ultimately  he  only  says  that  nature  does      1
not  in  the  case  of  every  production  begin  from  the  begin-     ;
ning  and  create  out  of  nothing,  but  as  it  were,  writing  on
in  the  same  style,  adds  on  to  what  already  exists,  makes   j
use  of  the  earlier  forms,  developed  andjraised  to  higher  /
power,  to  carry  its  work  further  :(just  as  iFhas  done  iiiv^
the  ascending  series  of  animals  entirely  in  accordance  with
the  law :  Natura  nonfacit  salttis,  ct  quod  commodissimum  in
omnibus  suis  operationibvs  sequitur  (Arist.  de  iticcssu  anir
malium,  c.  2  et  8).     Indeed,  to  explain  the  blossom  by
pointing  out  in  all  its  parts  the  form  of  the  leaf  seems  to
me  almost  the  same  as  explaining  the  structure  of  a  a
house  by  showing  that  all  its  parts,  storeys,  balconies,  and  \\
garrets,  are  only  composed  of  bricks  and  mere  repetitions  U
...
Trill  not  be  absolutely  diflferent  and  entirely  disparate
...
a  force  of  nature,  i.e.,  a  qualitas  occulta,  and,  therefore,  it
can  only  give  a  relative  explanation  ;  while  the  final  cause
within  its  sphere  afibrds  a  sufficient  and  perfect  explana-
tion. It  is  true  we  are  only  perfectly  content  when
we*  know  both  the  efiicient  cause,  also  called  by  Aristotle
17  aiTia  €^  avay/cTj(;,  and  the  final  cause,  17  x^ptv  tov  fieX-
TLovo^,  at  once  and  yet  separately,  as  their  concurrence,
...
perception  that  both  causes,  however  diflferent  may  be
...
of  butterflies  of  different  zones  and  latitudes.     It  has  been  j
...
worse  than  before,  and  now  generally  results  in  death :  I
similarly  that  consumptive  men  generally  beget  another  \
child  in  the  last  days  of  their  life.     The  Jinal  cause  here  I
is  that  nature,  always  so  anxiously  concerned   for  the   \
maintenance  of   the  species,  seeks  to  replace  by  a  new    1
individual  the   approaching  loss   of    one   in  the   prime    I
of  life;    the   effid&rU  cause,  on  the   other  hand,  is   the    \
...
non that  (according   to  Oken,  Die  Zeugurujf,  p.  65)  flies
...
nature  gave  man  the  beard  (which  shows  that  ?io7no  homini
lupus).  The  woman,  on  the  other  hand,  could  dispense
with  tliis ;  for  with  her  dissimulation  and  command  of
...
always  ambiguous,  and,  especially  when  the  effici^fit  cause
...
posed of  largo  masses  of  rock,  all  of  which  only  produce
...
For  the  rest,  if  any  one  desires  to  misuse  the  external  I
...
i.&,  the  end  lies  in  one  individual  and  the  means  in  anotJur.
...
of  the  Lampyris  noctiluca  (the  glowworm)   the  circum-

90  SECOND  BOOK,    CHAPTER  XXVL
...
Lam2)}jris  Italica  both  sexes  shine,  which  is  an  instance  of
...
to  _suckj  When,  on  the  contrary,  the  individual  that
affords  essential  help  to  another  belongs  to  an  entirely
difiTerent  species,  and  even  to  another  kingdom  of  nature,
we  will  doubt  this  external  design  just  as  in  unorganised
nature ;  imless  it  is  evident  that  the  maintenance  of  the
...
kinds  of  iris,  and  Ainstolochia  Clcmatitis  cannot  fructify
themselves  at  all  without  the  help  of  insects  {Chr.  Cour,
Sprengel,  Etitdccktes  Gehcimniss,  &c.,  1793  ;  Wildenow,
Grnuidriss  dcr  Krdutcrkunde,  353).  Very  many  dicecia,
monoecia,  and  polygamia  are  in  the  same  position.  The
reciprocal  support  which  the  plant  and  the  insect  worlds
receive  from  each  other  will  be  found  admirably  described
in  Burdach's  large  Physiology,  vol.  L  §  263.  He  very
beautifully  adds:  "This  is  no  mechanical  assistance,  no
make-shifc,  as  if   nature  had  made  the   plants  yester-
...
also,"  &c.  A  proof  of  this  consensus  Tiaturce  is  also
...
ment for  their  larvse,  are  hatched  exactly  at  the  time  at
...
not do  this,  in  the  state  of  pupae.
...
1am,  and  Spinoza.  But  in  the  case  of  all  three  we  know
...
in  his  Lettre  a  M,  Nicaise  (Spinozce  op,  ed  Pauhts,  vol.  ii.  p.
672)  :  "  Les  causes  finales,  ou  ce  qui  est  la  vtStne  chose,  la  con-
sideration dc  la  sagesse dimne dans  Vordre des choses*'  (The
devil  also  mSme  chose !)  At  the  same  point  of  view  we
find,  indeed.  Englishmen  even  at  the  present  day.  The
Bridgewater-Treatise-men  —  Lord  Brougham,  &c.  —  nay,
even  Eichard  Owen  also,  in  his  '*Ost4qlogie  Compar4e"
thinks  precisely  as  Leibnitz,  which  I  have  already  found

2  SECOND  BOOK.    CHAPTER  XXVI.
...
'  Let  me  here  remark  in  pasBiog  his   "Dialogues  on    Natural  Reli-

that,  judging  from  the  German  lite-  gion."     There  one  sees  him  in  his
...
wisdom  ha<l  consisted  in  his  obvi-  are  the  writings  on  account  of  which

ously  false  scepticism  with  regard  to  — I  know  of  nothing  that  says  more

the  law  of  causality,  for  this  alone  for  his  fame — even  to  the  present

is  everywhere  referred  to.    In  order  day,  he  is  everywhere  hated  by  the

t«>  know  Hume  one  must  read  his  English  clergy.
...
we  are  speakiDg,  since  they  lived  long  before  the  dawn  of
...
Bacon  {Be  augm,  sclent,^  iii.  4),  he  makes,  in  the  first
...
he  explains,  Natura  nihil  frustra  agere :  hoc  est,  guod  in
tcsum  hominum  nonsit:  similarly,  Omnia  naturalia  tanquam
ad  mum  utile  media  considerant,  et  credunt  aliqiiem  alium
esse,  qui  ilia  Toedia  paraverit ;  and  also :  Hivxi  statuerunt,
Deos  omnia  in  usum  hominum  fecisse  et  dirigere.  Upon
this,  then,  he  bases  his  assertion:  Naturamfinem  nullum
siii  prceftxum  habere  et  omnes  causae  finales  nihil,  nisi  hu-  H
mana  esse  f^menta.  His  aim  merely  was  to  block  the  \
...
me  to  give  the  correct  exposition  of  its  material,  whereby  I

I

y

94  SECOND  BOOK.    CHAPTER  XX VL

I  have  satisfied  the  maxim :  JSst  enim  verum  index  sui  et
...
any  accurate  knowledge  of  organised  nature.  Tliis  limited
...
physico-theology — such  a  thing  has  never  entered  his
...
train  of  thought.  He  always  says  :  "  17  (f>vai<;  ttoici  (ncUura
facit),  never  17  <f>vaif;  ireiroirfrai, "  {natura  facta  est).  But  after
he  has  truly  and  diligently  studied  nature,  he  finds  that  it
everywhere  proceeds  teleologically,  and  he  says :  "  fiarrfv
6p(0fJL€v  ovSev  iroiovaav  rrjv  ^vaiv  "  (naturani  nifiU  frustra
facere  cernimus).  Be  respir,,  c.  10 ;  and  in  the  books,  Be  par-
tibus  anwudium,  which  are  a  comparative  anatomy :  "  Ov&e
irepcef/yov  ovBep,  ovre  /ulttjv  17  ^vat^  iroicL — *H.  <f>vai^  evexa
Tov  iroiei  iravTO, — Havraypv  Se  7\£yofi€V  roBe  rovBe  hfexa,
oirov  av  <f>ai,vr)Tai  t€Xo9  ti,  irpo^  o  17  Kiprjai^  irepcuvei, '  oxrre
eipac  <f>av€pov,  on  can  ti  Toiotnov,  6  Srf  xai  xaXovfiev  <f>vaiv.
Eirei  TO  atofia  opyavov  evetca  rivo^  yap  CKaoTov  rtov  fiopuDv,
ofioia)<:  T€  Kai  to  oXov."  (Nihil  6upe7^aca}ieum,  nViil  frustra
naturafacit. — Naturarei  alicujus  gratia  facit  omnia, — Rem
autem  lianc  esse  Ulitts  gratia  asserere  vMque  solemus,  quoties
fnem  intdligimus  aliqucm,  in  quern  motus  terminetur  ;  quo-
circa  fjusmodi  aliquid  esse  constat,  qtwd  NcUuram  vocamus.
JSst  enim  corpus  instrumentum :  nam  membrum  unumquod-

ON  TELEOLOGY.  95

que  rei  alicujvs  gratia  est,  turn  vero  totum  ipsum,)     At
greater  length,  p.  633  and  645  of  the  Berlin  quarto  edition,
and  also  De  inccssu  animalium,  c.  2  :  "  'H  <f>u<n^  ovBev  iroiei
/laTrjv,  aX\'  aec,  €k  twv  evie)(Ofi€vtov  Tp  ovauiy  Trepi  ixaarov
y€vo<:  fcooi;  to  apiarop"     (Natura  nihil  frustra  facit,  sed
semper  ex  iis,  quce  cuiqiie  animalium  generis  essentice  con-
tinguntf  id  quod  optimum  est)     But  he  expressly  recom-
...
physico- theology  or  upon  the  an thropo-teleology  condemned
...
Aristotle's  second  book,  De  codo  (c.  i,  p.  284),  had  already
...
active  is  evidently  and  confessedly  the  wiUt  so  is  it  also
really  the  will  which  is  active  in  the  working  of  organ-
ising nature.

One  might  say,  the  will  of  animal  creatures  is  set  in
motion  in  two  diflferent  ways :  either  by  motivation  or  by
...
lurismtis"  (voL  ii.  p.  250)  a  case  is  mentioned  "  in  which
...
the  dsemon  of  Socrates,  on  account  of  which  he  had  the
...
goes  with  companions  to  a  powder  magazine ;  when  ho

loo  SECOND  BOOK.    CHAPTER  XXVI L
...
ON  IXSTISCT  ASD  XTECHANICAL  TESDESCY.     loi
...
itself  exist  for  this  end — and  so  with  every  other  jmrt — the
...
end,  just  like  the  parts  of  the  organism.  The  diftbreuce  is
...
choice  is  only  left  in  the  accidents  of  detail,  wliere  it  gives
assistance  and  adopts  what  has  to  be  carried  out  to  tlie
...
Introdiic.  to  JSntomoL  ;  Huber,  Des  abeilles).  Such  things
...
IC2  SECOND  BOOK.    CHAPTER  XXVI L
...
which  this  leaves.  Thus  wo  see  ants  carry  off  their  larvae
...
test  tlie  burying-beetle  {Necrophorus  vespillo),  had  tied  a
...
expected,  sink  into  tlie  ground;  after  much  perplexed
...
not  only  lieals  wounds,  replacing  even  bone  and  nerve
substance,  but,  if  througli  the  injury  of  a  vein  or  nerve
...
bambylitts)  lays  eggs,  the  working  humble-bees  are  seized
with  a  desire  to  devour  them,  which  lasts  from  six  to  eiglit
...
more  to  confirm  the  conviction  that  the  wiU  is  the  basis
...
I04  SECOND  BOOK.    CHAPTER  XXVI L
...
tion of  tlie  structure  of  every  animal  to  its  manner  of  life,
...
of  animals,  wo  might  bring  under  the  conception  of  a
knowledge  a  prioin,  if  knowledge  lay  at  their  foundation  at
...
from  the  far?n^  of  knowledge ;  therefore  with  reference  to
...
more  insidious  than  -^u^^  or  anima,  which  signify  breath.
...
io6  SECOND  BOOK.    CHAPTER  XXVIII.
...
Aristotle  was  right  in  saying :  "  17  ^vaiff  Saifiovia,  a\\*  ov
Beta  eoTt "  {Natura  dccvionia  est,  non  divijia),  Dc  divinaL,
...
the  people  by  the  word  le  sauverain ;  we  might  also  com-
...
quocsituniy  but  their  datum.     If  they  were  boys  I  would
then  explain  to  them  that  this  is  a  petitio  priiicipii,  but
...
the  reader  of  a  later  age  pardon  me  for  detaining  biiu
with  persons  of  whom  he  has  never  heard.

Every  glance  at  the  world,  to  explain  which  is  the  task
of  the  philosopher,  confirms  and  proves  that  mil  to  live,
...
organised  existence,  ie.,  life,  and  after  that  to  the  highest
...
wanting,  by  means  of  generatio  ceguivoca,  seizing  every
opportunity,  eagerly  grewping  for  itself  every  material
...
we  know,  nay,  the  kernel  of  reality  itselt
...
CHARACTERISATION  OF  THE  WILL  TO  LIVE.     icQ

not  sufiScient,  for  this.  Even  if  here  and  there  a  surplus
...
nature  was  only  concerned  that  of  all  her  (Platonic)  Td-eas,
ie.,  permanent  forms,  none  should  be  lost.  Accordingly,
...
the  individuals  are  fleeting  as  the  water  in  the  brook ;  tlie
...
!.«.,  in  the  sphere  of  the  idea,  and  were  therefore  obliged
to  confine  ourselves  to  this  province  in  solving  it.  But
the  case  is  otherwise,  and  a  glance  at  any  rate  is  afforded
us  into  the  interior  of  n/iture  ;  inasmuch  as  this  is  nothing
else  than  our  aiim  inner  heing,  which  is  precisely  where
...
tendency  of  all  animals  and  men  to  retain  lite  and  carry
it  ou  as  long  as  possible — a  tendency  which  was  set  forth
above  as  characteristic  of  the  subjective,  or  of  the  will — it
is  necessary  to  make  clear  to  ourselves  that  this  is  by  no
means  the  result  of  any  objective  knoiolcdge  of  the  worth
...
pJiorus  vespillo)  buries  a  mole  of  forty  times  its  own  size  in
two  days  in  order  to  deposit  its  eggs  in  it  and  insure  nour-
ishment for  the  future  brood  (Oleditsch,  Physik.  Bot.  (Ekon.
AhhaiidL,  iii.  220),  at  the  same  time  calling  to  mind  how
...
CHARACTERISATION  OF  THE  WILL  TO  LIVE,     in
...
life.    Take,  for  example,  the  mole,  tliat  unwearied  worker.
...
It  alone  is  truly  an  animal  Tioctumuni;  not  cats,  owls,
...
of  man,  is  given  by  Humboldt  in  his  "  Ansichtai  d^r
NaUir  "  (second  edition,  p.  30  et  seq.)  ;  nor  does  he  neglect
...
ing, constant  strife,  helium  omnium,  each  one  both  a  hunter
and  hunted,  pressure,  want,  need,  and  anxiety,  shrieking
and  howling ;  and  this  goes  on  in  secula  seculancm,  or  till
once  again  the  crust  of  tlie  planet  breaks.  Yuughahn
...
(Canis  iiUilans),  who  with  their  united  strength  lay  them
...
^  In  the  SUdc,  loth  April  1859,  vient  de  paroourir  plusieura  pro-
there  appears,  very  beautifully  writ-  vinces  de  Tile  de  Java  cite  un
ten,  the  Btory  of  a  Bquirrel  that  was  exemple  remarqueable  du  pouvoir
magically  drawn  by  a  serpent  into  facinateur  des  8er(>en8.  Levoyageur
its  very  jaws :  "  Un  voyageur  qui  dont  il  est  question  comment  ait  h
...
gravir  Junjind,  un  desmonts  appel(?8
par  lea  Hollandais  Pepei^^cbcrgtc
Apr^  avoir  p^n<$trd  dans  une  dpaisse
forot,  il  aper^ut  but  lea  branches
d'un  kijatile  an  ^ureuil  de  Java  h
tcte  blanche,  fol^rant  avec  la  grilce
et  TagUit^  qui  distinguent  oette
charmante  esp6ce  de  rongeurs.  Un
nid  sph^rique,  formd  de  brine  flexible
et  de  mousse,  plac^  dans  les  parties
lea  plus  ^ev^  de  Tarbre,  a  Tenfour-
chure  de  deux  branches,  et  une
cavity  dana  le  tronc,  aemblaient  lea
points  de  mire  de  aes  jeux.  A  peine
8*en  ^tait-il  ^oign^  qu'il  y  revenait
avec  une  ardeur  extreme.  On  ^tait
dana  le  mois  de  Juilletj  et  prubable-
ment  T^cureuil  avait  en  haut  aea
petita,  et  dana  le  baa  le  magaain  k
fruits.  Bientot  il  fut  comme  aaiai
d'effroi,  aea  mouvemena  devinrent
d^rdonn^  on  eut  dit  qu'il  cher-
chait  toujoura  k  mettre  un  obatacle
entre  lui  et  certainea  partiea  de
Tarbre :  puia  il  ae  tapit  et  rcsta  im-
mobile entre  deux  branches.  Le
voyageur  eut  le  sentiment  d'un
daiiger  pour  Tinnocente  bc^te,  mais  il
ne  pouvait  deviner  lequel.  II  ap-
procha,  et  un  examen  attentif  lu!
fit  d^oouvrir  dans  un  creux  du  trono
une  oouleuvre  lieu,  dardant  ses  yeux
fixes  dana  la  direction  de  I'^cureuil.
Notre  voyageur  trembla  pour  le
pauvre  ^cureuiL  La  couleuvre  ^tait
si  attentive  &  aa  proie  qu'elle  ne
aemblait  nullement  remarquer  la
prince  d'un  homme.  Notre  voya-
ger, ^ui  ^tait  arme,  aurait  done
prevemr  en  aide  k  I'infortun^  ron-
geur en  tuant  le  aerpent.  Maia  la
science  Temporta  sur  la  piti^  et  il
voulut  voir  quelle  iaaue  aurait  le
drame.  Le  denodment  fut  tragique.
L'^oazeail  ne  tarda  point  k  pouaaer
un  ori  plaintif  qui,  pour  tons  ceux
qui  le  oonnaiasent^  denote  le  voisi-

VOUIIL

nage  d'un  serpent.  II  avan^a  uii
pcu,  essaya  de  rcculer,  revint  encore
en  avant,  tilche  de  retoumer  en
arri6re.  Mais  a*approcha  toujoura
plus  du  reptile.  La  couleuvre,
roul^  en  spirale,  la  teto  au  dessUH
dca  anneaux,  et  immobile  comme  un
morceau  de  bois,  ne  le  quittait  pa?i
du  regard.  L'dcurouil,  de  branche
en  branche,  et  descendant  toujoura
plus  bas,  arriva  jusqu'ik  la  partie
nue  du  tronc.  Alora  le  pauvro
animal  ne  tenta  m6me  plus  de  fuir
le  danger.  Attird  par  une  puissance
invincible,  et  comme  pouusd  par  le
vertige,  il  se  prdcipita  dans  la  gueule
du  serpent,  qui  s'oumt  tout  li  coup
ddmesurdment  pour  le  rccevoir.
Autant  la  couleuvre  avait  6t4  inerte
juaque  Ut  autant  elle  devint  active
d^  qu'elle  fut  en  possession  de  sa
proie.  Ddroulant  ses  anneaux  et
prenant  sa  course  de  bas  en  haut
avec  une  agilitd  inconcevable,  sa
reptation  la  porta  en  un  din  d'lBil
au  sommct  de  I'arbre,  oh  ellc  alia
sans  doute  digdrer  et  dormir.'*

In  this  example  we  see  what
spirit  animates  nature,  for  it  reveals
itself  in  it,  and  how  very  true  in  th*^
saying  of  Aristotle  quoted  abovu
(p.  106).  This  story  is  not  only  iiii
portant  with  regard  to  faHcinatit)u,
but  also  as  an  argument  for  i)cssi  ■
mism.  That  an  animal  is  surpriKod
and  attacked  by  another  is  bad ;
still  we  can  console  ourselves  for
that ;  but  that  such  a  poor  inn<x;ent
...
adoualy  throw  itself  into  them  is
revolting  and  atrocioua.  What
monstrous  kind  of  nature  is  this  to
which  we  belong !

H

114  SECOND  BOOK.    CHAPTER  XXVI 1 1.
...
For  then  the  world  is  a  God,  ens  perfectisdmum^  i,e,,  nothing
...
waves    engulf   thousands.      AU  strive,  some    planning,
...
willing  ds  a  whoh  and  in  general.  It  depends  upon  this,
...
ii6  SECOND  BOOK.    CHAPTER  XXVI IT.
...
good  things  held  out  to  it,  the  attainment  of  which
would  be  a  sufficient  reward  for  its  ceaseless  cares  and
troubles.  The  matter  being  taken  thus,  every  one  would
rather  have  long  ago  said,  "Ze  jeu  ne  vaut  pas  la
chandcUe"  and  have  gone  out.  But,  on  the  contrary,  every
...
worth  of  tliat  pledge  without  seeing  it,  upon  trust  and
faith,  and  does  not  know  what  it  consists  in.  Hence  I
have  said  that  these  puppets  arc  not  pulled  from  with-
out, but  each  bears  in  itself  the  clockwork  from  which  its
movements  result  This  is  tJie  will  to  live,  manifesting  itself
...
vwbile  of  their  movements;  while  the  external  objects,
...
Tfudadies  mentaks,  1838.)  And  as  with  the  persistence
...
^  **AuguiUfU  de  eivU,  Dei,**  L.  xi  c.  27,  deserves  to  be  compared  as
an  interesting  commentary  on  what  is  said  here.

ii8  SECOND  BOOK.    CHAPTER  XXV III.
...
on,  to  use  an  expression  of  Aristotle's  {Be  ccelo,  ii.  13),
"  ov  <l>va€t,  aXXa  ^ta  "  (Motu,  non  naturali  sed  violento).
...
ledge of  life,  is  in  no  way  a  eonclusio  ex  pramiissis,  and  in
...
book  already  i)oint  forcibly  to  the  serious  theme  of  the
...
Supplements  to  tfie  ^fiicU  Boolt.

"  Stit  timilit  «pec(atort  at,  quad  ab  omm  uparatut  *ptctaculum  vidd."
— OnpBIKHiT,  Tol.  i.  p.  304.
...
relations  which  things  have  to  each  other  only  takes  pletce,

^  This  chapter  la  connected  with  §§  30-32  of  the  first  volume.
...
species;  consequently  it  now  has  for  its  object  the  IdcaSy
...
tence of  the  individuals,  the  species  renim,  which  really
...
of  Proclus  and  Olympiodorus,  vol.  ii.  p.  82):  "to  €iBo<:
fieraSeSaxe  fiev  rrj^  fiopffnj^  tq  vkrj'  afxepe^  Be  ov  fiereXafiev
cf  avTTjf:  Tov  Seaararov : "  i.e.,  the  Idea,  in  itself  unextended,
...
pass  over  into  each  other:  tSea,  €iBo<;,  species,  kind.  The
...
here  that  Aristotle  also  (Metaph.  i  9  and  xiiL  5)  says
that  the  Platonists  admitted  no  ideas  of  manufactured
articles :  **  6u>v  oixia,  kol  Sa/crt/Xu)?,  &v  ov  <f>aaip  eivai  €(£r) "
{Ut  donitis  et  annulus,  quoncm  ideas  dari  negant).  With
which  compare  the  Scholiast,  p.  562,  563  of  the  Berlin
quarto  edition.  Aristotle  further  says  {Metaph.  xL  3) :
"  aXK  enrep  (Supple.,  eiSrj  eari)  ctti  rtov  i^vaeL  {etm')  Bio
St)  ov  KaK(o^  6  nXarmv  €<fyq,  on  eiBrj  eari  oiroaa  <f>va€i "  (Si
quidcm  idem  sunt,  in  iis  sunt,  quae  nattcra  fiunt :  propter
quod  non  male  Plato  dixit,  quod  species  €<ynim  sunt,  quw
natura  sunt).    On  which  the   Scholiast  remarks,  p.  800 :

**  KaV   TOl/TO    ap€(TK€L     KUl    aVTOt?     T0t9    Ttt?    iScO^    ^eft€I/0t9'

rav  yap  viro  rexyrj^  yivop,€vo>v  iSea^  eivai  ovk  eXeyov,  aXKa
Tcov  vTTo  ^i;o-6a>9  "  {Hoc  ctiavi  ipsis  ideas  statuentibvs  placet  :
non  enim  artefactoncm  ideas  dari  ajebant,  sed  natura  pro^
crecUorum).  For  the  rest,  the  doctrine  of  Ideas  originated
with  the  Pythagoreans,  unless  we  distrust  the  assertion  of
Plutarch  in  the  book,  De  placitis  phUosophoruni,  L.  i  c.  3.
...
In  §  49  of  the  first  volume  I  have  sufiiciently  brought
...
reason,  yet  only  in  ahstracto,  as  a  concept,  universale,  which
...
quite  a  different /(?rm,  and  has  thereby  lost  its  perceptible
