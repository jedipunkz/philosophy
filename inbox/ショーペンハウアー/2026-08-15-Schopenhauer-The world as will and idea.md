---
source: "https://archive.org/details/worldaswillidea03scho"
title: "The world as will and idea"
author: "Schopenhauer, Arthur, 1788-1860"
year: "1907"
captured_at: "2026-08-15T07:17:49Z"
updated_at: "2026-08-15T07:17:49Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ショーペンハウアー"
query: "Die Welt als Wille und Vorstellung"
plain_text_url: "https://archive.org/download/worldaswillidea03scho/worldaswillidea03scho_djvu.txt"
public_domain: true
...
- 初版: 1907
- 情報源: [archive](https://archive.org/details/worldaswillidea03scho)
- パブリックドメイン: ✓
...
oe 1 —
a f = +
ae ak ae ; Sent amet - ee et om Ser ao Ss
- 7 nf 7 ee es et > 5 P = es - —— - ar ¥ - to - =
-_ ai "er oy ~v p 7 ae “ath - 7 a : . : i q Co ese 7 7 - = -
ewe @ fe ie Sa” : y - = — : . roo 7 7 -
= 7 : 7 : AS — 7 nN : - -% : c . 7 2 —
7 * : a 7 7 - = 7 Es ; ae
7 of : > pr oy 7 ae o ‘ ns © w ’ 7 ms s -
: - . - ‘ ' Pas : ar ‘ ia \ a, —-
: x - *) : 3
...
RETROSPECT AND Morr GENERAL VIEW

OBJECTIVE VIEW OF THE INTELLECT

ON THE OBJECTIFICATION OF THE WILL IN UNCON-
scious NATURE
...
ON THE AUSTHETICS OF ARCHITECTURE

TSOLATED REMARKS ON THE AUSTHETICS OF THE PLAS-
TIC AND PIcTORIAL ARTS

ON THE AUSTHETICS OF POETRY .

On HIsTory i ‘ ;

On THE MrtapHysics of Music .
...
On DEATH AND ITS RELATION TO THE INDESTRUCTI-
BILITY OF OUR TRUE NATURE : 3

THE LIFE OF THE SPECIES .

ON HEREDITY - ; ; ! ; .

Tur METAPHYSICS OF THE LOVE OF THE SEXES .
...
ANALYSIS OF “TH KouRFOLD Roor OF THE PRINCIPLE OF SUF-
...
Ir the ¢ntellect were not of a subordinate nature, as the
two preceding chapters show, then everything which takes
place without it, 4¢., without intervention of the idea, such
...
from which everything proceeds, a vous, an intelligence,
...
not know how to begin much with his vous, but merely
...
brought about by means of an <iniellect. Therefore 1t
...
thing taken as absolutely simple; for precisely from this
...
iollow from it. For although we can only conceive the
...
way, perhaps by gradually vanishing, TI, on the contrary,
...
thus shares the fate of this,—that the wild, on the contrary,
...
nomenon, consequently is not, ike the intellect, a Posterius
...
results, is with me the very first. The ¢ntellect, as mere
...
both of which primarily and directly belong to the wiil.
...
THERE are two tundamentally different ways of regarding
...
we owe to zootomists and physiologists, for the most
...
ven Gall may be named here, although his chief aim
...
the discussions to be found under the heading, “ Pflan-
venphysiologie, in the essay, “ Ueber den Willen in der
Natur,” and also a portion of those under the heading
“ Vergleachende Anatomie,” are devoted to it, the following
...
idea, the brain also, like everything else, is will. or
existing for another is being percewed; being in itself rs
...
the heart of the animal, as well as its hide; the white
_ and the yolk of an egg, as well as its shell. On the other
hand, upon the subjective path the inner is accessible to
us at every moment; for we find it as the will primarily
in ourselves, and must, by the clue of the analogy with
our own nature, be able to solve that of others, in that
we attain to the insight that a being in itself independent
of being known, «we. of exhibiting itself in an intellect,
is only conceivable as willing.

If now, in the oljectwve comprehension of the intellect,
...
take up into itself indirectly through knowledge, 2.¢., image
and concept. It would ¢ésedf already be all in all, and
therefore there would remain nothing for it to know, 1<.,
...
to intellect it passes beyond this limit by means of its
...
beautifully and happily: “Jl n'y a que Tesprit qui sente
Pesprit: cest une corde qui ne frémit qu’da lunison,” which
corresponds with Xenophon’s “ codov esvar dee Tov erruvyvw-
copevov Tov coor” (sapientem esse opportet ewm, qui sapien-
...
Pratschna Paramita, %.¢., that which is beyond all know-
...
_has attained its highest perfection and complexity does
the brain appear in its greatest development. But in the
preceding chapter we have recognised the organism as the
objectification of the will; therefore the brain also, asa
...
these conceptions, 2.¢., to thinking, as that in which his
...
idea, is the weld. Of course, in my explanation, the exist-
...
OBYECTIVE VIEW OF THE INTELLECT. 11

will which through this very process assumes the form of
_ the idea, we., enters the secondary existence of an objec-
...
_ Inner nature and peculiar function consisted in thinking,
...
ceptions, and wierne veritates for its objects, and leaves
...
a priori functions of the intellect they produce the wper-
...
unity of apperception (¢. vol. ii. p. 475). Only by means
...
OBFECTIVE VIEW OF THE INTELLECT. 13
...
the will. I admit that all that is said here is really anly
...
tenance arise. Thus accordingly the medwwm of motives
...
(a.¢., the will which objectities itself in it) produces nothing,
least of all the hardest of its productions—a more perfect
brain: in consequence of its lex parsumome: natura nihil
agit frustra et mhil facit supervacaneum. It has provided
...
OBFECTIVE VIEW OF THE INTELLECT. 15
...
eree that sometimes its relation to the will must momen-
...
of knowing and willing take place. This is an important
...
needs, thus in the service of the will. What this aims at
...
muscular power, combined with creat frailty and little en-
...
ing demands of the will: besides this, however, the two
...
ereater sorrows than the brute, but also of greater joy in
satisfied and pleasing emotions. In the same way his
higher intelligence makes him more sensible to ennwi than
the brute ; but it also becomes, if he is individually very

5 aye. “oe

OBFECTIVE VIEW OF THE INTELLECT. 17
...
lowest species of animals is related to the guast conscious-
...
erade of consciousness beings are as different as through
...
external world, it is to another a camera obscura in which
...
conditioned by a passionate temperament, and a phleematic
...
ous and passionate peoples; although, as Bacon! has most
...
1 De Augm. Scient., L. vi.c. 3.

OBFECTIVE VIEW OF THE INTELLECT. 19
...
ereat vehemence of character, and that therefore can hold
...
great, and through their very satisfaction, constantly in-
...
men, since as arule they have become so only by the force
...
Sommerring’s acute discovery, affords the true and closest
...
in motion by means of the motory nerves, so closely is
...
peculiar, absolutely real nature of these things. Rather,
...
meets Ais transcendental consideration of it; nay, appears
in a certain sense even as an @ priori insight into it; for,
...
OBFECTIVE VIEW OF THE INTELLECT. 23
...
comes into our apprehension by means of the sensation, in
...
torments and mocks him ”—because of all this, I say,
...
usin making. From this mundus phenomenon, however,
...
gous to expressing the stereometrical content of a body in
...
of things, and apprehends mere specves transitivas, not the
...
of Pure Reason has sprung really lies already at the
foundation of this expression. That we cannot compre-
hend the world on the direct path, ae, through the un-
...
the nature of which exhibits itself as will to the self-con-
...
alone it appeared. Jor the intellect is, as has been shown,
...
OBYECTIVE VIEW OF THE INTELLECT. 49

another), but when once it entirely loses hold, disappears,
as is shown by the paleotheria and the ichthyosaurians,
...
teonal truth, which Kant has appropriately indicated as
such by calling it the phenomenon in ee iii to the
thing un rtself.
...
thus a qguadam prodire tenus, which must always leave
...
and constiuct from its laws being in general, whereby it
...
apart from objective knowledge, «.¢., apart from the world
...
posterior’. But in this chapter, and also in my work,
...
world. Thus so far I have reached the same goal a prior.
...
OBY¥ECTIVE VIEW OF THE INTELLECT. 29
...
_ the supplement of that ideological, as the French say, or,
...
of plants, upon mere stimuli, but upon motives, «e., in
...
from the will; and thereby the objectwity of consciousness
...
eradation of intellectual capacity, both between different
_ kinds of animals and between individual human beings;
...
prehends things in some degree objectwely ; for he recog-
...
of which is genius, in which the comprehension of the
...
whole species, 2.¢., its Platonic Idea; which is brought about
...
really properly comes to know the world, 2.¢., comprehends
...
ON THE OBJECTIFICATION OF THE WILL IN UNCONSCIOUS
NATURE.

THAT the will which we find within us does not proceed, as
philosophy has hitherto assumed, first from knowledge, and
indeed is a mere modification of it, thus something secon-
dary, derived, and, like knowledge itself, conditioned by the
brain ; but that it is the praus of knowledge, the kernel of our
nature, and that original force itself which forms and sus-
tains the animal body, in that it carries out both its uncon-
scious and its conscious functions ;—this is the first step in
the fundamental knowledge of my metaphysics. Paradoxi-
cal as it even now seems to many that the will in itself is
without knowledge, yet the scholastics in some way already
recognised and confessed it; for Jul. Cees. Vaninus (that well-
known sacrifice to fanaticism and priestly fury), who was
thoroughly versed in their philosophy, says in his “ Ampha-
theatro,’ p. 181: “ Voluntas potentia caeca est, ex scholastico-
rum opynione.” That, further, it is that same will which in
...
and that in general, as the true and only avtoyator, in the
...
1 This chapter is connected with § 23 of the first volume,

THE WILL IN UNCONSCIOUS NATURE. 33

brought about by further reflection. But it would be the
erossest misunderstanding to suppose that this is a mere
question of a word to denote an unknown quantity. It
is rather the most real of all real knowledge which is here
expressed in lancuage. For it is the tracing back of that
which is quite inaccessible to our immediate knowledge,and
therefore in its essence foreign and unknown to us, which
we denote by the words force of nature, to that which is
...
various they may be, is in its nature identical; that yet
...
must call it wil. It is the insight that that which acts
and strives in nature, and exhibits itself in ever more
perfect phenomena, when it has worked itself up so far
that the light of knowledge falls directly upon it, 2,
...
other things. It is accordingly the thing in ttself so far
as this can ever be reached by knowledge. Consequently
it is that which must express itself in some way in every-
thing in the world, for it is the inner nature of the world
and the kernel of all phenomena. }

As my essay, “ Ueber den Willen in der Natur,’ spe-
...
which are therefore strung together in a somewhat frag-
...
often the case with Aristotle, are the opinions of earlier
...
their indwelling desires (emifupta) ; nay, that they also
...
the “Zimeus,” p. 403, Bip.) Aristotle, on the other hand,
...
promptly in as deputy,” namely, to Opemrexov, the faculty
of nourishing. Plants have this, and thus a part of the
so-called soul, according to his favourite division into
anvma vegetativa, sensitiva, and intellectwva. This, however,
is Just a scholastic Qucdditas, and signifies plante nutri-
untur quia habent facultatem nutritwam. It is therefore
...
which he specially explains in the books de Colo, intro-
duces the system of Ptolemy, whereby mankind was again

THE WILL IN UNCONSCIOUS NATURE. 35
...
with my teaching. It is G. R. Treviranus, who, in his
work, “ Ueber die Erscheinungen und Cesetze des organischen
Lebens,” 1832, Bd. 2, Abth. 1, § 49, has said what follows :
“A form of life is, however, conceivable in which the
effect of the external upon the internal produces merely
feelings of desire or dislike. Such is the life of plants.
...
as of the contradictio im adjecto which lies in the concep-
...
objective is, on the other hand, perception, and therefore a
product of the understanding, Yet this does not detract
at all from the truth and importance of what he says.

In fact, in the hfe of plants the truth that will can
exist without knowledge is apparent—-one might say
palpably recognisable. For here we see a decided effort,
determined by wants, modified in various ways, and
adapting itself to the difference of the circumstances,
...
nothing about it. As soon, on the other hand, as in
...
intentionally : he is ashamed of them.

Primarily, then, the vital force is identical with the
...
tion of a desire, ze, of a will, as the basis of plant life,
...
creater. In fact, the boundary between the organised
...
a fundamental and essential difference. In the wnorga-
...
body the case is exactly reversed; for its life, ae, its
existence as an organised being, simply consists in the
constant change of the materzal, while the form remains
...
organism that has been still remains fora while. There-
...
_ tendency towards an attempt at life, to which, however,
...
Goethe’s “ Wahlverwandischaften,” as the title indeed indi-
...
erade of its manifestation merely as gravity, rigidity, and

38 SECOND BOOK. CHAPTER XXIII.

inertia. Hydraulics shows us the same thing where
rigidity is wanting and the fluid material is now un-
...
water. These laws accurately inform us how water will
...
precipitation originates, and the whole of which is de-
...
it fora while. Finally, the poet shows us how the will
conducts itself under the influence of motives and reflec-
tion. He exhibits it therefore for the most part in the
...
THE WILL IN UNCONSCIOUS NATURE. 39

ereater is his fame; hence Shakespeare stands at the top.
...
appears from his writings, but is also known to me from
...
effort after sel/-preservation, which dwells in them also.
...
one may regard elastic bodies as the more courageous, which
seek to repel the enemy, or at least to prevent him from
pursuing further. Thus in the one secret which (besides
oravity) is left by mechanics otherwise so clear, in the
communicability of motion, we see a manifestation of the
...
called forth by causes. In § 26 of the first volume I have
fully explained the relation between cause, force of nature,
...
tion from the will as the thing in itself begin. In the
case of every physical phenomenon, of every change of
material things, its cause is primarily to be looked for; and
this cause is just such a particular change which has ap-
peared immediately before it. Then, however, the original
force of nature is to be sought by virtue of which this
cause was capable of acting. And first of all the will is
to be recognised as the inner nature of this force in oppo-
sition to its manifestation. Yet the will shows itself just as
...
account of its special form rolls back and foward for a long
...
which, however, in itself identical with the will, becomes

THE WILL IN UNCONSCIOUS NATURE. 41

here, as it were, the soul of a very brief guas¢ life. Thus
...
the actually completed case, for besides vis inertiw it
...
42 SECOND BOOK. CHAPTER XXIiI1I.
...
be eternal and omnipresent, @.¢., independent of time and
...
independent of the course of time, @¢, is outside of all
time; this is the force of nature which manifests itself in
it. One can even convince oneself to a certain extent
empirically and as a matter of fact of the tdeality of this
...
of nature, which manifest themselves in that rotation, and,
...
hand, contains much that can be known a prior, and
therefore depends upon the forms of our own intellect,
which as such carries with it the highest degree of compre-
...
will always admit only of a dynamical explanation, «e.,
...
weight, &c., and are therefore of a higher kind, 2¢., are
...
Ampére, who is otherwise so acute, upon light and heat,
which is to be found in the April number of the “ Annales
de chime et physique,’ of 1835, may be considered as a
...
THE WILL IN UNCONSCIOUS NATURE. 4S
...
thing in itself is really matter, from the fundamental
...
tween them, «¢., of absolute density and absolute vacuity ;
...
be quicker than another, «¢, in an equal time can pass
through more space, so also one body may have a greater
specific gravity than another, 7.2, in equal space may con-
...
ever, this is assumed, then we certainly have atoms, «e.,
absolutely indivisible bodies, thus bodies of such strong
...
eravity then be the same? This would be the criterion
of dynamics.
...
MatTrTsR has already been spoken of in the fourth chapter
of the supplements to the first book, when we were con-
sidering the part of our knowledge of which we are con-
sclous @ prior. But it could only be considered there
...
vestigated it only from the subjective side, ae, so far as
it is an idea, and not from the objective side, «¢., with
...
takes the place of causality in the table of our a priors
knowledge which is given there. For what is material is
that which ac¢s (the actual) in general, and regarded apart
...
jar and up to this point, belongs to the formal part of our
knowledge, and is consequently that form of the under-
standing, causality itself, bound up with space and time,
hence objectified, 2.¢., conceived as that which fills space.
...
function it so faris. Therefore of pure matter there is also
...
thought a priori, is distinguished from the a priori intut-
...
the matter which has once been placed in them, and accord-
ingly thought as existing, we can never again absolutely
think away, ie., imagine it as vanished and annihilated,
...
the enitrely empirical part of our knowledge of bodies,
...
_ jective forms of our intellect, a. they only become visible
...
bodies; and yet the matter itself is never perceived, bui
...
whereby the wil, which constitutes the inner nature of
...
existences, 4¢, phenomena is the will. Therefore every
object is, as thing in itself, will, and as phenomenon,
matter. If we could strip any given matter of all the
properties that come to it a priori, a.¢., of all the forms of
...
active ; 4.¢.,we would no longer have matter before us, but
the will. This very thing in itself, or the will, in that it
becomes a phenomenon, «¢., enters the forms of our intel-
lect, appears as matter, a.¢., as the invisible but necessarily
...
were right, not only in their sense but also in ours, when
they made the paradoxical assertion already referred to in
...
general, Yet, just because it is a manifestation of the
will, it belongs to knowledge a posteriori, not to knowledge
a prwr. ‘Therefore we can always picture to ourselves
...
2.¢.,1t would be without the power of acting ; but the nature
of matter as such just consists in acting, ue, in causality
in general; and causality depends upon the a priort form
of our understanding, and therefore cannot be thought
away.

Matter is accordingly the will itself, but no longer in
itself, but so far as it is percewed, u.e., assumes the form
...
general, 2¢., as absolute will, but always as particular, @e,,
...
as body, @.e., as matter clothed in form and quality. But
...
thing in itself, 2.¢., the will itself. Therefore, as has been
...
itself, 2.¢., presents itself objectively to the intellect, matter,
as its visibility, assumes jorm by means of the functions
of the intellect. Hence the Schoolmen said: “ Materia
appelit formam.’ That such was the origin of all forms of
...
—generatio equivoca still takes place, can only be decided
by experience; especially since the saying, Natura nihil
fact frustra, might, with reference to the paths of regular
propagation, be used as a valid argument against it. Yet
in spite of the most recent objections to it, I hold that at
very low grades generatio equivoca is very probable, and
...
corporis appears entirely of itself, and without any ego;
...
was foreign to that place. Thus Aucust St. Hilaire saw in
...
the Académie des sciences that upon the growing coral
...
lutely peculiar to these islands (Comptes rendus, 17th
...
that of generatio equivoca. Putrefaction is the decom-
...
according to design, 4.¢., objectifying the volition of the
will at the time, solidify out of the chemical elements,
as the chicken out of the fluidity of the egg. When,
however, this does not take place, the Hate Ee matter
is resolved into its ultéwmate constituent parts, which are
...
equivoca, With its premature shouts of victory, was the
...
and reaction. The reality of generatio equivoca and the
...
the visible, 2.¢., under the outer shell of form and quality,
...
sought in it. Yet it seems that the origination of or-
...
oreat difference of perfection and fulness. The old world,
...
_ apes proper only monkeys. Even from this last defect it
...
only something apprehended, something known, 1emains
...
quence of their investigations I was led te recognise and
...
it starts from a petitio principw, which when more closely
considered turns out indeed to be a rpwtov devdos. It
...
but with a matter which is not to be found im rerum
natura, but is rather a mere abstraction of that real matter,
a matter which would absolutely have no other than those
mevhanical qualities which, with the exception of gravity,
can be pretty well construed @ priori, just because they
...
and Democritus, and happens to it again now that it has
come toa second childhood through age; with the French
...
Credat Judeus Apella! Certainly the nature of light is
...
series of which was recently laid before the Académie
...
fall into time again? (Comptes rendus of 20th December
...
it had taken the actual and empirically given matter (2.e.,
...
itself, thus the true mater rerwm, from the obscurity of
whose womb all phenomena and forms come forth, to fall
back into it some time again; from this, 2.e., from matter
...
would then consist in this, that the Quwsita had been
...
that which is without qualities, the caput mortwwm of
nature, out of which nothing can honestly be made. Ii,
on the contrary, in the manner referred to, one leaves it
all these properties, one is guilty of a concealed wpetztzo
principtt, for one has assumed the Quesita beforehand as
Data. But what is accomplished with ¢hzs will no longer
be a proper materialism, but merely naturalism, 2.¢., an ab-
...
based simply upon qualitates occulte, which one can never
...
Jonic philosophers, and then materialism in the teaching
...
the inner nature, that which manifests itself, that which
appears, is one and the same, which comes forth ever more
...
év Ka Trav early appeared both in the east and in the west,
...
sclf-consciousness, then that inner being presents itself to
...
time, the whole condition of all things is firmly and accu-
...
THE WILL AS THING IN ITSELF. 67

and its conformity to law, one should assume a first be-
ginning, nothing would thereby be essentially changed.
For the arbitrarily assumed first condition of things would
at its origin have irrevocably determined and fixed, both
as a whole and down to the smallest detail, the state im-
mediately following it; this state, again, would have deter-
mined the one succeeding it, and so on per secula seculorum,
for the chain of causality, with its absolute strictness—
this brazen bond of necessity and fate—introduces every
phenomenon irrevocably and unalterably, just as it is.
The difference merely amounts to this, that in the case
of the one assumption we would have before us a piece
of clockwork which had once been wound up, but in
the case of the other a perpetual motion; the necessity of
the course, on the other hand, would remain the same. In
the prize essay already referred to I have irrefutably
proved that the action of man can make no exception
here, for I showed how it constantly proceeds with strict
necessity from two factors—his character and the motives
which come tohim. The character is inborn and unalter-
able; the motives are introduced with necessity under the
...
foreincomprehensible, play of an eternal necessity, an inscru-
table and inexorable Avay«n. Now, what is objectionable,
nay, revolting, in this inevitable and irrefutable view of
the world cannot be thoroughly done away with by any
assumption except this, that as in one aspect every being
in the world is a phenomenon, and necessarily determined
by the laws of the phenomenon, in another aspect it is
in itself wil/, and indeed absolutely free will, for necessity
only arises through the forms which belong entirely to
the phenomenon, through the principle of sufficient reason

i ea SECOND BOOK. CHAPTER XXV.

in its different modes. Such a will, then, must be self-
dependent, for, as free, z.¢, as a thing in itself, and there-
...
alone will as much /reedom be supposed as is needed
to counterbalance the inevitable strict necessity which
governs the course of the world. Accordingly one has
...
own I have shown in my prize essay on the freedom of
the will; with this, however, self-dependency is attributed
to his nature. The same relation holds good of all things
in the world. The strictest necessity, carried out honestly
with rigid consistency, and the most perfect freedom, rising
to omnipotence, had to appear at once and together in phi-
losophy ; but, without doing violence to truth, this could
only take place by placing the whole necessity in the acting
and doing (Operart), and the whole freedom in the being and
nature (Hsse). Thereby a riddle is solved which is as old
as the world, simply because it has hitherto always been
held upside down and the freedom persistently sought in
the Operari, the necessity in the Zsse, I, on the contrary,
say: Every being without exception acts with strict neces-
sity, but it eaists and is what it is by virtue of its freedom.
Thus with me freedom and necessity are to be met with
neither more nor less than in any earlier system; although
now one and now the other must be conspicuous accord-
ing as one takes offence that will is attributed to pro-
...
vears men have wearied themselves in vain to shake it,
...
_ bas a plan, then fate is the director; if it has none, then
_ blind necessity. There is no other deliverance from this
...
thing in itself, ae, the true nature of the world, so also
...
the grade of his reflective powers. Even this ultimately
springs from the fact that there really is only one being ;
...
with equally patient master-hand, perfects the last lke the
...
last as in the first, 2s wmmediately present whole and un-
...
in itself, 2.¢., to the inner primary force which shows itself
...
2.€.,does not depend upon the functions of our intellect,
...
prodire venus, more concerned to set up nothing false
...
present velocity and no other, because if 1t went faster it
...
sublate themselves again, like dissonances in music which
...
seeing that perfectly blind forces of nature, acting accord-
ing to unalterable natural laws, through their conflict and
...
them, and already in this manifestation striving after its
...
But I now turn to a sulyectwe consideration belonging
...
“Haud distributum anvmantibus, et quasi distributum tamen
insidens, animantiwmque sustentaculum id cognoscendum,
edax et rwrsus genitale” (Lect. 13, 16 vers. Schlegel). Cer-
...
cially those which swim, such as Veretiwlum, Funiculina,
...
_brain-consciousness disappears, like a lotus which nightly
...
that as in the generatio wquivoca there sometimes and
...
a will the basis of the existence of every natural being;
...
means of knowledge, thus upon the path of the ¢dea, has
also come into being upon the same path; thus that as it
exists for the intellect, it was also brought about dy the
intellect. We certainly can only bring about something

1 This chapter and the following one are connected with § 28 of the first
volume,

78 SECOND BOOK. CHAPTER XXVI.

recular and conforming to law, such, for example, as every
...
out mathematics, so also without physiology does it bring
...
nature recklessly exposes even this exceedingly ingenious
...
that the true inner being (@.¢., outside of our idea) of every
...
tenance of this organism. For apart from the will which
manifests itself im it, and the conditions of the external
...
be designed; and therefore final causes (cause finales) are
the clue to the understanding of organised nature, as effici-
ent causes (cause efficientes) are the clue to the understand-
...
and with great surprise; but in these cases that exceptio
 firmat reguiam applies, since they can be accounted for
upon other grounds. Such, for example, is the fact that
the tadpoles of the pipa toad have tails and gills, although,
unlike all other tadpoles, they do not swim, but await their
...
(Mus typhius) as superfluous; but here also it must at
...
cially by Richard Owen in his “ Ostéologie comparée,’ and
...
of the human fcetus, &c. All this points to a principle
which is independent of teleology, but which is yet the
foundation upon which teleology builds, or the already
given material for its works, and just that which Geoffroy
St. Hilaire has explained as the “anatomical element.”
It is the wneté de plan, the fundamental type of the higher
...
cause (causa jinalis) in these words: “ Avo tpomot ts
alTLasS, TO OV éveKa Kat TO c& avaryKns, Kat Ses AeyoVTAS
Tuyyavely wardtota pev augow. (Duo sunt cause modi:
alter cujus gratia, et alter e necessitate; ac potissumum
utrumque eruere oportet.) De part. anim.i.1. The efii-
...
what moves 77 is the motwe coming from without, thus
the causa jfinalts; which consequently appears here as
causa efficiens. Besides, we know from what has gone be-
fore that the bodily movement is one with the act of will,
for it is merely its phenomenal appearance in cerebral per-
ception. This union of the causa finalts with the efficient
...
a will is the forming power. In fact, we cannot otherwise
distinctly think a final cause except as an end in view, we,
a motive. Indeed, if we carefully consider the final causes
in nature in order to express their transcendent nature, we
must not shrink from a contradiction, and boldly say: the
final cause is a motive which acts upon a being, by which
itis not known. For certainly the termite nests are the mo-
...
will which extends an elephant’s trunk towards an object
...
again look for them no more, but are satisfied with the
final causes alone. At the most we have here some such
general principle as that the larger the part is to be the
...
cause alone helps us little. For exampie, if we really
knew the eficient cause of the circulation of the blood, as
...
the law: Natura non factt saltus, et quod commodissimum in
omnibus suis operatiombus sequitur (Arist. de incessu ani-
...
nation of the skull from vertebre, although even here also
...
The end of the corolla is—(1.) Protection of the pistil and
...
a force of nature, 2.2, a qgualitas occulta, and, therefore, it
...
n atia e€ avayxns, and the final cause, 7 yapw tov Ber-
Tovos, at once and yet separately, as their concurrence,
...
cient cause is seldom known to us; in wnorganised nature,
...
_ which physiologists may be able to substitute clearer and
...
sunilarly that consumptive men generally beget another
...
of life; the efficient cause, on the other hand, is the
...
and of the Mons Veneris in the female, is that even in
...
erows in the vicinity; and, secondly, also that the head
and the genitals are to a certain extent opposite poles
of each other, and therefore have various relations and
...
nature gave man the beard (which shows that homo homint
lupus). The woman, on the other hand, could dispense
with this; for with her dissimulation and command of
...
Yet in considering wnorganised nature the final cause is
always ambiguous, and, especially when the efficient cause
...
contrarvum, thus ateleological instances, to derange his con-
ception. One of the strongest is presented by the unsuit-
...
That in wnorganised nature the final causes entirely
...
2.¢., the end lies in one individual and the means in another.
Yeteven here it remains unquestionable so long as the
...
of the Lampyris noctiluca (the glowworm) the circums

go SECOND BOOK. CHAPTER XXVI.
...
themselves at all without the help of insects (Chr. Cour.
Sprengel, Hntdecktes Geheimniss, &c., 1793; Wildenow,
Grundriss der Kréuterkunde, 353). Very many dicecia,
moneecia, and polygamia are in the same position. The
...
also,” &c. <A proof of this consensus nature is also
...
attached to the twigs of the trees, which serve as nourish-
ment for their larvee, are hatched exactly at the time at
...
not do this, in the state of pupe.
...
teristic naiveté, he expresses it as something self-evident
in his Lettre a M. Nicaise (Spinoze op. ed Paulus, vol. ii. p.
672): “ Les causes finales, ow ce qui est la méme chose, la con-
sideration de la sagesse divine dans l’ordre des choses.” (The
devil also méme chose!) At the same point of view we
find, indeed, Englishmen even at the present day. The
Bridgewater-Treatise-men — Lord Brougham, &c. — nay,
even Richard Owen also, in his “ Ostéologie Compareée,”
...
at once also theology, and at every instance of desion
...
rational arguments, such as, however, the great Huine has
already advanced against them.) —
...
(as Piickler very happily designates their religion, or the
current arguments in its favour),

1 Let me here remark in passing
that, judging from the German lite-
rature since Kant, one would neces-
sarily believe that Hume’s whole
wisdom had consisted in his obvi-
ously false scepticism with regard to
the law of causality, for this alone
is everywhere referred to. In order
to know Hume one must read his
‘Natural History of Religion” and

his ‘‘ Dialogues on Natural Reli-
gion.” There one sees him in his
greatness, and these, together with
Essay 21 “Of National Characters,”
are the writings on account of which
—I know of nothing that says more
for his fame—even to the present
day, he is everywhere hated by the
English clergy.
...
oreat use of final causes, yet without connecting them
with speculative theology (which I shall have occasion
immediately especially to praise), Finally, Spinoza (Zh. 1.
prop. 36, appendia) makes it abundantly clear that he
identifies teleology so entirely with physico-theology,
against which he expresses himself with bitterness, that
he explains Natura nihil frustra agere: hoc est, quod wm
usum hominum non sit: similarly, Omnia naturalia tanquam
ad suum utile media considerant, et credunt alrquem aliwm
esse, qui ila media paraverit ; and also: Hine statuerunt,
Deos omnia in usum honvinum fecisse et dirigere. Upon
this, then, he bases his assertion: Naturam jinem nullwum
sibt preficum habere et omnes causas finales nihil, nist hu-
...
9A SECOND BOOK. CHAPTER XXVI.

I have satisfied the maxim: Hst enim verum index sui et
faist. But Spinoza did not know how else to help himself
...
physico-theology—such a thing hag never entered his
...
hypotheses as to the origin of animals and men (De generat.
anim., ili. 11) without lighting upon the physico-theological
train of thought. He always says: “1 ducts roves (natura
facit), never 7 ducts trerrontar” (natura facta est). But after
he has truly and diligently studied nature, he finds that it
everywhere proceeds teleologically, and he says: “ wary
Opwuev ovdev Trotovcay THY how” (naturam mhil frustra
facere cernvumus), De respir., c. 10; and in the books, De par-
tibus animalium, which are a comparative anatomy: “ Ovde
TEplepyov OvoEy, ovTE aTny 1 pvats Trovet.— H dvors évera
tou Troves TravTa.—IIavrayou de Aeyomev Tobe ToVvdE Evexa,
OTFOU av Pawnral TENOS TL, TPOS O 1) KLVNTLS TrEpalEL* BaTE
evar pavepor, OTL EOTL TL TOLOUTOY, 0 ON Kal KANOU[LEV vow.
Eves To cma opyavov’ éEvexa TLVOS yap EXATTOV TMY MopLoD,
ofolws Te Kat TO ONOY.” (Nehil supervacaneum, nihil frustra
natura facit.—Natura rei alicujus gratia facit omnia.—Rem
autem hane esse illius gratia asserere ubique solemus, quoties
jinem wntelligimus aliquem, in quem motus terminetur ; quo-
circa ejusmods aliquid esse constat, quod Naturam vocamus.
Fist envm corpus imstrumentum : nam membrum unumquod-

ON TELEOLOGY. 95

gue rer alicujus gratia est, tum vero totum wsum.) At
ereater length, p. 633 and 645 of the Berlin quarto edition,
and also De incessu animalium, c. 2: ““H vows ovdev roves
[aTNnV, ANN aél, EK TOV EVOEYO{LEVOV TH OVOLQ, TEDL EKACTOV
yevos Gwov to apiotov.” (Natura nihil frustra facit, sed
semper ex WS, que curque animalium generis essentie con-
tungunt, id quod optimum est.) But he expressly recom-
mends teleology at the end of the books De generatione
anvmalium, and blames Democritus for having denied it,
which is just what Bacon, in his prejudice, praises in him.
Especially, however, in the “ Physica,” ii. 8, p. 198, Aristotle
speaks ex wrofesso of final causes, and establishes them as
...
so far as it concerns wnorganised nature, is very defective
and unserviceable, as in the fundamental conceptions of
mechanics and physies he accepts the most gross errors,
which is the less pardonable, since before him the Pythago-
reans and Empedocles had been upon the right path and had
taught much better. Iimpedocles indeed, as we learn from
Aristotle’s second book, De celo (c. 1, p. 284), had already
...
are found, and conversely (De partwb. anim., ill. 2). Hence
...
{rt is asif nature had wished, in the mechanical tendencies
...
vellous termite dwelling, &., at least for those individual
...
instinct; thus from without, or from within; by an exter-
...
ON INSTINCT AND MECHANICAL TENDENCY. 097
...
of an inner tendency, «e., a definite quality of will which
...
the material for the nest; for the bee it is, for the begin-
...
often rare place, where the hatched larve will at once
...
98 SECOND BOOK. CHAPTER XXVII.

this the action proceeding from it may, according to its
...
high degree when assisted by the fact that in Kieser’s “ Zel-
lurismus” (vol. iil. p. 250) a case is mentioned “in which
...
the deemon of Socrates, on account of which he had the
...
tendencies of insects reflect much hght upon the working of
...
sense Burdach says (Physiologie, vol. 11. p. 22): “ The forma-
...
the animal organism, the vita propria of each part is
...
their action. or example, the caterpillar spins itself in
...
Introduc. to Entomol. ; Huber, Des abetlles). Such things
...
cause, cuided by instinct, it has only to fill up the gaps
which this leaves. Thus we see ants carry off their larvee
...
for the larvee, and also of the place to which they now
...
test the burying-beetle (Wecrophorus vespillo), had tied a
...
summer have with great care and labour fed their larve
...
bombylius) lays eggs, the working humble-bees are seized
...
the larve now being hatched out. This may without
...
more to confirm the conviction that the will is the basis
...
the anticepation of the future which appears in both. By
...
illustrated by the example of the Bombex in “The Will in
Nature” (second edit. p. 45, third edit. p. 47), that they
pursue and killin advance the enemies of their future eggs,
...
OvR second book closed with the question as to the goal
...
rations ; for “soul” signifies an individual unity of con-
...
more insidious than yruyn or anima, which signify breath.

Much more unsuitable, however, is the way in which
...
1 This chapter is connected with § 29 of the first volumes

106 SECOND BOOK. CHAPTER XXVIII.
...
Aristotle was right in saying: “7 vows datpovia, add’ ov
Gea eort” (Natura demonia est, non divina), De divinat.,
...
devil, J know well that the pretended philosophers of
...
world God, it is exactly the same thing as when Rousseau
in the “ Contrat social,” constantly and throughout denotes
the people by the word le sowverain ; we might also com-
...
quesitum, but their datwm. If they were boys I would
then explain to them that this is a petitio princypu, but
...
is the only true expression of its inmost nature. very-
thing presses and strives towards existence, if possible
organised existence, Le., life, and after that to the highest
...
wanting, by means of generatio equivoca, seizing every
...
108 SECOND BOOK. CHAPTER XXVIII.
...
to lwe is that which cannot be further explained, but lies
...
end. Why the individual exists would thus be clear; but
why does the species itself exist? That is a question
which nature when considered merely objectively cannot
answer. Tor in vain do we seek by contemplating her for
...
a.¢., permanent forms, none should be lost. Accordingly,
...
fancies should be lost, 7.¢., lest any one of these forms
...
ae, in the sphere of the idea, and were therefore obliged
to confine ourselves to this province in solving it. But
the case is otherwise, and a glance at any rate is afforded
us into the wnterior of nature ; inasmuch as this is nothing
else than owr own inner being, which is precisely where
...
110 SECOND BOOK. CHAPTER XXVIII.

tendency of all animals and men to retain life and carry
it on as long as possible—a tendency which was set forth
above as characteristic of the subjective, or of the will—it
is necessary to make clear to ourselves that this is by no
means the result of any objective knowledge of the worth
of life, but is independent of all knowledge; or, in other
words, that those beings exhibit themselves, not as drawn
from in front, but as impelled from behind. |
...
in every individual; and finally, if we take into considera-
...
the same labour; then also how, lke this, the life of the
...
upon us that life is a business, the proceeds of which are
very far from covering the cost of it. This becomes most
...
It alone is truly an animal nocturnwm ; not cats, owls,
...
alternation of insect larvee and hunger, makes the dis-
...
Il2 SECOND BOOK. CHAPTER XXVIII.
...
Natur” (second edition, p. 30 e seg.); nor does he neglect
...
brutes the emptiness and vanity of the struggle of the
...
tinetly with the want of any lasting final aim; instead of
which there presents itself only momentary comfort, fleet-
ing pleasure conditioned by wants, much and long suffer-
ing, constant strife, bellum omnium, each one both a hunter
and hunted, pressure, want, need, and anxiety, shrieking
and howling; and this goes on in secula seculorwm, or till
once again the crust of the planet breaks. Yunghahn
...
year out, yearin. For this, then, these turtles are born,
For whose guilt must they suffer this torment? Where-
fore the whole scene of horror? To this the only answer
is: it is thus that the will to live objectifies itself. Let one

1 In the Stécle, toth April 1859, vient de parcourir plusieurs pro-
there appears, very beautifully writ- vinces de Vile de Java cite un
ten, the story of a squirrel that was exemple remarqueable du pouvoir
magically drawn by a serpent into facinateur des serpens, Le voyageur
its very jaws: “Un voyageur qui dont il est question commencait %
...
gravir Junjind, un des monts appelés
par les Hollandais Pepergebergte.
Aprés avoir pénétré dans une épaisse
forét, il apercut sur les branches
d’un kijatile un écureuil de Java a
téte blanche, folatrant avec la grace
et Vagilité qui distinguent cette
charmante espéce de rongeurs. Un
nid sphérique, formé de brins flexible
et de mousse, placé dans les parties
les plus élevées de l’arbre, a l’enfour-
chure de deux branches, et une
cavité dans le tronc, semblaient les
points de mire de ses jeux. A peine
sen était-il éloigné quil y revenait
avec une ardeur extréme. On était
dans le mois de Juillet, et probable-
ment l’écureuil avait en haut ses
petits, et dans le bas le magasin &
fruits. Bientdt il fut comme saisi
d@effroi, ses mouvemens devinrent
désordonnés, on eut dit qu’il cher-
chait toujours 4 mettre un obstacle
entre lui et certaines parties de
Varbre: puis il se tapit et resta im-
mobile entre deux branches. le
voyageur eut le sentiment d’un
danger pour l’innocente béte, mais il
ne pouvait deviner lequel. I ap-
procha, et un examen attentif lui
fit découvrir dans un creux du trone
une couleuvre lieu, dardant ses yeux
fixes dans la direction de l’écureuil.
Notre voyageur trembla pour le
pauvre écureuil, La couleuvre était
si attentive a sa proie qu’elle ne
semblait nullement remarquer la
présence d'un homme. Notre voya-
geur, qui était armé, aurait donc
prevenir en aide 4 Vinfortuné ron-
geur en tuant le serpent. Mais la
science ’emporta sur la pitié, et il
voulut voir quelle issue aurait le
drame. Le dénotimeni fut tragique.
L’écureuil ne tarda point & pousser
un cri plaintif qui, pour tous ceux
qui le connaissent, dénote le voisi-

‘VOL. TIL...

nage d’un serpent. I] avanga un
peu, essaya de reculer, revint encore
en avant, tiche de retourner en
arriére. Mais s’approcha toujours
plus du reptile. La couleuvre,
roulée en spirale, la téte au dessus
des anneaux, et immobile comme un
morceau de bois, ne le quittait pas
du regard. L’écureuil, de branche
en branche, et descendant toujours
plus bas, arriva jusqu’& la partie
nue du tronc. Alors le pauvre
animal ne tenta méme plus de fuir
le danger. Attiré par une puissance
invincible, et comme poussé par le
vertige, il se précipita dans la gueule
du serpent, qui s’ouvrit tout & coup
démesurément pour le recevoir.
Autant la couleuvre avait été inerte
jusque 1a autant elle devint active
dés qu’elle fut en possession de sa
proie. Déroulant ses anneaux et
prenant sa course de bas en haut
avec une agilité inconcevable, sa
reptation la porta en un clin d’cil
au sommet de l’arbre, ow elle alla
sang doute digérer et dormir.”
...
114 SECOND BOOK. CHAPTER XXVIII.
...
For then the world is a God, ens perfectissimum, 4.¢., nothing
...
oreat and small, universal need, ceaseless cares, constant
...
116 SECOND BOOK. CHAPTER XXVIII.
...
Clearly this is all inexplicable 1f we seek the moving
...
cood things held out to it, the attainment of which
would be a sufficient reward for its ceaseless cares and
troubles. The matter being taken thus, every one would
rather have long ago said, “Ze jew ne vaut pas la
chandelle,” and have gone out. But, on the contrary, every
one guards and defends his life, like a precious pled¢e
...
physical, is everywhere the boundary-stone of every in-
vestigation, beyond which it cannot go. From the original
and unconditioned nature of the will, which has been
proved, it is explicable that man loves beyond everything

- CHARACTERISATION OF THE WILL TO LIVE. 119
...
him the one thing certain! Accordingly we often see a
...
beneath it only seemed to support it: z¢., the weakening of
...
1% Augustint de civit. Dei,” L. xi. c, 27, deserves to be compared as
an interesting commentary on what is said here,

i18 SECOND BOOK. CHAPTER XXVIII.
...
on, to use an expression of Aristotle’s (De celo, i. 13),
“ov doe, ara Bia” (Motu, non naturali sed violento).
...
ledge of life, is in no way a conclusio ex premissis, and in
general is nothing secondary. Rather, it is that which is
...
Supplements to the Third wook.

** Hi is similis spectatori est, quod ab omni separatus spectaculum videt.”
...
indirectly, in the service of the will. It therefore forms
...
erade of its manifestation. Form and colour, indeed, which
...
of Proclus and Olympiodorus, vol. i. p. 82): “vo edo
MeTAdEdwKE Lev TNS Lopdys TH VAN apwepes Se ov peTeAaBeEr
e€ autns Tou deactatov:” 2.¢., the Idea, in itself unextended,
...
pass over into each other: wea, etdos, species, kind. The
...
naturales, but only genera logica. Of manufactured articles
there are no Ideas, but only conceptions; thus genera
logica, and their subordinate classes are species logicw. To
what is said in this reference in vol. i,§ 41, I will add
here that Aristotle also (Metaph. 1. 9 and xiii. 5) says
that the Platonists admitted no ideas of manufactured
articles : “ dvov oKia, Kal SaxTUALoS, @Y ov hacw eEwvat ELON”
...
“arr evrrep (Supple., evd7 eore) ere tov duce. (eote’) d10
5n ov kaxos 0 IDhatav edn, ort edn exter droca hucer” (Si
quidem idee sunt, in vs sunt, que natura fiunt: propter
quod non male Plato dixit, quod species eorum sunt, que
natura sunt). On which the Scholiast remarks, p. 800:
“Kal TOUTO APETKEL KAL aUTOLS ToLS Tas LoEeas Demevots’
TOV Yap VITO TEYYNS YlVOMEVwY LEAS ELVAL OVK EAEYOV, AANA
Tov vo pucews”” (Hoc etiam ipsis ideas statuentibus placet :
non enim arte factorum ideas dart ajebant, sed natura pro-
creatorum). For the rest, the doctrine of Ideas originated
with the Pythagoreans, unless we distrust the assertion of
Plutarch in the book, De placitis philosophorum, L. i. ¢. 3.
The individual is rooted in the species, and time in eter-
nity. And as every individuals so only because it has
the nature of its species in itself, so also it has only tem-
poral existence because it isin eternity. In the following
...
reason, yet only 7m abstracto, as a concept, wniversale, which
...
the Scholastics, describe the Ideas as wniversalia ante
...
concepts to which the Realists now wished to attribute
...
act of the will, 2.¢, it cannot lie in our choice. On the
contrary, it springs only from a temporary preponderance
...
ON THE PURE SUBFECT OF KNOWLEDGE. | 127

perfect, z.e., the more objective, the less we are conscious
...
stituent elements of esthetic satisfaction. As soon, on
the other hand, as the consciousness of our own self, thus
subjectivity, 2.¢., the will, again obtains the upper hand, a
...
noluntas than of the voluntas. The excitement of the will
...
directly or indirectly, excites desire or aversion, even if it
...
kind of mental activity, as it accompanies the esthetic
apprehension, 2.¢. the knowledge of the Ideas, as a con-
dition.
...
time. Here also lies the analoey and, indeed, the re-
...
depends upon this that we can only apprehend the purely
objective nature of things, the Ideas which appear in
...
more easily from a work of art than from reality. For
...
of abstraction from our own volition, arising above its in-
terests which demands a special power of the intellect. In
a high degree, and for some duration, this belongs only to
genius, which consists indeed in this, that a greater measure
of the power of knowledge exists than is required for the
service of an individual will, and this surplus becomes
free, and now comprehends the world without reference
to the will. Thus that the work of art facilitates so greatly
the apprehension of the Ideas, in which esthetic satis-
faction consists, depends not merely upon the fact that art,
...
perceived object itself les entirely outside the province of
...
Nox erat, et celo fulgebat luna sereno,
Inter minora sidera,”
...
is sought to increase the effect of narrative or dramatic
...
condition of the enjoyment of esthetic objects, so much
...
nay, even in philosophy. The punctum saliens of every
...
Ideas, we, of the adequate objectivity of the will; while
...
maore enjoyable to me.

ON THE PURE SUB¥ECT OF KNOWLEDGE. 133
...
_the consideration will thereby gain in accuracy and extent,
...
tunate occurrence the whole world at once assumes @
...
letter, the Jew with the louis dors, the rope-ladder to
...
ON THE PURE SUBFECT OF KNOWLEDGE. 135
...
_ the intellect, separated from its root the will, moves freely,
...
here of sensual passion, but of esthetic pleasure.) Life is
...
Further, it is sublime, ¢.¢., it induces a lofty mood in us,
...
WuatT is properly denoted by the name genius is the
...
more profound perception of the world which les before
...
genius foreign to the will, ze, to the I proper, as it were
...
140 THIRD BOOK. CHAPTER XXXt.

sum, which, it is well known, it co-ordinates with monstra
per defectum and those per sitwm mutatum. Thus genius
...
The first manifestation which such a superfluity of the
power of knowledge calls forth shows itself for the most
part in the most original and fundamental knowledge, «<.,
...
schule der Aisthetik,” that Adelung, who had to speak the
...
of art, every immortal thought, received the spark of life,
...
may demand. Upon this rests the high value of imagina-
...
analysed in chapter 29. Always to see the universal in
...
to the actual which alone has interests for him, “«e.,
...
that the knower is the pure subject of knowledge, «e., that
...
those minds, «.¢., the purity with which in them the world
...
scribed by the motto of Giordano Bruno: Jn tristitia hila-
...
does not awake it, and set it inmotion. If, however, this
...
an awakened mind, «.¢., a mind actively aroused by volition;
...
ledge. The world can only appear in its true colour and
...
in which alone that condition takes place in a hich degree
and is of some duration, while in others it only appears
approximately and exceptionally. I take it to be in the
sense expounded here that Jean Paul (Vorschule der
. Aisthetik, § 12) places the essence of genius in reflective-
mess. The normal man is sunk in the whirl and tumult
of life, to which he belongs through his will; his intellect
is filled with the things and events of life; but he doeg
VOL, ITI, K

!

146 THIRD BOOK.” CHAPTER AX Ad.
...
tion. It has consciousness, 4¢., it knows itself and its
