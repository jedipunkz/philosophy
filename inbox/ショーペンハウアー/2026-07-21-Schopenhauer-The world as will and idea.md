---
source: "https://archive.org/details/worldaswillidea01scho"
title: "The world as will and idea"
author: "Schopenhauer, Arthur, 1788-1860"
year: "1907"
captured_at: "2026-07-21T03:56:37Z"
updated_at: "2026-07-21T03:56:37Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ショーペンハウアー"
query: "Die Welt als Wille und Vorstellung"
plain_text_url: "https://archive.org/download/worldaswillidea01scho/worldaswillidea01scho_djvu.txt"
public_domain: true
...
- 初版: 1907
- 情報源: [archive](https://archive.org/details/worldaswillidea01scho)
- パブリックドメイン: ✓
...
PERRET ACEO SILT EMILIO TINS NOTES IETS APSE eT RARER
=e ee i - wrestes > — = 2 2e== ewe tesa: —_ a
OSL SE EO St RS Seeaviws -
a SSSI SACI ET NOE AS OEP RSA ACERS I NET EIS RET

nl | alt nnsthaimnnetheatnement a J eee Sy ERR aC ENE fa AE a ES panne cine Si oy Ome ll ~
Sh emeinas ed eareente = Pn ea ea 4 Pane —a

SE er Ee a

Se ae REE PR EE ee oer
- - es Cae Ce re = Ss
Se
...
““Ob aicht Natur zuletzt sich doch ergriinde?” GOETHE.

SIXTH EDITION,

a
LONDON: |
KEGAN PAUL, TRENCH, TRUBNER & CO. LZ
...
FIRST BOOK.
PAGE
THE WorxLD AS IpDEA—First Aspect. THE IDEA SUBORDI- I
NATED TO THE PRINCIPLE OF SUFFICIENT REASON: THE
OBJECT OF EXPERIENCE AND SCIENCE . ° ° °

SECOND BOOK.

THE WoRLD AS WILL—FiRstT ASPECT. THE OBJECTIFICATION

OF THE WILL . ‘ ; “ : : Pi : F 121

THIRD BOOK.

THE WORLD AS IpDEA—SEcOoND ASPECT. THE IDEA INDEPEN-
...
multa fiert non posse, priusquam sint facta, judicantur ?
(Hist. nat. 7, 1.)
...
call ethics, and that which we call esthetics; and cer-
...
eonnection or coherence, that is, a connection in which
...
yet be organic, 2.¢., it must be a connection in which
every part supports the whole just as much ag it is
...
the thought explained in this work than ¢o read the book
...
just as if 1t were given with it. Besides, even if it had
...
word, or to say the same thing a second tine in other
...
a 3 8) PREFACE TO THE FIRST EDITION.
...
great living philosopher,’ who has certainly written
...
Nor to my contemporaries, not to my compatriots—to
...
ceneration, engrossed with the delusion of the moment,
...
and finally the absurd and senseless,’ stand in universal
...
the sympathy of his contemporaries. or the most part
...
point of reflection, 2.e., rational deliberation and honest
...
bast’ and charlatanism? in the highest honour, I have
...
be made out of one piece, is produced by joming together
...
orasp of that natural and childish realism in which we
...
sophy as a minor toa man of full age. That this truth
...
philosophy, they need a medicina ments, first as a sort of
...
vulgar mind. Born behind the broad, hich, finely-arched
...
PREFACE TO THE SECOND EDITION. Pw Gid
...
viwere, deinde philosophari? These gentlemen desire to
...
spite of the troublesome Kant with his Critique of Reason
...
XXX1l PREFACE TO THE SECOND EDITION.
...
Written at Frankfort-on-the-Maine
in February 1844.
...
THE IDEA SUBORDINATED TO THE PRINCIPLE OF SUFFICIENT
...
1. “THE world is my idea:” —this is a truth
...
as idea, ze, only in relation to something else, the con-
...
of the Vedanta philosophy ascribed to Vyasa, is pointed
out by Sir William Jones in the last of his essays: “On
the philosophy of the Asiatics” (Asiatic Researches, vol.
iv. p. 164), where he says, “The fundamental tenet of
...
is presupposed by them; it has therefore neither multi-
plicity nor its opposite unity. We never know it, but it
is always the knower wherever there is knowledge.

_ So then the world as idea, the only aspect in which
...
known from a consideration of the subject, ae, in Kan-
tian language, they le @ prior in our consciousness.
...
which we are a priort conscious; and that therefore all
that we know purely a priori, is merely the content of
that principle and what follows from it; in it all our
certain a priort knowledge is expressed. In my essay on
...
reason.» We shall consider these abstract ideas by |
...
2.¢., the absolutely universal element in its perception,
...
time, as they are known in @ priora perception or intui-
tion, are valid for all possible experience, as rules to
which it must invariably conform. Accordingly, in my
-1Kant is the only writer who my ‘‘Grundprobleme der Ethik” ;
...
ciple of sufficient reason, we shall find the same empti-
ness, and shall see that not time only but also space, and
the whole content of both of them, 7.¢., all that proceeds
from causes and motives, has a merely relative existence,
is only through and for another like to itself, 2.¢, not
...
phers declares, “It is May, the veil of deception, which
...
is nothing more than that form of the principle of suffi-
...
priately called in German Wirklichkeit,’ a word which is
far more expressive than Realitat. Again, that which is
...
2.€, In causation. <All the innumerable conceivable
phenomena and conditions of things, might be coexistent

1 Mira in quibusdam rebus ver- sermonis antiqui quedam efficacis-
borum proprietas est, et consuetudo simis notis signat. Seneca, epist. 81.

THE WORLD AS IDEA, It
...
i.e, Variation which takes place according to the law of
...
the whole essence of matter consisted in action, 7¢., in
...
latter gains the special character of change, «¢., the muta-
tion of quality and form in the permanence of substance,
that is to say, in matter.’ If the world were in space
...
change of its states.” As matter consists in the union
...
is therefore wholly deducible from that of space® (for
variation belongs to time alone, but in it alone and for

itself nothing is persistent).

1 Jt is shown in the Appendix
that matter and substance are one.
2 This shows the ground of the
Kantian explanation of matter, that
it is “that which is movable in

Matter shows that it springs

space,” for motion consists simply
in the union of space and time.

3 Not, as Kant holds, from the
knowledge of time, as will be ex-
plained in the Appendix.

THE WORLD AS IDEA. 13
...
the determination of what must occupy this tume and this
...
which we are conscious @ prior. These unalterable
characteristics are space-occupation, 2.¢., impenetrability,
2¢., causal action, consequently, extension, infinite divisi-
bility, persistence, «¢., indestructibility, and lastly mo-
...
Natural Philosophy,” p. 71 (p. 372 of Rosenkranz’s
...
which le at unequal distances behind each other; and
...
Reason,” § 21. All that is said there would find its
...
on “The Principle of Sufficient Reason,” § 23.
...
cedes perception and experience as their condition, and
...
18 THE WORLD AS IDEA.

perceived object, exhausts such an object itself, so far aa
it is object, ie, idea, for beyond this there is nothing
...
ing to its Immost meaning quite comprehensible to the
...
principle of the ground of knowing, but of being, as the
law of causality: every real object has paid its debt to
it, imasmuch as it has come to be, 2¢., has appeared as
...
_ founded. In such a case there is nothing for it but the
...
says (il 7.135): oxtas ovap avOpwios (umbree somnium
homo), and Sophocles :—
‘O2w yup nuas oudev ovrag aAAo, sAny
Sidwnr’ doormes Cumev, 7 xovpny oxsav.—Ajax, 125.
...
thought and meaning did not le at its heart as its real
...
adea, in another aspect as will? The fuller explanation
...
§ 6. For the present, Thomavon, in this first book we
...
sensibility of animal bodies, or the quality of being im-
...
the body is immediately known, is «mmediate object. But
...
It follows from what has been gaid, that all animals,
...
of the understanding, an immediate intuition, and as sucn
...
under abstract concepts, 2.¢., it makes knowledge distinct,
...
But the limits of these conceptions must not be toa
...
causality, 7.¢, power of understanding. The greatest,
...
understanding, is very great between man and maz, it is
...
suffices for the inference from thie effect on the immediate
object, to the indirectly known object as its cause, 2..,
...
mine how far understanding can go without reason, 2.e.,
...
the second book, when we consider the harmony or so-
called teleology of nature: and the 27th chapter of the
supplementary volume is expressly devoted to it.
Deficiency of wnderstanding we call stupidity: deficiency
...
erounds (Essay on the Principle of Sufficient Reason,
§ 29 and following paragraphs) ; that which is correctly
known by wnderstanding is reality, that is correct infer-
ence from effect on the immediate object to its cause.
Lirror is opposed to truth, as deception of the reason:
...
illusion. JI have explained in the essay referred to, how
...
mirrors, which, when the surface 1s convex appear some-
...
us as perceptions, and cannot be dispelled by any areu-
...
man, irrational, and is completely and sharply dis-
...
belongs to the understanding alone. __

§ 7. With reference to our exposition up to this point,

32 THE WORLD AS IDEA.
...
covered from the subject, z.¢., they may be known a priors,
...
from that of allformer systems. For they allstart either
...
in this doctrine of profound wisdom but BrEOCoUs and
wearisome bombast.
...
oljective, whether it be matter in the abstract, simply as
it is thought, or after it has taken form, is empirically
civen—that is to say, is substance, the chemical element
...
with equal right, oppcse the contrary assertion that all

36 THE WORLD AS IDEA.
...
such an immediate object, 2.2, the most dead and crude
...
organised state of matter has succeeded acruder state: so
...
sity, we might again call an antinomy in our faculty of
...
of Kronos (ypovos), the youngest of the Titans, as a sym-
...
to free himself. This is Plato’s Oavyafev, which he
calls a pada dirocodixoy waSos. But what distinguishes
...
deeply into the meaning of the book that nade him a
...
that all @ priori deduction, indeed all demonstration in
...
are convertible conceptions.’ But the principle of suffi-
cient reason is just the universal form of the object
as such. Thus it is in the object, but is not valid before

1 On this see “ The Fourfold Root of the Principle of Sufficient Reason,”
§ 49. | |

44 THE WORLD AS IDEA.
...
nothing but the principle of existence in it, 7.¢, succession;
space is nothing but the principle of existence in it, 2¢,
...
quite different and quite distinct from the 1dea; and in.
the next book we shall find this in a fact which is just.
as immediate to every living being as the idea. :

But we must first consider that class of ideas wnich
...
THE WORLD AS IDEA. 4s

sidered was understanding and sensibility, which are also
to be attributed to all the lower animals.’

§ 8. As from the direct light of the sun to the borrowed
licht of the moon, we pass from the immediate idea of
...
the object, or to pure sensibility and understanding (.e.,
...
and significant exactness, is called reflection. For it isin
...
acainst each other with reference to their power over the
will, The motive that overcomes, in that it decides the
auestion at issue, is the deliberate determinant of the
...
48 THE WORLD AS IDEA.

reason are expressed by the same word; 6 Aoyos, i
discorso. Vernunft is derived from. vernehmen, which
...
and which has been called reason, 0 Aoyos, To AoyiaTLKOD,
To Noyywov, ratio. Besides this, no one finds any diffi-
...
phers of all ages may be said to be on the whole at one
...
“Essay on the Human Understanding” (Book IL, ch. xi,
...
“Nouveaux Essais sur l’Entendement Humaine” (Book
II., ch. xi., §§ 10 and 11.) But when Locke (in Book IV.,
clivxvil; < 2 and 3) comes to the special explanation of
...
and meaning for the brutes. ‘hus language, like every
...
ence of concepts. Reflection is the necessary copy or
...
of grounds of knowledge does not extend ad infimtum ;
...
world of perception have been called conereta. But this
...
As examples of the first kind of concepts, @¢., abstracta
...
relation of its ground of knowledge, we, be thought
...
S4 THE WORLD AS IDEA.

idea of an idea, 7.e., its whole nature consists in its rela-
...
means of one concept, ze, may be brought under it.
...
according to their possibility, 2.¢, a priori, may be made
...
concepts of Ruminantia and Bisulea (ruminating and
cloven-hoofed animals), also those of vertebrate and red-
biooded animals (although there might be some doubt
...
together exemplify the syllogism in the first figure, «e.,
...
which do not lie within athird sphere. If many spheres
...
exactly, as ethics is to virtue, or esthetics to art; we
must yet remember that no one ever became an artist by
the study of xsthetics; that a noble character was never

58 THE WORLD AS IDEA.
...
esthetics and even ethics, though in a much less degree,
...
Jaws is determined in accordance with this general know-
...
_ vestigation of the particular case. With logic, however, it
...
make itsowndam. Logic is, therefore, without practical
...
doubt or difference of opinion, some _ pedantically
...
1 Cf. Ch. 9 and 10 of the Supplement.

62 THE WORLD AS IDEA.
...
example, ex merits particularibus aut negativis nihil sequi-
tur, a rationato ad rationem non valet consequentia, and
soon. That all this was only brought about slowly, and
...
a definite form (Sext. Emp. adv. Math. 1. 8, p. 112).
...
fallacies; for logical fallacies such as mentiens, velatus,
cornatus, &¢e., are clearly too clumsy for actual use. I
am not aware that hitherto any one has traced the
nature of all sophistry and persuasion back to this last

64 THE WORLD AS IDEA.

possible ground of its existence, and referred it to the
peculiar character of concepts, 2.¢., to the procedure of
...
Stahl’s Chemistry, Newton’s Theory of Colours, &c. &c.’
§ 10. Through all this, the question presses ever more
upon us, how certainty is to be attained, how gudgments

1 Cf. Ch. 11 of Suppiement.

VOL I. P G#

ad

el dita quaestuo - negotia quaelibet
ans sum idoneum vigorans
promovens eaaene
) salubre
...
Bonun al vana 4
desideria scientiam Experientiae
amplifi- latissimus
...
periculosum datnimentod

fiduciam auctoritatem
publicam \ | concilians sum
onium
comparans \. Jo
muneribus exitiosum
alici mee odia
di publics | invidiosum \ Madu
itans idoneum
ao edd suscitans
munera Feagens
publica
...
THE WORLD AS IDEA. 65

are to be established, what constitutes rational knowledge,
...
pure understanding, ae. from the a priori knowledge of
...
knowledge in something outside themselves, 2.¢., are true.
...
we attribute life to plants, but not consciousness. a-
...
§ 11. In this regard the direct opposite of rational.
...
sciousness, ts not a concept, is not abstract rational
...
love, &. &. There is absolutely nothing in common
...
relations presented a priort in perception, and also the

THE WORLD AS IDEA. 67
...
._knowledge. In the same way Schleiermacher speaks in
...
says, “One jelt that the fallacies were not right, but
...
have in German the nearly synonymous word emp/jindung
...
ception, in the concrete. But thisis much more important
...
ing can only comprenend one object ata time. Every

THE WORLD AS IDEA. 69
...
knowledge, or we must think the difference in numbers.
...
ceometry must be translated into arithmetic if it is to
...
ealculations, in which the symbols represent the most

72 THE WORLD AS IDEA.
...
felt, that is, it cannot be put into abstract concepts.
...
always there, ana therefore no continuous passage from

74 THE WORLD AS IDEA.
...
is never without a high, broad, finely-

certainly be judged to be so the
uglier the face is; anda stupid-
looking person may the more cer-
tainly be judged to be stupid the
more beautiful the face is; for
beauty, as the approximation to the
type of humanity, carries in and for
itself the expression of mental clear-
ness ; the opposite is the case with
ugliness, and so forth,
...
pleted in all its parts and rounded off to a whole.’

1 Of. Ch. 7 of the Supplement.

76 THE WORLD AS IDEA.
...
course of our work to doso. The cause of laughter in
...
carry it out, or when it shows itself merely in tps gibl
and opinions.

Pedantry is a form of folly. It arises in this way: a
...
evident that the former never condescends to the par-
ticular case, and that with its generality and rigid
...
pun is related to the witticism as the parabola (szc) of
the upper inverted cone to that of the lower. The mis-
understanding of the word or the guid pro quo is the
...
said on the subject in the “ Parerga,” vol. IT. ch. vi., § 98.!
...
judgements, and lastly with its content.
...
spheres which le within the concept of its object in
general. When the relations of these spheres to each
other have been determined, aJl that is thought in them
...
1 Suarez, Disput. Metaphysice, disp. iii. sect. 3, tit. 3.
...
be established hy deduction from preceding propositions,
...
pure @ priori, as it forms the basis of mathematics, partly
empirical a posteriori, as it forms the basis of all the other
...
astablish the truth of such primary judgments directly
...
eated by demonstrations. This is most difficult in the

86 THE WORLD AS IDEA.
...
all ares by deduction from the proposition of Pythagoras.
But even such a truth as this cannot essentially and
solely rest upon abstract principles, and the space-rela-
tions which he at its foundation also must be capable of
being so presented @ priort in pure intuition or perception
...
shall only explicitly expound what was already «wmpliciily
...
tion of space, which is given a prior, and is therefore
...
vravity, which acts precisely in relation to the masses
and the square of the distance; and, lastly, the law of
inertia, which follows from the law of causality and is
therefore true @ priort, and with it the empirical datum
...
the revalution of the latter according to Kepler’s second
law. But the ground of this law is, that with this
distance only this velocity will both chain the satellite to
the planet and prevent it from falling intoit. Thusitis
...
eases with the whole of the hypotheses, and with their
...
sary and universal forms of knowledge, cannot itself le
...
dcctrines and sophisms of every kind. Syllogisms are
indeed perfectly certain as regards form, but they are

90 THE WORLD AS IDEA.
...
go on crutches, or like that of the prince in the “ Zriwmph
...
contingent circumstance. Often a reductio ad absurdum
...
_ set up as the pattern of all scientific exposition. Men
...
conflict, that exists between what is perceived, dawopevor,”
and what is thought, vovpevoy, and used it in many ways
...
by necessity to found the axioms npon evidence of per-
ception (dawopevov), but all the rest he based upon
reasoning (vouyevov). His method reigned supreme
through all the succeeding centuries, and it could not
but do so as long as pure intuition or perception, a priors,

1 The reader must not think here terms, which is condemned in the
of Kant’s misuse of these Greek Appendix.

94 THE WORLD AS IDEA.
...
senses, conditioning it, not conditioned by it, a2, are a |
priort, and therefore are not exposed to the illusions of
...
conscious @ priort. This is always the principle of
sufficient reason; here as the form of perception, 22.,
...
admirably in the Analyt., post. 1 27: “AxpiBeotepa &
ETLOTNUN ETLOTHUNS KAL TpOTEpAa, NTE TOU OTL Kal Tov
OvoTL 4) aUTN, GAAG pM XwpLs Tov OTL, THS Tov SioTL”
(Subtilior autem et praestantior ea est scientia, gud QUOD
aliquid sit, eb CUR sit una svmulque intelligumus non
separatim QUOD, e¢ CUR sit). In physics we are only
...
known @ prior. For any one to wish to derive the
...
another. Yet this is what Eucld has done. His
...
When a criminal is examined, a proces-verbal is made
...
in tyme alone, and therefore cannot be represented by a
...
prove, for example, not that °%*-"—42; but we refer to
...
only in the abstract and indicated as so thought, as ,/r°
...
pure @ priori perception, with the same right and
...
self (substantia causa sut, &c.), and
in the demonstrations he allows

1 Spinoza, who always boasts that
he proceeds more geometrico, has

actually done so more than he him-
self was aware. For what he knew
...
which the nature of the wide con-
cept-spheres afford such convenient
opportunity. That his doctrine is
true and excellent is therefore in
his case, as in that of geometry,
quite independent of the demonstra-
tions of it. Cf. ch. 13 of supplemen:
tary volume.

THE WORLD AS IDEA, Iol
...
tion, 2.¢., from many consequents which point to one
...
induction, 2.¢, the knowledge of the cause from the
effects, approaches, not infinitely indeed, but yet so near
mathematical evidence, 2.¢., knowledge of the effects from
...
to all cases, ae, to the unknown ground on which all
...
that is @ priori is based, is given as a whole and at once,
...
are followed by the a priorz sciences referred to above.
...
priort, and therefore in themselves, 2.¢., according to their
...
but must be founded on perception. In the few a priort
...
where the wrong pigeons are caught, &. (Thestetus, p.
167, et seg.) Kant’s vague, indefinite explanation of the
source of error by means of the diagram of diagonal
motion, will be found in the “ Critique of Pure Reason,”
...
understanding, 7.e., deficiency in the capacity for imme-
...
through a prism, ae, bent up or down, appears as a
...
that sore particular cause is that of a certain effect.
...
and meaning only through this principle. Zxplanation is
...
is, 2.¢., it is the form of all knowledge. Therefore we do
not ask why 2 + 2=4; or why the equality of the

106 THE WORLD AS IDEA.
...
demanded, stops at an accepted gualitas occulta; but this
...
might be based upon this circumstance. Every explana-
...
efficiens or a causa finalts of the whole world. My philo-
sophy, at least, does not by any means seek to know
whence or wherefore the world exists, but merely what the
...
philosophia, quae mundi tpsius voces fidelissime reddit, et
velutt dictante mundo conscripta est, et mhil aliud est,
quam ejyusdem SIMULACRUM ET REFLECTIO, neque addit quid-
quam de proprio, sed tantum iterat et resonat (De Augm.
...
eround of knowledge, is not therefore to be made use
of to establish them, as that which is prior to them,

110 THE WORLD AS IDEA.
...
and as the seat of an absolute (ze, fallen from heaven)
...
are related to the lower animals very much as_ those
...
ception, 1.¢, the real objects which are immediately pre-
sent to them in time; we, on the contrary, on account

1 Cf. Ch. 17 of Supplement,

THE WORLD AS IDEA. IIr
...
as distincuished from the lower animals, possesses through
...
say to the strong: ovdnpevov vu tow nrop! (ferrewm certe
tibt cor), Il. 24, 521. Here we can say truly that reason
...
The ideal explained in the Séoical philosophy is the
most complete development of practical reason in the true
and genuine sense of the word; itis the highest summit to
...
happiness: teAos To evdas poveww (virtutes omnes finem
habere beatitudinem) it is called in the account of the Stoa
by Stobseus (Ecl, L. i. « 7, p. 114, and also p. 138).
Yet the ethics of Stoicism teach that happiness can only
be attained with certainty through inward peace and
quietness of spirit (atapafia), and that this again can
...
ethical teaching of Spinoza, which deduces a pure doctrme
of virtue from the egoistical swwm utile querere by means
...
him at once, directly, 7.¢., through mere knowledge, com-
...
nerable. Therefore Antisthenes says: det xtac@at vou»,
» Bpoxov (aut mentem parandam, aut laqueum. Plut. de
stoic. repugn., c. 14), ae., life is so full of troubles and
...
not to have and begets pain. Ov mewa dvirny epyagerat,
andra erOuuta (non paupertas dolorem efficit, sed cupiditas),
...
through fuller insight.’ Therefore Chrysippus says: des
nv Kat euretpiav tov duces cupLawovtwy (Stob. Ecl., L.
...
disturbs his atapakva.

In accordance with this spirit and aim of the Stoa,
Epictetus began and ended with the doctrine as the kernel

1 Omnes perturbationes judicio
censent fieri et opinione. Cic.
Tusc., 4,6. Tapacoer tovs avOpwirous
ov Ta mpaymara, a\AG TA Tepe TwY
mpaynatwr doywara (Perturbant
homines non res ips, sed de rebus
opiniones). Epictet., c. v.

2» Tovro yap eoTt TO airioy Tots

avOpwrols TavTwY TwWY KAKWY, TO TAS
Tpornpers Tas Kowas pn duvacdae
epapuocew tas ere pepovs (Hee
est causa mortalibus omnium ma-
lorum, non posse communes notiones
aptare singularibus). Epict. dissert.,
ii., 26,

THE WORLD AS IDEA. 117
...
asked whether we ought to apply the words donwm and
...
was that for the attainment of the highest good, ze.
blessedness and spiritual peace, one must live in harmony
with oneself (cuoroyoupevas Env: tovto Sects Kal éva
Aoyor Kat cuudwvov Env.— Consonanter vivere: hoc est
secundum unam rationem et concordem sibt vivere. Stob.
Eel. eth. L. 1, ¢ 7, p. 132. Also: Aperny dsvabeow evvas
wvyns suppovov éauTn mept orov tov Biov. Virtutem
esse anim affectionem secum per totam vitam consentientem,
abid., p. 104.) Now this was only possible for a man if
...
with nature” (ouoroyounevws ty guoet Env), which, as
Stobseus mentions in another place, was first added by
...
Ne te semper inops ayitet vexetque cupido,
Ne pavor et rerum mediocriter utiliwm spes,”
...
lead us to happiness. Rather, there lies an absolute con-
...
form of endszmonism, and those doctrines we have men-
...
ereatest poetic truth, and the highest significance, which
stands before us in perfect virtue, holiness, and sublimity,
yet in a state of supreme suffering.’

1 Cf. Ch. 16 of Supplement.

Second Book,

DHEOWORL D AS OW LLL:

FIRST ASPECT.

THE OBJECTIFICATION OF THE WILL.

Nos habitat, non tartara, sed nec sidera coeli 3
Spiritus, in nobis qui viget, illa facié.
...
meaning oniy in relation to the idea of perception, with-
out which it would be worthless and empty. Accordingly,
directing our attention exclusively to the idea of per-
ception, we shall now endeavour to arrive ata knowledge
...
very much in the same way of an olject which constitutes
the basis of the idea, and which is indeed different in its
whole being and nature from the idea, but yet is in ail

124 THE WORLD AS WILL. BK. IT.
...
Htvology. The first treats of the permanent forms, the
...
THE OBFECTIFICATION, OF THE WILL. ¥25
...
(unité de plan), is established, and thus they may be com-
...
cern is the knowledge of cause and effect. The sciences
...
it les outside the province of causal explanation, which
...
these conditions, and this appearance in a_ particular
...
THE OBFECTIFICATION OF THE WILL. 127

orderly eppearance under certain conditions a law of
...
_ way for each other. But the inner nature of the forces
...
start from the subject, 2.2, a priori, as if we start from
the object, 2.c., a posteriort. Kant indeed has taught us
this.
...
or whether it is also something else,
