---
source: "https://archive.org/details/the-world-as-will-and-representation"
title: "The World As Will And Representation"
author: "Schopenhauer, Arthur,"
year: "1958"
captured_at: "2026-08-30T16:54:28Z"
updated_at: "2026-08-30T16:54:28Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "ショーペンハウアー"
query: "Schopenhauer The World as Will and Representation"
plain_text_url: "https://archive.org/download/the-world-as-will-and-representation/The-World-as-Will-and-Representation_djvu.txt"
public_domain: true
...
- 初版: 1958
- 情報源: [archive](https://archive.org/details/the-world-as-will-and-representation)
- パブリックドメイン: ✓
...
Atenor Schopenhauer was born in the Hanseatic
...
work. Like Piato, he was deeply stirred by 00,0, by the wonder that
...
to keep note-books in which from time to time throughout his Itfe he
...
principle of sufficient reason states that, 1f certain premisses arc piven,
...
[ viii ] Transiator’s Introduction
...
Sutra,” C. A. Muses, 1955, passiz.

Downloaded from https:/Awww.holybooks.com

Translators Introduction [ix]

equivalent, although it may also be transtated “intuition” in the sense
...
Wilikiir means free will, free choice, arbitrary power, or caprice.
The expression “free will” is likely to give risc to a misconception,
...
1873 was it possible for Julius Frauenstédt, the philosopher's literary
...
tely on Frauenstadt’s edition as the standard, but with the suggestion
...
in 1879, Schopenhauer’s manuscript-bocks went to the Berlin Li-
...
the edition of Frauenstédt contained many hundreds of errors,
...
cates to state here how this book is to be read,
in order that it may be thoroughly understood. What is to be im-
parted by it is a single thought. Yet in spite of all my efforts, [ have
...
hand, @ single thought, however comprehensive, must preserve the
...
follows, and generally whatever might contribute to the greatest pus-
...
such passages in that essay wili come about quite automatically in
...
after F had already made use of better ones, has been the cause of
...
Finally, the third demand to be made on the reader might even
...
principal works of Kant. Irfdeed, I find, as has already been said on
...
condition. Therefore, while ] start in large measure from what was
...
rived as a consequence from the thought I am to impart, although
...
substantia], original, and absolutely indispensable works, as well as
in innumerable periodicals, and even daily papers; at 2 time when
...
Preface to the First Edition [ xvii J

and approved before his fifteenth year. Who could endure all this?
Therefore, my advice is simply to put the book aside.

J am afraid, however, that even so [ shall not be let off. The
reader who has got as far as the preface and is put off by that, has
paid moncy for the book, and wants to know how he is to be com-
pensated. My last refuge now is to remind him that he knows of
various ways of using 4 book without precisely reading it. It can,
...
Nz to my contemporaries or my compatriots, but
...
false fiourishes, For to unite the matter with the superficial aspect
...
sublime endeavour, like that after light and truth, can thrive in it
...
nourishes the ovter man just as does any other. They therefore
...
in other words, of the purpose or intention to serve those ends,
...
see the cherished mediocrity straining to bring about fronr its own
...
my writings bear the stamp of honesty and openness so distinctly on
...
books representing my own teaching. In the case of these, I have
...
in an inteJlectual regard, the supplement of another. We shall there-
...
by which an achromatic object-glass, since it cannot be made out of
...
to read first of all through the first volume without drageping in the
...
This change is so great that it may be regarded as an intelectual
rebirth. It alone is capable of realy removing the inborn realism
...
of that natural and childlike realism in which we are all born, and
...
Hegelians | have come across descriptions of the Kantian philosophy
...
sort of purgative, um petit cours de senscommunologie,® and after
...
it is truce of him in the highest degree, as indeed of all genuine
philosophers, that only from their own works docs one come ta
...
accordingly wili prefer to hear from one of its kind even what a
...
maxim primum vivere, deinde philosophari? * The gentlemen want
...
the principal theme of ali philosophy—in spite of the troublesome
...
beyond all possibility of experience, wholly and for ever shut otf
...
pursue their own aims. F, however, have only insight and discern-
...
everyone js at liberty to pluck 4 little feather here and there for his
own use, for the superfiuity of ideas at home is not usually very
...
as it is on the whole, Although we sce the Gorgiases and Hippiases
nearly always at the top; although as a rule the absurd culminates,
and it seems impossible for the voice of the individual ever to penc-
trate through the chorus of foolers and the fooled, still there is left
to the genuine works of all timcs a quite peculiar, silent, slow, and
...
Lis true and the genuine would more easily obtain
...
*“Tf anyone who wanders all day arrives towards evening, it is enough.” {Tr.]
...
Schopenhauers sdmtliche Werke, Ed, Paul Deussen. 13 vols. Munich:
R. Piper, 1911-42.

Schopenhauers samtliche Werke. Ed. Arthur Hiibscher. 7 vols. Wies-
baden: F. A. Brockhaus, 1946-50.

Schopenhauers handschriftlicher Nachiass.Ed. Arthur Hiibscher.5 vols.
...
by Open Court Publishing Co. in one velume).
...
The Pessimist’s Handbook: A Collection of Popular Essays. Trans.
...
Copieston, Frederick. Arthur Schopenhauer: Philosopher of Pessi-
...
Doring, W. O. Schopenkaver. Hamburg: Hansischer Gildenverlag,
1947.
...
. Schopenhauer: Biographie eines Weltbildes. Stuttgart: Reclam,
...
Pfeiffer, K. Arthur Schopenhauer: Persénlichkeit und Werk. Leipzig:
A. Kréner, 1925,
...
represents, and this is himself. Lf any truth can be expressed a priort,
...
only for the subject. The world 1s representation.
...
nay even our own bodies (as we shail discuss more fully later on),
...
The World As Will and Representation [5]

§ 2.

Bie which knows all things and is known by none
is the subject. It is accordingly the supporter of the world, the univer-
sa] condition of all that appears, of all objects, and it is always pre-
...
objects, although it is immediate object.4 Like all objects of percep-
...
they reside a prior in our consciousness. To have discovered this is
...
to say, stands in a necessary telation to other objects, on the one
...
by these forms. Here ¥ constantly assume that what was said in that
...
by themselves, but first of all we shall speak exclusively of the inzuitive
...
borrowed from expericnce through repetition, but is so entirely inde-
...
effaced its father the preceding moment, to be aguin effaced just as
...
H. who has recognized the form of the principle
...
time and space), their perceptibility, ie., matter, and hence the law
...
The World As Will and Representation [9]
...
expressive than Realitét, That on which it acts, again, is always
...
* Mira in quibusdam rebus verborum proprietas est, et consuetuda sermonis
...
The Worid As Will and Representation [11]

manent). The @ priori certainty of persistence or substance is there-
fore to be wholly and entirely derived from that of space.* Matter
reveals its origin from time im quality (accident), without which it
...
Or this derivation of the basic determinations of matter from the
...
are space-occupation, i.¢., impenetrability, i.e., effectiveness, then ex-
tension, infinite divisibility, persistence, ie., indestructibility, and
...
although it is not quite suitable; for sensibility presupposes mutter.
...
ately known, that is to say, felt; and as this effect is referred at once
...
The World As Will and Representation [13]

activity of the eye; and finally also the stereoscope; ali these are solid
...
tesults from experience, is not the case; this was the scepticism of
...
found, and hence that it exists wholly @ priori in respect of experi-
...
her attempted by Kant, which I criticize in the essay On the Principle
...
which dogmatism and scepticism oppose cach other, and the former
...
made triumphant attacks on both. Now just as the aw of causality

Downloaded from https:/Awww.holybooks.com

[14] The World As Will and Representation

already precedes, as condition, perception and experience, and thus
...
But the object as such everywhere presupposes the subject us its
necessary correlative, and hence the subject always remains outside
the province of the validity of the principle of sulficient reason. The
...
the object itself in so far as it is object, ij.e., representation, as beyond
...
{16} The World As Will and Representation

another class of objects. Thus the world of perception raises no ques-
...
appear, because there was no fonger any meaning in it. But this
...
answer might therefore run as follows: the /ong dream (life) has
complete connexion in itself according to the principle of sufficient
reason; but it has no such connexion with the short drearas, although
...
The World As Will and Representation 117]
...
undertaking or scheme occupies all our thoughts, and engrosscs our
...
strives to be awake. Pindar says (Pyth. viii, 135): oxiéq tvap
avigwresg (umbrae somnium homo),’ and Sophocles:

‘Ope ya¢ quads obdey Gvtas GAKG, TANY
Et8wk’, Ssorteo SQusy, % xoveTY GHidy.
Ajax, 125.

(Nas enim, quicunque vivimus, nihil aliud esse comperio, quam
simulacra et levem umbram.)® Beside which Shakespeare stands most
worthily:
“We are such stuff
...
Finally, Calderén was so deeply impressed with this view, that he
sought to express it in a kind of metaphysical drama, Life a Dream
(‘La Vida es Sucfio’).

*“"Man is the dream of a shadow.” [Tr.]
““T see that we who are alive are nothing but deccptive forms and a
...
After these numerous passages from the poets, I may now be per-
...
runs constantly through lite, and waking up indicates this difference,
...
The Worid As Will and Representation [19]

§ 6.

Masi for the present, in this first book we
...
sentations, is in even greater opposition when his own body its said to
...
[20] The World As Will and Representation

jectively, we say that the understanding first of all makes perception
...
ate significance for the will, and yet are perceived, i.e. exist orily for
...
The World As Will and Representation [21]

Sufficient Reason (second ed., § 20), in the Ethics (first essay, iii),
...
immediate insight, and as such the work of an instant, an apercu, 4
sudden idea. They are not the product of fong chains of abstract rea-
...
knowledge in the abstract concepts of such reason, in other words, to
...
cause from thc given effect, and thus provides the faculty of reason
...
called in the proper sense stupidity, and it is just duiness in applying
...
The World As Will and Representation [23]

because he did not understand this absolutely direct causation of re-
flection.
...
bined activity of these two. The discussion of this, however, dees not

Downloaded from https:/Awww.holybooks.com

[24] The World As Will and Representation

belong here, but will find its place in the second book, when we are
...
of understanding, or illuston, are the stick that seems broken when
...
Tt is the understanding that assumes the cause of the feebler bright-
...
The World As Will and Representation 125]

to atmospheric perspective, leads us to suppose that very high moun-
...
Win regard to the whole of our discussion so far,
...
[26] The World As Will and Representation

principle of sufficient reason. We, on the other hand, deny the rela-
...
completely lacking in all reason-intuition, 1 shall not venture to
speak of the aforesaid revered identity and of the Absolute. Yet,
since F take my stand merely on the manifestoes of the reason-
...
intuition. ali those expositions which presuppose it must be to me like
...
The World As Will and Representation [27]

cept. The Pythagoreans and the Chinese philosophy of the J Ching
...
tied farthest when it appears as materialism proper. It regards mat-
...
starts from the odjective; it takes an objective something as the
...
*“Bepging of the question.” [Tr.]

Downloaded from https:/Awww.holybooks.com

[28] The World As Will and Representation

nature and finally the knowing subject emerge from it, and thus
completely to explain these; whereas in truth everything objective is
already conditioned as such in manifoid ways by the knowing
...
The World As Will and Representation [29]

and the law of causality as organon. Accordingly, its end and aim
...
is the principle that renders all materialism for ever impossible. Suns
...
these words are a sideroxyion, an iron-wood.?® On the other hand
...
preceded it, and in which it itself appears as a smal! link. These two
...
2 4 word coined by Schepenhaver from two Greek words to express a
contradiction or absurdity. [Tr.]

Downloaded from https:/Awww.holybooks.com

The World As Will and Representation [31]

is its innermost being, its kernel, the thing-in-itself. This we shall
...
birth of Chronos (Xpovog), the youngest of the Titans, as the descrip-
...
[32] The World As Will and Representation

The first has been frequent and general in all philosophy hitherto;
...
which he tries to disengage himself. This is Plato’s Saupate,!!
which he calls a yada grhocoginty rabog.4t But what distinguishes
...
The World As Wiil and Representation {33]

the least fragment of all this. The only thing that interested him in
...
T find that it is the principle of sufficient reason of being in space.
...
ali demonstration in general, rests on a necessity, and that all
...
reason are convertible terms.1? But the principle of sufficient
...
principle of being in it, i-c., position; matter is nothing but causality;
...
The World As Will and Representation [35]

as the subjective correlatives of the representations so far considered
...
rowed reffected light of the moon, so do we pass from the immediate
...
“3 To these first seven paragraphs belong the first four chapters of the first
book of supplements.

Downloaded from https:/Awww.holybooks.com

[36] The World As Will and Representation

for every error carries a poison within itself. If it is the mind, if
...
sensibility and understanding (ie., knowledge of causality) if we
...
cannot Jive to see. They are given up entirely to the impression of
...
The World As Will and Representation [37]

Finally, he has an actual choice between several motives, for only
...
Italian speech and reason are expressed by the same word, 6 iéyag,
il discorso. Vernunft (reason) comes from vernehmen, which is not
...
Tt is the unanimous opinion of all times and of alli nations that
...
called Vernunft, reason, 6 XOyos, th Kopiatendy, 1d AOyiKov, ratio. All
...
faculty, and to say what is rational and what is irrational, where
...
repeats this in the Nouveaux essais sur Pentendement humain (Book
TI, chap. xi, §§ 10 and 11). But when Locke (Book IV, chap, xvii,
...
™4 [Three Dialogues between Hyltas and Philonous, no, 2, Tr]

Downloaded from https:/Awww.holybooks.com

The World As Will and Representation [39]

actual world, as well as all sagacity, good sense, and the inventive
...
fi concepts form a peculiar class, existing only in
...
ali these. As object of external experience, speech is obviously
...
[40] The World As Will and Representation

It is reason speaking to reason that keeps within its province, and
...
tion that is its ground of knowledge. Now this of course can again be
...
relation to another representation of the sare class, but in the case
...
[42] The World As Will and Representation

not thought in the concept at all. Thus several representations
...
Telation every subject stands to its predicate. To recognize this
...
in perception, even according to their possibility, ie., a priori,
...
and that of Bisuica (ruminating and cloven-hoofed animals); like-
...
[44] The World As Will and Representation
...
The World As Will and Representation [45]

to load the memory with these rules, for logic can never be of
...
Tun contrary to its essence and nature. Hence arises the strange
...
stated by the rule, will always iook for a mistake in the rule rather
...
The World As Will and Representation [47 }

deduced by construction, The only practical use we can make of logic
...
scale of the culture of the times.1®
...
of ail debating, this procedure of reason itself always conforming to
...
[48] The Worid As Will and Representation

fixed canon of debate, to which it would always be necessary to look
...
quentia;*? and so on, That all this came about only slowly and very
...
Empiricus, Adversus Mathematicos, 1. 8, p. 112 seqg.)}. Aristotle
...
Opportunity ‘ : increasi
for ‘storing increasing \ increasing
oa $
...
The World As Will and Representation [49]

contained in another, which other is in turn wholly contained in the
...
and im accordance with our intentions, mainly in the following way.
...
rest unobserved, cr kecping them concealed. On this trick all the
arts of persuasion, all the more subtle sophisms, really depend; for
the logical sophisms, such as mentiens, velatus, cornutus,)® and so on,
...
concept-spheres in matiy ways overlap one another, and thus enable
...
others, to cach of which the persuasive talker can pass at will. These
...
maintain direction from the centre (the piven chief concept) to the
circumference, and not go backwards. The manner of clothing such

“uM “ying, veiled, horned {dilemmaj.” [Tr.]

Downloaded from https:/Awww.holybooks.com

[50] The Worid As Will and Representation

a sophistication in words can be continuous speech or even the strict
...
‘Cf. chap. 11 of valume 2.

Downloaded from https:/Awww.holybooks.com

The Worid As Will and Representation [41]

of the Jaw of causality and of that law’s connexion with those pure
...
ness is not @ concept, not abstract knowledge of reason. However, be
...
wrong, feelmg of truth, aesthetic feeling, feeling of power, weakness,
...
[52] The World As Will and Representation

knowledge of reason. But this becomes most striking when even a
...
demonstrate, since they would then fee! geometrical truth, before the
demonstration brought them complete knowledge. In the same way
F. Schleiermacher speaks in his Kritik der Sitteniehre of logical and
...
The World As Will and Representation [53}

its own method of procedure had not become clear to it through
...
knowledge of reason, is rational knowledge (Wissen), and 1 have just
...
know jn the abstract and in general what was known intuitively and
...
ceptions with abstract concepts, take those concepts as the puide of
...
[54] The Warld As Will and Representation
...
[56] The World As Will and Representation

different times and therefore needing a deliberate plan. Thus, for
...
undérstand physiognomy; this too must occur directly through the
understanding. We say that the expression, the meaning of the fea-
tures, can only be felz, that is to say, it cannot enter into abstract
concepts. Every person has his own immediate intuitive methad of
...
the concept cannot reach them. Hence abstract rational knowledge is
...
through them in art. If the singer or virtuoso wishes to puide his
...
science. In the third book we shail inquire more closely into the
...
put out of tune.” Al! dissimulation is the work of reflection, but it
cannot be kept up permanently and without interruption; nemo potest
personam diu ferre fictam,”! says Seneca in his book De Clementia;
...
“T am therefore of the opinion that the science of physiognomy cannot go
...
qualities, manifestations of the will, are to be rcad in the mouth and the lower
half of the face. Forehead and eye elucidate each other; cither of them
secn without the other can be only half understood. Genius is never without
...
the more beautiful a face is, because beauty, as fitness and appropriateness ta
...
=*No one can wear a mask for long.” “Dissimulation soon reverts to its
own nature,” [Tr.]
...
tight by the pure understanding, and at the same time prevents this
from being grasped, and if it produces irresolution, then it can easily
ruin everything.

Finally, virtue and holiness result not from refiection, but from the
...
work is to be completed in all its parts and rounded off to a whole.”

§ 13.

Au these considerations of the advantages, as well
...
The World As Will and Representation [59]

son and deliberate method, yet some are better achieved without their
...
in some relation; and Jaughter itself is just the expression of this
...
[60] The World As Will and Representation

respects stands out; this species of the ludicrous is called folly. There-
...
The World As Will and Representation [61}

from purely rational abstract maxims without any inclination or
...
of wit, the play upon words, the calernbour, the pun, to which can be
added the equivocation, ’équivoque, whose chief use is in the obscene
...
ject in Parerga (vol. II, chap. 6, § 96), p. 134 (first edition) 3

§ 14.

B, all these various considerations it is hoped
...
has been brought out quite clearly. Further, there have been also the
...
The Worid As Will and Representation [63]

concept-spheres of every science, in other words, the knowledge of
...
the scholastics** that, because the syllogism requires two premisses, no
...
* Suarez, Disputationes metaphysicae, disp. IE, sect. 3, tit, 3.

Downloaded from https:/Awww.holybooks.com

[64] The World As Will and Representation

the most universal to the particular through intermediate concepts
...
wholly @ priori nature, is there irrefutable certainty of knowledge.
...
The Worid As Will and Representation £653

healthy faculty of reason is able to deduce propositions from proposi-
tions, to demonstrate, to draw conclusions. On the other hand, to lay
down and fix in appropriate concepts for reftection what is known
...
ference, ail according to the purpose and consideration that actually
...
reflection rests on, and is rooted in, the world of perception. AH ulti-
mate, Le., original, evidence is one of intuitive perception, as the
...
reach only by chains of syilogisms; for example, the calculation of
the chords and tangents to all arcs by means of deductions from the

Downloaded from https:/Awww.holybooks.com

[66] The World As Will and Representation

theorem of Pythagoras. But even such a truth cannot rest essentially
...
reasoning, however truce the premisses may be, we shall never obtain
more than an elucidation and exposition of what already lics complete
in the premisses; thus we shall only explicitly expound what was
already implicitly understood thercin. By these esteemed sciences are
...
sity (ground of being) that affords @ priori certainty, and they can
...
distance; and finally we have the law of inertia, @ privri certain, be-
...
if | know the mass of a planet and the distance from it of its satellite,
...
planct, and prevents it from falling into it. Hence only on such a
...
The World As Will and Representation [67]

motion of the planets is known empirically, after many false hypothe-
...
mediately what is @ priori certain; this, as the form of all knowledge,
...
addition, T have found Kant’s proof to be false (as explained in the
...
in some undoubted truth as a part or a presupposition of jt. Thus,
for example, I have shown that all empirical perception implies the

Downloaded from https:/Awww.holybooks.com

[ 68} The World As Will and Representation

application of the law of causality. Hence knowledge of this is a
...
pendence on other propositions, and hence through syliogisms which
...
The World As Wiil and Representation {69 ]

vidual case immediate knowledge lies nearer at hand than derived
...
Nw if with our conviction that perception is the
...
I must now call to mind what J said in the sixth chapter of the essay
...
us a rational knowledge that a thing is as it is, but no rational know!l-
...
of cach other, in accordance with the form which the principle of
...
tradiction to admit that everything demonstrated by Euctid is so, but
we do not get to know wéy it is so. We therefore have almost the
...
When a preat error concerning life or science is pursued intentionally
and methodically, and is accompanied by universal assent, it is al-

Downloaded from https:/Awww.holybooks.com

The World As Will and Representation [71]

ways possible to demonstrate the reason for this in the philosophy
that prevails at the time. The Elcatics first discovered the diflerence,
indecd more often the antagonism, between the perceived, gawvéuevay,
and the conceived, voodpevov,2® and used it in many ways for their
...
broken in the water, and so on. Jt was recognized that perception
...
of perception (92voyevov}, and all the rest on syllogisms (voosuevoy).
...
Therefore only after two thousand years will Kant’s tcaching,
...
different from empirical perception, entircly independent of any
impression on the senses, conditioning this and not conditioned by
it, i.c., are @ priori, and hence not in any way exposed to sense-
...
We see that such a method is like a wanderer who, mistaking at
...
the principle of sufficient reason; here, as form of perception, ie.,
...
in the Posterior Analytics (1, 27}: ’Axpthestépa Vervstqun emoryung
Kat npotépa, Too xs tod Ort nat tod Sidc: y abstr, AAG wy yeoi¢
6tt, tHG too Bedct. (Subtilior autem et praestantior ea est scientia,
quad QUOD aliquid sit, et CUR sit una simuique intelligimus, non
separatim QUOD, et CUR sit.)?" In physics we are satisfied only
when the knowledge that something is thus is combined with the
knowledge why it is thus. Jt is no use for us to know that the
mercury in the Torricelljan tube stands at a height of thirty inches,
...
™*“But more accurate and preferable to mere knowledge is that knowledge
...
The World As Will and Representation [73]

conviction of that necessity, and of the dependence of that property
...
ground is given; and there is no reason or ground that docs not
...
just as good an expression of such a relation as is onc of the twelve
...
are cqually indemonstrable, immediately evident, and knowable
@ priori. Therefore, if anyone wishes to derive the necessity of
space-rclations, knowable in intuition or perception, from the
...
sumptions made in the proposition, or with an carlier proposition, or
...
even itsclf. But the axioms themselves have no more immediate
evidence than any other geometrical proposition has, but only
preater simplicity by their smaller content.
...
The World As Will and Representation [75]

that nature must be consistent everywhere, and therefore also in
...
satisfied with a mere historical knowledge that a thing ts as it is. But
...
(7+9) X8-2 ee ee er ‘
ee oe 42, but refer to pure intuition in time, to counting;
...
[76] The Werld As Wili and Representation

same smal] ones, an intuitive or perceptive evidence of every sum
...
indicated in this respect, such as /r-®, so that they are no longer
...
intuition @ priori. In fact, it is always this necessity, known from
...
by someone else, and then boasts that he himself killed him.?8
...
The World As Will and Representation {77]

equality of the sides is known as established through the equality of
...
latter kind of knowledge is always only induction, ie., from many
...
of many kinds brings the induction on which the hypathesis rests so
...
experience induction, i.c., knowledge of the ground from the
...
of the consequent from the ground, not indeed infinitely, but yet so
...
from innumerable cases to all cases, Le., in reality to the unknown
...
a problem how the person judging can really believe he has such
...
wide a concept, and should be replaced by sometimes or generaily.
...
(1) The illusion of the senses (deception of the understanding) cives
...
grey here and there passes through al! shades into white, the cause is
...
is evident from the truth of the premisses, Every explanation not?®
...
the character of every orginal force of nature. Every explanation of
...
example, weight is a qualitas occuita, for it can be thought away,
...
that “im Text selbst habe ich das ‘nich?’ nicht gestrichen, Es steht in allen von
Schopenhauer besorgien Ausgaben. Die Handschrift besitzen wir nicht. Ich
nehme an, dass es sich um einen Flichtigkeitsfehler Schopenhauers handeit,
wie sie Sfter bei ihm vorkommen....iIn diesem Faille scheint mir die
...
follows from the law of causality; hence a reference to this is a
...
and imdeed the principle of sufficient reason itself, to which the
...
[82] The World As Will and Representation

down as the basis and limit of their explanation is precisely the
...
but merely what the world is. But here the Way is subordinated to
...
not to be fost in an endless multitude of particular judgements, it
...
whole individual as weil as the universal must be known, and hence
...
The World As Will and Representation £83]

of knowledge is immediately the world itself in its entirety, without
excluding anything, and hence everything to be found in human
consciousness. It will be @ complete recapitulation, so to speak, a
...
(De Augmentis Scientiarum, |, 2, c. 13).8° However, we take this in
...
A ter fully considering reason as a special faculty
...
[84] The World As Will and Representation
...
@ certain extent, in time and for inner knowledge. But just as the
...
as to declare, after the example of Duns Scotus, knawledge of
...
The World As Will and Representation [85]

declared all common concepts to have arisen from the confusion of
what was known through perception (Ethics H, prop. 40, schol. 1).
