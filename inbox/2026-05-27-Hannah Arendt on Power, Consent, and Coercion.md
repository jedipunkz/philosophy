---
source: "https://philarchive.org/rec/PREHAO"
title: "Hannah Arendt on Power, Consent, and Coercion"
author: "Gail M. Presbey"
year: "1992"
publication: "The Acorn 7 (2):24-32 ( 1992 )"
download: "https://philarchive.org/archive/PREHAO"
pdf: "https://philpapers.org/archive/PREHAO.pdf"
captured_at: "2026-05-27T08:36:09Z"
updated_at: "2026-05-27T08:36:09Z"
...
- 著者: Gail M. Presbey
- 年: 1992
- 掲載情報: The Acorn 7 (2):24-32 ( 1992 )
- 情報源: [philarchive](https://philarchive.org/rec/PREHAO)
- ダウンロード: https://philarchive.org/archive/PREHAO
- PDF: https://philpapers.org/archive/PREHAO.pdf
...
Presbey, Gail M. (1992). Hannah Arendt on Power, Consent, and Coercion. The Acorn 7 (2):24-32.

## BibTeX

```bibtex
@article{Presbey1992-PREHAO,
	author = {Gail M. Presbey},
	doi = {10.5840/acorn1992/1993729},
	journal = {The Acorn},
	number = {2},
	pages = {24--32},
...
Archival history: Archival date: 2020-05-30 View all versions
Categories: Hannah Arendt in 20th Century Philosophy Peace in Social and Political Philosophy Political Theory in Social and Political Philosophy Propaganda in Philosophy of Language
Keywords: Applied Philosophy   General Interest   Social and Political Philosophy   Nonviolence
DOI: 10.5840/acorn1992/1993729
...
version of
“Hannah Arendt on Power, Consent, and
Coercion: Some Parallels
to Gandhi
,
”
...
The version of record appears in
The
Acorn: Journal of the GandhiKing Society
...
Users of the material shall give appropriate credit, provide a link to the license, and indicate if changes were
made. They may do so
in any reasonable manner, but not in any way that suggests the licensor endorses the
licensee or his/ her use.

Hannah Arendt on

Power, Consent, and Coercion:

Some Parallels to Gandhi
...
Abstract:
Although Hannah Arendt is not known as an advocate of
nonviolence per se, her analysis of power
dynamics within and between groups closely parallels Gandhi’s. The paper shows the extent to which her insights
are compatible with Gandhi’s and also defends her against charges that her description of the world is
...
violence and coercion will

ultimately fail, because the resort to violence implies an inability to gain free consent or
cooperation. Any gains from violence are temporary, since agents will express themselves freely as soon as force
is withdrawn. Arendt argues that dominating power s know this, and therefore rely on manipulation, propaganda,
and outright lies to win people’s consent, an analysis which can be used to explain some current social dynamics.

I. Introduction

I have noticed in my studies of Arendt and Gandhi a common
fascination for
...
power as the paradigm. Both share a conviction that power structures base d on
coercion and violence will be shortlived, doomed to fail. Both hold up their ideals of
(nonviolent) political or human interaction that many say are unrealistic. Yet both
admit that violence is prevalent in the world, while still insisting that their
...
use of terminology. I plan to highlight those links, as

well as to point out the
...
powerful grou p, and how do they relate to those outside of their group? How does
power sometimes switch from the agreement of a variety of creatively thinking
persons to the singlemindedness of a group following their fearless leader? What are

2

the dangers of this latt er way of building power? What happens when consent wanes,
...
result in a more powerful group than those groups

structured in hierarchies, using
...
Let's look at Arendt's views first, beginning with some of her terminology a nd
key concepts.

In her seminal work,
The Human Condition
, Arendt describes the human capacity
for action. Humans can initiate something new, bringing into being something that
had not existed before. On a physical plane, babies are born, and with each ba by
...
Ar endt calls "natality." (Arendt, 1958, pgs. 177
-
8, 246
-
7).
...
eyes) wanted to separate t hese two stages of action rather than emphasize their
...
many others were not qualified

at all to initiate, but only to carry through the ideas of
others (slaves, women, and noncitizens). In contrast to the split between those who
think and command on the one hand and those who obey without thinking on the
other, Arendt imagines as an ideal

an egalitarian society where all get to practice the
wider range of their skills. (Arendt, 1958, 189
-
90 and 220
-
1; 1968, p. 109.) She calls
such a political group an "isonomy" or "self rule," akin to a participatory democracy.

Arendt says that a commun ity of people who have come to an agreement on a
...
of many wills and intentions; power
is not something stable that can be "possessed."
However, a group can try to prolong the power realized in its first meeting by
continuing the group by mutual promise or contract. (Arendt, 1958, p. 244
-
5.)

Power arises from the people; domination, the con trol or coercion of the people
...
3, 152
-
3.) For Arendt "power and v iolence are opposites," since
power emerges when the threat of violence is not needed, for all freely consent to a
certain action and act of their own volition. (Arendt,
Crises
, p. 140, 155.)

Arendt preferred the word "power" to the word "nonviolence,"
...
connotations. For similar reasons, Gandhi coined the term
satyagraha
...
to emphasize the active aspect of nonviolence. (Arendt, 1972, p. 155; Gandhi,
1920/1961, p. 6, 51
-
2)
...
"power with
,
" that arises out of cooperation) with Max Weber'
s. For Weber, power is
...
model of goalattainment, based on the purposiverational actor. The

actor must have
the means to compel the other to the desired behavior. This idea is modeled on socalled "will power." Just as we try to make ourselves do what we want to do, so we
would like to make others do what we want them to do. In this scenario the re is no
qualitative difference between power and violence: violence is only a more extreme
means to attain one's end. (Habermas, 1977, p. 3
-
4)

Arendt finds a wide array of philosophers through the centuries who have held,
according to her, the same mista ken notion of power. C. Wright Mills called violence
...
obedience. All of these accounts are com pletely unsatisfactory for Arendt. (Arendt,
1972, p. 134
-
6.) The person that Weber describes, the purposiverational actor, is not
an "actor" at all in Arendt's sense, since he or she is not involved in sincere speech
and interactions with peers, but rathe r treats others as raw material to be made into a
preset plan. To treat people in this way is always an act of violence.

III. Analysis and Critique

Perhaps at this point the links in views between Arendt and Gandhi are becoming
apparent. Both hold up a s a paradigm for political action an egalitarian and
...
violence is selfdefeating and
impractical. Now, are these views just nice dreams? Or
...
what kind of claims Arendt is mak ing. I will also critique her on a few points.

A. Internal Power Structure

1. The Role of Equal Sharing and Initiative

In Contrast to Rulers and the Ruled
...
a list of rules whi ch they author themselves and freely agree to obey. They are a selfgoverning body, both giving orders and following the orders they give themselves.
There is no need for coercion or violence, since each is motivated to follow the
agreement in which they p articipated. They get their power, specifically, from the fact
...
minds of many indep endent thinkers, set about seeing any topic from a multiplicity of

4

views, will ensure a more balanced decision on the part of the group. (Arendt, 1965,
167, 173.) Although unity is necessary, Arendt insists in
The Human Condition

that
unity must be based
on a plurality of unique thinkers. (Arendt, 1958, 175
-
6; 1965,
227.)
...
group can be powerfu l without being diverse. A group of likeminded people ("the
masses" as Arendt calls them in
Origins of Totalitarianism
), or a group of nonthinking followers blindly obeying a leader, could as well "act in concert" without any
of the safeguards of variety

that Arendt insists upon. I suggest that Arendt could call
...
However, it could be argued, does not the phrase "act

in concert" refer to, in fact
...
concerts are based on individual instruments taking
their orders from the composer
...
viewpoints (perhaps considering them irrelevant), and ag ree to a common plan, then
...
the group wil l guarantee a greater degree of cooperation with the plan, and therefore,
...
outcome; perhaps some one who is involved in drafting the group's proposal is most
...
willing to accept the work plan of
...
the more fulfilling, since the person is exercising all their capacities
—
in oth er words,
...
p erson engaged in political action is more fulfilled. But that may not be how it is
...
member of the Nation of Islam and conside red himself nothing more than the
...
with his own ideas and put these ideas to action in a new com munity, we could say
...
community, he announced, was ready to dialogue with other community leaders a nd
...
for t he Nation (in the mode of "obedient follower") obviously made the Nation more
powerful.
...
es say "On Violence" and her book
On Revolution
) she often focuses only on two
...
1965, pg s. 247
-
8; 1972, p. 155). At other places in her work she addresses the reality
of popular tyrants (Arendt, 1958, p. 203): certainly Hitler's Nazi Germany is one main
example. As she explains in
Origins of Totalitarianism,

Hitler is made powerful by
the sup port and cooperation of a fuzzythinking mass of conforming people. (Arendt,
1951, pgs. 308, 311
-
14; 1972, p. 143.)
...
extent to which group membe rs are treated equally, informed accurately, and allowed
...
result of dialogue between equ als. The opposite extreme is physical constraint and
...
between the two extremes. Following a re the categories along with brief descriptions:

1) Free Consent:
Based on reason, community members hearing all sides of
the story, having access to accurate information, persuasion through best
argument.

2) Strategy, Manipulation:
Playing on people's emotions to get them to act
irrationally, against their own or others' best interests.

3) Propaganda and Lies:

The community is subject to misinformation that
hinders their abilities to make rational choices.
Winning the people's
consent through misleading them.

4) Coercion, Threats of Violence
: Threats of jail, torture, or death; lifethreatening economic sanctions.

5) Physical Constraint, Violence
: Regardless of the person's lack of consent,
they are forced

bodily to obey orders or are killed.
...
Let me explain in more detail the many different gradations of group consent and
coercion. On one extre me is Arendt's ideal, our first category, which calls for group
...
most clearly guaranteed; since ea ch member can voice dissent and affect the final
...
not easily
reconciled. The group needs unity of result; a group divided in plan and
...
be part of po litical action, but Arendt does not want such actions called "political"
...
ended. (Arendt, 1958, 180,
200.) But in this way, the group's unity, and therefore
...
more p owerful, decides to influence the actions of others by giving them faulty
...
actions o n what they know. However, we can say that unbeknownst to them, they
have been controlled by the group that has lied to them. As Plato explained thousands
of years ago in the
Republic
, this view can be rationalized as being more humane than
overt violence;

it is also more practical, because the "controlled" people move of their
own volition, and so save the controllers the effort of having to move them against
their will. (Arendt, 1968, p. 229.)

The fourth and fifth stages leave the realm of free actions a nd consent and enter
...
and yet is compelled to do so. The fourth, coercion, involves
threat of violence: if one
...
government comes to draft you into an unjust war, and threatens to
kill you if you will
...
that your choice here is so limited that it counts as "freedo m" only in the most
restricted sense.
...
and it is easier for them because people do what
they're told under their own volition.
However, resisters grab onto that little bit of freedom left to them. Overcoming their

7

fear, they are not cowed by the threats. They refuse to go along, suffering the
consequences. Often the dominating power is not pr epared to carry out the threats; or
...
example to others. For Arendt, this is the height of impotence; it shows the group o r
...
difficult, consuming time and labor. For living subjects, violence rarely exist s in its
...
eat, and work. It even depends on them, in some cases, to walk to their own
...
(Arendt, 1950, pgs. 50
-
1, 54.) Nonviolent resisters challenge the dominator
to
...
what we want, or you'll have to lock us all up," the dominators must weigh, how
...
As regards this continuum, I think

Arendt has an important point. As long as
people continue to consent, and to act freely so as to give their energies to the
government, that government will become more powerful. So, categories 1
-
3 are the
locus of powerful governments. However, Arendt n otes, governments 4 and 5 are
...
continuum, does this mean that the government based on
...
having their lies unmasked, th ereby losing power. She expresses a confidence about
...
1972, 18
-
19.) I suggest, once ag ain, that it is difficult to compare, across the board,
...
Nazi Germany, and their plan t o exterminate the Jews was based on the Nazi party's
...
Jewish Council members were

told that if they only cooperated, the Nazis would be

8

more humane and spare some people; the people rounded up for the camps were told
that if only they boarded the trains cooperatively, they would be better treated.
Because of these lies, the massive pow er of the Jewish people was mobilized,
...
Arendt herself does some wishful thinking about the Jews during Wor ld War II: if
...
against them (as well as the lies they were told), and therefore their freedom
and
power was severely limited. Yet in
Eichmann in Jerusalem
, Arendt quotes R. Pendorf:
...
of fices, to liquidate many hundreds of thousands of other people." (Arendt, 1963, p.
...
Jewish lea dership, and that leadership cooperated with the Nazis.
...
Jewish Councils. This calcula tion is based on the fact that in Holland, where there was
total cooperation with the Nazis, only 519 of 103,000 Jews survived. In contrast, of
the 20,000
-
25,000 Jews who escaped the Nazis and went underground to survive, 40
-
45% were saved. (Arendt, 1963,
p. 125.) The fact that the Nazis were not as
...
government; withdrawal of consent takes its power
...
), Gandhi asserts that if he were a Jew, he would challenge the
...
look clo ser, we can see she is making important distinctions. She thought that through
noncooperation Jews could save more of their own lives. But she did not imagine a
Gandhistyle "baring of the neck" vulnerability ritual (see also 1921/1961, p. 57),
where Jews
would gather in public and dare the Nazis to shoot them down or
...
have no qualms about destroying whole populations. (Arendt,
1951, p. 310; 1972, p. 152.) She suggests that the Jews, knowing their oppressors,
should engage in noncooperation by going underground and fleeing. She was more
confident of German Gentiles' ab ility to do a Gandhistyle protest since the Germans
would be more hesitant to massacre their own. She cites with excitement the protest of
German nonJewish wives of Jewish husbands, who surrounded a prison and
successfully demanded the release of their h usbands. (Arendt, 1963)

9

B. Can Violence Be Powerful?
...
not descriptiv e of our world as it is, but is instead normative and supportive of radical
...
of the existi ng rulers. (Habermas, 1977, pgs. 7, 9; Luban, 1979, p. 82.) Still, how can
...
everyday usage of the term, in which domination and violence are
considered examples of great power?

I suggest that Arendt's view gets at the heart of the political situation and aptly

describes the world as it is. She is not just spinning a fairy tale.
To recap: Arendt sees
...
Mohandas Gandhi. How does a single leader become powerful? When the peopl e, the
...
and people together, are powerful. This is an example of "power with." They
are
...
continuing power. Sharp points this out in
The Politics of Nonviolent Action
: the
govern ment may seem to form a "monolith" that towers above and rules the people,
leaving them powerless. However, this monolith is a mirage. Without the cooperation
of the people, the monolith would crumble.

Arendt herself makes a distinction between "leaders a nd followers" and "rulers
...
source of the leader's power, and they are aware tha t the leader is dependent on them.
...
the source of the ruler's power. They experience thems elves as powerless, able only to
follow orders. (Arendt, 1958, 189
-
90.) In such a situation, of course, resentment can
...
suffering under him, they can learn that if they withdraw their support, the
...
empowers peopl e, in contrast to Weber's view, which makes the tyrants seemingly
invulnerable. (Arendt, 1965, p. 228.) Arendt's insight explains why popular revolts
against materially strong rulers are often successful. (Arendt, 1958, p. 200
-
1). Arendt
refers to Gandhi's

experiments with noncooperation as "enormously powerful" and a
"successful strategy." (Arendt, 1972, p. 152.)

10

Gandhi saw his role as educating his fellow Indians that British rule in India
could exist only so long as the millions of Indians cooperated
...
described before, comes the added cost of repressive measu res as well as the scrutiny
...
uprising
; they decide the bill to pay for subjugation is not too high. (Arendt, 1972, p.
152.) In fact every day we see countries around the world where rulers decide they
can "afford" to crush resistance. It could be argued,
contra

Arendt, that it is not at all
a pparent that the most violent governments are losing power: they seem to be more
entrenched than ever!

Let me suggest that most "successful" repressive governments do have a power
base somewhere: perhaps it is a minority of the population; perhaps it is m erely the
...
domination in itself that is generating power; that is the fruit, although it is the
...
isolated, unorganized, and
unwilling or unable to converse and plan with each other.
...
Arendt described the uprising of F
rench students in 1968 as such a phenomenon.
...
disaffected; so Castro's small band of revolution aries toppled them and took over. The
...
Well, this same dynamic of the s mall organized group controlling the larger
...
including government officials, military and po lice, is united in vision and coordinates
...
where the military sends scattering the elected off icials. (Certainly, by the way,
...
group, however larg e or small, that is acting in concert; the act of domination itself is
not a source of power, but a challenge to power, or a drain on power, or a sign of that

11

power's limitation. I think that this is what Arendt means when she says that
domination and viol ence are signs of impotence. "Power over" is perhaps a shorthand
...
it can be challenged; groups can split up, their members
...
have their changes as well.
Arendt herself admits that her paradigmatic councils and
soviets are often the most shortlived of power groups. (Arendt, 1965, pgs. 262
-
3.) I
think it is hard to categorize one or the other group as being more stable. Certain
groups provide more satisfact ion to their members than others, and so have a more
...
neither is invinci ble. Arendt sums up this contrast of weaknesses by saying that
...
material prerequisite: fo r people to gather together in a space; and one communicative
...
materially, through scatter ing people with gunfire; applying a curfew where people
...
alternative presses; also through s pies and informers who will turn over to the
government anyone saying something unfavorable to the government or anyone
involved in any disallowed political activity. (Arendt, 1958, p. 200
-
1; 1972, p. 154.)
It is no use denying that superior weapons of vi olence can obliterate any group, no
...
What can violence accomplish? Violence can c oerce people into obeying orders.
...
agree with a position or policy with which they don't want
to agree. It can influence
...
their former behavior. Although a violent group can destroy othe r power groups, it
...
C. Powerful Gr oups and External Relations
...
structure of the group must have some fairness involved, since
the people must
...
there is nothing to prevent a group from talking amongst itself and deci ding to destroy
...
(Arendt, 1958, pgs. 198
-
9.) Likewise revolutionary groups and resistance g roups (like
...
deciding t o combat the government's propaganda, wooing away the government's
...
each other internally: through dialogue, listening, and co ming to a common agreement
amongst themselves. Arendt calls this the "combination of powers" and sees this as
the basis of the federal system. (Arendt, 1965, 168
-
9.) This is the theory behind a
federal government like that in the U.S., based upon many powe rful states. Rather
...
they become more powerful. This same idea is behind the "fede ration of nations" that
Kant describes in his essay "Perpetual Peace." (Kant, 1789, p. 115
-
8.) Once again,
power is in its fullest fruition when dialogue and agreement are at its center.

However, groups and nations have many options of how they are to rel ate to each
...
groups. A country that must resort to military takeover of its neighbor sho ws that
...
violence win the consent of the other, and therefore it cannot harness the power of t he
...
I have already mentioned ma ny of the parallels to Gandhi during the paper.
...
Gandhi and Arendt. Gandhi was very insiste nt in his satyagraha actions that his
...
than, say, Gene Sharp is. Gandhi was concerned that

coercion could only bring a
...
Gandhi was more interested in the more permanent change that

could take place when

13

the opponent's heart was changed. That, he felt, was reform that could be depended
upon. This issue is dealt with very well and indepth by Joan Bondurant in her book,
Conquest of Violence: The Gandhian Philosophy of Conflict.

(Bondu rant, 1958, p. 9
-
11.) Bondurant adds the distinction that there is nonviolent moral coercion present in
Gandhi's satyagraha actions; but this is very different in character than coercion based
on physical threat.

I think this last point of Gandhi's is
very much in the spirit of Arendt. It
emphasizes the shortcomings of coercion and violence. It shows the importance of
dialogue and agreement.

References

Arendt, Hannah. (1950) "Social Science Techniques and the Study of Concentration
Camps,"
Jewish Social
...
in Jerusalem.
New York: Penguin, reprinted 1984.

Arendt, Hannah. (1965)
On Revolution.
New York: Viking Compass Edition; reprint,
New York: Penguin Books, 1985.

Arendt, Hannah. (1968)
Between Past and Future: Eight Exercises in Political
Thought.
Enlarged Edition. New York: Viking Compass Edition, 1968; reprint,
New York: Penguin Books, 1985.
...
Princeton Univ. Press. Reprinted in 1967 by Berkeley: Univ. of Calif. Press.

Gandhi, Mohandas K. (1961)
Nonviolent Resistance.
New York: Schocken Books.

Haberrnas, Jurgen
. (1977) "Hannah Arendt's Communications Concept of Power,"
Social Research
44, no. 1 (Sp ring
)

Kant, Immanuel. (1789) "Perpetual Peace," in
Perpetual Peace and Other Essays,
Indianapolis: Hackett, 1983.

Luban, David. (1979) "Habermas on Arendt on Power,"
