---
source: "https://archive.org/details/worksofaristotle0000wdro_f0a6"
title: "THE WORKS OF ARISTOTLE TRANSLATED INTO ENGLISH UNDER THE EDITORSHIP"
author: "W.D. ROSS"
year: "1921"
captured_at: "2026-08-10T13:24:53Z"
updated_at: "2026-08-10T13:24:53Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "アリストテレス"
query: "Aristotle"
plain_text_url: "https://archive.org/download/worksofaristotle0000wdro_f0a6/worksofaristotle0000wdro_f0a6_djvu.txt"
public_domain: true
...
- 著者: W.D. ROSS
- 初版: 1921
- 情報源: [archive](https://archive.org/details/worksofaristotle0000wdro_f0a6)
- パブリックドメイン: ✓
...
however, on the Polztics sincehis translation was published
...
ce. 1, 2. Definition and structure of the State.
...
It consists of villages which consist of households. The house-
...
But we do not need that form of finance which accumulates
...
Also in their subject-matter; for natural Snes is only con-
cerned with the fruits of the earth and animals.

Natural finance is necessary to the householder; he must there-
...
Lastly, we must discuss and distinguish the relations of husband
to wife, of father to child.

. In household management persons call for more attention than
...
BOOK IT:
1-8. Ldeal Commonwealths—Flato, Phaleas, Hippodamus.

To ascertain the nature of the ideal state we should start by
...
But the end which he has in view is wrong. He wishes to
...
. And the means by which he would promote unity are wrong.
...
To descend to details. The advantages to be expected from
...
always been against Plato, and experiment would show that 7

his idea is impracticable.

6. Plato sketched another ideal state in the Laws; it was meant
...
g. The Spartans cannot manage their serf population. Their
...
and in theassembly. But it is hard to find a definition which
...
man is one who is fitted to rule. But the citizen ina con-
...
circumstances oblige them to dothis. They have no choice.

cc. 6-13. Zhe Classification of Constitutions ; Democracy and
Oligarchy ; Kingship.
...
7. Constitutions are bad or good according as the common welfare
...
to. On the same principle, Justice is not the will of the majority or
...
equals? Obviously those who areequally able to be
...
cc- 14-18. Zhe Forms of Monarchy.
...
. Political science should study (1) the ideal state, (2) those states
...
been discussed (cf. Bk. III, c. 14 fol.). Let us begin by
...
Of Aristocracy in the strict sense there is but one form, that in
...
. There are different ways of effecting the compromise which

makes a Polity. The Laconian Constitution is an example
of a successful compromise.

Tyranny is of three kinds: (1) the barbarian despotism, and
...
11-13. Of the Best State both in general and under special
circumstances.

For the average city-state the best constitution will be a mean
...
were aided by the influence of the leading states.
...
15. (6) The Executive. Here he must know what offices are in-
...
5. (2) In Democracies revolutions may arise from a persecution
of the rich; or when a demagogue becomes a general, or
when politicians compete for the favour of the mob.

6. (4) In Oligarchies the people may rebel against oppression ;
...
g. In all magistrates we should require loyalty, ability, and justice ;
we should not carry the principle of the constitution to
extremes; we should educate the citizens in the spirit of'a
constitution. ;

10. (2) The causes which destroy and the means which preserve
...
dividing its subjects, or it may imitate Kingship by showing a
...
Plato’s discussion of revolutions in the Aepudblic is inade-
...
1. (A) Democracies differ zzfer se (1) according to the character
...
of offices is important. Some kinds of officé are necessary
in every state; others are peculiar to special types of state.

BOOK VII (IV).

cc. 1-3. Zhe Summum Bonum for tndividuals and states.

1. Before constructing the ideal state we must know what is the
...
be equipped with external goods asinstruments. These laws
hold good of both states and individuals.

2. But does the highest virtue consist in contemplation or in action?
...
g. But of these classes we should exclude from the citizen body
...
to pursue. Happiness was defined in the £7¢Aics as the
perfect exercise of virtue, the latter term being understood
not in the conditional, but in the absolute sense. Now aman
...
cc. 1-7. The Ldeal Education continued. Its Music and
Gymnastic.

. Education should be under state-control and the same for all

the citizens.

. It should comprise those useful studies which every one must

master, but none which degrade the mind or body.

. Reading, writing, and drawing have always been taught on the
...
. Music, if it were.a mere amusement, should not be taught to

children ; they would do better by listening to professionals.
But music is a moral discipline and a rational enjoyment.

. By learning music children become better critics and are given
...
. The various musical harmonies shouldbe used for different
...
1 EVERY state isa community of some kind, and every 1252
...
matter according to the method? which has hitherto
...
1 Cp. Plato, Politicus, 258 E-259 D. PeGpy t25622,
...
and origin, whether a state or anything else, will obtain
...
behind them an image of themselves), and of natural ruler
...
interest. Now nature has distinguished between the
female and theslave. For she is not niggardly, like the
...
many uses. But among barbarians no distinction is made
...
master and slave, the first thing to arise is the family,
...
* Eurip. /phig. in Aul. 1400. 2 Of. e¢ Di. 405.
_* Or, reading in 1. 15 with some MSS. and the old translator
(William of Moerbeke) opoxarvous, ‘companions of the hearth’,
...
were originally governed by kings; because the Hellenes
...
1 Od. ix. 114, quoted by Plato, Laws, iii. 680 B, and in WV. 7h,
x. 1180 28,
2 T1, ix. 63.
...
just and the unjust. And it is a characteristic of man
...
body bé destroyed, there will be no foot or hand, except
...
have the same_name. The proof that the state is a
...
implanted in all men by nature, and yet he who first
...
management correspond to the persons who compose the 1253”
...
ought to be:—I mean the relation of master and servant, 1°
the marriage relation (the conjunction of man and wife
has no name of its own), and thirdly, the procreative
relation? (this also has no proper name). And there is
...
I was saying at the outset,’ are all the same. Others :
...
1 Cp. WV. Eth. v. 1134* 31. ;
* Reading rexvoroutixy in 1. 10 with the MSS.
8 Plato in Pol. 258 E-259 D, referred to already in 1252* 7-106.
...
Property is a part of the household, and the art 4 q

of acquiring property*is a part of the art of managing
the household ; for no man can live well, or indeed live 5
a5 at all, unless he be provided with necessaries. And as .
...
a household.1_ Now instruments are of various sorts;
...
1254° Here, however, another distinction must be drawn: the in-
...
i «
Retaining oUT@ Kal T® oikovouik@ in |. 27, and omitting re
OLKOVOLLKD in |. 3I.
...
is spoken of as a pait is spoken of; for the part is not
...
nature and office of a slave; lie who is by nature not his
...
(and that rule is the better which is exercised over 2;
...
and another is ruled, they may be said to have a werk) ;
...
or corrupted natures the body will often appear to rule
...
even apprehend a principle ;* they obey their instincts.
And indeed the use made of slaves and of tame animals
is not very different; for both with their bodies minister
to the needs of life. Nature would like to distinguish
between the bodies of freemen and slaves, making the

' Reading dcakewrar 6€ rodrov in 1. 17, with the ‘old translation’
and some MSS.
? Reading Adyou in 1. 23 with some MSS.
...
_the statues of the Gods do from men, all would acknow- 35
...
simply one about justice (for it is due to one party iden-
tifying 1 justice with goodwill,” while the other identifies

on

1 No thoroughly satisfactory explanation has been given for
Sua todro, 1. 17, and it appears better to read dia yap ro... edvoray
(or ev evvoia) Ookely.

2 i.e. mutual goodwill, which is held to be incompatible with the
relation of mastér and slave. :
...
thus set out separately, the other views! have no force

a0 or plausibility against the view that the superior in virtue
...
be unjust? And again, no one would ever say that he isa
slave who is unworthy to bea slave. Were this the case,
...
in using this language, they really mean the natural slave
of whom we spoke at first ;? for it must be admitted that
...
and slavery, noble and humble birth, by the two
principles of good and evil? They think that as men
...
difference of opinion, and that all are not either slaves
by nature or freemen by nature, and also that there is
in some cases a marked distinction between the two

* i.e, those stated in Il. 5-12, that the stronger always has, and that
he never has, a right to enslave the weaker. Aristotle finds that these
views Cannot maintain themselves against his intermediate view,

that the superior in vér¢ve should rule.
A Cinkzios 5 - § Helena, fr. 3, Nauck?.
...
lordship which nature intended them tohave. The abuse
of this authority is injurious to both; for the interests of
part and whole, of body and soul, are the same, and the 10
...
and have a common interest, but where it rests merely _
...
affirm, the same with each other.* For there is one rule
...
duties. And such a knowledge may be carried further,
so as to include cookery and similar menial arts. For
some duties ate of the more necessary, others of the
more honourable sort ; as the proverb says, ‘slave before
slave, master before master ’.* But all such branches of 30
...
2 Plato, Polzt. 258 E-259 D, referred to already in 1252 7-16,
1253 18-20.

ES GUZEN 25 OC 293) Cs
...
a species of hunting or war.!_ Enough of the distinction
40 between master and slave.

1256% Let us now inquire into property generally, and into 8
the art of getting wealth, in accordance with our usual
method,? for a slave has been shown ® to be a part of
...
1o bronze of the statuary. Now it is ‘easy to see that the
...
is art. Ifthe getter of wealth has to consider whence wealth
and property can be procured, but there are many sorts
of property and riches,* then are husbandry, and the
care and provision of food in general, parts of the wealth-
getting art® or distinct arts? Again, there are many

or

1 Cp. vii. 1333 38.
* Of understanding the whole by the part, cp. 12522 17.
5 Chap. 4. * Reading a comma after éora in |. 16.
* Reading ris ypnpatiorixys in |. 17 with the MSS.
‘

BOOK I. 8

sorts of food, and therefore there are many kinds of lives
both of animals and men; they must all have food, and
...
ous or herbivorous or omnivorous: and their habits are
...
animals further differ among themselves. In the lives
...
sort of living farm. Others support themselves by hunt-
...
and whose food is not acquired by exchange and retail 1256”
...
a shepherd may be combined with that of a brigand, the
...
when they are first born, and when they are grown up. 10
...
15 selves, which is called milk. In like manner we may
...
40 There is another variety of the art of acquisition which g
‘is commonly and rightly called an art of wealth-getting,
* Cp. 1255” 38, 1333°38. The brackets round # yap Onpeutixr

Hépos avris in |. 23 should be removed.
> Bergk, Poet. Lyr.*, Solon, 13. 71.

BOOK I. 9 1257*

and has in fact suggested the notion that riches and 12573
...
came into use. For the various necessaries of life are
...
weight, but in process of time they put a stamp upon it,
...
Originating in the use of coin, the art of getting wealth
...
trade are concerned with coin. Others maintain that
...
a man may have a great abundance and yet perish with
...
wealth-getting. As in the art of medicine there is no 25
...
other hand, has a limit?; the unlimited acquisition of
...
case, but there is a further end inthe other. Hence some
...
money without limit, or at any rate not to lose it. The 40
origin of this disposition in men is that they are intent
upon living only, and not upon living well; and, as their 1258°
...
S Cpa256 32.
2 Reading ad’ for ov in |. 30, with Bernays.
GA5-17 C
...
tion,| Whether the art of getting wealth is the business
...
what remains over of that from which it is produced.!
...
one isa part of household management, the other is retail
trade : the former necessary and honourable, while that 4°
which consists in exchange is justly censured ; for it 1258”
...
interest. And this term interest,? which means the 5
birth of money from money, is applied ¢o the breeding
of money because the offspring resembles the parent.
Wherefore of all modes of getting wealth this is the
most unnatural.

Enough has been said about the theory of wealth-
...
and irksome.* The useful parts of wealth-getting are,
...
Le Cowmi2 50> Onmcnt 250° 15 1250515. 3 rdkos, lit. ‘ offspring ’.
4 Or, ‘We are free to speculate about them, but in practice we
are limited by circumstances.’ (Bernays.)
...
20 Thesé are the divisions of the true or proper art of
...
Those occupations are most truly arts in which there
...
4o various persons ; for example, by Chares the Parian, and
...
were wanted all at once and of a sudden, he let them
...
device for getting wealth is of universal application, and
...
‘out much increasing the price he gained 260 per cent.
...
Of household management we have seen' that there
...
which has been discussed already,! another of a father,
and the third of a husband. A husband and father, we
4o saw, rules over wife and children, both free, but the rule
differs, the rule over his children being a royal, over his
1259” wife a constitutional rule. For although there may be
...
zrule and are ruled by turns, for the idea of a con-
...
but he should be of the same kin or kind with them,
...
25 slaves possess only bodily and ministerial qualities. And, 4

1 1253" 14-1255? 39. 2 Cp. ii. 1261 30, iii, 1288 12.
5 Herod. ii. 172.
...
soul! has shown us the way; in it one part naturally rules,
...
applies generally, and therefore alfnost all things rule and
...
or the man over the child; although the parts of the soul ro
...
1 Reading (ra) wept rnv Wuyxny in |. 4 with Schiitz.
2 Or, with Bernays, ‘inconclusive’.

1260* S PORTIICS

1s supposed to be with the moral virtues also; all should
...
a man and of a woman, are not, as Socrates maintained,}
...
2s detail, for those who say generally that virtue consists 3
...
4o two cases? For the slave shares in his master’s life;
...
: Plato, Meno, 72 A-73 C. * Meno, 71 ©, 72 A.
8 Soph. 47. 293. * 1254> 16-39, cf. 1259? 25 sq.

BOOK L. 3

1260?

The meaner sort of mechanic has a special and separate 1260°
...
ship which trains the slave in his duties.1 Wherefore
they are mistaken who forbid us to converse with slaves
and say that we should employ command only,” for slaves
...
tp. 1255" 23, 31-35; 2 Plato, Laws, vi. 777 E.
: The question is not actually discussed in the Polz¢zcs.
5

Cp. v. 13108 12-36, vill. 1337% 11-18.
Plato, Laws, vi. 781 A.
...
OUR purpose is to consider what form of politicalI —
...
We will begin with the natural beginning of the sinjeee
...
40impossible, for the constitution is a community, and

1261* must at any rate have a common place—one city will be
in one place, and the citizens are those who share in that
...
poses in the Republic of Plato.t Which is better, our
...
* Rep. iv. 423 E, Vs 457 C, 462 B.
* Reading in 1, 14 dueXety, with good MS. authority.
...
from being a state, it becomes a family, and from being
...
constitute a state. Itis not likea military alliance. The 25
...
compensation,’ as I have already remarked in the
Ethics, is the salvation of states. Even among freemen
...
since it is better® that this should be so in politics as !
well, it is clear that while there should be continuance of the |
same persons in power where this is possible, yet where |
this is not possible by reason of the natural equality 1261”
|

’

of the citizens, and‘ at the same time it is just that

1 Or, ‘reciprocal proportion’. PUN than 113200327
3 Omitting the brackets in * 37, 4, and the marks of a lacuna
ita Er

4 Reading in |, 1 dua dé with the MSS.

1261" a POLITIC

all should share in the government (whether to govern be
a good thing or a bad 1), an approximation to this is that
equals should in turn retire from office and should, apart
from official position, be treated alike.* Thus the one
...
some persons affirm ; and that what issaid tobe the greatest
good of cities isin reality their destruction ; but surely
...
of time’, which, according to Socrates,* is the sign of

20 perfect unity ina state. For the word “all’ isambiguous.
If the meaning be that every individual says ‘mine’ and
‘not mine’ at the same time, then perhaps the result at
which Socrates aimsmay be in somedegree accomplished ;
...
common; they would say ‘all’ but not ‘each’. In like
...
, Cp. Pl. Rep. i. 345-6. 2 Cp. i. 1259>4, iii. 12887 12.
Cp. Pl. Rep. i. 353. * Pl. Red. v. 462 C.

BOOK IL. 3 1261”

argument becomes a source of logical puzzles. That all 30
...
same person is called by one man his own son whom to
...
the ground of their likeness... And some women, like
...
2, Other evils, against which it is not easy for the authors 4
...
strange it is that Socrates,® after having made the
...
4o This community oft wives and children seems better
suited to the husbandmen than to the guardians, for if

1262” they have wives and children in common, they will be
bound to one another by weaker ties, as a subject class
should be, and they will remain obedient and not rebel.+
In a word, the result of such a law would be just the

5 Opposite of that which good laws ought to have, and the
intention of Socrates in making these regulations about a

1 Cp. Herod. iv. 180. > Cp. Hist. Anim. vii. 586° 13.
8 Rep. iii. 403 A-C. * Cp. vii. 1330 28.
...
these names will be lost ; there is no reason why the so-
...
from the rank of husbandmen or of artisans to that of 2
...
therefore, be afraid of committing any crimes by reason
of consanguinity. Touching the community of wives
and children, let this be our conclusion.

ING puVe ef, Vill. 1155222. AS site
SSW. TOUN, LO2ic.- )*- Cp) C2350 > rep. il..415 B.%: § 425-40.
...
4o have their possessions in common or not? This question

may be discussed separately from the enactments about

12637 women and children. Even supposing that the women
...
among certain barbarians. Or (3), the soil and the

produce may be alike common.

When the husbandmen are not the owners, the case

to will be different and easier to deal with ; but when they
...
15 labour littleandreceiveor consumemuch. But indeed there
...
trifle which turns up. So with servants: we are most
...
' Reading in 1. 23 €xeu emxoopnbey eect, with some good MSS,

BOOK IL 5 . 1263%

common, but, as a general rule, private; for, when every

one has a distinct interest,’ men will not complain of one
...
as the proverb says, ‘ will have allthings common.’? Even 3°
...
they find? in the fields throughout the country. It is
...
man feels a thing to be his own ; for surely the love of self *
...
visibly annihilated in sucha state: first,temperancetowards
...
1 Cp. Ref, ii. 374. > Cp. Rep. iv. 424 A.
% Reading (rots) ev rots dypots, with Vahlen.
(Cio, AAG VOL: bis tek
...
which he starts.2 Unity there should be, both of the
family and of the state, but in some respects only. For
there is a point at which a state may attain sucha degree
...
saying, is a plurality,* which should be united and made
...
4o or by customs and laws, like those which prevail at
...
: Cp. WV. Eth. iv. L119» 22, > Rep. v. 464, 465.
“CpG 2. = Cp 1261206;

ppOOKe ht. 5

of ages; in the multitude of years these things, if they
...
do not use the knowledge which they have. Great light
...
all this legislation ends only in forbidding agriculture to
...
property in common? Or is each individual to have his
...
Must it not contain two states in one,! each hostile to 2
...
and quarrels, and all the evils which Socrates affirms ” to
exist in other states, will exist equally among them.

He says indeed that, having so good an education, the ;

citizens will not need many laws, for example laws about

' Cp. Ref. iv. 422 E. * Rep. v. 464, 465,
D 2
...
the city or about the markets;! but then he confines
his education to the guardians. Again, he makes the hus-
bandmen owners of the property upon condition of their
paying a tribute.” But in that case they are likely to
be much more unmanageable and conceited than the
35 Helots, or Penestae, or slaves in general.? And whether
...
nor is their character * of small importance if the common
40 life of the guardians is to be maintained.

1264” Again, if Socrates makes the women common, and
...
should follow the same-pursuits,® for animals have not to
managea household. The government, too, as constituted
...
iomore among high-spirited warriors? But that the
...
legislator ought to make the whole state happy.” But
the whole cannot be happy unless most, or all, or some
of its parts enjoy happiness. In this respect happiness

' Rep. iv. 425 D. > Rep. v. 464 C.
* Cp. 1269% 36. 4 Reading zo.ovs twas in 1. 39 with some MSS.
Cpu AeZaVer4 51D: ® Cp. Rep. iii. 415 A.

T Rep. iv. 419, 420. ® Cp. vil. 1329923.
...
is not like the even principle in numbers, which may 20
...
difficulties, and others quite as great. *5
...
* a few questions only ; such as the community of women 30
...
digressions foreign to the main subject, and with so
discussions about the education of the guardians. In the 1265*
...
exception of the community of women and property, he
...
ommon meals in both. The only difference is that in
the Laws, the common meals are extended to women,‘
and the warriors number 5000,’ but in the Republic
only 1000."

La]

' Rep. ii. 373 E. 7 Rep. iti 412 B. ; Rep. v. 451 bk.
+ Laws, vi. 780 i. b* LQws, V. 737 Es > Rep. iv. 423, A
...
20 But neighbouring countries also must not be forgotten
by him,? firstly because the state for which he legislates
is to have a political. and not an isolated lifes. For
...
to be the best, either for individuals or states,” still a city
...
which is only away of saying ‘to live well’; this is too
...
and temperance. are the only eligible qualities ® which
...
* Perhaps Laws, iv. 704-709, and v. 747 D. 3) Cprr267 219

Cp. vil. 1327? a0. ° Cp. vii. C. 2. and 3. -° Laws, v. 737s

Cp. vii. 1326 30.

= * Reading é€e:s aiperai in 1. 35 with Vettori.
...
to remain unlimited, and he thinks that it will be suffi-
ciently equalized * by a certain number of marriages being
unfruitful, however many are born to others, because he
...
as in the Laws, the supernumeraries, whether few or
...
in married persons. The neglect of this subject, which
...
same, although originally all the lots may have been of
...
There is another ornission in the Laws: Socrates does
not tell us how the rulers differ from their subjects ; he
_ only says that they should. be related as the warp and
the woof, which are made out of different wools.4 He
allows that a man’s whole property may be increased
fivefold,®> but why should not his land also increase to
a certain extent? Again, will the good management of
a household be promoted by his arrangement of home-

' But see Laws, v. 740 B-741 A.

2 Reading dvopadticOnoopévyy, in |. 40, with Madvig.

3 Cp. vii. 1326 26-32, 133079-18, 1335 19-26; but the promise
is hardly fulfilled. ¢

4 Laws, v. 734 B, 735 A: 5 Laws, Vv. 744 E.
...
25 steads ? for he assigns to each individual two homesteads
...
30 greatest number of states, he was very likely right, but
...
12667 and in the habits of daily life. In the Laws? it is
...
The constitution proposed in the Zaws has no element
of monarchy at all; it is nothing but oligarchy and
democracy, leaning rather to oligarchy. This is seen in
the mode of appointing magistrates ;* for although the
appointment of them by lot from among those who have
been already selected combines both elements, the way
10 in which the rich are compelled by law to attend the
assembly ° and vote for magistrates or discharge other
...
' Laws, v. 745 C, but cp. infra, vii. 13302 9-18.

* Cp. iv. 1293 16, 1294 18-34.

* ill, 693 D, 701 E, iv. 710, vi. 756 E.

* Laws, vi. 756, 763 E, 765.

* Laws, vi. 764 A; and Pol. iv. 1294% 37, 1298 16.

° BOOK II. 6

the endeavour ! to have the greater number of the magis-
...
council,? for all are compelled to choose, but the com-
...
equal number of each class selected. Thus a preponder-
...
and others which will be adduced * when the time comes
...
1 Laws, vi. 763 D E. 2 Laws, vi. 756 B-E.
5 Reading trois 8’ ex roy rpidv |} rerdprev| in 1. 17, cp. Laws, vi.
7560 C 8.

4 iv. 7-9, 12, 1296” 34-38, 1297” 7-13.
5 Laws, vi. 753 D.
...
40 ought to have equal possessions. He thought that in
1266" a new colony the equalization might be accomplished
...
* v. 744 E. 2 1265P er. 3 Cp. 1265 38- 16,
...
which require to be equalized,! and this is impossible, 30
...
Stil] he should tell us what will be the character of his
...
common people quarrel about the inequality of property, 1267*
...
the only reason—they may desire superfluities ° in order
...
second, habits of temperance; as to the third, if any 10
...
Ep. 126333. en [VAK2310; * Keeping dv émiOupoier.
...
who kills a thief, but on him who kills atyrant. Thus
...
powerful neighbours may be temipted by it, while the
...
has ot laid down any rule; but we should bear in mind
that abundance of wealth? is anadvantage. The best limit
...
These words of Eubulus made an impression on Auto-
...
than an equal share of honours ; and this is often found

* Cp, 126520,

* Or, reading 6 7 in 1. 28 with Stahr, ‘what amount of wealth.

BOOK II. 7 12672

to be a cause of sedition and revolution! And the
avarice of mankind is insatiable; at one time two obols 1267”
...
and most men live only for the gratification of it. The
...
these were worn on a cheap but warm garment?” both in
...
AKG oS 1h sie 2 Reading emi for éru in 1. 26.
...
5 the second was to support the warriors, the third was the
...
appeal, to which all causes seeming to have been impro-
perly decided might be referred; this court he formed
of elders chosen for the purpose. He was further of
...
a simple condemnation, or leave the tablet blank fora
...
had never been heard of before, yet it actually exists
at Athens! and in other places. As to the magistrates,
...
and therefore they become all but slaves df the warrior
...
1 Reading dvo oixias in |. I,
* Reading dro ris Catris) yns inl. 2 with Bocker.
...
to indeed, most legislators take pains to prevent the judges
...
15 allows five, another four minae. In this way they will go on
...
had better goa little into detail, for, as I was saying, there
...
have departed frgm traditional usage. And, if politics be
...
For the ancient Hellenes went about armed! and bought 4°
their brides of each other. The remains of ancient laws
which have come down to us are quite absurd; for 1269"
...
unaltered. As in other sciences, so in politics, it is im- to
...
the habit of lightly changing the laws is an evil, and, 15
...
a change in an art. For the law has no power to com- 20
mand obedience except that of habit, which can only be
given by time, so that a readiness to change from old to

Gp. Thucyd. 1. 5 and 6.
Cp. Plato, Laws, iii. 677 B; Polit.274 C; Tim. 22 D.
Cp. Plato, Polit. 295 A. * 1268? 34 sqq.
...
28 be changed, and in every state? And‘are they to be
...
indeed in all governments, two points have to be con-
...
the reason probably is that the neighbouring cities, even
...
enemies. In Thessaly, again, the original revolt of the
...
* These questions are not actually discussed in the Politics.
“Cp. 1271 41.
...
manner of most warlike races, except the Celts anda few
...
confusion thanthe enemy. This licence of the Lacedae-
...
only what might be expected. For, during the wars of 1270°
...
s prepared by the discipline of a soldiet’s life (in which
...
be attributed to them. Weare not, however, considering

o what is or is not to be excused, but what is right or wrong,
and the disorder of the women, as I have already said,' not
only gives an air of indecorum to the constitution con-
sidered in itself, but tends in a measure to foster avarice.

; he mention of avarice naturally suggests a criticism
...
for, although the legislator rightly holds up to shame the
...
o maintain 1500 cavalry and 30,000 hoplites, the whole
number of Spartan citizens* fell below 1000. The result
proves the faulty nature of their laws respecting property ;
for the city sank under a single defeat ; the want of men
was theirruin. There is a tradition that, in the days of
their ancient kings, they were in the habit of giving the
rights of citizenship to strangers, and therefore, in spite
...
* i, e, to the person who ‘inherits’ the heiress. Cf. Newman ad Joc.
’ At the time of the Theban invasion.

BOOK II. 9 1270°

by them; indeed, at one time Sparta is said to have
numbered not less than 10,000 citizens. Whether this
...
procreation of children is adverse to the correction of this 40
inequality. For the legislator, wanting to have as many 1270?
...
Yet it is obvious that, if there were many children, the
...
into the hands of very,poor men, who, being badly off, 1o
...
have been compelled to court them, so that, in this way
...
advantageous. For if a constitution is to be permanent, all
the parts of the state must wish that it should exist and
the same arrangements be maintained.' This is the case
...
1 Reading Scapévew radra in 1, 22 with most MSS. Cp. iv.
1294” 38, v. 1309? 17.
...
a5 the office of elder is a reward of virtue) ; and the people,
...
30 judgement, but according to written rules, and to the laws.
...
It may be said that the elders are good men and _avell
...
1271° And when men have been educated in such a manner
...
sin public affairs. And therefore they ought not to be
...
1o Spartans elect their elders is childish; and it is im-
...
I will consider at another time’; they should at any rate 20
...
Crete”; but among the Lacedaemonians every one is
...
The charge which Plato brings, in the Laws,* against 1271”
...
preserved, but when they had attained empire they fell,’ 5
for of the arts of peace they knew nothing, and had never
...
1 iii. 14-17. Cp 12729 13-21.
3 Laws, 1.625 KB, 630. * Cp. vii. 1334%6.
...
to Once more: the revenues of the state are ill-managed ;
...
ts another’s contributions. The result which the legislator
...
20 The Cretan constitution nearly resembles the Spartan, 1o
...
25‘Lycurgus, when he ceased to be the guardian of King
...
4o Lhe Helots are the husbandmen of the one, the Perioeci

1272° of the other, and both Cretans and Lacedaemonians have
...
two constitutions are similar ; for the office of the Ephors
...
them in war. A\ll classes share in the ecclesia, but it can
...
every one pays so much per head, or, if he fails, the law,
as I have already explained,! forbids him to exercise the
...
supported out of a common stock.” The legislator has
...
1 SiO eye. EiGpe wil 1330,
8 The question is nowhere discussed by Aristotle.
4 Reading éru 6€ in 1. 26, with the MSS.
...
the highest office, want the constitution to be permanent
...
The same criticism may be made about the Cretan,
...
office as out of the Ephoralty, since, unlike the Ephors,
...
wr The Carthaginians are also considered to have an ex-
cellent form of government, which differs from that of any
other state in several respects, though it is in some very 2
...
lent. The superiority of their constitution is proved by
...
power, and therefore, if they are persons of little worth, 1273
...
10 and any one who likes may oppose it; now this is not
...
20 tried by the magistrates, and not some by one class of
...
the leisure. If, then, election of magistrates for their
...
thing is more absolutely necessary than to provide that
...
of the state deem anything honourable, the other citizens
are sure to follow their example; and, where virtue has
not the first place, there aristocracy cannot be firmly
...
secure leisure for them when in office.'
...
_ said,.* this arrangement is fairer to all, and any action
familiarized by repetition is better and sooner performed.
We have a proof in military and naval matters; the
...
1 Cp. 1269? 34. 2 Cp. Plato, Rep. ii. 374 A. eeizolotle
...
sending them ! to their colonies. This is their panacea
...
__ of restoring peace by legal methods.
...
already spoken.* As to Solon, he is thought by some to
...
4o Clement, the elected magistracy, aristocratical, and the
...
ading ro mAourifew-aied re in 1. 19, with Schneider; cp. iv.
...
demagogue in turn increased the power of the demo-
...
’ or from the class called zeugitae,® or from a third class
...
cities in Italy and Sicily. Some people attempt to
make out that Onomacritus was the first people who
had any special skill in legislation,* and that he, although
...
2 °Cp. Vs 1904% 20, Vill. 1341229. 25 Epi 1250132)
...
In the legislation of Charondas there is nothing re-
...
property, the common meals of women, and the law
...
Draco has left laws, but he adapted them to a consti-
...
more heavily punished than if he were sober ;* he looked

Reading rod pev ovvorroy rod & od cdvorroy in 1. 38.

® Cp. Laws, i. 640 D, ii. 671 D-672 A. 3 Cp. Laws, vii. D.
* Cp. A Eth. (113 31. .

= Pr.

utions which either actually exist, or ave eee
by theorists. LH ews
...
‘ What isa state?’ At present this is a disputed question.
Some say that the state has done a certain act; others,
no, not the state,! but the oligarchy or the tyrant. And
...
are the citizens, who compose it. It is evident, therefore,
that we must begin by asking, Who is the citizen, and
what is the meaning of the term? For here again there
may bea difference of opinion. He who is a citizen ina
democracy will often not be-a citizen in an oligarchy.
Leaving out of consideration those who have been made
...
and being sued; for this right may be enjoyed under
...
or to old men who have been relieved from state duties.
...
20 Of that sort; the precise expression is immaterial, for
...
—for example, the office of dicast or ecclesiast.!. It may,
...
others are posterior ; those which are faulty or perverted
are necessarily posterior to those which are perfect.
(What we mean by perversion will be hereafter ex-
plained.?) The citizen then of necessity differs under
each form of government; and our definition is best
...
1 Dicast ’=juryman and judge in one: ‘ ecclesiast’=member of
the ecclesia or assembly of the citizens.
A Chay py fey a6
Hee2,
...
10 which they distribute among themselves, while the elders
...
15 of a definite, not of an indefinite office, who legislates
...
magistrates ;* for it is their trade to make Larissaeans.’3

30 Yet the question is really simple, for, if according to the
definition just given they shared in the government,* they
...
_* Anuntranslatable play upon the word dyovpyds, which means
either ‘a magistrate’ or ‘an artisan’,

* Reading in |. 30 Aapwratorocovs, which seems to have been read
by Aretinus. seCpylans:
...
whether he who is ought to be a citizen; and there 1276*
...
citizen was defined ' by the fact of his holding some kind
...
3 Whether they ought to be so or not is a question
...
democracy will be neither more nor less acts of the state in
question than those of an oligarchy or of atyranny. This
...
be separated, and some of the inhabitants may live in one 20
...
the rivers, are the same, but that the state changes? For,
since the state is a partnership, and is a partnership of
...
from a comic chorus, although the members of both may
...
the Dorian or the Phrygian niode is employed. And if
...
i.e. wédts means both ‘state’ and ‘city’.

Cp. ii. 12657 14.
° The size of the state is discussed in vii. 13262 8-1327% 3; the

question whether it should consist of more than one nation is
barely touched upon, in v. 1303® 25-} 3,
...
not to fulfil engagements when the form of government
changes.

There is a point nearly allied to the preceding:
Whether the virtue of a good man and a good citizen
is the same or not.! But, before entering on this discus-
sion, we must certainly first obtain some general notion
of the virtue of the citizen. Like the sailor, the citizen
isa member of a community. Now, sailors have different
...
is safety innavigation. Similarly, one citizen differs from
...
road, from aconsideration of the best:constitution. Ifthe
state cannot ” be entirely composed of good men, and yet
each citizen is expected to do his own business well, and
musttherefore have virtue, still, inasmuch as all the citizens

cannot be alike, the virtue of the citizen and of the good 1277*
...
Cp. NV. Lh. v. 1130°-28.
2 Reading advvaroy in |. 38 with the MSS.
...
"5 Again, the state, as composed of unlikes, may be com- __
...
15 cide? To this we answer that the good rer is a good
...
aruler. If then? the virtue of a good ruler is the same
...
25 But, on the other hand, it may be argued that men are
...
1 Acolus, fr. 16, Nauck?,
* Reading «i 5) in 1, 20, with some good MSS.
...
learn different things? and not the same, but that the
...
crafts of inferiors except for their own occasional use ;°
...
freeman, and how to obey like a freeman—these are the
virtues of a citizen. And, although the temperance and

" Reading duo érepa for appdrepa in 1. 30, with Bernays.
2 Cp. i. 1255 20-37. > Cp, vili. 1337" 15.
4 Reading rov pev... roy ¢ in Il. 6, 7, with the MSS.
...
differ... For a man would be thought a coward if he had
...
25 other to preserve. Practical wisdom only is characteristic
of the ruler:? it would seem that all other virtues must
...
1278° May we not reply, that as far as this objection goes
...
1 Cp. i. 1260820. 2 Cp. Rep. iv. 428. * Cp. Ref. x. 601 D, EB.

* Cp. 12788 40, 1288 39, iv. 1293» 5, vil. 13339 11.

BOOK Tilvs ~ 1278

citizens equally with grown-up men, who are citizens
absolutely, but children, not being grown up, are only 5
citizens on a certain assumption.! Nay, in ancient times,
and among some nations, the artisan class zere slaves or
...
who are subjects; so that under somé governments the
...
which honours are given according to vjrtue and merit ;
...
them are rich. At Thebes® there was a law that no man 25
...
words ‘like some dishonoured stranger’;* he who is
...
As to the question whether the virtue of the good man
is the same as that of the good citizen, the considerations
...
state *, especially of the highest of all. The government
...
the first part of this treatise,? when discussing house-
hold management and the rule of a master, that man is
by nature a political animal. And therefore, men, even

* Achilles complains of Agamemmon’s so treating him, Z/. ix.
648, xvl. 59. ; ‘
2 Cp. 1274» 38, iv. 12892 15.» eTG@pAvi2s'3 42.
...
also for the sake of mere life (in which there is possibly 25
...
in discussions outside the schoo]. The rule of a master,
although the slave by nature and the master bynature have
...
be the case in medicine, gymnastic, and the arts in 1279°
general, which are only accidentally concerned with the
good of the artists themselves.'. For there is no reason
why the trainer may not sometimes practise gym- i
nastics, and the helmsman is always one of the crew. The u
...
One might imagine that the rulers, being sickly, were
...
only the interest of the rulers are all defective and
perverted forms, for they are despotic, whereas a state is
a community of freemen.

Having determined these points, we have next to con-
...
few, or of the many, are perversions.2,_ For the members of
...
not many, rule, aristocracy ; and it is so called, either
...
1 Cp. ii, 12612 37-6. * Cp. WV. Lth, viii. 10, —
...
for this use of language. One man or a few may excel 40

in virtue; but as the number increases it becomes more
difficult for them to attain perfection in every kind of 1279”
...
overlook or omit anything, but to set forth the truth in 1;
every particular. Tyranny, as I was saying, is monarchy
exercising the rule of a master over the political society ; l
...
4o the real difference between democracy and oligarchy is
12807 poverty and wealth. Wherever men rule by reason of
...
to of some kind, but their conceptions are imperfect and
...
a just distribution, as I have already said in the Ez/zcs,)
...
in one respect, for example wealth, consider themselves
...
same share of a hundred minae, whether of the principal ;
...
there are no magistracies common to the contracting 1280?
...
2 The sentence in the original becomes involved in so many
parentheses that there is no true apodosis to the protasis beginning
in 1. 31. In sezse the apodosis comes at 12814,
...
10a surety to one another of justice,’ as the sophist
...
if men dwelt at a distance ftom one another, but not so
...
man, another a shoemaker, and soon, and that their
...
because they are at a distance from one another: for even
...
30 afteras before their union. It is clear then that a state isnot
...
isa community of families and aggregations of families
...
union of families and villages in a perfect and self-sufficing 12817
life," by which we mean a happy and honourable life.2
...
Or atyrant? Any of these alternatives seems to involve
...
1 Omitting yap in 1. 1. 2 Cpiet252".275 NN. Eth.i. 1097°6,
G2
...
2srulers? And what if they, in like manner, rob and
...
3o power? Butin that case everybody else, being excluded
...
4o occasion.” The principle that the multitude ought to be
supreme rather than the few best is one that is main-
tained, and, though not, free from difficulty,t yet seems
to contain an element of truth. ‘For the many, of
1281? whom each individual is but an ordinary person, when
...
* Cp. 12826, 2 Cp, ll. 11-34. Se. 12-17, 1, Vis
‘ 4 Reading in l. 41 Aé€yerOu, as suggested by Richards, and
aroptayv, with the MSS.
...
derstand the whole. There is a similar combination of
...
than in the picture. Whether this principle can apply to
...
from brutes? But there may be bodies of men about 20
...
have no personal merit—are both solved. There is still 25
...
1282* that is, in other words, the physician; and so in all pro-
...
to to steer, a pilot; and, even if there be some occupations
...
15 answer,' that if the people are not utterly degraded,
...
but there is another akin to it. That inferior persons 25
...
and having but a small property qualification, sit in the 30
...
The discussion of the first question * shows nothing so 1282?
...
15 In all sciences and arts the end is a good, and the 12
greatest good and in the highest degree a good in the most
auth6ritative of all1—this is the political science of which
the good is justice, in other words, the common interest.
All men think justice to be a sort of equality; and toa
certain extent * they agree in the philosophical distinctions
...
4o and may excel flute-playing in a greater ratio than he
excels the others in his art, still he ought to have the
1283° best flutes given to him, unless the advantages of wealth

bo
fe}

1 Cp. 1. 1252923 WV, Beh. i. 1094 1. * Cp. 1280* 9,
"eC Vi, aah syed
...
may be compared with any other. For if a given height 1
may be measured against wealth and against freedom, ;
...
ofastate. And therefore the noble, or free-born, or rich,
...
and valour are equally so;* for without the former
...
life, then, as I have already said,® education and virtue 25
...
* Omitting waddoy in |. 4 with Ridgeway.
2 Ep. iv. 1291210-33; 2 (joy tio

1283°

POLITIC

30 already admitted,! but all have not an absolute claim.
...
man’s own home and country. Another reason is, that
...
better. But, what if the good, the rich, the noble,
...
who found their claims on wealth or family might be
...
they are freeborn. In an aristocracy, or government of

1 1280" 9 sqq. 2 Cpe ier255832. "Cp. 1.1253" 37.
* Cp. WV. £th, v. 11292 a
...
other men in subjection to them are strictly right. To 30
...
the case which we have mentioned occurs.!- Now what 40
...
governed. He differs under different forms of govern- 1284°
...
Cf. 1. 33. The brackets in ll. 36, 39 should be removed.
...
15 attempted to make laws for them: they would prob-
...
3° ears of corn till he had brought the fieldtoa level. The
...
the state ;* and this-is a policy not only expedient for
...
‘i.e. ‘where are your claws and teeth?’ B*CDcV.2135L71Z0,
* Cp. vi 1302": 18

BOOK III. 13. 7 1284?

humbled their allies contrary to treaty ; and the Persian 1284”
...
be observed in the arts and sciences ; for the painter will
...
government is for the interest of the state. Hence where
...
this or some similar measure. The principle, however, 2
...
but it is also clear that it is not absolutely just. In the a;
...
1 Cp. v. 1302 34, 1309» 21; vil. 13267 35 ; Rep. iv. 420.
...
many. It is easy to.see that there are many, and that the
...
royal power is not absolute, except when the kings go
...
of life and death, except ina specified case! as for
instance, in ancient times, he had it when upon a
campaign. by right of force. This custom is described
...
vultures, for in my hands is death,’ ?

This, then, is one form of royalty—a_ generalship

sfor life: and of such royalties some are hereditary
...
A Perit: Awe co
, Reading éy-rux without any noun, as proposed by Bernays.
* L7. ii, 391-393. The last clause is not found in our Homer,
...
of tyrants are mercenaries.*_ For kings rule according to
...
fora term of years, or until certain duties had been per-
...
in one of his banquet odes* that they chose Pittacus
...
"Cid, to HOGAN. ey Comye tos 7
SR iris eA eer eke 4-Cp.'v. 1310? ro.
...
their power extended continuously toallthings whatsoever,
in city and country, as well as in foreign parts ; but at a
later date they relinquished several of these privileges, and
...
has the disposal of all, just as each nation or each state
has the disposal of public matters ; this form corresponds
to the control ofa household. For as household manage-
ment is the kingly rule of a house, so kingly rule! is the
household management of a city, or of a nation, or of
many nations.

Of these forms we need only consider two, the Lace-
daemonian and the absolute royalty; for most of the
...
1 Reading BacrAela in 1. 32, with the MSS.

BOOK III. 15 1285”

and if so, should the office be confined to one family, or
open to the citizens in turn?! Secondly, is it well that a 12867
...
is asort of constitution ; this we have now to consider, and
...
rules is absurd. In Egypt* the physician is allowed to
...
1 Reading 7) xara pépos in |. 39, with the best MSS.
2 It is not discussed later. ® Cp. Plato, Polit. 294 A-295 C.
4 Omitting was in |. 12, with some MSS.
...
ees is better than a banquet furnished by a single
man,! so a multitude is a better judge of many things
than any individual.
...
his judgement is necessarily perverted ; but it is hardly
...
4o the one good ruler, or the many who are all good?

1286”

Will not the many? But, you will say, there may be
...
eminent virtue were few. Further, they were made kings
...
mischievous. But, says the lover of royalty, the king,
...
able to coerce the refractory? if not, how will he
...
is not much difficulty in answering this question; the 3;
...
16 At this place in the discussion there impends the 1287*
...
as I have already remarked,” is not a distinct form of
...
supreme over the administration of astate. A magistracy

" Cp. iv. 12937 1, 129722. ? 128622,
Ik
...
of this kind exists at Epidamnus,! and also at Opus, but
in the latter city has a more limited power. Now,
...
share, in the offices of state, is as bad as for different
...
argued, is preferable to that of any individual. On the
...
determine, but in such cases can a man? Nay, it will
...
the beast ; for desire is a wild beast, and passion perverts
...
of the arts is clearly not in point ; for the physician does
...
WCpavembsoneits ® Cp. 12869 12-14, Polit. 296 B.
...
neutral,’ for the law is the mean. Again, customary laws
...
_ Again, it is by no means easy for one man to super-
...
him because he needed them? If, as I said before,? the
...
judges, and not one only. For every ruler ° who has been
trained by the law judges well ; and it would surely seem
Cpa. Eth. v. 1132%22. 2 1283 21, 1284» 32.

ERLE X22 A. = th We, SYpe-
> Cp. for similar arguments 1286% 28- 7.
...
himself ought to rule equally with himself. These are
...
contrary to nature. Now, to judge at least from what
has been said, it is manifest that, where men are alike

1288° and equal, it is neither expedient nor just that one man
...
should he have a right to rule, unless ina particular case,
at which I have already hinted, and to which I will
once more recur.®? But first of all, I must determine
...
* Reading atrots in 1. 31, with Schol. in Aristoph. Acharn. 92.

* Reading deozroruxdy kal @AXo Bacrdevrixdy in 1. 38.
§ 1284% 3, and 128815.
...
of political command are adapted for an aristocracy: 2 4
...
king of the whole nation. For, as I said before,® to give
...
claim of excellence, althotigh not the same excellence),
but accords with the principle already laid down.* For 25
...
_of a whole to a part. But if so, the only alternative is
...
18 We maintain® that the true forms of government are |
|

' Retaining év@... mdnOos in |. 12, 25 Ep.2 12792.
8 1283» 20, 1284% 3-17, © 25. ;
4 Cp. 1284 28. mavry.. . THY adrny in |. 23 is parenthetical.
D(Cioy, WASP AA ce
...
1288” he will frame a state that is to be ruled by an aristocracy
...
I IN all arts and sciences which embrace the whole of 1° .
...
form of training is adapted to the great majority of men 1;
(4). And if a man does not desire the best habit of body,
or the greatest skill in gymnastics, which might be
attained by him, still’ the trainer or the teacher of
...
to particular states. or the best is often unattainable,
...
1 Reading in I. 18, with Bekker’s 2nd edition, dywviay, ovdev Arrov
Tov maoorpiBov.

* The numbers in this paragraph are made to correspond with
...
ment which is best suited to states in general; for
...
natural advantages are required. Others, again, speak
of a more attainable form, and, although they reject the
constitution under which they are living, they extol
some one in particular, for example the Lacedaemonian.'
Any change of government which has to be introduced
...
as to unlearn is as hard as to learn. And therefore, in
addition to the qualifications of the statesman already
mentioned, he should be able to find remedies for the
defects of existing constitutions, as has been said before.”
...
But this is a mistake; and, in order to avoid such mis-
...
to the laws. A constitution is the organization of offices
...
and the number of varieties, of each form of government, if 2°

only with a view to making laws. For the samé laws
...
In our original discussion’ about governments we
...
Of kingly rule and of aristocracy we have already spoken,”
...
latter should be established.* In what follows we have
...
the worst. And just as a royal rule, if not a mere name, 1289”
...
A writer® who preceded me has already made these
...
in CD nVeEreth. Vill, 10s ? ii, 14-18.

8 iii, 1279* 32-37, 1286” 3-5, 1284 3- 34, ch. 17.

Cpr ill. 204% 3-0 34, “Chs..tl7 als, (ve 13 1OP Toesy., vil.
1325” 10-12.

5 Plato, Poli¢. 302 H, 303°A.
...
to case defective, and that! one oligarchy is not to be

accounted better than another, but only less bad.

Not to pursue this question further at present, let us
begin by determining (1) ? how many varieties of constitu-
tion there are (since of democracy and oligarchy there are

15 several) ; (2)® what constitution is the most generally ac-
...
time adapted to states in general ; (3) * of the other forms
...
and in the multitude of citizens there must be some
...
' Reading éxev in |. 10, with Richards. 27G@. 3-10:
(Gy Wily PRON Oe ° Book vi. 1-7. 5 Book v.
...
Meander, and of other peoples in Asia. Besides dif-
ferences of wealth there are differences of rank and
merit, and there are some other elements which were
...
greater number, have a share in the government. It is
...
south wind. Similarly of musical modes there are said
...
a very favourite notion. But in either case the better
and more exact way is to distinguish, as I have done,? the
one or two which are true forms, and to regard the others
as perversions, whether of the most perfectly attempered
mode or of the best form of government: we may

? iii, 1283714 sq., and cp. vii. 8, 9.
® 1289% 31-33, 40 sqq., Cp. Vill. 1340% 4o-" 5, 1342% 28 sqq., 29 sqq.
...
compare the severer and more overpowering modes to _
the oligarchical forms, and the more relaxed and gentler
ones to the democratic.

30 It must not be assumed, as some are fond of saying,
that democracy is simply that form of government in
which the greater number are sovereign,’ for in oligar-
...
in all other respects their equals, a share of the govern-
...
4o office, an oligarchy. Therefore we should rather say

1290° that democracy is the form of government in which the
...
ro a democracy * in which the freemen, being few in number,
...
Ep iligie7oleT. ? Reading dios in |. 11, with the MSS.
...
Why there are more than those already mentioned,! and
what they are, and whence they arise, I will now pro-
ceed to consider, starting from the principle already
admitted,? which is that every state consists, not of one,
but of many parts. If we were going to speak of the
...
organs, but that there may be differences in them—I 30
...
organs. The same, then,? is true of the forms of govern-
ment which have been described; states, as I have
repeatedly said,* are composed, not of one, but of many
elements. One element is the food-producing class, who 40
are called husbandmen ; a second, the class of mechanics 1291°
...
} i.e. democracy and oligarchy, cp. 1290 13. #1280? 27 sq.
5 Reading roy avrov 6) rpdrov in 1, 37, with Coraes.
‘il. 1261%22 sqq., iil. 1283%14 sqq.,iv. 1289>27-1290%5,

1290° 23 sq., cp. iil. 1277" 5 sqq.
...
they are not enough, he adds a smith, and again a
...
admit into the state a military class until the country |
...
more truly part of an animal than the body, so the higher
...
zens, or of the same,—for it may often happen that the
...
there must also be persons who have the ability of 1291”
...
to fill most offices. But the same persons cannot be rich
...
I have already explained! that there are many forms
...
Here then is one sort of democracy. There is another?
in which the magistrates are elected according to a cer-
tain property qualification, but a low one; he who has
the required amount of property has a share in the
government, but he who loses his property loses his
rights. Another kind is that in which all the citizens
...
mocracy, in other respects the same, is that in which, not
...
1 Or, reading apyew in 1. 32 with Vettori, ‘that the poor should
no more govern than the rich’. The emendation i is not absolutely
necessary, though supported by vi. 13186 1 imov yap TO pnbev Hao»
dipyew TOUS ardpous i) Tovs edrdpous, pnde kuplovus eival pdvous anra mayras
e€ t toou Kar’ apOuor,

2 Retaining dAdo de in 139.
...
uncertain. At all events this sort of democracy, which 1s
...
be a real form of government, the sort of system in which 3;
...
where the property qualification for office is such that the
poor, although they form the majority, have no share in
the government, yet he who acquires a qualification may
obtain a share. Another sort is when there is a qualifi-
...
oligarchy is when the son succeeds the father. There
...
in fact this sort of oligarchy receives the name of a
...
states! the constitution which is established by law,
although not democratic, owing to the education and
habits of the people may be administered democrati-
cally, and conversely in other states the established
...
with encroaching a little upon their opponents. The
laws which existed previously continue in force, but
...
whom we mentioned? must share in the government, or
some only and not others. When the class of husband-
men and of those who possess moderate fortunes have

1 Cp, v. 1301? to. * 1291» 17-30,

BOOK IV. 6 ) 1292”

the supreme power, the government is administered
according tolaw. For the citizens being compelled to live
...
constitution. But leisure cannot be provided for them !
...
for the reason which has been already given; so that in 40
this form again the law must rule. A fourth kind of
democracy is that which comes latest in the history of 1293*
...
' Placing dvé... peréyew after ddcyapyixdy in 1, 32, and omitting |
the second ¢£eiva in 1. 32 with Thurot. ite
...
represent their wishes.1_ When this power is intensified
...
3o son shall succeed the father. When, again, the rulers
...
35 . Lhere are still two forms besides democracy and 7
...
' i.e. they make a law that the governing class shall have the
...
different kinds of government ; like Plato,! in their books 1293”
about the state, they recognize four only. The term
‘aristocracy ’ is rightly applied to the form of government
which is described in the first part of our treatise ; 2. for
...
tocracies. The truth is, that they all fall short of the 2;
most perfect form of government, and so they are |
reckoned among petversions, and the really perverted

1 Rep. viii, ix. 2 iii, 12792 34, 1286 3, cp. vii. 1328 37.
Ss Cpiiil2739 21-30. ;
...
discussion! Last of all I will speak of tyranny, which I
place last in the series because I am inquiring into the
constitutions of states, and this is the very reverse of a
constitution.

30 Having explained why I have adopted this Onis
I will proceed to consider constitutional government ; of
...
3s usually applied to those forms of government which
...
4o And inasmuch as aristocracy seeks to give predominance
to the best of the citizens, people say also of oligarchies
that they are composed of noblemen and gentlemen.

1294* Now it appears to be an impossible thing that the state
...
ment has authority. Now in most states the form called
- polity exists,) for the fusion goes no further than the
attempt to unite the freedom of the poor and the wealth
of the rich, who commonly take the place of the noble.
But as there are three grounds on which men claim an
...
Thus far I"have shown the existence of forms of states
...
Now there are three modes in which fusions of govern-
ment may be effected. In the first mode we must
combine the laws? made by both governments, say
...
democracies they give pay to the poor and do not fine
the rich. Now (1) the union of these two modes? is
a common or middle term between them, and is

Retaining kaeira in 1. 15.
* Reading @ in 1. 36 with some good MSS. &°Cp, 3297" 38.
...
therefore characteristic of a constitutional government,
...
one; here neither of these is the common term, but
...
when the same state may be termed either a democracy
...
scribed as a democracy, becauge it has many democratical
features. In the first place the youth receive a demo-
cratical education. or the sons of the poor are brought
...
for they elect the Senators and share in the Ephoralty.
...
good will of a majority!1—they might be equally well-
...
Enough of the manner in which a constitutional 40
government, and in which the so-called aristocracies
ought to be framed. |

Io Of the nature of tyranny I have still to speak, in order 1295
...
already in the former part of this treatise? discussed
...
they are, as I said before,* royal, in so far as the monarch
rules according to law over willing subjects; but they
are tyrannical in so far as he is despotic and rules accord-
ing tohisownfancy. There is alsoa third kind of tyranny,

or

' Omitting ¢£oev in. 1. 37, with Thurot. ie
? iii, 14-17. § iii.1285*.16—" 3. pre 28 5) 2.

1295° POLITICA

which is the most typical form, and is the counterpart of
the perfect monarchy. This tyranny is just that arbitrary _
20 power of an individual which is responsible to no one,
...
2, We have now to inquire what is the best constitution I
...
30 in which the majority are able to share, and to the form
...
35, rests upon the same grounds. For if what was said
in the ¢iics” is true, that the happy life is the life
...
4o Of cities and of constitutions; for the constitution is in

1295” 2 figure the life of the city.

Now in all states there are three elements: one class is
very rich, another very poor, and a third ina mean. It
...
1 1293 7-21, cp. 1293> 36-12942 25.

2 N. Eth, i. 1098" 16, vii. 1153" 10, x. 11.77% 12,
...
the same path. But a city ought to be composed, as far :
...
of the state naturally consists.2 And this is the class of
...
1 Cp. Pl. Rep. iv. 421 D ff. 4"€p. v. 1310%.22.
3 Cp. ll. 1-3. * Fr. 12, Bergk*.
...
akin to them. Iwill explain the reason of this hereafter,
when I speak of the revolutions of states.1_ The mean con-
...
in the middle. And democracies are safer? and more
...
his own verses testify ; and Lycurgus, for he was not a
...
1 vy. 1308% 18-24. 2 Cp. v. 1302°8, 1307 16,
...
democracy and the other an oligarchy.. F urther, both the
...
States, not even to care about equality; all men are 1296"
...
since we say” that there are many kinds of democracy and
many of oligarchy, it is not difficult to see which has the ;
...
given conditions: I say ‘relatively to given conditions’, ro
...
? Retaining é’ jyepovia yevouévay in 1, 39. The reference js ‘
probably to Theramenes.

* 12897 8, °13, 1291” 15-1292? Io, 1292» 22-1293? Io,

8 Reading eyyvrata in 1, 8 with most MSS.
...
25a comparison of quantity and quality. Where the
...
the artisans and labouring class, the last; and so with
...
4o the others, and in that case there will be no fear that
...
because they mistrust one another. The arbiter is always
...
(3. The devices by which oligarchies deceive the people
...
flicted on the poor for non-attend
