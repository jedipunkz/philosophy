---
source: "https://archive.org/details/nicomacheanethic00arisuoft"
title: "The Nicomachean ethics. Translated by D.P. Chase"
author: "Aristotle"
year: "1915"
captured_at: "2026-07-04T19:26:03Z"
updated_at: "2026-07-04T19:26:03Z"
capture_tool: "scrapem-book"
source_name: "archive"
keyword: "アリストテレス"
query: "Aristotle Nicomachean Ethics"
plain_text_url: "https://archive.org/download/nicomacheanethic00arisuoft/nicomacheanethic00arisuoft_djvu.txt"
public_domain: true
...
# The Nicomachean ethics. Translated by D.P. Chase

- 著者: Aristotle
- 初版: 1915
- 情報源: [archive](https://archive.org/details/nicomacheanethic00arisuoft)
- パブリックドメイン: ✓
...
INTRODUCTION  BY  J.  A.  SMITH,  M.A.
WAYNFLETE  PROFESSOR  OF  META-
PHYSICS AND  MORAL  PHILOSOPHY
IN    THE     UNIVERSITY    OF     OXFORD

THIS  IS  NO.  547  OF  eV8T<r3i^D<:^S

LlB'R^TiT.  THE  PUBLISHERS  WILL
...
First  Issue  of  Tins  Edition    •  .     1911
...
same  subj ect.  This  subj ect  is  what  Aristotle  calls  in  one  place
...
(an  order  which  in  the  actual  treatise  is  not  adhered  to).
...
play  the  great  force  of  the  PoUtical  Community  or  State,
...
good  character  is  not  the  end  of  cither  individual  or  state
...
doing.  The  end  of  all  action,  individual  or  collective,  is
...
able human  qualities  which  fit  a  man  for  life  in  an  organised
...
ordinate to  this  main  interest  and  purpose.  Yet  "  the
...
There  is  a  basis  of  what  we  should  call  Psychology,  sketched
...
own  waj^s  of  regarding  conduct  and  speaking  of  it.  Thus
...
realisation.  Such  knowledge  is  that  which  in  its  con-
...
a  mathematics  of  conduct.  The  subject-matter  of  Human
...
subject-matter  of  conduct  to  a  few  simple  rigorous  abstract
principles,  with  conclusions  necessarily  issuing  from  them,
and  the  view  tha,t  it  is  the  field  of  operation  of  inscrutable
...
xii  Aristotle's  Ethics

element — something  which  it  is  not  yet  and  which  under
...
by  his  efibrts.  There  is  in  Aristotle's  theory  of  human
...
positive  view  of  Happiness,  and,  though  he  avowedly  states
...
good  luck,  the  absence  or  diminution  of  which  render
...
blurred,  and  uncertain.  Aristotle  draws  the  outline  with
...
intelligence.  These  last  fall  into  tw-o  groups,  which  Aristotle
distinguishes  as  Goodnesses  of  Intellect  and  Goodnesses  of
Character.  They  have  in  common  that  they  all  excite  in
us  admiration  and  praise  of  their  possessors,  and  that  they
...
rule,  and  not  the  faculty  which  apprehends,  formulates,
considers  them).
...
of  describing  their  "  Tightness,"  and  here  for  the  first  time
Aristotle  introduces  his  famous  "  Doctrine  of  the  Mean."

xvi  Aristotle's  Ethics
...
as  we  might  in  modem  phrase  put  it,  of  his  will ;  it  consists
...
conformity  to  which  secures  rightness  in  the  individual
...
and  defect  of  that  which  in  due  measure  constitutes  the
...
xvlii  Aristotle's  Ethics

sense  they  are  his,  they  are  him  in  action,  and  the  most
...
reality  of  his  individual  responsibiUty.  For  his  present
purpose  the  metaphysical  difficulties  are  irrelevant.

The  treatment  of  Justice  in  Book  V.  has  always  been  a
source  of  great  difificulty  to  students  of  the  Ethics.  Almost
more  than  any  other  part  of  the  work  it  has  exercised
mfluence  upon  mediaeval  and  modem  thought  upon  the
...
confused  by  the  unhappy  attempt  to  give  a  precise  mathe-
...
describe  goodness  of  intellect  and  discover  its  highest  foiTU
or  forms;  (2)  to  show  how  this  is  related  to  goodness  of
character,  and  so  to  conduct  generally.  As  all  thinking  is
either  theoretical  or  practical,  goodness  of  intellect  has  tivo
...
/  XX?  Aristotle's  Ethics

that  which  terminates  in  the  production  of  a  rule  which
declares  some  means  to  the  end  of  Hfe.  The  process  pre-
...
Aristotle  is  not  an  intuilionist,  but  he  recognises  the
...
the  level  of  moral  virtue  or  fall  belov/  that  of  moral  vice,

Introduction  xxi

but  partly  and  more  largely  with  conditions  in  which  the
...
arc  not  necessarily  or  inherently  bad,  as  has  sometimes
...
Books  VIII.  and  IX.  (on  Friendship)  arc  almost  an
...
xxii  Aristotle's  Ethics

without  comment  to  the  readers.  These  books  contain  a
necessary  and  attractive  complement  to  the  somewhat  dr\^
account  of  Greek  moraUty  in  the  preceding  books,  and
...
or,  to  put  it  more  distmctly,  "  in  the  life  of  the  philosopher.

Introduction  xxiii

the  life  of  scientific  and  philosophic  contemplation."  The
...
to  be  unnecessarily  and  unjustifiably  hmited.  But  it  must
be  borne  in  mind  that  this  is  a  first  endeavour  to  determine
its  principle,  and  that  smiilar  failures  have  attended  the
attempts  to  describe  the  "  religious  "  or  the  "  spiritual  "
ideals  of  life,  which  have  continually  been  suggested  by
the  apparently  inherent  limitations  of  the  "  practical  "  or
"  moral  "  life,  which  is  the  subject  of  Moral  Philosophy.

xxiv  Aristotle's  Ethics
...
answer  is  given  will  "the  philosophy  of  human  afiairs  "
be  complete.
...
essentially  teleological  view  of  human  life  and  action:
...
their  efficacy  to  produce  such  a  result.  It  arises  fmni-the
application  to  morality  of  the  distinction  of  means  and
end;~  "lFor  this  distinction,  for  all  its  plausibility  and  use-
...
xxvi  Aristotle's  Ethics

distinction  or  separation,_and  all  thinking  abontjtjwhich.
"presupposes  thefinality  of  thig_distinction  wanders_into
misconcepHorir  and  error.,..  The  thinking  which  really
...
which  reveals  to  the  agent  the  situation.  mwhich_£eJs.  to
act,  ^oth,  that  is.,  the  universal  situation  on  which  as  man
Re"  always  and  everywhere  stand^,  and  the  ever-varying
...
still  m.uch  to  learn  from  Aristotle's  Ethics.  The  work  still
...
second  book  of  GEconomica),  5  vols,  by  Aldus  Manutius,  Venice,  1495-8;
...
De  Anima:  Torstrik,  1862;  Trendelenburg,  2nd  edition,  1S77;
with  Enghsh  translation,  E.  Wallace,  1882;  Biehl,  1884,  1896;  with
...
1878,  4th  edition,  1890;  Ramsauer  (Nicomachean),  187S,  Suseraihl,
...
M etaphysica :   Schwegler,  1848;   W.  Christ,  1899.
...
1875;  with  German  translation,  Susemihl,  1874;  Schmidt,  1875;
Christ,  1878;    I.  Bywater,  1898;   T.  G.  Tucker,  1899.

De  Republica  Athenientium :  Text  and  facsimile  of  Papyrus,  F.  G.
Kenyon,  1891,  3rd  edition,  1892;  Kaibel  and  Wilamowitz  -  Moel -
lendorf,  1891,  3rd  edition,  1898;  Van  Herwerden  and  Leeuwen
(from  Kenyon's  text),  1891;  Blass,  1892,  1895,  1S98,  1903;  J.  E.
Sandys,  1893.

Politica:  Susemihl,  1872;  with  German,  1878,  3rd  edition,  1882;
Susemihl  and  Hicks,  1894,  etc.;   O.  Immisch,  1909.

Physica:   C.  Prantl,  1S79.

Rhetorica  :  Stahr,  1S62  ;  Sprengel  (with  Latin  text),  1867;  Cope  and
Sandys,  1877;   Roemer,  1885,  1898.

English  Translations  of  One  or  More  Works:  De  Anima  (with
Parva  Naturaha),  by  W.  A.  Hammond,  1902.  Ethica:  Of  Morals  to
Nicomachus,  by  E.  Pargiter,  1745;  with  Politica,  by  J.  Gillies,  1797,
1804,  1813;  with  Rhetorica  and  Poetica,  by  T.  Taylor,  1818,  and  later
editions.  Nicomachean  Ethics,  1819;  mainly  from  text  of  Bekker,  by
D.  P.  Chase,  1847;  revised  1861,  and  later  editions,  with  an  intro-
ductory essay  by  G.  H.  Lewes  (Camelot  Classics),  1890;  re-edited  by
J.  M.  Mitchell  (New  Universal  Library),  1906,  1910;  by  R.  W.  Browne
...
1881;  J.  E.  C.  Welldon,  1892;  J.  Gillies  (Lubbock's  Hundred  Books),
1893.  Historia  Animalium,  by  R.  Creswell  (Bohn's  Classical  Library)
1848 ;  with  Treatise  on  Phvsiognomy,  by  T.  Taylor,  1809.  Metaphysica,
by  T.Taylor,  1801 ;  by  J.H.  M'Mahon  (Bohn's  Classical  Library),  1848.
Organon,  with  Porph>Ty's  Introduction,  by  O.  F.  Owen  (Bohn's  Classi-
cal Library),  1848.  Posterior  Analytics,  E.  Poste,  1850;  E.  S.  Bourchier,
...
1897.  Poetica,  with  Notes  from  the  French  of  D'Acier,  1705;  by
...
(Bohn's  Classical  Library),  1850 ;  by  Wharton,  1883  (see  Greek  version),
S.  H.  Butcher,  1895,  1898,  3rd  edition,  1902;  E.  S.  Bourchier,  1907;
by  Ingram  Bywater,  1909.  De  Partibus  Animalium,  W.  Ogle,  1882.
De  Republica  Athenientium,  by  E.  Poste,  1891;  F.  G.  Kenyon,  1891;
T.  J.  Dymes,  1891.  De  Virtutibus  et  Vitiis,  by  W.  Bridgman,  1804.
Politica,  from  the  French  of  Regius,  1598;  by  W.  Ellis,  1776,  1778,
1888  (Morley's  Universal  Library),  1893  (Lubbock's  Hundred  Books);
by  E.  Walford  (with  .^Economics,  and  Life  by  Dr.  Gillies),  (Bohn's
Qassical  Library),  1848;  J.  E.C.  Welldon,  1883;  B.  Jowett,  1885;  with

xxviii  Aristotle's  Ethics

Introduction  and  Index  bv  H.  W.  C.  Davis,  1905;  Books  i.  iii.  iv.
(vii.)  from  Bekker's  text  bv  W.  E.  Holland,  with  Introduction  by
A  Lang,  1877.  Problemata  (with  writings  of  other  philosophers),
1597,  1607,  1680,  1684,  etc.  Rhetorica:  A  summary  by  T.  Hobbes,
ibss'l?)  new  edition,  1759;  by  the  translators  of  the  Art  of  Thinking,
1686  1816;  by  D.  M.  Crimmin,  1812;  J.  Gillies,  1823;  Anon.  1847;
J.  e'.  C.  Welldon,  1886;  R.  C.  Jebb,  with  Introduction  and  Supple-
mentary Notes  by  J.  E.  Sandys,  1909  (see  under  Poetica  and  Ethica).
Secreta  Secretorum  (supposititious  work).  Anon.  1702;  from  the
Hebrew  version  by  M.  Gaster,  1907,  1908.  Version  by  Lydgate  and
Burgh,  edited  by  R.  Steele  (E.E.T.S.),  1894,  1898.

Life,  etc.:  J.  W.  Blakesley,  1839;  A.  Crichton  (Jardine's  Natura-
list's Library),  1843;  J.  S.  Blackie,  Four  Phases  of  Morals,  Socrates,
Aristotle,  etc.,  1871;  G.  Grote,  Aristotle,  edited  by  A.  Bain  and  G.
C.  Robertson,  1872,  1880;  E.  Wallace,  Outlines  of  the  Philosophy  of
Aristotle,  187=;,  1880;  A.  Grant  (Ancient  Classics  for  English  readers),
1877;  t!  Davidson,  Aristotle  and  Ancient  Educational  Ideals  (Great
Educators),  1892;  F.  Sewall,  Swedenborg  and  Aristotle,  1895;  W.  A.
Heidel,  The  Necessary  and  the  Contingent  of  the  Aristotelian  System
(University  of  Chicago:  Contributions  to  Philosophy),  1896;  F.  W.
Bain,  On  the  Reahsatioa  of  the  Possible,  and  the  Spirit  of  Aristotle,
1899;  J.  H.  Hyslop,  The  Ethics  of  the  Greek  Philosophers,  etc.
(Evolution  of  Ethics),  1903 ;  M.  V.  WilHams,  Six  Essays  on  the  Platonic
Theory  of  Knowledge  as  expounded  in  the  later  dialogues  and  reviewed
by  Aristotle,  1908;  J.  M.  Watson,  Aristotle's  Criticism  of  Plato,  1909.

ARISTOTLE'S    ETHICS

BOOK  I

Every  art,  and  every  science  reduced  to  a  teachable  form,  I  1094a
...
the  heaUng  art,  for  instance,  health;  of  the  ship-building
...
choose  in  all  instances  with  a  further  End  in  view  (for  then
...
to  this  description,  TroAirtKr)  plainly  answers:  for  this  it  is
that  determines  which  of  the  sciences  should  be  in  the  com-
1094^  munities,  and  which  kind  individuals  are  to  learn,  and  what
...
III  Such  then  are  the  objects  proposed  by  our  treatise,  which
is  of  the  nature  of  TroXiTiKr):  and  I  conceive  I  shall  have
...
similar  error,  because  harm  comes  to  many  from  them:  for
...
4  Aristotle's  Ethics  book  i.

to  those  who  form  their  desires  and  act  in  accordance  with
reason,  to  have  knowledge  on  these  points  must  be  very
profitable.

Let  thus  much  suffice  by  way  of  preface  on  these  three
J  points,  the  student,  the  spirit  in  which  our  observations
...
say  TToXiTLKr]  aims  at?  or,  in  other  words,  what  is  the
...
and  beside  these  many  good  things,  which  is  in  fact  to  all
...
1095^  just  ^  iri  the  racecourse  from  the  judges  to  the  further  end,
or  vice  versa.

Of  course,  we  must  begin  with  what  is  known;  but  then

Book  I.  Aristotlc's  Ethics  5

this  is  of  two  kinds,  what  we  do  know,  and  what  we  jnay
know:  perhaps  then  as  individuals  we  must  begin  with
what  we  do  know.  Hence  the  necessity  that  he  should
...
But  whoso  neithei-  of  himself  conceiveth  nor  hearing  from
...
search,  because  it  is  thought  to  rest  with  those  who  pay
...
6  Aristotle's  Ethics  book  i.

believe  themselves  to  be  good :  for  instance,  they  seek  to  be
honoured  by  the  wise,  and  by  those  among  whom  they  are
kno%vn,  and  for  virtue:  clearly  then,  in  the  opinion  at  least
...
virtue  might  sleep  or  be  inactive  all  through  his  life,  or,  as
a  third  case,  suffer  the  greatest  evils  and  misfortunes:  and
1096a  the  man  who  should  live  thus  no  one  would  call  happy,
...
duced these  eLSi].  Still  perhaps  it  may  appear  better,  nay
...
of  ei!6y^,  did  not  apply  it  to  those  things  in  which  they  spoke
of  priority  and  posteriority,  and  so  they  never  made  any  tSea
of  numbers;  but  good  is  predicated  in  the  categories  of
Substance,  Quality,  and  Relation;  now  that  which  exists  of

Book  I.  AfistOtlc's   EthicS  7
...
there  cannot  be  a  common  I'Sea  in  the  case  of  these.
...
Quality,  as  The  Virtues — and  in  that  of  Quantity,  as  The
Mean — and  in  that  of  Relation,  as  The  Useful — and  in  that
of  Time,  as  Opportunity — and  in  that  of  Place,  as  Abode;
...
Thirdly,  since  those  things  which  range  under  one  I'St'a
...
exercise,  the  gymnastic  science.  A  person  might  fairly
doubt  also  what  in  the  world  they  mean  by  very- this  that  or  1096&
...
called  good  because  of  these  other  goodi,  and  after  another
...
under  one  I'Sea.  But  the  question  next  arises,  what  kind  of
...
Book  I.  Aristotlc's  Ethics  9

the  body,  and  so  on?  However,  perhaps  we  ought  to  leave
these  questions  now,  for  an  accurate  investigation  of  them
is  more  properly  the  business  of  a  different  philosophy.  And
likewise  respecting  the  I'Sea:  for  even  if  there  is  some  one
...
goods  as  are  attainable  and  practical,  because,  with  this  as  1097a
...
cures  or  to  command  an  army  for  having  seen  the  (Sea  itself.
...
And  now  let  us  revert  to  the  Good  of  which  we  are  in  search:  VII
what  can  it  be?  for  manifestly  it  is  different  in  different
actions  and  arts :  for  it  is  different  in  the  healing  art  and  in
...
lo  Aristotle's  Ethics  book  i.

short,  in  every  action  and  moral  choice  the  End,  because  in
...
musical  instalments,  and,  in  general,  all  instruments),  it  is
/  clear  that  all  are  not  final :  but  the  Chief  Good  is  manifestly
something  final;  and  so,  if  there  is  some  one  only  which  is
...
I097&this  we  choose  always  for  its  own  sake,  and  never  with  a

view  to  anything  further :  whereas  honour,  pleasure,  intellect,

j  in  fact  every  excellence  we  choose  for  their  own  sakes,  it  is
...
sufiicient,  being  the  end  of  all  things  which  are  and  may  be
done.
...
1 2  Aristotle's  Ethics  book  i.

is  shared  with  him  even  by  vegetables,  and  we  want  what  is
1098a  pecuUar  to  him.  We  must  separate  off  then  the  life  of  mere
nourishment  and  growth,  and  next  will  come  the  life  of
sensation:  but  this  again  manifestly  is  common  to  horses,
oxen,  and  every  animal.  There  remains  then  a  kind  of  life
of  the  Rational  Nature  apt  to  act:  and  of  this  Nature  there
...
man  may  improve  and  connect  what  is  good  in  the  sketch,
and  that  time  is  a  good  discoverer  and  co-operator  in  such
matters:    it  is  thus  in  fact  that  all  improvements  in  the

Book  I.  Aristotlc's  Ethics  13

various  arts  have  been  brought  about,  for  any  man  may  fill
up  a  deficiency.
...
has  been  well  demonstrated,  which  is  the  case  with  firstioQSZ)
...
1099a state  or  habit  may  possibly  exist  in  a  subject  without
...
Book  I.  Aristotlc's  Ethics  I  5

is  a  mental  sensation,  and  that  is  to  each  pleasant  of  which
...
for  friends,  money,  and  political  influence  are  in  a  manner  10996
instruments  whereby  many  things  are  done:    some  things

1 6  Aristotle's  Ethics  book  l
...
is  ill-bom,  or  solitary  and  childless;  and  still  less  perhaps
...
kind,  or  discipline,  it  is  yet  one  of  the  most  Godlike  things;
...
I  The  question  may  be  determined  also  by  a  reference  to
t  our  definition  of  Happiness,  that  it  is  a  working  of  the  soul
in  the  way  of  excellence  or  virtue  of  a  certain  kind :   and  of

Book  I.  Ati.  .Otlc's  EthicS  I7
...
TToXiTiKr]  to  be  most  excellent:  now  this  bestows  most  care
...
brute  animal  do  we  call  happy,  for  none  of  them  can  partake  iioob
in  such  working:  and  for  this  same  reason  a  child  is  not
...
Solon  would  have  us,  look  to  the  end.'*    And  again,  if  we
...
iiooito  pronounce  the  living  happy  by  reason  of  their  liability
...
Cook  I.  AHstotle's  Ethics

19

results  attach  so  much  as  it  does  to  the  workinirs  in  the  wav
...
truly  good  and  sensible  bears  all  fortunes,  we  presume,  iioia
...
20  Aristotle's  Ethics  book  i.

to  be :  I  do  not  mean  to  say  he  \n\\  be  blessed  should  he  fall
into  fortunes  like  those  of  Priam.

Nor,  in  truth,  is  he  shifting  and  easily  changeable,  for  on
the  one  hand  from  his  happiness  he  wall  not  be  shaken  easily
...
if  at  all,  in  a  long  and  complete  period,  during  which  he  has
made  himself  master  of  great  and  noble  things.

^Vhy  then  should  we  not  call  happy  the  man  who  works
...
much.
XI  Now  that  the  fortunes  of  their  descendants,  and  friends
...
which  befall  all  our  friends  ahke;  if  further,  whether  they
...
of  any  good  or  evil;  it  seems  to  result  from  all  these  con-  iioii
...
best  objects  is  not  praise,  but  sometliing  higher  and  better:
...
'  what  is  noble ;  but  encomia  to  definite  works  of  body  or
mind.
...
no2athat  Happiness  belongs  to  the  class  of  things  precious  and
final.  And  it  seems  to  be  so  also  because  of  its  being  a
starting-point;  which  it  is,  in  that  with  a  view  to  it  we  all
...
Cretans  and  Laced8emonians  and  whatever  other  such  there
have  been.)  But  if  this  investigation  belongs  properly  to
TToAiTtK?),  then  clearly  the  inquiry  will  be  in  accordance  with
our  original  design.
...
Book  I.  Aristotle's  Ethics  23

By  Human  Excellence  we  mean  not  that  of  man's  body
but  that  of  his  soul ;  for  we  ckll  Happiness  a  working  of  the
Soul.
...
so  in  proportion  as  TrokiTiKr)  is  more  precious  and  higher
...
adopt  them  here:    as,  that  the  Soul  consists  of  two  parts,  1
the  Irrational  and  the  Rational  (as  to  whether  these  are   1
...
would  assume  to  exist  in  a'l  things  that  receive  nourishment,
even  in  embryos,  and  this  the  same  as  in  the  perfect  creatures;  1102&
...
its  rule.    (So  too  in  common  phrase  we  say  we  have  Ao'yo^'  of

Book  I.  Aristotle's  Ethics  25
...
tion indicate.  If  then  we  are  to  say  that  this  also  has  Reason,  iio^a
then  the  Rational,  as  well  as  the  Irrational,  will  be  twofold,
the  one  supremely  and  in  itself,  the  other  paying  it  a  kind
of  filial  regard.

I  The  Excellence  of  Man  then  is  divided  in  accordance  with
...
]\Ioral:.  now  the  Intellectual  springs  originally,  and  is
...
Again,  every  Virtue  is  either  produced  or  destroyed  from
...
Similarly  is  it  also  with  nespect  to  the  occasions  of  lust
...
2  8  Aristotle's  Ethics  book  ii.
...
shall  b2  formed  depends  on  these.
...
which  carmot  be  seen  we  must  use  those  that  can),  for
...
and  stand  up  against  them  that  we  come  to  be  brave;  and  1104b
...
Book  II.  Aristotlc's  Ethics  3 1
...
it  is  harder,  as  Heraclitus  says,  to  fight  against  pleasure  than  i
...
H05& excepting  the  one  point  of  knowledge:  whereas  for  posses-
...
being  so  in  a  particular  way),  but  in  right  of  the  virtues  and  iio6a
vices  we  are.
...
Now  how  this  shall  be  it  is  true  we  ha\e  said  already,  but
...
'f  us:  and  the  exactly  equal  is  a  mean  between  excess  and
...
relatively  to  ourselves,  that  which  is  neither  too  much  ijor
too  little  for  the  particular  individual.  This  of  course  i^
...
for  it  does  not  follow,  supposing  ten  minse  is  too  large  a
\io6b  quantity  to  eat  and  two  too  small,  that  the  trainer  will  order
...
Book  II.  Aristotlc's  Ethics  35

and  defect,  but  seeks  for  and  chooses  the  mean,  not  the
...
And  so,  viewing  it  in  reepect  of  its  essence  and  definition.
...
Book  II.  Anstotlc's  Ethics  37

It  is  not  enough,  however,  to  state  this  in  general  terms,  VII
...
has  no  name  (which  is  a  common  case),  the  latter  is  called  11070
...
I io8a  unambitious,  and  we  commend  sometimes  the  one  and  some-
...
40  Aristotle's  Ethics  book  ii.

composition,  is  called  Shameless:    but  the  right  character
Shamefaced.

iioSb  Indignation  against  successful  vice,  again,  is  a  state  in
...
Book  ii.  Afistotlc's  Ethics  4 1
...
Further:  of  the  extremes  in  some  cases  the  excess,  and  in  1109a
...
and  actions,  all  this  has  been  set  forth  fully  and  sufhciently.
...
time,  with  a  right  object,  and  in  the  light  manner,  this  is
...
follows  this  method.
1109&  We  ought  also  to  take  into  consideration  our  own  natural
bias;  which  varies  in  each  man's  case,  and  will  be  ascertained
from  the  pleasure  and  pain  arising  in  us.  Furthermore,  we
should  force  ourselves  ofi  in  the  contrary  direction,  because
...
I  Ilea  Involuntary  actions  then  are  thought  to  be  of  two  kinds,
...
Book  III.  Aristotlc's  Ethics  45
...
where  the  origination  is  in  himself  it  rests  with  himself  to    i
do  or  not  to  do.
...
ference to  what,  and  much  more  so  to  abide  by  one's  decisions:
...
What  kind  of  actions  then  are  to  be  called  compulsory?  iiioJ
may  we  say,  simply  and  abstractedly  whenever  the  cause  \
is  external  and  the  agent  contributes  nothing;    and  that  j
...
honourable  exert  a  compulsive  force  (for  that  they  -^re
...
is  different  from  the  other,  we  will  call  a  n^TyDluntajry_agent;
...
I    \    the  actions  of  the  drunken  or  angry  man,  but  either  the
...
and  what  to  leave  undone,  and  by  reason  of  such  error  men      T
...
bu    not  involuntariness :  nor  does  any  ignorance  of  principle
(because  for  this  men  are  blamed)  but  ignorance  in  particular
details,  wherein  consists   the  action  and  wherewith  it  is
concerned,  for  in  these  there  is  both  compassion  and  allow- iiiic  /
ance,  because  he  who  acts  in  ignorance  of  any  of  them  acts       i  /
in  a  proper  sense  involuntarily.

It  may  be  as  well,  therefore,  to  define  these  particular^  n'
details;  what  they  are,  and  how  many;  viz.  who  acts,  whatSk,^
he  is  doing,  with  respect  to  what  or  in  what,  sometimes  wi^h
...
in  his  senses  could  beignoranf  of ;  plainly  not  of  the 'agent,
being  himself.     But  what  he  is  doing  a  man  may  be  ignorant,
as  men  in  speaking  say  a  thing  escaped  them  unawares;  or-s^
as  iEschylus  did  with  respect  to  the  Mysteries,  that  he  was  ^
not  aware  that  it  was  unlawful  to  speak  of  them;   or  as  in  xi
...
of  any  of  them  is  thought^to  have  acted  involuntarily,  an~

48  Aristotle's  Ethics  book  hi.
...
maintain  actions  to  be  involuntary  which  we  are  boujid"  to
grasp  at :  now  there  are  occasions  on  which  anger  is  ^  duty,
and   there  are   things  which  we  are  bound   to  lust  "    ""

health,  for  instance,  and  learning.

Again,  whereas  actions  strictly  involuntary  are  thought^
to  be  attended  with  pain,  those  which  are  done  to  gratifyT^
lust  are  thought  to  be  pleasant.  <*>

Aga-n:  how  does  the  involuntariness  make  any  differenc^
between  wrong  actions  done  from  deliberate  calculation,  and  ^
those  done  by  reason  of  anger?  for  both  ought  to  be  avoided,
iiiifcand  the  irrational  feelings  are  thought  to  be  just  as  natural
to  man  as  reason,  and  so  of  course  must  be  such  actions  of
the  individud  as  are  done  from  Anger  and  Lust.     It  is
...
Book  III.  Aristotlc's  Ethics  40
...
unhmited  in  its  range  of  objects,  and  to  be  exercised  as  well
...
Iii2a  However,  nobody  perhaps  maintains  its  identity  with
...
Book  III.  Aristotlc's  Ethics  51
...
Nor  in  fact  even  about  all  human  affairs;  no  Lacedse-
...
as  are  exact  and  independent:  as,  for  instance,  about  written  iii2i
...
f  2  Aristotle's  Ethics  book  hi.

invariably  in  the  same  way;  as,  for  instance,  about  matters
connected  with  the  heaUng  art,  or  with  money-making ;  and,
...
the  substance  before  me  is  bread,  or  has  been  properly  1113a
...
of  ]\Ioral  Choice  is  thenceforward  separated  off  and  definite,
...
the  End  of  Deliberation  and  j\Ioral  Choice,  the  actions  regard-

Book  III.  Aristotlc's  Ethics  55
...
refer  out  actions  to  any  other  originations  beside  those  in
...
to  be  self-caused;    to  the  drunken,  for  instance,  penallies

56

Aristotle's  Ethics  book  iii.

are  double,  because  the  origination  in  such  case  hes  in  a
...
1114a know,  they  chastise;  and  similarly  in  all  other  cases  where
...
impression,  but  that  the  End  impresses  each  with  a  notion  iii4i'
...
is  no  matter  of  one's  own  choice,  but  one  must  be  bom  with
...
If  all  this  be  true,  how  will  Virtue  be  a  vhit  more  voluntary

S8

Aristotle's  Ethics  book  hi.

than  Vice?  Alike  to  the  good  man  and  the  bad,  the  End
gives  its  impression  and  is  fixed  by  nature  or  howsoever  you
like  to  savj  and  they  act  so  and  so,  referring  everything  else
to  this  End.
...
1115a able  (as  is  the  case  with  sicknesses):  still  they  are  voluntary
...
number  v/ill  be  thereby  shown.

Book  III.  AHstotle's  Ethics

59

First,  then,  of  Courage.     Now  that  it  is  a  mean  state,  in  VI
...
the  casfes;  for  there  are  men  who,  though  timid  in  the
...
115^  also  on  the  sea  (and  in  sickness),  but  not  in  the  same  way  as
...
Book  III.  Aristotlc's  Ethics  6 1
...
objects,  in  wrong  ways,  and  so  forth.  He  is  deficient  alsoiii6a
...
I  respect  of  objects  inspiring  boldness  or  fear,  in  the  circum-
...
VIII  Courage  proper  is  somewhat  of  the  kind  I  have  described,
...
Tliis  I  say  most  nearly  resembles  the  Courage  before  spoken
...
Book  III.  Aristotlc's  Ethics  63
...
Tliose  commanders  who  station  staunch  troops  by  doubtful
ones,  or  who  beat  their  men  if  they  flinch,  or  who  draw  their
troops  up  in  line  with  the  trenches,  or  other  similar  obstacles,  1116b
...
the  Hermseum),  for  in  the  eyes  of  these  flight  was  disgraceful
...
Book  III.  Aristotlc's  Ethics  65
...
deceived  fly  the  moment  they  know  things  to  be  othersvise
than  they  supposed,  which  the  Argives  experienced  when
they  fell  on  the  Lacedsemonians,  taking  them  for  the  men  of
Sicyon.

B

66  Aristotle's  Ethics  book  hi.

We  have  described  then  what  kind  of  men  the  Brave  are,
...
iixjb  It  must  not  be  thought  but  that  the  End  and  object  of
...
Book  III.  Aristotlc's  Ethics  67
...
and  bodily :  insta,nces  of  the  former  being  love  of  honour  or
...
I  mean,  that  they  who  take  pleasure  in  objects  percei^'C(l
...
Book  III.  Aristotlc's  Ethics  69
...
The  sense  then  with  which  is  connected  the  habit  of  1118^
...
1119a  Now  the  man  destitute  of  self-control  desires  either  all
...
Book  III.  Aristotlc's  EthlCS  J I
...
But  the  man  of  Perfected  Self-]\Iastery  is  in  the  mean  with
...
Now  the  vice  of  being  destitute  of  all  Self-Control  seems  to  XII
...
iiiQ&name  is  primarily  applied,  and  to  which  secondarily  or
...
Book  III.  Afistotlc's  Ethics  73
...
directs.  Let  tliis  be  taken  for  our  account  of  Perfected
Self-Mastery.
...
ii2oais  thought  to  be  a  kind  of  wasting  of  himself,  since  these
...
II20&  receive,  doing  this  not  as  honourable  but  as  necessary,  thai
...
proportion,  m  great  things  and  in  small  alike,  and  all  this
...
Again,  should  it  happen  to  him  to  spend  money  beyond  ii2ifl
...
We  have  said  already  that  Prodigahty  and  Stinginess  are
...
you  see,  already  the  fads  of  the  Liberal  man,  he  gives  and
...
1121^  then  necessitated  to  get  from  some  other  quarter:  and  then
...
passions,  and  turn  ofE  to  their  pleasures  because  they  do  not
...
1122a  improper  amounts.  Their  common  characteristic  is  base-
...
for  its  object-matter  Wealth;  but  it  does  not,  hke  that,
...
Book  IV.  Aristotlc's  Ethics  8  I
...
spend  largely  in  good  taste;  for,  as  we  said  at  the  commence-  xi22b
...
nor  very  unseemly.
Ill  The  very  name  of  Great-mindedness  implies,  that  great
...
in  an  individual.
1123&  Well  then,  he  is  thought  to  be  Great-minded  who  values
...
Honour  then  and  dishonour  arc  specially  the  object-matter  1124a

86  Aristotle's  Ethics  book  iv.

of  the  Great-minded  man :  and  at  such  as  is  great,  and  given
...
and  not  being  able  to  bear  it,  and  possessed  with  an  idea  of  1124*
...
kindnesses  she  had  done  him,  nor  did  the  Lacedi3emonians
...
1125a  all  flatterers  are  low  and  men  in  low  estate  are  flatterers.
...
things  is  consequent  only  uf)on  real  anxiety  about  them.
...
set  themselves  off,  by  dress,  and  carr.'age,  and  such-like
...
Honour,  as  we  have  said:    and  there  seems  to  be  a  virtue  1125^
having  Honour  also  for  its  object  (as  we  stated  in  the  former

90  Aristotle's  Ethics  book  iv.

book),  which  may  seem  to  bear  to  Great-mindedness  the
same  relation  that  Liberahty  does  to  Magnificence:  that
...
more  than  he  ought,  and  from  wrong  sources ;  and  him  v/ho
...
in  right  manner,  nor  in  right  time,  nor  v/ith  those  with  whom
...
ii26&are  deficient  in  the  feeling  and  call  them  Meek,  sometimes
...
the  contrary  line  to  these,  and  oppose  in  everj^thing,  and
...
some  profit  :n  the  way  of  wealth,  or  those  things  which
...
Book  IV.  Aristotlc's  Ethics  95

The  mean  state  which  steers  clear  of  Exaggeration  has  VII
...
1127&  province  of  a  different  virtue),  but,  in  such  as  do  not  involve
...
is  of  such  a  character  is  praiseworth}',  yet  he  leans  rather  to
that  which  is  below  the  truth,  this  havmg  an  appearance  of
...
lie  from  a  desire  of  glor\'  or  gain.  They  who  exaggerate  with
...
manner  of  saying  them ;  and  in  respect  of  hearing  likewise  1 1 28a
...
Book  IV.  Afistotle's  Ethics  90

The  Clownish  man  is  for  such  intercourse  wholly  useless:  1 128 J
...
much  more  like  a  feeling  than  a  moral  state.  It  is  defined,
...
loo  Aristotle's  Ethics  book  iv.
...
I02  Aristotle's  Ethics  book  v.

It  follows  moreover  in  general,  that  if  of  two  contrary
terms  the  one  is  u^ed  in  many  senses  so  also  will  the  other
...
the  word  kXcis  is  used  equivocally  to  denote  the  bone  which
...
1129&  Unjust  "  the  unlawful  and  the  unequal.
...
Book  V.  Ai'istotle's  Ethics  105
...
same  name  because  the  definition  is  in  the  same  genus
